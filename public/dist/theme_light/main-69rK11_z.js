...
const be = ge([
  {
    ...
    children: [
      ...
      },
      {
        path: "/auth",
        async lazy() {
          const { default: e } = await import("./page-BTNiURkk.js");
          return { Component: e };
        }
      },
      {
        ...
        async lazy() {
          const { default: e } = await import("./page-BFOK3Ilp.js");
          return { Component: e };
        }
      },
      {
        ...
        async lazy() {
          const { default: e } = await import("./page-C7CqJBux.js");
          return { Component: e };
        }
      },
      {
        path: "/",
        async lazy() {
          const { default: e } = await import("./main-layout-DUSmlDqU.js");
          return { Component: e };
        },
        errorElement: /* @__PURE__ */ r.jsx(X, {}),
        children: [
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-Bs_lU-3p.js");
                  return { Component: e };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: e } = await import("./page-XlPYlJpP.js");
                  return { Component: e };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-bGAFmUXb.js");
                  return { Component: e };
                }
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: e } = await import("./page-8O-X9uRH.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-BRLmPD6P.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-BHj5Uua9.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: e } = await import("./page-D4FNt8Ly.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: e } = await import("./page-BdhJ3_UA.js");
                  return { Component: e };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: e } = await import("./page-B8bSTEa9.js");
                  return { Component: e };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: e } = await import("./page-Chhn10r4.js");
                          return { Component: e };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: e } = await import("./page-C6wuRq0T.js");
                          return { Component: e };
                        }
                      }
                    ]
        ...
        children: [
          {
            path: "transfer",
            async lazy() {
              const { default: e } = await import("./page-qqk4vGnH.js");
              return { Component: e };
            }
          },
          {
            path: "register",
            async lazy() {
              const { default: e } = await import("./page-DmRMBqum.js");
              return { Component: e };
            }
          }
        ]
