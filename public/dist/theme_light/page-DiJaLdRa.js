...
import { k as b, j as k, r as o } from "./vendor-react-CwfAKKXk.js";
import { f, T as w, B as d, L as C, v as S, g as u } from "./main-DtxzRDTa.js";
import { B as L } from "./vendor-utils-DOORVzle.js";
import { u as R } from "./useTransaction-BD5FqpZY.js";
import { L as B } from "./index-jdHRmqor.js";
import { f as x } from "./vendor-web3-VgZtbLWg.js";
function V() {
  const [i] = b(), h = k(), { signTransaction: p, waitForTransactionExection: g } = R(), [s, v] = o.useState(), [r, I] = o.useState("PENDING"), [c, m] = o.useState(!1), j = o.useRef();
  o.useEffect(() => {
    T();
  }, [i]), o.useEffect(() => {
    s && I(s.status);
  ...
  return /* @__PURE__ */ t.jsx("div", { className: "mt-[120px] flex items-center justify-center", children: /* @__PURE__ */ t.jsxs("div", { className: "bg-white rounded-2xl px-4 md:px-12 py-8 mx-6 max-w-md w-full", children: [
