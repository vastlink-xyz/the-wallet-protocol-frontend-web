import { j as F } from "./vendor-radix-DAGGyvqc.js";
import { K as Et, C as rg, m as Ul, n as qe, w as yr, _ as X, o as St, p as Nr, V as _w, r as Aw, q as se, s as Yi, t as Sf, R as Ew, v as Tw, x as Mw, y as Ft, z as ur, A as Iw, E as Of, F as jw, G as Dw, H as Kn, J as ng, M as Lo, N as Nw, O as Bo, P as kw, Q as ag, U as ig, W as og, X as lg, Y as Rw, Z as uc, $ as ug, a as qi, a0 as $f, f as Ki, h as Pf, c as xe, a1 as Lw, a2 as Bw, a3 as Fw, D as Hw, b as Ww, d as Vw, e as zw, B as Cf, g as _f, a4 as In, T as Uw, a5 as cg, u as Af } from "./main-C7od9bzF.js";
import { _ as Pe, c as Ae, h as Yw, R as qw } from "./vendor-ui-utils-CsaM-dHT.js";
import { a as S, b as Kw, R as k, p as je, e as Le, d as lr, l as Yl } from "./vendor-react-BNvQ9I2c.js";
import { P as _e, B as sg } from "./vendor-utils-B-eF5hYT.js";
import { i as fg, u as br, R as ql, V as Gw, a as Xw, T as Zw, b as Qw, o as dg, g as Jw, c as e1, d as pg, F as vg, C as hg, e as jn } from "./index--OK2eXqO.js";
import { j as cr, g as pe, i as Te, _ as Gi, f as t1 } from "./vendor-web3-DanlmASa.js";
import { R as r1, g as mg, B as n1, u as gg, a as yg } from "./button-Dc0jN4yY.js";
import { T as a1, a as i1, b as cc, c as on, d as Bd, e as zr } from "./table-CZdXmzvK.js";
import { E as o1, R as bg, P as l1, u as u1 } from "./index-DtPcgWKK.js";
import { W as c1 } from "./index-UYWh9-3G.js";
import { u as Fd } from "./MarketplaceProvider-DzdeitCL.js";
...
const NO = (e) => {
  const t = /* @__PURE__ */ S.forwardRef((r, n) => {
    ...
    } = pg(C, P), I = $(), [_, E] = Tg("rangePicker", w, p), j = ag(C), [N, R, B] = Iy(C, j);
    if (je.env.NODE_ENV !== "production") {
    ...
    }), z = S.useContext(ig), K = d ?? z, J = S.useContext(vg), {
      hasFeedback: te,
      status: ie,
      feedbackIcon: U
...
const RO = (e) => {
  const t = (u, c) => {
    const s = c === Qd ? "timePicker" : "datePicker", f = /* @__PURE__ */ S.forwardRef((d, p) => {
      ...
      } = pg(B, j), V = S.useRef(null), [z, K] = Tg("datePicker", D, b), J = ag(B), [te, ie, U] = Iy(B, J);
      ...
      }), Ee = S.useContext(ig), De = C ?? Ee, it = S.useContext(vg), {
        hasFeedback: ot,
        status: nt,
        feedbackIcon: ze
...
const PU = ["performanceChart"], CU = async (e, t) => {
  try {
...
function MU() {
  const e = Yl(), { address: t } = qi.all(), [r, n] = S.useState("7D"), [a, i] = S.useState([]), [o, l] = S.useState([]), [u, c] = S.useState([]), { data: s, isFetched: f, refetch: d } = _U(365, {
    enabled: !!t
  });
  S.useEffect(() => {
    f && p();
  ...
  const p = async () => {
    ...
    if (n(m), !s) return;
    const v = TU(m), y = s.chartData.slice(-v);
        ...
        /* @__PURE__ */ F.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
          ...
          /* @__PURE__ */ F.jsx(
            Lw,
            {
              value: r,
              onValueChange: (m) => h(m),
              children: /* @__PURE__ */ F.jsx(Bw, { className: "h-[28px] bg-transparent", children: EU.map((m) => /* @__PURE__ */ F.jsx(
                Fw,
                {
                  value: m,
                  className: xe(
...
function DU({ data: e, isLoading: t }) {
...
const NU = ["transactionHistory"], kU = async (e, t) => {
  try {
...
function LU() {
  const { address: e } = qi.all(), [t, r] = S.useState(Jm), [n, a] = S.useState("ALL"), [i, o] = S.useState(!1), { data: l } = cg({
    enabled: !!e
  }), { data: u, isFetching: c, refetch: s, error: f } = RU({
    enabled: !!e,
...
`), O = new Blob([w], { type: "text/csv;charset=utf-8;" }), g = URL.createObjectURL(O), b = document.createElement("a");
  ...
  return /* @__PURE__ */ F.jsxs("div", { className: "min-h-[500px]", children: [
    ...
    ] }) : /* @__PURE__ */ F.jsx(DU, { data: u || [], isLoading: c })
  ] });
}
const BU = ["purchased-products"], FU = async () => (await Ki.get("/user/purchasedProducts")).data, HU = () => $f({
  queryKey: BU,
  queryFn: FU
});
function eg({
...
function WU() {
  const e = Yl(), { handleConnect: t } = Fd(), { data: r } = HU(), {
    setIsModalOpen: n,
    setDappInfo: a,
    isConnected: i,
...
function nY() {
  ...
  return /* @__PURE__ */ F.jsxs("div", { className: "mt-[40px] tablet:mt-[100px]", children: [
    t && t.isUSDZero && /* @__PURE__ */ F.jsx(WU, {}),
    t && !t.isUSDZero && /* @__PURE__ */ F.jsx(MU, {}),
    ((r == null ? void 0 : r.purchasedProducts) ?? []).length > 0 ? /* @__PURE__ */ F.jsx(zU, {}) : /* @__PURE__ */ F.jsx(VU, { className: "mt-[48px] tablet:mt-[100px]" }),
    /* @__PURE__ */ F.jsx("div", { className: "mt-[60px] tablet:mt-[100px]", children: /* @__PURE__ */ F.jsx(LU, {}) })
  ] });
}
export {
  nY as default
