import { j as s } from "./vendor-radix-BYJ0AyiX.js";
import { l as C, k as A, r } from "./vendor-react-CuOkI7kW.js";
import { B as i, a as O } from "./vendor-utils-DMWa-Mp_.js";
import { f as o, g as U, B as d, L as f, k as V, a as W, h as y } from "./main-DJ2eXCQq.js";
import { L as E } from "./index-B5Q10HkQ.js";
import { k as Y } from "./vendor-web3-DDgB3Js4.js";
function K() {
  const [l] = C(), w = A(), [u, b] = r.useState(!1), [x, p] = r.useState(!1), [h, g] = r.useState(!1), [I, j] = r.useState(!1), [t, S] = r.useState(), [m, k] = r.useState("PENDING"), [T, G] = r.useState("");
  r.useEffect(() => {
    P();
  }, [l]), r.useEffect(() => {
    t && k(t.status);
