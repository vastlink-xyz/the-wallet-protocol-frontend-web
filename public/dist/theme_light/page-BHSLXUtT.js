...
import { f, T as w, B as d, L as C, v as S, g as u } from "./main-CmE7wmKE.js";
import { B as L } from "./vendor-utils-BMKgA_3H.js";
import { u as R } from "./useTransaction-5pA7Tj1L.js";
import { L as B } from "./index-DGLuelxM.js";
import { f as x } from "./vendor-web3-SIldcrZc.js";
function V() {
  const [i] = b(), h = k(), { signTransaction: p, waitForTransactionExection: g } = R(), [s, v] = o.useState(), [r, I] = o.useState("PENDING"), [c, l] = o.useState(!1), j = o.useRef();
  o.useEffect(() => {
    T();
  }, [i]), o.useEffect(() => {
    s && I(s.status);
