import { j as p } from "./vendor-radix-D7Ti2ut_.js";
import { K as Ne, A as we, M as It, ao as ve, ap as W, J as oe, aq as Je, ar as Qe, Q as Ye, as as H, P as Ze, r as B, O as Et, z as k, X as et, Z as tt, at as ke, U as St, T as Ot, W as Dt, q as Te, au as at, av as Ft, a0 as Rt, E as Pt, aw as Lt, a as Le, c as z, f as rt, al as nt, ah as Mt, B as Ie, L as Ut, h as Tt, ax as At, t as zt, ay as _t, u as qt, ac as Ht, ae as Bt } from "./main-Bv5HMVJf.js";
import { r as l, p as G, R as Me, a as Ve } from "./vendor-react-Bi1rjDlg.js";
import { B as be, a as kt } from "./vendor-utils-BZIeOlaI.js";
import { P as it } from "./progress-du-qgBly.js";
import { _ as ee, s as Vt, P as Xt } from "./vendor-ui-utils-CRHGvpNr.js";
import { q as U, r as Wt, p as Gt, _ as Kt } from "./vendor-web3-DTRFnZJ-.js";
import { i as Jt, d as Qt, e as Yt, f as Xe, u as Zt } from "./index-C3hVfV-J.js";
import { R as We, B as Ge, a as ea } from "./button-Bd-TESk-.js";
import { o as ta } from "./CheckOutlined-D3tFVKNf.js";
const aa = (e) => ({
  [e.componentCls]: {
  ...
  return [Jt(n, ra, na, e.motionDurationMid, t), {
    [`
        ${i}${n}-enter,
        ${i}${n}-appear
      `]: {
...
var ua = { icon: { tag: "svg", attrs: { viewBox: "64 64 896 896", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M505.7 661a8 8 0 0012.6 0l112-141.7c4.1-5.2.4-12.9-6.3-12.9h-74.1V168c0-4.4-3.6-8-8-8h-60c-4.4 0-8 3.6-8 8v338.3H400c-6.7 0-10.4 7.7-6.3 12.9l112 141.8zM878 626h-60c-4.4 0-8 3.6-8 8v154H214V634c0-4.4-3.6-8-8-8h-60c-4.4 0-8 3.6-8 8v198c0 17.7 14.3 32 32 32h684c17.7 0 32-14.3 32-32V634c0-4.4-3.6-8-8-8z" } }] }, name: "download", theme: "outlined" }, pa = function(t, r) {
  return /* @__PURE__ */ l.createElement(we, ee({}, t, {
    ref: r,
    icon: ua
  }));
...
}, name: "picture", theme: "twotone" }, ba = function(t, r) {
  return /* @__PURE__ */ l.createElement(we, ee({}, t, {
    ref: r,
    icon: va
  }));
...
const De = function(e, t) {
  if (e && t) {
    var r = Array.isArray(t) ? t : t.split(","), n = e.name || "", i = e.type || "", s = i.replace(/\/.*$/, "");
    return r.some(function(o) {
      var a = o.trim();
      if (/^\*(\/\*)?$/.test(o))
        return !0;
      if (a.charAt(0) === ".") {
        var m = n.toLowerCase(), c = a.toLowerCase(), d = [c];
...
function xa(e) {
  ...
  e.data && Object.keys(e.data).forEach(function(i) {
    ...
    r.append(i, s);
  }), e.file instanceof Blob ? r.append(e.filename, e.file, e.file.name) : r.append(e.filename, e.file), t.onerror = function(s) {
    e.onError(s);
  }, t.onload = function() {
...
var ya = /* @__PURE__ */ function() {
  var e = ve(/* @__PURE__ */ W().mark(function t(r, n) {
    var i, s, o, a, m, c, d, f;
      ...
      for (; ; ) switch (w.prev = w.next) {
        case 0:
          c = function() {
            ...
            return a = ve(/* @__PURE__ */ W().mark(function C(j) {
              var I, x, y, $, u;
...
var ja = ["component", "prefixCls", "className", "classNames", "disabled", "id", "name", "style", "styles", "multiple", "accept", "capture", "children", "directory", "openFileDialogOnClick", "onMouseEnter", "onMouseLeave", "hasControlInside"], Na = /* @__PURE__ */ function(e) {
  ...
  function r() {
    ...
    for (var i = arguments.length, s = new Array(i), o = 0; o < i; o++)
      s[o] = arguments[o];
    return n = t.call.apply(t, [this].concat(s)), U(H(n), "state", {
      uid: Fe()
    }), U(H(n), "reqs", {}), U(H(n), "fileInput", void 0), U(H(n), "_isMounted", void 0), U(H(n), "onChange", function(a) {
      var m = n.props, c = m.accept, d = m.directory, f = a.target.files, g = oe(f).filter(function(w) {
        return !d || De(w, c);
      });
      n.uploadFiles(g), n.reset();
    }), U(H(n), "onClick", function(a) {
      var m = n.fileInput;
      if (m) {
        var c = a.target, d = n.props.onClick;
    ...
    }), U(H(n), "onKeyDown", function(a) {
      a.key === "Enter" && n.onClick(a);
    }), U(H(n), "onFileDrop", /* @__PURE__ */ function() {
    ...
    }), U(H(n), "processFile", /* @__PURE__ */ function() {
    ...
    }()), U(H(n), "saveFileInput", function(a) {
      n.fileInput = a;
    }), n;
  }
  return Ze(r, [{
    ...
    value: function(i) {
      ...
      if (this._isMounted) {
        var d = this.props, f = d.onStart, g = d.customRequest, w = d.name, h = d.headers, C = d.withCredentials, j = d.method, I = a.uid, x = g || xa, y = {
          action: m,
          filename: w,
          data: o,
          file: c,
...
var Ue = /* @__PURE__ */ function(e) {
  ...
  function r() {
    ...
    for (var i = arguments.length, s = new Array(i), o = 0; o < i; o++)
      s[o] = arguments[o];
    return n = t.call.apply(t, [this].concat(s)), U(H(n), "uploader", void 0), U(H(n), "saveUploader", function(a) {
      n.uploader = a;
    }), n;
  }
  return Ze(r, [{
...
const Ia = (e) => {
  ...
  const {
    componentCls: t
  } = e, r = new Ne("uploadAnimateInlineIn", {
    from: {
      width: 0,
      height: 0,
      padding: 0,
      ...
      `]: {
        [a]: {
          ...
          [`${a}-thumbnail`]: Object.assign(Object.assign({}, tt), {
            width: n,
            height: n,
            lineHeight: k(s(n).add(e.paddingSM).equal()),
            textAlign: "center",
            flex: "none",
            [r]: {
  ...
  const {
    ...
    uploadProgressOffset: s(s(r).div(2)).add(n).equal(),
...
const Ua = function() {
  ...
  if (e.type && !e.thumbUrl)
    return pt(e.type);
  const t = e.thumbUrl || e.url || "", r = Ua(t);
...
function Aa(e) {
  return new Promise((t) => {
    ...
    if (i.onload = () => {
      ...
      s > o ? (m = o * (se / s), d = -(m - a) / 2) : (a = s * (se / o), c = -(a - m) / 2), n.drawImage(i, c, d, a, m);
      const f = r.toDataURL();
      document.body.removeChild(r), window.URL.revokeObjectURL(i.src), t(f);
...
const za = /* @__PURE__ */ l.forwardRef((e, t) => {
  ...
  if (o === "picture" || o === "picture-card" || o === "picture-circle")
    if (T === "uploading" || !a.thumbUrl && !a.url) {
      const F = B(`${r}-list-item-thumbnail`, {
        [`${r}-list-item-file`]: T !== "uploading"
      });
      ...
      }) : de, R = B(`${r}-list-item-thumbnail`, {
        [`${r}-list-item-file`]: w && !w(a)
      });
  ...
  const L = B(`${r}-list-item`, `${r}-list-item-${T}`), ae = typeof a.linkProps == "string" ? JSON.parse(a.linkProps) : a.linkProps, ue = (typeof C == "function" ? C(a) : C) ? f(
    ...
    !0
  ) : null, ge = (typeof j == "function" ? j(a) : j) && T === "done" ? f((typeof y == "function" ? y(a) : y) || /* @__PURE__ */ l.createElement(lt, null), () => D(a), r, s.downloadFile) : null, re = o !== "picture-card" && o !== "picture-circle" && /* @__PURE__ */ l.createElement("span", {
    key: "download-delete",
    className: B(`${r}-list-item-actions`, {
      picture: o === "picture"
    })
  }, ge, ue), J = typeof $ == "function" ? $(a) : $, b = J && /* @__PURE__ */ l.createElement("span", {
    className: `${r}-list-item-extra`
  }, J), M = B(`${r}-list-item-name`), X = a.url ? /* @__PURE__ */ l.createElement("a", Object.assign({
    key: "view",
    target: "_blank",
    rel: "noopener noreferrer",
    className: M,
    ...
    onClick: (F) => u(a, F),
    title: s.previewFile
  }, typeof I == "function" ? I(a) : I || /* @__PURE__ */ l.createElement(st, null)) : null, ne = (o === "picture-card" || o === "picture-circle") && T !== "uploading" && /* @__PURE__ */ l.createElement("span", {
    className: `${r}-list-item-actions`
  }, q, T === "done" && ge, ue), {
    getPrefixCls: ie
  } = l.useContext(Te), xe = ie(), Y = /* @__PURE__ */ l.createElement("div", {
    className: L
  }, V, X, re, ne, le && /* @__PURE__ */ l.createElement(at, {
    motionName: `${xe}-fade`,
    visible: T === "uploading",
    motionDeadline: 2e3
  }, (F) => {
    ...
    return /* @__PURE__ */ l.createElement("div", {
      className: B(`${r}-list-item-progress`, R)
    }, Z);
  ...
  return /* @__PURE__ */ l.createElement("div", {
    className: B(`${r}-list-item-container`, n),
    style: i,
    ref: t
  }, g ? g(ye, a, m, {
  ...
  const {
    ...
    itemRender: D,
    disabled: E
  } = e, _ = sa(), [Q, K] = l.useState(!1), T = ["picture-card", "picture-circle"].includes(r);
  l.useEffect(() => {
    r.startsWith("picture") && (f || []).forEach((b) => {
  ...
  const te = (b, M) => {
    ...
    if (r.startsWith("picture")) {
      const X = r === "picture" ? /* @__PURE__ */ l.createElement(We, null) : a.uploading, q = c != null && c(b) ? /* @__PURE__ */ l.createElement(ut, null) : /* @__PURE__ */ l.createElement(ct, null);
      return M ? X : q;
    }
    ...
    return ne && (ie.disabled = E), /* @__PURE__ */ l.isValidElement(b) ? /* @__PURE__ */ l.createElement(Ge, Object.assign({}, ie, {
  ...
  const {
    getPrefixCls: L
  } = l.useContext(Te), ae = L("upload", d), ue = L(), ge = B(`${ae}-list`, `${ae}-list-${r}`), re = l.useMemo(() => ta(Yt(ue), ["onAppearEnd", "onEnterEnd", "onLeaveEnd"]), [ue]), J = Object.assign(Object.assign({}, T ? {} : re), {
    motionDeadline: 2e3,
...
const $e = `__LIST_IGNORE_${Date.now()}__`, Ha = (e, t) => {
  const {
    ...
    rootClassName: ce
  } = e, de = l.useContext(Rt), V = g ?? de, [L, ae] = Zt(n || [], {
    value: r,
    postState: (v) => v ?? []
  }), [ue, ge] = l.useState("drop"), re = l.useRef(null), J = l.useRef(null);
  ...
  }), jt = Object.assign(Object.assign({}, F == null ? void 0 : F.style), u);
  if (y === "drag") {
...
function Va({
  ...
  const [r, n] = l.useState(!1), [i, s] = l.useState(0), [o, a] = l.useState(e || ""), { username: m } = Le.all(), c = {
    name: "file",
    multiple: !1,
    showUploadList: !1,
  ...
  return /* @__PURE__ */ p.jsx("div", { className: z(
    ...
    ka,
    {
      ...
      children: /* @__PURE__ */ p.jsx("div", { children: r ? /* @__PURE__ */ p.jsxs("div", { className: "text-black/90 text-sm font-normal leading-snug", children: [
...
function Wa({
  isOpen: e,
  onClose: t,
  initialAvatarIndex: r,
  initialAvatar: n
}) {
  const i = nt(), [s, o] = l.useState("select"), [a, m] = l.useState(0), [c, d] = l.useState(""), [f, g] = l.useState(!1), [w, h] = l.useState(!1);
  l.useEffect(() => {
    e && (n ? (m(0), d(n), o("upload")) : m(r));
  }, [e]);
...
function Ga() {
  const e = nt(), { data: t } = At(), [r, n] = l.useState(!1), i = () => {
    n(!0);
  }, s = (o = !1) => {
    n(!1), o && e.invalidateQueries({ queryKey: ["dailyWithdrawalLimits"] });
  };
...
function sr() {
  const { address: e, username: t } = Le.all(), { data: r } = qt(), [n, i] = l.useState(""), [s, o] = l.useState(0), [a, m] = l.useState(""), [c, d] = l.useState(!1), [f, g] = l.useState(!1);
  l.useEffect(() => {
    r && (i(r.avatar), o(r.avatarIndex), m(r.avatar || Le.getUserRandomAvatar(r.avatarIndex)));
  }, [r]);
  const w = () => {
    g(!0);
  };
