...
import { j as p } from "./vendor-react-CA5sEv1f.js";
function n() {
  const a = p();
  return /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ e.jsx("div", { className: t(
      ...
      /* @__PURE__ */ e.jsxs("div", { className: t(
        ...
        ), children: "Over 5000 users around the world trust Vastlink’s software and APIs to simplify global PayFi operations, unlock new oppotunitues, and grow without limits" }),
        /* @__PURE__ */ e.jsx("div", { className: t(
    ...
    /* @__PURE__ */ e.jsxs("div", { className: t(
      ...
      /* @__PURE__ */ e.jsxs("div", { className: t(
        ...
        /* @__PURE__ */ e.jsxs("div", { children: [
          ...
          ), children: "Build on the shoulders of giants" }),
          /* @__PURE__ */ e.jsx("div", { className: t(
            "text-[#e8ffdc] font-normal leading-7",
            "laptop:w-[403px] desktop:w-[572px]",
            "laptop:text-base desktop:text-xl"
          ), children: "Platform and infrastructure partners, with more exciting features on the way!" })
        ] })
      ] }),
      /* @__PURE__ */ e.jsxs("div", { className: t(
        "block laptop:hidden"
        ...
        /* @__PURE__ */ e.jsx(
          "img",
          {
            ...
            src: "/imgs/banners/landing_2_1_tablet.png",
            alt: "banner"
          }
        )
      ] })
