...
import { i as T, r as a, j as A, n as R } from "./vendor-react-U4DfHahV.js";
import { c as p, w as z, f as C, h as B, q as k } from "./main-OpUhS-4m.js";
import { S as I, P as M } from "./ProductList-CxlBxymc.js";
import { a as O } from "./MarketplaceProvider-Cq_eOz3F.js";
import { j as S, b as E } from "./vendor-ui-utils-DB1608yX.js";
import { u as F, B as _ } from "./vendor-utils-CQorlrD-.js";
import { E as D } from "./index-DaCT8V52.js";
const L = [
  "Most popular",
  "Free",
  "Latest",
...
function G({
  ...
  const { checkNewProducts: h, hasNewProducts: l } = O(), i = T(), m = L, [o, f] = a.useState(!1), [r, v] = a.useState(!1), n = a.useRef(null), [j, g] = a.useState(!1), b = a.useRef(0), x = () => {
    const e = n.current;
    if (e) {
  ...
  a.useEffect(() => {
    ...
    const e = n.current;
    if (e)
      return e.addEventListener("scroll", x), () => e.removeEventListener("scroll", x);
  }, []), a.useEffect(() => {
...
function X() {
  ...
  const [u, h] = a.useState(!1), [l, i] = a.useState(L[0]), {
    ...
    try {
      ...
      g(e.data.products), f(e.data.total);
    } catch (e) {
      const d = B(e);
      _.error(d.message);
    } finally {
