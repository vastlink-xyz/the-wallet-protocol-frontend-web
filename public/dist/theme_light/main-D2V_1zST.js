...
import { j as v, S as Hu, d as Vs, g as Ws, P as Uu, C as Ks, I as Gs, i as Qs, k as qs, l as Xs, L as Ys, m as Zs, n as zu, T as Vu, o as Js, p as ec, q as tc, r as Wu } from "./vendor-radix-CPmBDWYo.js";
...
import { t as Zu, c as Ju, C as ed, a as td, b as nd, d as rd, e as ad, _ as Ze, X as Vo, L as od, f as Pa, g as nc, h as id, i as sd, j as cd, I as ld } from "./vendor-ui-utils-BWSrTfCS.js";
import { a as jn, u as Wo, C as ud, B as st, Q as dd, X as fd, i as rc, b as hd, I as pd } from "./vendor-utils-nZmF9_dO.js";
...
const $v = 30, Bv = async () => {
...
}, Hv = Xu([
  {
    path: "/",
    async lazy() {
      const { RootLayout: e } = await import("./root-layout-CMvzWMu4.js");
      return { Component: e };
    },
    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: e } = await import("./main-layout-BrH06_BQ.js");
          return { Component: e };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: e } = await import("./page-DsyhVL5p.js");
              return { Component: e };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: e } = await import("./page-D7E5WVLo.js");
              return { Component: e };
            }
          },
          {
            ...
            async lazy() {
              const { default: e } = await import("./page-CXdBcRyO.js");
              return { Component: e };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: e } = await import("./page-BwBhRzub.js");
              return { Component: e };
            }
          },
          {
            ...
            async lazy() {
              const { default: e } = await import("./page-CzsYt8qG.js");
              return { Component: e };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-C7k5gj11.js");
                  return { Component: e };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: e } = await import("./page-CbsV1ggL.js");
                  return { Component: e };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: e } = await import("./page-Dbw_r1Tc.js");
                  return { Component: e };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-CLE0gvPN.js");
                  return { Component: e };
                },
                loader: Bv
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: e } = await import("./page-Bq6GFprs.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-Bs0iFC1X.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-CKRMw_8n.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: e } = await import("./page-ZDSkpQeC.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: e } = await import("./page-BHWUE3ge.js");
                  return { Component: e };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: e } = await import("./page-5hWRIGnP.js");
                  return { Component: e };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: e } = await import("./page-BDm9KSSW.js");
                          return { Component: e };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: e } = await import("./page-BINF-bbD.js");
                          return { Component: e };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: e } = await import("./page-ssxADmJW.js");
                  return { Component: e };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: e } = await import("./page-aP5j-P23.js");
                  return { Component: e };
                }
              }
            ]
          },
          {
            path: "profile",
            async lazy() {
              const { default: e } = await import("./index-DgDJestB.js");
              return { Component: e };
            }
          },
          {
            path: "multisender",
            async lazy() {
              const { default: e } = await import("./page-DPFoiX2t.js");
              return { Component: e };
            }
          }
        ]
