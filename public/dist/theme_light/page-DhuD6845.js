...
import { U as nt, T as st, W as at, z as ke, q as rt, r as it, E as ot, c as M, g as $e, I as qe, aO as lt, ah as ct, B as _e, t as D, aP as dt, i as je, aQ as Ne, f as Re, n as De, a as ut, aR as ht, an as ft, ax as pt, aS as ze, ab as pe, a4 as be, h as mt, ak as gt, aT as xt, ay as bt, G as vt, D as yt, b as kt, d as wt, e as _t, aU as Tt } from "./main-Bv5HMVJf.js";
import { r as A, p as Fe, o as jt, q as Et, c as Ct, d as Nt, f as Ge } from "./vendor-react-Bi1rjDlg.js";
import { u as St, i as He, L as At, f as Ke, g as Me, T as It, P as Ot, I as Rt } from "./vendor-ui-utils-CRHGvpNr.js";
import { u as Qe, B as Ie } from "./vendor-utils-BZIeOlaI.js";
import { u as Dt } from "./useTransaction-CzAFFl_l.js";
import { w as Pe, x as Ft, j as Mt, l as Vt, n as $t, i as Te, u as Ce } from "./vendor-web3-DTRFnZJ-.js";
import { d as Lt } from "./index-C3hVfV-J.js";
const zt = (i) => {
  const {
    componentCls: a,
...
const Ye = (i) => {
  const {
    ...
    plain: ee,
    style: G
  } = i, ie = Wt(i, ["prefixCls", "type", "orientation", "orientationMargin", "className", "rootClassName", "children", "dashed", "variant", "plain", "style"]), F = a("divider", l), [te, B, $] = Bt(F), Q = !!S, ne = g === "left" && x != null, Y = g === "right" && x != null, I = it(F, s == null ? void 0 : s.className, B, $, `${F}-${p}`, {
    [`${F}-with-text`]: Q,
    [`${F}-with-text-${g}`]: Q,
    [`${F}-dashed`]: !!O,
    [`${F}-${V}`]: V !== "solid",
    [`${F}-plain`]: !!ee,
    [`${F}-rtl`]: c === "rtl",
    [`${F}-no-default-orientation-margin-left`]: ne,
    [`${F}-no-default-orientation-margin-right`]: Y
  ...
  if (Fe.env.NODE_ENV !== "production") {
    const o = ot("Divider");
    Fe.env.NODE_ENV !== "production" && o(!S || p !== "vertical", "usage", "`children` not working in `vertical` mode.");
  }
...
Fe.env.NODE_ENV !== "production" && (Ye.displayName = "Divider");
const Oe = 337;
function Ut({
  className: i,
  onSuccess: a,
  ...
  return A.useEffect(() => {
    const B = (Q) => F(Q.clientX), $ = (Q) => {
      Q.preventDefault(), F(Q.touches[0].clientX);
    };
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ n.jsx("div", { className: "absolute text-white inset-0 flex items-center justify-center pointer-events-none", children: s ? /* @__PURE__ */ n.jsx(He, { className: "w-5 h-5 animate-spin" }) : /* @__PURE__ */ n.jsx("span", { className: M(
...
function qt({
  ...
  return /* @__PURE__ */ n.jsxs("div", { className: M(
    ...
    p && !c && /* @__PURE__ */ n.jsx(Me, { className: M(
    ...
    p && /* @__PURE__ */ n.jsx("p", { className: M(
  ...
  return Yt.getOrCreate(p, async () => {
    ...
    try {
      ...
      const O = await d.estimateGas({
        ...S,
        account: c
      }), V = s || await d.getGasPrice(), G = (l || await d.getBlock()).baseFeePerGas || BigInt(0), ie = V > G ? V - G : BigInt(1e9), F = G + ie * BigInt(2), te = O * F, B = je(
...
(function(i, a) {
  (function(c, s) {
    ...
    var s = typeof self < "u" ? self : typeof window < "u" ? window : s !== void 0 ? s : {}, l = !s.document && !!s.postMessage, p = s.IS_PAPA_WORKER || !1, g = {}, x = 0, d = { parse: function(t, e) {
      ...
      var o = !1, m = !0, v = ",", T = `\r
`, N = '"', R = N + N, L = !1, k = null, W = !1;
      (function() {
        if (typeof e == "object") {
          if (typeof e.delimiter != "string" || d.BAD_DELIMITERS.filter(function(y) {
            return e.delimiter.indexOf(y) !== -1;
          }).length || (v = e.delimiter), (typeof e.quotes == "boolean" || typeof e.quotes == "function" || Array.isArray(e.quotes)) && (o = e.quotes), typeof e.skipEmptyLines != "boolean" && typeof e.skipEmptyLines != "string" || (L = e.skipEmptyLines), typeof e.newline == "string" && (T = e.newline), typeof e.quoteChar == "string" && (N = e.quoteChar), typeof e.header == "boolean" && (m = e.header), Array.isArray(e.columns)) {
            if (e.columns.length === 0) throw new Error("Option columns is empty");
            k = e.columns;
          }
          e.escapeChar !== void 0 && (R = e.escapeChar + N), (typeof e.escapeFormulae == "boolean" || e.escapeFormulae instanceof RegExp) && (W = e.escapeFormulae instanceof RegExp ? e.escapeFormulae : /^[=+\-@\t\r].*$/);
        }
      })();
      var E = new RegExp(F(N), "g");
      ...
      function se(y, P) {
        ...
        return (ae = ae || o === !0 || typeof o == "function" && o(y, P) || Array.isArray(o) && o[P] || function(re, X) {
          ...
          return !1;
        }(H, d.BAD_DELIMITERS) || -1 < H.indexOf(v) || H.charAt(0) === " " || H.charAt(H.length - 1) === " ") ? N + H + N : H;
      }
    } };
...
`, '"', d.BYTE_ORDER_MARK], d.WORKERS_SUPPORTED = !l && !!s.Worker, d.NODE_STREAM_INPUT = 1, d.LocalChunkSize = 10485760, d.RemoteChunkSize = 5242880, d.DefaultDelimiter = ",", d.Parser = te, d.ParserHandle = ie, d.NetworkStreamer = O, d.FileStreamer = V, d.StringStreamer = ee, d.ReadableStreamStreamer = G, s.jQuery) {
      ...
      w.fn.parse = function(t) {
        ...
        return this.each(function(T) {
          ...
          for (var N = 0; N < this.files.length; N++) o.push({ file: this.files[N], inputElem: this, instanceConfig: w.extend({}, e) });
        }), m(), this;
        function m() {
          if (o.length !== 0) {
            var T, N, R, L, k = o[0];
            if (I(t.before)) {
              ...
              if (typeof W == "object") {
                if (W.action === "abort") return T = "AbortError", N = k.file, R = k.inputElem, L = W.reason, void (I(t.error) && t.error({ name: T }, N, R, L));
    ...
    function S(t) {
      this._handle = null, this._finished = !1, this._completed = !1, this._halted = !1, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = !0, this._completeResults = { data: [], errors: [], meta: {} }, (function(e) {
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          var N = T.meta.cursor;
          this._finished || (this._partialLine = v.substring(N - this._baseIndex), this._baseIndex = N), T && T.data && (this._rowCount += T.data.length);
    ...
    function V(t) {
      ...
      this.stream = function(v) {
        ...
        var N = e.readAsText(v, this._config.encoding);
        m || this._chunkLoaded({ target: { result: N } });
    ...
    function ie(t) {
      var e, o, m, v = Math.pow(2, 53), T = -v, N = /^\s*-?(\d+\.?|\.\d+|\d+\.\d+)([eE][-+]?\d+)?\s*$/, R = /^((\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z)))$/, L = this, k = 0, W = 0, E = !1, oe = !1, se = [], y = { data: [], errors: [], meta: {} };
      if (I(t.step)) {
        var P = t.step;
        t.step = function(_) {
          if (y = _, re()) H();
        ...
        return y && m && (Z("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + d.DefaultDelimiter + "'"), m = !1), t.skipEmptyLines && (y.data = y.data.filter(function(_) {
          ...
          function _(f, u) {
            ...
            for (h = 0; h < f.length; h++) {
              var j = h, C = f[h];
              t.header && (j = h >= se.length ? "__parsed_extra" : se[h]), t.transform && (C = t.transform(C, j)), C = X(j, C), j === "__parsed_extra" ? (b[j] = b[j] || [], b[j].push(C)) : b[j] = C;
            }
      ...
      this.parse = function(_, r, f) {
        var u = t.quoteChar || '"';
        if (t.newline || (t.newline = function(j, C) {
          j = j.substring(0, 1048576);
          var U = new RegExp(F(C) + "([^]*?)" + F(C), "gm"), q = (j = j.replace(U, "")).split("\r"), le = j.split(`
...
` : "\r";
          ...
          var h = function(j, C, U, q, le) {
            var he, ce, K, J;
            le = le || [",", "	", "|", ";", d.RECORD_SEP, d.UNIT_SEP];
            for (var ve = 0; ve < le.length; ve++) {
              var z = le[ve], we = 0, fe = 0, ye = 0;
              K = void 0;
              for (var me = new te({ comments: q, delimiter: z, newline: C, preview: 10 }).parse(j), ge = 0; ge < me.data.length; ge++) if (U && ae(me.data[ge])) ye++;
              else {
    ...
    function te(t) {
      var e, o = (t = t || {}).delimiter, m = t.newline, v = t.comments, T = t.step, N = t.preview, R = t.fastMode, L = e = t.quoteChar === void 0 || t.quoteChar === null ? '"' : t.quoteChar;
...
`);
      ...
      this.parse = function(E, oe, se) {
        ...
        if (t.header && !oe) {
          ...
          for (var j in f) {
            var C = f[j];
            I(t.transformHeader) && (C = t.transformHeader(C, j));
            var U = C, q = h[C] || 0;
            for (0 < q && (b = !0, U = C + "_" + q), h[C] = q + 1; u.includes(U); ) U = U + "_" + q;
            u.push(U);
          }
          if (b) {
            var le = E.split(m);
        ...
        if (R || R !== !1 && E.indexOf(e) === -1) {
          for (var he = E.split(m), ce = 0; ce < he.length; ce++) {
            ...
            if (!v || _.substring(0, H) !== v) {
              ...
              if (N && N <= ce) return X = X.slice(0, N), de(!0);
            }
          }
          return de();
        }
        for (var K = E.indexOf(o, k), J = E.indexOf(m, k), ve = new RegExp(F(L) + F(e), "g"), z = E.indexOf(e, k); ; ) if (E[k] !== e) if (v && _.length === 0 && E.substring(k, k + H) === v) {
          if (J === -1) return de();
...
function an({
  ...
  const { address: a } = ut.all(), { t: c } = Qe(), { data: s, isFetched: l } = ht(), { data: p } = ft(), { data: g } = pt(), [x, d] = A.useState(null), [w, S] = A.useState([]), [O, V] = A.useState([]), [ee, G] = A.useState([]), [ie, F] = A.useState(!1), [te, B] = A.useState(!1), [$, Q] = A.useState({
    ...D.createTokenMap(() => "0"),
    usdValue: "0"
  ...
  const o = A.useMemo(
    ...
    const u = BigInt(x[f]), h = BigInt(Ce($[f])), b = BigInt(Ce(g[f]));
    return u + h > b;
  ...
  }), [w, O, o, v]), N = A.useMemo(() => w.some((r) => r.to || r.note || r.amount), [w]);
  A.useEffect(() => {
    I.forEach((r, f) => {
      r.to && k(r.to, f);
    });
  ...
  const R = A.useCallback(async () => {
    ...
    B(!0);
    try {
      const r = D.getAllTokens().map((b) => b.tokenType), f = {}, u = (b) => I.filter((j, C) => {
        var q;
        return j.token === b && j.amount && (Te(j.to) || ((q = t[C]) == null ? void 0 : q.fullAddress));
      }).map((j, C) => {
        var U;
        return {
          to: Te(j.to) ? j.to : (U = t[C]) == null ? void 0 : U.fullAddress,
          amount: Ce(j.amount)
        };
      });
      for (const b of r) {
      ...
      const h = D.getAllTokens().reduce((b, j) => {
        const C = f[j.tokenType], U = p == null ? void 0 : p[j.tokenType];
        return b + (C && U ? parseFloat(C) * parseFloat(U) : 0);
      }, 0);
    ...
    if (C != null && C.hash && (U != null && U.gasless)) {
      const q = await xt(C.hash, r.token);
    ...
    handleFileChange: (r) => {
      ...
      f && sn.parse(f, {
        ...
        complete: (h) => {
          ...
          const j = h.data.slice(1).filter((C) => C[0] && C[0].trim() !== "").map((C) => ({
            to: C[0],
            note: C[1],
            token: C[2],
            amount: C[3],
            balance: (s == null ? void 0 : s[C[2]]) || "0"
          }));
          S(j), V(j.map(() => ({
            isValidating: !1,
            isValidEmail: !1,
...
function Ze({
  ...
  const c = Je(a), s = (x) => {
    ...
    return d ? w = parseFloat(i[d] || "0") + parseFloat((c == null ? void 0 : c[x]) || "0") : w = parseFloat((c == null ? void 0 : c[x]) || "0"), w ? {
      amount: Ne(je(w.toString(), 18)),
      symbol: x
    } : null;
  }, l = (x) => {
    const d = x, w = parseFloat(i[d] || "0");
    return w ? {
      amount: Ne(je(w.toString())),
      symbol: d
    } : null;
  }, p = () => {
    const x = [];
...
function dn({
  ...
  return A.useEffect(() => {
    ...
    g && /* @__PURE__ */ n.jsx("p", { className: M(
...
function un({
  ...
  return /* @__PURE__ */ n.jsxs("div", { className: M(
    ...
    /* @__PURE__ */ n.jsxs("div", { children: [
      ...
      /* @__PURE__ */ n.jsx("div", { className: "", children: a.map((N, R) => /* @__PURE__ */ n.jsxs("div", { className: "border-b border-[#ebebeb]", children: [
        /* @__PURE__ */ n.jsxs(
          "div",
          {
            className: M(
    ...
    /* @__PURE__ */ n.jsxs("div", { className: "mt-[120px]", children: [
      ...
      Q ? /* @__PURE__ */ n.jsx("div", { className: "flex items-center justify-end mt-0.5", children: /* @__PURE__ */ n.jsx(He, { className: "animate-spin", size: 14 }) }) : $ ? /* @__PURE__ */ n.jsxs("p", { className: "text-black text-sm font-medium leading-none text-right mt-0.5", children: [
        (() => {
          const N = Je($);
          return Object.entries(N || {}).filter(([R, L]) => L !== "0").map(([R, L], k, W) => /* @__PURE__ */ n.jsxs("span", { children: [
            L,
            " ",
            R,
            k < W.length - 1 && " & "
        ...
        Object.values($).some((N) => N !== "0") && ` (~$${$.usdValue} USD)`
          ...
          children: [
            /* @__PURE__ */ n.jsxs("div", { className: M(
              ...
              /* @__PURE__ */ n.jsxs("div", { className: M(
                ...
                l.type === "invitation" && l.status === "sent" && /* @__PURE__ */ n.jsx(Me, { className: "text-blue-500", size: 12 }),
                l.status === "failed" && /* @__PURE__ */ n.jsx(Me, { className: "text-destructive", size: 12 })
              ] })
            ] }),
            /* @__PURE__ */ n.jsx("p", { className: M(
