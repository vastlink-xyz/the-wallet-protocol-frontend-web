...
import { l as w, h as k, a as o } from "./vendor-react-KTk2TwQ7.js";
import { k as C, i as f, T as S, B as m, L as h, n as R, l as u } from "./main-Cnoo90sq.js";
import { B } from "./vendor-utils-D1d8vwmL.js";
import { f as x } from "./vendor-web3-CjewkP9U.js";
function A() {
  const [i] = w(), p = k(), { signTransaction: g, waitForTransactionExection: I } = C(), [e, v] = o.useState(), [r, T] = o.useState("PENDING"), [c, l] = o.useState(!1), j = o.useRef();
  o.useEffect(() => {
    y();
  }, [i]), o.useEffect(() => {
    e && T(e.status);
  ...
  const y = async () => {
    ...
    if (e)
      try {
        ...
        u("result", s), s != null && s.needOtp ? a = await I(s.transactionId) : a = s == null ? void 0 : s.hash, await E(e.id, {
          status: "COMPLETED"
        }), d(e.id), u("hash is", a);
      } catch (n) {
