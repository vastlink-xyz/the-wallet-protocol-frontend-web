...
import { a as Fa, c as et, l as zl, B as Ms, u as Qs, D as Wl, b as Zl, d as Gl, e as Ro, f as is, h as Os, S as js, g as Dl, G as Fs, t as _l, i as Ls } from "./main-COWkWeS2.js";
import { j as CA, k as Rl, L as Hs, r as B, a as Ns, p as Ml, O as Us } from "./vendor-react-CuOkI7kW.js";
import { u as Ql, B as zs } from "./vendor-utils-DMWa-Mp_.js";
import { X as Ws } from "./vendor-ui-utils-2_WY-nJY.js";
import { W as Yl, V as Zs } from "./index-tDFy_7Ib.js";
import { S as Gs } from "./SendButton-CM4BBfx0.js";
import { W as _s, M as Ys } from "./MarketplaceProvider-ZmG6yuSr.js";
...
function Vs() {
  const { t: f } = Ql(), [c, g] = B.useState(!1), m = Fa.isAuthenticated(), A = Rl(), { pathname: w } = CA(), { data: P } = Qs(), [E, y] = B.useState("");
  B.useEffect(() => {
  ...
  function ve(a, u, v, x, O) {
    switch (u) {
      ...
      case "option":
        ...
        if (N != null) if (v = ie !== null ? "" + ie : ne(V), T(N)) {
...
`), I;
      ...
      case "html":
        return O.insertionMode === 0 && a.push("<!DOCTYPE html>"), te(a, v, u, x);
      default:
        if (u.indexOf("-") === -1 && typeof v.is != "string") return te(a, v, u, x);
        a.push(ce(u)), N = I = null;
  ...
  function kn(a, u, v, x, O, I, N, V, ie) {
    ...
    return u = { destination: null, responseState: u, progressiveChunkSize: x === void 0 ? 12800 : x, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: ue, pingedTasks: he, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: O === void 0 ? ct : O, onAllReady: jt, onShellReady: N === void 0 ? jt : N, onShellError: jt, onFatalError: jt }, v = rn(u, 0, null, v, !1, !1), v.parentFlushed = !0, a = nn(u, a, null, v, ue, Rt, null, yr), he.push(a), u;
  }
  ...
  function Yt(a, u, v, x, O) {
    if (typeof v == "function") if (v.prototype && v.prototype.isReactComponent) {
      ...
      switch (O = u.blockedSegment, I = ve(O.chunks, v, x, a.responseState, O.formatContext), O.lastPushedText = !1, N = O.formatContext, O.formatContext = re(N, v, x), Ht(a, u, I), O.formatContext = N, v) {
        case "area":
        case "base":
        case "br":
        case "col":
          ...
          if (ie.status === 0) {
            ...
            try {
              ...
              if ($n(), typeof st == "object" && st !== null && typeof st.then == "function") {
                ...
                var ue = N.blockedBoundary, Be = st, At = Ft(V, Be);
                if (ue === null ? on(V, Be) : (ue.pendingTasks--, ue.forceClientRender || (ue.forceClientRender = !0, ue.errorDigest = At, ue.parentFlushed && V.clientRenderedBoundaries.push(ue))), V.allPendingTasks--, V.allPendingTasks === 0) {
                  var lt = V.onAllReady;
                  lt();
                }
              }
  ...
  function it(a, u) {
    try {
      ...
      for (I = 0; I < O.length; I++) {
        var N = O[I];
        x = u;
        var V = a.responseState, ie = N.id, he = N.errorDigest, ue = N.errorMessage, Be = N.errorComponentStack;
...
function $s() {
  ...
  var ne = /([A-Z])/g, te = /^ms-/, Ae = Array.isArray, ae = C("<script>"), ce = C("<\/script>"), ve = C('<script src="'), de = C('<script type="module" src="'), Me = C('" async=""><\/script>'), Ce = /(<\/|<)(s)(cript)/gi;
  function ee(i, s, h, S) {
    return "" + s + (h === "s" ? "\\u0073" : "\\u0053") + S;
  }
    ...
    for (var S in h) if (k.call(h, S)) {
      ...
      if (j != null && typeof j != "boolean" && j !== "") {
        if (S.indexOf("--") === 0) {
          ...
          M = S;
          var z = Se.get(M);
          z !== void 0 || (z = C(Z(M.replace(ne, "-$1").toLowerCase().replace(te, "-ms-"))), Se.set(M, z)), M = z, j = typeof j == "number" ? j === 0 || k.call(X, S) ? y("" + j) : y(j + "px") : y(Z(("" + j).trim()));
        }
...
` && i.push(Rt), M;
  ...
  function zt(i) {
    var s = ue;
    s !== i && (s === null ? lt(i) : i === null ? At(s) : s.depth === i.depth ? Be(s, i) : s.depth > i.depth ? st(s, i) : ln(s, i), ue = i);
  }
  ...
  return gA.renderToReadableStream = function(i, s) {
    return new Promise(function(h, S) {
      var j, M, z = new Promise(function(ye, je) {
        M = ye, j = je;
      }), J = no(i, se(s ? s.identifierPrefix : void 0, s ? s.nonce : void 0, s ? s.bootstrapScriptContent : void 0, s ? s.bootstrapScripts : void 0, s ? s.bootstrapModules : void 0), be(s ? s.namespaceURI : void 0), s ? s.progressiveChunkSize : void 0, s ? s.onError : void 0, M, function() {
...
function qs() {
  return Kl || (Kl = 1, Ml.env.NODE_ENV !== "production" && function() {
    ...
    var G = Object.prototype.hasOwnProperty, $ = 0, Z = 1, ne = 2, te = 3, Ae = 4, ae = 5, ce = 6, ve = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", de = ve + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", Me = new RegExp("^[" + ve + "][" + de + "]*$"), Ce = {}, ee = {};
    function se(e) {
    ...
    function oe(e, t, n, o, l, d, p) {
      this.acceptsBooleans = t === ne || t === te || t === Ae, this.attributeName = o, this.attributeNamespace = l, this.mustUseProperty = n, this.propertyName = e, this.type = t, this.sanitizeURL = d, this.removeEmptyString = p;
    }
    var me = {}, Oe = [
      "children",
      ...
      for (var l in n)
        if (G.call(n, l)) {
          ...
          if (!(d == null || typeof d == "boolean" || d === "")) {
            ...
            R ? (p = Ve(l), re(d, l), D = Ve(("" + d).trim())) : (Qt(l, d), p = Nt(l), typeof d == "number" ? d !== 0 && !G.call(Zt, l) ? D = d + "px" : D = "" + d : (re(d, l), D = Ve(("" + d).trim()))), o ? (o = !1, e.push(at, p, An, D)) : e.push(pn, p, An, D);
          }
        }
      o || e.push(it);
    }
...
function eu() {
  return $l || ($l = 1, Ml.env.NODE_ENV !== "production" && function() {
    ...
    function $(r, e) {
      if (X(r))
        return A("The provided `%s` attribute is an unsupported type %s. This value must be coerced to a string before before using it here.", e, re(r)), G(r);
    }
    function Z(r, e) {
      if (X(r))
        return A("The provided `%s` CSS property is an unsupported type %s. This value must be coerced to a string before before using it here.", e, re(r)), G(r);
    }
    function ne(r) {
      if (X(r))
        return A("The provided HTML markup uses a value of unsupported type %s. This value must be coerced to a string before before using it here.", re(r)), G(r);
    }
    var te = Object.prototype.hasOwnProperty, Ae = 0, ae = 1, ce = 2, ve = 3, de = 4, Me = 5, Ce = 6, ee = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", se = ee + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", fe = new RegExp("^[" + ee + "][" + se + "]*$"), be = {}, oe = {};
    function me(r) {
      return te.call(oe, r) ? !0 : te.call(be, r) ? !1 : fe.test(r) ? (oe[r] = !0, !0) : (be[r] = !0, A("Invalid attribute name: `%s`", r), !1);
    }
    function Oe(r, e, t, n) {
      if (t !== null && t.type === Ae)
        return !1;
    ...
    {
      var We = {}, Yn = /^on./, mr = /^on[^A-Z]/, yr = new RegExp("^(aria)-[" + se + "]*$"), Xn = new RegExp("^(aria)[A-Z][" + se + "]*$");
      _n = function(r, e, t, n) {
        if (te.call(We, e) && We[e])
          return !0;
        var o = e.toLowerCase();
      ...
      for (var o in t)
        if (te.call(t, o)) {
          ...
          if (!(l == null || typeof l == "boolean" || l === "")) {
            ...
            D ? (d = F(Ze(o)), Z(l, o), p = F(Ze(("" + l).trim()))) : (Kn(o, l), d = u(o), typeof l == "number" ? l !== 0 && !te.call(xe, o) ? p = F(l + "px") : p = F("" + l) : (Z(l, o), p = F(Ze(("" + l).trim())))), n ? (n = !1, r.push(v, d, x, p)) : r.push(O, d, x, p);
          }
        }
      n || r.push(ie);
    }
...
const au = "data:image/svg+xml;base64,", iu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 0 637 637", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m478 113-13 2-4 1h4l14-2c10-2 35-2 42-1l6 3 3 1c3 0-4-3-8-5-7-1-34-1-44 1m56 6 8 6c7 5 20 17 20 19s7 12 8 12l-3-6-4-6c0-3-15-17-25-24-5-3-8-4-4-1m-198 16-9 1a512 512 0 0 1 9-1m-180 30a412 412 0 0 0-23 4 167 167 0 0 0-32 8 439 439 0 0 1 46-9 304 304 0 0 1 11-2l6-1h-8m369 8 4 3-7-6c-1 0 0 2 3 3m-439 9c-7 3-18 13-18 15l6-5c5-5 9-8 14-10l6-4-8 4m442 12-10 11-7 6 7-6c7-5 14-14 13-16l-3 5M65 205l-1 11c0 9 0 10 4 17 5 10 7 12 22 11 10 0 15 0 38-5l5-1-6 1-16 2-21 2c-13 1-16-1-21-10-3-5-4-6-4-15l1-12c1-4 1-5-1-1m335 1c3 0 3 1 3 3l-2 6c-2 5-35 39-76 80-53 51-120 117-138 137-21 24-22 25-22 27 0 3 6 9 9 9 4 0 14-8 38-27a5073 5073 0 0 1 15-16 1421 1421 0 0 0-17 15l-31 25-6 2-4-3c-3-3-3-4-2-6 3-8 79-85 160-163 57-57 79-80 79-86 0-2-3-4-7-4-2 0-2 0 1 1m165 18c-9 17-25 32-57 53l-10 8 16-11 12-8c15-10 27-22 39-39 5-7 6-8 4-8l-4 5m-221 2a199 199 0 0 0-19 10 183 183 0 0 1 27-12c0-1-1-1-8 2m-34 16c-3 3-2 3 2 0l1-2-3 2m151 3-1 2 2-2c3-3 2-3-1 0m-16 12-11 10a281 281 0 0 0 11-10m-24 18-7 5-7 5-42 31c-10 7-24 19-22 19l7-6 16-12a343 343 0 0 0 35-25 573 573 0 0 0 20-17m-187 0-2 2 4-2 3-2-5 2m-14 6-3 2 4-1 4-3-5 2m-7 3-8 4-18 8 18-7 7-3 3-1c1-2 0-2-2-1m254 24a2672 2672 0 0 1-71 54 601 601 0 0 0 39-29 1352 1352 0 0 1 32-25m-291-8-2 2 4-2 3-2-5 2m-13 5-2 2h3c5-3 4-4-1-2m-19 9-7 3-13 6c-10 5-13 7-14 10-3 4-2 5 1 0 2-3 5-5 14-9l13-6 12-6-6 2m178 36c-17 12-21 16-21 17a390 390 0 0 1 20-17m-206 34 1 4 1 3 1 5 2 8 1 5v-6l-1-8-2-5-1-4-1-2c-1-2-1-2-1 0m222 23-9 7a683 683 0 0 0-56 44 261 261 0 0 0-26 20 1345 1345 0 0 0-46 34c-6 3-7 3-19 3-11 0-12 0-18-3-8-4-10-8-17-20l-5-10 4 10c5 10 12 18 19 22 4 2 6 2 17 2 13 0 14 0 21-3l26-19 42-33a2183 2183 0 0 0 43-34 643 643 0 0 1 24-20", fill: "#fff", fillRule: "evenodd" }), /* @__PURE__ */ B.createElement("path", { d: "M478 114a620 620 0 0 1-39 6l-21 3a5481 5481 0 0 0-19 3 870 870 0 0 1-54 8l-1 1-6 1-12 2-13 2a992 992 0 0 0-76 12 400 400 0 0 1-45 8l-6 1-5 1h-3l-3 1-2 1-26 4-13 2-17 3c-23 5-33 9-43 19-7 8-9 13-9 27 0 8 1 9 4 14 5 9 8 11 21 10l21-2a1133 1133 0 0 1 23-4 659 659 0 0 0 74-14l3-1h3l3-1h3l2-1 2-1h3l2-1h2l24-5 38-7a2100 2100 0 0 1 93-18l3-1 10-1a2082 2082 0 0 1 120-17l2 1c2 0 8 5 8 7l1 2 1 6c0 4 0 6-3 10-2 4-16 16-18 16l-7 5-10 8a1070 1070 0 0 0-11 7 113 113 0 0 1-20 14l-2 2-3 2-2 2h-1a154 154 0 0 1-28 21l-5 4-5 4a573 573 0 0 1-50 37 175 175 0 0 0-24 18l-1 2-2 1-2 1-2 1-1 1-12 10a396 396 0 0 0-32 25l-8 6-6 5-9 7a326 326 0 0 1-25 20l-13 12a5073 5073 0 0 0-17 15c-24 20-34 27-39 27-2 0-8-6-8-9 0-2 1-3 22-27 18-20 85-86 138-137 41-41 74-75 76-80l2-6c0-2 0-3-2-3l-7 1a233 233 0 0 1-26 9l-1 1-1 1h-1l-1 1h-2l-3 2-1 1h-2l-3 2h-1l-5 2-22 10-9 4-4 2-5 2-10 4-2 1-2 1-2 1-13 6a334 334 0 0 1-38 17 75 75 0 0 0-14 6l-5 2-4 1-2 1-3 2-7 3-16 6a247 247 0 0 0-32 14l-1 1h-2l-1 1h-2l-1 1-12 6a103 103 0 0 0-27 15l-2 5-1 1v11l1 5 1 5 1 4c0 3 0 4 2 4v3l1 3 1 2 2 10 1 4 1 5 2 10 2 8 1 4 1 4c3 3 9 25 11 38l1 7v2l1 4v1l1 1v2l1 2 1 3v1l5 10c7 13 9 16 17 20 6 3 7 3 18 3 12 0 13 0 19-3 8-4 11-6 26-18a1345 1345 0 0 1 85-67 683 683 0 0 1 50-39l12-9a513 513 0 0 1 44-33 201 201 0 0 0 22-17 2270 2270 0 0 0 73-54 158 158 0 0 0 58-59c2 0 3-9 4-27l-1-19-1-4-1-6-1-3-4-6-4-6c0-2-6-8-13-14a77 77 0 0 0-28-18c-6-1-34-1-43 1" })), es = B.forwardRef(iu), Au = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M765-321q0 117-84 196-83 80-200 80-118 0-200-80t-83-196v-392q0-85 61-144 61-58 146-58 86 0 147 58 61 59 61 144v374q0 54-39 92-39 37-93 37-55 0-93-37-38-38-38-92v-372h110v372q0 9 6 14t15 5q8 0 15-5t7-14v-374q0-39-29-66t-68-27q-40 0-69 27t-29 66v392q0 71 51 119t122 48q71 0 122-48t51-119v-426h111v426Z" })), ts = B.forwardRef(Au), lu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M125-165v-113h77v-273q0-93 55-167 56-75 146-100v-19q0-32 22-55 23-23 55-23t55 23q22 23 22 55v19q90 25 146 99 56 73 56 168v273h77v113H125ZM480-32q-38 0-66-27-27-27-27-66h186q0 39-27 66t-66 27Z" })), su = B.forwardRef(lu), uu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M137-190v-113h78v-253q0-41 11-79 11-39 35-71l-9 150h10L17-802l74-74L873-92l-74 74-175-172H137Zm609-149L319-769q20-15 41-25t44-16v-28q0-32 22-54t54-22q32 0 55 22t22 54v28q85 23 137 94t52 160v217ZM481-47q-38 0-65-27t-27-65h184q0 38-27 65t-65 27Z" })), cu = B.forwardRef(uu), du = (f, c) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", ref: c, ...f }, /* @__PURE__ */ B.createElement("g", { strokeLinecap: "round", strokeWidth: 10 }, /* @__PURE__ */ B.createElement("path", { d: "m19 19 61 61M80 19 19 80" }))), fu = B.forwardRef(du), hu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M94-136v-255l351-93-351-92v-253l816 346L94-136Z" })), pu = B.forwardRef(hu), vu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M480-372q-61 0-105-43-43-43-43-105v-240q0-61 43-105 43-43 105-43 61 0 105 43 43 44 43 105v240q0 62-43 105t-105 43ZM425-76v-122q-121-16-197-108t-76-214h109q0 91 64 154t155 63q91 0 155-63t64-154h109q0 122-77 214T534-198v122H425Z" })), gu = B.forwardRef(vu), mu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m763-343-80-79q8-20 13-44 5-23 5-54h109q0 49-11 95t-36 82ZM625-482 336-770v-2q3-56 45-96t101-40q62 0 105 43t43 105v249l-1 17q-1 7-4 12ZM427-76v-122q-120-16-196-108-77-92-77-214h109q0 91 64 154t155 63q43 0 80-14 37-15 67-41l78 79q-35 32-78 53t-93 28v122H427Zm362 27L41-796l75-75 748 748-75 74Z" })), yu = B.forwardRef(mu), wu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M625-511q29 0 50-21t20-50q0-29-20-50-21-20-50-20t-50 20-20 50q0 29 20 50 21 21 50 21Zm-290 0q29 0 50-21t20-49q0-30-20-50t-50-21q-29 0-50 20-20 21-20 50 0 30 20 50 21 21 50 21Zm145 268q75 0 137-43t85-115H258q24 72 85 115 62 43 137 43Zm0 198q-90 0-170-34-79-34-138-93T79-310q-34-80-34-170t34-170q34-79 93-138t138-93q80-34 170-34t170 34q79 34 138 93t93 138q34 80 34 170t-34 170q-34 79-93 138T650-79q-80 34-170 34Zm0-435Zm0 322q134 0 228-94t94-228q0-134-94-228t-228-94q-134 0-228 94t-94 228q0 134 94 228t228 94Z" })), ns = B.forwardRef(wu), bu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M553-64v-108q107-27 173-113 67-87 67-197 0-109-67-195T553-789v-108q152 26 249 144 97 117 97 271 0 155-97 273T553-64ZM61-335v-290h176l236-237v764L237-335H61Zm492 28v-346q51 23 82 70t31 103-31 103q-31 47-82 70Z" })), Su = B.forwardRef(bu), xu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M807-15 700-123q-33 21-71 37-38 15-80 22v-108q20-4 38-12l35-17-153-154v257L234-335H57v-290h144L10-818l74-75L882-90l-75 75Zm37-264-80-79q13-30 19-60 7-31 7-64 0-109-68-195-67-86-173-112v-108q152 26 249 144 98 117 98 271 0 55-14 107-13 51-38 96ZM661-462 549-575v-78q51 23 83 70 31 47 31 103l-1 9-1 9ZM469-655 366-759l103-103v207Z" })), Eu = B.forwardRef(xu), Cu = "data:audio/wav;base64,", As = {
...
}, ls = B.createContext({ settings: {}, setSettings: () => null }), De = () => B.useContext(ls), Du = ({
  children: f,
  settings: c = As,
  setSettings: g
...
}, us = B.createContext({ styles: {}, setStyles: () => null }), Ye = () => B.useContext(us), Pu = ({
  children: f,
  styles: c = ss,
  setStyles: g
}) => /* @__PURE__ */ b.jsx(us.Provider, { value: { styles: c, setStyles: g }, children: f }), Bu = ({ buttons: f }) => {
  var c, g, m, A, w;
...
}, cs = B.createContext({}), bt = () => B.useContext(cs), ku = ({
  children: f,
  botIdRef: c,
  flowRef: g
}) => {
...
}, ds = B.createContext({}), gt = () => B.useContext(ds), Tu = ({
  children: f,
  settings: c
}) => {
  var g, m, A, w, P, E;
  ...
  ), [K, re] = B.useState(!1), [X, G] = B.useState(!1), [$, Z] = B.useState(!0), [ne, te] = B.useState(!1), [Ae, ae] = B.useState(!1), [ce, ve] = B.useState(!1), [de, Me] = B.useState(0), [Ce, ee] = B.useState(0), [se, fe] = B.useState(!1), [be, oe] = B.useState(null), [me, Oe] = B.useState(((P = window.visualViewport) == null ? void 0 : P.height) ?? window.innerHeight), [Se, le] = B.useState(((E = window.visualViewport) == null ? void 0 : E.width) ?? window.innerWidth);
  ...
  function L(F) {
    if (!y.current)
      return;
    const T = y.current.scrollTop, K = y.current.scrollHeight - y.current.clientHeight - T, re = 20;
    let X = 0;
    function G() {
      if (!y.current)
        return;
  ...
  const _ = (F, T, K, re) => (F /= re / 2, F < 1 ? K / 2 * F * F + T : (F--, -K / 2 * (F * (F - 2) - 1) + T));
...
}, fs = B.createContext({ paths: [], setPaths: () => null }), Ol = () => B.useContext(fs), Mu = ({ children: f }) => {
...
}, hs = B.createContext({ toasts: [], setToasts: () => null }), ps = () => B.useContext(hs), Ou = ({ children: f }) => {
  const [c, g] = B.useState([]);
...
}, vs = B.createContext({ messages: [], setMessages: () => null }), jl = () => B.useContext(vs), Fu = ({ children: f }) => {
  const [c, g] = B.useState([]);
  ...
  const { settings: U } = De(), { styles: L } = Ye(), { messages: _ } = jl(), { toasts: F } = ps(), { isChatWindowOpen: T } = vr(), {
    isBotTyping: K,
    isScrolling: re,
    setIsScrolling: X,
    setUnreadCount: G
    ...
    ...L.userBubbleStyle
  }, te = (A = U.userBubble) != null && A.animate ? "rcb-user-message-entry" : "", Ae = {
  ...
  const { settings: L } = De(), { styles: _ } = Ye(), { paths: F } = Ol(), { handleSubmitText: T } = Ha(), [K, re] = B.useState(/* @__PURE__ */ new Set()), [X, G] = B.useState(!1), $ = {
    ...
    return /* @__PURE__ */ b.jsx(
      "div",
      {
        ...
        onMouseDown: (Z) => {
          ...
          _(!f.reusable);
          let te;
          f.sendOutput != null ? te = f.sendOutput : te = ((ne = y.chatInput) == null ? void 0 : ne.sendOptionOutput) ?? !0, k(X, te);
        },
        children: X
      },
      X
...
let ys = !1, Il = "rcb-history", yA = 30, ws = !1, EA = [];
const wA = async (f) => {
  if (ws)
    return;
  ...
  var c, g, m;
  Il = (c = f.chatHistory) == null ? void 0 : c.storageKey, yA = (g = f.chatHistory) == null ? void 0 : g.maxEntries, ws = (m = f.chatHistory) == null ? void 0 : m.disabled, EA = nc(localStorage.getItem(Il));
      ...
      return A.textContent;
    {
      ...
      let y = Array.from(A.attributes).reduce((H, k) => {
        ...
        if (Q === "style") {
          ...
          U.forEach((_) => {
            const [F, T] = _.split(":").map((re) => re.trim()), K = F.replace(/-([a-z])/g, (re, X) => X.toUpperCase());
            L[K] = T;
          }), H[Q] = L;
        } else
  ...
  const { settings: f } = De(), {
    ...
    if (_ != null && _.startsWith("data:audio")) {
      const K = atob(_.split(",")[1]), re = new ArrayBuffer(K.length), X = new Uint8Array(re);
  ...
  const { settings: A } = De(), { messages: w, setMessages: P } = jl(), {
    ...
    setIsBotTyping: H,
    setUnreadCount: k
  } = gt(), { streamMessageMap: Q, chatBodyRef: U } = bt(), { callRcbEvent: L } = Wn(), { playNotificationSound: _ } = Fl(), F = B.useCallback(async (Z, ne, te) => {
    H(!1), P((ve) => {
      const de = [...ve, Z];
      return $(de), de;
  ...
  }, [w, Q]), T = B.useCallback(async (Z, ne = "bot") => {
    var te, Ae, ae, ce, ve, de, Me, Ce;
    let ee = Oo(Z, ne);
    ...
    let se = !1;
    ne === "bot" ? se = (Ae = A.botBubble) == null ? void 0 : Ae.dangerouslySetInnerHtml : ne === "user" && (se = (ae = A.userBubble) == null ? void 0 : ae.dangerouslySetInnerHtml), qu(A, E, y, ee, se);
    ...
    var ne;
    const te = w.find((Ae) => Ae.id === Z);
    return !te || (ne = A.event) != null && ne.rcbRemoveMessage && L(Ee.REMOVE_MESSAGE, { message: te }).defaultPrevented ? null : (P((Ae) => {
      const ae = Ae.filter((ce) => ce.id !== Z);
      return $(ae), ae;
    }), k((Ae) => Math.max(Ae - 1, 0)), Z);
  }, [L, w, (f = A.event) == null ? void 0 : f.rcbRemoveMessage]), re = B.useCallback(async (Z, ne = "bot") => {
    var te, Ae;
    if (!Q.current.has(ne)) {
      const ce = Oo(Z, ne);
      return (te = A.event) != null && te.rcbStartStreamMessage && L(Ee.START_STREAM_MESSAGE, { message: ce }).defaultPrevented ? null : (H(!1), P((ve) => {
        const de = [...ve, ce];
        return $(de), [...ve, ce];
      }), k((ve) => ve + 1), Q.current.set(ne, ce.id), ce.id);
    }
    const ae = { ...Oo(Z, ne), id: Q.current.get(ne) };
    return (Ae = A.event) != null && Ae.rcbChunkStreamMessage && L(
      Ee.CHUNK_STREAM_MESSAGE,
      { ...ae, id: Q.current.get(ne) }
    ).defaultPrevented ? null : (P((ce) => {
      const ve = [...ce];
      for (let de = ve.length - 1; de >= 0; de--)
        if (ve[de].sender === ne && typeof ve[de].content == typeof Z) {
          ve[de] = ae;
          break;
        }
      return $(ve), ve;
    }), Q.current.get(ne) ?? null);
    ...
    if (!Q.current.has(Z))
      return !0;
    const te = Q.current.get(Z), Ae = w.find((ae) => ae.id === te);
    return (ne = A.event) != null && ne.rcbStopStreamMessage && L(Ee.STOP_STREAM_MESSAGE, { messageToEndStreamFor: Ae }).defaultPrevented ? !1 : (Q.current.delete(Z), wA(w), !0);
    ...
    wA(Z);
    let Ae = !0;
    (Z.length === 0 || y && !C) && (Ae = !1), (ne = A.general) != null && ne.embedded && Ss(U.current) && (Ae = !1);
    const ae = Z[Z.length - 1];
    (!ae || ae.sender === "user") && (Ae = !1), Ae && _(), ((te = A.chatWindow) != null && te.autoJumpToBottom || !C) && setTimeout(() => {
...
const Ll = () => {
  ...
  const { settings: f } = De(), {
    ...
    if (E.current && C.current !== null) {
      const re = (F = f.chatInput) == null ? void 0 : F.characterLimit, X = (T = f.chatInput) != null && T.allowNewline ? _ : _.replace(/\n/g, " ");
      if (re != null && re >= 0 && X.length > re ? E.current.value = X.slice(0, re) : E.current.value = X, (K = f.event) != null && K.rcbTextAreaChangeValue && H(
    ...
    (F = E.current) != null && F.disabled || setTimeout(() => {
      var T, K, re;
      (T = f.general) != null && T.embedded ? Ss(y == null ? void 0 : y.current) && ((K = E.current) == null || K.focus()) : _ !== "start" && ((re = E.current) == null || re.focus());
    }, 100);
  }, []), U = B.useCallback(() => {
  ...
  const { settings: A } = De(), { endStreamMessage: w, injectMessage: P, removeMessage: E, streamMessage: y } = BA(), { getCurrPath: C, getPrevPath: H, goToPath: k } = DA(), {
    ...
    setInputLength: re
  } = gt(), { flowRef: X, chatBodyRef: G, inputRef: $, keepVoiceOnRef: Z, paramsInputRef: ne } = bt(), { showToast: te, dismissToast: Ae } = PA(), { callRcbEvent: ae } = Wn(), { syncVoice: ce } = Nl(), { setTextAreaValue: ve } = La(), { openChat: de } = vr(), Me = B.useCallback(async (ee) => {
    var se, fe, be;
    const oe = C();
    if (!(!oe || !X.current[oe])) {
      if (_) {
  ...
  }, [X, C, A, P, _]), Ce = B.useCallback(async (ee, se, fe = !0) => {
    var be, oe;
    se = se.trim(), se !== "" && (fe && await Me(se), Q && clearTimeout(Q), ne.current = se, G.current && (G.current.scrollTop = G.current.scrollHeight), $.current && (ve(""), re(0)), (be = A.chatInput) != null && be.blockSpam && F(!0), Z.current = U, ce(!1), setTimeout(() => {
      T(!0);
      ...
      if (!await ms(X.current, ee, Oe, k)) {
        ...
        if (!le)
          return;
        le.chatDisabled || F((me = A.chatInput) == null ? void 0 : me.disabled), gs(le, L, Oe), K(typeof le.file == "function"), ce(Z.current), T(!1);
      }
  ...
  return { handleSubmitText: B.useCallback(async (ee, se = !0) => {
    var fe, be;
  ...
  const Q = kA(), { settings: U } = De(), { styles: L } = Ye(), {
    ...
    setInputLength: X
  } = gt(), { inputRef: G } = bt(), [$, Z] = B.useState(!1), [ne, te] = B.useState(!1), { handleSubmitText: Ae } = Ha(), { setTextAreaValue: ae } = La(), ce = {
  ...
  return /* @__PURE__ */ b.jsxs(
    "div",
    {
      ...
      onMouseDown: (Se) => {
        var le;
        Se.stopPropagation(), !K && ((le = U.general) == null ? void 0 : le.flowStartTrigger) === "ON_CHATBOT_INTERACT" && re(!0);
      },
      ...
      children: [
        ...
        /* @__PURE__ */ b.jsxs("div", { className: "rcb-chat-input-button-container", children: [
          f == null ? void 0 : f.map(
            (Se, le) => /* @__PURE__ */ b.jsx(B.Fragment, { children: Se }, le)
          ),
  ...
  B.useEffect(() => {
    ...
    if (X === "ALWAYS")
      if (A) {
        let G;
        E ? G = (((K = P.chatWindowStyle) == null ? void 0 : K.width) ?? 375) - (((re = P.chatButtonStyle) == null ? void 0 : re.width) ?? 75) : G = 0, L(G), H(!0);
      } else
        H(!E);
    else
  ...
  var f, c, g, m, A, w;
  const { settings: P } = De(), { styles: E } = Ye(), { injectMessage: y, streamMessage: C, removeMessage: H, endStreamMessage: k } = BA(), { getCurrPath: Q, getPrevPath: U, goToPath: L, blockAllowsAttachment: _ } = DA(), { flowRef: F, inputRef: T } = bt(), K = F.current, { showToast: re, dismissToast: X } = PA(), { callRcbEvent: G } = Wn(), { openChat: $ } = vr(), { setTextAreaValue: Z } = La(), { handleSubmitText: ne } = Ha(), te = {
    ...
    if (me != null) {
      ...
      await ne("📄 " + Oe.join(", "), (ee = P.fileAttachment) == null ? void 0 : ee.sendFileName), await me({
  ...
  return /* @__PURE__ */ b.jsxs(
    "label",
    {
      ...
      style: _ ? E.fileAttachmentButtonStyle : te,
      children: [
        /* @__PURE__ */ b.jsx(
          "input",
          {
  ...
  B.useEffect(() => {
    const G = (ne) => {
      const te = ne.composedPath();
      k.current && !te.includes(k.current) && Q.current && !te.includes(Q.current) && L(!1);
    }, $ = () => {
      if (k.current && Q.current) {
        const ne = Q.current.getBoundingClientRect(), te = k.current.offsetHeight, Ae = ne.top - te - 8;
        k.current.style.left = `${ne.left}px`, k.current.style.top = `${Ae}px`;
      }
    }, Z = () => {
      $();
    };
  ...
  B.useEffect(() => {
    var G;
    (G = m.voice) != null && G.sendAsAudio ? (re(), U.current = []) : Q();
  }, [L]), B.useEffect(() => {
    E ? fc(
      m,
      y,
  ...
  const { settings: y } = De(), { styles: C } = Ye(), { textAreaDisabled: H } = gt(), [k, Q] = B.useState(!1), { handleSubmitText: U } = Ha(), L = {
    ...
    var Z;
    const ne = (Z = y.chatInput) == null ? void 0 : Z.sendButtonIcon;
    return !ne || typeof ne == "string" ? /* @__PURE__ */ b.jsx(
      "span",
      {
    ...
    ) : ne && /* @__PURE__ */ b.jsx("span", { className: "rcb-send-icon", "data-testid": "rcb-send-icon", children: /* @__PURE__ */ b.jsx(
      ne,
      {
        style: H ? K : k ? re : T
      }
  ...
  }), []), { header: g, chatInput: m, footer: A } = B.useMemo(() => Ic(f, c), [f, c]), w = B.useMemo(() => g, [g]), P = B.useMemo(() => m, [m]), E = B.useMemo(() => A, [A]);
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { showChatHistory: w } = Cs(), [P, E] = B.useState(!1), y = {
    color: (f = m.general) == null ? void 0 : f.primaryColor,
    borderColor: (c = m.general) == null ? void 0 : c.primaryColor,
  ...
  const A = kA(), { settings: w } = De(), {
    ...
    setIsChatWindowOpen: $,
    setTextAreaDisabled: Z,
    setAudioToggledOn: ne,
    setVoiceToggledOn: te,
    setIsBotTyping: Ae,
    setTextAreaSensitiveMode: ae,
    setBlockAllowsAttachment: ce,
    setTimeoutId: ve
  } = gt(), { chatBodyRef: de, flowRef: Me, streamMessageMap: Ce, paramsInputRef: ee, keepVoiceOnRef: se } = bt(), fe = Me.current, { viewportHeight: be, setViewportHeight: oe, setViewportWidth: me, openChat: Oe } = vr(), { setUpNotifications: Se } = Fl(), { handleFirstInteraction: le } = Uc(), { showChatHistory: Le } = Cs(), { updateTextAreaFocus: Zt, setTextAreaValue: Gt } = La(), { syncVoice: tt } = Nl(), mt = B.useRef(0);
  B.useEffect(() => (window.addEventListener("click", le), window.addEventListener("keydown", le), window.addEventListener("touchstart", le), () => {
    window.removeEventListener("click", le), window.removeEventListener("keydown", le), window.removeEventListener("touchstart", le);
  }), []), B.useEffect(() => {
    var xe, Ue, Pe;
    Se(), Z((xe = w.chatInput) == null ? void 0 : xe.disabled), $((Ue = w.chatWindow) == null ? void 0 : Ue.defaultOpen), ne((Pe = w.audio) == null ? void 0 : Pe.defaultToggledOn), setTimeout(() => {
      var Ie;
      te((Ie = w.voice) == null ? void 0 : Ie.defaultToggledOn);
    }, 1);
  }, []), B.useEffect(() => {
    ...
    if (A)
      return;
    re && (oe((xe = window.visualViewport) == null ? void 0 : xe.height), me((Ue = window.visualViewport) == null ? void 0 : Ue.width));
    ...
    (async (Ie, Ke, nt) => {
      ...
      await Vu(
        ...
        L,
        ve
      ), Ae(!1), "chatDisabled" in Ke || Z((ze = w.chatInput) == null ? void 0 : ze.disabled), ce(typeof Ke.file == "function"), Zt(Ie), tt(se.current && !Ke.chatDisabled), Ce.current.clear(), wA(H);
    })(xe, Ue, Pe);
  }, [_]), B.useEffect(() => {
    var xe;
  ...
  const w = kA(), { settings: P } = De(), { styles: E } = Ye(), { hasFlowStarted: y, setHasFlowStarted: C } = gt(), { inputRef: H } = bt(), {
    ...
    viewportWidth: U,
    isChatWindowOpen: L
  } = vr(), { headerButtons: _, chatInputButtons: F, footerButtons: T } = Hc();
  zc();
  const K = B.useMemo(() => {
    var X;
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: (() => {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ b.jsxs("div", { style: re(), className: "rcb-chat-window", children: [
...
}, Zc = Ul.DEFAULT_URL, Gc = Ul.DEFAULT_EXPIRATION, Ds = Ul.CACHE_KEY_PREFIX, _c = (f, c, g) => {
  ...
  let F = {};
  _.ok ? F = await _.json() : console.info(`Could not fetch styles.json from ${H}`), Yc(g, P, L, F, k);
  const T = os(f, k);
...
`), Ps = () => Bs(As), Vc = () => Bs(ss), Jc = async (f, c, g, m) => {
  var A, w;
  let P = Ps(), E = Vc(), y = "";
  if (m != null)
    if (Array.isArray(m))
  ...
  return c;
}, ks = B.createContext(void 0), Ts = () => B.useContext(ks), Kc = ({
  children: f
}) => {
  var c;
  ...
  const y = B.useMemo(() => f, []), C = Ts(), { flowRef: H } = bt();
  ...
  const P = B.useMemo(() => f || "rcb-" + SA(), []), E = !c || Object.keys(c).length === 0 ? qc : c, y = g || {}, C = m || {}, H = w || [], [k, Q] = B.useState(!1), U = Ts(), L = B.useRef(null), [_, F] = B.useState(A || []);
  B.useEffect(() => {
    A && F(A);
  }, [A]);
...
function nd() {
  ...
  const L = async (K) => {
    const { address: re } = Fa.all();
    c(re);
    let G = await _l.getToken(K).getBalance(re);
    G = Ls(G), m(G);
  }, _ = async (K) => {
    Dl("handleQuestion params", K);
    const re = await is.post("/ai/chat", {
    ...
    if (!X)
      ...
      let ne = G;
      if (typeof G == "string") {
        const te = Object.values(Fs).find(
          (Ae) => Ae.toUpperCase() === G
        );
        te && (ne = _l.getNativeTokenTypeByGasSymbol(te));
      }
      U({
        action: X,
        toEmail: Z,
    ...
    transfer: {
      ...
      component: (K) => {
        if (Q.action === "transfer")
          return Dl(P, f, g, Q.token, Q.toEmail, Q.amount), /* @__PURE__ */ b.jsx("div", { className: "pl-4 pt-2", children: P && f && g && Q.token && Q.toEmail && Q.amount && /* @__PURE__ */ b.jsx(Gs, { onClick: () => w(!0) }) });
      },
      // chatDisabled: true,
      path: "transfer"
    }
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: H && /* @__PURE__ */ b.jsx(B.Suspense, { fallback: null, children: /* @__PURE__ */ b.jsxs("div", { children: [
    /* @__PURE__ */ b.jsx(td.Provider, { value: { settings: y, setSettings: C }, children: /* @__PURE__ */ b.jsx(ed, { settings: y, flow: F, styles: T }) }),
    /* @__PURE__ */ b.jsx(
      js,
      {
        open: A,
...
function vd() {
  ...
  return /* @__PURE__ */ b.jsx("section", { className: "bg-background w-full flex flex-col min-h-screen", children: /* @__PURE__ */ b.jsxs(_s, { children: [
    ...
    /* @__PURE__ */ b.jsx("div", { className: "flex-grow min-h-custom-main", children: /* @__PURE__ */ b.jsx(Ys, { children: /* @__PURE__ */ b.jsx(Us, {}) }) }),
    !f && /* @__PURE__ */ b.jsx(nd, {}),
    /* @__PURE__ */ b.jsx(Zs, {}),
    /* @__PURE__ */ b.jsx(Ad, {})
  ] }) });
