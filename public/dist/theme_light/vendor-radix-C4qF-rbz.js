import { r as uo, p as fo, a as c, b as Zt, e as ze, $ as Ca, c as Ea } from "./vendor-react-KTk2TwQ7.js";
var Ln = { exports: {} }, ht = {};
/**
 * @license React
...
` + B[re].replace(" at new ", " at ");
    ...
    function Mr(p) {
      if (ra(p))
        return y("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", na(p)), Ar(p);
    }
    var mt = b.ReactCurrentOwner, oa = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    var ua = function(p, E, T, j, ee, te, K) {
      var B = {
    ...
    function fa(p, E, T, j, ee) {
      {
        var te, K = {}, B = null, ce = null;
        T !== void 0 && (Mr(T), B = "" + T), sa(E) && (Mr(E.key), B = "" + E.key), ia(E) && (ce = E.ref, aa(E, ee));
        for (te in E)
          Ee.call(E, te) && !oa.hasOwnProperty(te) && (K[te] = E[te]);
        if (p && p.defaultProps) {
        ...
        if (B || ce) {
          ...
          B && ca(K, oe), ce && la(K, oe);
        }
        return ua(p, B, ce, ee, j, mt.current, K);
      }
    }
    ...
    function $r(p, E, T, j, ee, te) {
      {
        ...
        if (Ee.call(E, "key")) {
          var Ye = k(p), de = Object.keys(E).filter(function(ba) {
            return ba !== "key";
          }), Pn = de.length > 0 ? "{key: someKey, " + de.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!Fr[Ye + Pn]) {
            var xa = de.length > 0 ? "{" + de.join(": ..., ") + ": ...}" : "{}";
            y(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Pn, Ye, xa, Ye), Fr[Ye + Pn] = !0;
          }
        }
        return p === r ? ma(oe) : va(oe), oe;
      }
    }
    function ha(p, E, T) {
      return $r(p, E, T, !0);
    ...
    var wa = ga, ya = ha;
    gt.Fragment = r, gt.jsx = wa, gt.jsxs = ya;
  }()), gt;
}
fo.env.NODE_ENV === "production" ? Ln.exports = Sa() : Ln.exports = Ra();
var h = Ln.exports;
...
function Le({
  ...
  const [r, o] = Aa({ defaultProp: t, onChange: n }), i = e !== void 0, s = i ? e : r, a = xe(n), l = c.useCallback(
    (u) => {
      if (i) {
...
var Fe = c.forwardRef((e, t) => {
  const { children: n, ...r } = e, o = c.Children.toArray(n), i = o.find(Ma);
  if (i) {
...
var La = "DismissableLayer", $n = "dismissableLayer.update", Fa = "dismissableLayer.pointerDownOutside", $a = "dismissableLayer.focusOutside", Vr, mo = c.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...l
    } = e, u = c.useContext(mo), [f, d] = c.useState(null), m = (f == null ? void 0 : f.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, g] = c.useState({}), w = q(t, (P) => d(P)), v = Array.from(u.layers), [x] = [...u.layersWithOutsidePointerEventsDisabled].slice(-1), b = v.indexOf(x), y = f ? v.indexOf(f) : -1, C = u.layersWithOutsidePointerEventsDisabled.size > 0, S = y >= b, R = Va((P) => {
...
ft.displayName = La;
var Wa = "DismissableLayerBranch", Ba = c.forwardRef((e, t) => {
...
function Ha(e, t = globalThis == null ? void 0 : globalThis.document) {
  ...
  return c.useEffect(() => {
    const o = (i) => {
      i.target && !r.current && ho($a, n, { originalEvent: i }, {
        discrete: !1
      });
    };
...
var _n = "focusScope.autoFocusOnMount", An = "focusScope.autoFocusOnUnmount", Kr = { bubbles: !1, cancelable: !0 }, Ua = "FocusScope", St = c.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  c.useEffect(() => {
    ...
    if (a) {
      ...
      if (!a.contains(v)) {
        ...
        a.addEventListener(_n, u), a.dispatchEvent(b), b.defaultPrevented || (Ka(qa(go(a)), { select: !0 }), document.activeElement === v && ke(a));
      }
      return () => {
  ...
  const w = c.useCallback(
    (v) => {
      ...
      if (x && b) {
        const y = v.currentTarget, [C, S] = Ga(y);
...
function we(e) {
  const [t, n] = c.useState(Za());
  return le(() => {
    e || n((r) => r ?? String(Ja++));
  }, [e]), e || (t ? `radix-${t}` : "");
}
const Qa = ["top", "right", "bottom", "left"], $e = Math.min, pe = Math.max, Ht = Math.round, Nt = Math.floor, We = (e) => ({
  x: e,
  y: e
}), ec = {
  left: "right",
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = i.arrow) != null && n.alignmentOffset)
        return {};
      const b = Ne(o), y = Be(a), C = Ne(a) === a, S = await (l.isRTL == null ? void 0 : l.isRTL(u.floating)), R = m || (C || !v ? [Ut(a)] : rc(a)), O = w !== "none";
      !m && O && R.push(...ic(a, v, w, S));
...
function xo(e) {
  const t = Ve(e);
  return ct(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Me(t) && Rt(t) ? t : xo(t);
}
function bt(e, t, n) {
  var r;
...
const wc = /* @__PURE__ */ We(0);
function Co(e) {
  const t = ve(e);
  return !sr() || !t.visualViewport ? wc : {
...
function Eo(e, t) {
  const n = Ve(e);
  return n === t || !Re(n) || ct(n) ? !1 : Pe(n).position === "fixed" || Eo(n, t);
}
function Rc(e, t) {
  const n = t.get(e);
  if (n)
  ...
  for (; Re(s) && !ct(s); ) {
    const a = Pe(s), l = ir(s);
    !l && a.position === "fixed" && (o = null), (i ? !l && !o : !l && a.position === "static" && !!o && ["absolute", "fixed"].includes(o.position) || Rt(s) && !l && Eo(e, s)) ? r = r.filter((f) => f !== s) : o = a, s = Ve(s);
  }
  return t.set(e, r), r;
}
function Pc(e) {
...
function So(e, t) {
  ...
  for (; r && hc(r) && Mn(r); )
    r = eo(r, t);
  return r && ct(r) && Mn(r) && !ir(r) ? n : r || gc(e) || n;
}
...
const Nc = dc, jc = pc, kc = lc, Lc = mc, Fc = uc, to = cc, $c = vc, Wc = (e, t, n) => {
...
function Bc(e) {
  ...
  const [w, v] = c.useState(null), [x, b] = c.useState(null), y = c.useCallback((D) => {
    ...
    G.current && (D.platform = G.current), Wc(O.current, P.current, D).then((A) => {
      const Z = {
        ...A,
...
var qc = "Arrow", Po = c.forwardRef((e, t) => {
...
var cr = "Popper", [To, He] = er(cr), [Qc, _o] = To(cr), Ao = (e) => {
  const { __scopePopper: t, children: n } = e, [r, o] = c.useState(null);
  return /* @__PURE__ */ h.jsx(Qc, { scope: t, anchor: r, onAnchorChange: o, children: n });
};
Ao.displayName = cr;
...
Oo.displayName = Mo;
var lr = "PopperContent", [el, tl] = To(lr), Io = c.forwardRef(
  (e, t) => {
    var I, Y, J, U, Q, X;
    const {
      __scopePopper: n,
      ...
      onPlaced: w,
      ...v
    } = e, x = _o(lr, n), [b, y] = c.useState(null), C = q(t, (ae) => y(ae)), [S, R] = c.useState(null), O = Jc(S), P = (O == null ? void 0 : O.width) ?? 0, M = (O == null ? void 0 : O.height) ?? 0, $ = r + (i !== "center" ? "-" + i : ""), W = typeof f == "number" ? f : { top: 0, right: 0, bottom: 0, left: 0, ...f }, G = Array.isArray(u) ? u : [u], V = G.length > 0, k = {
      padding: W,
      boundary: G.filter(rl),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: V
    }, { refs: L, floatingStyles: z, placement: N, isPositioned: H, middlewareData: D } = Bc({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: $,
      whileElementsMounted: (...ae) => Dc(...ae, {
      ...
      middleware: [
        Hc({ mainAxis: o + M, alignmentAxis: s }),
        l && Uc({
          mainAxis: !0,
          crossAxis: !1,
          limiter: d === "partial" ? Kc() : void 0,
          ...k
        }),
        l && Gc({ ...k }),
        Yc({
        ...
        S && Xc({ element: S, padding: a }),
        ol({ arrowWidth: P, arrowHeight: M }),
        m && zc({ strategy: "referenceHidden", ...k })
      ]
    }), [A, Z] = jo(N), ne = xe(w);
    le(() => {
      H && (ne == null || ne());
...
Io.displayName = lr;
var Do = "PopperArrow", nl = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, No = c.forwardRef(function(t, n) {
  const { __scopePopper: r, ...o } = t, i = tl(Do, r), s = nl[i.placedSide];
  return (
...
var on = Ao, Pt = Oo, sn = Io, an = No, il = "Portal", Tt = c.forwardRef((e, t) => {
  var a;
  const { container: n, ...r } = e, [o, i] = c.useState(!1);
  le(() => i(!0), []);
  const s = n || o && ((a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : a.body);
  return s ? Ea.createPortal(/* @__PURE__ */ h.jsx(F.div, { ...r, ref: t }), s) : null;
});
Tt.displayName = il;
function sl(e, t) {
...
var be = (e) => {
  const { present: t, children: n } = e, r = al(t), o = typeof n == "function" ? n({ present: r.isPresent }) : c.Children.only(n), i = q(r.ref, cl(o));
  return typeof n == "function" || r.isPresent ? c.cloneElement(o, { ref: i }) : null;
};
be.displayName = "Presence";
function al(e) {
  const [t, n] = c.useState(), r = c.useRef({}), o = c.useRef(e), i = c.useRef("none"), s = e ? "mounted" : "unmounted", [a, l] = sl(s, {
    mounted: {
      UNMOUNT: "unmounted",
...
var In = "rovingFocusGroup.onEntryFocus", ll = { bubbles: !1, cancelable: !0 }, cn = "RovingFocusGroup", [Un, ko, ul] = tr(cn), [fl, ln] = er(
  cn,
  [ul]
), [dl, pl] = fl(cn), Lo = c.forwardRef(
  (e, t) => /* @__PURE__ */ h.jsx(Un.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ h.jsx(Un.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ h.jsx(vl, { ...e, ref: t }) }) })
);
Lo.displayName = cn;
var vl = c.forwardRef((e, t) => {
  const {
    ...
    defaultProp: a,
    onChange: l
  }), [b, y] = c.useState(!1), C = xe(u), S = ko(n), R = c.useRef(!1), [O, P] = c.useState(0);
  return c.useEffect(() => {
    const M = m.current;
    if (M)
  ...
  (e, t) => {
    const {
      ...
      tabStopId: i,
      ...s
    } = e, a = we(), l = i || a, u = pl(Fo, n), f = u.currentTabStopId === l, d = ko(n), { onFocusableItemAdd: m, onFocusableItemRemove: g } = u;
    return c.useEffect(() => {
      if (r)
        return m(), () => g();
        ...
        children: /* @__PURE__ */ h.jsx(
          F.span,
          {
            ...
            onKeyDown: _(e.onKeyDown, (w) => {
              ...
              const v = gl(w, u.orientation, u.dir);
              if (v !== void 0) {
...
var Bo = Lo, Vo = $o, yl = function(e) {
  ...
  var o = xl(t, Array.isArray(e) ? e : [e]);
  ...
  var r = Array.from(Array.isArray(e) ? e : [e]), o = yl(e);
  return o ? (r.push.apply(r, Array.from(o.querySelectorAll("[aria-live]"))), bl(r, o, n, "aria-hidden")) : function() {
    return null;
  };
}, Ae = function() {
...
var Bt = "right-scroll-bar-position", Vt = "width-before-scroll-bar", El = "with-scroll-bars-hidden", Sl = "--removed-body-scroll-bar-size";
function Nn(e, t) {
...
var Pl = typeof window < "u" ? c.useLayoutEffect : c.useEffect, ro = /* @__PURE__ */ new WeakMap();
function Tl(e, t) {
...
}, Bl = Yo(), at = "data-scroll-locked", Vl = function(e, t, n, r) {
...
`);
  ...
  return c.createElement(Bl, { styles: Vl(i, !t, o, n ? "" : "!important") });
}, Kn = !1;
if (typeof window < "u")
  try {
...
var ot = Kn ? { passive: !1 } : !1, Kl = function(e) {
  ...
  return e === "v" ? zl(t) : Xl(t);
}, ql = function(e, t) {
  return e === "h" && t === "rtl" ? -1 : 1;
}, Zl = function(e, t, n, r, o) {
  var i = ql(e, window.getComputedStyle(t).direction), s = i * r, a = n.target, l = t.contains(a), u = !1, f = s > 0, d = 0, m = 0;
  do {
...
function tu(e) {
  var t = c.useRef([]), n = c.useRef([0, 0]), r = c.useRef(), o = c.useState(eu++)[0], i = c.useState(Yo)[0], s = c.useRef(e);
  c.useEffect(function() {
    s.current = e;
  }, [e]), c.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var v = Cl([e.lockRef.current], (e.shards || []).map(ao), !0).filter(Boolean);
  ...
  var a = c.useCallback(function(v, x) {
    ...
    var C = { name: v, delta: x, target: b, should: y, shadowParent: nu(b) };
  ...
  return c.createElement(
    c.Fragment,
    null,
    w ? c.createElement(i, { styles: Ql(o) }) : null,
    g ? c.createElement(Ul, { gapMode: e.gapMode }) : null
  );
}
function nu(e) {
...
var _t = c.forwardRef(function(e, t) {
  return c.createElement(fn, Ae({}, e, { ref: t, sideCar: ru }));
});
_t.classNames = fn.classNames;
var Gn = ["Enter", " "], ou = ["ArrowDown", "PageUp", "Home"], Zo = ["ArrowUp", "PageDown", "End"], iu = [...ou, ...Zo], su = {
  ltr: [...Gn, "ArrowRight"],
  rtl: [...Gn, "ArrowLeft"]
}, au = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, At = "Menu", [Ct, cu, lu] = tr(At), [Qe, Jo] = Je(At, [
  lu,
  He,
  ln
]), dn = He(), Qo = ln(), [uu, et] = Qe(At), [fu, Mt] = Qe(At), ei = (e) => {
...
ei.displayName = At;
var du = "MenuAnchor", ur = c.forwardRef(
  (e, t) => {
...
ur.displayName = du;
var fr = "MenuPortal", [pu, ti] = Qe(fr, {
  forceMount: void 0
}), ni = (e) => {
  const { __scopeMenu: t, forceMount: n, children: r, container: o } = e, i = et(fr, t);
  return /* @__PURE__ */ h.jsx(pu, { scope: t, forceMount: n, children: /* @__PURE__ */ h.jsx(be, { present: n || i.open, children: /* @__PURE__ */ h.jsx(Tt, { asChild: !0, container: o, children: r }) }) });
};
ni.displayName = fr;
var ye = "MenuContent", [vu, dr] = Qe(ye), ri = c.forwardRef(
  (e, t) => {
    const n = ti(ye, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, i = et(ye, e.__scopeMenu), s = Mt(ye, e.__scopeMenu);
    return /* @__PURE__ */ h.jsx(Ct.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: /* @__PURE__ */ h.jsx(Ct.Slot, { scope: e.__scopeMenu, children: s.modal ? /* @__PURE__ */ h.jsx(mu, { ...o, ref: t }) : /* @__PURE__ */ h.jsx(hu, { ...o, ref: t }) }) }) });
  }
), mu = c.forwardRef(
  (e, t) => {
  ...
  (e, t) => {
    const {
      ...
      ...v
    } = e, x = et(ye, n), b = Mt(ye, n), y = dn(n), C = Qo(n), S = cu(n), [R, O] = c.useState(null), P = c.useRef(null), M = q(t, P, x.onContentChange), $ = c.useRef(0), W = c.useRef(""), G = c.useRef(0), V = c.useRef(null), k = c.useRef("right"), L = c.useRef(0), z = w ? _t : c.Fragment, N = w ? { as: Fe, allowPinchZoom: !0 } : void 0, H = (A) => {
      var I, Y;
      const Z = W.current + A, ne = S().filter((J) => !J.disabled), ie = document.activeElement, me = (I = ne.find((J) => J.ref.current === ie)) == null ? void 0 : I.textValue, fe = ne.map((J) => J.textValue), Ce = _u(fe, Z, me), se = (Y = ne.find((J) => J.textValue === Ce)) == null ? void 0 : Y.ref.current;
      (function J(U) {
    ...
    const D = c.useCallback((A) => {
      var ne, ie;
      return k.current === ((ne = V.current) == null ? void 0 : ne.side) && Mu(A, (ie = V.current) == null ? void 0 : ie.area);
    }, []);
    return /* @__PURE__ */ h.jsx(
      vu,
      {
                    ...
                    children: /* @__PURE__ */ h.jsx(
                      sn,
                      {
                        ...
                        onKeyDown: _(v.onKeyDown, (A) => {
                          ...
                          const fe = P.current;
                          if (A.target !== fe || !iu.includes(A.key)) return;
                          A.preventDefault();
                          const se = S().filter((I) => !I.disabled).map((I) => I.ref.current);
                          Zo.includes(A.key) && se.reverse(), Pu(se);
                        }),
                        onBlur: _(e.onBlur, (A) => {
...
ri.displayName = ye;
var gu = "MenuGroup", vr = c.forwardRef(
  (e, t) => {
...
vr.displayName = gu;
var wu = "MenuLabel", oi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
...
), yu = "MenuCheckboxItem", si = c.forwardRef(
  (e, t) => {
...
si.displayName = yu;
var ai = "MenuRadioGroup", [xu, bu] = Qe(
  ai,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ h.jsx(xu, { scope: e.__scopeMenu, value: n, onValueChange: i, children: /* @__PURE__ */ h.jsx(vr, { ...o, ref: t }) });
  }
);
ci.displayName = ai;
var li = "MenuRadioItem", ui = c.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = bu(li, e.__scopeMenu), i = n === o.value;
...
ui.displayName = li;
var mr = "MenuItemIndicator", [fi, Cu] = Qe(
  mr,
  { checked: !1 }
), di = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: r, ...o } = e, i = Cu(mr, n);
    return /* @__PURE__ */ h.jsx(
      be,
      {
...
di.displayName = mr;
var Eu = "MenuSeparator", pi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
    return /* @__PURE__ */ h.jsx(
      F.div,
...
pi.displayName = Eu;
var Su = "MenuArrow", vi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = dn(n);
    ...
    return c.useEffect(() => f, [f]), c.useEffect(() => {
      ...
      ii,
      {
        ...
        onKeyDown: _(e.onKeyDown, (d) => {
          ...
          e.disabled || m && d.key === " " || su[r.dir].includes(d.key) && (n.onOpenChange(!0), (g = n.content) == null || g.focus(), d.preventDefault());
        })
      }
    ) });
  }
    ...
    return /* @__PURE__ */ h.jsx(Ct.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: /* @__PURE__ */ h.jsx(Ct.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ h.jsx(
      pr,
      {
        ...
        onKeyDown: _(e.onKeyDown, (f) => {
          var g;
          const d = f.currentTarget.contains(f.target), m = au[s.dir].includes(f.key);
...
var Ou = ei, Iu = ur, Du = ni, Nu = ri, ju = vr, ku = oi, Lu = pn, Fu = si, $u = ci, Wu = ui, Bu = di, Vu = pi, Hu = vi, Uu = hi, Ku = wi, gr = "DropdownMenu", [Gu, vd] = Je(
  gr,
  [Jo]
), ue = Jo(), [Yu, xi] = Gu(gr), bi = (e) => {
  const {
  ...
  return /* @__PURE__ */ h.jsx(
    Yu,
    {
      ...
      modal: a,
      children: /* @__PURE__ */ h.jsx(Ou, { ...l, open: f, onOpenChange: d, dir: r, modal: a, children: n })
    }
  );
};
bi.displayName = gr;
var Ci = "DropdownMenuTrigger", Ei = c.forwardRef(
  (e, t) => {
    ...
    return /* @__PURE__ */ h.jsx(Iu, { asChild: !0, ...s, children: /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
        id: i.triggerId,
...
Ei.displayName = Ci;
var zu = "DropdownMenuPortal", Si = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, r = ue(t);
  return /* @__PURE__ */ h.jsx(Du, { ...r, ...n });
};
Si.displayName = zu;
var Ri = "DropdownMenuContent", Pi = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = xi(Ri, n), i = ue(n), s = c.useRef(!1);
    return /* @__PURE__ */ h.jsx(
      Nu,
      {
        id: o.contentId,
...
Pi.displayName = Ri;
var Xu = "DropdownMenuGroup", qu = c.forwardRef(
  (e, t) => {
...
qu.displayName = Xu;
var Zu = "DropdownMenuLabel", Ti = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
Ti.displayName = Zu;
var Ju = "DropdownMenuItem", _i = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
_i.displayName = Ju;
var Qu = "DropdownMenuCheckboxItem", Ai = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Fu, { ...o, ...r, ref: t });
});
Ai.displayName = Qu;
var ef = "DropdownMenuRadioGroup", tf = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx($u, { ...o, ...r, ref: t });
});
tf.displayName = ef;
var nf = "DropdownMenuRadioItem", Mi = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Wu, { ...o, ...r, ref: t });
});
Mi.displayName = nf;
var rf = "DropdownMenuItemIndicator", Oi = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Bu, { ...o, ...r, ref: t });
});
Oi.displayName = rf;
var of = "DropdownMenuSeparator", Ii = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Vu, { ...o, ...r, ref: t });
});
Ii.displayName = of;
var sf = "DropdownMenuArrow", af = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
af.displayName = sf;
var cf = "DropdownMenuSubTrigger", Di = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Uu, { ...o, ...r, ref: t });
});
Di.displayName = cf;
var lf = "DropdownMenuSubContent", Ni = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(
    Ku,
    {
...
Ni.displayName = lf;
var md = bi, hd = Ei, gd = Si, wd = Pi, yd = Ti, xd = _i, bd = Ai, Cd = Mi, Ed = Oi, Sd = Ii, Rd = Di, Pd = Ni, wr = "Dialog", [ji, Td] = Je(wr), [uf, Te] = ji(wr), ki = (e) => {
  const {
    __scopeDialog: t,
    children: n,
    open: r,
...
ki.displayName = wr;
var Li = "DialogTrigger", Fi = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(Li, n), i = q(t, o.triggerRef);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
Fi.displayName = Li;
var yr = "DialogPortal", [ff, $i] = ji(yr, {
  forceMount: void 0
}), Wi = (e) => {
  const { __scopeDialog: t, forceMount: n, children: r, container: o } = e, i = Te(yr, t);
  return /* @__PURE__ */ h.jsx(ff, { scope: t, forceMount: n, children: c.Children.map(r, (s) => /* @__PURE__ */ h.jsx(be, { present: n || i.open, children: /* @__PURE__ */ h.jsx(Tt, { asChild: !0, container: o, children: s }) })) });
};
Wi.displayName = yr;
var Xt = "DialogOverlay", Bi = c.forwardRef(
  (e, t) => {
    const n = $i(Xt, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(Xt, e.__scopeDialog);
    return i.modal ? /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: /* @__PURE__ */ h.jsx(df, { ...o, ref: t }) }) : null;
  }
);
Bi.displayName = Xt;
var df = c.forwardRef(
...
), qe = "DialogContent", Vi = c.forwardRef(
  (e, t) => {
    const n = $i(qe, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(qe, e.__scopeDialog);
    return /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: i.modal ? /* @__PURE__ */ h.jsx(pf, { ...o, ref: t }) : /* @__PURE__ */ h.jsx(vf, { ...o, ref: t }) });
  }
);
Vi.displayName = qe;
var pf = c.forwardRef(
  ...
  (e, t) => {
    ...
    return en(), /* @__PURE__ */ h.jsxs(h.Fragment, { children: [
      ...
      /* @__PURE__ */ h.jsxs(h.Fragment, { children: [
        /* @__PURE__ */ h.jsx(mf, { titleId: a.titleId }),
        /* @__PURE__ */ h.jsx(gf, { contentRef: l, descriptionId: a.descriptionId })
      ] })
    ] });
  }
), xr = "DialogTitle", Ui = c.forwardRef(
  (e, t) => {
...
Ui.displayName = xr;
var Ki = "DialogDescription", Gi = c.forwardRef(
  (e, t) => {
...
Gi.displayName = Ki;
var Yi = "DialogClose", zi = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(Yi, n);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
var Xi = "DialogTitleWarning", [_d, qi] = Ta(Xi, {
  contentName: qe,
  titleName: xr,
  docsSlug: "dialog"
}), mf = ({ titleId: e }) => {
  const t = qi(Xi), n = `\`${t.contentName}\` requires a \`${t.titleName}\` for the component to be accessible for screen reader users.
...
}, hf = "DialogDescriptionWarning", gf = ({ contentRef: e, descriptionId: t }) => {
  const r = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${qi(hf).contentName}}.`;
  return c.useEffect(() => {
    var i;
    const o = (i = e.current) == null ? void 0 : i.getAttribute("aria-describedby");
    t && o && (document.getElementById(t) || console.warn(r));
  }, [r, e, t]), null;
}, Ad = ki, Md = Fi, Od = Wi, Id = Bi, Dd = Vi, Nd = Ui, jd = Gi, kd = zi, wf = "Label", Zi = c.forwardRef((e, t) => /* @__PURE__ */ h.jsx(
  F.label,
  {
    ...e,
    ref: t,
...
Zi.displayName = wf;
var Ld = Zi, Cr = "Tabs", [yf, Fd] = Je(Cr, [
  ln
]), Ji = ln(), [xf, Er] = yf(Cr), Qi = c.forwardRef(
  (e, t) => {
    const {
      __scopeTabs: n,
      value: r,
...
Qi.displayName = Cr;
var es = "TabsList", ts = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, loop: r = !0, ...o } = e, i = Er(es, n), s = Ji(n);
    return /* @__PURE__ */ h.jsx(
      Bo,
      {
        asChild: !0,
...
ts.displayName = es;
var ns = "TabsTrigger", rs = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, value: r, disabled: o = !1, ...i } = e, s = Er(ns, n), a = Ji(n), l = ss(s.baseId, r), u = as(s.baseId, r), f = r === s.value;
    return /* @__PURE__ */ h.jsx(
      Vo,
      {
        asChild: !0,
...
rs.displayName = ns;
var os = "TabsContent", is = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, value: r, forceMount: o, children: i, ...s } = e, a = Er(os, n), l = ss(a.baseId, r), u = as(a.baseId, r), f = r === a.value, d = c.useRef(f);
    return c.useEffect(() => {
...
var $d = Qi, Wd = ts, Bd = rs, Vd = is, bf = "VisuallyHidden", Sr = c.forwardRef(
  (e, t) => /* @__PURE__ */ h.jsx(
    F.span,
    {
      ...e,
...
Sr.displayName = bf;
var Cf = Sr, [vn, Hd] = Je("Tooltip", [
  He
]), mn = He(), cs = "TooltipProvider", Ef = 700, Yn = "tooltip.open", [Sf, Rr] = vn(cs), ls = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Ef,
...
ls.displayName = cs;
var hn = "Tooltip", [Rf, gn] = vn(hn), us = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
...
us.displayName = hn;
var zn = "TooltipTrigger", fs = c.forwardRef(
  (e, t) => {
...
fs.displayName = zn;
var Pf = "TooltipPortal", [Ud, Tf] = vn(Pf, {
  forceMount: void 0
}), lt = "TooltipContent", ds = c.forwardRef(
  (e, t) => {
    const n = Tf(lt, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...i } = e, s = gn(lt, e.__scopeTooltip);
    return /* @__PURE__ */ h.jsx(be, { present: r || s.open, children: s.disableHoverableContent ? /* @__PURE__ */ h.jsx(ps, { side: o, ...i, ref: t }) : /* @__PURE__ */ h.jsx(_f, { side: o, ...i, ref: t }) });
  }
), _f = c.forwardRef((e, t) => {
  ...
  }, [l, f, s, u, m]), /* @__PURE__ */ h.jsx(ps, { ...e, ref: i });
}), [Af, Mf] = vn(hn, { isInside: !1 }), ps = c.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
...
ds.displayName = lt;
var vs = "TooltipArrow", Of = c.forwardRef(
  (e, t) => {
...
var $f = [" ", "Enter", "ArrowUp", "ArrowDown"], Wf = [" ", "Enter"], Ot = "Select", [wn, yn, Bf] = tr(Ot), [vt, Xd] = Je(Ot, [
  Bf,
  He
]), xn = He(), [Vf, Ue] = vt(Ot), [Hf, Uf] = vt(Ot), ms = (e) => {
  const {
    __scopeSelect: t,
    children: n,
    open: r,
...
ms.displayName = Ot;
var hs = "SelectTrigger", gs = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, disabled: r = !1, ...o } = e, i = xn(n), s = Ue(hs, n), a = s.disabled || r, l = q(t, s.onTriggerChange), u = yn(n), f = c.useRef("touch"), [d, m, g] = Vs((v) => {
      const x = u().filter((C) => !C.disabled), b = x.find((C) => C.value === s.value), y = Hs(x, v, b);
...
gs.displayName = hs;
var ws = "SelectValue", ys = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, className: r, style: o, children: i, placeholder: s = "", ...a } = e, l = Ue(ws, n), { onValueNodeHasChildrenChange: u } = l, f = i !== void 0, d = q(t, l.onValueNodeChange);
    return le(() => {
      u(f);
    }, [u, f]), /* @__PURE__ */ h.jsx(
      F.span,
      {
        ...
        children: Ws(l.value) ? /* @__PURE__ */ h.jsx(h.Fragment, { children: s }) : i
      }
    );
  }
);
ys.displayName = ws;
var Kf = "SelectIcon", xs = c.forwardRef(
  (e, t) => {
...
xs.displayName = Kf;
var Gf = "SelectPortal", bs = (e) => /* @__PURE__ */ h.jsx(Tt, { asChild: !0, ...e });
bs.displayName = Gf;
var Ze = "SelectContent", Cs = c.forwardRef(
  (e, t) => {
    ...
    if (le(() => {
      ...
      return i ? Zt.createPortal(
        /* @__PURE__ */ h.jsx(Es, { scope: e.__scopeSelect, children: /* @__PURE__ */ h.jsx(wn.Slot, { scope: e.__scopeSelect, children: /* @__PURE__ */ h.jsx("div", { children: e.children }) }) }),
        i
      ) : null;
    }
    return /* @__PURE__ */ h.jsx(Ss, { ...e, ref: t });
  }
);
Cs.displayName = Ze;
var Se = 10, [Es, Ke] = vt(Ze), Yf = "SelectContentImpl", Ss = c.forwardRef(
  (e, t) => {
    const {
      __scopeSelect: n,
    ...
    const [Z, ne] = Vs((I) => {
      const Y = V().filter((Q) => !Q.disabled), J = Y.find((Q) => Q.ref.current === document.activeElement), U = Hs(Y, I, J);
...
Xn.displayName = Xf;
var [qf, Pr] = vt(Ze, {}), qn = "SelectViewport", Ps = c.forwardRef(
  (e, t) => {
...
Ps.displayName = qn;
var Ts = "SelectGroup", [Zf, Jf] = vt(Ts), _s = c.forwardRef(
  (e, t) => {
...
_s.displayName = Ts;
var As = "SelectLabel", Ms = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, ...r } = e, o = Jf(As, n);
    return /* @__PURE__ */ h.jsx(F.div, { id: o.id, ...r, ref: t });
  }
);
Ms.displayName = As;
var qt = "SelectItem", [Qf, Os] = vt(qt), Is = c.forwardRef(
  (e, t) => {
    const {
      __scopeSelect: n,
      value: r,
            ...
            children: /* @__PURE__ */ h.jsx(
              F.div,
              {
                ...
                onKeyDown: _(s.onKeyDown, (y) => {
                  var S;
                  ((S = l.searchRef) == null ? void 0 : S.current) !== "" && y.key === " " || (Wf.includes(y.key) && b(), y.key === " " && y.preventDefault());
                })
              }
            )
          }
...
Is.displayName = qt;
var yt = "SelectItemText", Ds = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, className: r, style: o, ...i } = e, s = Ue(yt, n), a = Ke(yt, n), l = Os(yt, n), u = Uf(yt, n), [f, d] = c.useState(null), m = q(
      t,
      (b) => d(b),
      l.onItemTextChange,
      (b) => {
...
Ds.displayName = yt;
var Ns = "SelectItemIndicator", js = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, ...r } = e;
    return Os(Ns, n).isSelected ? /* @__PURE__ */ h.jsx(F.span, { "aria-hidden": !0, ...r, ref: t }) : null;
  }
);
js.displayName = Ns;
var Zn = "SelectScrollUpButton", ks = c.forwardRef((e, t) => {
...
ks.displayName = Zn;
var Jn = "SelectScrollDownButton", Ls = c.forwardRef((e, t) => {
...
}), ed = "SelectSeparator", $s = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, ...r } = e;
...
var Bs = c.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = c.useRef(null), i = q(t, o), s = Ff(n);
    return c.useEffect(() => {
...
var qd = ms, Zd = gs, Jd = ys, Qd = xs, ep = bs, tp = Cs, np = Ps, rp = _s, op = Ms, ip = Is, sp = Ds, ap = js, cp = ks, lp = Ls, up = $s, Tr = "Popover", [Us, fp] = Je(Tr, [
  He
]), It = He(), [rd, Ge] = Us(Tr), Ks = (e) => {
  const {
    __scopePopover: t,
    children: n,
    open: r,
...
Ks.displayName = Tr;
var Gs = "PopoverAnchor", od = c.forwardRef(
  (e, t) => {
    const { __scopePopover: n, ...r } = e, o = Ge(Gs, n), i = It(n), { onCustomAnchorAdd: s, onCustomAnchorRemove: a } = o;
    return c.useEffect(() => (s(), () => a()), [s, a]), /* @__PURE__ */ h.jsx(Pt, { ...i, ...r, ref: t });
  }
);
od.displayName = Gs;
var Ys = "PopoverTrigger", zs = c.forwardRef(
  (e, t) => {
    const { __scopePopover: n, ...r } = e, o = Ge(Ys, n), i = It(n), s = q(t, o.triggerRef), a = /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
        "aria-haspopup": "dialog",
...
zs.displayName = Ys;
var _r = "PopoverPortal", [id, sd] = Us(_r, {
  forceMount: void 0
}), Xs = (e) => {
...
Xs.displayName = _r;
var ut = "PopoverContent", qs = c.forwardRef(
  (e, t) => {
...
), Js = "PopoverClose", ld = c.forwardRef(
  (e, t) => {
    const { __scopePopover: n, ...r } = e, o = Ge(Js, n);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
