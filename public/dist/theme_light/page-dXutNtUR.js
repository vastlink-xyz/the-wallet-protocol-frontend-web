...
import { j as se, r as n } from "./vendor-react-U4DfHahV.js";
import { I as t, B as x, L as C, f as y, g as v, h as R, c as le } from "./main-BjushY0K.js";
import { C as ae } from "./card-CS_C7fTw.js";
import { L as W } from "./label-CSVA-4yl.js";
import { B as p } from "./vendor-utils-BclDYac0.js";
import { K as J, c as re } from "./helper-C3A8L7vk.js";
import { u as te } from "./useFlowData-DpJwd5cs.js";
import { j as ne, E as oe, m as ce } from "./vendor-ui-utils-BJ7JrnFc.js";
import { S as de } from "./index-BYI3srE6.js";
const Z = {
  registered_name: "",
  ABN: "",
  ACN: "",
...
function me() {
  const j = se(), [h, N] = n.useState(1), [k, S] = n.useState(""), [w, B] = n.useState(!1), [d, u] = n.useState(!1), [l, F] = n.useState(null), [m, f] = n.useState(Z), [i, I] = n.useState({
    ...
    try {
      u(!0);
      const { data: a } = await y.post("/marketplace/product/frankieone/query-asic-report", {
    ...
    const c = async () => {
      var O, M, Q;
      try {
        const g = await y.get(`/marketplace/product/frankieone/retrieve-response?requestId=${a}`);
    ...
    try {
      u(!0);
      const { data: a } = await y.post("/marketplace/product/frankieone/save-kyb-data", {
...
const ue = re.map((j) => ({
  ...
  const j = se(), { flowId: h, flowIndex: N, serviceUrl: k, nextIndex: S } = te(), [w, B] = n.useState(!1), [d, u] = n.useState(1), [l, F] = n.useState(""), [m, f] = n.useState(!1), [i, I] = n.useState(null), [r, Y] = n.useState(ee), [b, P] = n.useState({
    sourceOfCapital: "",
    industry: "",
    websiteUrl: "",
    socialMediaUrl: "",
  ...
  return /* @__PURE__ */ e.jsx("div", { className: "light", children: /* @__PURE__ */ e.jsxs(ae, { className: "p-8 pt-6", children: [
    ...
    d === 3 && /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
      ...
      /* @__PURE__ */ e.jsx("div", { className: "mt-4 text-right", children: /* @__PURE__ */ e.jsx(x, { className: "", onClick: () => a(), disabled: m, children: m ? /* @__PURE__ */ e.jsx(C, {}) : "Submit" }) })
    ] }),
