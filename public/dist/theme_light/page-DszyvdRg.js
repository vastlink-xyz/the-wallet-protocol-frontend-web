...
import { j as n, c as t, a as l } from "./main-aWh1b37I.js";
import { i } from "./vendor-react-wyPiRY-L.js";
const p = () => {
  const { loginWithRedirect: s } = n(), a = async () => {
    await s({
      ...
      authorizationParams: {
        // screen_hint: "signup",
        // connection: 'email',
        audience: "https://staging.api.vastlink.xyz",
  ...
  return /* @__PURE__ */ e.jsxs("div", { className: "nav-bar__buttons", children: [
    !s && /* @__PURE__ */ e.jsx(e.Fragment, { children: /* @__PURE__ */ e.jsx(p, {}) }),
...
function m() {
  return i(), l.isAuthenticated(), /* @__PURE__ */ e.jsxs("div", { className: t(
