...
import { N as nt, M as st, O as at, q as ke, m as rt, n as it, v as ot, c as M, g as $e, I as qe, aH as lt, aa as ct, B as _e, t as R, aI as dt, i as je, aJ as Ce, f as Re, j as De, a as ut, aK as ht, ag as ft, aq as pt, aL as ze, a4 as pe, $ as be, h as mt, ad as gt, aM as xt, ar as bt, G as vt, D as yt, b as kt, d as wt, e as _t, aN as Tt } from "./main-qUKxxNV6.js";
import { a as S, p as Me, q as jt, s as Et, e as Ct, g as Nt, l as Ge } from "./vendor-react-DSEtE0wE.js";
import { u as St, i as He, L as At, f as Ke, g as Fe, T as It, P as Ot, I as Rt } from "./vendor-ui-utils-CGOon9_P.js";
import { u as Qe, B as Ie } from "./vendor-utils-Q0yJ_o1H.js";
import { u as Dt } from "./useTransaction-DQRW2wPG.js";
import { w as Pe, x as Mt, j as Ft, l as Vt, n as $t, i as Te, u as Ne } from "./vendor-web3-CQEmmIwE.js";
import { d as Lt } from "./index-Dkee3feI.js";
const zt = (i) => {
  const {
    componentCls: r,
...
const Je = (i) => {
  const {
    ...
    plain: Z,
    style: B
  } = i, re = Wt(i, ["prefixCls", "type", "orientation", "orientationMargin", "className", "rootClassName", "children", "dashed", "variant", "plain", "style"]), D = r("divider", l), [ee, z, P] = Bt(D), H = !!j, te = b === "left" && m != null, Q = b === "right" && m != null, I = it(D, a == null ? void 0 : a.className, z, P, `${D}-${f}`, {
    [`${D}-with-text`]: H,
    [`${D}-with-text-${b}`]: H,
    [`${D}-dashed`]: !!O,
    [`${D}-${F}`]: F !== "solid",
...
function Ut({
  ...
  const [f, b] = S.useState(!1), [m, c] = S.useState(0), [_, j] = S.useState(!1), O = S.useRef(null), F = S.useRef(null), Z = S.useRef(0), B = () => {
    ...
    const P = O.current, H = F.current, te = P.getBoundingClientRect();
    let Q = z - te.left - H.offsetWidth / 2;
    if (z - te.left < H.offsetWidth / 2) {
      c(0);
      return;
    }
    Q + H.offsetWidth >= Oe && (Q = Oe - H.offsetWidth - 2, B()), c(Q);
  }, ee = () => {
    _ || c(0), b(!1);
  };
  return S.useEffect(() => {
...
`, '"', c.BYTE_ORDER_MARK], c.WORKERS_SUPPORTED = !l && !!a.Worker, c.NODE_STREAM_INPUT = 1, c.LocalChunkSize = 10485760, c.RemoteChunkSize = 5242880, c.DefaultDelimiter = ",", c.Parser = ee, c.ParserHandle = re, c.NetworkStreamer = O, c.FileStreamer = F, c.StringStreamer = Z, c.ReadableStreamStreamer = B, a.jQuery) {
        ...
        function x() {
          if (o.length !== 0) {
            ...
            if (I(t.before)) {
              ...
              if (typeof U == "object") {
                if (U.action === "abort") return w = "AbortError", T = k.file, W = k.inputElem, V = U.reason, void (I(t.error) && t.error({ name: w }, T, W, V));
    ...
    function j(t) {
      this._handle = null, this._finished = !1, this._completed = !1, this._halted = !1, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = !0, this._completeResults = { data: [], errors: [], meta: {} }, (function(e) {
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          ...
          return this._config.step || this._config.chunk || (this._completeResults.data = this._completeResults.data.concat(w.data), this._completeResults.errors = this._completeResults.errors.concat(w.errors), this._completeResults.meta = w.meta), this._completed || !W || !I(this._config.complete) || w && w.meta.aborted || (this._config.complete(this._completeResults, this._input), this._completed = !0), W || w && w.meta.paused || this._nextChunk(), w;
        }
        this._halted = !0;
    ...
    function re(t) {
        ...
        return y && x && (X("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + c.DefaultDelimiter + "'"), x = !1), t.skipEmptyLines && (y.data = y.data.filter(function(s) {
          ...
          function s(d, p) {
            ...
            for (g = 0; g < d.length; g++) {
              var N = g, A = d[g];
              t.header && (N = g >= ne.length ? "__parsed_extra" : ne[g]), t.transform && (A = t.transform(A, N)), A = Y(N, A), N === "__parsed_extra" ? (C[N] = C[N] || [], C[N].push(A)) : C[N] = A;
            }
            return t.header && (g > ne.length ? X("FieldMismatch", "TooManyFields", "Too many fields: expected " + ne.length + " fields but parsed " + g, U + p) : g < ne.length && X("FieldMismatch", "TooFewFields", "Too few fields: expected " + ne.length + " fields but parsed " + g, U + p)), C;
          }
          var h = 1;
      ...
      this.parse = function(s, h, d) {
        var p = t.quoteChar || '"';
        if (t.newline || (t.newline = function(N, A) {
          N = N.substring(0, 1048576);
          var K = new RegExp(D(A) + "([^]*?)" + D(A), "gm"), ie = (N = N.replace(K, "")).split("\r"), ue = N.split(`
...
` : "\r";
          ...
          var g = function(N, A, K, ie, ue) {
            var he, le, G, J;
            ue = ue || [",", "	", "|", ";", c.RECORD_SEP, c.UNIT_SEP];
            for (var ve = 0; ve < ue.length; ve++) {
              var $ = ue[ve], we = 0, fe = 0, ye = 0;
              G = void 0;
              for (var me = new ee({ comments: ie, delimiter: $, newline: A, preview: 10 }).parse(N), ge = 0; ge < me.data.length; ge++) if (K && se(me.data[ge])) ye++;
              else {
        ...
        var C = te(t);
        return t.preview && t.header && C.preview++, e = s, o = new ee(C), y = o.parse(e, h, d), q(), E ? { meta: { paused: !0 } } : y || { meta: { paused: !1 } };
...
`);
      ...
      this.parse = function(E, oe, ne) {
        ...
        var y = E.length, L = o.length, se = x.length, q = v.length, ae = I(w), Y = [], X = [], s = [], h = k = 0;
        if (!E) return ce();
        if (t.header && !oe) {
          var d = E.split(x)[0].split(o), p = [], g = {}, C = !1;
          for (var N in d) {
            var A = d[N];
            I(t.transformHeader) && (A = t.transformHeader(A, N));
            var K = A, ie = g[A] || 0;
            for (0 < ie && (C = !0, K = A + "_" + ie), g[A] = ie + 1; p.includes(K); ) K = K + "_" + ie;
            p.push(K);
          }
          if (C) {
            var ue = E.split(x);
...
var nn = Xe.exports;
const sn = /* @__PURE__ */ Nt(nn);
function an({
  onSent: i
}) {
  const { address: r } = ut.all(), { t: u } = Qe(), { data: a, isFetched: l } = ht(), { data: f } = ft(), { data: b } = pt(), [m, c] = S.useState(null), [_, j] = S.useState([]), [O, F] = S.useState([]), [Z, B] = S.useState([]), [re, D] = S.useState(!1), [ee, z] = S.useState(!1), [P, H] = S.useState({
    ...R.createTokenMap(() => "0"),
    usdValue: "0"
  ...
  const o = S.useMemo(
    () => Object.entries(P).filter(([s]) => s !== "usdValue").some(([s, h]) => {
      const d = s, p = parseFloat((a == null ? void 0 : a[d]) || "0"), g = parseFloat(h), C = te && te[d] ? parseFloat(te[d]) : 0;
      return g + C > p;
    }),
    [P, a, te]
  ), x = ({
  ...
  const T = S.useCallback(async () => {
    ...
    z(!0);
    try {
      const s = R.getAllTokens().map((g) => g.tokenType), h = {}, d = (g) => I.filter((C, N) => {
        var K;
        return C.token === g && C.amount && (Te(C.to) || ((K = t[N]) == null ? void 0 : K.fullAddress));
      }).map((C, N) => {
        var A;
        return {
          to: Te(C.to) ? C.to : (A = t[N]) == null ? void 0 : A.fullAddress,
          amount: Ne(C.amount)
        };
      });
      for (const g of s) {
        ...
        if (C.length > 0) {
          const A = (await Promise.all(
            ...
            (K, ie) => ie ? K + parseFloat(ie.feeInTokens) : K,
            0
          );
          if (A > 0) {
            const K = je(A.toFixed(18), 18);
            h[g] = Ce(K);
          }
        }
      }
      const p = R.getAllTokens().reduce((g, C) => {
        const N = h[C.tokenType], A = f == null ? void 0 : f[C.tokenType];
        return g + (N && A ? parseFloat(N) * parseFloat(A) : 0);
      }, 0);
    ...
    if (Te(s.to))
      ...
      C = s.to, await Re.post("/invite/invite-register", {
        toEmail: C,
        from: r,
        amount: Ne(p).toString(),
        token: s.token,
        note: s.note
      });
      return;
    ...
    if (N != null && N.hash && (A != null && A.gasless) && !await xt(N.hash, s.token))
      ...
      try {
        ...
        for (let h = 0; h < _.length; h++) {
          ...
          try {
            ...
            const g = x({ transfer: d, validation: O[h] }) ? "invitation" : "transaction", C = mt(p);
            $e("handleSend", { errorInfo: C }), s.push({
              to: d.to,
              type: g,
              status: "failed",
              statusMessage: g === "transaction" ? C.message : "Not sent. Please try transferring again.",
              amount: d.amount,
              token: d.token
            });
          }
    ...
    handleFileChange: (s) => {
      ...
      h && sn.parse(h, {
        ...
        complete: (p) => {
          ...
          const C = p.data.slice(1).filter((N) => N[0] && N[0].trim() !== "").map((N) => ({
            to: N[0],
            note: N[1],
            token: N[2],
            amount: N[3],
            balance: (a == null ? void 0 : a[N[2]]) || "0"
          }));
          j(C), F(C.map(() => ({
            isValidating: !1,
            isValidEmail: !1,
            fullAddress: "",
            error: ""
          }))), B(C.map(() => !1)), Ie.success("CSV file uploaded successfully");
        },
        error: (p) => {
...
function rn({
  ...
  const [a, l] = S.useState(!1), b = R.getAllTokens().map((m) => m.tokenType).filter((m) => {
    const c = BigInt(i[m]), _ = BigInt(Ne(u[m])), j = BigInt(Ne(r[m]));
    return c + _ > j;
  });
...
function Ze({
  ...
  const u = Ye(r), a = (m) => {
    ...
    return c ? _ = parseFloat(i[c] || "0") + parseFloat((u == null ? void 0 : u[m]) || "0") : _ = parseFloat((u == null ? void 0 : u[m]) || "0"), _ ? {
      amount: Ce(je(_.toString(), 18)),
      symbol: m
    } : null;
  }, l = (m) => {
    const c = m, _ = parseFloat(i[c] || "0");
    return _ ? {
      amount: Ce(je(_.toString())),
      symbol: c
    } : null;
  }, f = () => {
    const m = [];
