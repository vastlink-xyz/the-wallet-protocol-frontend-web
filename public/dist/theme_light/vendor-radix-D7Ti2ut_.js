import { r as c, p as uo, a as Zt, R as ze, $ as xa, b as ba } from "./vendor-react-Bi1rjDlg.js";
var Ln = { exports: {} }, ht = {};
/**
 * @license React
...
var Le = c.forwardRef((e, t) => {
  const { children: n, ...r } = e, o = c.Children.toArray(n), i = o.find(Ra);
  if (i) {
...
function Fe({
  ...
  const [r, o] = Ma({ defaultProp: t, onChange: n }), i = e !== void 0, s = i ? e : r, a = xe(n), l = c.useCallback(
    (u) => {
      if (i) {
...
function tr(e) {
  ...
  const u = e + "CollectionItemSlot", f = "data-radix-collection-item", d = ze.forwardRef(
    (g, w) => {
      ...
      return ze.useEffect(() => (S.itemMap.set(y, { ref: y, ...b }), () => void S.itemMap.delete(y))), /* @__PURE__ */ h.jsx(Le, { [f]: "", ref: C, children: x });
    }
  );
  d.displayName = u;
  function m(g) {
...
var ye = "MenuContent", [du, dr] = Qe(ye), ni = c.forwardRef(
  ...
  (e, t) => {
    const {
      ...
      ...v
    } = e, x = et(ye, n), b = Mt(ye, n), y = dn(n), C = Jo(n), S = su(n), [R, O] = c.useState(null), P = c.useRef(null), M = q(t, P, x.onContentChange), $ = c.useRef(0), W = c.useRef(""), G = c.useRef(0), V = c.useRef(null), k = c.useRef("right"), L = c.useRef(0), z = w ? _t : c.Fragment, N = w ? { as: Le, allowPinchZoom: !0 } : void 0, H = (A) => {
      var I, Y;
...
Di.displayName = af;
var vd = xi, md = Ci, hd = Ei, gd = Ri, wd = Pi, yd = Ti, xd = _i, bd = Ai, Cd = Mi, Ed = Oi, Sd = Ii, Rd = Di, wr = "Tabs", [cf, Pd] = Je(wr, [
  ln
]), Ni = ln(), [lf, yr] = cf(wr), ji = c.forwardRef(
  (e, t) => {
    const {
      __scopeTabs: n,
      value: r,
...
var ki = "TabsList", Li = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, loop: r = !0, ...o } = e, i = yr(ki, n), s = Ni(n);
    return /* @__PURE__ */ h.jsx(
      Wo,
      {
        asChild: !0,
...
Li.displayName = ki;
var Fi = "TabsTrigger", $i = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, value: r, disabled: o = !1, ...i } = e, s = yr(Fi, n), a = Ni(n), l = Vi(s.baseId, r), u = Hi(s.baseId, r), f = r === s.value;
    return /* @__PURE__ */ h.jsx(
      Bo,
      {
        asChild: !0,
...
$i.displayName = Fi;
var Wi = "TabsContent", Bi = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, value: r, forceMount: o, children: i, ...s } = e, a = yr(Wi, n), l = Vi(a.baseId, r), u = Hi(a.baseId, r), f = r === a.value, d = c.useRef(f);
    return c.useEffect(() => {
...
var Td = ji, _d = Li, Ad = $i, Md = Bi, xr = "Dialog", [Ui, Od] = Je(xr), [uf, Te] = Ui(xr), Ki = (e) => {
  const {
    __scopeDialog: t,
    children: n,
    open: r,
...
Ki.displayName = xr;
var Gi = "DialogTrigger", ff = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(Gi, n), i = q(t, o.triggerRef);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
ff.displayName = Gi;
var br = "DialogPortal", [df, Yi] = Ui(br, {
  forceMount: void 0
}), zi = (e) => {
  const { __scopeDialog: t, forceMount: n, children: r, container: o } = e, i = Te(br, t);
  return /* @__PURE__ */ h.jsx(df, { scope: t, forceMount: n, children: c.Children.map(r, (s) => /* @__PURE__ */ h.jsx(be, { present: n || i.open, children: /* @__PURE__ */ h.jsx(Tt, { asChild: !0, container: o, children: s }) })) });
};
zi.displayName = br;
var Xt = "DialogOverlay", Xi = c.forwardRef(
  (e, t) => {
    const n = Yi(Xt, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(Xt, e.__scopeDialog);
    return i.modal ? /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: /* @__PURE__ */ h.jsx(pf, { ...o, ref: t }) }) : null;
  }
);
Xi.displayName = Xt;
var pf = c.forwardRef(
...
), qe = "DialogContent", qi = c.forwardRef(
  (e, t) => {
    const n = Yi(qe, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(qe, e.__scopeDialog);
    return /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: i.modal ? /* @__PURE__ */ h.jsx(vf, { ...o, ref: t }) : /* @__PURE__ */ h.jsx(mf, { ...o, ref: t }) });
  }
);
qi.displayName = qe;
var vf = c.forwardRef(
  ...
  (e, t) => {
    ...
    return en(), /* @__PURE__ */ h.jsxs(h.Fragment, { children: [
      ...
      /* @__PURE__ */ h.jsxs(h.Fragment, { children: [
        /* @__PURE__ */ h.jsx(hf, { titleId: a.titleId }),
        /* @__PURE__ */ h.jsx(wf, { contentRef: l, descriptionId: a.descriptionId })
      ] })
    ] });
  }
), Cr = "DialogTitle", Ji = c.forwardRef(
  (e, t) => {
...
Ji.displayName = Cr;
var Qi = "DialogDescription", es = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(Qi, n);
    return /* @__PURE__ */ h.jsx(F.p, { id: o.descriptionId, ...r, ref: t });
  }
);
es.displayName = Qi;
var ts = "DialogClose", ns = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(ts, n);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
var rs = "DialogTitleWarning", [Id, os] = _a(rs, {
  contentName: qe,
  titleName: Cr,
  docsSlug: "dialog"
}), hf = ({ titleId: e }) => {
  const t = os(rs), n = `\`${t.contentName}\` requires a \`${t.titleName}\` for the component to be accessible for screen reader users.
...
}, gf = "DialogDescriptionWarning", wf = ({ contentRef: e, descriptionId: t }) => {
  const r = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${os(gf).contentName}}.`;
  return c.useEffect(() => {
    var i;
    const o = (i = e.current) == null ? void 0 : i.getAttribute("aria-describedby");
    t && o && (document.getElementById(t) || console.warn(r));
  }, [r, e, t]), null;
}, Dd = Ki, Nd = zi, jd = Xi, kd = qi, Ld = Ji, Fd = es, $d = ns, yf = "Label", is = c.forwardRef((e, t) => /* @__PURE__ */ h.jsx(
  F.label,
  {
    ...e,
    ref: t,
...
var bf = "VisuallyHidden", Sr = c.forwardRef(
  (e, t) => /* @__PURE__ */ h.jsx(
    F.span,
    {
      ...e,
...
var hn = "Tooltip", [Rf, gn] = vn(hn), cs = (e) => {
  const {
    ...
    delayDuration: a
  } = e, l = Rr(hn, e.__scopeTooltip), u = mn(t), [f, d] = c.useState(null), m = we(), g = c.useRef(0), w = s ?? l.disableHoverableContent, v = a ?? l.delayDuration, x = c.useRef(!1), [b = !1, y] = Fe({
    prop: r,
    defaultProp: o,
    onChange: (P) => {
...
var Ff = [" ", "Enter", "ArrowUp", "ArrowDown"], $f = [" ", "Enter"], Ot = "Select", [wn, yn, Wf] = tr(Ot), [vt, Yd] = Je(Ot, [
  ...
  const {
    ...
    required: g,
    form: w
  } = e, v = xn(t), [x, b] = c.useState(null), [y, C] = c.useState(null), [S, R] = c.useState(!1), O = Qt(u), [P = !1, M] = Fe({
    prop: r,
    defaultProp: o,
    onChange: i
  }), [$, W] = Fe({
...
var $s = c.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = c.useRef(null), i = q(t, o), s = xf(n);
    return c.useEffect(() => {
