...
import { N as nt, M as st, O as at, q as ke, m as rt, n as it, v as ot, c as M, g as $e, I as qe, aH as lt, t as D, D as ct, b as dt, d as ut, e as ht, aa as pt, B as we, aI as ft, i as je, aJ as Ne, f as Re, j as De, a as mt, aK as gt, ag as xt, aq as bt, aL as ze, a4 as fe, $ as be, h as vt, ad as yt, ar as kt, G as wt, aM as _t } from "./main-kXKSh1Wy.js";
...
const Je = (o) => {
  const {
    ...
    plain: Z,
    style: B
  } = o, re = Bt(o, ["prefixCls", "type", "orientation", "orientationMargin", "className", "rootClassName", "children", "dashed", "variant", "plain", "style"]), R = r("divider", g), [ee, z, P] = Pt(R), G = !!N, te = b === "left" && f != null, K = b === "right" && f != null, A = it(R, a == null ? void 0 : a.className, z, P, `${R}-${i}`, {
    [`${R}-with-text`]: G,
    [`${R}-with-text-${b}`]: G,
    [`${R}-dashed`]: !!O,
    [`${R}-${F}`]: F !== "solid",
  ...
  }, c, _), t = S.useMemo(() => typeof f == "number" ? f : /^\d+$/.test(f) ? Number(f) : f, [f]), e = Object.assign(Object.assign({}, te && {
    marginLeft: t
  }), K && {
    marginRight: t
  });
...
function Wt({
  ...
  const [i, b] = S.useState(!1), [f, c] = S.useState(0), [_, N] = S.useState(!1), O = S.useRef(null), F = S.useRef(null), Z = S.useRef(0), B = () => {
    const z = Date.now();
      ...
      children: [
        ...
        /* @__PURE__ */ n.jsx(
          "div",
          {
            ...
            style: { transform: `translate(${f}px, -50%)` },
...
function Ut({
  ...
  const { t: _ } = Qe(), N = _("/dashboard.[token].sendModal.unregisteredEmailNotice");
...
const qt = D.getAllTokens().map((o) => o.tokenType);
function Ht({
  ...
  return /* @__PURE__ */ n.jsxs(ct, { children: [
    /* @__PURE__ */ n.jsxs(dt, { disabled: a, className: "flex items-center gap-[6px] px-0 py-1 focus:outline-none", children: [
    ...
    /* @__PURE__ */ n.jsx(ut, { align: "start", className: "bg-white", children: qt.map((g) => /* @__PURE__ */ n.jsxs(
      ht,
      {
        disabled: a,
        onClick: () => o(g, r),
...
async function Xt({
  ...
  const i = Jt({ tokenType: o, transferParams: r, fromAddress: u });
  return Yt.getOrCreate(i, async () => {
    const b = Ue.get(i);
    if (b)
      return b.result;
    try {
      const f = D.getToken(o).viemChain;
      if (!f) return null;
      const c = Mt({
        chain: f,
        transport: Ft()
      ...
      throw console.error("Gas estimation error:", f), f;
    }
  });
}
const Zt = (o) => {
  ...
  return { isValid: !0 };
}, Ve = /* @__PURE__ */ new Map(), en = 5 * 60 * 1e3;
async function tn(o) {
  const r = Ve.get(o), u = Date.now();
  if (r && u - r.timestamp < en)
    return {
      data: r.data
    };
...
(function(o, r) {
  (function(u, a) {
    ...
    var a = typeof self < "u" ? self : typeof window < "u" ? window : a !== void 0 ? a : {}, g = !a.document && !!a.postMessage, i = a.IS_PAPA_WORKER || !1, b = {}, f = 0, c = { parse: function(t, e) {
      ...
      if (A(l) && (e.dynamicTypingFunction = l, l = {}), e.dynamicTyping = l, e.transform = !!A(e.transform) && e.transform, e.worker && c.WORKERS_SUPPORTED) {
        var x = function() {
          ...
          return T.onmessage = z, T.id = f++, b[T.id] = T;
        }();
...
`, '"', c.BYTE_ORDER_MARK], c.WORKERS_SUPPORTED = !g && !!a.Worker, c.NODE_STREAM_INPUT = 1, c.LocalChunkSize = 10485760, c.RemoteChunkSize = 5242880, c.DefaultDelimiter = ",", c.Parser = ee, c.ParserHandle = re, c.NetworkStreamer = O, c.FileStreamer = F, c.StringStreamer = Z, c.ReadableStreamStreamer = B, a.jQuery) {
    ...
    function re(t) {
      ...
      function q() {
        return y && x && (X("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + c.DefaultDelimiter + "'"), x = !1), t.skipEmptyLines && (y.data = y.data.filter(function(s) {
          ...
          function s(d, p) {
            ...
            return t.header && (m > ne.length ? X("FieldMismatch", "TooManyFields", "Too many fields: expected " + ne.length + " fields but parsed " + m, U + p) : m < ne.length && X("FieldMismatch", "TooFewFields", "Too few fields: expected " + ne.length + " fields but parsed " + m, U + p)), E;
          }
          var h = 1;
      ...
      function X(s, h, d, p) {
        ...
        p !== void 0 && (m.row = p), y.errors.push(m);
      }
          ...
          var m = function(C, I, Q, ie, ue) {
            ...
            for (var ve = 0; ve < ue.length; ve++) {
              ...
              for (var me = new ee({ comments: ie, delimiter: $, newline: I, preview: 10 }).parse(C), ge = 0; ge < me.data.length; ge++) if (Q && se(me.data[ge])) ye++;
                ...
                pe += xe, H !== void 0 ? 0 < xe && (_e += Math.abs(xe - H), H = xe) : H = xe;
              }
              0 < me.data.length && (pe /= me.data.length - ye), (le === void 0 || _e <= le) && (J === void 0 || J < pe) && 1.99 < pe && (le = _e, he = $, J = pe);
            }
...
`);
      ...
      this.parse = function(j, oe, ne) {
        ...
        if (!j) return ce();
        if (t.header && !oe) {
          var d = j.split(x)[0].split(l), p = [], m = {}, E = !1;
          for (var C in d) {
            var I = d[C];
            A(t.transformHeader) && (I = t.transformHeader(I, C));
            var Q = I, ie = m[I] || 0;
            for (0 < ie && (E = !0, Q = I + "_" + ie), m[I] = ie + 1; p.includes(Q); ) Q = Q + "_" + ie;
            p.push(Q);
          }
          if (E) {
            var ue = j.split(x);
            ue[0] = p.join(l), j = ue.join(x);
          }
        }
        ...
        for (var H = j.indexOf(l, w), J = j.indexOf(x, w), ve = new RegExp(R(V) + R(e), "g"), $ = j.indexOf(e, w); ; ) if (j[w] !== e) if (v && s.length === 0 && j.substring(w, w + q) === v) {
          ...
          if (e !== V || j[$ + 1] !== V) {
            if (e === V || $ === 0 || j[$ - 1] !== V) {
              ...
              if (j.substr($ + 1 + _e, L) === l) {
                s.push(j.substring(w, $).replace(ve, e)), j[w = $ + 1 + _e + L] !== e && ($ = j.indexOf(e, w)), H = j.indexOf(l, w), J = j.indexOf(x, w);
                break;
              }
              var pe = me(J);
              if (j.substring($ + 1 + pe, $ + 1 + pe + se) === x) {
                if (s.push(j.substring(w, $).replace(ve, e)), xe($ + 1 + pe + se), H = j.indexOf(l, w), $ = j.indexOf(e, w), ae && (Ee(), U)) return ce();
                if (T && Y.length >= T) return ce(!0);
                break;
              }
...
var sn = Xe.exports;
const an = /* @__PURE__ */ Nt(sn);
function rn({
  onSent: o
}) {
  const { address: r } = mt.all(), { t: u } = Qe(), { data: a, isFetched: g } = gt(), { data: i } = xt(), { data: b } = bt(), [f, c] = S.useState(null), [_, N] = S.useState([]), [O, F] = S.useState([]), [Z, B] = S.useState([]), [re, R] = S.useState(!1), [ee, z] = S.useState(!1), [P, G] = S.useState({
    ...D.createTokenMap(() => "0"),
    usdValue: "0"
  }), [te, K] = S.useState(null), A = ze(_, 800), t = ze(O, 800), { signTransaction: e } = Rt();
  S.useEffect(() => {
    g && W();
  }, [g]), S.useEffect(() => {
    nn(), w();
    ...
    let h = 0;
    i && (h = Object.values(fe).reduce((p, m) => p + s[m] * parseFloat(i[m] || "0"), 0));
    const d = D.getAllTokens().reduce((p, m) => ({
      ...p,
  ...
  const l = S.useMemo(
    () => Object.entries(P).filter(([s]) => s !== "usdValue").some(([s, h]) => {
      const d = s, p = parseFloat((a == null ? void 0 : a[d]) || "0"), m = parseFloat(h), E = te && te[d] ? parseFloat(te[d]) : 0;
      return m + E > p;
    }),
    [P, a, te]
  ), x = ({
  ...
  const T = S.useCallback(async () => {
    ...
    try {
      ...
      const p = D.getAllTokens().reduce((m, E) => {
    ...
    N([{
      ...
      amount: "",
      token: fe.TVWT,
      balance: (a == null ? void 0 : a[fe.TVWT]) || "0"
    }]), F([{
      isValidating: !1,
      isValidEmail: !1,
      fullAddress: "",
      ...
      try {
        ...
        for (let h = 0; h < _.length; h++) {
          ...
          try {
            ...
            const m = x({ transfer: d, validation: O[h] }) ? "invitation" : "transaction", E = vt(p);
    ...
    handleFileChange: (s) => {
      ...
      h && an.parse(h, {
        ...
        complete: (p) => {
          ...
          const E = p.data.slice(1).filter((C) => C[0] && C[0].trim() !== "").map((C) => ({
            to: C[0],
            note: C[1],
            token: C[2],
            amount: C[3],
...
function ln({
  ...
  const [a, g] = S.useState(!1), b = D.getAllTokens().map((f) => f.tokenType).filter((f) => {
    const c = BigInt(o[f]), _ = BigInt(Ce(u[f])), N = BigInt(Ce(r[f]));
    return c + _ > N;
  });
  return b.length === 0 ? null : /* @__PURE__ */ n.jsxs(n.Fragment, { children: [
    /* @__PURE__ */ n.jsx("div", { className: "bg-black/5 rounded-lg border-b border-[#dbdbdb] py-[12px] px-[16px] mb-[24px]", children: /* @__PURE__ */ n.jsxs("div", { className: "flex items-start gap-[12px]", children: [
      ...
      /* @__PURE__ */ n.jsxs("div", { children: [
        b.map((f) => /* @__PURE__ */ n.jsxs("p", { className: "text-xs text-black font-normal leading-snug", children: [
          D.getToken(f).symbol,
...
function cn({
  ...
  if (!a) return null;
  const i = (b, f) => r != null && r[f] ? be((parseFloat(b) * parseFloat(r[f])).toString(), 2) : "0";
  return /* @__PURE__ */ n.jsx("div", { className: "bg-black/5 rounded-lg border-b border-[#dbdbdb] py-[12px] px-[16px] mb-[24px]", children: /* @__PURE__ */ n.jsxs("div", { className: "flex items-start gap-[12px]", children: [
    ...
    /* @__PURE__ */ n.jsxs("div", { children: [
      ...
      Object.keys(o).map((b) => {
        const f = b, c = parseFloat(o[f] || "0"), _ = parseFloat(u[f] || "0"), N = g && g[f] ? parseFloat(g[f]) : 0, O = _ + N;
...
function Ze({
  ...
  const u = Ye(r), a = (f) => {
    const c = D.getNativeTokenTypeByGasSymbol(f);
    let _ = 0;
    return c ? _ = parseFloat(o[c] || "0") + parseFloat((u == null ? void 0 : u[f]) || "0") : _ = parseFloat((u == null ? void 0 : u[f]) || "0"), _ ? {
      amount: Ne(je(_.toString(), 18)),
      symbol: f
    } : null;
  }, g = (f) => {
    const c = f, _ = parseFloat(o[c] || "0");
    return _ ? {
    ...
    return Object.values(wt).forEach((c) => {
      ...
      f.push(g(c.tokenType));
    }), f.filter((c) => c !== null);
  }, b = () => {
    const f = parseFloat(o.usdValue), c = parseFloat((r == null ? void 0 : r.usdValue) || "0"), _ = f + c;
  ...
  return /* @__PURE__ */ n.jsxs(n.Fragment, { children: [
    ...
    /* @__PURE__ */ n.jsxs("p", { className: "text-black text-xl font-medium leading-none text-right mt-0.5", children: [
      i().map((f, c, _) => /* @__PURE__ */ n.jsxs("span", { children: [
        f.amount,
        " ",
        f.symbol,
        c < _.length - 1 && " & "
...
function dn({
  ...
  const {
    ...
    onSent: o
  }), { showExitPrompt: e, handleExitPrompt: l } = Kt({
    shouldBlock: i
  }), x = He(), v = () => {
    x(-1);
  };
  ...
  return /* @__PURE__ */ n.jsxs("div", { className: M(
    ...
    /* @__PURE__ */ n.jsxs("div", { className: "mt-[30px]", children: [
      ...
      /* @__PURE__ */ n.jsxs("p", { className: "text-black text-sm font-medium leading-none text-right mt-0.5", children: [
        u && Object.entries(u).filter(([i]) => i !== "usdValue" && u[i] !== "0").map(([i, b], f, c) => /* @__PURE__ */ n.jsxs("span", { children: [
          b,
          " ",
          D.getToken(i).symbol,
          f < c.length - 1 && " & "
...
fe.ETH, fe.ETH, fe.ETH, fe.ETH;
function kn() {
  const [o, r] = S.useState(!1), [u, a] = S.useState([]), [g, i] = S.useState(null), [b, f] = S.useState({
    ...D.createTokenMap(() => "0"),
    usdValue: "0"
  }), c = (_, N, O) => {
    a(_), i(N), f(O), r(!0);
