import { r as c, p as uo, a as Zt, e as ze, $ as ba, b as Ca } from "./vendor-react-X5c0QESR.js";
var Ln = { exports: {} }, ht = {};
/**
 * @license React
...
function Le({
  ...
  const [r, o] = _a({ defaultProp: t, onChange: n }), i = e !== void 0, s = i ? e : r, a = xe(n), l = c.useCallback(
    (u) => {
      if (i) {
...
var Fe = c.forwardRef((e, t) => {
  const { children: n, ...r } = e, o = c.Children.toArray(n), i = o.find(Aa);
  if (i) {
...
var ka = "DismissableLayer", $n = "dismissableLayer.update", La = "dismissableLayer.pointerDownOutside", Fa = "dismissableLayer.focusOutside", Vr, vo = c.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...l
    } = e, u = c.useContext(vo), [f, d] = c.useState(null), m = (f == null ? void 0 : f.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, g] = c.useState({}), w = q(t, (P) => d(P)), v = Array.from(u.layers), [x] = [...u.layersWithOutsidePointerEventsDisabled].slice(-1), b = v.indexOf(x), y = f ? v.indexOf(f) : -1, C = u.layersWithOutsidePointerEventsDisabled.size > 0, S = y >= b, R = Ba((P) => {
...
function Va(e, t = globalThis == null ? void 0 : globalThis.document) {
  ...
  return c.useEffect(() => {
    const o = (i) => {
      i.target && !r.current && mo(Fa, n, { originalEvent: i }, {
        discrete: !1
      });
    };
...
var _n = "focusScope.autoFocusOnMount", An = "focusScope.autoFocusOnUnmount", Kr = { bubbles: !1, cancelable: !0 }, Ha = "FocusScope", St = c.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  c.useEffect(() => {
    ...
    if (a) {
      ...
      if (!a.contains(v)) {
        ...
        a.addEventListener(_n, u), a.dispatchEvent(b), b.defaultPrevented || (Ua(Xa(ho(a)), { select: !0 }), document.activeElement === v && ke(a));
      }
      return () => {
  ...
  const w = c.useCallback(
    (v) => {
      ...
      if (x && b) {
        const y = v.currentTarget, [C, S] = Ka(y);
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = i.arrow) != null && n.alignmentOffset)
        return {};
      const b = Ne(o), y = Be(a), C = Ne(a) === a, S = await (l.isRTL == null ? void 0 : l.isRTL(u.floating)), R = m || (C || !v ? [Ut(a)] : nc(a)), O = w !== "none";
      !m && O && R.push(...oc(a, v, w, S));
...
function Rc(e) {
  ...
  const s = [...n === "clippingAncestors" ? nn(t) ? [] : Sc(t, this._c) : [].concat(n), r], a = s[0], l = s.reduce((u, f) => {
    const d = Qr(t, f, o);
...
var Xc = "Arrow", Ro = c.forwardRef((e, t) => {
...
var cr = "Popper", [Po, He] = er(cr), [Jc, To] = Po(cr), _o = (e) => {
...
Mo.displayName = Ao;
var lr = "PopperContent", [Qc, el] = Po(lr), Oo = c.forwardRef(
  (e, t) => {
    var I, Y, J, U, Q, X;
    const {
      __scopePopper: n,
      ...
      onPlaced: w,
      ...v
    } = e, x = To(lr, n), [b, y] = c.useState(null), C = q(t, (ae) => y(ae)), [S, R] = c.useState(null), O = Zc(S), P = (O == null ? void 0 : O.width) ?? 0, M = (O == null ? void 0 : O.height) ?? 0, $ = r + (i !== "center" ? "-" + i : ""), W = typeof f == "number" ? f : { top: 0, right: 0, bottom: 0, left: 0, ...f }, G = Array.isArray(u) ? u : [u], V = G.length > 0, k = {
      padding: W,
...
Oo.displayName = lr;
var Io = "PopperArrow", tl = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, Do = c.forwardRef(function(t, n) {
  const { __scopePopper: r, ...o } = t, i = el(Io, r), s = tl[i.placedSide];
  return (
...
var on = _o, Pt = Mo, sn = Oo, an = Do, ol = "Portal", Tt = c.forwardRef((e, t) => {
  var a;
...
var In = "rovingFocusGroup.onEntryFocus", cl = { bubbles: !1, cancelable: !0 }, cn = "RovingFocusGroup", [Un, jo, ll] = tr(cn), [ul, ln] = er(
  cn,
  [ll]
), [fl, dl] = ul(cn), ko = c.forwardRef(
...
var pl = c.forwardRef((e, t) => {
  ...
  (e, t) => {
    const {
      ...
      tabStopId: i,
      ...s
    } = e, a = we(), l = i || a, u = dl(Lo, n), f = u.currentTabStopId === l, d = jo(n), { onFocusableItemAdd: m, onFocusableItemRemove: g } = u;
    return c.useEffect(() => {
      if (r)
        return m(), () => g();
...
}, Wl = Go(), at = "data-scroll-locked", Bl = function(e, t, n, r) {
...
function eu(e) {
  var t = c.useRef([]), n = c.useRef([0, 0]), r = c.useRef(), o = c.useState(Ql++)[0], i = c.useState(Go)[0], s = c.useRef(e);
  c.useEffect(function() {
    s.current = e;
...
var Gn = ["Enter", " "], ru = ["ArrowDown", "PageUp", "Home"], qo = ["ArrowUp", "PageDown", "End"], ou = [...ru, ...qo], iu = {
  ltr: [...Gn, "ArrowRight"],
  rtl: [...Gn, "ArrowLeft"]
}, su = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, At = "Menu", [Ct, au, cu] = tr(At), [Qe, Zo] = Je(At, [
  cu,
  He,
  ln
]), dn = He(), Jo = ln(), [lu, et] = Qe(At), [uu, Mt] = Qe(At), Qo = (e) => {
...
ti.displayName = fr;
var ye = "MenuContent", [pu, dr] = Qe(ye), ni = c.forwardRef(
  (e, t) => {
  ...
  (e, t) => {
    const {
      ...
      ...v
    } = e, x = et(ye, n), b = Mt(ye, n), y = dn(n), C = Jo(n), S = au(n), [R, O] = c.useState(null), P = c.useRef(null), M = q(t, P, x.onContentChange), $ = c.useRef(0), W = c.useRef(""), G = c.useRef(0), V = c.useRef(null), k = c.useRef("right"), L = c.useRef(0), z = w ? _t : c.Fragment, N = w ? { as: Fe, allowPinchZoom: !0 } : void 0, H = (A) => {
      var I, Y;
      const Z = W.current + A, ne = S().filter((J) => !J.disabled), ie = document.activeElement, me = (I = ne.find((J) => J.ref.current === ie)) == null ? void 0 : I.textValue, fe = ne.map((J) => J.textValue), Ce = Tu(fe, Z, me), se = (Y = ne.find((J) => J.textValue === Ce)) == null ? void 0 : Y.ref.current;
      (function J(U) {
                    ...
                    children: /* @__PURE__ */ h.jsx(
                      sn,
                      {
                        ...
                        onKeyDown: _(v.onKeyDown, (A) => {
                          ...
                          qo.includes(A.key) && se.reverse(), Ru(se);
                        }),
                        onBlur: _(e.onBlur, (A) => {
...
vr.displayName = hu;
var gu = "MenuLabel", ri = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
...
), wu = "MenuCheckboxItem", ii = c.forwardRef(
  (e, t) => {
...
ii.displayName = wu;
var si = "MenuRadioGroup", [yu, xu] = Qe(
  si,
...
var ci = "MenuRadioItem", li = c.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = xu(ci, e.__scopeMenu), i = n === o.value;
...
li.displayName = ci;
var mr = "MenuItemIndicator", [ui, bu] = Qe(
  mr,
  { checked: !1 }
), fi = c.forwardRef(
  (e, t) => {
...
var Cu = "MenuSeparator", di = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
    return /* @__PURE__ */ h.jsx(
      F.div,
...
di.displayName = Cu;
var Eu = "MenuArrow", pi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = dn(n);
...
pi.displayName = Eu;
var Su = "MenuSub", [dd, vi] = Qe(Su), wt = "MenuSubTrigger", mi = c.forwardRef(
  (e, t) => {
...
var Mu = Qo, Ou = ur, Iu = ti, Du = ni, Nu = vr, ju = ri, ku = pn, Lu = ii, Fu = ai, $u = li, Wu = fi, Bu = di, Vu = pi, Hu = mi, Uu = gi, gr = "DropdownMenu", [Ku, pd] = Je(
  gr,
  [Zo]
), ue = Zo(), [Gu, yi] = Ku(gr), xi = (e) => {
  const {
...
Ci.displayName = bi;
var Yu = "DropdownMenuPortal", Ei = (e) => {
...
Xu.displayName = zu;
var qu = "DropdownMenuLabel", Pi = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
Pi.displayName = qu;
var Zu = "DropdownMenuItem", Ti = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
Ti.displayName = Zu;
var Ju = "DropdownMenuCheckboxItem", _i = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
ef.displayName = Qu;
var tf = "DropdownMenuRadioItem", Ai = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx($u, { ...o, ...r, ref: t });
});
Ai.displayName = tf;
var nf = "DropdownMenuItemIndicator", Mi = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Wu, { ...o, ...r, ref: t });
});
Mi.displayName = nf;
var rf = "DropdownMenuSeparator", Oi = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
sf.displayName = of;
var af = "DropdownMenuSubTrigger", Ii = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Hu, { ...o, ...r, ref: t });
});
Ii.displayName = af;
var cf = "DropdownMenuSubContent", Di = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(
    Uu,
    {
...
Di.displayName = cf;
var vd = xi, md = Ci, hd = Ei, gd = Ri, wd = Pi, yd = Ti, xd = _i, bd = Ai, Cd = Mi, Ed = Oi, Sd = Ii, Rd = Di, wr = "Dialog", [Ni, Pd] = Je(wr), [lf, Te] = Ni(wr), ji = (e) => {
  const {
    __scopeDialog: t,
    children: n,
    open: r,
...
ji.displayName = wr;
var ki = "DialogTrigger", Li = c.forwardRef(
  (e, t) => {
...
Li.displayName = ki;
var yr = "DialogPortal", [uf, Fi] = Ni(yr, {
  forceMount: void 0
}), $i = (e) => {
...
$i.displayName = yr;
var Xt = "DialogOverlay", Wi = c.forwardRef(
  (e, t) => {
    const n = Fi(Xt, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(Xt, e.__scopeDialog);
...
), qe = "DialogContent", Bi = c.forwardRef(
  (e, t) => {
    const n = Fi(qe, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(qe, e.__scopeDialog);
...
), xr = "DialogTitle", Hi = c.forwardRef(
  (e, t) => {
...
Hi.displayName = xr;
var Ui = "DialogDescription", Ki = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(Ui, n);
    return /* @__PURE__ */ h.jsx(F.p, { id: o.descriptionId, ...r, ref: t });
  }
);
Ki.displayName = Ui;
var Gi = "DialogClose", Yi = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(Gi, n);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
var zi = "DialogTitleWarning", [Td, Xi] = Pa(zi, {
  contentName: qe,
  titleName: xr,
  docsSlug: "dialog"
}), vf = ({ titleId: e }) => {
  const t = Xi(zi), n = `\`${t.contentName}\` requires a \`${t.titleName}\` for the component to be accessible for screen reader users.
...
For more information, see https://radix-ui.com/primitives/docs/components/${t.docsSlug}`;
  ...
  const r = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${Xi(mf).contentName}}.`;
  return c.useEffect(() => {
    var i;
    const o = (i = e.current) == null ? void 0 : i.getAttribute("aria-describedby");
    t && o && (document.getElementById(t) || console.warn(r));
  }, [r, e, t]), null;
}, _d = ji, Ad = Li, Md = $i, Od = Wi, Id = Bi, Dd = Hi, Nd = Ki, jd = Yi, gf = "Label", qi = c.forwardRef((e, t) => /* @__PURE__ */ h.jsx(
  F.label,
  {
    ...e,
    ref: t,
