...
var eu = [], gd = !1, Tc, wy = -1;
function nO() {
  !gd || !Tc || (gd = !1, Tc.length ? eu = Tc.concat(eu) : wy = -1, eu.length && IT());
}
function IT() {
  if (!gd) {
    var f = BT(nO);
...
dr.nextTick = function(f) {
  ...
  if (arguments.length > 1)
    for (var m = 1; m < arguments.length; m++)
      v[m - 1] = arguments[m];
  eu.push(new $T(f, v)), eu.length === 1 && !gd && BT(IT);
};
function $T(f, v) {
...
var vT;
function EE() {
  return vT || (vT = 1, ft.env.NODE_ENV === "production" ? Ey.exports = aO() : Ey.exports = iO()), Ey.exports;
}
var hE = { exports: {} }, si = {}, Cy = { exports: {} }, oE = {};
/**
 * @license React
...
var yT;
function QT() {
  return yT || (yT = 1, ft.env.NODE_ENV === "production" ? Cy.exports = lO() : Cy.exports = oO()), Cy.exports;
}
/**
 * @license React
...
` + c[E].replace(" at new ", " at ");
  ...
  function Le(n, r, l, u, c, p, E, b, L) {
    Ce = !1, Pe = null, ae.apply(Ue, arguments);
  }
  ...
  } }), jy = xe(Ji), xd = ge({}, Vt, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), Oc = xe(xd), Dd = ge({}, Yt, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: bd }), Vy = xe(Dd), Lc = ge({}, ot, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), Uv = xe(Lc), da = ge({}, Vt, {
    deltaX: function(n) {
...
`).replace(Xy, "");
  ...
  var jl = Math.random().toString(36).slice(2), Oi = "__reactFiber$" + jl, wo = "__reactProps$" + jl, rl = "__reactContainer$" + jl, Bd = "__reactEvents$" + jl, Jy = "__reactListeners$" + jl, Id = "__reactHandles$" + jl;
  function Ya(n) {
    var r = n[Oi];
    if (r) return r;
  ...
  var Zc = be.ReactCurrentDispatcher, Fs = be.ReactCurrentBatchConfig, We = 0, Ke = null, yt = null, Lt = null, Ma = !1, bu = !1, Ps = 0, Zy = 0;
  function Br() {
    throw Error(m(321));
  }
  function Hs(n, r) {
  ...
  function le(n, r, l, u, c, p) {
    if (We = p, Ke = r, r.memoizedState = null, r.updateQueue = null, r.lanes = 0, Zc.current = n === null || n.memoizedState === null ? eg : Cn, n = l(u, c), bu) {
      p = 0;
      do {
...
` + p.stack;
  ...
  var lg = Math.ceil, Ao = be.ReactCurrentDispatcher, bf = be.ReactCurrentOwner, ei = be.ReactCurrentBatchConfig, At = 0, $n = null, bn = null, or = 0, Ra = 0, Bu = xt(0), ur = 0, Gs = null, Fo = 0, Iu = 0, dp = 0, Kl = null, Yr = null, xf = 0, $u = 1 / 0, sl = null, Df = !1, pp = null, ti = null, Yu = !1, ni = null, _f = 0, Ks = 0, kf = null, Xs = -1, Po = 0;
  function Cr() {
  ...
  function sg(n, r, l, u) {
    ...
    if (Ed(n, p), n === $n && (bn = $n = null, or = 0), !(l.subtreeFlags & 2064) && !(l.flags & 2064) || Yu || (Yu = !0, Ph(Gr, function() {
      ...
      Wt = 1;
      var b = At;
      At |= 4, bf.current = null, ag(n, l), kh(l, n), zc(Ro), Ia = !!Hd, Ro = Hd = null, n.current = l, ig(l), sa(), At = b, Wt = E, ei.transition = p;
    } else n.current = l;
...
var ci = {}, ST;
function sO() {
  return ST || (ST = 1, ft.env.NODE_ENV !== "production" && function() {
    typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(new Error());
    var f = EE(), v = QT(), m = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, C = !1;
    function T(e) {
      C = e;
    }
    function x(e) {
...
Check the render method of \`` + e + "`." : "";
    ...
    var Ji = "http://www.w3.org/1999/xhtml", jy = "http://www.w3.org/1998/Math/MathML", xd = "http://www.w3.org/2000/svg";
    function Oc(e) {
      switch (e) {
        case "svg":
          return xd;
    ...
    var tl = 1, bs = 2, Eo = 4, Gy = tl | bs | Eo, xs = null;
    function Ds(e) {
    ...
    var Vf = null, gg = null, wp = null, Sg = !1;
    function Rw(e) {
    ...
    function ww(e, t, a, i, o, s, d) {
      ...
      switch (t) {
        case "focusin":
          (Ih(h) || h.contentEditable === "true") && (Vf = h, gg = a, wp = null);
          break;
        case "focusout":
          Vf = null, gg = null, wp = null;
          break;
        case "mousedown":
          Sg = !0;
          break;
    ...
    function Dw(e, t, a, i, o, s, d) {
      xw(e, t, a, i, o, s);
      var h = (s & Gy) === 0;
      h && (Ge(e, t, a, i, o), Y(e, t, a, i, o), ww(e, t, a, i, o), hg(e, t, a, i, o));
    }
    ...
    var ai = !1, _p = "dangerouslySetInnerHTML", Gh = "suppressContentEditableWarning", Ku = "suppressHydrationWarning", WE = "autoFocus", rc = "children", ac = "style", Kh = "__html", wg, Xh, kp, GE, qh, KE, XE;
    wg = {
...
`).replace(zw, "");
    ...
    function Hw(e, t, a, i) {
      ...
      return h === Ji && !o && Object.prototype.toString.call(d) === "[object HTMLUnknownElement]" && !vr.call(wg, e) && (wg[e] = !0, y("The tag <%s> is unrecognized in this browser. If you meant to render a React component, start its name with an uppercase letter.", e)), d;
    }
    function jw(e, t) {
    ...
    };
    {
      ...
      Op = function(e, t, a) {
        ...
        var s = qw(e, o) ? null : i, d = s ? null : Jw(e, a), h = s || d;
        if (h) {
          var g = h.tag, R = !!s + "|" + e + "|" + g;
          if (!eC[R]) {
            eC[R] = !0;
    ...
    var tm = "suppressHydrationWarning", nm = "$", rm = "/$", Np = "$?", Mp = "$!", Zw = "style", kg = null, Og = null;
    function eb(e) {
    ...
    var Ng = typeof setTimeout == "function" ? setTimeout : void 0, cb = typeof clearTimeout == "function" ? clearTimeout : void 0, Mg = -1, tC = typeof Promise == "function" ? Promise : void 0, fb = typeof queueMicrotask == "function" ? queueMicrotask : typeof tC < "u" ? function(e) {
    ...
    function Ab(e, t, a, i, o, s, d) {
      ...
      var R = (s.mode & Ke) !== We;
      return Yw(e, t, a, h, i, R, d);
    }
    function Fb(e, t, a, i) {
      return Ap(a, e), a.mode & Ke, Qw(e, t);
    }
    function Pb(e, t) {
      Ap(t, e);
    }
    ...
    var $f = Math.random().toString(36).slice(2), Yf = "__reactFiber$" + $f, Ag = "__reactProps$" + $f, zp = "__reactContainer$" + $f, Fg = "__reactEvents$" + $f, nx = "__reactListeners$" + $f, rx = "__reactHandles$" + $f;
    function ax(e) {
      delete e[Yf], delete e[Ag], delete e[Fg], delete e[nx], delete e[rx];
    }
    function Ap(e, t) {
      t[Yf] = e;
    }
    ...
    function dl(e, t, a, i, o) {
      {
        ...
        for (var d in e)
          if (s(e, d)) {
            ...
            h && !(h instanceof Error) && (om(o), y("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", i || "React class", a, d, typeof h), om(null)), h instanceof Error && !(h.message in lC) && (lC[h.message] = !0, om(o), y("Failed %s type: %s", a, h.message), om(null));
          }
      }
    }
    var Hg = [], um;
    ...
    function mx(e) {
      ...
      return Hi = Ub(t), Zr = e, pl = !0, es = null, sc = !1, !0;
    }
    function yx(e, t, a) {
      return Hi = zb(t), Zr = e, pl = !0, es = null, sc = !1, a !== null && px(e, a), !0;
    }
    function mC(e, t) {
      switch (e.tag) {
        case M: {
    ...
    function Xg(e) {
      if (pl) {
        var t = Hi;
        if (!t) {
          Gg(e) && (Wg(Zr, e), Kg()), gC(Zr, e), pl = !1, Zr = e;
          return;
        }
        var a = t;
        if (!SC(e, t)) {
    ...
    function mm(e) {
      ...
      if (!pl)
        return EC(e), pl = !0, !1;
      if (e.tag !== M && (e.tag !== K || Bb(e.type) && !Lg(e.type, e.memoizedProps))) {
        var t = Hi;
        if (t)
          if (Gg(e))
            CC(e), Kg();
      ...
      return EC(e), e.tag === De ? Hi = Cx(e) : Hi = Zr ? Up(e.stateNode) : null, !0;
    }
    function Rx() {
      return pl && Hi !== null;
    }
...
Learn more about this warning here: https://reactjs.org/link/legacy-context`, o);
    ...
    var Jg, Zg, eS, tS, nS, wC = function(e, t) {
    };
    Jg = !1, Zg = !1, eS = {}, tS = {}, nS = {}, wC = function(e, t) {
...
See https://reactjs.org/link/refs-must-have-owner for more information.`);
    ...
    var rS = qu(null), aS;
    aS = {};
    var Em = null, Zf = null, iS = null, Cm = !1;
    function Rm() {
      Em = null, Zf = null, iS = null, Cm = !1;
    }
    function _C() {
      Cm = !0;
    }
    ...
    var NC = 0, MC = 1, wm = 2, sS = 3, bm = !1, cS, xm;
    cS = !1, xm = null;
    function fS(e) {
      var t = {
    ...
    function ts(e, t, a) {
      ...
      if (i === null)
        return null;
      var o = i.shared;
      if (xm === o && !cS && (y("An update (setState, replaceState, or forceUpdate) was scheduled from inside an update function. Update functions should be pure, with zero side-effects. Consider using componentDidUpdate or a callback."), cS = !0), M_()) {
        var s = o.pending;
    ...
    var Px = 0, HC = 1, jC = 1, Wp = 2, hl = qu(Px);
    function mS(e, t) {
      return (e & t) !== 0;
    }
    function nd(e) {
    ...
    var Me = m.ReactCurrentDispatcher, Gp = m.ReactCurrentBatchConfig, ES, ad;
    ES = /* @__PURE__ */ new Set();
    var pc = le, cn = null, Lr = null, Nr = null, Mm = !1, Kp = !1, Xp = 0, Bx = 0, Ix = 25, ne = null, ji = null, as = -1, CS = !1;
    function rn() {
      {
        var e = ne;
...
Incoming: %s`, ne, "[" + t.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function ld(e, t, a, i, o, s) {
      pc = s, cn = t, ji = e !== null ? e._debugHookTypes : null, as = -1, CS = e !== null && e.type !== t.type, t.memoizedState = null, t.updateQueue = null, t.lanes = le, e !== null && e.memoizedState !== null ? Me.current = uR : ji !== null ? Me.current = oR : Me.current = lR;
      var d = a(i, o);
      if (Kp) {
        var h = 0;
        do {
          ...
          h += 1, CS = !1, Lr = null, Nr = null, t.updateQueue = null, as = -1, Me.current = sR, d = a(i, o);
        } while (Kp);
      }
    ...
    function BC() {
      ...
      pc = le, cn = null, Lr = null, Nr = null, ji = null, as = -1, ne = null, tR = !1, Kp = !1, Xp = 0;
    }
    function no() {
      var e = {
        memoizedState: null,
    ...
    function DS(e, t, a) {
      ...
      return o.queue = R, Pm(QC.bind(null, i, R, e), [e]), i.flags |= kn, qp(kr | ta, YC.bind(null, i, R, s, t), void 0, null), s;
    }
    function Um(e, t, a) {
      var i = cn, o = Vi(), s = t();
      if (!ad) {
      ...
      Nr !== null && Nr.memoizedState.tag & kr) {
        i.flags |= kn, qp(kr | ta, YC.bind(null, i, R, s, t), void 0, null);
        var w = fy();
        if (w === null)
          throw new Error("Expected a work-in-progress root. This is a bug in React. Please file an issue.");
        Is(w, pc) || $C(i, t, s);
    ...
    function MS(e, t, a) {
      ...
      return o |= va, (cn.mode & Ma) !== We && (o |= ha), Jp(o, Or, KC.bind(null, t, e), i);
    }
    function Vm(e, t, a) {
      typeof t != "function" && y("Expected useImperativeHandle() second argument to be a function that creates a handle. Instead received: %s.", t !== null ? typeof t : "null");
      var i = a != null ? a.concat([e]) : null;
      return Fm(xt, Or, KC.bind(null, t, e), i);
    }
    function Yx(e, t) {
    }
    var Bm = Yx;
    ...
    }, lR = null, oR = null, uR = null, sR = null, ro = null, ml = null, Wm = null;
    {
      var HS = function() {
    ...
    var is = v.unstable_now, cR = 0, Gm = -1, ev = -1, Km = -1, jS = !1, Xm = !1;
    function fR() {
      return jS;
    }
    function Xx() {
    ...
    var YS = {}, QS, WS, GS, KS, XS, hR, Jm, qS, JS, ZS, tv;
    {
...
https://reactjs.org/link/unsafe-component-lifecycles`, _e, at, W !== null ? `
  ...
  ` + Z : ""));
    ...
    function n0(e, t, a, i) {
      ...
      if (typeof g == "function" && (e0(e, t, g, a), o.state = e.memoizedState), typeof t.getDerivedStateFromProps != "function" && typeof o.getSnapshotBeforeUpdate != "function" && (typeof o.UNSAFE_componentWillMount == "function" || typeof o.componentWillMount == "function") && (eD(e, o), _m(e, a, o, i), o.state = e.memoizedState), typeof o.componentDidMount == "function") {
        var R = xt;
    ...
    function nD(e, t, a, i, o) {
      ...
      var at = km() || yR(t, a, h, i, Z, _e, z) || // TODO: In some cases, we'll end up checking if context has changed twice,
...
` + ("" + R);
    ...
    function i0(e, t, a) {
      ...
      return d !== null && typeof d.componentDidCatch == "function" && (i.callback = function() {
        N1(e), a0(e, t), typeof o != "function" && G_(this);
    ...
    function oD(e, t, a, i, o) {
      if (a.flags |= ka, Na && gv(e, o), i !== null && typeof i == "object" && typeof i.then == "function") {
        ...
        var g = TR(t);
        if (g !== null) {
          (g.flags & gr) === rt && (g.flags |= Bn), wR(g, t, a, e, o), qg(vc(i, a));
          return;
        }
      }
      i = vc(i, a), j_(i);
    ...
    var nv = m.ReactCurrentOwner, gl = !1, l0, rv, o0, u0, s0, hc, c0, Zm, av;
    ...
    function bR(e, t, a, i, o) {
      ...
      return ga(), e !== null && !gl ? (VC(e, t, o), Go(e, t, o)) : (ea() && R && Yg(t), t.flags |= Vl, za(e, t, g, o), t.child);
    }
    ...
    function DR(e, t, a, i, o) {
      ...
      if (e !== null) {
        ...
        t.type === e.type)
          if (gl = !1, t.pendingProps = i = w, S0(e, o))
            (e.flags & Us) !== rt && (gl = !0);
    ...
    function OR(e, t, a, i, o) {
      ...
      var q = t.stateNode, Z;
      q === null ? (ty(e, t), SR(t, a, i), n0(t, a, i, o), Z = !0) : e === null ? Z = tD(t, a, i, o) : Z = nD(e, t, a, i, o);
    ...
    function d0(e, t, a, i, o, s) {
      ...
      return t.flags |= Vl, e !== null && d ? sD(e, t, g, s) : za(e, t, g, s), t.memoizedState = h.state, o && fC(t, a, !0), t.child;
    }
    function LR(e) {
      var t = e.stateNode;
    ...
    function mD(e, t, a, i) {
      ...
      t.type = g;
      var R = t.tag = hk(g), w = yl(g, o), z;
      switch (R) {
        case _:
          return p0(t, g), t.type = g = hd(g), z = f0(null, t, g, w, i), z;
        case O:
          return t.type = g = I0(g), z = OR(null, t, g, w, i), z;
        case ye:
          return t.type = g = $0(g), z = bR(null, t, g, w, i), z;
        case I: {
          if (t.type !== t.elementType) {
            var N = g.propTypes;
            N && dl(
    ...
    function yD(e, t, a, i, o) {
      ty(e, t), t.tag = O;
      var s;
      return eo(a) ? (s = !0, fm(t)) : s = !1, ed(t, o), SR(t, a, i), n0(t, a, i, o), d0(null, t, a, !0, s, o);
    }
    function gD(e, t, a, i) {
      ty(e, t);
      ...
      if (
        ...
        var N = !1;
        return eo(a) ? (N = !0, fm(t)) : N = !1, t.memoizedState = h.state !== null && h.state !== void 0 ? h.state : null, fS(t), gR(t, h), n0(t, a, o, i), d0(null, t, a, !0, N, i);
      } else {
...
Check the render method of \`` + i + "`.");
    ...
    function MR(e, t, a) {
      ...
      if (d || ED(o, e) ? (s = !0, t.flags &= ~mt) : (e === null || e.memoizedState !== null) && (o = Hx(o, jC)), o = nd(o), rs(t, o), e === null) {
        Xg(t);
        ...
        if (s) {
          ...
          return Xe.memoizedState = $t === null ? h0(a) : SD($t, a), Xe.childLanes = CD(e, a), t.memoizedState = v0, at;
        } else {
    ...
    function RD(e, t, a, i) {
      ...
      return (o & Ke) === We && s !== null ? (h = s, h.childLanes = le, h.pendingProps = d, e.mode & yt && (h.actualDuration = 0, h.actualStartTime = -1, h.selfBaseDuration = 0, h.treeBaseDuration = 0), g = fs(a, o, i, null)) : (h = y0(d, o), g = fs(a, o, i, null)), h.return = e, g.return = e, h.sibling = g, e.child = h, g;
    }
    function y0(e, t, a) {
    ...
    function bD(e, t, a, i, o) {
      var s = t.mode, d = {
        mode: "visible",
        children: a
      }, h = y0(d, s), g = fs(i, s, o, null);
      return g.flags |= Tn, h.return = t, g.return = t, h.sibling = g, t.child = h, (t.mode & Ke) !== We && Jf(t, e.child, null, o), g;
    }
    function xD(e, t, a) {
      return (e.mode & Ke) === We ? (y("Cannot hydrate Suspense in legacy mode. Switch from ReactDOM.hydrate(element, container) to ReactDOMClient.hydrateRoot(container, <App />).render(element) or remove the Suspense components from the server rendered components."), e.lanes = Je) : zg(t) ? e.lanes = ol : e.lanes = Ir, null;
    }
    ...
    function FR(e, t, a) {
      ...
      var h = hl.current, g = mS(h, Wp);
      if (g)
        h = yS(h, Wp), t.flags |= mt;
      else {
        var R = e !== null && (e.flags & mt) !== rt;
        R && _D(t, t.child, a), h = nd(h);
      }
    ...
    function Go(e, t, a) {
      return e !== null && (t.dependencies = e.dependencies), vR(), yv(t.lanes), Ca(a, t.childLanes) ? (_x(e, t), t.child) : null;
    }
    function AD(e, t, a) {
      {
        var i = t.return;
    ...
    function jR(e, t, a) {
      if (t._debugNeedsRemount && e !== null)
        return AD(e, t, K0(t.type, t.key, t.pendingProps, t._debugOwner || null, t.mode, t.lanes));
      if (e !== null) {
        ...
        t.type !== e.type)
          ...
          (t.flags & mt) === rt)
            return gl = !1, FD(e, t, a);
          (e.flags & Us) !== rt ? gl = !0 : gl = !1;
        }
      } else if (gl = !1, ea() && ux(t)) {
        var d = t.index, h = sx();
        vC(t, h, d);
      }
      switch (t.lanes = le, t.tag) {
        ...
        case I: {
          ...
          return Ft = yl(Xe.type, Ft), xR(e, t, Xe, Ft, a);
        }
        case Fe:
    ...
    BR = function(e, t, a, i) {
      ...
      if (s !== i) {
        var d = t.stateNode, h = vS(), g = ob(d, a, s, i, o, h);
    ...
    function YR(e, t, a) {
      ...
      switch (Qg(t), t.tag) {
        ...
        case K: {
          ...
          if (e !== null && t.stateNode != null)
            ...
            if (z)
              ...
              var N = ab(R, i, g, w, t);
              BR(N, t, !1, !1), t.stateNode = N, lb(N, R, i, g) && ud(t);
            }
            t.ref !== null && VR(t);
          }
          return na(t), null;
        ...
        case re: {
          ...
          if (e && t.stateNode != null) {
            ...
            if (typeof W != "string" && t.stateNode === null)
              throw new Error("We must have new props for new mounts. This error is likely caused by a bug in React. Please file an issue.");
            var Z = FC(), _e = vS(), at = mm(t);
            at ? Sx(t) && ud(t) : t.stateNode = ub(W, Z, _e, t);
          }
          return na(t), null;
        }
        case De: {
        ...
        case B:
          return td(t), E0(e, t), e === null && tx(t.stateNode.containerInfo), na(t), null;
        case he:
        ...
        case pt: {
              ...
              if (!fr)
                for (var Xt = t.child; Xt !== null; ) {
                  ...
                  if (rr !== null) {
                    ...
                    return xa !== null && (t.updateQueue = xa, t.flags |= xt), t.subtreeFlags = rt, kx(t, a), rs(t, yS(hl.current, Wp)), t.child;
                  }
                  Xt = Xt.sibling;
                }
          ...
          if (Rt.tail !== null) {
            ...
            var Da = hl.current;
            return fn ? Da = yS(Da, Wp) : Da = nd(Da), rs(t, Da), Ha;
          }
          return na(t), null;
        }
        case Mt:
    ...
    var WR = null;
    WR = /* @__PURE__ */ new Set();
    var ny = !1, ra = !1, jD = typeof WeakSet == "function" ? WeakSet : Set, $e = null, sd = null, cd = null;
    function VD(e) {
      wo(null, function() {
        throw e;
      }), Id();
...
Learn more about data fetching with Hooks: https://reactjs.org/link/hooks-data-fetching` : R = " You returned: " + h, y("%s must not return anything besides a function, which is used for clean-up.%s", g, R);
    ...
    function t1(e, t, a) {
      switch (Do(a), a.tag) {
        ...
        case re: {
          {
            var i = aa, o = El;
            aa = null, os(e, t, a), aa = i, El = o, aa !== null && (El ? Cb(aa, a.stateNode) : Eb(aa, a.stateNode));
          }
          return;
        }
        case et: {
          aa !== null && (El ? Rb(aa, a.stateNode) : Ug(aa, a.stateNode));
          return;
        }
        case B: {
          {
    ...
    function h_(e) {
      switch (e.tag) {
        ...
        case ye:
        case Fe: {
          e.mode & yt ? (IS(), Sl(ta | kr, e, e.return), BS(e)) : Sl(ta | kr, e, e.return);
          break;
        }
      }
    }
    ...
    function g_(e, t) {
      switch (e.tag) {
        ...
        case ye:
        case Fe: {
          e.mode & yt ? (IS(), Sl(ta, e, t), BS(e)) : Sl(ta, e, t);
          break;
        }
      }
    }
    ...
    var D_ = Math.ceil, b0 = m.ReactCurrentDispatcher, x0 = m.ReactCurrentOwner, ia = m.ReactCurrentBatchConfig, Rl = m.ReactCurrentActQueue, Mr = (
      /*             */
      0
    ), u1 = (
      /*               */
      ...
      /*                */
      4
    ), Ko = 0, uv = 1, mc = 2, ay = 3, sv = 4, s1 = 5, D0 = 6, It = Mr, Aa = null, qn = null, Ur = le, oo = le, _0 = qu(le), zr = Ko, cv = null, iy = le, fv = le, ly = le, dv = null, oi = null, k0 = 0, c1 = 500, f1 = 1 / 0, __ = 500, Xo = null;
    function pv() {
      f1 = zn() + __;
    }
    function d1() {
    ...
    var oy = !1, O0 = null, dd = null, yc = !1, us = null, vv = le, L0 = [], N0 = null, k_ = 50, hv = 0, M0 = null, U0 = !1, uy = !1, O_ = 50, pd = 0, sy = null, mv = Cn, cy = le, p1 = !1;
    function fy() {
      return Aa;
    }
    function Fa() {
    ...
    function Ar(e, t, a, i) {
      tk(), p1 && y("useInsertionEffect must not schedule updates."), U0 && (uy = !0), zo(e, a, i), (It & la) !== le && e === Aa ? ak(t) : (Na && Ef(e, t, a), ik(t), e === Aa && ((It & la) === Mr && (fv = bt(fv, a)), zr === sv && cs(e, Ur)), ui(e, i), a === Je && It === Mr && (t.mode & Ke) === We && // Treat `act` as if it's inside `batchedUpdates`, even in legacy mode.
      !Rl.isBatchingLegacy && (pv(), pC()));
    }
    function N_(e, t, a) {
      var i = e.current;
    ...
    function ui(e, t) {
      ...
      var d;
      if (o === Je)
        e.tag === Ju ? (Rl.isBatchingLegacy !== null && (Rl.didScheduleLegacyUpdate = !0), ox(m1.bind(null, e))) : dC(m1.bind(null, e)), Rl.current !== null ? Rl.current.push(Zu) : fb(function() {
          (It & (la | Bi)) === Mr && Zu();
        }), d = null;
      else {
        var h;
      ...
      switch (t) {
        ...
        case sv: {
          if (cs(e, a), Ch(a))
            break;
          if (!O1()) {
            var d = mh(e, a), h = d, g = zn() - h, R = ek(g) - g;
            if (R > 10) {
    ...
    function gc(e, t) {
      ...
      if (a !== Mg && (e.timeoutHandle = Mg, cb(a)), qn !== null)
      ...
      return qn = s, Ur = oo = t, zr = Ko, cv = null, iy = le, fv = le, ly = le, dv = null, oi = null, Nx(), vl.discardPendingWarnings(), s;
    }
    function g1(e, t) {
      do {
        var a = qn;
        try {
          if (Rm(), BC(), Vn(), x0.current = null, a === null || a.return === null) {
            zr = uv, cv = t, qn = null;
            return;
          }
    ...
    function I_(e, t) {
      ...
      while (!0);
      return Rm(), E1(i), It = a, qn !== null ? (qc(), Ko) : (Jc(), Aa = null, Ur = le, zr);
    }
    function $_() {
      for (; qn !== null && !Yc(); )
        C1(qn);
    ...
    function C1(e) {
      ...
      tn(e);
      var a;
      (e.mode & yt) !== We ? (VS(e), a = H0(t, e, oo), qm(e, !0)) : a = H0(t, e, oo), Vn(), e.memoizedProps = e.pendingProps, a === null ? R1(e) : qn = a, x0.current = null;
    }
    function R1(e) {
      var t = e;
      do {
        ...
        if ((t.flags & ka) === rt) {
          tn(t);
          var o = void 0;
          if ((t.mode & yt) === We ? o = YR(a, t, oo) : (VS(t), o = YR(a, t, oo), qm(t, !1)), Vn(), o !== null) {
            qn = o;
            return;
          }
        } else {
    ...
    function Y_(e, t, a, i) {
      ...
      Sf(e, d), e === Aa && (Aa = null, qn = null, Ur = le), ((o.subtreeFlags & Ga) !== rt || (o.flags & Ga) !== rt) && (yc || (yc = !0, N0 = a, B0(Ni, function() {
        return Jo(), null;
      })));
      ...
      if (h || g) {
        ...
        In(Kn);
        var z = It;
        It |= Bi, x0.current = null, $D(e, o), pR(), a_(e, o, s), rb(e.containerInfo), e.current = o, Jd(s), i_(o, e, s), wu(), uh(), It = z, In(w), ia.transition = R;
      } else
        e.current = o, pR();
      var N = yc;
      if (yc ? (yc = !1, us = e, vv = s) : (pd = 0, sy = null), d = e.pendingLanes, d === le && (dd = null), N || x1(e.current, !1), Cu(o.stateNode, i), Na && e.memoizedUpdaters.clear(), w_(), ui(e, zn()), t !== null)
      ...
      return Ca(vv, Je) && e.tag !== Ju && Jo(), d = e.pendingLanes, Ca(d, Je) ? (Xx(), e === M0 ? hv++ : (hv = 0, M0 = e)) : hv = 0, Zu(), Gc(), null;
    }
    function Jo() {
      if (us !== null) {
        var e = _r(vv), t = rg(Mi, e), a = ia.transition, i = Za();
        try {
    ...
    function W_() {
      ...
      Zd(), x1(t.current, !0), It = i, Zu(), uy ? t === sy ? pd++ : (pd = 0, sy = t) : pd = 0, U0 = !1, uy = !1, qa(t);
      {
      ...
      for (i = t; i !== null; ) {
        if (i.tag === M) {
          ...
          if (typeof o.getDerivedStateFromError == "function" || typeof s.componentDidCatch == "function" && !T1(s)) {
            var d = vc(a, e), h = i0(i, d, Je), g = ts(i, h, Je), R = Fa();
...
%s`, a);
    ...
    function q_(e, t, a) {
      ...
      i !== null && i.delete(t);
      var o = Fa();
      gf(e, a), lk(e), Aa === e && Uo(Ur, a) && (zr === sv || zr === ay && Sh(Ur) && zn() - k0 < c1 ? gc(e, le) : ly = bt(ly, a)), ui(e, o);
    }
    function b1(e, t) {
      t === nr && (t = L_(e));
      var a = Fa(), i = ii(e, t);
    ...
    function tk() {
      ...
      pd > O_ && (pd = 0, sy = null, y("Maximum update depth exceeded. This can happen when a component calls setState inside useEffect, but useEffect either doesn't have a dependency array, or one of the dependencies changes on every render."));
    }
    function nk() {
      ...
      H0 = function(e, t, a) {
        ...
        try {
          ...
          if (hx() || s !== null && typeof s == "object" && typeof s.then == "function")
            throw s;
          if (Rm(), BC(), QR(e, t), z1(t, i), t.mode & yt && VS(t), wo(null, jR, null, e, t, a), Jy()) {
            var o = Id();
    ...
    function ik(e) {
      {
        if (e.mode & Ke) {
          if (!o1())
            return;
        } else if (!x_() || It !== Mr || e.tag !== _ && e.tag !== ye && e.tag !== Fe)
          return;
        if (Rl.current === null) {
          var t = Un;
          try {
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://reactjs.org/link/wrap-tests-with-act`, Et(e));
    ...
    function lk(e) {
      e.tag !== Ju && o1() && Rl.current === null && y(`A suspended resource finished loading inside a test, but the event was not wrapped in act(...).
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://reactjs.org/link/wrap-tests-with-act`);
    ...
    var Ii = null, vd = null, ok = function(e) {
      Ii = e;
    };
    function hd(e) {
      {
    ...
    function Q0(e, t, a) {
      {
        ...
        var g = !1;
        h !== null && t.has(h) && (g = !0), g ? fk(e, a) : i !== null && Q0(i, t, a), o !== null && Q0(o, t, a);
      }
    }
    function fk(e, t) {
      {
...
Check the render method of \`` + R + "`.");
    ...
    function A1(e, t, a, i, o, s, d, h, g, R) {
      var w = new Tk(e, t, a, h, g), z = yk(t, s);
    ...
    function H1(e, t, a, i, o, s, d, h, g, R) {
      var w = !0, z = A1(a, i, w, e, o, s, d, h, g);
      z.context = F1(null);
      var N = z.current, W = Fa(), q = ss(N), Z = Wo(W, q);
      return Z.callback = t ?? null, ts(N, Z, q), N_(z, q, W), z;
    }
    function Ev(e, t, a, i) {
      qd(t, e);
...
Check the render method of %s.`, Et(Un) || "Unknown"));
    ...
    function zk(e, t) {
      ...
      lT(e);
      var a = !1, i = !1, o = "", s = iT;
      t != null && (t.hydrate ? x("hydrate through createRoot is deprecated. Use ReactDOMClient.hydrateRoot(container, <App />) instead.") : typeof t == "object" && t !== null && t.$$typeof === ae && y(`You passed a JSX element to createRoot. You probably meant to call root.render instead. Example usage:
  ...
  root.render(<App />);`), t.unstable_strictMode === !0 && (a = !0), t.identifierPrefix !== void 0 && (o = t.identifierPrefix), t.onRecoverableError !== void 0 && (s = t.onRecoverableError), t.transitionCallbacks !== void 0 && t.transitionCallbacks);
    ...
    function Fk(e, t, a) {
      ...
      var i = a ?? null, o = a != null && a.hydratedSources || null, s = !1, d = !1, h = "", g = iT;
      ...
      var R = H1(t, null, e, dm, i, s, d, h, g);
    ...
    Au(xk), ag(Dk), Tf(_k), Dh(Za), _h($r), (typeof Map != "function" || // $FlowIssue Flow incorrectly thinks Map has no prototype
    Map.prototype == null || typeof Map.prototype.forEach != "function" || typeof Set != "function" || // $FlowIssue Flow incorrectly thinks Set has no prototype
    Set.prototype == null || typeof Set.prototype.clear != "function" || typeof Set.prototype.forEach != "function") && y("React depends on Map and Set built-in types. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"), rh(Ww), Hc(A0, F_, qo);
    function Qk(e, t) {
    ...
    var lE = {
      ...
      Events: [Xu, Qf, lm, Pc, ks, A0]
    };
    function Gk(e, t) {
      return lE.usingClientEntryPoint || y('You are importing createRoot from "react-dom" which is not supported. You should instead import it from "react-dom/client".'), zk(e, t);
    }
    function Kk(e, t, a) {
      return lE.usingClientEntryPoint || y('You are importing hydrateRoot from "react-dom" which is not supported. You should instead import it from "react-dom/client".'), Fk(e, t, a);
    }
    function Xk(e) {
...
You might need to use a local HTTP server (instead of file://): https://reactjs.org/link/react-devtools-faq` : ""), "font-weight:bold");
    ...
    ci.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = lE, ci.createPortal = Qk, ci.createRoot = Gk, ci.findDOMNode = Vk, ci.flushSync = Xk, ci.hydrate = Bk, ci.hydrateRoot = Kk, ci.render = Ik, ci.unmountComponentAtNode = Yk, ci.unstable_batchedUpdates = A0, ci.unstable_renderSubtreeIntoContainer = Wk, ci.version = Z0, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
  }()), ci;
}
function WT() {
...
ft.env.NODE_ENV === "production" ? (WT(), hE.exports = uO()) : hE.exports = sO();
var GT = hE.exports;
...
var ie = EE();
const dO = /* @__PURE__ */ YT(ie), pO = /* @__PURE__ */ jT({
  __proto__: null,
  default: dO
}, [ie]);
/**
...
function mO(f, v, m, C) {
  ...
  let ue = {
    ...
    listen(pe) {
      ...
      return T.addEventListener(ET, M), _ = pe, () => {
        T.removeEventListener(ET, M), _ = null;
      };
    },
    createHref(pe) {
      return v(T, pe);
...
function _y(f, v, m, C) {
  return m === void 0 && (m = []), C === void 0 && (C = {}), f.map((T, x) => {
    ...
    if (dt(T.index !== !0 || !T.children, "Cannot specify children on an index route"), dt(!C[F], 'Found a route id collision on id "' + F + `".  Route id's must be globally unique within Data Router usages`), gO(T)) {
      let _ = Qn({}, T, v(T), {
        id: F
      });
      return C[F] = _, _;
      ...
      return C[F] = _, T.children && (_.children = _y(T.children, v, y, C)), _;
    }
  });
}
function Cc(f, v, m) {
  return m === void 0 && (m = "/"), by(f, v, m, !1);
}
function by(f, v, m, C) {
...
function KT(f, v, m, C) {
  ...
  let T = (x, y, F) => {
    ...
    ), KT(x.children, v, $, O)), !(x.path == null && !x.index) && v.push({
      path: O,
      score: DO(O, x.index),
      routesMeta: $
    });
...
function EO(f) {
  f.sort((v, m) => v.score !== m.score ? m.score - v.score : _O(v.routesMeta.map((C) => C.childrenIndex), m.routesMeta.map((C) => C.childrenIndex)));
}
const CO = /^:[\w-]+$/, RO = 3, TO = 2, wO = 1, bO = 10, xO = -2, RT = (f) => f === "*";
function DO(f, v) {
  let m = f.split("/"), C = m.length;
  return m.some(RT) && (C += xO), v && (C += TO), m.filter((T) => !RT(T)).reduce((T, x) => T + (CO.test(x) ? RO : x === "" ? wO : bO), C);
}
function _O(f, v) {
...
function kO(f, v, m) {
  ...
  for (let F = 0; F < C.length; ++F) {
    let _ = C[F], O = F === C.length - 1, $ = x === "/" ? v : v.slice(x.length) || "/", M = ky({
      path: _.relativePath,
    ...
    Object.assign(T, M.params), y.push({
      ...
      pathnameBase: UO(fo([x, M.pathnameBase])),
      route: B
...
function ky(f, v) {
  ...
  let [m, C] = OO(f.path, f.caseSensitive, f.end), T = v.match(m);
  if (!T) return null;
...
function NO(f, v) {
  ...
  return {
    pathname: m ? m.startsWith("/") ? m : MO(m, v) : v,
    search: zO(C),
    hash: AO(T)
  };
}
...
function RE(f, v, m, C) {
  C === void 0 && (C = !1);
  let T;
  typeof f == "string" ? T = ys(f) : (T = Qn({}, f), dt(!T.pathname || !T.pathname.includes("?"), sE("?", "pathname", "search", T)), dt(!T.pathname || !T.pathname.includes("#"), sE("#", "pathname", "hash", T)), dt(!T.search || !T.search.includes("#"), sE("#", "search", "hash", T)));
  ...
  let _ = NO(T, F), O = y && y !== "/" && y.endsWith("/"), $ = (x || y === ".") && m.endsWith("/");
...
const JT = ["post", "put", "patch", "delete"], FO = new Set(JT), PO = ["get", ...JT], HO = new Set(PO), jO = /* @__PURE__ */ new Set([301, 302, 303, 307, 308]), VO = /* @__PURE__ */ new Set([307, 308]), cE = {
  state: "idle",
  location: void 0,
  formMethod: void 0,
  formAction: void 0,
...
function $O(f) {
  ...
  if (f.mapRouteProperties)
    ...
    T = IO;
  let x = {}, y = _y(f.routes, T, void 0, x), F, _ = f.basename || "/", O = f.dataStrategy || GO, $ = f.patchRoutesOnNavigation, M = Qn({
    v7_fetcherPersist: !1,
  ...
  if (he)
    if (he.some((k) => k.route.lazy))
      ...
      if (P) {
        let Q = he.findIndex((ae) => P[ae.route.id] !== void 0);
        be = he.slice(0, Q + 1).every((ae) => !yE(ae.route, k, P));
      } else
  ...
  function zt() {
    if (B = f.history.listen((k) => {
      ...
      Fr(St.size === 0 || ae != null, "You are trying to use a blocker on a POP navigation to a location that was not created by @remix-run/router. This will fail silently in production. This can happen if you are navigating outside the router via `window.history.pushState`/`window.location.hash` instead of using router navigation APIs.  This can also happen if you are using createHashRouter and the user manually changes the URL.");
      let Ce = on({
  ...
  function en(k, P) {
    ...
    M.v7_fetcherPersist && I.fetchers.forEach((Ce, Pe) => {
      Ce.state === "idle" && (qe.has(Pe) ? ae.push(Pe) : Q.push(Pe));
    }), [...K].forEach((Ce) => Ce(I, {
      deletedFetchers: ae,
      viewTransitionOpts: P.viewTransitionOpts,
      flushSync: P.flushSync === !0
    })), M.v7_fetcherPersist && (Q.forEach((Ce) => I.fetchers.delete(Ce)), ae.forEach((Ce) => Wr(Ce)));
  }
  function pr(k, P, Q) {
    var ae, Ce;
    let {
      flushSync: Pe
    } = Q === void 0 ? {} : Q, lt = I.actionData != null && I.navigation.formMethod != null && Tl(I.navigation.formMethod) && I.navigation.state === "loading" && ((ae = k.state) == null ? void 0 : ae._isRedirect) !== !0, ke;
    P.actionData ? Object.keys(P.actionData).length > 0 ? ke = P.actionData : ke = null : lt ? ke = I.actionData : ke = null;
    let Ue = P.loaderData ? LT(I.loaderData, P.loaderData, P.matches || [], P.errors) : I.loaderData, Le = I.blockers;
  ...
  async function Dn(k, P) {
    ...
    let Q = mE(I.location, I.matches, _, M.v7_prependBasename, k, M.v7_relativeSplatPath, P == null ? void 0 : P.fromRouteId, P == null ? void 0 : P.relative), {
      ...
      submission: Ce,
      error: Pe
    } = TT(M.v7_normalizeFormMethod, !1, Q, P), lt = I.location, ke = _v(I.location, ae, P && P.state);
  ...
  async function Pn(k, P, Q) {
    ...
    let ae = F || y, Ce = Q && Q.overrideNavigation, Pe = Cc(ae, P, _), lt = (Q && Q.flushSync) === !0, ke = Yi(Pe, ae, P.pathname);
    ...
    if (I.initialized && !it && eL(I.location, P) && !(Q && Q.submission && Tl(Q.submission.formMethod))) {
      pr(P, {
        matches: Pe
      }, {
        flushSync: lt
    ...
    if (Q && Q.pendingError)
      ...
      if (Tt.pendingActionResult) {
        ...
        if (wi(pn) && My(pn.error) && pn.error.status === 404) {
          Ze = null, pr(P, {
            matches: Tt.matches,
            loaderData: {},
            errors: {
      ...
      Pe = Tt.matches || Pe, Le = Tt.pendingActionResult, Ce = fE(P, Q.submission), lt = !1, ke.active = !1, Ue = yd(f.history, Ue.url, Ue.signal);
    }
    let {
      shortCircuited: Re,
      matches: vt,
  ...
  async function Pr(k, P, Q, ae, Ce, Pe) {
    Pe === void 0 && (Pe = {}), Qr();
    let lt = lL(P, Q);
    if (en({
      navigation: lt
      ...
      let Le = await Qi(ae, P.pathname, k.signal);
      if (Le.type === "aborted")
        return {
          shortCircuited: !0
        };
    ...
    else if (ke = (await wr("action", I, k, [Ue], ae, null))[Ue.route.id], k.signal.aborted)
      return {
        shortCircuited: !0
      };
    if (wc(ke)) {
      let Le;
      return Pe && Pe.replace != null ? Le = Pe.replace : Le = _T(ke.response.headers.get("Location"), new URL(k.url), _) === I.location.pathname + I.location.search, await Hn(k, ke, !0, {
        submission: Q,
        replace: Le
      }), {
        shortCircuited: !0
  ...
  async function Jn(k, P, Q, ae, Ce, Pe, lt, ke, Ue, Le, Re) {
    let vt = Ce || fE(P, Pe), _t = Pe || lt || zT(vt), gn = !tt && (!M.v7_partialHydration || !Ue);
    if (ae) {
      if (gn) {
        let an = ua(Re);
        en(Qn({
    ...
    let Tt = F || y, [Ht, pn] = bT(f.history, I, Q, _t, P, M.v7_partialHydration && Ue === !0, M.v7_skipActionErrorRevalidation, it, qt, Pt, qe, te, A, Tt, _, Re);
  ...
  function di(k) {
    return k.forEach((P) => {
      let Q = I.fetchers.get(P.key), ae = wv(void 0, Q ? Q.data : void 0);
      I.fetchers.set(P.key, ae);
    }), new Map(I.fetchers);
  }
  function hr(k, P, Q, ae) {
    if (C)
      throw new Error("router.fetch() was called during the server render, but it shouldn't be. You are likely calling a useFetcher() method in the body of your component. Try moving it to a useEffect or a callback.");
    Ve(k);
    let Ce = (ae && ae.flushSync) === !0, Pe = F || y, lt = mE(I.location, I.matches, _, M.v7_prependBasename, Q, M.v7_relativeSplatPath, P, ae == null ? void 0 : ae.relative), ke = Cc(Pe, lt, _), Ue = Yi(ke, Pe, lt);
    ...
    let {
      ...
      submission: Re,
      error: vt
    } = TT(M.v7_normalizeFormMethod, !0, lt, ae);
    if (vt) {
      Mn(k, P, vt, {
        flushSync: Ce
      });
    ...
    let _t = Dv(ke, Le), gn = (ae && ae.preventScrollReset) === !0;
  ...
  async function Hr(k, P, Q, ae, Ce, Pe, lt, ke, Ue) {
    Qr(), te.delete(k);
    function Le(Sn) {
    ...
    if (Pe) {
      ...
      if (Sn.type === "error") {
        ...
        if (Ce = Sn.matches, ae = Dv(Ce, Q), Le(ae))
          return;
      } else {
        Mn(k, P, fi(404, {
          pathname: Q
    ...
    Se.set(k, vt);
    let gn = ve, Ht = (await wr("action", I, _t, [ae], Ce, k))[ae.route.id];
    ...
    I.fetchers.set(k, sn);
    let [Wi, ir] = bT(f.history, I, _a, Ue, pn, !1, M.v7_skipActionErrorRevalidation, it, qt, Pt, qe, te, A, Di, _, [ae.route.id, Ht]);
    ...
    Jt(sa), I.navigation.state === "loading" && sa > Qe ? (dt(Fe, "Expected pending action"), Ze && Ze.abort(), pr(I.navigation.location, {
      ...
      errors: Zn,
      loaderData: LT(I.loaderData, Kr, _a, Zn),
      fetchers: new Map(I.fetchers)
    }), it = !1);
  }
  async function ja(k, P, Q, ae, Ce, Pe, lt, ke, Ue) {
    ...
    Se.set(k, Re);
    let _t = ve, Tt = (await wr("loader", I, vt, [ae], Ce, k))[ae.route.id];
    if (ps(Tt) && (Tt = await wE(Tt, vt.signal, !0) || Tt), Se.get(k) === Re && Se.delete(k), !vt.signal.aborted) {
      if (qe.has(k)) {
        yn(k, ds(void 0));
        return;
      }
  ...
  async function Hn(k, P, Q, ae) {
    ...
    dt(Ue, "Expected a Location header on the redirect Response"), Ue = _T(Ue, new URL(k.url), _);
    ...
    !Ce && !Pe && vt && _t && gn && (Ce = zT(I.navigation));
    let Tt = Ce || Pe;
    if (VO.has(P.response.status) && Tt && Tl(Tt.formMethod))
      await Pn(Re, Le, {
        submission: Qn({}, Tt, {
          formAction: Ue
        }),
  ...
  async function wr(k, P, Q, ae, Ce, Pe) {
    let lt, ke = {};
    try {
      lt = await KO(O, k, P, Q, ae, Ce, Pe, x, T);
    } catch (Ue) {
    ...
    for (let [Ue, Le] of Object.entries(lt))
      if (tL(Le)) {
        ...
        ke[Ue] = {
          type: Rn.redirect,
          response: JO(Re, Q, Ue, Ce, _, M.v7_relativeSplatPath)
        };
      } else
        ke[Ue] = await qO(Le);
    return ke;
  }
  async function br(k, P, Q, ae, Ce) {
    let Pe = k.matches, lt = wr("loader", k, Ce, Q, P, null), ke = Promise.all(ae.map(async (Re) => {
    ...
    return await Promise.all([aL(P, Ue, Ce.signal, Pe, k.loaderData), iL(P, Le, ae)]), {
      loaderResults: Ue,
      fetcherResults: Le
    };
  }
  ...
  function bi(k) {
    return M.v7_fetcherPersist && (nt.set(k, (nt.get(k) || 0) + 1), qe.has(k) && qe.delete(k)), I.fetchers.get(k) || BO;
  }
  function Wr(k) {
  ...
  function Qt() {
    let k = [], P = !1;
    for (let Q of A) {
      let ae = I.fetchers.get(Q);
      dt(ae, "Expected fetcher: " + Q), ae.state === "loading" && (A.delete(Q), k.push(Q), P = !0);
    }
    return Dt(k), P;
  }
  function Jt(k) {
  ...
  function dn(k) {
    let P = [];
    return gt.forEach((Q, ae) => {
      (!k || k(ae)) && (Q.cancel(), P.push(ae), gt.delete(ae));
    }), P;
  }
  function un(k, P, Q) {
    if (re = k, pe = P, ue = Q || null, !Ae && I.navigation === cE) {
      Ae = !0;
      let ae = $i(I.location, I.matches);
      ae != null && en({
  ...
  function xi(k, P) {
    return ue && ue(k, P.map((ae) => SO(ae, I.loaderData))) || k.key;
  }
  function pi(k, P) {
    if (re && pe) {
      let Q = xi(k, P);
  ...
  async function Qi(k, P, Q) {
    ...
    for (; ; ) {
      ...
      let Ue = by(Pe, P, _, !0);
      if (!Ue || ae.length === Ue.length && ae.every((Le, Re) => Le.route.id === Ue[Re].route.id))
        return {
          type: "success",
          matches: null
        };
...
function mE(f, v, m, C, T, x, y, F) {
  ...
  if (y) {
    ...
    _ = v, O = v[v.length - 1];
  let $ = RE(T || ".", CE(_, x), wl(f.pathname, m) || f.pathname, F === "path");
...
function bT(f, v, m, C, T, x, y, F, _, O, $, M, B, K, re, ue) {
  let pe = ue ? wi(ue[1]) ? ue[1].error : ue[1].data : void 0, Ae = f.createURL(v.location), he = f.createURL(T), ye = m;
  x && v.errors ? ye = wT(m, Object.keys(v.errors)[0], !0) : ue && wi(ue[1]) && (ye = wT(m, ue[0]));
  let be = ue ? ue[1].statusCode : void 0, De = y && be && be >= 400, I = ye.filter((je, Ze) => {
    ...
    if (QO(v.loaderData, v.matches[Ze], je) || _.some((tt) => tt === je.route.id))
      return !0;
  ...
  return M.forEach((je, Ze) => {
    ...
    B.has(Ze) ? tt = !1 : O.has(Ze) ? (O.delete(Ze), tt = !0) : pt && pt.state !== "idle" && pt.data === void 0 ? tt = F : tt = xT(Mt, Qn({
      currentUrl: Ae,
...
function DT(f, v, m, C, T) {
  ...
  if (f) {
    ...
    y = m;
  let F = v.filter((O) => !y.some(($) => tw(O, $))), _ = _y(F, T, [f || "_", "patch", String(((x = y) == null ? void 0 : x.length) || "0")], C);
  y.push(..._);
}
function tw(f, v) {
  return "id" in f && "id" in v && f.id === v.id ? !0 : f.index === v.index && f.path === v.path && f.caseSensitive === v.caseSensitive ? (!f.children || f.children.length === 0) && (!v.children || v.children.length === 0) ? !0 : f.children.every((m, C) => {
    var T;
    return (T = v.children) == null ? void 0 : T.some((x) => tw(m, x));
  }) : !1;
}
async function WO(f, v, m) {
  if (!f.lazy)
    return;
  let C = await f.lazy();
  if (!f.lazy)
  ...
  for (let y in C) {
    ...
    y !== "hasErrorBoundary";
    Fr(!_, 'Route "' + T.id + '" has a static property "' + y + '" defined but its lazy function is also returning a value for this property. ' + ('The lazy route property "' + y + '" will be ignored.')), !_ && !yO.has(y) && (x[y] = C[y]);
  }
...
async function KO(f, v, m, C, T, x, y, F, _, O) {
  let $ = x.map((K) => K.route.lazy ? WO(K.route, _, F) : void 0), M = x.map((K, re) => {
    let ue = $[re], pe = T.some((he) => he.route.id === K.route.id);
    return Qn({}, K, {
      shouldLoad: pe,
      resolve: async (he) => (he && C.method === "GET" && (K.route.lazy || K.route.loader) && (pe = !0), pe ? XO(v, C, K, ue, he, O) : Promise.resolve({
        type: Rn.data,
        result: void 0
      }))
    });
...
async function qO(f) {
  ...
  if (m === Rn.error) {
    ...
    return {
      type: Rn.error,
      error: v,
      statusCode: My(v) ? v.status : void 0
    };
  }
  if (nL(v)) {
    var x, y;
...
function JO(f, v, m, C, T, x) {
  let y = f.headers.get("Location");
  if (dt(y, "Redirects returned/thrown from loaders/actions must have a Location header"), !TE.test(y)) {
...
function yd(f, v, m, C) {
  let T = f.createURL(nw(v)).toString(), x = {
    signal: m
  };
...
function ZO(f, v, m, C, T) {
  ...
  return f.forEach((M) => {
    ...
    if (dt(!wc(K), "Cannot handle redirect results in processLoaderData"), wi(K)) {
      ...
      x[B] = void 0, _ || (_ = !0, F = My(K.error) ? K.error.status : 500), K.headers && (O[B] = K.headers);
    } else
...
async function aL(f, v, m, C, T) {
  let x = Object.entries(v);
  for (let y = 0; y < x.length; y++) {
    let [F, _] = x[y], O = f.find((B) => (B == null ? void 0 : B.route.id) === F);
    if (!O)
      continue;
    let $ = C.find((B) => B.route.id === O.route.id), M = $ != null && !ew($, O) && (T && T[O.route.id]) !== void 0;
    ps(_) && M && await wE(_, m, !1).then((B) => {
      B && (v[F] = B);
    });
  }
}
async function iL(f, v, m) {
  for (let C = 0; C < m.length; C++) {
    ...
    f.find((O) => (O == null ? void 0 : O.route.id) === x) && ps(F) && (dt(y, "Expected an AbortController for revalidating fetcher deferred result"), await wE(F, y.signal, !0).then((O) => {
      O && (v[T] = O);
    }));
  }
}
async function wE(f, v, m) {
...
function Dv(f, v) {
  ...
  if (f[f.length - 1].route.index && bE(m || ""))
    return f[f.length - 1];
  let C = qT(f);
  return C[C.length - 1];
}
...
const Sd = /* @__PURE__ */ ie.createContext(null);
ft.env.NODE_ENV !== "production" && (Sd.displayName = "DataRouter");
const Uy = /* @__PURE__ */ ie.createContext(null);
ft.env.NODE_ENV !== "production" && (Uy.displayName = "DataRouterState");
const cL = /* @__PURE__ */ ie.createContext(null);
ft.env.NODE_ENV !== "production" && (cL.displayName = "Await");
const bl = /* @__PURE__ */ ie.createContext(null);
ft.env.NODE_ENV !== "production" && (bl.displayName = "Navigation");
const zy = /* @__PURE__ */ ie.createContext(null);
ft.env.NODE_ENV !== "production" && (zy.displayName = "Location");
const xl = /* @__PURE__ */ ie.createContext({
  outlet: null,
  matches: [],
  isDataRoute: !1
});
ft.env.NODE_ENV !== "production" && (xl.displayName = "Route");
const xE = /* @__PURE__ */ ie.createContext(null);
...
function dL() {
  ...
  let f = ie.useContext(Sd), {
    ...
    pathname: x
  } = bc(), y = JSON.stringify(CE(T, m.v7_relativeSplatPath)), F = ie.useRef(!1);
  return iw(() => {
    F.current = !0;
  }), ie.useCallback(function(O, $) {
    if ($ === void 0 && ($ = {}), ft.env.NODE_ENV !== "production" && Fr(F.current, aw), !F.current) return;
    if (typeof O == "number") {
      C.go(O);
      return;
    }
    let M = RE(O, JSON.parse(y), x, $.relative === "path");
    f == null && v !== "/" && (M.pathname = M.pathname === "/" ? v : fo([v, M.pathname])), ($.replace ? C.replace : C.push)(M, $.state, $);
  }, [v, C, y, x, f]);
}
const pL = /* @__PURE__ */ ie.createContext(null);
function vL(f) {
  let v = ie.useContext(xl).outlet;
  return v && /* @__PURE__ */ ie.createElement(pL.Provider, {
    value: f
  }, v);
}
function dN() {
  let {
    matches: f
  } = ie.useContext(xl), v = f[f.length - 1];
  return v ? v.params : {};
}
function Ov(f, v) {
  let {
    ...
    pathname: x
  } = bc(), y = JSON.stringify(CE(T, C.v7_relativeSplatPath));
  return ie.useMemo(() => RE(f, JSON.parse(y), x, m === "path"), [f, y, x, m]);
}
function hL(f, v, m, C) {
  kv() || (ft.env.NODE_ENV !== "production" ? dt(
    !1,
  ...
  let {
    ...
    matches: x
  } = ie.useContext(xl), y = x[x.length - 1], F = y ? y.params : {}, _ = y ? y.pathname : "/", O = y ? y.pathnameBase : "/", $ = y && y.route;
  if (ft.env.NODE_ENV !== "production") {
    let Ae = $ && $.path || "";
    uw(_, !$ || Ae.endsWith("*"), "You rendered descendant <Routes> (or called `useRoutes()`) at " + ('"' + _ + '" (under <Route path="' + Ae + '">) but the ') + `parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.
...
function mL() {
  let f = wL(), v = My(f) ? f.status + " " + f.statusText : f instanceof Error ? f.message : JSON.stringify(f), m = f instanceof Error ? f.stack : null, C = "rgba(200,200,200, 0.5)", T = {
    padding: "0.5rem",
    backgroundColor: C
  }, x = {
    padding: "2px 4px",
  ...
  return ft.env.NODE_ENV !== "production" && (console.error("Error handled by React Router default ErrorBoundary:", f), y = /* @__PURE__ */ ie.createElement(ie.Fragment, null, /* @__PURE__ */ ie.createElement("p", null, "💿 Hey developer 👋"), /* @__PURE__ */ ie.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", /* @__PURE__ */ ie.createElement("code", {
    style: x
  }, "ErrorBoundary"), " or", " ", /* @__PURE__ */ ie.createElement("code", {
    style: x
  }, "errorElement"), " prop on your route."))), /* @__PURE__ */ ie.createElement(ie.Fragment, null, /* @__PURE__ */ ie.createElement("h2", null, "Unexpected Application Error!"), /* @__PURE__ */ ie.createElement("h3", {
    style: {
      fontStyle: "italic"
    }
  }, v), m ? /* @__PURE__ */ ie.createElement("pre", {
    style: T
  }, m) : null, y);
}
const yL = /* @__PURE__ */ ie.createElement(mL, null);
class gL extends ie.Component {
  constructor(v) {
    super(v), this.state = {
      location: v.location,
  ...
  render() {
    return this.state.error !== void 0 ? /* @__PURE__ */ ie.createElement(xl.Provider, {
      value: this.props.routeContext
    }, /* @__PURE__ */ ie.createElement(xE.Provider, {
...
function SL(f) {
  let {
    ...
    match: m,
    children: C
  } = f, T = ie.useContext(Sd);
  return T && T.static && T.staticContext && (m.route.errorElement || m.route.ErrorBoundary) && (T.staticContext._deepestRenderedBoundaryId = m.route.id), /* @__PURE__ */ ie.createElement(xl.Provider, {
    value: v
  }, C);
}
function EL(f, v, m, C) {
  ...
  return y.reduceRight(($, M, B) => {
    ...
    m && (K = F && M.route.id ? F[M.route.id] : void 0, ue = M.route.errorElement || yL, _ && (O < 0 && B === 0 ? (uw("route-fallback", !1, "No `HydrateFallback` element provided to render during initial hydration"), re = !0, pe = null) : O === B && (re = !0, pe = M.route.hydrateFallbackElement || null)));
    let Ae = v.concat(y.slice(0, B + 1)), he = () => {
      let ye;
      return K ? ye = ue : re ? ye = pe : M.route.Component ? ye = /* @__PURE__ */ ie.createElement(M.route.Component, null) : M.route.element ? ye = M.route.element : ye = $, /* @__PURE__ */ ie.createElement(SL, {
        match: M,
        routeContext: {
          outlet: $,
          matches: Ae,
    ...
    return m && (M.route.ErrorBoundary || M.route.errorElement || B === 0) ? /* @__PURE__ */ ie.createElement(gL, {
      location: m.location,
...
function CL(f) {
  let v = ie.useContext(Sd);
  return v || (ft.env.NODE_ENV !== "production" ? dt(!1, DE(f)) : dt(!1)), v;
}
function _E(f) {
  let v = ie.useContext(Uy);
  return v || (ft.env.NODE_ENV !== "production" ? dt(!1, DE(f)) : dt(!1)), v;
}
function RL(f) {
  let v = ie.useContext(xl);
  return v || (ft.env.NODE_ENV !== "production" ? dt(!1, DE(f)) : dt(!1)), v;
}
function Ay(f) {
  let v = RL(f), m = v.matches[v.matches.length - 1];
  return m.route.id || (ft.env.NODE_ENV !== "production" ? dt(!1, f + ' can only be used on routes that contain a unique "id"') : dt(!1)), m.route.id;
}
function TL() {
  return Ay(hs.UseRouteId);
}
function pN() {
  return _E(hs.UseNavigation).navigation;
}
function vN() {
  let f = _E(hs.UseLoaderData), v = Ay(hs.UseLoaderData);
...
function wL() {
  var f;
  let v = ie.useContext(xE), m = _E(hs.UseRouteError), C = Ay(hs.UseRouteError);
  return v !== void 0 ? v : (f = m.errors) == null ? void 0 : f[C];
}
function bL() {
  let {
    router: f
  } = CL(ow.UseNavigateStable), v = Ay(hs.UseNavigateStable), m = ie.useRef(!1);
  return iw(() => {
    m.current = !0;
  }), ie.useCallback(function(T, x) {
    x === void 0 && (x = {}), ft.env.NODE_ENV !== "production" && Fr(m.current, aw), m.current && (typeof T == "number" ? f.navigate(T) : f.navigate(T, Ly({
      fromRouteId: v
    }, x)));
  }, [f, v]);
}
const AT = {};
function uw(f, v, m) {
  !v && !AT[f] && (AT[f] = !0, ft.env.NODE_ENV !== "production" && Fr(!1, m));
}
function hN(f) {
  return vL(f.context);
}
function xL(f) {
  ...
  return ft.env.NODE_ENV !== "production" && Fr(ue != null, '<Router basename="' + _ + '"> is not able to match the URL ' + ('"' + $ + M + B + '" because it does not start with the ') + "basename, so the <Router> won't render anything."), ue == null ? null : /* @__PURE__ */ ie.createElement(bl.Provider, {
    value: O
  }, /* @__PURE__ */ ie.createElement(zy.Provider, {
    children: m,
    value: ue
  }));
}
...
function DL(f) {
  ...
  return f.Component && (ft.env.NODE_ENV !== "production" && f.element && ft.env.NODE_ENV !== "production" && Fr(!1, "You should not include both `Component` and `element` on your route - `Component` will be used."), Object.assign(v, {
    element: /* @__PURE__ */ ie.createElement(f.Component),
    Component: void 0
    ...
    hydrateFallbackElement: /* @__PURE__ */ ie.createElement(f.HydrateFallback),
    ...
    errorElement: /* @__PURE__ */ ie.createElement(f.ErrorBoundary),
...
function dE(f) {
  return f != null && !zL.has(f) ? (ft.env.NODE_ENV !== "production" && Fr(!1, '"' + f + '" is not a valid `encType` for `<Form>`/`<fetcher.Form>` ' + ('and will default to "' + Dy + '"')), null) : f;
}
function AL(f, v) {
  let m, C, T, x, y;
  if (kL(f)) {
    let F = f.getAttribute("action");
    C = F ? wl(F, v) : null, m = f.getAttribute("method") || xy, T = dE(f.getAttribute("enctype")) || Dy, x = new FormData(f);
  } else if (_L(f) || OL(f) && (f.type === "submit" || f.type === "image")) {
    let F = f.form;
    if (F == null)
      throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');
    let _ = f.getAttribute("formaction") || F.getAttribute("action");
    if (C = _ ? wl(_, v) : null, m = f.getAttribute("formmethod") || F.getAttribute("method") || xy, T = dE(f.getAttribute("formenctype")) || dE(F.getAttribute("enctype")) || Dy, x = new FormData(F, f), !UL()) {
      let {
        name: O,
        type: $,
        value: M
...
const OE = /* @__PURE__ */ ie.createContext({
  isTransitioning: !1
});
ft.env.NODE_ENV !== "production" && (OE.displayName = "ViewTransition");
const sw = /* @__PURE__ */ ie.createContext(/* @__PURE__ */ new Map());
ft.env.NODE_ENV !== "production" && (sw.displayName = "Fetchers");
...
function yN(f) {
  let {
    ...
    router: m,
    future: C
  } = f, [T, x] = ie.useState(m.state), [y, F] = ie.useState(), [_, O] = ie.useState({
    isTransitioning: !1
  }), [$, M] = ie.useState(), [B, K] = ie.useState(), [re, ue] = ie.useState(), pe = ie.useRef(/* @__PURE__ */ new Map()), {
    v7_startTransition: Ae
  } = C || {}, he = ie.useCallback((je) => {
    Ae ? YL(je) : je();
  }, [Ae]), ye = ie.useCallback((je, Ze) => {
    let {
      deletedFetchers: et,
      flushSync: pt,
  ...
  ie.useLayoutEffect(() => m.subscribe(ye), [m, ye]), ie.useEffect(() => {
    _.isTransitioning && !_.flushSync && M(new QL());
  }, [_]), ie.useEffect(() => {
    if ($ && y && m.window) {
  ...
  }, [he, y, $, m.window]), ie.useEffect(() => {
    $ && y && T.location.key === y.location.key && $.resolve();
  }, [$, B, T.location, y]), ie.useEffect(() => {
  ...
  }, [_.isTransitioning, re]), ie.useEffect(() => {
  ...
  }), [m]), De = m.basename || "/", I = ie.useMemo(() => ({
    router: m,
    navigator: be,
    static: !1,
    basename: De
  }), [m, be, De]), Fe = ie.useMemo(() => ({
    v7_relativeSplatPath: m.future.v7_relativeSplatPath
  }), [m.future.v7_relativeSplatPath]);
  return /* @__PURE__ */ ie.createElement(ie.Fragment, null, /* @__PURE__ */ ie.createElement(Sd.Provider, {
    value: I
  }, /* @__PURE__ */ ie.createElement(Uy.Provider, {
    value: T
  }, /* @__PURE__ */ ie.createElement(sw.Provider, {
    value: pe.current
  }, /* @__PURE__ */ ie.createElement(OE.Provider, {
    value: _
  }, /* @__PURE__ */ ie.createElement(xL, {
    basename: De,
    location: T.location,
    navigationType: T.historyAction,
    navigator: be,
    future: Fe
  }, T.initialized || m.future.v7_partialHydration ? /* @__PURE__ */ ie.createElement(WL, {
    routes: m.routes,
    future: m.future,
    state: T
  }) : v))))), null);
}
const WL = /* @__PURE__ */ ie.memo(GL);
function GL(f) {
  let {
    routes: v,
    future: m,
  ...
  return hL(v, void 0, C, m);
}
ft.env.NODE_ENV;
const KL = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", XL = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, cw = /* @__PURE__ */ ie.forwardRef(function(v, m) {
  let {
    onClick: C,
    relative: T,
    reloadDocument: x,
    ...
    basename: K
  } = ie.useContext(bl), re, ue = !1;
  if (typeof O == "string" && XL.test(O) && (re = O, KL))
    try {
  ...
  return (
    ...
    /* @__PURE__ */ ie.createElement("a", ms({}, B, {
      href: re || pe,
      onClick: ue || x ? C : he,
      ref: m,
      target: _
...
ft.env.NODE_ENV !== "production" && (cw.displayName = "Link");
const qL = /* @__PURE__ */ ie.forwardRef(function(v, m) {
  let {
    "aria-current": C = "page",
    caseSensitive: T = !1,
    className: x = "",
    ...
    relative: M.relative
  }), K = bc(), re = ie.useContext(Uy), {
    navigator: ue,
    basename: pe
  } = ie.useContext(bl), Ae = re != null && // Conditional usage is OK here because the usage of a data router is static
  // eslint-disable-next-line react-hooks/rules-of-hooks
  lN(B) && O === !0, he = ue.encodeLocation ? ue.encodeLocation(B).pathname : B.pathname, ye = K.pathname, be = re && re.navigation && re.navigation.location ? re.navigation.location.pathname : null;
  ...
  return /* @__PURE__ */ ie.createElement(cw, ms({}, M, {
    "aria-current": Ze,
    className: et,
    ref: m,
    style: pt,
...
ft.env.NODE_ENV !== "production" && (qL.displayName = "NavLink");
const JL = /* @__PURE__ */ ie.forwardRef((f, v) => {
  let {
    fetcherKey: m,
    navigate: C,
    reloadDocument: T,
  ...
  return /* @__PURE__ */ ie.createElement("form", ms({
    ref: v,
    method: pe,
    action: ue,
    onSubmit: T ? O : Ae
...
ft.env.NODE_ENV !== "production" && (JL.displayName = "Form");
ft.env.NODE_ENV;
var Ny;
(function(f) {
...
function fw(f) {
  let v = ie.useContext(Sd);
  return v || (ft.env.NODE_ENV !== "production" ? dt(!1, ZL(f)) : dt(!1)), v;
}
function eN(f, v) {
  let {
    target: m,
    ...
    relative: y,
    viewTransition: F
  } = v === void 0 ? {} : v, _ = lw(), O = bc(), $ = Ov(f, {
    relative: y
  });
  return ie.useCallback((M) => {
    if (NL(M, m)) {
      M.preventDefault();
...
function gN(f) {
  ...
  let v = ie.useRef(SE(f)), m = ie.useRef(!1), C = bc(), T = ie.useMemo(() => (
    // Only merge in the defaults if we haven't yet called setSearchParams.
    // Once we call that we want those to take precedence, otherwise you can't
    // remove a param with setSearchParams({}) if it has an initial value
    ML(C.search, m.current ? null : v.current)
  ), [C.search]), x = lw(), y = ie.useCallback((F, _) => {
...
function aN() {
  let {
    ...
    basename: v
  } = ie.useContext(bl), m = TL();
  return ie.useCallback(function(C, T) {
    T === void 0 && (T = {}), tN();
    let {
      action: x,
      method: y,
...
function iN(f, v) {
  let {
    ...
    basename: C
  } = ie.useContext(bl), T = ie.useContext(xl);
