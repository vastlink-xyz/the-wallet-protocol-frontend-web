...
import { j as s, c as t, a as l } from "./main-ZrsMs0Kw.js";
import { h as p } from "./vendor-react-DG1r0zWq.js";
const i = () => {
  const { loginWithRedirect: n } = s(), a = async () => {
    await n({
      appState: {
        returnTo: "/"
      },
  ...
  const { isAuthenticated: n, user: a } = s();
  return /* @__PURE__ */ e.jsxs("div", { className: "nav-bar__buttons", children: [
    !n && /* @__PURE__ */ e.jsx(e.Fragment, { children: /* @__PURE__ */ e.jsx(i, {}) }),
    n && /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
