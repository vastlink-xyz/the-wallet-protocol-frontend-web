import { g as xr, B as Or } from "./vendor-walletconnect-CNbnIvIA.js";
import { p as le, a as U, R as J, r as Rr, e as Dn } from "./vendor-react-DG1r0zWq.js";
import { c as me } from "./vendor-ui-utils-9-Ouo9pm.js";
function Fn(t, e) {
  return function() {
...
Q.HttpStatusCode = Lt;
Q.default = Q;
const Ae = (t) => typeof t == "number" && !isNaN(t), ve = (t) => typeof t == "string", ue = (t) => typeof t == "function", Ve = (t) => ve(t) || ue(t) ? t : null, Nt = (t) => U.isValidElement(t) || ve(t) || ue(t) || Ae(t);
function ti(t, e, n) {
  n === void 0 && (n = 300);
...
function it(t) {
  ...
  return function(o) {
    ...
    return U.useLayoutEffect(() => {
      ...
      const x = d.current, w = () => {
        x.removeEventListener("animationend", w), s ? ti(x, u, i) : u();
      };
...
let Ie = [];
const At = /* @__PURE__ */ new Set(), ni = (t) => At.forEach((e) => e(t)), lr = () => ne.size > 0;
function ur(t, e) {
  var n;
    ...
    return { subscribe(a) {
      const l = /* @__PURE__ */ function(u, d, f) {
        ...
        const S = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Set(), b = () => {
          ...
          T.staleId && S.delete(T.staleId), S.set(I, T), g = [...g, T.props.toastId].filter((Y) => Y !== T.staleId), b(), f(ln(T, fe ? "added" : "updated")), fe && ue(B) && B(U.isValidElement(ae) && ae.props);
        };
        return { id: u, props: w, observe: (T) => (E.add(T), () => E.delete(T)), toggle: (T, I) => {
          ...
          const G = { ...w, style: w.toastStyle, key: y++, ...Object.fromEntries(Object.entries(I).filter((N) => {
            ...
            ue(P) && P(U.isValidElement(C) && C.props), f(ln(N, "removed")), S.delete(B), h--, h < 0 && (h = 0), m.length > 0 ? L(m.shift()) : b();
          } };
          var K, Z;
          ...
          let v = T;
          U.isValidElement(T) && !ve(T.type) ? v = U.cloneElement(T, { closeToast: te, toastProps: G, data: ae }) : ue(T) && (v = T({ closeToast: te, toastProps: G, data: ae }));
...
function We(t, e) {
  return { ...e, type: e && e.type || t, toastId: ai(e) };
}
function De(t) {
...
const li = typeof window < "u" ? U.useLayoutEffect : U.useEffect, Fe = (t) => {
  ...
  }(Z)), J.createElement(y, { isIn: z, done: B, position: h, preventExitTransition: n, nodeRef: r, playToast: i }, J.createElement("div", { id: I, onClick: c, "data-in": z, className: X, ...s, style: g, ref: r }, J.createElement("div", { ...z && { role: D }, className: ue(x) ? x({ type: u }) : me("Toastify__toast-body", x), style: w }, G != null && J.createElement("div", { className: me("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !ae }) }, G), J.createElement("div", null, a)), v, J.createElement(ii, { ...b && !K ? { key: `pb-${b}` } : {}, rtl: T, theme: Y, delay: l, isRunning: e, isIn: z, closeToast: f, hide: d, type: u, style: E, className: S, controlledProgress: K, progress: L || 0 })));
}, ot = function(t, e) {
...
const Ao = it(ot("zoom"));
it(ot("flip"));
const fi = { position: "top-right", transition: ci, autoClose: 5e3, closeButton: !0, pauseOnHover: !0, pauseOnFocusLoss: !0, draggable: "touch", draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light" };
function Io(t) {
  let e = { ...fi, ...t };
  const n = t.stacked, [r, s] = U.useState(!0), i = U.useRef(null), { getToastToRender: o, isToastActive: a, count: l } = ri(e), { className: c, style: u, rtl: d, containerId: f } = e;
  function y(m) {
  ...
  return li(() => {
    ...
    return J.createElement("div", { className: y(m), style: x, key: `container-${m}` }, g.map((w) => {
      ...
      return J.createElement(ui, { ...E, stacked: n, collapseAll: h, isIn: a(E.toastId, E.containerId), style: E.style, key: `toast-${E.key}` }, S);
    }));
  }));
}
const di = (...t) => {
  ...
  Se(t[0]) && cn[t[0]] || (Se(t[0]) && (cn[t[0]] = /* @__PURE__ */ new Date()), di(...t));
}, dr = (t, e) => () => {
  if (t.isInitialized)
    e();
  else {
...
}, pi = (t, e, n = {}) => !e.languages || !e.languages.length ? (It("i18n.languages were undefined or empty", e.languages), !0) : e.hasLoadedNamespace(t, {
  lng: n.lng,
  precheck: (r, s) => {
    var i;
...
}), Se = (t) => typeof t == "string", hi = (t) => typeof t == "object" && t !== null, gi = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, mi = {
  "&amp;": "&",
  "&#38;": "&",
  "&lt;": "<",
  "&#60;": "<",
  ...
  "&#x2F;": "/",
  "&#47;": "/"
}, yi = (t) => mi[t], bi = (t) => t.replace(gi, yi);
let _t = {
...
const Oi = (t, e) => {
...
}, gr = (t, e, n, r) => t.getFixedT(e, n, r), Ri = (t, e, n, r) => U.useCallback(gr(t, e, n, r), [t, e, n, r]), ko = (t, e = {}) => {
  var E, b, D, L;
  const {
    i18n: n
  } = e, {
    i18n: r,
    defaultNS: s
  } = U.useContext(hr) || {}, i = n || r || Ei();
  if (i && !i.reportNamespaces && (i.reportNamespaces = new xi()), !i) {
    It("You will need to pass in an i18next instance by using initReactI18next");
    const T = (B, z) => Se(z) ? z : hi(z) && Se(z.defaultValue) ? z.defaultValue : Array.isArray(B) ? B[B.length - 1] : B, I = [T, {}, !1];
  ...
  const u = (i.isInitialized || i.initializedStoreOnce) && c.every((T) => pi(T, i, o)), d = Ri(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), f = () => d, y = () => gr(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), [h, m] = U.useState(f);
  let g = c.join();
  e.lng && (g = `${e.lng}${g}`);
  const x = Oi(g), w = U.useRef(!0);
  U.useEffect(() => {
    const {
      bindI18n: T,
      bindI18nStore: I
...
function $o({
  ...
  return U.createElement(hr.Provider, {
    value: r
  }, n);
}
var at = {}, Ti = function() {
  ...
  "text/html": "Url",
  default: "Text"
}, Pi = "Copy to clipboard: #{key}, Enter";
function Li(t) {
...
function Ni(t, e) {
  ...
  try {
    ...
    try {
      ...
      n && console.error("unable to copy using clipboardData: ", d), n && console.error("falling back to prompt"), r = Li("message" in e ? e.message : Pi), window.prompt(r, t);
    }
  } finally {
...
var Ue = mr(Rr()), Ii = mr(Ai), _i = ["text", "onCopy", "options", "children"];
function mr(t) {
...
var br = /* @__PURE__ */ function(t) {
  ...
  function n() {
    ...
    return r = e.call.apply(e, [this].concat(i)), qt(yr(r), "onClick", function(a) {
      var l = r.props, c = l.text, u = l.onCopy, d = l.children, f = l.options, y = Ue.default.Children.only(d), h = (0, Ii.default)(c, f);
  ...
  return Fi(n, [{
    ...
    value: function() {
      ...
      var i = s.children, o = ki(s, _i), a = Ue.default.Children.only(i);
...
var Hi = at, jt = Hi.CopyToClipboard;
jt.CopyToClipboard = jt;
var qi = jt;
const jo = /* @__PURE__ */ Dn(qi), _ = (t) => typeof t == "string", Ce = () => {
  let t, e;
