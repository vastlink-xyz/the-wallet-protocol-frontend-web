...
import { k as C, j as A, r as n } from "./vendor-react-CwfAKKXk.js";
import { B as i, a as O } from "./vendor-utils-DOORVzle.js";
import { f as o, g as U, B as d, L as f, k as V, a as W, h as N } from "./main-BY45iJ-a.js";
import { L as E } from "./index-ZbuPpR4e.js";
import { f as Y } from "./vendor-web3-VgZtbLWg.js";
function K() {
  const [l] = C(), b = A(), [u, w] = n.useState(!1), [x, p] = n.useState(!1), [h, g] = n.useState(!1), [I, j] = n.useState(!1), [t, S] = n.useState(), [m, T] = n.useState("PENDING"), [k, G] = n.useState("");
  n.useEffect(() => {
    P();
  }, [l]), n.useEffect(() => {
    t && T(t.status);
  ...
  const P = async () => {
    ...
    try {
      ...
      if ((await o.get("/address/check", {
        ...
        const y = await o.get("/address/", {
          params: { email: e.toEmail }
        });
        y.data.success && (await v(e.id, {
          status: "REGISTERED",
          to: y.data.address
        }), c(a));
      }
  ...
  return /* @__PURE__ */ s.jsx("div", { className: "h-screen bg-cool-frosted-aqua-80 bg-opacity-20 flex items-center justify-center", children: /* @__PURE__ */ s.jsxs("div", { className: "bg-white rounded-2xl shadow-lg px-4 md:px-12 py-8 mx-6 max-w-md w-full", children: [
