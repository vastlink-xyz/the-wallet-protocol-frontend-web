...
import { a as _, aa as V, c as g, ab as q, ac as z, B as y, f as P, t as G, L as Q, g as S, ad as H, ae as J } from "./main-CfyskFtf.js";
import { u as K, B as j } from "./vendor-utils-BPVAmMsZ.js";
import { u as X } from "./useTransaction-BjVvehXm.js";
import { L as Y } from "./index-DReq0u83.js";
import { S as Z, A as ee } from "./vendor-ui-utils-CGOon9_P.js";
import { k as te } from "./vendor-web3-CQEmmIwE.js";
import { u as se, a as ae } from "./MarketplaceProvider-CXJmMquS.js";
function be({
  text: i,
...
function we({
  ...
  const E = async () => {
    ...
    N(R);
  }, k = async (n) => (await P.get(`/thirdparty/sign-moonpay-params?url=${encodeURIComponent(n)}`)).data.signature, L = () => {
    o(!1), m(!1), u(!1);
  }, C = async (n) => {
    if (d(!1), await B()) {
