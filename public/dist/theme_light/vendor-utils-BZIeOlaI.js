import { g as xr, B as Or } from "./vendor-walletconnect-DgnLJNqO.js";
import { p as le, r as F, R as J, d as Dn } from "./vendor-react-Bi1rjDlg.js";
import { c as me } from "./vendor-ui-utils-CRHGvpNr.js";
function Fn(t, e) {
  return function() {
    return t.apply(e, arguments);
  };
}
const { toString: Rr } = Object.prototype, { getPrototypeOf: Ut } = Object, et = /* @__PURE__ */ ((t) => (e) => {
  const n = Rr.call(e);
...
const Pr = tt("string"), ce = tt("function"), Mn = tt("number"), nt = (t) => t !== null && typeof t == "object", Lr = (t) => t === !0 || t === !1, He = (t) => {
  if (et(t) !== "object")
    return !1;
  const e = Ut(t);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(Symbol.toStringTag in t) && !(Symbol.iterator in t);
}, Nr = de("Date"), Ar = de("File"), Ir = de("Blob"), _r = de("FileList"), kr = (t) => nt(t) && ce(t.pipe), $r = (t) => {
  let e;
...
}, jr = de("URLSearchParams"), [Dr, Fr, Ur, Mr] = ["ReadableStream", "Request", "Response", "Headers"].map(de), Br = (t) => t.trim ? t.trim() : t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const zr = (t, e, n, { allOwnKeys: r } = {}) => (ke(e, (s, i) => {
  n && ce(s) ? t[i] = Fn(s, n) : t[i] = s;
}, { allOwnKeys: r }), t), Hr = (t) => (t.charCodeAt(0) === 65279 && (t = t.slice(1)), t), qr = (t, e, n, r) => {
  ...
  for (; e-- > 0; )
    n[e] = t[e];
  return n;
}, Wr = /* @__PURE__ */ ((t) => (e) => t && e instanceof t)(typeof Uint8Array < "u" && Ut(Uint8Array)), Yr = (t, e) => {
  ...
  for (; (n = t.exec(e)) !== null; )
    r.push(n);
  return r;
}, Gr = de("HTMLFormElement"), Qr = (t) => t.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), Jt = (({ hasOwnProperty: t }) => (e, n) => t.call(e, n))(Object.prototype), Zr = de("RegExp"), Hn = (t, e) => {
...
}, rs = (t, e) => t != null && Number.isFinite(t = +t) ? t : e, ut = "abcdefghijklmnopqrstuvwxyz", Wt = "0123456789", qn = {
  DIGIT: Wt,
  ALPHA: ut,
  ALPHA_DIGIT: ut + ut.toUpperCase() + Wt
}, ss = (t = 16, e = qn.ALPHA_DIGIT) => {
  let n = "";
  const { length: r } = e;
  for (; t--; )
    n += e[Math.random() * r | 0];
...
const os = (t) => {
  ...
  return n(t, 0);
}, as = de("AsyncFunction"), ls = (t) => t && (nt(t) || ce(t)) && ce(t.then) && ce(t.catch), Vn = ((t, e) => t ? setImmediate : e ? ((n, r) => (ye.addEventListener("message", ({ source: s, data: i }) => {
  ...
  ce(ye.postMessage)
), us = typeof queueMicrotask < "u" ? queueMicrotask.bind(ye) : typeof le < "u" && le.nextTick || Vn, p = {
  isArray: Oe,
  isArrayBuffer: Un,
  isBuffer: Tr,
  isFormData: $r,
...
const ds = p.toFlatObject(p, {}, null, function(e) {
...
function rt(t, e, n) {
  ...
  function u(h, m, g) {
    ...
    if (h && !g && typeof h == "object") {
      ...
      else if (p.isArray(h) && fs(h) || (p.isFileList(h) || p.endsWith(m, "[]")) && (x = p.toArray(h)))
...
}, hs = typeof URLSearchParams < "u" ? URLSearchParams : Mt, gs = typeof FormData < "u" ? FormData : null, ms = typeof Blob < "u" ? Blob : null, ys = {
  isBrowser: !0,
  classes: {
    URLSearchParams: hs,
    FormData: gs,
...
}, Bt = typeof window < "u" && typeof document < "u", Rt = typeof navigator == "object" && navigator || void 0, bs = Bt && (!Rt || ["ReactNative", "NativeScript", "NS"].indexOf(Rt.product) < 0), vs = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", Ss = Bt && window.location.href || "http://localhost", ws = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: Bt,
...
function Qn(t) {
  function e(n, r, s, i) {
    ...
    return o = !o && p.isArray(s) ? s.length : o, l ? (p.hasOwnProp(s, o) ? s[o] = [s[o], r] : s[o] = r, !a) : ((!s[o] || !p.isObject(s[o])) && (s[o] = []), e(n, r, s[o], i) && p.isArray(s[o]) && (s[o] = Os(s[o])), !a);
  }
  ...
  transformRequest: [function(e, n) {
    ...
    if (i) {
      if (r.indexOf("application/x-www-form-urlencoded") > -1)
        return Es(e, this.formSerializer).toString();
    ...
    return i || s ? (n.setContentType("application/json", !1), Rs(e)) : e;
  }],
...
const Ts = p.toObjectSet([
  ...
  return t && t.split(`
`).forEach(function(o) {
    s = o.indexOf(":"), n = o.substring(0, s).trim().toLowerCase(), r = o.substring(s + 1).trim(), !(!n || e[n] && Ts[n]) && (n === "set-cookie" ? e[n] ? e[n].push(r) : e[n] = [r] : e[n] = e[n] ? e[n] + ", " + r : r);
  }), e;
}, Qt = Symbol("internals");
function Te(t) {
...
const Ls = (t) => /^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());
...
class oe {
  ...
  set(e, n, r) {
    ...
    if (p.isPlainObject(e) || e instanceof this.constructor)
      o(e, n);
    else if (p.isString(e) && (e = e.trim()) && !Ls(e))
      o(Cs(e), n);
...
}, en = (t) => (...e) => p.asap(() => t(...e)), $s = ie.hasStandardBrowserEnv ? (
...
const nr = (t) => {
  ...
  if (ie.hasStandardBrowserEnv && (r && p.isFunction(r) && (r = r(e)), r || r !== !1 && $s(e.url))) {
    const c = s && i && js.read(i);
    c && o.set(s, c);
  }
  return e;
}, Us = typeof XMLHttpRequest < "u", Ms = Us && function(t) {
...
}, st = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", rr = st && typeof ReadableStream == "function", Vs = st && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((t) => (e) => t.encode(e))(new TextEncoder()) : async (t) => new Uint8Array(await new Response(t).arrayBuffer())), sr = (t, ...e) => {
  try {
    return !!t(...e);
  } catch {
    return !1;
...
const Js = async (t) => {
  ...
  let y = Bs([s, i && i.toAbortSignal()], o), h;
  const m = y && y.unsubscribe && (() => {
    y.unsubscribe();
  });
  let g;
  try {
    if (l && Ks && n !== "get" && n !== "head" && (g = await Ws(u, r)) !== 0) {
      let b = new Request(e, {
        method: "POST",
        body: r,
        duplex: "half"
...
const sn = (t) => `- ${t}`, Xs = (t) => p.isFunction(t) || t === null || t === !1, ir = {
  getAdapter: (t) => {
    t = p.isArray(t) ? t : [t];
    const { length: e } = t;
    let n, r;
    ...
    for (let i = 0; i < e; i++) {
      n = t[i];
      let o;
      if (r = n, !Xs(n) && (r = Ct[(o = String(n)).toLowerCase()], r === void 0))
...
Q.HttpStatusCode = Lt;
Q.default = Q;
const Ae = (t) => typeof t == "number" && !isNaN(t), ve = (t) => typeof t == "string", ue = (t) => typeof t == "function", Ve = (t) => ve(t) || ue(t) ? t : null, Nt = (t) => F.isValidElement(t) || ve(t) || ue(t) || Ae(t);
function ei(t, e, n) {
  n === void 0 && (n = 300);
...
function it(t) {
  ...
  return function(o) {
    ...
    const h = r ? `${e}--${l}` : e, m = r ? `${n}--${l}` : n, g = F.useRef(0);
    return F.useLayoutEffect(() => {
      ...
      const x = d.current, w = () => {
        x.removeEventListener("animationend", w), s ? ei(x, u, i) : u();
      };
...
let Ie = [];
const At = /* @__PURE__ */ new Set(), ti = (t) => At.forEach((e) => e(t)), lr = () => ne.size > 0;
function ur(t, e) {
  var n;
...
function cr(t, e) {
  Nt(t) && (lr() || Ie.push({ content: t, options: e }), ne.forEach((n) => {
    n.buildToast(t, e);
  }));
}
function un(t, e) {
...
function ni(t) {
    ...
    return { subscribe(a) {
      const l = /* @__PURE__ */ function(u, d, f) {
        ...
        const S = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Set(), b = () => {
          ...
          T.staleId && S.delete(T.staleId), S.set(I, T), g = [...g, T.props.toastId].filter((Y) => Y !== T.staleId), b(), f(ln(T, fe ? "added" : "updated")), fe && ue(B) && B(F.isValidElement(ae) && ae.props);
        };
        return { id: u, props: w, observe: (T) => (E.add(T), () => E.delete(T)), toggle: (T, I) => {
          ...
          const G = { ...w, style: w.toastStyle, key: y++, ...Object.fromEntries(Object.entries(I).filter((N) => {
            ...
            ue(P) && P(F.isValidElement(C) && C.props), f(ln(N, "removed")), S.delete(B), h--, h < 0 && (h = 0), m.length > 0 ? L(m.shift()) : b();
          } };
          var K, Z;
          G.closeButton = w.closeButton, I.closeButton === !1 || Nt(I.closeButton) ? G.closeButton = I.closeButton : I.closeButton === !0 && (G.closeButton = !Nt(w.closeButton) || w.closeButton);
          let v = T;
          F.isValidElement(T) && !ve(T.type) ? v = F.cloneElement(T, { closeToast: te, toastProps: G, data: ae }) : ue(T) && (v = T({ closeToast: te, toastProps: G, data: ae }));
      ...
      ne.set(o, l);
      const c = l.observe(a);
      return Ie.forEach((u) => cr(u.content, u.options)), Ie = [], () => {
        c(), ne.delete(o);
      };
    }, setProps(a) {
      var l;
  ...
  }, isToastActive: ur, count: s == null ? void 0 : s.length };
}
function ri(t) {
  ...
  (y = ne.get((f = { id: t.toastId, containerId: t.containerId, fn: n }).containerId || 1)) == null || y.setToggle(f.id, f.fn), F.useEffect(() => {
...
const fr = () => "" + ii++;
function oi(t) {
  return t && (ve(t.toastId) || Ae(t.toastId)) ? t.toastId : fr();
}
function Pe(t, e) {
  return cr(t, e), e.toastId;
}
function We(t, e) {
  return { ...e, type: e && e.type || t, toastId: oi(e) };
}
function De(t) {
  return (e, n) => Pe(e, We(t, n));
}
function W(t, e) {
  return Pe(t, We("default", e));
}
W.loading = (t, e) => Pe(t, We("default", { isLoading: !0, autoClose: !1, closeOnClick: !1, closeButton: !1, draggable: !1, ...e })), W.promise = function(t, e, n) {
  let r, { pending: s, error: i, success: o } = e;
  s && (r = ve(s) ? W.loading(s, n) : W.loading(s.render, { ...n, ...s }));
  const a = { isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null }, l = (u, d, f) => {
    ...
    const y = { type: u, ...a, ...n, data: f }, h = ve(d) ? { render: d } : d;
    return r ? W.update(r, { ...y, ...h }) : W(h.render, { ...y, ...h }), f;
  }, c = ue(t) ? t() : t;
  return c.then((u) => l("success", o, u)).catch((u) => l("error", i, u)), c;
}, W.success = De("success"), W.info = De("info"), W.error = De("error"), W.warning = De("warning"), W.warn = W.warning, W.dark = (t, e) => Pe(t, We("default", { theme: "dark", ...e })), W.dismiss = function(t) {
  (function(e) {
    var n;
    if (lr()) {
      if (e == null || ve(n = e) || Ae(n)) ne.forEach((r) => {
        r.removeToast(e);
      });
...
}, W.isActive = ur, W.update = function(t, e) {
  e === void 0 && (e = {});
  const n = ((r, s) => {
    var i;
    let { containerId: o } = s;
  ...
  if (n) {
    const { props: r, content: s } = n, i = { delay: 100, ...r, ...e, toastId: e.toastId || t, updateId: fr() };
...
}, W.play = (t) => un(!0, t), W.pause = (t) => un(!1, t);
const ai = typeof window < "u" ? F.useLayoutEffect : F.useEffect, Fe = (t) => {
  ...
  return J.createElement(Fe, { ...t }, J.createElement("path", { d: "M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z" }));
}, warning: function(t) {
  return J.createElement(Fe, { ...t }, J.createElement("path", { d: "M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z" }));
}, success: function(t) {
  return J.createElement(Fe, { ...t }, J.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}, error: function(t) {
  return J.createElement(Fe, { ...t }, J.createElement("path", { d: "M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z" }));
}, spinner: function() {
  return J.createElement("div", { className: "Toastify__spinner" });
} }, li = (t) => {
  const { isRunning: e, preventExitTransition: n, toastRef: r, eventHandlers: s, playToast: i } = ri(t), { closeButton: o, children: a, autoClose: l, onClick: c, type: u, hideProgressBar: d, closeToast: f, transition: y, position: h, className: m, style: g, bodyClassName: x, bodyStyle: w, progressClassName: S, progressStyle: E, updateId: b, role: D, progress: L, rtl: T, toastId: I, deleteToast: B, isIn: z, isLoading: ae, closeOnClick: fe, theme: Y } = t, te = me("Toastify__toast", `Toastify__toast-theme--${Y}`, `Toastify__toast--${u}`, { "Toastify__toast--rtl": T }, { "Toastify__toast--close-on-click": fe }), X = ue(m) ? m({ rtl: T, position: h, type: u, defaultClassName: te }) : me(te, m), G = function(O) {
    let { theme: N, type: P, isLoading: C, icon: k } = O, A = null;
    const $ = { theme: N, type: P };
    return k === !1 || (ue(k) ? A = k({ ...$, isLoading: C }) : F.isValidElement(k) ? A = F.cloneElement(k, $) : C ? A = pt.spinner() : ((U) => U in pt)(P) && (A = pt[P]($))), A;
  }(t), K = !!L || !l, Z = { closeToast: f, type: u, theme: Y };
  let v = null;
  return o === !1 || (v = ue(o) ? o(Z) : F.isValidElement(o) ? F.cloneElement(o, Z) : function(O) {
  ...
  }(Z)), J.createElement(y, { isIn: z, done: B, position: h, preventExitTransition: n, nodeRef: r, playToast: i }, J.createElement("div", { id: I, onClick: c, "data-in": z, className: X, ...s, style: g, ref: r }, J.createElement("div", { ...z && { role: D }, className: ue(x) ? x({ type: u }) : me("Toastify__toast-body", x), style: w }, G != null && J.createElement("div", { className: me("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !ae }) }, G), J.createElement("div", null, a)), v, J.createElement(si, { ...b && !K ? { key: `pb-${b}` } : {}, rtl: T, theme: Y, delay: l, isRunning: e, isIn: z, closeToast: f, hide: d, type: u, style: E, className: S, controlledProgress: K, progress: L || 0 })));
}, ot = function(t, e) {
...
const No = it(ot("zoom"));
it(ot("flip"));
const ci = { position: "top-right", transition: ui, autoClose: 5e3, closeButton: !0, pauseOnHover: !0, pauseOnFocusLoss: !0, draggable: "touch", draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light" };
function Ao(t) {
  let e = { ...ci, ...t };
  const n = t.stacked, [r, s] = F.useState(!0), i = F.useRef(null), { getToastToRender: o, isToastActive: a, count: l } = ni(e), { className: c, style: u, rtl: d, containerId: f } = e;
  function y(m) {
  ...
  return ai(() => {
    ...
    return J.createElement("div", { className: y(m), style: x, key: `container-${m}` }, g.map((w) => {
      ...
      return J.createElement(li, { ...E, stacked: n, collapseAll: h, isIn: a(E.toastId, E.containerId), style: E.style, key: `toast-${E.key}` }, S);
    }));
  }));
}
const fi = (...t) => {
  console != null && console.warn && (Se(t[0]) && (t[0] = `react-i18next:: ${t[0]}`), console.warn(...t));
}, cn = {}, It = (...t) => {
  Se(t[0]) && cn[t[0]] || (Se(t[0]) && (cn[t[0]] = /* @__PURE__ */ new Date()), fi(...t));
}, dr = (t, e) => () => {
  if (t.isInitialized)
    e();
  else {
  ...
  Se(n) && (n = [n]), n.forEach((s) => {
    t.options.ns.indexOf(s) < 0 && t.options.ns.push(s);
  }), t.loadLanguages(e, dr(t, r));
}, di = (t, e, n = {}) => !e.languages || !e.languages.length ? (It("i18n.languages were undefined or empty", e.languages), !0) : e.hasLoadedNamespace(t, {
  lng: n.lng,
  precheck: (r, s) => {
    var i;
...
}), Se = (t) => typeof t == "string", pi = (t) => typeof t == "object" && t !== null, hi = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, gi = {
  "&amp;": "&",
  "&#38;": "&",
  "&lt;": "<",
  "&#60;": "<",
  ...
  "&#x2F;": "/",
  "&#47;": "/"
}, mi = (t) => gi[t], yi = (t) => t.replace(hi, mi);
let _t = {
...
const xi = (t, e) => {
...
}, gr = (t, e, n, r) => t.getFixedT(e, n, r), Oi = (t, e, n, r) => F.useCallback(gr(t, e, n, r), [t, e, n, r]), _o = (t, e = {}) => {
  var E, b, D, L;
  const {
    i18n: n
  } = e, {
    i18n: r,
    defaultNS: s
  } = F.useContext(hr) || {}, i = n || r || wi();
  if (i && !i.reportNamespaces && (i.reportNamespaces = new Ei()), !i) {
    It("You will need to pass in an i18next instance by using initReactI18next");
    const T = (B, z) => Se(z) ? z : pi(z) && Se(z.defaultValue) ? z.defaultValue : Array.isArray(B) ? B[B.length - 1] : B, I = [T, {}, !1];
    return I.t = T, I.i18n = {}, I.ready = !1, I;
  }
  (E = i.options.react) != null && E.wait && It("It seems you are still using the old wait option, you may migrate to the new useSuspense behaviour.");
  const o = {
    ...vi(),
    ...i.options.react,
    ...e
  ...
  c = Se(c) ? [c] : c || ["translation"], (L = (D = i.reportNamespaces).addUsedNamespaces) == null || L.call(D, c);
  const u = (i.isInitialized || i.initializedStoreOnce) && c.every((T) => di(T, i, o)), d = Oi(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), f = () => d, y = () => gr(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), [h, m] = F.useState(f);
  let g = c.join();
  e.lng && (g = `${e.lng}${g}`);
  const x = xi(g), w = F.useRef(!0);
  F.useEffect(() => {
    const {
      bindI18n: T,
      bindI18nStore: I
    } = o;
    w.current = !0, !u && !a && (e.lng ? dn(i, e.lng, c, () => {
      w.current && m(y);
    }) : fn(i, c, () => {
      w.current && m(y);
...
function ko({
  ...
  return F.createElement(hr.Provider, {
    value: r
  }, n);
}
var at = {}, Ri = function() {
  ...
  "text/html": "Url",
  default: "Text"
}, Ci = "Copy to clipboard: #{key}, Enter";
function Pi(t) {
...
function Li(t, e) {
  ...
  try {
    ...
    try {
      ...
      n && console.error("unable to copy using clipboardData: ", d), n && console.error("falling back to prompt"), r = Pi("message" in e ? e.message : Ci), window.prompt(r, t);
    }
  } finally {
...
at.CopyToClipboard = void 0;
var Ue = mr(F), Ai = mr(Ni), Ii = ["text", "onCopy", "options", "children"];
function mr(t) {
...
function gn(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? hn(Object(n), !0).forEach(function(r) {
      qt(t, r, n[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : hn(Object(n)).forEach(function(r) {
...
function Di(t, e, n) {
  return e && ji(t.prototype, e), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function Fi(t, e) {
...
function $t(t, e) {
  return $t = Object.setPrototypeOf || function(r, s) {
...
var br = /* @__PURE__ */ function(t) {
  ...
  function n() {
    ...
    for (var s = arguments.length, i = new Array(s), o = 0; o < s; o++)
      i[o] = arguments[o];
    return r = e.call.apply(e, [this].concat(i)), qt(yr(r), "onClick", function(a) {
      var l = r.props, c = l.text, u = l.onCopy, d = l.children, f = l.options, y = Ue.default.Children.only(d), h = (0, Ai.default)(c, f);
  ...
  return Di(n, [{
    ...
    value: function() {
      ...
      var i = s.children, o = _i(s, Ii), a = Ue.default.Children.only(i);
      return /* @__PURE__ */ Ue.default.cloneElement(a, gn(gn({}, o), {}, {
        onClick: this.onClick
      }));
    }
  }]), n;
}(Ue.default.PureComponent);
at.CopyToClipboard = br;
qt(br, "defaultProps", {
  onCopy: void 0,
  options: void 0
});
var zi = at, jt = zi.CopyToClipboard;
jt.CopyToClipboard = jt;
var Hi = jt;
const $o = /* @__PURE__ */ Dn(Hi), _ = (t) => typeof t == "string", Ce = () => {
  let t, e;
  const n = new Promise((r, s) => {
    t = r, e = s;
  });
  return n.resolve = t, n.reject = e, n;
}, mn = (t) => t == null ? "" : "" + t, qi = (t, e, n) => {
  t.forEach((r) => {
    e[r] && (n[r] = e[r]);
  });
}, Vi = /###/g, yn = (t) => t && t.indexOf("###") > -1 ? t.replace(Vi, ".") : t, bn = (t) => !t || _(t), Le = (t, e, n) => {
...
const Yi = (t) => _(t) ? t.replace(/[&<>"'\/]/g, (e) => Wi[e]) : t;
class Xi {
  constructor(e) {
...
const Gi = [" ", ",", "?", "!", ";"], Qi = new Xi(20), Zi = (t, e, n) => {
  e = e || "", n = n || "";
  const r = Gi.filter((o) => e.indexOf(o) < 0 && n.indexOf(o) < 0);
  if (r.length === 0) return !0;
  const s = Qi.getRegExp(`(${r.map((o) => o === "?" ? "\\?" : o).join("|")})`);
  let i = !s.test(t);
  if (!i) {
    const o = t.indexOf(n);
...
class Ze extends lt {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    super(), qi(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = n, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = he.create("translator");
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
...
class oo {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.languageUtils = e, this.options = n, this.logger = he.create("pluralResolver"), (!this.options.compatibilityJSON || so.includes(this.options.compatibilityJSON)) && (typeof Intl > "u" || !Intl.PluralRules) && (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = io(), this.pluralRulesCache = {};
  }
  addRule(e, n) {
    this.rules[e] = n;
  }
...
class ao {
  ...
  init() {
    ...
    this.escape = n !== void 0 ? n : Yi, this.escapeValue = r !== void 0 ? r : !0, this.useRawValueToEscape = s !== void 0 ? s : !1, this.prefix = i ? Ee(i) : o || "{{", this.suffix = a ? Ee(a) : l || "}}", this.formatSeparator = c || ",", this.unescapePrefix = u ? "" : d || "-", this.unescapeSuffix = this.unescapePrefix ? "" : u || "", this.nestingPrefix = f ? Ee(f) : y || Ee("$t("), this.nestingSuffix = h ? Ee(h) : m || Ee(")"), this.nestingOptionsSeparator = g || ",", this.maxReplaces = x || 1e3, this.alwaysFormat = w !== void 0 ? w : !1, this.resetRegExp();
  }
  reset() {
...
class fo extends lt {
  ...
  loaded(e, n, r) {
    ...
    this.queue.forEach((l) => {
      Ki(l.loaded, [i], o), co(l, e), n && l.errors.push(n), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((c) => {
        a[c] || (a[c] = {});
        const u = l.loaded[c];
...
class _e extends lt {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      f.logger = he, f.resourceStore = this.store, f.languageUtils = d, f.pluralResolver = new oo(d, {
...
function go() {
  return Pn || (Pn = 1, le.env.NODE_ENV !== "production" && function() {
    ...
    q.AsyncMode = b, q.ConcurrentMode = D, q.ContextConsumer = L, q.ContextProvider = T, q.Element = I, q.ForwardRef = B, q.Fragment = z, q.Lazy = ae, q.Memo = fe, q.Portal = Y, q.Profiler = te, q.StrictMode = X, q.Suspense = G, q.isAsyncMode = Z, q.isConcurrentMode = v, q.isContextConsumer = O, q.isContextProvider = N, q.isElement = P, q.isForwardRef = C, q.isFragment = k, q.isLazy = A, q.isMemo = $, q.isPortal = U, q.isProfiler = V, q.isStrictMode = M, q.isSuspense = se, q.isValidElementType = S, q.typeOf = E;
  }()), q;
}
var Ln;
function wr() {
  return Ln || (Ln = 1, le.env.NODE_ENV === "production" ? Be.exports = ho() : Be.exports = go()), Be.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function bo() {
  if (kn) return St;
  kn = 1;
  var t = wr(), e = mo(), n = Vt(), r = Er(), s = yo(), i = function() {
  };
  ...
  return St = function(a, l) {
    ...
    function g(v) {
      ...
      function P(k, A, $, U, V, M, se) {
        ...
        return A[$] == null ? k ? A[$] === null ? new m("The " + V + " `" + M + "` is marked as required " + ("in `" + U + "`, but its value is `null`.")) : new m("The " + V + " `" + M + "` is marked as required in " + ("`" + U + "`, but its value is `undefined`.")) : null : v(A, $, U, V, M);
      }
      var C = P.bind(null, !1);
    ...
    function S(v) {
      function O(N, P, C, k, A) {
        ...
        if (!Array.isArray($)) {
          var U = X($);
          return new m("Invalid " + k + " `" + A + "` of type " + ("`" + U + "` supplied to `" + C + "`, expected an array."));
        }
    ...
    function D(v) {
      function O(N, P, C, k, A) {
        if (!(N[P] instanceof v)) {
          var $ = v.name || f, U = Z(N[P]);
          return new m("Invalid " + k + " `" + A + "` of type " + ("`" + U + "` supplied to `" + C + "`, expected ") + ("instance of `" + $ + "`."));
        }
        return null;
      }
      return g(O);
    ...
    function T(v) {
      function O(N, P, C, k, A) {
        ...
        var $ = N[P], U = X($);
        if (U !== "object")
          return new m("Invalid " + k + " `" + A + "` of type " + ("`" + U + "` supplied to `" + C + "`, expected an object."));
        for (var V in $)
          if (r($, V)) {
            var M = v($, V, C, k, A + "." + V, n);
            if (M instanceof Error)
    ...
    function ae(v) {
      function O(N, P, C, k, A) {
        var $ = N[P], U = X($);
        if (U !== "object")
          return new m("Invalid " + k + " `" + A + "` of type `" + U + "` " + ("supplied to `" + C + "`, expected `object`."));
        for (var V in v) {
          var M = v[V];
...
if (le.env.NODE_ENV !== "production") {
  var So = wr(), wo = !0;
  Ft.exports = bo()(So.isElement, wo);
} else
  Ft.exports = vo()();
var Eo = Ft.exports;
const jo = /* @__PURE__ */ Dn(Eo);
var ee = [];
...
function Do(t, e, n) {
  ...
  t = t || {};
  var r = t.random || (t.rng || Ro)();
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, xo(r);
}
export {
  W as B,
  $o as C,
