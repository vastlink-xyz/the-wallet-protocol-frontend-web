...
import { Q as fe, X as Ce, i as ne, a as ve, I as we } from "./vendor-utils-RvkaSVWD.js";
var Z, f = pe;
...
const be = ge([
  {
    ...
    children: [
      ...
      },
      {
        path: "/auth",
        async lazy() {
          const { default: e } = await import("./page-BTMFrFgZ.js");
          return { Component: e };
        }
      },
      {
        ...
        async lazy() {
          const { default: e } = await import("./page-CBXUgIdG.js");
          return { Component: e };
        }
      },
      {
        ...
        async lazy() {
          const { default: e } = await import("./page-DDtnkYCn.js");
          return { Component: e };
        }
      },
      {
        path: "/",
        async lazy() {
          const { default: e } = await import("./main-layout-DyQHStsi.js");
          return { Component: e };
        },
        errorElement: /* @__PURE__ */ r.jsx(X, {}),
        children: [
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-CsL5p8qo.js");
                  return { Component: e };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: e } = await import("./page-Bx6T46BP.js");
                  return { Component: e };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-DzkD7kkP.js");
                  return { Component: e };
                }
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: e } = await import("./page-Dp3031Te.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-cYewioGL.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-BAab1gk4.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: e } = await import("./page-C2QqRAVI.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: e } = await import("./page-DoDraWT-.js");
                  return { Component: e };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: e } = await import("./page-Dm36MPRi.js");
                  return { Component: e };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: e } = await import("./page-DoJ2nGG1.js");
                          return { Component: e };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: e } = await import("./page-BJhUMwPn.js");
                          return { Component: e };
                        }
                      }
                    ]
        ...
        children: [
          {
            path: "transfer",
            async lazy() {
              const { default: e } = await import("./page-CWqSKXQ1.js");
              return { Component: e };
            }
          },
          {
            path: "register",
            async lazy() {
              const { default: e } = await import("./page-Cz9jVB9o.js");
              return { Component: e };
            }
          }
        ]
