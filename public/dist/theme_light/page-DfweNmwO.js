...
import { i as C, r, f as L, l as P, n as T } from "./vendor-react-Bi1rjDlg.js";
import { c as d, af as A, f as R, h as z, ag as E } from "./main-BoBlYE1P.js";
import { S as B, P as I } from "./ProductList-rchI11Sn.js";
import { a as O } from "./MarketplaceProvider-DvLlIR_m.js";
import { l as M, b as F } from "./vendor-ui-utils-CRHGvpNr.js";
import { P as _ } from "./index-DRdYnwds.js";
import { B as D } from "./vendor-utils-BZIeOlaI.js";
import { E as G } from "./index-Zjbw0r6U.js";
const N = [
  "Most popular",
  "Free",
  "Latest",
...
function W({
  ...
  const { checkNewProducts: l, hasNewProducts: f } = O(), i = C(), c = N, [v, b] = r.useState(!1), [y, h] = r.useState(!1), a = r.useRef(null), [m, j] = r.useState(!1), x = r.useRef(0), u = () => {
    const e = a.current;
    if (e) {
  ...
  return /* @__PURE__ */ t.jsxs(t.Fragment, { children: [
    m && /* @__PURE__ */ t.jsx("div", { className: "fixed top-0 left-0 right-0 h-[68px] bg-white shadow z-30" }),
    /* @__PURE__ */ t.jsxs(
      "div",
      {
        className: d([
                ...
                return /* @__PURE__ */ t.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ t.jsxs("div", { className: d(
                      ...
                      e,
                      e === "Added" && f && /* @__PURE__ */ t.jsx("div", { className: "absolute -top-1 -right-4 w-2 h-2 bg-red-500 rounded-full" })
                    ] })
                  },
                  s
                );
...
function ee() {
  const n = L(), [p] = P(), l = p.get("category"), [f, i] = r.useState(!1), [c, v] = r.useState(N[0]), {
    pagination: b,
    handlePageChange: y,
    updateTotal: h,
    updatePageSize: a
  } = A(), { products: m, total: j } = T(), [x, u] = r.useState(m), w = r.useCallback(async (s) => {
    try {
      i(!0);
