...
import { a as r } from "./vendor-react-DG1r0zWq.js";
import { c as $, I as q, B as u, L as T, f as U, g as b, h as B } from "./main-ZrsMs0Kw.js";
import { C as M } from "./card-C8ynHN8C.js";
import { L as O } from "./label-CcvMNezC.js";
import { T as te, a as se, b as H, c as j, d as oe, e as y } from "./table-Bx-QvTj0.js";
import { B as c } from "./vendor-utils-CARgNrN0.js";
import { S as le, v as me, g as ue } from "./frankieone-DzOavaY8.js";
import { R as he, E as pe } from "./vendor-ui-utils-9-Ouo9pm.js";
const re = ({ steps: N, currentStep: l }) => /* @__PURE__ */ e.jsx("div", { className: "w-full mb-8", children: /* @__PURE__ */ e.jsx("div", { className: "flex items-center justify-between", children: N.map((p, o) => /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col items-center flex-1", children: [
  ...
  for (let w = 0; w < g.length; w++)
    C[w] = g.charCodeAt(w);
  const A = new Uint8Array(C), v = new Blob([A], { type: p }), k = URL.createObjectURL(v), i = document.createElement("a");
...
function xe({
  ...
  const [l, p] = r.useState(!1), [o, g] = r.useState(1), [C, A] = r.useState(""), [v, k] = r.useState([]), [i, w] = r.useState(null), [V, Y] = r.useState(null), [S, R] = r.useState({
    asicExtract: "idle",
    uboReport: "idle"
  }), [I, W] = r.useState({
    asicExtract: null,
    ...
    try {
      p(!0);
      const t = (await U.post("/marketplace/product/frankieone/get-token")).data, { data: m } = await U.post("/marketplace/product/frankieone/business-lookup", {
        search: C,
        token: t
      });
      b("data", m), k(m), g(2);
    ...
    var m, f;
    try {
      const x = await U.get(`/marketplace/product/frankieone/retrieve-document?documentId=${s}`);
    ...
    const x = async () => {
      try {
        const a = await U.get(`/marketplace/product/frankieone/retrieve-response?requestId=${s}`);
        if (b("response", a.data), a.status === 202 || a.data.status === "pending")
          ...
          n.reportResult && n.reportResult.documentId ? await L(n.reportResult.documentId, t) : c.error(`No document ID found for ${t} report`), c.success(`${t} report is ready`);
        } else
  ...
  return /* @__PURE__ */ e.jsxs("div", { children: [
    ...
    o === 1 && /* @__PURE__ */ e.jsxs(M, { className: "p-8", children: [
      ...
      /* @__PURE__ */ e.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ e.jsx(q, { id: "search", name: "search", placeholder: "Business name or ABN / ACN", onChange: D }),
        /* @__PURE__ */ e.jsx(u, { onClick: E, disabled: l, children: l ? /* @__PURE__ */ e.jsx(T, {}) : "Search" })
      ] })
    ] }),
    o === 2 && /* @__PURE__ */ e.jsxs(M, { className: "p-8", children: [
      ...
      /* @__PURE__ */ e.jsxs(te, { children: [
        /* @__PURE__ */ e.jsx(se, { children: /* @__PURE__ */ e.jsxs(H, { children: [
          /* @__PURE__ */ e.jsx(j, { children: "Name" }),
          /* @__PURE__ */ e.jsx(j, { children: "ABN" }),
          /* @__PURE__ */ e.jsx(j, { children: "ACN" }),
          /* @__PURE__ */ e.jsx(j, { children: "State" }),
          /* @__PURE__ */ e.jsx(j, { children: "Action" })
        ] }) }),
        /* @__PURE__ */ e.jsx(oe, { children: v.map((s, t) => /* @__PURE__ */ e.jsxs(H, { children: [
          /* @__PURE__ */ e.jsx(y, { children: s.name }),
          /* @__PURE__ */ e.jsx(y, { children: s.abn }),
          /* @__PURE__ */ e.jsx(y, { children: s.acn || "N/A" }),
          /* @__PURE__ */ e.jsx(y, { children: s.state }),
          /* @__PURE__ */ e.jsx(y, { children: /* @__PURE__ */ e.jsx(u, { onClick: () => Z(s), children: "Select" }) })
        ] }, t)) })
      ] })
    ] }),
    o === 3 && i && /* @__PURE__ */ e.jsxs(M, { className: "p-8", children: [
        ...
        /* @__PURE__ */ e.jsxs("div", { className: "border rounded-lg p-4 flex justify-between items-center", children: [
          ...
          /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col space-y-2", children: [
            S.asicExtract !== "complete" && /* @__PURE__ */ e.jsx(
              u,
              {
                onClick: () => F("asicExtract"),
                disabled: S.asicExtract === "loading",
                className: "w-40",
                children: S.asicExtract === "loading" ? /* @__PURE__ */ e.jsx(T, {}) : "Generate Report"
              }
            ),
            S.asicExtract === "complete" && I.asicExtract && /* @__PURE__ */ e.jsx(u, { onClick: () => K("asicExtract"), className: "w-40", children: "Download Report" })
          ] })
        ] }),
        /* @__PURE__ */ e.jsxs("div", { className: "border rounded-lg p-4 flex justify-between items-center", children: [
          /* @__PURE__ */ e.jsxs("div", { className: "flex-grow", children: [
          ...
          /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col space-y-2", children: [
            S.uboReport !== "complete" && /* @__PURE__ */ e.jsx(
              u,
              {
                ...
                children: S.uboReport === "loading" ? /* @__PURE__ */ e.jsx(T, {}) : "Generate Report"
              }
            ),
            S.uboReport === "complete" && I.uboReport && /* @__PURE__ */ e.jsx(u, { onClick: () => K("uboReport"), className: "w-40", children: "Download Report" })
          ] })
        ] })
      ] }),
...
function Ne({
  ...
  const [l, p] = r.useState(!1), [o, g] = r.useState(1), [C, A] = r.useState(""), [v, k] = r.useState([]), [i, w] = r.useState(null), [V, Y] = r.useState(null), [S, R] = r.useState(""), [I, W] = r.useState(""), [D, E] = r.useState([]), [Z, L] = r.useState("idle"), F = (a) => {
    A(a);
  }, z = async () => {
    if (!S && !I) {
    ...
    try {
      p(!0);
      const { data: a } = await U.post("/marketplace/product/frankieone/international-business-search", {
        country: C,
    ...
    try {
      ...
      Y(d);
      const h = await ue(d);
      b("response", h), E(h.data.reports), L("idle");
    } catch (n) {
      const d = B(n);
      c.error(d.message), L("error");
    }
  }, t = (a, n) => {
    E((d) => {
      const h = [...d];
    ...
    if (i)
      try {
        t(n, "loading");
        const d = await U.post("/marketplace/product/frankieone/international-business-entity-report", {
          entityId: V,
    ...
    const Q = async () => {
      var X, _;
      try {
        const { data: G } = await U.post("/marketplace/product/frankieone/international-business-entity-report-status", {
          entityId: V,
          requestId: a
        });
        if (G.reportStatus !== "Completed")
          h < 60 ? (h++, setTimeout(Q, 1e4)) : (t(n, "error"), c.error("Timeout while generating report"));
        else if (G.reportStatus === "Completed") {
          const P = (_ = (X = (await U.post("/marketplace/product/frankieone/retrieve-document-scan-data-by-url", {
            documentUrl: G.reportUrl
          })).data) == null ? void 0 : X.document) == null ? void 0 : _.docScan;
          if (b("docScan", P), P && P.length > 0) {
            const J = P[P.length - 1], ae = J.scanMIME && J.scanType === "PDF";
            E((ie) => ie.map((ne, de) => de === n ? {
              ...ne,
              ordered: !0,
              doc: J,
  ...
  return /* @__PURE__ */ e.jsxs("div", { children: [
      ...
      /* @__PURE__ */ e.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ e.jsx(
          u,
          {
            onClick: z,
            disabled: l || !C || !S && !I,
            children: l ? /* @__PURE__ */ e.jsx(T, {}) : "Search"
          }
        )
      ] })
    ] }),
    o === 2 && /* @__PURE__ */ e.jsxs(M, { className: "p-8", children: [
      ...
      /* @__PURE__ */ e.jsxs(te, { children: [
        /* @__PURE__ */ e.jsx(se, { children: /* @__PURE__ */ e.jsxs(H, { children: [
          /* @__PURE__ */ e.jsx(j, { children: "Name" }),
          /* @__PURE__ */ e.jsx(j, { children: "Code" }),
          /* @__PURE__ */ e.jsx(j, { children: "Company ID" }),
          /* @__PURE__ */ e.jsx(j, { children: "Legal Status" }),
          /* @__PURE__ */ e.jsx(j, { children: "Action" })
        ] }) }),
        /* @__PURE__ */ e.jsx(oe, { children: v.map((a, n) => /* @__PURE__ */ e.jsxs(H, { children: [
          /* @__PURE__ */ e.jsx(y, { children: a.Name }),
          /* @__PURE__ */ e.jsx(y, { children: a.Code }),
          /* @__PURE__ */ e.jsx(y, { children: a.CompanyID }),
          /* @__PURE__ */ e.jsx(y, { children: a.LegalStatus }),
          /* @__PURE__ */ e.jsx(y, { children: /* @__PURE__ */ e.jsx(u, { onClick: () => K(a), children: "Select" }) })
        ] }, n)) })
      ] })
    ] }),
    o === 3 && i && /* @__PURE__ */ e.jsxs(M, { className: "p-8", children: [
      ...
      /* @__PURE__ */ e.jsx("div", { className: "space-y-4", children: D.length === 0 ? /* @__PURE__ */ e.jsx("div", { className: "flex justify-center", children: Z === "loading" ? /* @__PURE__ */ e.jsxs("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ e.jsx(T, {}),
        /* @__PURE__ */ e.jsx("p", { children: "Loading available reports..." })
      ] }) : "No reports available" }) : D.map((a, n) => /* @__PURE__ */ e.jsxs("div", { className: "border rounded-lg p-4 flex justify-between items-center", children: [
        /* @__PURE__ */ e.jsxs("div", { className: "flex-grow", children: [
        ...
        /* @__PURE__ */ e.jsx("div", { className: "flex flex-col space-y-2", children: a.ordered ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
          ...
          u,
          {
            ...
            className: "w-40",
            children: a.status === "loading" ? /* @__PURE__ */ e.jsx(T, {}) : a.status === "error" ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
...
function fe({
  ...
  const [l, p] = r.useState(null), o = (v) => {
    p(v);
  }, g = () => {
    window.open(window.location.href, "_blank");
  }, C = () => /* @__PURE__ */ e.jsxs(M, { className: "p-8 relative", children: [
    N && /* @__PURE__ */ e.jsx(
      u,
      {
        variant: "ghost",
  ...
  return l ? /* @__PURE__ */ e.jsx(xe, { resetFlow: A }) : l === !1 ? /* @__PURE__ */ e.jsx(Ne, { resetFlow: A }) : C();
}
function Be() {
  return /* @__PURE__ */ e.jsx("div", { className: "bg-background", children: /* @__PURE__ */ e.jsx(fe, { showExternalLink: !0 }) });
}
export {
  Be as default
};
