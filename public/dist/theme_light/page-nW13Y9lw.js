...
import { g as m, T as C, B as d, L as u, t as S, f as h } from "./main-aLpcFRdZ.js";
import { B as R } from "./vendor-utils-y1QZaLEY.js";
import { u as B } from "./useTransaction-Db6jmW6G.js";
import { f as x } from "./vendor-web3-BOznxXNv.js";
function G() {
  const [i] = w(), p = k(), { signTransaction: g, waitForTransactionExection: I } = B(), [e, j] = o.useState(), [r, v] = o.useState("PENDING"), [c, l] = o.useState(!1), T = o.useRef();
  o.useEffect(() => {
    y();
  }, [i]), o.useEffect(() => {
    e && v(e.status);
