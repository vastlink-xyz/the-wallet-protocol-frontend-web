import { j as b } from "./vendor-radix-CNSo_uHA.js";
import { a as Ol, c as ze, D as Tl, b as Il, d as Rl, e as Oo, l as _l, B as Us, f as As, h as zs, S as Ws, g as Dl, T as Zs, i as Gs } from "./main-BjushY0K.js";
import { i as jl, j as ls, L as Yl, r as B, a as _s, p as Fl, O as Ys } from "./vendor-react-U4DfHahV.js";
import { h as Xs, X as Vs } from "./vendor-ui-utils-BJ7JrnFc.js";
import { u as ss, B as Js } from "./vendor-utils-BclDYac0.js";
import { W as Xl, V as Ks } from "./index-D6b8OblB.js";
import { S as $s } from "./SendButton-Bzt-r73q.js";
import { W as qs, M as eu } from "./MarketplaceProvider-CEsK4kup.js";
function tu({ routes: f, currentRouteName: s }) {
  const { pathname: h } = jl(), m = ls(), A = Ol.isAuthenticated();
  return /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
    ...
    /* @__PURE__ */ b.jsx("div", { className: ze("flex tablet:hidden"), children: /* @__PURE__ */ b.jsxs(Tl, { children: [
      /* @__PURE__ */ b.jsx(Il, { asChild: !0, children: /* @__PURE__ */ b.jsxs("div", { className: ze(
      ...
      /* @__PURE__ */ b.jsx(Rl, { className: "bg-white", children: f.map((y) => {
        ...
        return /* @__PURE__ */ b.jsx(
          Oo,
          {
            ...
            children: P ? /* @__PURE__ */ b.jsxs(Yl, { to: y.href, className: "flex items-center gap-2", children: [
...
function Vl({
  ...
  const { i18n: s } = ss(), [h, m] = B.useState(!1);
  B.useEffect(() => {
    const P = _l.getData();
    P && s.changeLanguage(P);
  }, [s]);
  const A = (P) => {
    s.changeLanguage(P), _l.setData(P), m(!1), f == null || f();
      ...
      /* @__PURE__ */ b.jsxs("div", { className: "p-6 border-b border-[#EBEBEB] flex justify-center gap-[82px]", children: [
        /* @__PURE__ */ b.jsxs(
          "div",
          {
            ...
            children: [
              "English",
              s.language === "en" && /* @__PURE__ */ b.jsx("img", { src: "/imgs/icons/checked.svg", alt: "" })
            ]
          }
        ),
        /* @__PURE__ */ b.jsxs(
          "div",
          {
            ...
            children: [
              "简体中文",
              s.language === "zh" && /* @__PURE__ */ b.jsx("img", { src: "/imgs/icons/checked.svg", alt: "" })
            ]
          }
        )
      ] }),
...
function nu() {
  const [f, s] = B.useState(!1), h = async () => {
    try {
      await As.post("/auth/logout"), Ol.clearAllAuthData(), window.location.href = "/auth";
    } catch (m) {
      const A = zs(m);
      Js.error(A.message);
    }
  ...
  return /* @__PURE__ */ b.jsxs("div", { className: "justify-start items-center gap-[21px] flex", children: [
    /* @__PURE__ */ b.jsx("div", { className: "hidden tablet:flex", children: /* @__PURE__ */ b.jsx(Xl, {}) }),
    /* @__PURE__ */ b.jsxs("div", { className: "justify-start items-center gap-7 flex", children: [
            ...
            /* @__PURE__ */ b.jsxs(Rl, { className: "bg-white border-none", children: [
              /* @__PURE__ */ b.jsx(
                Oo,
                {
                  ...
                  children: /* @__PURE__ */ b.jsx(Xl, { className: "p-0 bg-transparent" })
                }
              ),
              /* @__PURE__ */ b.jsx(
                Oo,
              ...
              /* @__PURE__ */ b.jsx(
                ...
                {
                  onSelect: (m) => m.preventDefault(),
                  children: /* @__PURE__ */ b.jsx(Vl, { onLanguageChange: () => s(!1) })
                }
              ),
              /* @__PURE__ */ b.jsx(
                Oo,
      ...
      /* @__PURE__ */ b.jsx("div", { className: ze(
        ...
        /* @__PURE__ */ b.jsx(Rl, { className: "bg-white", children: /* @__PURE__ */ b.jsx(Oo, { onSelect: () => h(), children: "Logout" }) })
      ] }) }),
      /* @__PURE__ */ b.jsx("div", { className: ze(
        "hidden laptop:block",
      ...
      ), children: /* @__PURE__ */ b.jsx(Vl, {}) })
    ] })
  ] });
}
function ru() {
  const { pathname: f } = jl(), { t: s } = ss(), h = ls(), m = [
    {
...
function au() {
  ...
  function j(i, u, p, S, O, M, z) {
    this.acceptsBooleans = u === 2 || u === 3 || u === 4, this.attributeName = S, this.attributeNamespace = O, this.mustUseProperty = p, this.propertyName = i, this.type = u, this.sanitizeURL = M, this.removeEmptyString = z;
  }
  var T = {};
  ...
  function Z(i) {
    ...
    if (u) {
      ...
      for (S = u.index; S < i.length; S++) {
        ...
        O !== S && (p += i.substring(O, S)), O = S + 1, p += u;
      }
      i = O !== S ? p + i.substring(O, S) : p;
    }
    return i;
  }
  ...
  function le(i, u, p, S, O) {
    i = i === void 0 ? "" : i, u = u === void 0 ? ae : C('<script nonce="' + Z(u) + '">');
    var M = [];
    if (p !== void 0 && M.push(u, w(("" + p).replace(Ce, ee)), ce), S !== void 0) for (p = 0; p < S.length; p++) M.push(ve, w(Z(S[p])), Me);
  ...
  var me = C("<!-- -->");
  function Oe(i, u, p, S) {
    return u === "" ? S : (S && i.push(me), i.push(w(Z(u))), !0);
  }
      ...
      if (u = T.hasOwnProperty(p) ? T[p] : null, u !== null) {
        ...
        switch (p = w(u.attributeName), u.type) {
          case 3:
            ...
            break;
          case 4:
            S === !0 ? i.push(tt, p, Ue) : S !== !1 && i.push(tt, p, yt, w(Z(S)), xe);
            break;
          case 5:
            isNaN(S) || i.push(tt, p, yt, w(Z(S)), xe);
            break;
          case 6:
            !isNaN(S) && 1 <= S && i.push(tt, p, yt, w(Z(S)), xe);
            break;
          default:
            u.sanitizeURL && (S = "" + S), i.push(tt, p, yt, w(Z(S)), xe);
        }
      } else if (_(p)) {
        switch (typeof S) {
          case "function":
...
` && i.push(Rt), M;
      ...
      case "missing-glyph":
        return dt(i, p, u, S);
      case "html":
        return O.insertionMode === 0 && i.push(Xe), dt(i, p, u, S);
      default:
        if (u.indexOf("-") === -1 && typeof p.is != "string") return dt(i, p, u, S);
        i.push(et(u)), z = M = null;
  ...
  function ft(i, u, p, S) {
    switch (p.insertionMode) {
      case 0:
      case 1:
        return A(i, Mt), A(i, u.segmentPrefix), A(i, w(S.toString(16))), y(i, qt);
      case 2:
        return A(i, en), A(i, u.segmentPrefix), A(i, w(S.toString(16))), y(i, Dn);
      case 3:
        return A(i, Qt), A(i, u.segmentPrefix), A(i, w(S.toString(16))), y(i, Pn);
      case 4:
        return A(i, Ke), A(i, u.segmentPrefix), A(i, w(S.toString(16))), y(i, $n);
      case 5:
        return A(i, br), A(i, u.segmentPrefix), A(i, w(S.toString(16))), y(i, Ge);
      case 6:
        return A(i, $r), A(i, u.segmentPrefix), A(i, w(S.toString(16))), y(i, qr);
      case 7:
        return A(
          i,
          tr
        ), A(i, u.segmentPrefix), A(i, w(S.toString(16))), y(i, Bn);
      default:
        throw Error(s(397));
    }
  }
  ...
  function Xt(i, u, p) {
    ...
    if (30 < M) {
      var z = O - O % 5;
      return M = (S & (1 << z) - 1).toString(32), S >>= z, O -= z, { id: 1 << 32 - gn(u) + O | p << O | S, overflow: M + i };
    }
    return { id: 1 << M | p << O | S, overflow: i };
  }
  var gn = Math.clz32 ? Math.clz32 : Er, Ua = Math.log, za = Math.LN2;
  function Er(i) {
    return i >>>= 0, i === 0 ? 32 : 31 - (Ua(i) / za | 0) | 0;
  }
  function Wt(i, u) {
    return i === u && (i !== 0 || 1 / i === 1 / u) || i !== i && u !== u;
  }
  var Wa = typeof Object.is == "function" ? Object.is : Wt, Vt = null, eo = null, Cr = null, Qe = null, mn = !1, Dr = !1, yn = 0, un = null, Pr = 0;
  function cn() {
  ...
  function Br(i, u, p) {
    if (Vt = cn(), Qe = to(), mn) {
      var S = Qe.queue;
      if (u = S.dispatch, un !== null && (p = un.get(S), p !== void 0)) {
        un.delete(S), S = Qe.memoizedState;
        do
          S = i(S, p.action), p = p.next;
        while (p !== null);
        return Qe.memoizedState = S, [S, u];
      }
      return [Qe.memoizedState, u];
    }
    return i = i === No ? typeof u == "function" ? u() : u : p !== void 0 ? p(u) : u, Qe.memoizedState = i, i = Qe.queue = { last: null, dispatch: null }, i = i.dispatch = Za.bind(null, Vt, i), [Qe.memoizedState, i];
  }
  function Uo(i, u) {
    if (Vt = cn(), Qe = to(), u = u === void 0 ? null : u, Qe !== null) {
      ...
      if (p !== null && u !== null) {
        ...
        e: if (S === null) S = !1;
          ...
          for (var O = 0; O < S.length && O < u.length; O++) if (!Wa(u[O], S[O])) {
            S = !1;
            break e;
          }
          S = !0;
  ...
  function ro(i, u, p, S, O, M, z, J, pe) {
    var we = [], ye = /* @__PURE__ */ new Set();
    return u = { destination: null, responseState: u, progressiveChunkSize: S === void 0 ? 12800 : S, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: ye, pingedTasks: we, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: O === void 0 ? _a : O, onAllReady: M === void 0 ? Qn : M, onShellReady: z === void 0 ? Qn : z, onShellError: J === void 0 ? Qn : J, onFatalError: pe === void 0 ? Qn : pe }, p = On(u, 0, null, p, !1, !1), p.parentFlushed = !0, i = oo(u, i, null, p, ye, ie, null, vn), we.push(i), u;
  }
  function oo(i, u, p, S, O, M, z, J) {
    i.allPendingTasks++, p === null ? i.pendingRootTasks++ : p.pendingTasks++;
    var pe = { node: u, ping: function() {
      var we = i.pingedTasks;
      we.push(pe), we.length === 1 && Vo(i);
    }, blockedBoundary: p, blockedSegment: S, abortSet: O, legacyContext: M, context: z, treeContext: J };
    return O.add(pe), pe;
  }
  function On(i, u, p, S, O, M) {
    return { status: 0, id: -1, index: u, parentFlushed: !1, chunks: [], children: [], formatContext: S, boundary: p, lastPushedText: O, textEmbedded: M };
  }
  function or(i, u) {
  ...
  function Wo(i, u, p, S, O) {
    for (Vt = {}, eo = u, yn = 0, i = p(S, O); Dr; ) Dr = !1, yn = 0, Pr += 1, Qe = null, i = p(S, O);
    return nr(), i;
  }
  function Zo(i, u, p, S) {
    var O = p.render(), M = S.childContextTypes;
    if (M != null) {
      var z = u.legacyContext;
      if (typeof p.getChildContext != "function") S = z;
      else {
        p = p.getChildContext();
        for (var J in p) if (!(J in M)) throw Error(s(108, V(S) || "Unknown", J));
        S = Nt({}, z, p);
      }
      u.legacyContext = S, vt(i, u, O), u.legacyContext = z;
    } else vt(i, u, O);
  }
  function Go(i, u) {
    if (i && i.defaultProps) {
  ...
  function Ir(i, u, p, S, O) {
    if (typeof p == "function") if (p.prototype && p.prototype.isReactComponent) {
      O = he(p, u.legacyContext);
      var M = p.contextType;
      M = new p(S, typeof M == "object" && M !== null ? M._currentValue : O), sn(M, p, S, O), Zo(i, u, M, p);
    } else {
      M = he(p, u.legacyContext), O = Wo(i, u, p, S, M);
      var z = yn !== 0;
      if (typeof O == "object" && O !== null && typeof O.render == "function" && O.$$typeof === void 0) sn(O, p, S, M), Zo(i, u, O, p);
      else if (z) {
        S = u.treeContext, u.treeContext = Xt(S, 1, 0);
        try {
          vt(i, u, O);
        } finally {
          u.treeContext = S;
      ...
      switch (O = u.blockedSegment, M = Gn(O.chunks, p, S, i.responseState, O.formatContext), O.lastPushedText = !1, z = O.formatContext, O.formatContext = oe(z, p, S), Rr(i, u, M), O.formatContext = z, p) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      switch (p) {
        ...
        case qe:
          e: {
            p = u.blockedBoundary, O = u.blockedSegment, M = S.fallback, S = S.children, z = /* @__PURE__ */ new Set();
      ...
      if (typeof p == "object" && p !== null) switch (p.$$typeof) {
        case Rn:
          ...
          return;
        case a:
          p = p.type, S = Go(p, S), Ir(i, u, p, S, O);
          return;
        case Ut:
          if (O = S.children, p = p._context, S = S.value, M = p._currentValue, p._currentValue = S, z = se, se = S = { parent: z, depth: z === null ? 0 : z.depth + 1, context: p, parentValue: M, value: S }, u.context = S, vt(i, u, O), i = se, i === null) throw Error(s(403));
          S = i.parentValue, i.context._currentValue = S === I ? i.context._defaultValue : S, i = se = i.parent, u.context = i;
          return;
        case At:
          S = S.children, S = S(p._currentValue), vt(i, u, S);
          return;
        case c:
          O = p._init, p = O(p._payload), S = Go(p, S), Ir(i, u, p, S, void 0);
          return;
      }
      throw Error(s(
        130,
  ...
  function vt(i, u, p) {
    if (u.node = p, typeof p == "object" && p !== null) {
      ...
      if (p === null || typeof p != "object" ? S = null : (S = N && p[N] || p["@@iterator"], S = typeof S == "function" ? S : null), S && (S = S.call(p))) {
        if (p = S.next(), !p.done) {
          var O = [];
          do
            O.push(p.value), p = S.next();
          while (!p.done);
          _o(i, u, O);
        }
        return;
    ...
    typeof p == "string" ? (S = u.blockedSegment, S.lastPushedText = Oe(u.blockedSegment.chunks, p, i.responseState, S.lastPushedText)) : typeof p == "number" && (S = u.blockedSegment, S.lastPushedText = Oe(u.blockedSegment.chunks, "" + p, i.responseState, S.lastPushedText));
  }
  function _o(i, u, p) {
    for (var S = p.length, O = 0; O < S; O++) {
      var M = u.treeContext;
      u.treeContext = Xt(M, S, O);
      try {
        Rr(i, u, p[O]);
      } finally {
        u.treeContext = M;
  ...
  function Rr(i, u, p) {
    var S = u.blockedSegment.formatContext, O = u.legacyContext, M = u.context;
    try {
      return vt(i, u, p);
    } catch (pe) {
      if (nr(), typeof pe == "object" && pe !== null && typeof pe.then == "function") {
        ...
        z.children.push(J), z.lastPushedText = !1, i = oo(i, u.node, u.blockedBoundary, J, u.abortSet, u.legacyContext, u.context, u.treeContext).ping, p.then(i, i), u.blockedSegment.formatContext = S, u.legacyContext = O, u.context = M, zt(M);
      } else throw u.blockedSegment.formatContext = S, u.legacyContext = O, u.context = M, zt(M), pe;
    }
  }
  function Ya(i) {
  ...
  function Yo(i, u, p) {
    ...
    i.blockedSegment.status = 3, S === null ? (u.allPendingTasks--, u.status !== 2 && (u.status = 2, u.destination !== null && u.destination.close())) : (S.pendingTasks--, S.forceClientRender || (S.forceClientRender = !0, i = p === void 0 ? Error(s(432)) : p, S.errorDigest = u.onError(i), S.parentFlushed && u.clientRenderedBoundaries.push(S)), S.fallbackAbortableTasks.forEach(function(O) {
      return Yo(O, u, p);
      ...
      try {
        ...
        for (M = 0; M < O.length; M++) {
          ...
          if (pe.status === 0) {
            zt(z.context);
            try {
              vt(J, z, z.node), pe.lastPushedText && pe.textEmbedded && pe.chunks.push(me), z.abortSet.delete(z), pe.status = 1, Xo(J, z.blockedBoundary, pe);
            } catch (Dt) {
  ...
  function Qr(i, u, p) {
    switch (p.parentFlushed = !0, p.status) {
      case 0:
        ...
        return p.lastPushedText = !1, p.textEmbedded = !1, i = i.responseState, A(u, Ze), A(u, i.placeholderPrefix), i = w(S.toString(16)), A(u, i), y(u, Xn);
      case 1:
        p.status = 2;
        var O = !0;
        S = p.chunks;
        ...
        for (var z = 0; z < p.length; z++) {
          for (O = p[z]; M < O.index; M++) A(u, S[M]);
          O = Or(i, u, O);
        }
        for (; M < S.length - 1; M++) A(u, S[M]);
        return M < S.length && (O = y(u, S[M])), O;
      default:
        throw Error(s(390));
    }
  }
  function Or(i, u, p) {
    var S = p.boundary;
    if (S === null) return Qr(i, u, p);
    if (S.parentFlushed = !0, S.forceClientRender) S = S.errorDigest, y(u, Cn), A(u, Jn), S && (A(u, Kn), A(u, w(Z(S))), A(u, $t)), y(u, wr), Qr(i, u, p);
      ...
      O = C(O.boundaryPrefix + M.toString(16)), S = S.id = O, at(u, i.responseState, S), Qr(i, u, p);
    } else if (S.byteSize > i.progressiveChunkSize) S.rootSegmentID = i.nextSegmentId++, i.completedBoundaries.push(S), at(u, i.responseState, S.id), Qr(i, u, p);
    else {
      if (y(u, mr), p = S.completedSegments, p.length !== 1) throw Error(s(391));
      Or(i, u, p[0]);
    }
    return y(u, Kr);
  }
  ...
  function Ko(i, u, p) {
    for (var S = p.completedSegments, O = 0; O < S.length; O++) $o(i, u, p, S[O]);
    if (S.length = 0, i = i.responseState, S = p.id, p = p.rootSegmentID, A(u, i.startInlineScript), i.sentCompleteBoundaryFunction ? A(u, ht) : (i.sentCompleteBoundaryFunction = !0, A(u, on)), S === null) throw Error(s(395));
    return p = w(p.toString(16)), A(u, S), A(u, Sr), A(u, i.segmentPrefix), A(u, p), y(u, xr);
  }
  function $o(i, u, p, S) {
    if (S.status === 2) return !0;
    var O = S.id;
    if (O === -1) {
      if ((S.id = p.rootSegmentID) === -1) throw Error(s(392));
      return Jo(i, u, S);
    }
    return Jo(i, u, S), i = i.responseState, A(u, i.startInlineScript), i.sentCompleteSegmentFunction ? A(u, nn) : (i.sentCompleteSegmentFunction = !0, A(u, kn)), A(u, i.segmentPrefix), O = w(O.toString(16)), A(u, O), A(u, rn), A(u, i.placeholderPrefix), A(u, O), y(u, Ft);
  }
  function ao(i, u) {
    ...
    try {
      ...
      if (p !== null && i.pendingRootTasks === 0) {
        ...
        for (p = 0; p < S.length - 1; p++) A(u, S[p]);
        p < S.length && y(u, S[p]);
      }
      ...
      for (M = 0; M < gt.length; M++) Ko(i, u, gt[M]);
      ...
      for (M = 0; M < ar.length; M++) Ko(i, u, ar[M]);
      ar.splice(0, M);
    } finally {
    ...
    return new Promise(function(p, S) {
      ...
      if (u && u.signal) {
        var pe = u.signal, we = function() {
          qo(J, pe.reason), pe.removeEventListener("abort", we);
        };
...
` && e.push(gn), l;
    ...
    var za = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, Er = /* @__PURE__ */ new Map();
    function Wt(e) {
      var t = Er.get(e);
      if (t === void 0) {
        if (!za.test(e))
    ...
    function Vt(e, t, n, o, l) {
      switch (dt(t, n), gr(t, n), mr(t, n, null), !n.suppressContentEditableWarning && n.contentEditable && n.children != null && A("A component is `contentEditable` and contains `children` managed by React. It is now your responsibility to guarantee that none of those nodes are unexpectedly modified or duplicated. This is probably not intentional."), l.insertionMode !== jt && l.insertionMode !== kn && t.indexOf("-") === -1 && typeof n.is != "string" && t.toLowerCase() !== t && A("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", t), t) {
        ...
        case "missing-glyph":
          return vn(e, n, t, o);
        case "html":
          return l.insertionMode === tn && e.push(Wa), vn(e, n, t, o);
        default:
    ...
    var Pr = "<!--$-->", cn = '<!--$?--><template id="', Et = '"></template>', to = "<!--$!-->", nr = "<!--/$-->", No = "<template", Br = '"', Uo = ' data-dgst="', Za = ' data-msg="', Ga = ' data-stck="', kr = "></template>";
    function zo(e, t) {
      return C(e, Pr);
    }
    function rr(e, t, n) {
    ...
    function no(e, t, n, o, l) {
      var d;
      return d = C(e, to), w(e, No), n && (w(e, Uo), w(e, Ke(n)), w(e, Br)), o && (w(e, Za), w(e, Ke(o)), w(e, Br)), l && (w(e, Ga), w(e, Ke(l)), w(e, Br)), d = C(e, kr), d;
    }
    function _a(e, t) {
      return C(e, nr);
    }
    ...
    var oo = '<div hidden id="', On = '">', or = "</div>", Tr = '<svg aria-hidden="true" style="display:none" id="', Wo = '">', Zo = "</svg>", Go = '<math aria-hidden="true" style="display:none" id="', Ir = '">', vt = "</math>", _o = '<table hidden id="', Rr = '">', Ya = "</table>", Yo = '<table hidden><tbody id="', Mr = '">', Xo = "</tbody></table>", Vo = '<table hidden><tr id="', Qr = '">', Or = "</tr></table>", Jo = '<table hidden><colgroup id="', Ko = '">', $o = "</colgroup></table>";
    function ao(e, t, n, o) {
      switch (n.insertionMode) {
        ...
        case jt:
          return w(e, Tr), w(e, t.segmentPrefix), w(e, o.toString(16)), C(e, Wo);
        case kn:
          return w(e, Go), w(e, t.segmentPrefix), w(e, o.toString(16)), C(e, Ir);
        case nn:
          return w(e, _o), w(e, t.segmentPrefix), w(e, o.toString(16)), C(e, Rr);
        case rn:
          return w(e, Yo), w(e, t.segmentPrefix), w(e, o.toString(16)), C(e, Mr);
        case Ft:
          return w(e, Vo), w(e, t.segmentPrefix), w(e, o.toString(16)), C(e, Qr);
        case on:
          return w(e, Jo), w(e, t.segmentPrefix), w(e, o.toString(16)), C(e, Ko);
        default:
    ...
    var Ct = p + ';$RX("', Dt = '$RX("', jr = '"', ea = ")<\/script>", ar = ",";
    function TA(e, t, n, o, l, d) {
      if (w(e, t.startInlineScript), t.sentClientRenderFunction ? w(e, Dt) : (t.sentClientRenderFunction = !0, w(e, Ct)), n === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return w(e, n), w(e, jr), (o || l || d) && (w(e, ar), w(e, Xa(o || ""))), (l || d) && (w(e, ar), w(e, Xa(l || ""))), d && (w(e, ar), w(e, Xa(d))), C(e, ea);
    }
    var IA = /[<\u2028\u2029]/g;
    function Xa(e) {
    ...
    var bt = Object.assign, LA = Symbol.for("react.element"), Oi = Symbol.for("react.portal"), ta = Symbol.for("react.fragment"), Pt = Symbol.for("react.strict_mode"), ji = Symbol.for("react.profiler"), na = Symbol.for("react.provider"), ra = Symbol.for("react.context"), oa = Symbol.for("react.forward_ref"), aa = Symbol.for("react.suspense"), io = Symbol.for("react.suspense_list"), Ao = Symbol.for("react.memo"), Fr = Symbol.for("react.lazy"), Va = Symbol.for("react.scope"), Ja = Symbol.for("react.debug_trace_mode"), Ka = Symbol.for("react.legacy_hidden"), ia = Symbol.for("react.default_value"), Fi = Symbol.iterator, HA = "@@iterator";
    function NA(e) {
    ...
    function Hi() {
      {
        if (lo === 0) {
          Li = console.log, qa = console.info, He = console.warn, Lr = console.error, ei = console.group, ti = console.groupCollapsed, ni = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: ri,
    ...
    var Aa = h.ReactCurrentDispatcher, la;
    function so(e, t, n) {
      {
        if (la === void 0)
          try {
...
` + la + e;
    ...
    function ir(e, t) {
      ...
      var d;
      d = Aa.current, Aa.current = null, Hi();
      try {
        if (t) {
          var v = function() {
            throw Error();
...
` + D[W].replace(" at new ", " at ");
        ...
        oi = !1, Aa.current = d, Ni(), Error.prepareStackTrace = l;
      }
    ...
    var Ui = {}, Ai = h.ReactDebugCurrentFrame;
    function sa(e) {
      if (e) {
    ...
    function ua(e, t, n, o, l) {
      {
        ...
        for (var v in e)
          if (d(e, v)) {
            ...
            D && !(D instanceof Error) && (sa(l), A("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", n, v, typeof D), sa(null)), D instanceof Error && !(D.message in Ui) && (Ui[D.message] = !0, sa(l), A("Failed %s type: %s", n, D.message), sa(null));
          }
      }
    }
    var ca;
    ...
    function zi(e, t, n, o) {
      {
        if (typeof e.getChildContext != "function") {
          {
            var l = Ne(t) || "Unknown";
            ca[l] || (ca[l] = !0, A("%s.childContextTypes is specified but there is no getChildContext() method on the instance. You can either define getChildContext() on %s or remove childContextTypes from it.", l, l));
          }
          return n;
        }
    ...
    function po(e, t) {
      ...
      if (n === null)
        throw new Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");
      e.depth === n.depth ? fa(e, n) : po(e, n), lr(t);
    }
    function vo(e) {
      var t = jn, n = e;
      t !== n && (t === null ? ha(n) : n === null ? Fn(t) : t.depth === n.depth ? fa(t, n) : t.depth > n.depth ? pa(t, n) : po(t, n), jn = n);
    }
    function Wi(e, t) {
      var n;
    ...
    function Zi(e) {
      ...
      {
        var n = t.parentValue;
        n === ia ? t.context._currentValue2 = t.context._defaultValue : t.context._currentValue2 = n, e._currentRenderer2 !== void 0 && e._currentRenderer2 !== null && e._currentRenderer2 !== Ar && A("Detected multiple renderers concurrently rendering the same context provider. This is currently unsupported."), e._currentRenderer2 = Ar;
      }
      return jn = t.parent;
    }
    function Gi() {
    ...
    var _i = {}, Nr = {}, go, ui, va, ga, ma, Ur, mo, yo, ya;
    {
      go = /* @__PURE__ */ new Set(), ui = /* @__PURE__ */ new Set(), va = /* @__PURE__ */ new Set(), mo = /* @__PURE__ */ new Set(), ga = /* @__PURE__ */ new Set(), yo = /* @__PURE__ */ new Set(), ya = /* @__PURE__ */ new Set();
      ...
      Ur = function(e, t) {
        ...
        if (t === void 0) {
          ...
          ga.has(n) || (ga.add(n), A("%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. You have returned undefined.", n));
        }
      };
    }
    function wa(e, t) {
...
Please check the code for the %s component.`, t, t, o), _i[l] = !0;
    ...
    var ba = {
      ...
      enqueueSetState: function(e, t, n) {
        var o = si(e);
        o.queue === null ? wa(e, "setState") : (o.queue.push(t), n != null && Ur(n, "setState"));
      },
      ...
      enqueueForceUpdate: function(e, t) {
        var n = si(e);
        n.queue === null ? wa(e, "forceUpdate") : t != null && Ur(t, "setState");
      }
    };
    function ci(e, t, n, o, l) {
      var d = n(l, o);
      ma(t, d);
      ...
      var D = new e(t, o);
      {
        ...
        if (typeof e.getDerivedStateFromProps == "function" || typeof D.getSnapshotBeforeUpdate == "function") {
          ...
          if (typeof D.componentWillMount == "function" && D.componentWillMount.__suppressDeprecationWarning !== !0 ? W = "componentWillMount" : typeof D.UNSAFE_componentWillMount == "function" && (W = "UNSAFE_componentWillMount"), typeof D.componentWillReceiveProps == "function" && D.componentWillReceiveProps.__suppressDeprecationWarning !== !0 ? Y = "componentWillReceiveProps" : typeof D.UNSAFE_componentWillReceiveProps == "function" && (Y = "UNSAFE_componentWillReceiveProps"), typeof D.componentWillUpdate == "function" && D.componentWillUpdate.__suppressDeprecationWarning !== !0 ? q = "componentWillUpdate" : typeof D.UNSAFE_componentWillUpdate == "function" && (q = "UNSAFE_componentWillUpdate"), W !== null || Y !== null || q !== null) {
            ...
            va.has(ge) || (va.add(ge), A(`Unsafe legacy lifecycles will not be called for components using new component APIs.
    ...
    function Xi(e, t, n) {
      {
        ...
        var d = e.props !== n;
        e.props !== void 0 && d && A("%s(...): When calling super() in `%s`, make sure to pass up the same props that your component's constructor was passed.", o, o), e.defaultProps && A("Setting defaultProps as an instance property on %s is not supported and will be ignored. Instead, define defaultProps as a static property on %s.", o, o), typeof e.getSnapshotBeforeUpdate == "function" && typeof e.componentDidUpdate != "function" && !ui.has(t) && (ui.add(t), A("%s: getSnapshotBeforeUpdate() should be used with componentDidUpdate(). This component defines getSnapshotBeforeUpdate() only.", Ne(t))), typeof e.getDerivedStateFromProps == "function" && A("%s: getDerivedStateFromProps() is defined as an instance method and will be ignored. Instead, declare it as a static method.", o), typeof e.getDerivedStateFromError == "function" && A("%s: getDerivedStateFromError() is defined as an instance method and will be ignored. Instead, declare it as a static method.", o), typeof t.getSnapshotBeforeUpdate == "function" && A("%s: getSnapshotBeforeUpdate() is defined as a static method and will be ignored. Instead, declare it as an instance method.", o);
        var v = e.state;
...
Please update the following components: %s`,
      ...
      typeof t.UNSAFE_componentWillMount == "function" && t.UNSAFE_componentWillMount(), n !== t.state && (A("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", Ne(e) || "Component"), ba.enqueueReplaceState(t, t.state, null));
    }
    function ZA(e, t, n, o) {
    ...
    function Ji(e, t, n, o) {
      ...
      typeof R == "function" && (e.state = ci(e, t, R, l, n)), typeof t.getDerivedStateFromProps != "function" && typeof e.getSnapshotBeforeUpdate != "function" && (typeof e.UNSAFE_componentWillMount == "function" || typeof e.componentWillMount == "function") && (Vi(t, e), ZA(d, e, n, o));
    }
    var GA = {
      id: 1,
      overflow: ""
    ...
    var XA = Math.clz32 ? Math.clz32 : VA, fi = Math.log, Sa = Math.LN2;
    function VA(e) {
      var t = e >>> 0;
      return t === 0 ? 32 : 31 - (fi(t) / Sa | 0) | 0;
    }
    function JA(e, t) {
      return e === t && (e !== 0 || 1 / e === 1 / t) || e !== e && t !== t;
    }
    var KA = typeof Object.is == "function" ? Object.is : JA, wn = null, hi = null, xa = null, Fe = null, Bt = !1, zr = !1, sr = 0, ke = null, Hn = 0, Ea = 25, kt = !1, Tt;
    function dn() {
      if (wn === null)
...
Incoming: %s`, Tt, "[" + e.join(", ") + "]", "[" + t.join(", ") + "]");
    ...
    function Nn() {
      return Fe === null ? xa === null ? (Bt = !1, xa = Fe = Jt()) : (Bt = !0, Fe = xa) : Fe.next === null ? (Bt = !1, Fe = Fe.next = Jt()) : (Bt = !0, Fe = Fe.next), Fe;
    }
    function ur(e, t) {
      wn = t, hi = e, kt = !1, sr = 0;
    }
    ...
    function So() {
      kt = !1, wn = null, hi = null, zr = !1, xa = null, Hn = 0, ke = null, Fe = null;
    }
    function el(e) {
    ...
    function Ki(e, t, n) {
      if (e !== Ca && (Tt = "useReducer"), wn = dn(), Fe = Nn(), Bt) {
        ...
        kt = !0;
        var W;
        e === Ca ? W = typeof t == "function" ? t() : t : W = n !== void 0 ? n(t) : t, kt = !1, Fe.memoizedState = W;
        var Y = Fe.queue = {
          last: null,
          dispatch: null
    ...
    function ll() {
      var e = hi, t = _A(e.treeContext), n = mi;
      if (n === null)
...
` + o.stack;
    ...
    var Ba = h.ReactCurrentDispatcher, xo = h.ReactDebugCurrentFrame, ka = 0, Wr = 1, Ta = 2, Ia = 3, Ra = 4, Zr = 0, yi = 1, cr = 2, rA = 12800;
    function sl(e) {
    ...
    function _r(e, t, n, o, l, d, v, D, R) {
      ...
      ge.parentFlushed = !0;
      var Te = dr(q, e, null, ge, Y, fo, da, GA);
      return W.push(Te), q;
    }
    function ul(e, t) {
      var n = e.pingedTasks;
    ...
    var bn = null;
    function wi() {
      return bn === null || bn.componentStack === null ? "" : Pa(bn.componentStack);
    }
    function fr(e, t) {
      e.componentStack = {
        tag: 0,
    ...
    function Kt(e, t) {
      ...
      o(t), e.destination !== null ? (e.status = cr, L(e.destination, t)) : (e.status = yi, e.fatalError = t);
    }
    function Do(e, t, n) {
      fr(t, "Suspense");
      var o = t.blockedBoundary, l = t.blockedSegment, d = n.fallback, v = n.children, D = /* @__PURE__ */ new Set(), R = cl(e, D), W = l.chunks.length, Y = Ma(
        e,
        W,
        R,
        l.formatContext,
      ...
      try {
        ...
        q.status = Ra, R.forceClientRender = !0, R.errorDigest = Co(e, Te), Qa(R, Te);
      } finally {
    ...
    function oA(e, t, n, o, l) {
      var d = n.render();
      n.props !== l && (xi || A("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", Ne(o) || "a component"), xi = !0);
      {
    ...
    var aA = {}, ko = {}, Si = {}, iA = {}, xi = !1, To = {}, Ei = !1, Ci = !1, Di = !1;
    function AA(e, t, n, o) {
      var l;
    ...
    function lA(e) {
      {
        ...
        if (typeof e.contextType == "object" && e.contextType !== null) {
          var o = Ne(e) || "Unknown";
          Si[o] || (A("%s: Function components do not support contextType.", o), Si[o] = !0);
        }
      }
    }
    function Pi(e, t) {
    ...
    function sA(e, t, n, o, l) {
      Eo(t, n.render);
      var d = Bo(e, t, n.render, o, l), v = pi();
      if (v) {
        var D = t.treeContext, R = 1, W = 0;
        t.treeContext = di(D, R, W);
        try {
          It(e, t, d);
        } finally {
          t.treeContext = D;
    ...
    function fl(e, t, n, o, l) {
      var d = n.type, v = Pi(d, o);
      Bi(e, t, d, v, l);
    }
    function hl(e, t, n, o) {
      n._context === void 0 ? n !== n.Consumer && (Di || (Di = !0, A("Rendering <Context> directly is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?"))) : n = n._context;
      var l = o.children;
    ...
    function pl(e, t, n, o, l) {
      fr(t, "Lazy");
      var d = n._payload, v = n._init, D = v(d), R = Pi(D, o);
      Bi(e, t, D, R, l), fn(t);
    }
    ...
    function vl(e, t) {
      ...
      e[Symbol.toStringTag] === "Generator" && (Ei || A("Using Generators as children is unsupported and will likely yield unexpected results because enumerating a generator mutates it. You may convert it to an array with `Array.from()` or the `[...spread]` operator before rendering. Keep in mind you might need to polyfill these features for older browsers."), Ei = !0), e.entries === t && (Ci || A("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Ci = !0);
    }
    function It(e, t, n) {
      try {
        return gl(e, t, n);
      } catch (o) {
        throw typeof o == "object" && o !== null && typeof o.then == "function" || (xn = xn !== null ? xn : wi()), o;
      }
    }
    function gl(e, t, n) {
    ...
    function yl(e, t, n, o) {
      var l = Co(e, o);
      if (t === null ? Kt(e, o) : (t.pendingTasks--, t.forceClientRender || (t.forceClientRender = !0, t.errorDigest = l, Qa(t, o), t.parentFlushed && e.clientRenderedBoundaries.push(t))), e.allPendingTasks--, e.allPendingTasks === 0) {
        var d = e.onAllReady;
        d();
      }
    }
      ...
      if (n.status === ka) {
        ...
        try {
          ...
          if (So(), typeof d == "object" && d !== null && typeof d.then == "function") {
            ...
            t.abortSet.delete(t), n.status = Ra, yl(e, t.blockedBoundary, n, d);
        } finally {
          bn = o;
        }
      }
    ...
    function ki(e) {
      if (e.status !== cr) {
        var t = Gi(), n = Ba.current;
        Ba.current = tA;
        var o;
        o = xo.getCurrentStack, xo.getCurrentStack = wi;
        var l = mi;
        nA(e.responseState);
        try {
          ...
          nA(l), Ba.current = n, xo.getCurrentStack = o, n === tA && vo(t);
        }
      }
    }
    function hr(e, t, n) {
    ...
    function Ti(e, t, n) {
      return ao(t, e.responseState, n.formatContext, n.id), Io(e, t, n), qo(t, n.formatContext);
    }
    function Ro(e, t, n) {
    ...
    function hA(e, t, n, o) {
      ...
      if (l === -1) {
        ...
        return Ti(e, t, o), J(t, e.responseState, l);
    }
    function Fa(e, t) {
      try {
    ...
    function gA(e, t, n, o) {
      ...
      var Y = _r(e, RA(n, t ? t.identifierPrefix : void 0), MA(), 1 / 0, Ii, void 0, W);
...
var wA = {}, ql;
function Au() {
  return ql || (ql = 1, Fl.env.NODE_ENV !== "production" && function() {
    var f = B, s = "18.3.1", h = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function m(r) {
      {
    ...
    function Wt(r, e, t, n) {
      ...
      if (o != null) {
        var Y;
        if (d !== null ? ($(d, "value"), Y = "" + d) : (D !== null && (vn || (vn = !0, A("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), Y = za(l)), ft(o))
...
` && r.push(yn), o;
    ...
    var Ga = T('<template id="'), kr = T('"></template>');
    function zo(r, e, t) {
      k(r, Ga), k(r, e.placeholderPrefix);
      var n = j(t.toString(16));
      return k(r, n), F(r, kr);
    }
    var rr = T("<!--$-->"), no = T('<!--$?--><template id="'), _a = T('"></template>'), Qn = T("<!--$!-->"), ro = T("<!--/$-->"), oo = T("<template"), On = T('"'), or = T(' data-dgst="'), Tr = T(' data-msg="'), Wo = T(' data-stck="'), Zo = T("></template>");
    function Go(r, e) {
      return F(r, rr);
    }
    function Ir(r, e, t) {
    ...
    function vt(r, e, t, n, o) {
      var l;
      return l = F(r, Qn), k(r, oo), t && (k(r, or), k(r, j(Ge(t))), k(r, On)), n && (k(r, Tr), k(r, j(Ge(n))), k(r, On)), o && (k(r, Wo), k(r, j(Ge(o))), k(r, On)), l = F(r, Zo), l;
    }
    function _o(r, e) {
      return F(r, ro);
    }
    ...
    var Yo = T('<div hidden id="'), Mr = T('">'), Xo = T("</div>"), Vo = T('<svg aria-hidden="true" style="display:none" id="'), Qr = T('">'), Or = T("</svg>"), Jo = T('<math aria-hidden="true" style="display:none" id="'), Ko = T('">'), $o = T("</math>"), ao = T('<table hidden id="'), qo = T('">'), i = T("</table>"), u = T('<table hidden><tbody id="'), p = T('">'), S = T("</tbody></table>"), O = T('<table hidden><tr id="'), M = T('">'), z = T("</tr></table>"), J = T('<table hidden><colgroup id="'), pe = T('">'), we = T("</colgroup></table>");
    function ye(r, e, t, n) {
      switch (t.insertionMode) {
        case Yt:
        case _e:
          return k(r, Yo), k(r, e.segmentPrefix), k(r, j(n.toString(16))), F(r, Mr);
        case Lt:
          return k(r, Vo), k(r, e.segmentPrefix), k(r, j(n.toString(16))), F(r, Qr);
        case Ht:
          return k(r, Jo), k(r, e.segmentPrefix), k(r, j(n.toString(16))), F(r, Ko);
        case an:
          return k(r, ao), k(r, e.segmentPrefix), k(r, j(n.toString(16))), F(r, qo);
        case Tn:
    ...
    function LA(r, e, t, n, o, l) {
      if (k(r, e.startInlineScript), e.sentClientRenderFunction ? k(r, OA) : (e.sentClientRenderFunction = !0, k(r, QA)), t === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return k(r, t), k(r, jA), (n || o || l) && (k(r, bt), k(r, j(ta(n || "")))), (o || l) && (k(r, bt), k(r, j(ta(o || "")))), l && (k(r, bt), k(r, j(ta(l)))), F(r, FA);
    }
    var Oi = /[<\u2028\u2029]/g;
    function ta(r) {
    ...
    var Pt = Object.assign, ji = Symbol.for("react.element"), na = Symbol.for("react.portal"), ra = Symbol.for("react.fragment"), oa = Symbol.for("react.strict_mode"), aa = Symbol.for("react.profiler"), io = Symbol.for("react.provider"), Ao = Symbol.for("react.context"), Fr = Symbol.for("react.forward_ref"), Va = Symbol.for("react.suspense"), Ja = Symbol.for("react.suspense_list"), Ka = Symbol.for("react.memo"), ia = Symbol.for("react.lazy"), Fi = Symbol.for("react.scope"), HA = Symbol.for("react.debug_trace_mode"), NA = Symbol.for("react.legacy_hidden"), UA = Symbol.for("react.default_value"), $a = Symbol.iterator, Ne = "@@iterator";
    function lo(r) {
    ...
    function He(r) {
      ...
      if (typeof r == "object")
        switch (r.$$typeof) {
          case Ao:
            var e = r;
            return qa(e) + ".Consumer";
          case io:
            var t = r;
            return qa(t._context) + ".Provider";
          case Fr:
    ...
    function so() {
      {
        if (Lr === 0) {
          ei = console.log, ti = console.info, ni = console.warn, ri = console.error, Hi = console.group, Ni = console.groupCollapsed, Aa = console.groupEnd;
          var r = {
            configurable: !0,
            enumerable: !0,
            value: la,
    ...
    var Hr = h.ReactCurrentDispatcher, ai;
    function ir(r, e, t) {
      {
        if (ai === void 0)
          try {
...
` + v[R].replace(" at new ", " at ");
        ...
        ii = !1, Hr.current = l, oi(), Error.prepareStackTrace = o;
      }
    ...
    var ca = {}, fo = h.ReactDebugCurrentFrame;
    function ho(r) {
      if (r) {
    ...
    function Gi(r, e) {
      ...
      if (t === null)
        throw new Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");
      r.depth === t.depth ? po(r, t) : Gi(r, t), pa(e);
    }
    function Ln(r) {
      var e = Fn, t = r;
    ...
    var va = {}, ga = {}, ma, Ur, mo, yo, ya, wo, wa, ba, ci;
    {
      ma = /* @__PURE__ */ new Set(), Ur = /* @__PURE__ */ new Set(), mo = /* @__PURE__ */ new Set(), wa = /* @__PURE__ */ new Set(), yo = /* @__PURE__ */ new Set(), ba = /* @__PURE__ */ new Set(), ci = /* @__PURE__ */ new Set();
    ...
    function Ji(r, e, t) {
      ...
      var v = new r(e, n);
      {
        if (typeof r.getDerivedStateFromProps == "function" && (v.state === null || v.state === void 0)) {
          ...
          ma.has(D) || (ma.add(D), A("`%s` uses `getDerivedStateFromProps` but its initial state is %s. This is not recommended. Instead, define the initial state by assigning an object to `this.state` in the constructor of `%s`. This ensures that `getDerivedStateFromProps` arguments have a consistent shape.", D, v.state === null ? "null" : "undefined", D));
        }
...
Please update the following components: %s`,
    ...
    function bo(r, e, t, n) {
      ...
      if (typeof d == "object" && d !== null ? r.context = Nr(d) : r.context = n, r.state === t) {
        ...
        wa.has(v) || (wa.add(v), A("%s: It is not recommended to assign props directly to state because updates to props won't be reflected in state. In most cases, it is better to use props directly.", v));
      }
      var D = e.getDerivedStateFromProps;
      typeof D == "function" && (r.state = ZA(r, e, D, o, t)), typeof e.getDerivedStateFromProps != "function" && typeof r.getSnapshotBeforeUpdate != "function" && (typeof r.UNSAFE_componentWillMount == "function" || typeof r.componentWillMount == "function") && (_A(e, r), di(l, r, t, n));
    }
    var YA = {
      id: 1,
      overflow: ""
    ...
    function fi(r, e, t) {
      var n = r.id, o = r.overflow, l = Sa(n) - 1, d = n & ~(1 << l), v = t + 1, D = Sa(e) + l;
      if (D > 30) {
        var R = l - l % 5, W = (1 << R) - 1, Y = (d & W).toString(32), q = d >> R, ge = l - R, Te = Sa(e) + ge, rt = v << ge, pr = rt | q, vr = Y + o;
        return {
          id: 1 << Te | pr,
          overflow: vr
        };
    ...
    var JA = Math.clz32 ? Math.clz32 : hi, KA = Math.log, wn = Math.LN2;
    function hi(r) {
      var e = r >>> 0;
    ...
    var Fe = typeof Object.is == "function" ? Object.is : xa, Bt = null, zr = null, sr = null, ke = null, Hn = !1, Ea = !1, kt = 0, Tt = null, dn = 0, $A = 25, Jt = !1, Nn;
    function ur() {
      if (Bt === null)
        throw new Error(`Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
...
Incoming: %s`, Nn, "[" + r.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function So() {
      return ke === null ? sr === null ? (Hn = !1, sr = ke = pi()) : (Hn = !0, ke = sr) : ke.next === null ? (Hn = !1, ke = ke.next = pi()) : (Hn = !0, ke = ke.next), ke;
    }
    function el(r, e) {
      Bt = e, zr = r, Jt = !1, kt = 0;
    }
    function tl(r, e, t, n) {
      for (; Ea; )
        Ea = !1, kt = 0, dn += 1, ke = null, t = r(e, n);
      return vi(), t;
    }
    function Ca() {
      var r = kt !== 0;
    ...
    function vi() {
      Jt = !1, Bt = null, zr = null, Ea = !1, sr = null, dn = 0, Tt = null, ke = null;
    }
    function Ki(r) {
    ...
    function qi(r, e, t) {
      if (r !== gi && (Nn = "useReducer"), Bt = ur(), ke = So(), Hn) {
        ...
        Jt = !0;
        var R;
        r === gi ? R = typeof e == "function" ? e() : e : R = t !== void 0 ? t(e) : e, Jt = !1, ke.memoizedState = R;
        var W = ke.queue = {
          last: null,
          dispatch: null
...
` + n.stack;
    ...
    var Ta = h.ReactCurrentDispatcher, Ia = h.ReactDebugCurrentFrame, Ra = 0, Zr = 1, yi = 2, cr = 3, rA = 4, sl = 0, Gr = 1, _r = 2, ul = 12800;
    function cl(r) {
      return console.error(r), null;
    }
    function dr() {
    }
    function Ma(r, e, t, n, o, l, d, v, D) {
      ...
      q.parentFlushed = !0;
      var ge = fr(Y, r, null, q, W, da, fa, YA);
      return R.push(ge), Y;
    }
    function bn(r, e) {
      var t = r.pingedTasks;
    ...
    function oA(r, e, t) {
      xn(e, "Suspense");
      var n = e.blockedBoundary, o = e.blockedSegment, l = t.fallback, d = t.children, v = /* @__PURE__ */ new Set(), D = wi(r, v), R = o.chunks.length, W = Eo(
        r,
        R,
        D,
        o.formatContext,
      ...
      try {
        ...
        Y.status = rA, D.forceClientRender = !0, D.errorDigest = Po(r, ge), bi(D, ge);
      } finally {
    ...
    function dl(r, e, t, n) {
      ...
      o.formatContext = pn(d, t, n), Yr(r, e, l), o.formatContext = d, Uo(o.chunks, t), o.lastPushedText = !1, Kt(e);
    }
    function aA(r) {
    ...
    function Si(r, e, t, n, o) {
      var l = t.render();
      t.props !== o && (Di || A("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", He(n) || "a component"), Di = !0);
      {
        var d = n.childContextTypes;
        if (d != null) {
          var v = e.legacyContext, D = li(t, n, v, d);
    ...
    function iA(r, e, t, n) {
      ...
      bo(l, t, n, o), Si(r, e, l, t, n), Kt(e);
    }
    var xi = {}, To = {}, Ei = {}, Ci = {}, Di = !1, AA = {}, lA = !1, Pi = !1, sA = !1;
    function fl(r, e, t, n) {
      var o;
      if (o = jn(t, e.legacyContext), Qa(e, t), t.prototype && typeof t.prototype.render == "function") {
        var l = He(t) || "Unknown";
        xi[l] || (A("The <%s /> component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.", l, l), xi[l] = !0);
      }
      ...
      if (
        ...
        bo(d, t, n, o), Si(r, e, d, t, n);
      } else if (hl(t), v) {
        var W = e.treeContext, Y = 1, q = 0;
        e.treeContext = fi(W, Y, q);
        try {
          mt(r, e, d);
        } finally {
          e.treeContext = W;
    ...
    function hl(r) {
      {
        ...
        if (typeof r.getDerivedStateFromProps == "function") {
          var t = He(r) || "Unknown";
          Ci[t] || (A("%s: Function components do not support getDerivedStateFromProps.", t), Ci[t] = !0);
        }
        if (typeof r.contextType == "object" && r.contextType !== null) {
          var n = He(r) || "Unknown";
          Ei[n] || (A("%s: Function components do not support contextType.", n), Ei[n] = !0);
        }
      }
    }
    function uA(r, e) {
    ...
    function It(r, e, t, n) {
      ...
      v = e.context, e.context = si(o, l), mt(r, e, d), e.context = WA(o), v !== e.context && A("Popping the context provider did not return back to the original snapshot. This is a bug in React.");
    }
    ...
    function Yr(r, e, t) {
      ...
      try {
        ...
        if (vi(), typeof v == "object" && v !== null && typeof v.then == "function") {
    ...
    function fA(r, e, t, n) {
      var o = Po(r, n);
      if (e === null ? Bo(r, n) : (e.pendingTasks--, e.forceClientRender || (e.forceClientRender = !0, e.errorDigest = o, bi(e, n), e.parentFlushed && r.clientRenderedBoundaries.push(e))), r.allPendingTasks--, r.allPendingTasks === 0) {
        var l = r.onAllReady;
        l();
      }
    }
    ...
    function bl(r, e) {
      ...
      if (t.status === Ra) {
        ...
        try {
          ...
          if (vi(), typeof l == "object" && l !== null && typeof l.then == "function") {
            var o = e.ping;
            l.then(o, o);
          } else
    ...
    function Ti(r) {
      if (r.status !== _r) {
        var e = _i(), t = Ta.current;
        Ta.current = Ba;
        var n;
        n = Ia.getCurrentStack, Ia.getCurrentStack = fn;
        var o = xo;
        ka(r.responseState);
        try {
          ...
          l.splice(0, d), r.destination !== null && Ii(r, r.destination);
        } catch (D) {
          Po(r, D), Bo(r, D);
        } finally {
          ka(o), Ta.current = t, Ia.getCurrentStack = n, t === Ba && Ln(e);
        }
      }
    }
    function Ro(r, e, t) {
    ...
    function ja(r, e, t) {
      ...
      if (n.parentFlushed = !0, n.forceClientRender)
        return vt(e, r.responseState, n.errorDigest, n.errorMessage, n.errorComponentStack), Ro(r, e, t), Ya(e, r.responseState);
      if (n.pendingTasks > 0) {
        ...
        if (l.length !== 1)
          throw new Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");
        var d = l[0];
        return ja(r, e, d), _o(e, r.responseState);
      }
    }
    function hA(r, e, t) {
    ...
    function Fa(r, e, t) {
      return ye(e, r.responseState, t.formatContext, t.id), ja(r, e, t), je(e, t.formatContext);
    }
    function pA(r, e, t) {
    ...
    function vA(r, e, t, n) {
      ...
      if (o === -1) {
        ...
        return Fa(r, e, n), IA(e, r.responseState, o);
    }
    function Ii(r, e) {
      H();
      try {
        var t = r.completedRootSegment;
        t !== null && r.pendingRootTasks === 0 && (ja(r, e, t), r.completedRootSegment = null, Za(e, r.responseState));
    ...
    function mA(r, e) {
      try {
        ...
        t.forEach(function(n) {
          return ki(n, r, e);
        }), t.clear(), r.destination !== null && Ii(r, r.destination);
      } catch (n) {
        Po(r, n), Bo(r, n);
      }
    }
    function El(r, e) {
      return new Promise(function(t, n) {
        ...
        var R = Ma(r, xr(e ? e.identifierPrefix : void 0, e ? e.nonce : void 0, e ? e.bootstrapScriptContent : void 0, e ? e.bootstrapScripts : void 0, e ? e.bootstrapModules : void 0), An(e ? e.namespaceURI : void 0), e ? e.progressiveChunkSize : void 0, e ? e.onError : void 0, l, v, D, o);
        if (e && e.signal) {
...
var Fo, Ml;
Fl.env.NODE_ENV === "production" ? (Fo = ou(), Ml = au()) : (Fo = iu(), Ml = Au());
...
Lo.renderToReadableStream = Ml.renderToReadableStream;
const Ve = {
...
}, lu = (f, s) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 32, height: 32, viewBox: "0 0 42 42", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { style: {
  fill: "none",
  strokeWidth: 2,
  strokeLinecap: "butt",
...
const du = "data:image/svg+xml;base64,", fu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 0 637 637", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m478 113-13 2-4 1h4l14-2c10-2 35-2 42-1l6 3 3 1c3 0-4-3-8-5-7-1-34-1-44 1m56 6 8 6c7 5 20 17 20 19s7 12 8 12l-3-6-4-6c0-3-15-17-25-24-5-3-8-4-4-1m-198 16-9 1a512 512 0 0 1 9-1m-180 30a412 412 0 0 0-23 4 167 167 0 0 0-32 8 439 439 0 0 1 46-9 304 304 0 0 1 11-2l6-1h-8m369 8 4 3-7-6c-1 0 0 2 3 3m-439 9c-7 3-18 13-18 15l6-5c5-5 9-8 14-10l6-4-8 4m442 12-10 11-7 6 7-6c7-5 14-14 13-16l-3 5M65 205l-1 11c0 9 0 10 4 17 5 10 7 12 22 11 10 0 15 0 38-5l5-1-6 1-16 2-21 2c-13 1-16-1-21-10-3-5-4-6-4-15l1-12c1-4 1-5-1-1m335 1c3 0 3 1 3 3l-2 6c-2 5-35 39-76 80-53 51-120 117-138 137-21 24-22 25-22 27 0 3 6 9 9 9 4 0 14-8 38-27a5073 5073 0 0 1 15-16 1421 1421 0 0 0-17 15l-31 25-6 2-4-3c-3-3-3-4-2-6 3-8 79-85 160-163 57-57 79-80 79-86 0-2-3-4-7-4-2 0-2 0 1 1m165 18c-9 17-25 32-57 53l-10 8 16-11 12-8c15-10 27-22 39-39 5-7 6-8 4-8l-4 5m-221 2a199 199 0 0 0-19 10 183 183 0 0 1 27-12c0-1-1-1-8 2m-34 16c-3 3-2 3 2 0l1-2-3 2m151 3-1 2 2-2c3-3 2-3-1 0m-16 12-11 10a281 281 0 0 0 11-10m-24 18-7 5-7 5-42 31c-10 7-24 19-22 19l7-6 16-12a343 343 0 0 0 35-25 573 573 0 0 0 20-17m-187 0-2 2 4-2 3-2-5 2m-14 6-3 2 4-1 4-3-5 2m-7 3-8 4-18 8 18-7 7-3 3-1c1-2 0-2-2-1m254 24a2672 2672 0 0 1-71 54 601 601 0 0 0 39-29 1352 1352 0 0 1 32-25m-291-8-2 2 4-2 3-2-5 2m-13 5-2 2h3c5-3 4-4-1-2m-19 9-7 3-13 6c-10 5-13 7-14 10-3 4-2 5 1 0 2-3 5-5 14-9l13-6 12-6-6 2m178 36c-17 12-21 16-21 17a390 390 0 0 1 20-17m-206 34 1 4 1 3 1 5 2 8 1 5v-6l-1-8-2-5-1-4-1-2c-1-2-1-2-1 0m222 23-9 7a683 683 0 0 0-56 44 261 261 0 0 0-26 20 1345 1345 0 0 0-46 34c-6 3-7 3-19 3-11 0-12 0-18-3-8-4-10-8-17-20l-5-10 4 10c5 10 12 18 19 22 4 2 6 2 17 2 13 0 14 0 21-3l26-19 42-33a2183 2183 0 0 0 43-34 643 643 0 0 1 24-20", fill: "#fff", fillRule: "evenodd" }), /* @__PURE__ */ B.createElement("path", { d: "M478 114a620 620 0 0 1-39 6l-21 3a5481 5481 0 0 0-19 3 870 870 0 0 1-54 8l-1 1-6 1-12 2-13 2a992 992 0 0 0-76 12 400 400 0 0 1-45 8l-6 1-5 1h-3l-3 1-2 1-26 4-13 2-17 3c-23 5-33 9-43 19-7 8-9 13-9 27 0 8 1 9 4 14 5 9 8 11 21 10l21-2a1133 1133 0 0 1 23-4 659 659 0 0 0 74-14l3-1h3l3-1h3l2-1 2-1h3l2-1h2l24-5 38-7a2100 2100 0 0 1 93-18l3-1 10-1a2082 2082 0 0 1 120-17l2 1c2 0 8 5 8 7l1 2 1 6c0 4 0 6-3 10-2 4-16 16-18 16l-7 5-10 8a1070 1070 0 0 0-11 7 113 113 0 0 1-20 14l-2 2-3 2-2 2h-1a154 154 0 0 1-28 21l-5 4-5 4a573 573 0 0 1-50 37 175 175 0 0 0-24 18l-1 2-2 1-2 1-2 1-1 1-12 10a396 396 0 0 0-32 25l-8 6-6 5-9 7a326 326 0 0 1-25 20l-13 12a5073 5073 0 0 0-17 15c-24 20-34 27-39 27-2 0-8-6-8-9 0-2 1-3 22-27 18-20 85-86 138-137 41-41 74-75 76-80l2-6c0-2 0-3-2-3l-7 1a233 233 0 0 1-26 9l-1 1-1 1h-1l-1 1h-2l-3 2-1 1h-2l-3 2h-1l-5 2-22 10-9 4-4 2-5 2-10 4-2 1-2 1-2 1-13 6a334 334 0 0 1-38 17 75 75 0 0 0-14 6l-5 2-4 1-2 1-3 2-7 3-16 6a247 247 0 0 0-32 14l-1 1h-2l-1 1h-2l-1 1-12 6a103 103 0 0 0-27 15l-2 5-1 1v11l1 5 1 5 1 4c0 3 0 4 2 4v3l1 3 1 2 2 10 1 4 1 5 2 10 2 8 1 4 1 4c3 3 9 25 11 38l1 7v2l1 4v1l1 1v2l1 2 1 3v1l5 10c7 13 9 16 17 20 6 3 7 3 18 3 12 0 13 0 19-3 8-4 11-6 26-18a1345 1345 0 0 1 85-67 683 683 0 0 1 50-39l12-9a513 513 0 0 1 44-33 201 201 0 0 0 22-17 2270 2270 0 0 0 73-54 158 158 0 0 0 58-59c2 0 3-9 4-27l-1-19-1-4-1-6-1-3-4-6-4-6c0-2-6-8-13-14a77 77 0 0 0-28-18c-6-1-34-1-43 1" })), ts = B.forwardRef(fu), hu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M765-321q0 117-84 196-83 80-200 80-118 0-200-80t-83-196v-392q0-85 61-144 61-58 146-58 86 0 147 58 61 59 61 144v374q0 54-39 92-39 37-93 37-55 0-93-37-38-38-38-92v-372h110v372q0 9 6 14t15 5q8 0 15-5t7-14v-374q0-39-29-66t-68-27q-40 0-69 27t-29 66v392q0 71 51 119t122 48q71 0 122-48t51-119v-426h111v426Z" })), ns = B.forwardRef(hu), pu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M125-165v-113h77v-273q0-93 55-167 56-75 146-100v-19q0-32 22-55 23-23 55-23t55 23q22 23 22 55v19q90 25 146 99 56 73 56 168v273h77v113H125ZM480-32q-38 0-66-27-27-27-27-66h186q0 39-27 66t-66 27Z" })), vu = B.forwardRef(pu), gu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M137-190v-113h78v-253q0-41 11-79 11-39 35-71l-9 150h10L17-802l74-74L873-92l-74 74-175-172H137Zm609-149L319-769q20-15 41-25t44-16v-28q0-32 22-54t54-22q32 0 55 22t22 54v28q85 23 137 94t52 160v217ZM481-47q-38 0-65-27t-27-65h184q0 38-27 65t-65 27Z" })), mu = B.forwardRef(gu), yu = (f, s) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", ref: s, ...f }, /* @__PURE__ */ B.createElement("g", { strokeLinecap: "round", strokeWidth: 10 }, /* @__PURE__ */ B.createElement("path", { d: "m19 19 61 61M80 19 19 80" }))), wu = B.forwardRef(yu), bu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M94-136v-255l351-93-351-92v-253l816 346L94-136Z" })), Su = B.forwardRef(bu), xu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M480-372q-61 0-105-43-43-43-43-105v-240q0-61 43-105 43-43 105-43 61 0 105 43 43 44 43 105v240q0 62-43 105t-105 43ZM425-76v-122q-121-16-197-108t-76-214h109q0 91 64 154t155 63q91 0 155-63t64-154h109q0 122-77 214T534-198v122H425Z" })), Eu = B.forwardRef(xu), Cu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m763-343-80-79q8-20 13-44 5-23 5-54h109q0 49-11 95t-36 82ZM625-482 336-770v-2q3-56 45-96t101-40q62 0 105 43t43 105v249l-1 17q-1 7-4 12ZM427-76v-122q-120-16-196-108-77-92-77-214h109q0 91 64 154t155 63q43 0 80-14 37-15 67-41l78 79q-35 32-78 53t-93 28v122H427Zm362 27L41-796l75-75 748 748-75 74Z" })), Du = B.forwardRef(Cu), Pu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M625-511q29 0 50-21t20-50q0-29-20-50-21-20-50-20t-50 20-20 50q0 29 20 50 21 21 50 21Zm-290 0q29 0 50-21t20-49q0-30-20-50t-50-21q-29 0-50 20-20 21-20 50 0 30 20 50 21 21 50 21Zm145 268q75 0 137-43t85-115H258q24 72 85 115 62 43 137 43Zm0 198q-90 0-170-34-79-34-138-93T79-310q-34-80-34-170t34-170q34-79 93-138t138-93q80-34 170-34t170 34q79 34 138 93t93 138q34 80 34 170t-34 170q-34 79-93 138T650-79q-80 34-170 34Zm0-435Zm0 322q134 0 228-94t94-228q0-134-94-228t-228-94q-134 0-228 94t-94 228q0 134 94 228t228 94Z" })), rs = B.forwardRef(Pu), Bu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M553-64v-108q107-27 173-113 67-87 67-197 0-109-67-195T553-789v-108q152 26 249 144 97 117 97 271 0 155-97 273T553-64ZM61-335v-290h176l236-237v764L237-335H61Zm492 28v-346q51 23 82 70t31 103-31 103q-31 47-82 70Z" })), ku = B.forwardRef(Bu), Tu = (f, s) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: s, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M807-15 700-123q-33 21-71 37-38 15-80 22v-108q20-4 38-12l35-17-153-154v257L234-335H57v-290h144L10-818l74-75L882-90l-75 75Zm37-264-80-79q13-30 19-60 7-31 7-64 0-109-68-195-67-86-173-112v-108q152 26 249 144 98 117 98 271 0 55-14 107-13 51-38 96ZM661-462 549-575v-78q51 23 83 70 31 47 31 103l-1 9-1 9ZM469-655 366-759l103-103v207Z" })), Iu = B.forwardRef(Tu), Ru = "data:audio/wav;base64,", us = {
        ...
        children: [
          ...
          /* @__PURE__ */ b.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ b.jsx(ts, { style: { width: "80%", height: "80%", fill: "#fff" } })
            },
            1
          ),
...
}, cs = B.createContext({ settings: {}, setSettings: () => null }), De = () => B.useContext(cs), Mu = ({
  children: f,
  settings: s = us,
  setSettings: h
}) => /* @__PURE__ */ b.jsx(cs.Provider, { value: { settings: s, setSettings: h }, children: f }), ds = {
  tooltipStyle: {},
...
}, fs = B.createContext({ styles: {}, setStyles: () => null }), Ye = () => B.useContext(fs), Qu = ({
  children: f,
  styles: s = ds,
  setStyles: h
}) => /* @__PURE__ */ b.jsx(fs.Provider, { value: { styles: s, setStyles: h }, children: f }), Ou = ({ buttons: f }) => {
  var s, h, m, A, y;
...
}, hs = B.createContext({}), ot = () => B.useContext(hs), ju = ({
  children: f,
  botIdRef: s,
  flowRef: h
}) => {
...
}, ps = B.createContext({}), ct = () => B.useContext(ps), Fu = ({
  children: f,
  settings: s
}) => {
  var h, m, A, y, P, E;
  ...
  return /* @__PURE__ */ b.jsx(ps.Provider, { value: {
    isBotTyping: w,
    setIsBotTyping: C,
    isChatWindowOpen: H,
...
}, vs = B.createContext({ paths: [], setPaths: () => null }), Ll = () => B.useContext(vs), Nu = ({ children: f }) => {
  const [s, h] = B.useState([]);
  return /* @__PURE__ */ b.jsx(vs.Provider, { value: { paths: s, setPaths: h }, children: f });
}, Ri = () => {
  const { settings: f } = De(), { paths: s, setPaths: h } = Ll(), {
    setIsBotTyping: m,
  ...
  const { getCurrPath: f, getPrevPath: s, paths: h } = gs(), { botIdRef: m } = ot();
  return { callRcbEvent: B.useCallback((A, y) => {
    const P = { botId: m.current, currPath: f(), prevPath: s() };
    return CA(A, P, y);
  }, [h]) };
}, ms = B.createContext({ toasts: [], setToasts: () => null }), ys = () => B.useContext(ms), Uu = ({ children: f }) => {
  const [s, h] = B.useState([]);
  return /* @__PURE__ */ b.jsx(ms.Provider, { value: { toasts: s, setToasts: h }, children: f });
}, La = () => {
  const { settings: f } = De(), { toasts: s, setToasts: h } = ys(), { callRcbEvent: m } = Wn(), A = B.useRef(s);
  B.useEffect(() => {
    A.current = s;
  }, [s]);
  ...
  var m, A;
  const { settings: y } = De(), { styles: P } = Ye(), { dismissToast: E } = La(), [w, C] = B.useState(!1), H = {
  ...
  }, [f, E, h]), typeof s == "string" ? /* @__PURE__ */ b.jsx(
    "div",
    {
      onMouseEnter: () => {
        C(!0);
  ...
  ) : /* @__PURE__ */ b.jsx(b.Fragment, { children: s });
}, Zn = () => {
  const { settings: f } = De(), {
    isChatWindowOpen: s,
...
}, ws = B.createContext({ messages: [], setMessages: () => null }), Hl = () => B.useContext(ws), Wu = ({ children: f }) => {
  const [s, h] = B.useState([]);
  return /* @__PURE__ */ b.jsx(ws.Provider, { value: { messages: s, setMessages: h }, children: f });
}, Zu = ({
  setChatScrollHeight: f
}) => {
  var s, h, m, A, y, P, E, w, C, H, k, F;
  const { settings: U } = De(), { styles: L } = Ye(), { messages: _ } = Hl(), { toasts: j } = ys(), { isChatWindowOpen: T } = Zn(), {
    isBotTyping: K,
    isScrolling: te,
    setIsScrolling: X,
    setUnreadCount: G
  ...
  const { settings: L } = De(), { styles: _ } = Ye(), { paths: j } = Ll(), { handleSubmitText: T } = Na(), [K, te] = B.useState(/* @__PURE__ */ new Set()), [X, G] = B.useState(!1), $ = {
  ...
  const P = /* @__PURE__ */ b.jsx(Gu, { checkboxes: y, checkedItems: /* @__PURE__ */ new Set(), path: h });
  ...
  var h, m, A, y, P, E;
  const { settings: w } = De(), { styles: C } = Ye(), { paths: H } = Ll(), { handleSubmitText: k } = Na(), [F, U] = B.useState([]), [L, _] = B.useState(!1), j = {
  ...
  const P = /* @__PURE__ */ b.jsx(Vu, { options: y, path: h });
  await m.injectMessage(P);
}, Ku = async (f, s, h) => {
  const m = f.path;
  if (!m)
  ...
  for (const P of y)
    P === "function" && await Yu(A, h);
  return y.includes("path") ? await Ku(A, h, m) : !1;
}, nc = (f) => {
  const s = [];
  let h = "", m = !1;
  ...
  return h !== "" && s.push(h), s;
}, rc = (f) => typeof window.DOMParser < "u" ? new DOMParser().parseFromString(f, "text/html").body.textContent || "" : f.replace(/<\/?[^>]+(>|$)/g, ""), oc = (f, s, h, m, A) => {
...
let xs = !1, Ql = "rcb-history", bA = 30, Es = !1, DA = [];
const SA = async (f) => {
  if (Es)
    return;
  const s = [], h = xs ? DA.length : 0;
  ...
  var s, h, m;
  Ql = (s = f.chatHistory) == null ? void 0 : s.storageKey, bA = (h = f.chatHistory) == null ? void 0 : h.maxEntries, Es = (m = f.chatHistory) == null ? void 0 : m.disabled, DA = lc(localStorage.getItem(Ql));
}, uc = (f) => B.isValidElement(f.content) ? structuredClone({
  id: f.id,
  ...
  if (xs = !0, h != null)
    try {
      m((C) => {
        const H = jo(/* @__PURE__ */ b.jsx(Ac, {}), "system");
        return C.shift(), [H, ...C];
      });
      const w = h.map((C) => {
        if (C.type === "object") {
          const H = Ps(C.content, f, s);
          return { ...C, content: H };
        }
        return C;
      });
      setTimeout(() => {
        m((C) => {
          ...
          C.shift();
          let k;
          return (H = f.chatHistory) != null && H.autoLoad ? k = jo(/* @__PURE__ */ b.jsx(b.Fragment, {}), "system") : k = jo(/* @__PURE__ */ b.jsx(ic, {}), "system"), [...w, k, ...C];
        });
      }, 500), setTimeout(() => {
        if (!A.current)
          return;
  ...
  return Array.from(m.body.childNodes).map((A, y) => {
      ...
      return A.textContent;
    {
      ...
      const C = A.classList;
      if ((P = s.botBubble) != null && P.showAvatar && (w = dc(C, w)), w = fc(C, w, s, h), w = hc(C, w, s, h), w = pc(C, w, s, h), w = vc(C, w, s, h), [
        "area",
        "base",
        "br",
        "col",
      ...
      {
        const H = Ps(A.innerHTML, s, h);
        return B.createElement(E, { key: y, ...w }, ...H);
      }
    }
  });
}, dc = (f, s) => ((f.contains("rcb-options-container") || f.contains("rcb-checkbox-container")) && (Object.prototype.hasOwnProperty.call(s, "class") ? s.class = `${f.toString()} rcb-options-offset` : s.class = "rcb-options-offset"), s), fc = (f, s, h, m) => {
  var A, y, P, E, w;
  ...
  var f, s, h, m;
  const { settings: A } = De(), { messages: y, setMessages: P } = Hl(), {
    audioToggledOn: E,
    isChatWindowOpen: w,
    isScrolling: C,
    setIsBotTyping: H,
    setUnreadCount: k
  } = ct(), { streamMessageMap: F, chatBodyRef: U } = ot(), { callRcbEvent: L } = Wn(), { playNotificationSound: _ } = Nl(), j = B.useCallback(async (Z, re, ne) => {
    H(!1), P((ve) => {
      const de = [...ve, Z];
      return $(de), de;
    ...
    let le = !1;
    re === "bot" ? le = (ue = A.botBubble) == null ? void 0 : ue.dangerouslySetInnerHtml : re === "user" && (le = (ae = A.userBubble) == null ? void 0 : ae.dangerouslySetInnerHtml), ac(A, E, w, ee, le);
    ...
    const ae = { ...jo(Z, re), id: F.current.get(re) };
    ...
    SA(Z);
    let ue = !0;
    (Z.length === 0 || w && !C) && (ue = !1), (re = A.general) != null && re.embedded && Bs(U.current) && (ue = !1);
...
const Ul = () => {
  ...
  var E;
  (E = f.voice) != null && E.sendAsAudio ? yc(h, y) : mc(
    f,
    s,
    h,
    m,
  ...
  var h, m, A;
  const y = Ul();
  (h = s.voice) != null && h.disabled || !((m = s.chatInput) != null && m.blockSpam) || !y || (f && !Jr ? (Jr = !0, (A = s.voice) != null && A.sendAsAudio ? zn == null || zn.start() : y.start()) : f || zl());
}, Bl = (f, s) => {
  var h;
  (h = s.current) != null && h.disabled || f(), zl();
}, PA = () => {
  ...
  const { settings: f } = De(), {
    ...
    (j = E.current) != null && j.disabled || setTimeout(() => {
      var T, K, te;
      (T = f.general) != null && T.embedded ? Bs(w == null ? void 0 : w.current) && ((K = E.current) == null || K.focus()) : _ !== "start" && ((te = E.current) == null || te.focus());
    }, 100);
  }, []), U = B.useCallback(() => {
  ...
  var f, s, h, m;
  const { settings: A } = De(), { endStreamMessage: y, injectMessage: P, removeMessage: E, streamMessage: w } = Ha(), { getCurrPath: C, getPrevPath: H, goToPath: k } = Ri(), {
    timeoutId: F,
    voiceToggledOn: U,
    ...
    setInputLength: te
  } = ct(), { flowRef: X, chatBodyRef: G, inputRef: $, keepVoiceOnRef: Z, paramsInputRef: re } = ot(), { showToast: ne, dismissToast: ue } = La(), { callRcbEvent: ae } = Wn(), { syncVoice: ce } = PA(), { setTextAreaValue: ve } = Ho(), { openChat: de } = Zn(), Me = B.useCallback(async (ee) => {
    var le, fe, be;
    const oe = C();
    if (!(!oe || !X.current[oe])) {
      if (_) {
    ...
    le = le.trim(), le !== "" && (fe && await Me(le), F && clearTimeout(F), re.current = le, G.current && (G.current.scrollTop = G.current.scrollHeight), $.current && (ve(""), te(0)), (be = A.chatInput) != null && be.blockSpam && j(!0), Z.current = U, ce(!1), setTimeout(() => {
      ...
      if (!await Ss(X.current, ee, Oe, k)) {
        ...
        if (!Ae)
          return;
        Ae.chatDisabled || j((me = A.chatInput) == null ? void 0 : me.disabled), bs(Ae, L, Oe), K(typeof Ae.file == "function"), ce(Z.current), T(!1);
      }
  ...
  const F = BA(), { settings: U } = De(), { styles: L } = Ye(), {
    ...
    setInputLength: X
  } = ct(), { inputRef: G } = ot(), [$, Z] = B.useState(!1), [re, ne] = B.useState(!1), { handleSubmitText: ue } = Na(), { setTextAreaValue: ae } = Ho(), ce = {
  ...
  return /* @__PURE__ */ b.jsxs("div", { "data-testid": "chatbot-footer-container", style: m.footerStyle, className: "rcb-chat-footer-container", children: [
    ...
    /* @__PURE__ */ b.jsx("span", { children: (s = h.footer) == null ? void 0 : s.text })
  ] });
}, xc = () => {
  var f, s, h, m, A, y, P;
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: !((h = y.general) != null && h.embedded) && /* @__PURE__ */ b.jsxs(
    "div",
    {
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: h ? /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
    s === "image" && h && /* @__PURE__ */ b.jsx(
      "div",
      {
        style: w,
        className: "rcb-media-display-image-container rcb-media-entry",
        "data-testid": "media-display-image-container",
        children: /* @__PURE__ */ b.jsx("img", { src: h, alt: "Image Display", className: "rcb-media-display-image" })
      }
    ),
    s === "video" && h && /* @__PURE__ */ b.jsx(
      "div",
      {
        style: w,
        ...
        children: /* @__PURE__ */ b.jsxs("video", { controls: !0, className: "rcb-media-display-video", children: [
          /* @__PURE__ */ b.jsx("source", { src: h, type: f.type }),
          "Your browser does not support the video tag."
        ] })
      }
    ),
    s === "audio" && h && /* @__PURE__ */ b.jsxs(
      "audio",
      {
  ...
  var f, s, h, m, A, y;
  const { settings: P } = De(), { styles: E } = Ye(), { injectMessage: w, streamMessage: C, removeMessage: H, endStreamMessage: k } = Ha(), { getCurrPath: F, getPrevPath: U, goToPath: L, blockAllowsAttachment: _ } = Ri(), { flowRef: j, inputRef: T } = ot(), K = j.current, { showToast: te, dismissToast: X } = La(), { callRcbEvent: G } = Wn(), { openChat: $ } = Zn(), { setTextAreaValue: Z } = Ho(), { handleSubmitText: re } = Na(), ne = {
  ...
  var f, s, h, m, A, y;
  const { settings: P } = De(), { styles: E } = Ye(), { inputRef: w } = ot(), { textAreaDisabled: C, setTextAreaValue: H } = Ho(), k = B.useRef(null), F = B.useRef(null), [U, L] = B.useState(!1), _ = {
    cursor: `url(${(f = P.general) == null ? void 0 : f.actionDisabledIcon}), auto`,
    ...E.emojiButtonStyle,
    // by default inherit the base style
  ...
  var f, s, h;
  const { settings: m } = De(), { styles: A } = Ye(), { audioToggledOn: y, toggleAudio: P } = Is(), E = {
  ...
  const { notificationsToggledOn: f, toggleNotifications: s, playNotificationSound: h } = Nl();
  return {
  ...
  var f, s, h;
  const { settings: m } = De(), { styles: A } = Ye(), { notificationsToggledOn: y, toggleNotifications: P } = Rs(), E = {
  ...
  var f, s, h;
  const { settings: m } = De(), { styles: A } = Ye(), { injectMessage: y } = Ha(), { inputRef: P } = ot(), { voiceToggledOn: E, toggleVoice: w } = PA(), { setInputLength: C, setTextAreaValue: H, textAreaDisabled: k } = Ho(), { handleSubmitText: F } = Na(), U = B.useRef([]), [L, _] = B.useState(!1);
  B.useEffect(() => {
    var G;
  ...
  const j = {
    ...
    const G = new Blob(U.current, { type: "audio/wav" }), $ = new File([G], "voice-input.wav", { type: "audio/wav" }), Z = await Ts($);
  ...
  var f, s, h, m, A, y, P, E;
  const { settings: w } = De(), { styles: C } = Ye(), { textAreaDisabled: H } = ct(), [k, F] = B.useState(!1), { handleSubmitText: U } = Na(), L = {
...
}, Rc = (f) => Object.values(Ve).includes(f), Mc = (f, s) => {
...
}, Qc = () => /* @__PURE__ */ b.jsx(Pc, {}), Oc = () => /* @__PURE__ */ b.jsx(kc, {}), jc = () => /* @__PURE__ */ b.jsx(Bc, {}), Fc = () => /* @__PURE__ */ b.jsx(Tc, {}), Lc = () => /* @__PURE__ */ b.jsx(Ic, {}), Hc = () => /* @__PURE__ */ b.jsx(Cc, {}), Nc = () => /* @__PURE__ */ b.jsx(Dc, {}), Uc = () => {
  const { settings: f } = De(), s = B.useMemo(() => ({
    [Ve.CLOSE_CHAT_BUTTON]: () => jc(),
    [Ve.AUDIO_BUTTON]: () => Qc(),
    [Ve.NOTIFICATION_BUTTON]: () => Oc(),
    [Ve.EMOJI_PICKER_BUTTON]: () => Nc(),
    [Ve.FILE_ATTACHMENT_BUTTON]: () => Hc(),
    [Ve.SEND_MESSAGE_BUTTON]: () => Lc(),
    [Ve.VOICE_MESSAGE_BUTTON]: () => Fc()
  }), []), { header: h, chatInput: m, footer: A } = B.useMemo(() => Mc(f, s), [f, s]), y = B.useMemo(() => h, [h]), P = B.useMemo(() => m, [m]), E = B.useMemo(() => A, [A]);
  return { headerButtons: y, chatInputButtons: P, footerButtons: E };
}, Wl = () => {
  const { settings: f } = De(), { styles: s } = Ye(), { setMessages: h } = Hl(), {
    ...
    var C;
    const H = Cs();
    H && ((C = f.event) != null && C.rcbLoadChatHistory && P(Ee.LOAD_CHAT_HISTORY, {}).defaultPrevented || (A(!0), cc(
      f,
      s,
      H,
      h,
  ...
  var f, s, h;
  const { settings: m } = De(), { styles: A } = Ye(), { showChatHistory: y } = Wl(), [P, E] = B.useState(!1), w = {
    color: (f = m.general) == null ? void 0 : f.primaryColor,
    borderColor: (s = m.general) == null ? void 0 : s.primaryColor,
  ...
  return /* @__PURE__ */ b.jsx("div", { className: "rcb-view-history-container", children: /* @__PURE__ */ b.jsx(
    "div",
    {
      ...
      role: "button",
      tabIndex: 0,
      children: /* @__PURE__ */ b.jsx("p", { children: (h = m.chatHistory) == null ? void 0 : h.viewChatHistoryButtonText })
    }
  ) });
}, Ms = () => {
  var f;
  ...
  const A = BA(), { settings: y } = De(), {
    ...
    messages: H,
    replaceMessages: k
  } = Ha(), { getCurrPath: F, getPrevPath: U, goToPath: L, paths: _ } = Ri(), { showToast: j, dismissToast: T } = La(), {
    isBotTyping: K,
    isChatWindowOpen: te,
    isScrolling: X,
    hasFlowStarted: G,
    ...
    setTimeoutId: ve
  } = ct(), { chatBodyRef: de, flowRef: Me, streamMessageMap: Ce, paramsInputRef: ee, keepVoiceOnRef: le } = ot(), fe = Me.current, { viewportHeight: be, setViewportHeight: oe, setViewportWidth: me, openChat: Oe } = Zn(), { setUpNotifications: Se } = Nl(), { handleFirstInteraction: Ae } = Ms(), { showChatHistory: Le } = Wl(), { updateTextAreaFocus: Zt, setTextAreaValue: Gt } = Ho(), { syncVoice: tt } = PA(), yt = B.useRef(0);
  B.useEffect(() => (window.addEventListener("click", Ae), window.addEventListener("keydown", Ae), window.addEventListener("touchstart", Ae), () => {
    ...
    else if (sc(y), localStorage.getItem((Pe = y.chatHistory) == null ? void 0 : Pe.storageKey) != null) {
      const $e = jo(/* @__PURE__ */ b.jsx(zc, {}), "system");
  ...
  const y = BA(), { settings: P } = De(), { styles: E } = Ye(), { hasFlowStarted: w, setHasFlowStarted: C } = ct(), { inputRef: H } = ot(), {
    ...
    viewportWidth: U,
    isChatWindowOpen: L
  } = Zn(), { headerButtons: _, chatInputButtons: j, footerButtons: T } = Uc();
  Wc();
  const K = B.useMemo(() => {
    var X;
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: (() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ b.jsx(Ec, {}),
        /* @__PURE__ */ b.jsx(xc, {}),
        L && !y && !((s = P.general) != null && s.embedded) && /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
        ...
        /* @__PURE__ */ b.jsxs("div", { style: te(), className: "rcb-chat-window", children: [
          ((h = P.general) == null ? void 0 : h.showHeader) && /* @__PURE__ */ b.jsx(Ou, { buttons: _ }),
          /* @__PURE__ */ b.jsx(Zu, { setChatScrollHeight: k }),
          ((m = P.general) == null ? void 0 : m.showInputRow) && /* @__PURE__ */ b.jsx(bc, { buttons: j }),
          ((A = P.general) == null ? void 0 : A.showFooter) && /* @__PURE__ */ b.jsx(Sc, { buttons: T })
        ] })
      ]
    }
  ) });
...
}, Gc = Zl.DEFAULT_URL, _c = Zl.DEFAULT_EXPIRATION, Qs = Zl.CACHE_KEY_PREFIX, Yc = (f, s, h) => {
  const m = localStorage.getItem(`${Qs}_${f}_${s}`);
  if (!m)
    return null;
  try {
  ...
  localStorage.setItem(`${Qs}_${f}_${s}`, JSON.stringify(E));
}, Vc = async (f, s) => {
  ...
  const { id: h, version: m, baseUrl: A = Gc, cacheDuration: y = _c } = s, P = m || await Vc(h, A);
  if (!P)
    return console.error(`Unable to find version for theme: ${h}`), { settings: {}, inlineStyles: {}, cssStylesText: "" };
  const E = Yc(h, P, y);
  if (E) {
    const K = as(f, E.cssStylesText);
  ...
  let j = {};
  _.ok ? j = await _.json() : console.info(`Could not fetch styles.json from ${H}`), Xc(h, P, L, j, k);
  const T = as(f, k);
  return { settings: L, inlineStyles: j, cssStylesText: T };
}, as = (f, s) => s.split(new RegExp("(?<=})")).map((h) => {
  const m = h.trim();
  return m.startsWith("@import") || m.startsWith("@keyframes") || m.startsWith("@media") ? m : m ? `#${f} ${m}` : "";
}).join(`
`), Gl = () => kA(us), Os = () => kA(ds), Jc = async (f, s, h, m) => {
  var A, y;
  let P = Gl(), E = Os(), w = "";
  if (m != null)
    if (Array.isArray(m))
      for (const C of m) {
        const H = await os(f, C);
        P = Vr(H.settings, P), E = Vr(H.inlineStyles, E), w += H.cssStylesText;
      }
    else {
      const C = await os(f, m);
  ...
  return s;
}, js = B.createContext(void 0), Fs = () => B.useContext(js), Ls = ({
  children: f
}) => {
  var s;
  ...
  return w ? /* @__PURE__ */ b.jsx("div", { style: { fontFamily: (s = A.general) == null ? void 0 : s.fontFamily }, children: /* @__PURE__ */ b.jsx(js.Provider, { value: { loadConfig: H }, children: /* @__PURE__ */ b.jsx(Mu, { settings: A, setSettings: y, children: /* @__PURE__ */ b.jsx(Qu, { styles: P, setStyles: E, children: /* @__PURE__ */ b.jsx(Uu, { children: /* @__PURE__ */ b.jsx(ju, { botIdRef: h, flowRef: m, children: /* @__PURE__ */ b.jsx(Nu, { children: /* @__PURE__ */ b.jsx(Fu, { settings: A, children: /* @__PURE__ */ b.jsx(Wu, { children: f }) }) }) }) }) }) }) }) }) : null;
}, Kc = ({
  id: f,
  flow: s,
  settings: h,
  ...
  const w = B.useMemo(() => f, []), C = Fs(), { flowRef: H } = ot();
...
}, kl = ["Quickstart", "API Docs", "Examples", "Github", "Discord"], $c = {
  start: {
  ...
  const P = B.useMemo(() => f || "rcb-" + EA(), []), E = !s || Object.keys(s).length === 0 ? $c : s, w = h || {}, C = m || {}, H = y || [], [k, F] = B.useState(!1), U = Fs(), L = B.useRef(null), [_, j] = B.useState(A || []);
  B.useEffect(() => {
    A && j(A);
  }, [A]);
  ...
  return U == null ? /* @__PURE__ */ b.jsxs(Ls, { children: [
  ...
  const { audioToggledOn: f, toggleAudio: s } = Is();
  return {
    audioToggledOn: f,
    toggleAudio: s
  };
  ...
  const { hasInteractedPage: f } = Ms();
  return {
    hasInteractedPage: f
  };
}, ad = () => {
  const { replaceMessages: f } = Ha(), { replacePaths: s } = Ri(), { replaceToasts: h } = La(), { hasFlowStarted: m } = ct(), { flowRef: A } = ot();
  return {
    hasFlowStarted: m,
    restartFlow: () => {
      f([]), h([]), s(["start"]);
  ...
  const { hasFlowStarted: f, restartFlow: s, getFlow: h } = ad();
  return {
    hasFlowStarted: f,
    restartFlow: s,
    getFlow: h
  ...
  const { settings: f, replaceSettings: s, updateSettings: h } = ld();
  return {
    settings: f,
    replaceSettings: s,
    updateSettings: h
  ...
  const { styles: f, replaceStyles: s, updateStyles: h } = ud();
  return {
    styles: f,
    replaceStyles: s,
    updateStyles: h
  ...
  const { showToast: f, dismissToast: s, toasts: h, replaceToasts: m } = La();
  return {
    showToast: f,
    dismissToast: s,
    toasts: h,
  ...
  const { showChatHistory: f } = Wl();
  return {
    showChatHistory: f,
    getHistoryMessages: Cs,
    setHistoryMessages: Ds
  };
  ...
  ChatBotProvider: Ls,
  default: qc,
  getDefaultSettings: Gl,
  getDefaultStyles: Os,
  useAudio: ed,
  useBotId: nd,
  useChatHistory: pd,
  useChatWindow: rd,
  useFirstInteraction: od,
  useFlow: id,
  useMessages: Ad,
  useNotifications: Rs,
  usePaths: gs,
  ...
  useToasts: fd,
  useVoice: hd
}, Symbol.toStringTag, { value: "Module" })), gd = B.lazy(() => Promise.resolve().then(() => vd)), Hs = Gl(), md = B.createContext({
  settings: Hs,
  setSettings: () => {
  }
});
function yd() {
  ...
  const L = async (K) => {
    const { address: te } = Ol.all();
    s(te);
    let G = await Zs.getInstance().createToken(K).getBalance(te);
    G = Gs(G), m(G);
  }, _ = async (K) => {
    ...
    transfer: {
      ...
      component: (K) => {
        if (F.action === "transfer")
          return Dl(P, f, h, F.token, F.toEmail, F.amount), /* @__PURE__ */ b.jsx("div", { className: "pl-4 pt-2", children: P && f && h && F.token && F.toEmail && F.amount && /* @__PURE__ */ b.jsx($s, { onClick: () => y(!0) }) });
      },
      // chatDisabled: true,
      path: "transfer"
    }
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: H && /* @__PURE__ */ b.jsx(B.Suspense, { fallback: null, children: /* @__PURE__ */ b.jsxs("div", { children: [
    /* @__PURE__ */ b.jsx(md.Provider, { value: { settings: w, setSettings: C }, children: /* @__PURE__ */ b.jsx(gd, { settings: w, flow: j, styles: T }) }),
    /* @__PURE__ */ b.jsx(
      Ws,
      {
        open: A,
...
function Id() {
  const { hideChatbot: f } = Sd();
  return /* @__PURE__ */ b.jsx("section", { className: "bg-background w-full flex flex-col min-h-screen", children: /* @__PURE__ */ b.jsxs(qs, { children: [
    /* @__PURE__ */ b.jsx(ru, {}),
    /* @__PURE__ */ b.jsx("div", { className: "flex-grow", children: /* @__PURE__ */ b.jsx(eu, { children: /* @__PURE__ */ b.jsx(Ys, {}) }) }),
    !f && /* @__PURE__ */ b.jsx(yd, {}),
    /* @__PURE__ */ b.jsx(Ks, {})
  ] }) });
}
