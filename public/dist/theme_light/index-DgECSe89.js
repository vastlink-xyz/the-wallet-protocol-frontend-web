import { j as p } from "./vendor-radix-J-HUYjfF.js";
import { K as Ie, q as we, y as It, ae as ve, af as W, x as oe, ag as Je, ah as Qe, F as Ye, ai as q, E as Ze, n as B, A as Nt, p as V, M as et, O as tt, aj as Ve, H as Et, G as St, J as Ot, m as Te, ak as at, al as Dt, Q as Ft, s as Rt, am as Pt, a as Le, c as z, f as rt, ac as Lt, a8 as Mt, B as Ne, L as Ut, h as Tt, an as At, ao as zt, a4 as _t, a2 as Ht, a5 as qt } from "./main-CUT_4fhD.js";
import { r as o, p as G, R as Me, a as ke } from "./vendor-react-BG344YhI.js";
import { B as be, a as Bt } from "./vendor-utils-C0Sc_Wei.js";
import { P as nt } from "./progress-tH12YMpK.js";
import { _ as ee, s as Vt, P as kt } from "./vendor-ui-utils-BXvI5fwV.js";
import { i as U, j as Xt, g as Wt, _ as Gt } from "./vendor-web3-CB7u4wt6.js";
import { i as Kt, e as Jt, o as Qt, f as Yt, h as Xe, u as Zt } from "./index-BL9fVDuo.js";
import { R as We, B as Ge, a as ea } from "./button-CZF25viL.js";
const ta = (e) => ({
  [e.componentCls]: {
...
const De = function(e, t) {
  if (e && t) {
    ...
    return a.some(function(l) {
      ...
      return /\/\*$/.test(r) ? s === r.replace(/\/.*$/, "") : i === r ? !0 : /^\w+$/.test(r) ? (It(!1, "Upload takes an invalidate 'accept' type '".concat(r, "'.Skip for check.")), !0) : !1;
    });
  }
  return !0;
};
      ...
      for (; ; ) switch (w.prev = w.next) {
        case 0:
          c = function() {
            ...
            var h = ve(/* @__PURE__ */ W().mark(function C(j, N) {
              var x, y;
...
var Ca = ["component", "prefixCls", "className", "classNames", "disabled", "id", "name", "style", "styles", "multiple", "accept", "capture", "children", "directory", "openFileDialogOnClick", "onMouseEnter", "onMouseLeave", "hasControlInside"], ja = /* @__PURE__ */ function(e) {
        ...
        return W().wrap(function(u) {
          for (; ; ) switch (u.prev = u.next) {
            ...
            case 29:
              j = C;
            case 30:
              return N = // string type is from legacy `transformFile`.
              // Not sure if this will work since no related test case works with it
              (Gt(g) === "object" || typeof g == "string") && g ? g : c, N instanceof File ? x = N : x = new File([N], c.name, {
                type: c.type
  ...
  return Ze(a, [{
    ...
    value: function(i) {
      ...
      if (this._isMounted) {
        var d = this.props, f = d.onStart, g = d.customRequest, w = d.name, h = d.headers, C = d.withCredentials, j = d.method, N = r.uid, x = g || wa, y = {
          action: m,
          filename: w,
          data: l,
          file: c,
          ...
          onSuccess: function(u, D) {
            ...
            E == null || E(u, c, D), delete s.reqs[N];
          },
          onError: function(u, D) {
            var E = s.props.onError;
            E == null || E(u, D, c), delete s.reqs[N];
          }
        };
        f(r), this.reqs[N] = x(y);
      }
    ...
    value: function() {
      ...
      return /* @__PURE__ */ Me.createElement(s, ee({}, te, {
        ...
        style: w
      }), /* @__PURE__ */ Me.createElement("input", ee({}, Nt(Q, {
        aria: !0,
        data: !0
      }), {
        id: f,
...
const Ia = (e) => {
  ...
  const {
    componentCls: t
  } = e, a = new Ie("uploadAnimateInlineIn", {
    from: {
      width: 0,
      height: 0,
      padding: 0,
  ...
  }), n = new Ie("uploadAnimateInlineOut", {
    to: {
      width: 0,
      height: 0,
      padding: 0,
  ...
  return [Fa(l), Ia(l), Sa(l), Oa(l), Na(l), Ea(l), Da(l), ta(l)];
}, Ra);
function Ce(e) {
...
const Aa = /* @__PURE__ */ o.forwardRef((e, t) => {
  ...
  const L = B(`${a}-list-item`, `${a}-list-item-${T}`), ae = typeof r.linkProps == "string" ? JSON.parse(r.linkProps) : r.linkProps, ue = (typeof C == "function" ? C(r) : C) ? f(
    ...
    onClick: (F) => u(r, F),
    title: s.previewFile
  }, typeof N == "function" ? N(r) : N || /* @__PURE__ */ o.createElement(it, null)) : null, ne = (l === "picture-card" || l === "picture-circle") && T !== "uploading" && /* @__PURE__ */ o.createElement("span", {
  ...
  const {
    getPrefixCls: L
  } = o.useContext(Te), ae = L("upload", d), ue = L(), ge = B(`${ae}-list`, `${ae}-list-${a}`), re = o.useMemo(() => Qt(Yt(ue), ["onAppearEnd", "onEnterEnd", "onLeaveEnd"]), [ue]), J = Object.assign(Object.assign({}, T ? {} : re), {
    motionDeadline: 2e3,
...
const $e = `__LIST_IGNORE_${Date.now()}__`, Ha = (e, t) => {
  const {
    ...
    rootClassName: ce
  } = e, de = o.useContext(Ft), k = g ?? de, [L, ae] = Zt(n || [], {
    value: a,
    postState: (v) => v ?? []
  ...
  const b = (v, S, P) => {
    let I = oe(S), O = !1;
    E === 1 ? I = I.slice(-1) : E && (O = I.length > E, I = I.slice(0, E)), ke.flushSync(() => {
      ae(I);
    });
    const A = {
      file: v,
    ...
    I.some((me) => me.uid === v.uid)) && ke.flushSync(() => {
      c == null || c(A);
    });
    ...
    if (!Pe(S, L))
      return;
    const I = Ce(S);
    I.status = "done", I.percent = 100, I.response = v, I.xhr = P;
    const O = je(I, L);
    b(I, O);
  }, ne = (v, S) => {
    if (!Pe(S, L))
    ...
    if (!Pe(P, L))
      return;
    const I = Ce(P);
    I.error = v, I.response = S, I.status = "error";
    const O = je(I, L);
    b(I, O);
  }, xe = (v) => {
    let S;
    Promise.resolve(typeof i == "function" ? i(v) : i).then((P) => {
      ...
      }), (I = re.current) === null || I === void 0 || I.abort(S), b(S, O));
    });
  }, Y = (v) => {
  ...
  const {
    ...
    direction: ye,
    upload: F
  } = o.useContext(Te), R = pe("upload", N), Z = Object.assign(Object.assign({
    onBatchStart: X,
    onError: ie,
    onProgress: ne,
    onSuccess: H
  ...
  const _e = `${R}-wrapper`, [Ee, He, ft] = Pa(R, _e), [gt] = ea("Upload", Pt.Upload), {
    showRemoveIcon: qe,
    showPreviewIcon: ht,
    showDownloadIcon: vt,
    removeIcon: bt,
...
function Va({
  ...
  const [a, n] = o.useState(!1), [i, s] = o.useState(0), [l, r] = o.useState(e || ""), { username: m } = Le.all(), c = {
    ...
    customRequest: async ({ file: d, onSuccess: f, onError: g, onProgress: w }) => {
      try {
        n(!0), s(0), r("");
        const C = `${m.replace(/[@.]/g, "_")}`, j = Math.round((/* @__PURE__ */ new Date()).getTime() / 1e3), N = await rt.post("/thirdparty/get-cloudinary-signature", {
          overwrite: !0,
          public_id: C,
          timestamp: j
        }), { signature: x } = N.data, y = new FormData();
...
function Xa({
  ...
  const C = () => s === "upload" ? !c : !1, j = (u) => {
    ...
    /* @__PURE__ */ p.jsx(Ne, { className: "hidden tablet:block", variant: "outline", onClick: () => x(), children: "Cancel" }),
    /* @__PURE__ */ p.jsx(
      Ne,
      {
  ...
  return /* @__PURE__ */ p.jsxs("div", { className: "pt-[36px]", children: [
    ...
    /* @__PURE__ */ p.jsxs("div", { className: "mt-[32px] border rounded-[8px] border-[#edf0f7] p-6", children: [
      ...
      /* @__PURE__ */ p.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ p.jsx(Ne, { className: "hidden tablet:inline-block h-[36px]", variant: "outline", onClick: n, children: "Change limit" })
      ] }),
      ...
      /* @__PURE__ */ p.jsx("div", { className: "text-center mt-4", children: /* @__PURE__ */ p.jsx(Ne, { className: "tablet:hidden h-[36px]", variant: "outline", onClick: n, children: "Change limit" }) })
    ] }),
    /* @__PURE__ */ p.jsx(
      zt,
      {
