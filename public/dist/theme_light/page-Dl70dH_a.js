...
import { a as c, n as z } from "./vendor-react-BdtkaT_f.js";
import { S as B, T as b, L as T, C as u, h as k, f as E, a as D } from "./main-CDK5RuLO.js";
import { S as M } from "./SendButton-B8yLGNNJ.js";
import { T as A, a as H, b as p, c as h, d as I, e as i } from "./table-BwF7M6qH.js";
import { C as w } from "./card-DyXMUwbt.js";
import { u as y, B as P } from "./vendor-utils-CISROZyj.js";
import { q as U, f as q } from "./vendor-web3-CfO0z015.js";
import { M as F, i as $, R as O } from "./vendor-ui-utils-D5jysYH4.js";
function _({
  balance: a,
  address: t,
  tokenType: d,
  ...
  return /* @__PURE__ */ e.jsxs(w, { className: "text-primary", children: [
    ...
    /* @__PURE__ */ e.jsxs(A, { className: "mb-4", children: [
      ...
      /* @__PURE__ */ e.jsx(I, { children: l ? /* @__PURE__ */ e.jsx(p, { children: /* @__PURE__ */ e.jsx(i, { colSpan: 6, className: "h-[200px]", children: /* @__PURE__ */ e.jsx("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ e.jsx(T, { type: "breathe" }) }) }) }) : d.map((s) => /* @__PURE__ */ e.jsxs(p, { children: [
        /* @__PURE__ */ e.jsx(i, { className: "font-medium", children: U(s.from, a) ? /* @__PURE__ */ e.jsx("div", { className: "border border-gray-400 rounded-full w-[32px] h-[32px] flex items-center justify-center", children: /* @__PURE__ */ e.jsx(F, { size: 14 }) }) : /* @__PURE__ */ e.jsx("div", { className: "bg-brand-foreground rounded-full w-[32px] h-[32px] flex items-center justify-center", children: /* @__PURE__ */ e.jsx($, { size: 14, color: "#fff" }) }) }),
