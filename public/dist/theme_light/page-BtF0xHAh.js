import { a2 as _, a3 as L, a4 as z, j as e, a5 as I, a6 as B, a7 as X, a8 as Y, a9 as $ } from "./vendor-radix-C4qF-rbz.js";
import { B as q, C as H } from "./index-BlqMxo_O.js";
import { c as p, k as K, B as N, i as P, h as W, l as G, a as J, T as Q } from "./main-Cnoo90sq.js";
import { a as c, c as U, h as Z, k as ee } from "./vendor-react-KTk2TwQ7.js";
import { a as te, X as se } from "./vendor-ui-utils-C5-iOwQy.js";
import { L as ae } from "./index-B8NCOjM2.js";
import { u as ne, B as C } from "./vendor-utils-D1d8vwmL.js";
import { p as R } from "./vendor-web3-CjewkP9U.js";
var S = "Checkbox", [re, je] = _(S), [ce, oe] = re(S), T = c.forwardRef(
  (t, r) => {
    const {
      ...
      form: i,
      ...l
    } = t, [m, g] = c.useState(null), v = L(r, (f) => g(f)), w = c.useRef(!1), y = m ? i || !!m.closest("form") : !0, [k = !1, E] = z({
      prop: o,
      defaultProp: n,
      onChange: h
    }), V = c.useRef(k);
    ...
    }, [m, E]), /* @__PURE__ */ e.jsxs(ce, { scope: s, state: k, disabled: d, children: [
      /* @__PURE__ */ e.jsx(
        I.button,
        {
          type: "button",
          role: "checkbox",
          "aria-checked": b(k) ? "mixed" : k,
          "aria-required": u,
          "data-state": O(k),
          ...
          onClick: B(t.onClick, (f) => {
            E((j) => b(j) ? !0 : !j), y && (w.current = f.isPropagationStopped(), w.current || f.stopPropagation());
          })
        }
      ),
      y && /* @__PURE__ */ e.jsx(
...
var A = "CheckboxIndicator", M = c.forwardRef(
  (t, r) => {
    ...
    return /* @__PURE__ */ e.jsx(X, { present: a || b(n.state) || n.state === !0, children: /* @__PURE__ */ e.jsx(
      I.span,
      {
...
var ie = (t) => {
  ...
  c.useEffect(() => {
    const i = u.current, l = window.HTMLInputElement.prototype, g = Object.getOwnPropertyDescriptor(l, "checked").set;
    if (d !== s && g) {
      const v = new Event("click", { bubbles: a });
      i.indeterminate = b(s), g.call(i, b(s) ? !1 : s), i.dispatchEvent(v);
    }
  }, [d, s, a]);
  const h = c.useRef(b(s) ? !1 : s);
...
const de = ({ isOpen: t, onClose: r, product: s, balance: a }) => {
  const [o, n] = c.useState(!1), { signTransaction: u, waitForTransactionExection: d } = K(), { t: x } = ne(), h = async () => {
    ...
    try {
      n(!0);
      const { data: { success: l, needOtp: m, message: g, transactionId: v } } = await P.post("/user/purchase", {
        productId: s.id
      });
      if (l)
