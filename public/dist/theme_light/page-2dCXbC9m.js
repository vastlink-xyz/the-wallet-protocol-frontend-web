...
import { l as se, a as n } from "./vendor-react-BNvQ9I2c.js";
import { I as t, B as x, L as B, f as w, g as v, h as R, c as le } from "./main-C7od9bzF.js";
import { C as ae } from "./card-Bv_pUVIY.js";
import { L as W } from "./label-Ds7ky41X.js";
import { B as p } from "./vendor-utils-B-eF5hYT.js";
import { K as J, c as re } from "./helper-C3A8L7vk.js";
import { u as te } from "./useFlowData-C3IuOAmk.js";
import { l as ne, E as oe, o as ce } from "./vendor-ui-utils-CsaM-dHT.js";
import { S as de, v as me } from "./frankieone-DA14zHkY.js";
import { L as ue } from "./index-D2kfGm-9.js";
const Z = {
  registered_name: "",
  ABN: "",
  ACN: "",
...
function xe() {
  const j = se(), [h, N] = n.useState(1), [y, C] = n.useState(""), [S, F] = n.useState(!1), [d, u] = n.useState(!1), [l, k] = n.useState(null), [m, f] = n.useState(Z), [i, I] = n.useState({
    sourceOfCapital: "",
    industry: "",
    websiteUrl: "",
    socialMediaUrl: "",
...
const he = re.map((j) => ({
  ...
  const j = se(), { flowId: h, flowIndex: N, serviceUrl: y, nextIndex: C } = te(), [S, F] = n.useState(!1), [d, u] = n.useState(1), [l, k] = n.useState(""), [m, f] = n.useState(!1), [i, I] = n.useState(null), [r, Y] = n.useState(ee), [b, P] = n.useState({
    sourceOfCapital: "",
    industry: "",
    websiteUrl: "",
    socialMediaUrl: "",
