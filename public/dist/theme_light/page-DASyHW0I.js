...
import { C as y } from "./index-D6t354GC.js";
import { w as C, c as n, B as b, L as B, f as g, h as E, a as S, T as P } from "./main-CmE7wmKE.js";
import { C as T } from "./checkbox-KgrdgH5g.js";
import { L as I } from "./index-DGLuelxM.js";
import { u as A } from "./useTransaction-5pA7Tj1L.js";
import { r as m, b as M, m as O } from "./vendor-react-CwfAKKXk.js";
import { u as R, B as f } from "./vendor-utils-BMKgA_3H.js";
import { X as V } from "./vendor-ui-utils-Cm_-IfYd.js";
import { p as k } from "./vendor-web3-SIldcrZc.js";
import { D as L } from "./dialog-DGP960f9.js";
import { B as v } from "./index-C4cj0dCT.js";
import { C as z } from "./index-DmpxAg3X.js";
const F = ({ isOpen: s, onClose: l, product: t, balance: a }) => {
  const r = C(), [i, d] = m.useState(!1), { signTransaction: u, waitForTransactionExection: h } = A(), { t: x } = R(), c = t.discount ? t.price * (1 - t.discount / 100) : t.price, o = async () => {
    ...
    try {
      d(!0);
      const { data: { success: p, needOtp: j, message: D, transactionId: N } } = await g.post("/user/purchase", {
        productId: t.id
      });
      if (p)
        await r.invalidateQueries({ queryKey: ["userInfo"] }), l(!0), f.success(x("/marketplace.productCard.purchaseSuccess")), d(!1);
      else if (j && (f.warning(x("/marketplace.productCard.dailyLimitExceededOtpRequired")), await h(N))) {
