...
var _ = (t, e, s) => Qn(t, typeof e != "symbol" ? e + "" : e, s), Tt = (t, e, s) => e.has(t) || ds("Cannot " + s);
...
import { p as ze, a as en, r as v, b as tn, R as K, O as Kn, u as $n, e as Vn, f as Gn } from "./vendor-react-U4DfHahV.js";
...
import { a as rt, u as Xt, C as ia, B as je, Q as oa, X as la, i as nn, b as ca, I as ua } from "./vendor-utils-CQorlrD-.js";
import { d as an, C as fs, c as St, f as Jt, h as es, E as da, m as ha, a as fa, b as ps, i as ms, p as ys } from "./vendor-web3-BqNTAT7x.js";
var Mt, yt = en;
...
const Ta = At.WEB3AUTH_WITH_MPC, Na = Ra.getService(Ta), dn = Hn, hn = Wn, Pa = v.forwardRef(({ className: t, inset: e, children: s, ...n }, o) => /* @__PURE__ */ u.jsxs(
  _s,
  {
    ref: o,
    className: N(
...
function Fa({
  ...
  const [i, r] = v.useState(""), [c, h] = v.useState(""), [y, g] = v.useState(""), [m, b] = v.useState(!1), [A, S] = v.useState(""), x = v.useRef(), [E, j] = v.useState(o), [F, B] = v.useState("0"), [R, P] = v.useState(!1), [H, D] = v.useState(!1), [X, ee] = v.useState(""), [U, W] = v.useState(""), { t: L } = Xt();
  v.useEffect(() => {
    t ? fe(o) : ke();
  }, [t]), v.useEffect(() => {
    t && (d && r(d), f && h(f), p && g(p));
  ...
  const ne = v.useMemo(() => !i || !c || m || !H || R || !!U && U !== L("/dashboard.[token].sendModal.unregisteredEmailNotice") || parseFloat(c) > parseFloat(F), [i, c, m, H, R, U, F]), fe = async (I) => {
    j(I);
    const q = xt.getInstance().createToken(I);
    x.current = q, S(x.current.symbol);
    ...
    if (ms(i))
      ...
      P(!0), W("");
      try {
        const q = await he.get("/address/", {
          params: { email: I }
        });
        q.data.success ? (D(!0), ee(q.data.address)) : xs.test(I) ? (D(!0), ee(""), W(L("/dashboard.[token].sendModal.unregisteredEmailNotice"))) : (D(!1), ee(""), W(L("/dashboard.[token].sendModal.invalidEmailFormat")));
      } catch {
      } finally {
        P(!1);
      }
  ...
  const Ne = (I) => {
    var te;
    const q = `${(te = x.current) == null ? void 0 : te.openUrl}/${I}`;
    ...
    if (!ne)
      try {
        ...
        const q = bt(I);
        ve("errorInfo", q), je.error(L("/dashboard.[token].sendModal.sendError"));
      } finally {
        b(!1);
      }
  }, ke = () => {
      ...
      /* @__PURE__ */ u.jsx("div", { className: "p-6 border-b border-[#EBEBEB]", children: /* @__PURE__ */ u.jsxs("form", { children: [
        /* @__PURE__ */ u.jsxs("div", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ u.jsxs("div", { className: "relative", children: [
            ...
            R && /* @__PURE__ */ u.jsx("div", { className: "absolute right-3 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ u.jsx(na, { className: "animate-spin", size: 16 }) }),
            H && !R && !U && /* @__PURE__ */ u.jsx(hs, { className: "absolute right-3 top-1/2 transform -translate-y-1/2 text-green-500", size: 16 }),
            U && !R && /* @__PURE__ */ u.jsx(aa, { className: N(
        ...
        /* @__PURE__ */ u.jsxs("div", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ u.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ u.jsx("div", { className: "absolute left-2 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ u.jsxs(dn, { children: [
              ...
              /* @__PURE__ */ u.jsx(as, { align: "start", className: "bg-white", children: Da.map((I) => /* @__PURE__ */ u.jsx(rs, { onClick: () => fe(I), children: I }, I)) })
            ] }) })
          ] })
        ] }),
...
((t) => {
  const e = class T {
    ...
    static encodeSegments(a, i, r = 1, c = 40, h = -1, y = !0) {
      ...
      let g, m;
      for (g = r; ; g++) {
        const x = T.getNumDataCodewords(g, i) * 8, E = f.getTotalBits(a, g);
        if (E <= x) {
          m = E;
          break;
        }
      ...
      for (const x of [T.Ecc.MEDIUM, T.Ecc.QUARTILE, T.Ecc.HIGH])
        y && m <= T.getNumDataCodewords(g, x) * 8 && (i = x);
      let b = [];
      for (const x of a) {
      ...
      o(b.length == m);
      const A = T.getNumDataCodewords(g, i) * 8;
      ...
      for (; S.length * 8 < b.length; )
        S.push(0);
      return b.forEach((x, E) => S[E >>> 3] |= x << 7 - (E & 7)), new T(g, i, S, h);
    }
    /*-- Accessor methods --*/
    ...
    drawFinderPattern(a, i) {
      for (let r = -4; r <= 4; r++)
        for (let c = -4; c <= 4; c++) {
          const h = Math.max(Math.abs(c), Math.abs(r)), y = a + c, g = i + r;
          0 <= y && y < this.size && 0 <= g && g < this.size && this.setFunctionModule(y, g, h != 2 && h != 4);
        }
    }
    ...
    addEccAndInterleave(a) {
      ...
      const c = T.NUM_ERROR_CORRECTION_BLOCKS[r.ordinal][i], h = T.ECC_CODEWORDS_PER_BLOCK[r.ordinal][i], y = Math.floor(T.getNumRawDataModules(i) / 8), g = c - y % c, m = Math.floor(y / c);
      let b = [];
      const A = T.reedSolomonComputeDivisor(h);
      for (let x = 0, E = 0; x < c; x++) {
        let j = a.slice(E, E + m - h + (x < g ? 0 : 1));
        E += j.length;
    ...
    drawCodewords(a) {
      ...
      for (let r = this.size - 1; r >= 1; r -= 2) {
        ...
        for (let c = 0; c < this.size; c++)
          for (let h = 0; h < 2; h++) {
            const y = r - h, m = (r + 1 & 2) == 0 ? this.size - 1 - c : c;
    ...
    getPenaltyScore() {
      ...
      for (let h = 0; h < this.size; h++) {
        ...
        for (let b = 0; b < this.size; b++)
          this.modules[h][b] == y ? (g++, g == 5 ? a += T.PENALTY_N1 : g > 5 && a++) : (this.finderPenaltyAddHistory(g, m), y || (a += this.finderPenaltyCountPatterns(m) * T.PENALTY_N3), y = this.modules[h][b], g = 1);
        a += this.finderPenaltyTerminateAndCount(y, g, m) * T.PENALTY_N3;
      }
      for (let h = 0; h < this.size; h++) {
        let y = !1, g = 0, m = [0, 0, 0, 0, 0, 0, 0];
        for (let b = 0; b < this.size; b++)
          this.modules[b][h] == y ? (g++, g == 5 ? a += T.PENALTY_N1 : g > 5 && a++) : (this.finderPenaltyAddHistory(g, m), y || (a += this.finderPenaltyCountPatterns(m) * T.PENALTY_N3), y = this.modules[b][h], g = 1);
        a += this.finderPenaltyTerminateAndCount(y, g, m) * T.PENALTY_N3;
      }
      for (let h = 0; h < this.size - 1; h++)
        for (let y = 0; y < this.size - 1; y++) {
          const g = this.modules[h][y];
          g == this.modules[h][y + 1] && g == this.modules[h + 1][y] && g == this.modules[h + 1][y + 1] && (a += T.PENALTY_N2);
        }
      let i = 0;
      for (const h of this.modules)
        i = h.reduce((y, g) => y + (g ? 1 : 0), i);
    ...
    static reedSolomonComputeRemainder(a, i) {
      ...
      for (const c of a) {
        const h = c ^ r.shift();
        r.push(0), i.forEach((y, g) => r[g] ^= T.reedSolomonMultiply(y, h));
      }
      return r;
    }
...
function Ha(t, e, s, n) {
  if (n == null)
    return null;
  const o = t.length + s * 2, d = Math.floor(e * _a), f = o / e, p = (n.width || d) * f, a = (n.height || d) * f, i = n.x == null ? t.length / 2 - p / 2 : n.x * f, r = n.y == null ? t.length / 2 - a / 2 : n.y * f, c = n.opacity == null ? 1 : n.opacity;
  let h = null;
  if (n.excavate) {
...
function Sn({
  ...
  const { cells: i, margin: r, numCells: c, calculatedImageSettings: h } = K.useMemo(() => {
    let y = a.getModules();
...
var qa = function() {
  ...
  function(e, s) {
    const n = e, {
      ...
      "marginSize",
      "imageSettings"
    ]), { style: b } = m, A = Ft(m, ["style"]), S = y == null ? void 0 : y.src, x = K.useRef(null), E = K.useRef(null), j = K.useCallback(
      (U) => {
    ...
    K.useEffect(() => {
      if (x.current != null) {
        ...
        const ge = d / H * ye;
        W.scale(ge, ge), W.fillStyle = p, W.fillRect(0, 0, H, H), W.fillStyle = a, qa ? W.fill(new Path2D(Cn(L, R))) : P.forEach(function(Te, Ne) {
          Te.forEach(function(Pe, Me) {
            Pe && W.fillRect(Me + R, Ne + R, 1, 1);
          });
        }), D && (W.globalAlpha = D.opacity), fe && W.drawImage(
          ne,
          D.x + R,
          D.y + R,
          D.w,
...
var Bt = K.forwardRef(
  function(e, s) {
    ...
    return /* @__PURE__ */ K.createElement(
      ...
      /* @__PURE__ */ K.createElement("path", { fill: a, d: F, shapeRendering: "crispEdges" }),
      j
    );
  }
);
...
function Pn(t) {
  ...
  const d = Ht(), f = (m) => {
    ...
    e = !1;
  }, i = () => os.isFocused() && (t.networkMode === "always" || Et.isOnline()) && t.canRun(), r = () => Tn(t.networkMode) && t.canRun(), c = (m) => {
    var b;
...
var V = tr(), De, Ds, Mn = (Ds = class {
...
}, De = new WeakMap(), Ds), Ge, Ye, ae, G, ut, Fe, ie, me, Fs, sr = (Fs = class extends Mn {
  constructor(e) {
    super();
    C(this, ie);
    C(this, Ge);
    ...
    C(this, ut);
    C(this, Fe);
    w(this, Fe, !1), w(this, ut, e.defaultOptions), this.setOptions(e.options), this.observers = [], w(this, ae, e.cache), this.queryKey = e.queryKey, this.queryHash = e.queryHash, w(this, Ge, nr(this.options)), this.state = e.state ?? l(this, Ge), this.scheduleGc();
  }
  get meta() {
  ...
  fetch(e, s) {
    ...
    o(f), (a = this.options.behavior) == null || a.onFetch(
      f,
      this
    ), w(this, Ye, this.state), (this.state.fetchStatus === "idle" || this.state.fetchMeta !== ((i = f.fetchOptions) == null ? void 0 : i.meta)) && M(this, ie, me).call(this, { type: "fetch", meta: (r = f.fetchOptions) == null ? void 0 : r.meta });
    const p = (c) => {
      var h, y, g, m;
      Nt(c) && c.silent || M(this, ie, me).call(this, {
        type: "error",
        error: c
      }), Nt(c) || ((y = (h = l(this, ae).config).onError) == null || y.call(
        h,
        c,
        this
    ...
    return w(this, G, Pn({
      ...
      onSuccess: (c) => {
        ...
        (y = (h = l(this, ae).config).onSuccess) == null || y.call(h, c, this), (m = (g = l(this, ae).config).onSettled) == null || m.call(
          g,
          c,
          this.state.error,
          this
...
}, Ge = new WeakMap(), Ye = new WeakMap(), ae = new WeakMap(), G = new WeakMap(), ut = new WeakMap(), Fe = new WeakMap(), ie = new WeakSet(), me = function(e) {
  const s = (n) => {
    switch (e.type) {
      case "failed":
        return {
...
var le, Bs, ar = (Bs = class extends pt {
  constructor(e = {}) {
    super();
    C(this, le);
...
}, le = new WeakMap(), Bs), ce, Y, Be, ue, be, Us, rr = (Us = class extends Mn {
  constructor(e) {
    super();
    C(this, ue);
    C(this, ce);
    C(this, Y);
    C(this, Be);
    this.mutationId = e.mutationId, w(this, Y, e.mutationCache), w(this, ce, []), this.state = e.state || ir(), this.setOptions(e.options), this.scheduleGc();
  }
  setOptions(e) {
  ...
  async execute(e) {
    var o, d, f, p, a, i, r, c, h, y, g, m, b, A, S, x, E, j, F, B;
    w(this, Be, Pn({
    ...
    try {
      ...
      return await ((i = (a = l(this, Y).config).onSuccess) == null ? void 0 : i.call(
        ...
        this.state.context,
        this
      )), await ((c = (r = this.options).onSuccess) == null ? void 0 : c.call(r, R, e, this.state.context)), await ((y = (h = l(this, Y).config).onSettled) == null ? void 0 : y.call(
        h,
        R,
        null,
        ...
        this.state.context,
        this
      )), await ((m = (g = this.options).onSettled) == null ? void 0 : m.call(g, R, null, e, this.state.context)), M(this, ue, be).call(this, { type: "success", data: R }), R;
    } catch (R) {
      try {
...
var se, dt, Ls, or = (Ls = class extends pt {
  constructor(e = {}) {
    super();
    C(this, se);
    C(this, dt);
...
function Rs(t) {
  return {
    onFetch: (e, s) => {
      var r, c, h, y, g;
      const n = e.options, o = (h = (c = (r = e.fetchOptions) == null ? void 0 : r.meta) == null ? void 0 : c.fetchMore) == null ? void 0 : h.direction, d = ((y = e.state.data) == null ? void 0 : y.pages) || [], f = ((g = e.state.data) == null ? void 0 : g.pageParams) || [];
      ...
      const i = async () => {
        ...
        const b = (x) => {
          ...
          const B = await A(
            F
          ), { maxPages: R } = e.options, P = j ? Za : Ya;
          return {
            pages: P(x.pages, B, R),
        ...
        if (o && d.length) {
          const x = o === "backward", E = x ? lr : Ts, j = {
            pages: d,
            pageParams: f
          }, F = E(n, j);
          p = await S(j, F, x);
          ...
          const x = t ?? d.length;
          do {
            const E = a === 0 ? f[0] ?? n.initialPageParam : Ts(n, p);
            if (a > 0 && E == null)
              break;
            p = await S(p, E), a++;
          } while (a < x);
...
var z, Ce, Ee, Ze, Xe, Se, Je, et, Qs, cr = (Qs = class {
  ...
  setQueryData(t, e, s) {
    const n = this.defaultQueryOptions({ queryKey: t }), o = l(this, z).get(
      n.queryHash
    ), d = o == null ? void 0 : o.state.data, f = Va(e, d);
    if (f !== void 0)
...
}, z = new WeakMap(), Ce = new WeakMap(), Ee = new WeakMap(), Ze = new WeakMap(), Xe = new WeakMap(), Se = new WeakMap(), Je = new WeakMap(), et = new WeakMap(), Qs), J, k, ht, Z, Ue, tt, Ae, de, ft, st, nt, Le, Qe, Re, at, O, ot, Wt, qt, Kt, $t, Vt, Gt, Yt, jn, zs, ur = (zs = class extends pt {
  constructor(e, s) {
    super();
    C(this, O);
    C(this, J);
  ...
  setOptions(e, s) {
    ...
    d && Ps(
      ...
      this.options,
      n
    ) && M(this, O, ot).call(this), this.updateResult(s), d && (l(this, k) !== o || oe(this.options.enabled, l(this, k)) !== oe(n.enabled, l(this, k)) || qe(this.options.staleTime, l(this, k)) !== qe(n.staleTime, l(this, k))) && M(this, O, Wt).call(this);
    const f = M(this, O, qt).call(this);
  ...
  createResult(e, s) {
    var R;
    const n = l(this, k), o = this.options, d = l(this, Z), f = l(this, Ue), p = l(this, tt), i = e !== n ? e.state : l(this, ht), { state: r } = e;
    let c = { ...r }, h = !1, y;
    ...
    if (s.select && c.data !== void 0)
      if (d && c.data === (f == null ? void 0 : f.data) && s.select === l(this, ft))
        ...
        try {
          w(this, ft, s.select), y = s.select(c.data), y = _t(d == null ? void 0 : d.data, y, s), w(this, st, y), w(this, de, null);
        } catch (P) {
          w(this, de, P);
        }
    else
    ...
    l(this, de) && (g = l(this, de), y = l(this, st), m = Date.now(), b = "error");
...
}, J = new WeakMap(), k = new WeakMap(), ht = new WeakMap(), Z = new WeakMap(), Ue = new WeakMap(), tt = new WeakMap(), Ae = new WeakMap(), de = new WeakMap(), ft = new WeakMap(), st = new WeakMap(), nt = new WeakMap(), Le = new WeakMap(), Qe = new WeakMap(), Re = new WeakMap(), at = new WeakMap(), O = new WeakSet(), ot = function(e) {
...
}, Ar = (t, e) => t.isLoading && t.isFetching && !e, Rr = (t, e) => (t == null ? void 0 : t.suspense) && e.isPending, Ms = (t, e, s) => e.fetchOptimistic(t).catch(() => {
  s.clearReset();
});
function Tr(t, e, s) {
  var r, c, h, y, g;
  ...
  const n = fr(), o = mr(), d = br(), f = n.defaultQueryOptions(t);
  (c = (r = n.getDefaultOptions().queries) == null ? void 0 : r._experimental_beforeQuery) == null || c.call(
    r,
    f
  ), f._optimisticResults = o ? "isRestoring" : "optimistic", Sr(f), wr(f, d), Cr(d);
  ...
  if ((y = (h = n.getDefaultOptions().queries) == null ? void 0 : h._experimental_afterQuery) == null || y.call(
    ...
    f,
    i
  ), f.experimental_prefetchInRender && !He && Ar(i, o)) {
    const m = p ? (
      // Fetch immediately on render in order to ensure `.promise` is resolved even if the component is unmounted
      Ms(f, a, d)
    ) : (
      // subscribe to the "cache promise" so that we can finalize the currentThenable once data comes in
      (g = n.getQueryCache().get(f.queryHash)) == null ? void 0 : g.promise
    );
...
function jr() {
  const t = $.getUserRandomAvatar(), { address: e } = $.all(), { data: s, refetch: n } = kr({
    enabled: !!e
  }), [o, d] = v.useState(!1), [f, p] = v.useState(!1), [a, i] = v.useState("ETH"), [r, c] = v.useState(!0);
  v.useEffect(() => {
    y(a);
  }, []);
  const h = () => {
...
const Dr = 30, Fr = async () => {
...
}, Br = Vn([
  {
    path: "/",
    async lazy() {
      const { RootLayout: t } = await import("./root-layout-DERStjom.js");
      return { Component: t };
    },
    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: t } = await import("./main-layout-x2AFcGKS.js");
          return { Component: t };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: t } = await import("./page-DtQ80En1.js");
              return { Component: t };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: t } = await import("./page-CaDKIzaz.js");
              return { Component: t };
            }
          },
          {
            ...
            async lazy() {
              const { default: t } = await import("./page-BQA00g18.js");
              return { Component: t };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: t } = await import("./page-Dc4rU268.js");
              return { Component: t };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-BTPn7J_-.js");
                  return { Component: t };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: t } = await import("./page-MUWdXfrt.js");
                  return { Component: t };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: t } = await import("./page-BAmtG-hm.js");
                  return { Component: t };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-DoYUHPJr.js");
                  return { Component: t };
                },
                loader: Fr
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: t } = await import("./page-CAF0KCnx.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-yKs_SV4q.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-BpKIu0oK.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: t } = await import("./page-By8FszuY.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: t } = await import("./page-DQ_tai--.js");
                  return { Component: t };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: t } = await import("./page-CUT-mE77.js");
                  return { Component: t };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: t } = await import("./page-kHVjVVnc.js");
                          return { Component: t };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: t } = await import("./page-B8qX7T2j.js");
                          return { Component: t };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: t } = await import("./page-BYY6YCY-.js");
                  return { Component: t };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: t } = await import("./page-DDOwgAIf.js");
                  return { Component: t };
                }
              }
            ]
  ...
  const [e, s] = v.useState(!1), [n, o] = v.useState(!1), [d, f] = v.useState({ name: "", url: "" }), [p, a] = v.useState(!1), [i, r] = v.useState(), c = v.useRef(), h = (y) => {
    r(y), c.current = y;
  };
...
var Pt = () => {
  ...
  const n = v.useRef(null), { init: o, debug: d } = v.useContext(Rt), f = v.useRef(new $r().if(d || !1)), p = v.useCallback(async () => {
    var a, i;
    if (n.current) {
