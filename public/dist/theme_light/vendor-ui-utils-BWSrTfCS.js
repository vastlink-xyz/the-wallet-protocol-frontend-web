import { r as o, $ as Vt, a as ft, b as Bt } from "./vendor-react-BA5A8Axg.js";
import { c as Wt, _ as Gt, u as Kt, a as le, f as qt, z as Ht, s as Xt, b as Yt, R as Zt, e as Jt, h as Qt } from "./vendor-radix-CPmBDWYo.js";
function pt(e) {
  var r, t, n = "";
...
const Ge = "-", er = (e) => {
  ...
  const {
    ...
    const b = d.length === 0 ? l : l.substring(u), h = b.startsWith(vt), x = h ? b.substring(1) : b, f = m && m > u ? m - u : void 0;
    return {
      modifiers: d,
  ...
  for (let d = c.length - 1; d >= 0; d -= 1) {
    ...
    let x = !!h, f = n(x ? b.substring(0, h) : b);
    if (!f) {
      if (!x) {
        l = i + (l.length > 0 ? " " + l : l);
        continue;
    ...
    const v = lr(u).join(":"), y = m ? v + vt : v, C = y + f;
    if (s.includes(C))
      continue;
    s.push(C);
    const k = a(f, x);
...
const T = (e) => {
...
}, bt = /^\[(?:([a-z-]+):)?(.+)\]$/i, pr = /^\d+\/\d+$/, mr = /* @__PURE__ */ new Set(["px", "full", "screen"]), vr = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, hr = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, br = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, gr = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, yr = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, W = (e) => ie(e) || mr.has(e) || pr.test(e), H = (e) => de(e, "length", Rr), ie = (e) => !!e && !Number.isNaN(Number(e)), Me = (e) => de(e, "number", ie), me = (e) => !!e && Number.isInteger(Number(e)), wr = (e) => e.endsWith("%") && ie(e.slice(0, -1)), $ = (e) => bt.test(e), X = (e) => vr.test(e), $r = /* @__PURE__ */ new Set(["length", "size", "percentage"]), xr = (e) => de(e, $r, gt), Cr = (e) => de(e, "position", gt), Er = /* @__PURE__ */ new Set(["image", "url"]), kr = (e) => de(e, Er, Pr), Sr = (e) => de(e, "", Mr), ve = () => !0, de = (e, r, t) => {
  const n = bt.exec(e);
  ...
  hr.test(e) && !br.test(e)
), gt = () => !1, Mr = (e) => gr.test(e), Pr = (e) => yr.test(e), Ar = () => {
  const e = T("colors"), r = T("spacing"), t = T("blur"), n = T("brightness"), a = T("borderColor"), s = T("borderRadius"), c = T("borderSpacing"), l = T("borderWidth"), d = T("contrast"), i = T("grayscale"), u = T("hueRotate"), m = T("invert"), b = T("gap"), h = T("gradientColorStops"), x = T("gradientColorStopPositions"), f = T("inset"), v = T("margin"), y = T("opacity"), C = T("padding"), k = T("saturate"), E = T("scale"), S = T("sepia"), A = T("skew"), N = T("space"), M = T("translate"), _ = () => ["auto", "contain", "none"], V = () => ["auto", "hidden", "clip", "visible", "scroll"], U = () => ["auto", $, r], O = () => [$, r], fe = () => ["", W, H], B = () => ["auto", ie, $], G = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], K = () => ["solid", "dashed", "dotted", "double", "none"], ne = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], oe = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], q = () => ["", "0", $], pe = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], F = () => [ie, $];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
      ...
      gradientColorStopPositions: [wr, H],
      inset: U(),
      margin: U(),
      opacity: F(),
      padding: O(),
...
const P = (e, r) => {
  const t = o.forwardRef(
    ({ className: n, ...a }, s) => o.createElement(Nr, {
      ref: s,
      iconNode: r,
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const bo = P("ChevronUp", [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]]);
/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function wt(e) {
  var r, t, n = "";
  if (typeof e == "string" || typeof e == "number") n += e;
  else if (typeof e == "object") if (Array.isArray(e)) for (r = 0; r < e.length; r++) e[r] && (t = wt(e[r])) && (n && (n += " "), n += t);
  else for (r in e) e[r] && (n && (n += " "), n += r);
  return n;
}
function Tr() {
  for (var e, r, t = 0, n = ""; t < arguments.length; ) (e = arguments[t++]) && (r = wt(e)) && (n && (n += " "), n += r);
  return n;
}
const Ze = (e) => typeof e == "boolean" ? "".concat(e) : e === 0 ? "0" : e, Je = Tr, Uo = (e, r) => (t) => {
  var n;
...
var Qe = 1, Dr = 0.9, Lr = 0.8, _r = 0.17, Pe = 0.1, Ae = 0.999, Fr = 0.9999, zr = 0.99, jr = /[\\\/_+.#"@\[\(\{&]/, Ur = /[\\\/_+.#"@\[\(\{&]/g, Vr = /[\s-]/, $t = /[\s-]/g;
function Fe(e, r, t, n, a, s, c) {
  if (s === r.length) return a === e.length ? Qe : zr;
  var l = `${a},${s}`;
  if (c[l] !== void 0) return c[l];
  for (var d = n.charAt(s), i = t.indexOf(d, a), u = 0, m, b, h, x; i >= 0; ) m = Fe(e, r, t, n, i + 1, s + 1, c), m > u && (i === a ? m *= Qe : jr.test(e.charAt(i - 1)) ? (m *= Lr, h = e.slice(a, i - 1).match(Ur), h && a > 0 && (m *= Math.pow(Ae, h.length))) : Vr.test(e.charAt(i - 1)) ? (m *= Dr, x = e.slice(a, i - 1).match($t), x && a > 0 && (m *= Math.pow(Ae, x.length))) : (m *= _r, a > 0 && (m *= Math.pow(Ae, i - a))), e.charAt(i) !== r.charAt(s) && (m *= Fr)), (m < Pe && t.charAt(i - 1) === n.charAt(s + 1) || n.charAt(s + 1) === n.charAt(s) && t.charAt(i - 1) !== n.charAt(s)) && (b = Fe(e, r, t, n, i + 1, s + 2, c), b * Pe > m && (m = b * Pe)), m > u && (u = m), i = t.indexOf(d, i + 1);
  return c[l] = u, u;
}
function et(e) {
...
function Gr(e, r = []) {
  ...
  function n(s, c) {
    ...
    function i(m) {
      const { scope: b, children: h, ...x } = m, f = (b == null ? void 0 : b[e][d]) || l, v = o.useMemo(
        () => x,
        Object.values(x)
      );
    ...
    function u(m, b) {
      const h = (b == null ? void 0 : b[e][d]) || l, x = o.useContext(h);
      if (x) return x;
...
const an = /* @__PURE__ */ o.createContext({
  ...
  var t;
  const { disableOutsidePointerEvents: n = !1, onEscapeKeyDown: a, onPointerDownOutside: s, onFocusOutside: c, onInteractOutside: l, onDismiss: d, ...i } = e, u = o.useContext(an), [m, b] = o.useState(null), h = (t = m == null ? void 0 : m.ownerDocument) !== null && t !== void 0 ? t : globalThis == null ? void 0 : globalThis.document, [, x] = o.useState({}), f = ye(
    r,
    (M) => b(M)
  ), v = Array.from(u.layers), [y] = [
    ...u.layersWithOutsidePointerEventsDisabled
  ].slice(-1), C = v.indexOf(y), k = m ? v.indexOf(m) : -1, E = u.layersWithOutsidePointerEventsDisabled.size > 0, S = k >= C, A = ln((M) => {
    const _ = M.target, V = [
      ...u.branches
    ].some(
      (U) => U.contains(_)
    );
    !S || V || (s == null || s(M), l == null || l(M), M.defaultPrevented || d == null || d());
  }, h), N = cn((M) => {
    const _ = M.target;
    [
      ...u.branches
      ...
      (U) => U.contains(_)
    ) || (c == null || c(M), l == null || l(M), M.defaultPrevented || d == null || d());
  }, h);
  return rn((M) => {
    k === u.layers.size - 1 && (a == null || a(M), !M.defaultPrevented && d && (M.preventDefault(), d()));
  }, h), o.useEffect(() => {
    if (m)
      return n && (u.layersWithOutsidePointerEventsDisabled.size === 0 && (tt = h.body.style.pointerEvents, h.body.style.pointerEvents = "none"), u.layersWithOutsidePointerEventsDisabled.add(m)), u.layers.add(m), rt(), () => {
        n && u.layersWithOutsidePointerEventsDisabled.size === 1 && (h.body.style.pointerEvents = tt);
      };
  }, [
    m,
    h,
    ...
    const M = () => x({});
    return document.addEventListener(Ue, M), () => document.removeEventListener(Ue, M);
    ...
    onPointerDownCapture: ue(e.onPointerDownCapture, A.onPointerDownCapture)
  }));
});
...
const Ie = "focusScope.autoFocusOnMount", Ne = "focusScope.autoFocusOnUnmount", nt = {
  bubbles: !1,
  cancelable: !0
}, un = /* @__PURE__ */ o.forwardRef((e, r) => {
  const { loop: t = !1, trapped: n = !1, onMountAutoFocus: a, onUnmountAutoFocus: s, ...c } = e, [l, d] = o.useState(null), i = Q(a), u = Q(s), m = o.useRef(null), b = ye(
    r,
    (f) => d(f)
  ), h = o.useRef({
    paused: !1,
  ...
  o.useEffect(() => {
    if (n) {
      let f = function(k) {
        ...
        const E = k.target;
        l.contains(E) ? m.current = E : Y(m.current, {
          select: !0
        });
      }, v = function(k) {
        if (h.paused || !l) return;
        const E = k.relatedTarget;
        E !== null && (l.contains(E) || Y(m.current, {
          select: !0
        }));
      }, y = function(k) {
    ...
    if (l) {
      ...
      if (!l.contains(f)) {
        ...
        l.addEventListener(Ie, i), l.dispatchEvent(y), y.defaultPrevented || (dn(hn(Et(l)), {
          select: !0
        }), document.activeElement === f && Y(l));
      }
      return () => {
        l.removeEventListener(Ie, i), setTimeout(() => {
          const y = new CustomEvent(Ne, nt);
          l.addEventListener(Ne, u), l.dispatchEvent(y), y.defaultPrevented || Y(f ?? document.body, {
            select: !0
          }), l.removeEventListener(Ne, u), at.remove(h);
        }, 0);
      };
    }
  }, [
  ...
  const x = o.useCallback((f) => {
    if (!t && !n || h.paused) return;
    const v = f.key === "Tab" && !f.altKey && !f.ctrlKey && !f.metaKey, y = document.activeElement;
    if (v && y) {
      const C = f.currentTarget, [k, E] = fn(C);
      k && E ? !f.shiftKey && y === E ? (f.preventDefault(), t && Y(k, {
        select: !0
      })) : f.shiftKey && y === k && (f.preventDefault(), t && Y(E, {
        select: !0
      })) : y === C && f.preventDefault();
    }
  }, [
    t,
    n,
...
function fn(e) {
  const r = Et(e), t = ot(r, e), n = ot(r.reverse(), e);
  return [
    t,
    n
  ];
...
const bn = /* @__PURE__ */ o.forwardRef((e, r) => {
  var t;
...
function yn(e) {
  ...
  return o.useEffect(() => {
    ...
    if (u !== e) {
      const b = s.current, h = xe(i);
      e ? d("MOUNT") : h === "none" || (i == null ? void 0 : i.display) === "none" ? d("UNMOUNT") : d(u && b !== h ? "ANIMATION_OUT" : "UNMOUNT"), a.current = e;
    }
  }, [
    e,
    d
    ...
    if (r) {
      const i = (m) => {
        const h = xe(n.current).includes(m.animationName);
        m.target === r && h && ft.flushSync(
          () => d("ANIMATION_END")
        );
      }, u = (m) => {
...
var kt = Wt(), De = function() {
  ...
  }), a = n[0], s = n[1], c = e.forwardProps, l = e.children, d = e.className, i = e.removeScrollBar, u = e.enabled, m = e.shards, b = e.sideCar, h = e.noIsolation, x = e.inert, f = e.allowPinchZoom, v = e.as, y = v === void 0 ? "div" : v, C = Gt(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as"]), k = b, E = Kt([t, r]), S = le(le({}, C), a);
  return o.createElement(
    o.Fragment,
    null,
    u && o.createElement(k, { sideCar: kt, removeScrollBar: i, shards: m, noIsolation: h, inert: x, setCallbacks: s, allowPinchZoom: !!f, lockRef: t }),
    c ? o.cloneElement(o.Children.only(l), le(le({}, S), { ref: E })) : o.createElement(y, le({}, S, { className: d, ref: E }), l)
  );
});
Se.defaultProps = {
  enabled: !0,
...
var ae = Ve ? { passive: !1 } : !1, $n = function(e) {
  ...
  return e === "v" ? xn(r) : Cn(r);
}, Mt = function(e, r) {
  return e === "v" ? En(r) : kn(r);
}, Sn = function(e, r) {
  return e === "h" && r === "rtl" ? -1 : 1;
}, Rn = function(e, r, t, n, a) {
  var s = Sn(e, window.getComputedStyle(r).direction), c = s * n, l = t.target, d = r.contains(l), i = !1, u = c > 0, m = 0, b = 0;
  do {
    var h = Mt(e, l), x = h[0], f = h[1], v = h[2], y = f - v - s * x;
    (x || y) && Rt(e, l) && (m += y, b += x), l = l.parentNode;
  } while (
    // portaled content
    !d && l !== document.body || // self content
    d && (r.contains(l) || r === l)
  );
  return (u && (m === 0 || !a) || !u && (b === 0 || !a)) && (i = !0), i;
}, Ee = function(e) {
...
function On(e) {
  ...
  var l = o.useCallback(function(f, v) {
    ...
    var y = Ee(f), C = t.current, k = "deltaX" in f ? f.deltaX : C[0] - y[0], E = "deltaY" in f ? f.deltaY : C[1] - y[1], S, A = f.target, N = Math.abs(k) > Math.abs(E) ? "h" : "v";
    if ("touches" in f && N === "h" && A.type === "range")
      return !1;
    var M = ct(N, A);
    if (!M)
      return !0;
    if (M ? S = N : (S = N === "v" ? "h" : "v", M = ct(N, A)), !M)
      return !1;
    if (!n.current && "changedTouches" in f && (k || E) && (n.current = S), !S)
      return !0;
    var _ = n.current || S;
    return Rn(_, v, f, _ === "h" ? k : E, !0);
  }, []), d = o.useCallback(function(f) {
    var v = f;
    if (!(!se.length || se[se.length - 1] !== s)) {
      var y = "deltaY" in v ? it(v) : Ee(v), C = r.current.filter(function(S) {
        return S.name === v.type && S.target === v.target && Mn(S.delta, y);
      })[0];
      if (C && C.should) {
      ...
      if (!C) {
        ...
        }), E = k.length > 0 ? l(v, k[0]) : !c.current.noIsolation;
        E && v.cancelable && v.preventDefault();
      }
    }
  }, []), i = o.useCallback(function(f, v, y, C) {
    var k = { name: f, delta: v, target: y, should: C };
    ...
    t.current = Ee(f), n.current = void 0;
  }, []), m = o.useCallback(function(f) {
    i(f.type, it(f), f.target, l(f, e.lockRef.current));
  }, []), b = o.useCallback(function(f) {
    i(f.type, Ee(f), f.target, l(f, e.lockRef.current));
  }, []);
  o.useEffect(function() {
  ...
  return o.createElement(
    o.Fragment,
    null,
    x ? o.createElement(s, { styles: Pn(a) }) : null,
    h ? o.createElement(Zt, { gapMode: "margin" }) : null
  );
}
const In = Jt(kt, On);
var Pt = o.forwardRef(function(e, r) {
  return o.createElement(Se, le({}, e, { ref: r, sideCar: In }));
});
Pt.classNames = Se.classNames;
const At = "Dialog", [Ot, Vo] = Gr(At), [Nn, re] = Ot(At), Tn = (e) => {
  ...
  return /* @__PURE__ */ o.createElement(Nn, {
    scope: r,
    triggerRef: l,
    contentRef: d,
    contentId: Oe(),
...
}, It = "DialogPortal", [Dn, Nt] = Ot(It, {
  forceMount: void 0
}), Ln = (e) => {
  const { __scopeDialog: r, forceMount: t, children: n, container: a } = e, s = re(It, r);
  return /* @__PURE__ */ o.createElement(Dn, {
    ...
    (c) => /* @__PURE__ */ o.createElement(ke, {
      present: t || s.open
    }, /* @__PURE__ */ o.createElement(bn, {
      asChild: !0,
      container: a
    }, c))
  ));
}, Be = "DialogOverlay", _n = /* @__PURE__ */ o.forwardRef((e, r) => {
  const t = Nt(Be, e.__scopeDialog), { forceMount: n = t.forceMount, ...a } = e, s = re(Be, e.__scopeDialog);
...
}), be = "DialogContent", zn = /* @__PURE__ */ o.forwardRef((e, r) => {
  const t = Nt(be, e.__scopeDialog), { forceMount: n = t.forceMount, ...a } = e, s = re(be, e.__scopeDialog);
  ...
  const t = re(be, e.__scopeDialog), n = o.useRef(null), a = ye(r, t.contentRef, n);
  return o.useEffect(() => {
    const s = n.current;
    if (s) return Qt(s);
  ...
  const t = re(be, e.__scopeDialog), n = o.useRef(!1), a = o.useRef(!1);
  ...
  const { __scopeDialog: t, trapFocus: n, onOpenAutoFocus: a, onCloseAutoFocus: s, ...c } = e, l = re(be, t), d = o.useRef(null), i = ye(r, d);
  return wn(), /* @__PURE__ */ o.createElement(o.Fragment, null, /* @__PURE__ */ o.createElement(un, {
    asChild: !0,
    loop: !0,
    trapped: n,
    onMountAutoFocus: a,
...
var he = '[cmdk-group=""]', Le = '[cmdk-group-items=""]', Kn = '[cmdk-group-heading=""]', qe = '[cmdk-item=""]', dt = `${qe}:not([aria-disabled="true"])`, We = "cmdk-item-select", J = "data-value", qn = (e, r, t) => Br(e, r, t), Lt = o.createContext(void 0), we = () => o.useContext(Lt), _t = o.createContext(void 0), He = () => o.useContext(_t), Ft = o.createContext(void 0), zt = o.forwardRef((e, r) => {
  let t = ce(() => {
    var p, w;
    return { search: "", value: (w = (p = e.value) != null ? p : e.defaultValue) != null ? w : "", filtered: { count: 0, items: /* @__PURE__ */ new Map(), groups: /* @__PURE__ */ new Set() } };
  }), n = ce(() => /* @__PURE__ */ new Set()), a = ce(() => /* @__PURE__ */ new Map()), s = ce(() => /* @__PURE__ */ new Map()), c = ce(() => /* @__PURE__ */ new Set()), l = jt(e), { label: d, children: i, value: u, onValueChange: m, filter: b, shouldFilter: h, loop: x, disablePointerSelection: f = !1, vimBindings: v = !0, ...y } = e, C = o.useId(), k = o.useId(), E = o.useId(), S = o.useRef(null), A = oo();
  ee(() => {
    if (u !== void 0) {
      let p = u.trim();
  ...
  let N = o.useMemo(() => ({ subscribe: (p) => (c.current.add(p), () => c.current.delete(p)), snapshot: () => t.current, setState: (p, w, R) => {
    var g, I, D;
    if (!Object.is(t.current[p], w)) {
      if (t.current[p] = w, p === "search") O(), V(), A(1, U);
      else if (p === "value" && (R || A(5, fe), ((g = l.current) == null ? void 0 : g.value) !== void 0)) {
        let z = w ?? "";
        (D = (I = l.current).onValueChange) == null || D.call(I, z);
        return;
      }
      N.emit();
    }
  ...
  } }), []), M = o.useMemo(() => ({ value: (p, w, R) => {
    var g;
    w !== ((g = s.current.get(p)) == null ? void 0 : g.value) && (s.current.set(p, { value: w, keywords: R }), t.current.filtered.items.set(p, _(w, R)), A(2, () => {
      V(), N.emit();
    }));
  }, item: (p, w) => (n.current.add(p), w && (a.current.has(w) ? a.current.get(w).add(p) : a.current.set(w, /* @__PURE__ */ new Set([p]))), A(3, () => {
    O(), V(), t.current.value || U(), N.emit();
  }), () => {
    s.current.delete(p), n.current.delete(p), t.current.filtered.items.delete(p);
    let R = B();
    A(4, () => {
      O(), (R == null ? void 0 : R.getAttribute("id")) === p && U(), N.emit();
    });
  }), group: (p) => (a.current.has(p) || a.current.set(p, /* @__PURE__ */ new Set()), () => {
    s.current.delete(p), a.current.delete(p);
  }), filter: () => l.current.shouldFilter, label: d || e["aria-label"], disablePointerSelection: f, listId: C, inputId: E, labelId: k, listInnerRef: S }), []);
  function _(p, w) {
    var R, g;
    let I = (g = (R = l.current) == null ? void 0 : R.filter) != null ? g : qn;
    return p ? I(p, t.current.search, w) : 0;
  }
  function V() {
    if (!t.current.search || l.current.shouldFilter === !1) return;
    let p = t.current.filtered.items, w = [];
    t.current.filtered.groups.forEach((g) => {
      let I = a.current.get(g), D = 0;
      I.forEach((z) => {
        let Z = p.get(z);
        D = Math.max(Z, D);
      }), w.push([g, D]);
    ...
    G().sort((g, I) => {
      var D, z;
      let Z = g.getAttribute("id"), $e = I.getAttribute("id");
      return ((D = p.get($e)) != null ? D : 0) - ((z = p.get(Z)) != null ? z : 0);
    }).forEach((g) => {
      let I = g.closest(Le);
      I ? I.appendChild(g.parentElement === I ? g : g.closest(`${Le} > *`)) : R.appendChild(g.parentElement === R ? g : g.closest(`${Le} > *`));
    }), w.sort((g, I) => I[1] - g[1]).forEach((g) => {
      let I = S.current.querySelector(`${he}[${J}="${encodeURIComponent(g[0])}"]`);
      I == null || I.parentElement.appendChild(I);
    });
  }
  function U() {
    let p = G().find((R) => R.getAttribute("aria-disabled") !== "true"), w = p == null ? void 0 : p.getAttribute(J);
  ...
  function O() {
    ...
    for (let D of n.current) {
      let z = (w = (p = s.current.get(D)) == null ? void 0 : p.value) != null ? w : "", Z = (g = (R = s.current.get(D)) == null ? void 0 : R.keywords) != null ? g : [], $e = _(z, Z);
      t.current.filtered.items.set(D, $e), $e > 0 && I++;
    }
  ...
  function fe() {
    var p, w, R;
    let g = B();
    g && (((p = g.parentElement) == null ? void 0 : p.firstChild) === g && ((R = (w = g.closest(he)) == null ? void 0 : w.querySelector(Kn)) == null || R.scrollIntoView({ block: "nearest" })), g.scrollIntoView({ block: "nearest" }));
  }
  function B() {
    var p;
    return (p = S.current) == null ? void 0 : p.querySelector(`${qe}[aria-selected="true"]`);
  }
  function G() {
    var p;
  ...
  function K(p) {
    let w = G()[p];
    w && N.setState("value", w.getAttribute(J));
  }
  function ne(p) {
    var w;
    let R = B(), g = G(), I = g.findIndex((z) => z === R), D = g[I + p];
    (w = l.current) != null && w.loop && (D = I + p < 0 ? g[g.length - 1] : I + p === g.length ? g[0] : g[I + p]), D && N.setState("value", D.getAttribute(J));
  }
  function oe(p) {
    let w = B(), R = w == null ? void 0 : w.closest(he), g;
    for (; R && !g; ) R = p > 0 ? ro(R, he) : no(R, he), g = R == null ? void 0 : R.querySelector(dt);
    g ? N.setState("value", g.getAttribute(J)) : ne(p);
  }
  let q = () => K(G().length - 1), pe = (p) => {
    p.preventDefault(), p.metaKey ? q() : p.altKey ? oe(1) : ne(1);
  }, F = (p) => {
    p.preventDefault(), p.metaKey ? K(0) : p.altKey ? oe(-1) : ne(-1);
  };
  return o.createElement(j.div, { ref: r, tabIndex: -1, ...y, "cmdk-root": "", onKeyDown: (p) => {
    var w;
    if ((w = y.onKeyDown) == null || w.call(y, p), !p.defaultPrevented) switch (p.key) {
      case "n":
      case "j": {
        v && p.ctrlKey && pe(p);
        break;
  ...
  } }, o.createElement("label", { "cmdk-label": "", htmlFor: M.inputId, id: M.labelId, style: so }, d), Re(e, (p) => o.createElement(_t.Provider, { value: N }, o.createElement(Lt.Provider, { value: M }, p))));
}), Hn = o.forwardRef((e, r) => {
  var t, n;
  let a = o.useId(), s = o.useRef(null), c = o.useContext(Ft), l = we(), d = jt(e), i = (n = (t = d.current) == null ? void 0 : t.forceMount) != null ? n : c == null ? void 0 : c.forceMount;
  ee(() => {
    if (!i) return l.item(a, c == null ? void 0 : c.id);
  }, [i]);
  let u = Ut(a, s, [e.value, e.children, s], e.keywords), m = He(), b = te((A) => A.value && A.value === u.current), h = te((A) => i || l.filter() === !1 ? !0 : A.search ? A.filtered.items.get(a) > 0 : !0);
  o.useEffect(() => {
    let A = s.current;
    if (!(!A || e.disabled)) return A.addEventListener(We, x), () => A.removeEventListener(We, x);
  }, [h, e.onSelect, e.disabled]);
  function x() {
    var A, N;
    f(), (N = (A = d.current).onSelect) == null || N.call(A, u.current);
  }
  function f() {
    m.setState("value", u.current, !0);
  }
  if (!h) return null;
  let { disabled: v, value: y, onSelect: C, forceMount: k, keywords: E, ...S } = e;
  return o.createElement(j.div, { ref: ge([s, r]), ...S, id: a, "cmdk-item": "", role: "option", "aria-disabled": !!v, "aria-selected": !!b, "data-disabled": !!v, "data-selected": !!b, onPointerMove: v || l.disablePointerSelection ? void 0 : f, onClick: v ? void 0 : x }, e.children);
}), Xn = o.forwardRef((e, r) => {
  let { heading: t, children: n, forceMount: a, ...s } = e, c = o.useId(), l = o.useRef(null), d = o.useRef(null), i = o.useId(), u = we(), m = te((h) => a || u.filter() === !1 ? !0 : h.search ? h.filtered.groups.has(c) : !0);
  ee(() => u.group(c), []), Ut(c, l, [e.value, e.heading, d]);
  let b = o.useMemo(() => ({ id: c, forceMount: a }), [a]);
  return o.createElement(j.div, { ref: ge([l, r]), ...s, "cmdk-group": "", role: "presentation", hidden: m ? void 0 : !0 }, t && o.createElement("div", { ref: d, "cmdk-group-heading": "", "aria-hidden": !0, id: i }, t), Re(e, (h) => o.createElement("div", { "cmdk-group-items": "", role: "group", "aria-labelledby": t ? i : void 0 }, o.createElement(Ft.Provider, { value: b }, h))));
}), Yn = o.forwardRef((e, r) => {
  ...
  let { onValueChange: t, ...n } = e, a = e.value != null, s = He(), c = te((u) => u.search), l = te((u) => u.value), d = we(), i = o.useMemo(() => {
    var u;
    let m = (u = d.listInnerRef.current) == null ? void 0 : u.querySelector(`${qe}[${J}="${encodeURIComponent(l)}"]`);
  ...
  let { children: t, label: n = "Suggestions", ...a } = e, s = o.useRef(null), c = o.useRef(null), l = we();
  return o.useEffect(() => {
    if (c.current && s.current) {
      let d = c.current, i = s.current, u, m = new ResizeObserver(() => {
        u = requestAnimationFrame(() => {
          let b = d.offsetHeight;
          i.style.setProperty("--cmdk-list-height", b.toFixed(1) + "px");
        });
      });
      return m.observe(d), () => {
...
}), Bo = Object.assign(zt, { List: Jn, Item: Hn, Input: Zn, Group: Xn, Separator: Yn, Dialog: Qn, Empty: eo, Loading: to });
function ro(e, r) {
