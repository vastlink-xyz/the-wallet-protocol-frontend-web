...
import { J as et, H as tt, M as nt, q as ye, m as st, n as at, t as rt, c as D, g as De, I as He, aG as it, T as ot, D as lt, b as ct, $ as ue, d as dt, e as ut, a9 as ht, B as Te, aH as ft, aI as pt, i as Re, f as Ae, j as Oe, a as mt, aJ as Ne, af as Ue, ap as gt, aK as We, Z as xe, h as xt, ac as bt, aq as vt } from "./main-DH96ONN5.js";
import { r as I, p as Me, o as yt, q as wt, c as Tt, d as kt, k as qe } from "./vendor-react-BA5A8Axg.js";
import { u as _t, i as Ge, L as jt, f as Ke, g as Ve, T as Et, P as Ct, I as Nt } from "./vendor-ui-utils-BWSrTfCS.js";
import { u as Je, B as Se } from "./vendor-utils-nZmF9_dO.js";
import { u as St } from "./useTransaction-DF96Fmcv.js";
import { c as It, h as At, e as Ot, k as ke, p as je } from "./vendor-web3-CqtRdeC5.js";
import { d as Mt } from "./index-DDdiT0sA.js";
const Vt = (o) => {
  const {
    componentCls: s,
...
const Qe = (o) => {
  ...
  return ne(/* @__PURE__ */ I.createElement("div", Object.assign({
    className: S,
    style: Object.assign(Object.assign({}, a == null ? void 0 : a.style), V)
  }, G, {
    role: "separator"
...
function $t({
  ...
  const [g, l] = I.useState(!1), [p, d] = I.useState(0), [C, A] = I.useState(!1), q = I.useRef(null), Y = I.useRef(null), M = I.useRef(0), V = () => {
    const W = Date.now();
    ...
    X + L.offsetWidth >= Ie && (X = Ie - L.offsetWidth, V()), d(X);
  }, ne = () => {
    C || d(0), l(!1);
  };
  return I.useEffect(() => {
...
function Wt({
  ...
  return /* @__PURE__ */ n.jsxs("div", { className: D(
    ...
    g && !f && /* @__PURE__ */ n.jsx(Ve, { className: D(
  ...
  return qt.getOrCreate(g, async () => {
    ...
    try {
      ...
      const q = await d.estimateGas({
        ...A,
        account: f
      }), Y = a || await d.getGasPrice(), V = (m || await d.getBlock()).baseFeePerGas || BigInt(0), G = Y > V ? Y - V : BigInt(1e9), N = V + G * BigInt(2), ne = q * N, W = Re(
...
const Kt = (o) => {
  ...
  return { isValid: !0 };
}, Fe = /* @__PURE__ */ new Map(), Jt = 5 * 60 * 1e3;
async function Qt(o) {
  const s = Fe.get(o), f = Date.now();
...
(function(o, s) {
  (function(f, a) {
    ...
    var a = typeof self < "u" ? self : typeof window < "u" ? window : a !== void 0 ? a : {}, m = !a.document && !!a.postMessage, g = a.IS_PAPA_WORKER || !1, l = {}, p = 0, d = { parse: function(t, e) {
      ...
      }(t), u = e.download ? new q(e) : new M(e)) : t.readable === !0 && S(t.read) && S(t.on) ? u = new V(e) : (a.File && t instanceof File || t instanceof Object) && (u = new Y(e)), u.stream(t);
...
`, j = '"', B = j + j, P = !1, T = null, H = !1;
      ...
      function ie(y, $, ae) {
        ...
        for (var k = 0; k < $.length; k++) {
          var F = Z ? y.length : $[k].length, r = !1, x = Z ? Object.keys($[k]).length === 0 : $[k].length === 0;
...
`, '"', d.BYTE_ORDER_MARK], d.WORKERS_SUPPORTED = !m && !!a.Worker, d.NODE_STREAM_INPUT = 1, d.LocalChunkSize = 10485760, d.RemoteChunkSize = 5242880, d.DefaultDelimiter = ",", d.Parser = ne, d.ParserHandle = G, d.NetworkStreamer = q, d.FileStreamer = Y, d.StringStreamer = M, d.ReadableStreamStreamer = V, a.jQuery) {
      var C = a.jQuery;
    ...
    function G(t) {
      ...
      function z() {
        return y && h && (te("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + d.DefaultDelimiter + "'"), h = !1), t.skipEmptyLines && (y.data = y.data.filter(function(k) {
          ...
          if (Array.isArray(y.data[0])) {
            for (var F = 0; Z() && F < y.data.length; F++) y.data[F].forEach(k);
            y.data.splice(0, 1);
          ...
          var F = 1;
          return !y.data.length || Array.isArray(y.data[0]) ? (y.data = y.data.map(k), F = y.data.length) : y.data = k(y.data, 0), t.header && y.meta && (y.meta.fields = se), H += F, y;
        }();
      }
      function Z() {
      ...
      function ee(k, F) {
        return r = k, t.dynamicTypingFunction && t.dynamicTyping[r] === void 0 && (t.dynamicTyping[r] = t.dynamicTypingFunction(r)), (t.dynamicTyping[r] || t.dynamicTyping) === !0 ? F === "true" || F === "TRUE" || F !== "false" && F !== "FALSE" && (function(x) {
          if (j.test(x)) {
            var c = parseFloat(x);
            if (w < c && c < u) return !0;
          }
          return !1;
        }(F) ? parseFloat(F) : B.test(F) ? new Date(F) : F === "" ? null : F) : F;
        var r;
      }
      function te(k, F, r, x) {
        var c = { type: k, code: F, message: r };
        x !== void 0 && (c.row = x), y.errors.push(c);
      }
      this.parse = function(k, F, r) {
        var x = t.quoteChar || '"';
...
` : "\r";
        ...
        var v = re(t);
        return t.preview && t.header && v.preview++, e = k, i = new ne(v), y = i.parse(e, F, r), z(), _ ? { meta: { paused: !0 } } : y || { meta: { paused: !1 } };
...
`);
      ...
      this.parse = function(_, ie, se) {
        ...
        var y = _.length, $ = i.length, ae = h.length, z = u.length, Z = S(w), ee = [], te = [], k = [], F = T = 0;
        if (!_) return ce();
        if (t.header && !ie) {
        ...
        function ce(de) {
          return { data: ee, errors: te, meta: { delimiter: i, linebreak: h, aborted: H, truncated: !!de, cursor: F + (ie || 0) } };
        }
        function _e() {
          w(ce()), ee = [], te = [];
        }
    ...
    }), (q.prototype = Object.create(A.prototype)).constructor = q, (Y.prototype = Object.create(A.prototype)).constructor = Y, (M.prototype = Object.create(M.prototype)).constructor = M, (V.prototype = Object.create(A.prototype)).constructor = V, d;
  });
})(Ye);
var Xt = Ye.exports;
...
function en({
  ...
  const { address: s } = mt.all(), { t: f } = Je(), { data: a, isFetched: m } = Ne("ETH"), { data: g, isFetched: l } = Ne("MATIC"), { data: p, isFetched: d } = Ne("TVWT"), { data: C } = Ue(), { data: A } = gt(), [q, Y] = I.useState(null), [M, V] = I.useState([]), [G, N] = I.useState([]), [ne, W] = I.useState(!1), [K, L] = I.useState(!1), [re, X] = I.useState({
    ETH: "0",
    MATIC: "0",
    TVWT: "0",
    usdValue: "0"
  ...
  return {
    ...
    handleDeleteTransfer: (r) => {
      V(M.filter((x, c) => c !== r)), N(G.filter((x, c) => c !== r));
    },
    handleFileChange: (r) => {
      var c;
      ...
      x && Zt.parse(x, {
        ...
        complete: (v) => {
          const b = Kt(v.data);
          if (!b.isValid) {
            Se.error(b.error), V([]), r.target.value = "";
            return;
          }
  ...
  return /* @__PURE__ */ n.jsxs("div", { className: D(
    ...
    /* @__PURE__ */ n.jsxs("div", { className: "mt-[120px]", children: [
      ...
      /* @__PURE__ */ n.jsxs("p", { className: "text-black text-xl font-medium leading-none text-right mt-0.5", children: [
        Object.entries(V).filter(([h]) => h !== "usdValue" && V[h] !== "0").map(([h, u], w, j) => /* @__PURE__ */ n.jsxs("span", { children: [
          u,
          " ",
          ue(h),
          w < j.length - 1 && " & "
        ] }, h)),
        Object.values(V).some((h) => h !== "0") && ` (~$${V.usdValue} USD)`
      ] }),
          ...
          children: [
            /* @__PURE__ */ n.jsxs("div", { className: D(
              ...
              /* @__PURE__ */ n.jsxs("div", { className: D(
                ...
                l.type === "invitation" && l.status === "sent" && /* @__PURE__ */ n.jsx(Ve, { className: "text-blue-500", size: 12 }),
                l.status === "failed" && /* @__PURE__ */ n.jsx(Ve, { className: "text-destructive", size: 12 })
              ] })
            ] }),
            /* @__PURE__ */ n.jsx("p", { className: D(
