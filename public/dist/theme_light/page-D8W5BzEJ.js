...
import { B as k, C as w } from "./index-DNJTVjmq.js";
import { a as j } from "./index-BM60kQF_.js";
import { c as t } from "./main-B77raCsP.js";
import { a as y } from "./auth-BdKvj3eV.js";
import { B as u } from "./button-CKwz-iep.js";
import { C } from "./checkbox-DqrXzfMG.js";
import { u as B } from "./useTransaction-AD_lKMT8.js";
import { h as E } from "./error-EuuGdfel.js";
import { r as m, b as P, l as S } from "./vendor-react-CA5sEv1f.js";
import { u as T, B as b } from "./vendor-utils-C-Nds55G.js";
import { X as I } from "./vendor-ui-utils-BGnsFFgj.js";
import { p as v } from "./vendor-web3-4JjHsX86.js";
import { D as A } from "./dialog-DzGTiGoN.js";
import { T as M } from "./TokenService-Dm8dxXLZ.js";
import { C as z } from "./index-Dpq6gUpu.js";
function O() {
...
const R = ({ isOpen: s, onClose: i, product: n, balance: a }) => {
  const [l, r] = m.useState(!1), { signTransaction: h, waitForTransactionExection: f } = B(), { t: d } = T(), x = n.discount ? n.price * (1 - n.discount / 100) : n.price, c = async () => {
    if (v(a) < v(String(x))) {
...
function F({
  ...
  var c;
  const [a, l] = m.useState(!1), [r, h] = m.useState(!1), f = () => {
  ...
  return s ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    ...
    /* @__PURE__ */ e.jsxs("div", { className: t([
      ...
      /* @__PURE__ */ e.jsxs("label", { className: "flex items-center gap-x-2 cursor-pointer", children: [
        /* @__PURE__ */ e.jsx(C, { checked: a, onCheckedChange: () => l(!a) }),
...
function ne() {
  const { productId: s } = S(), [i, n] = m.useState(""), [a, l] = m.useState(null), [r, h] = m.useState(!1);
  m.useEffect(() => {
    f();
  }, [s]);
  const f = async () => {
    ...
    const c = y.all().address, o = await M.getInstance().createToken("TVWT").getBalance(c);
    n(o);
  }, x = () => {
    h(!0);
  };
