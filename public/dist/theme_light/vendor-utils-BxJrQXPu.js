import { g as xr, B as Or } from "./vendor-walletconnect-DWr_8Xx3.js";
import { p as le, r as F, d as Dn, R as J } from "./vendor-react-CwfAKKXk.js";
import { c as me } from "./vendor-ui-utils-ERHZUJ9g.js";
function Fn(t, e) {
  return function() {
...
const ei = (...t) => {
  ...
  ve(t[0]) && ln[t[0]] || (ve(t[0]) && (ln[t[0]] = /* @__PURE__ */ new Date()), ei(...t));
}, lr = (t, e) => () => {
  if (t.isInitialized)
    e();
  else {
...
}, ti = (t, e, n = {}) => !e.languages || !e.languages.length ? (Nt("i18n.languages were undefined or empty", e.languages), !0) : e.hasLoadedNamespace(t, {
  lng: n.lng,
  precheck: (r, s) => {
    var i;
...
}), ve = (t) => typeof t == "string", ni = (t) => typeof t == "object" && t !== null, ri = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, si = {
  "&amp;": "&",
  "&#38;": "&",
  "&lt;": "<",
  "&#60;": "<",
  ...
  "&#x2F;": "/",
  "&#47;": "/"
}, ii = (t) => si[t], oi = (t) => t.replace(ri, ii);
let At = {
...
const di = (t, e) => {
...
}, fr = (t, e, n, r) => t.getFixedT(e, n, r), pi = (t, e, n, r) => F.useCallback(fr(t, e, n, r), [t, e, n, r]), Ao = (t, e = {}) => {
  var E, b, D, L;
  const {
    i18n: n
  } = e, {
  ...
  if (i && !i.reportNamespaces && (i.reportNamespaces = new fi()), !i) {
    ...
    const T = (B, z) => ve(z) ? z : ni(z) && ve(z.defaultValue) ? z.defaultValue : Array.isArray(B) ? B[B.length - 1] : B, I = [T, {}, !1];
  ...
  const u = (i.isInitialized || i.initializedStoreOnce) && c.every((T) => ti(T, i, o)), d = pi(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), f = () => d, y = () => fr(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), [h, m] = F.useState(f);
  let g = c.join();
  e.lng && (g = `${e.lng}${g}`);
  const x = di(g), w = F.useRef(!0);
  F.useEffect(() => {
    const {
      bindI18n: T,
      bindI18nStore: I
...
function Io({
  ...
  return F.createElement(cr.Provider, {
    value: r
  }, n);
}
var it = {}, hi = function() {
  ...
  "text/html": "Url",
  default: "Text"
}, mi = "Copy to clipboard: #{key}, Enter";
function yi(t) {
...
function bi(t, e) {
  ...
  try {
    ...
    try {
      ...
      n && console.error("unable to copy using clipboardData: ", d), n && console.error("falling back to prompt"), r = yi("message" in e ? e.message : mi), window.prompt(r, t);
    }
  } finally {
...
var De = dr(F), Si = dr(vi), wi = ["text", "onCopy", "options", "children"];
function dr(t) {
...
var hr = /* @__PURE__ */ function(t) {
  ...
  function n() {
    ...
    return r = e.call.apply(e, [this].concat(i)), qt(pr(r), "onClick", function(a) {
      var l = r.props, c = l.text, u = l.onCopy, d = l.children, f = l.options, y = De.default.Children.only(d), h = (0, Si.default)(c, f);
  ...
  return Ti(n, [{
    ...
    value: function() {
      ...
      var i = s.children, o = Ei(s, wi), a = De.default.Children.only(i);
...
var Ai = it, kt = Ai.CopyToClipboard;
kt.CopyToClipboard = kt;
var Ii = kt;
const _o = /* @__PURE__ */ Dn(Ii), Ae = (t) => typeof t == "number" && !isNaN(t), Se = (t) => typeof t == "string", ue = (t) => typeof t == "function", Ve = (t) => Se(t) || ue(t) ? t : null, $t = (t) => F.isValidElement(t) || Se(t) || ue(t) || Ae(t);
function _i(t, e, n) {
  n === void 0 && (n = 300);
...
function ot(t) {
  ...
  return function(o) {
    ...
    return F.useLayoutEffect(() => {
      ...
      const x = d.current, w = () => {
        x.removeEventListener("animationend", w), s ? _i(x, u, i) : u();
      };
...
let Ie = [];
const jt = /* @__PURE__ */ new Set(), ki = (t) => jt.forEach((e) => e(t)), gr = () => ne.size > 0;
function mr(t, e) {
  var n;
    ...
    return { subscribe(a) {
      const l = /* @__PURE__ */ function(u, d, f) {
        ...
        const S = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Set(), b = () => {
          ...
          T.staleId && S.delete(T.staleId), S.set(I, T), g = [...g, T.props.toastId].filter((Y) => Y !== T.staleId), b(), f(hn(T, fe ? "added" : "updated")), fe && ue(B) && B(F.isValidElement(ae) && ae.props);
        };
        return { id: u, props: w, observe: (T) => (E.add(T), () => E.delete(T)), toggle: (T, I) => {
          ...
          const G = { ...w, style: w.toastStyle, key: y++, ...Object.fromEntries(Object.entries(I).filter((N) => {
            ...
            ue(P) && P(F.isValidElement(C) && C.props), f(hn(N, "removed")), S.delete(B), h--, h < 0 && (h = 0), m.length > 0 ? L(m.shift()) : b();
          } };
          var K, Z;
          ...
          let v = T;
          F.isValidElement(T) && !Se(T.type) ? v = F.cloneElement(T, { closeToast: te, toastProps: G, data: ae }) : ue(T) && (v = T({ closeToast: te, toastProps: G, data: ae }));
...
function Ye(t, e) {
  return { ...e, type: e && e.type || t, toastId: Ui(e) };
}
function Fe(t) {
...
const Mi = typeof window < "u" ? F.useLayoutEffect : F.useEffect, Ue = (t) => {
  ...
  }(Z)), J.createElement(y, { isIn: z, done: B, position: h, preventExitTransition: n, nodeRef: r, playToast: i }, J.createElement("div", { id: I, onClick: c, "data-in": z, className: X, ...s, style: g, ref: r }, J.createElement("div", { ...z && { role: D }, className: ue(x) ? x({ type: u }) : me("Toastify__toast-body", x), style: w }, G != null && J.createElement("div", { className: me("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !ae }) }, G), J.createElement("div", null, a)), v, J.createElement(Di, { ...b && !K ? { key: `pb-${b}` } : {}, rtl: T, theme: Y, delay: l, isRunning: e, isIn: z, closeToast: f, hide: d, type: u, style: E, className: S, controlledProgress: K, progress: L || 0 })));
}, at = function(t, e) {
...
const ko = ot(at("zoom"));
ot(at("flip"));
const Hi = { position: "top-right", transition: zi, autoClose: 5e3, closeButton: !0, pauseOnHover: !0, pauseOnFocusLoss: !0, draggable: "touch", draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light" };
function $o(t) {
  let e = { ...Hi, ...t };
  const n = t.stacked, [r, s] = F.useState(!0), i = F.useRef(null), { getToastToRender: o, isToastActive: a, count: l } = $i(e), { className: c, style: u, rtl: d, containerId: f } = e;
  function y(m) {
  ...
  return Mi(() => {
    ...
    return J.createElement("div", { className: y(m), style: x, key: `container-${m}` }, g.map((w) => {
      ...
      return J.createElement(Bi, { ...E, stacked: n, collapseAll: h, isIn: a(E.toastId, E.containerId), style: E.style, key: `toast-${E.key}` }, S);
    }));
  }));
}
