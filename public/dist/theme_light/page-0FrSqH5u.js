...
import { m as b, l as w, a as o } from "./vendor-react-BNvQ9I2c.js";
import { f, T as k, B as d, L as C, ac as S, g as u } from "./main-C7od9bzF.js";
import { B as L } from "./vendor-utils-B-eF5hYT.js";
import { u as R } from "./useTransaction-Cfpzirn8.js";
import { L as B } from "./index-D2kfGm-9.js";
import { f as x } from "./vendor-web3-DanlmASa.js";
function V() {
  const [i] = b(), h = w(), { signTransaction: p, waitForTransactionExection: g } = R(), [s, v] = o.useState(), [r, I] = o.useState("PENDING"), [c, l] = o.useState(!1), T = o.useRef();
  o.useEffect(() => {
    j();
  }, [i]), o.useEffect(() => {
    s && I(s.status);
  ...
  const j = async () => {
    ...
    if (a.data.success) {
      v(a.data.inviteInfo);
      const n = k.getInstance().createToken(a.data.inviteInfo.token);
      T.current = n;
    }
  }, N = async () => {
    try {
