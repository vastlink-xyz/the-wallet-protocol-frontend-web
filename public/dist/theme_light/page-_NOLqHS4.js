...
import { m as C, h as A, a as r } from "./vendor-react-DG1r0zWq.js";
import { B as n, a as O } from "./vendor-utils-CARgNrN0.js";
import { f as o, g as V, B as f, L as u, a as U, h as E, o as W } from "./main-ZrsMs0Kw.js";
import { L as b } from "./index-DB8_Lllq.js";
import { k as Y } from "./vendor-web3-CfovYfnB.js";
function J() {
  const [l] = C(), x = A(), [p, I] = r.useState(!1), [h, g] = r.useState(!1), [j, v] = r.useState(!1), [w, y] = r.useState(!1), [t, S] = r.useState(), [m, T] = r.useState("PENDING"), [k, R] = r.useState("");
  r.useEffect(() => {
    G();
  }, [l]), r.useEffect(() => {
    t && T(t.status);
