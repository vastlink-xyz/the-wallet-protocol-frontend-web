...
import { l as k, k as b, r as i } from "./vendor-react-CuOkI7kW.js";
import { f as d, t as w, B as f, L as S, ad as C, g as u } from "./main-DJ2eXCQq.js";
import { B as L } from "./vendor-utils-DMWa-Mp_.js";
import { u as R } from "./useTransaction-uPXAfYPH.js";
import { L as B } from "./index-B5Q10HkQ.js";
import { k as x } from "./vendor-web3-DDgB3Js4.js";
function V() {
  const [o] = k(), h = b(), { signTransaction: p, waitForTransactionExection: g } = R(), [s, v] = i.useState(), [r, I] = i.useState("PENDING"), [c, m] = i.useState(!1), j = i.useRef();
  i.useEffect(() => {
    T();
  }, [o]), i.useEffect(() => {
    s && I(s.status);
