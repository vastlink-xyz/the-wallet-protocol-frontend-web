...
import { j as d, S as zn, d as _s, g as Hs, P as _n, C as qs, I as Ks, i as Ws, k as $s, l as Vs, L as Gs, m as Ys, n as Hn, T as qn, o as Zs, p as Xs, q as Js, r as Kn } from "./vendor-radix-nT--cb5B.js";
import { p as Qe, a as en, r as x, b as tn, R as K, O as Wn, u as $n, e as Vn, f as Gn } from "./vendor-react-CwfAKKXk.js";
import { t as Yn, c as Zn, C as Xn, a as Jn, b as er, d as tr, e as sr, X as sn, L as nr, f as hs, g as rr, h as ar } from "./vendor-ui-utils-BZIqroPj.js";
import { a as rt, u as es, C as ir, B as be, Q as or, X as lr, i as nn, b as cr, I as ur } from "./vendor-utils-lcIc62q_.js";
import { d as rn, C as fs, c as Rt, f as ts, h as ss, E as dr, m as hr, a as fr, b as ps, i as ms, p as ys } from "./vendor-web3-VgZtbLWg.js";
    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: t } = await import("./main-layout-B0m03ewQ.js");
          return { Component: t };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: t } = await import("./page-CUYZYYK_.js");
              return { Component: t };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: t } = await import("./page-Xh8JTUcW.js");
              return { Component: t };
            }
          },
          {
            ...
            async lazy() {
              const { default: t } = await import("./page-CJqcfXQX.js");
              return { Component: t };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: t } = await import("./page-CkyD190Q.js");
              return { Component: t };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-DLAR8zrC.js");
                  return { Component: t };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: t } = await import("./page-fSa49DGN.js");
                  return { Component: t };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: t } = await import("./page-Dns3hEfb.js");
                  return { Component: t };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-vv3eLEZV.js");
                  return { Component: t };
                },
                loader: La
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: t } = await import("./page-CDNGY1Fp.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-rgWIFinO.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-NKAa-CUc.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: t } = await import("./page-BnpEcNBT.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: t } = await import("./page-DTvvQEbo.js");
                  return { Component: t };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: t } = await import("./page-Brp1MISI.js");
                  return { Component: t };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: t } = await import("./page-BHvzvkGh.js");
                          return { Component: t };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: t } = await import("./page-CEJDEcgk.js");
                          return { Component: t };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: t } = await import("./page-D6UgNKFl.js");
                  return { Component: t };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: t } = await import("./page-CnTOrF6G.js");
                  return { Component: t };
                }
              }
            ]
