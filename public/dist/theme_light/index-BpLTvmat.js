...
import { k as B, f as E, r as l } from "./vendor-react-X5c0QESR.js";
import { u as L, B as o, a as g } from "./vendor-utils-avI_LICu.js";
import { I as $, p as M, B as U, l as p, o as S, h } from "./main-BVot_80u.js";
import { C as F, a as H, c as O, d as V } from "./card-fI06gMpa.js";
import { L as q } from "./label-fc6Up90H.js";
function Q() {
  const [n] = B(), y = E(), { t: a } = L(), [d, w] = l.useState(""), [m, i] = l.useState(!1), [x, f] = l.useState(!1), [c, b] = l.useState(!0), [N, j] = l.useState(!1);
  l.useEffect(() => {
    (async () => {
      const t = n == null ? void 0 : n.get("email"), r = n == null ? void 0 : n.get("otp"), u = n == null ? void 0 : n.get("type");
      t && r && (w(t), u === "login" ? I(t, r) : C(t, r));
    })();
  }, [n]);
  async function k() {
    p("call register");
