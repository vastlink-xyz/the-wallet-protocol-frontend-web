...
import { f as o, g as U, B as d, L as f, k as V, a as W, h as y } from "./main-DtxzRDTa.js";
import { L as E } from "./index-jdHRmqor.js";
import { f as Y } from "./vendor-web3-VgZtbLWg.js";
function K() {
  const [l] = C(), w = A(), [u, b] = n.useState(!1), [x, p] = n.useState(!1), [h, g] = n.useState(!1), [I, j] = n.useState(!1), [t, S] = n.useState(), [m, T] = n.useState("PENDING"), [k, G] = n.useState("");
  n.useEffect(() => {
    P();
  }, [l]), n.useEffect(() => {
    t && T(t.status);
  ...
  return /* @__PURE__ */ s.jsx("div", { className: "mt-[120px] flex items-center justify-center", children: /* @__PURE__ */ s.jsxs("div", { className: "bg-white rounded-2xl px-4 md:px-12 py-8 mx-6 max-w-md w-full", children: [
