import { r as M, R as J, p as ce, g as ts } from "./vendor-react-Cqw-pUgZ.js";
import { c as Re } from "./vendor-ui-utils-D8A1AlyV.js";
import { g as ns, B as rs } from "./vendor-web3-DM8VQNRv.js";
...
const I = (t) => typeof t == "string", Me = () => {
...
}, mn = (t) => t == null ? "" : "" + t, gs = (t, e, n) => {
  t.forEach((r) => {
    e[r] && (n[r] = e[r]);
  });
}, ms = /###/g, yn = (t) => t && t.indexOf("###") > -1 ? t.replace(ms, ".") : t, vn = (t) => !t || I(t), Ue = (t, e, n) => {
  ...
  for (const r in e)
    r !== "__proto__" && r !== "constructor" && (r in t ? I(t[r]) || t[r] instanceof String || I(e[r]) || e[r] instanceof String ? n && (t[r] = e[r]) : lr(t[r], e[r], n) : t[r] = e[r]);
  return t;
}, De = (t) => t.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
var bs = {
  "&": "&amp;",
...
const Es = (t) => I(t) ? t.replace(/[&<>"'\/]/g, (e) => bs[e]) : t;
class ws {
  constructor(e) {
...
const Ss = [" ", ",", "?", "!", ";"], Ts = new ws(20), xs = (t, e, n) => {
  e = e || "", n = n || "";
  const r = Ss.filter((o) => e.indexOf(o) < 0 && n.indexOf(o) < 0);
  if (r.length === 0) return !0;
  const s = Ts.getRegExp(`(${r.map((o) => o === "?" ? "\\?" : o).join("|")})`);
  let i = !s.test(t);
  if (!i) {
    const o = t.indexOf(n);
...
class ft {
  ...
  init(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.prefix = n.prefix || "i18next:", this.logger = e || Os, this.options = n, this.debug = n.debug;
  }
  log() {
...
class En extends vt {
  ...
  addResource(e, n, r, s) {
    ...
    let a = [e, n];
    r && (a = a.concat(o ? r.split(o) : r)), e.indexOf(".") > -1 && (a = e.split("."), s = n, n = a[1]), this.addNamespaces(n), bn(this.data, a, s), i.silent || this.emit("added", e, n, r, s);
  }
  addResources(e, n, r) {
    let s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {
      silent: !1
  ...
  addResourceBundle(e, n, r, s, i) {
    ...
    o.skipCopy || (r = JSON.parse(JSON.stringify(r))), s ? lr(l, r, i) : l = {
      ...l,
      ...r
    }, bn(this.data, a, l), o.silent || this.emit("added", e, n, r);
  }
...
class dt extends vt {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    super(), gs(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = n, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = we.create("translator");
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  extractFromKey(e, n) {
    ...
    const o = r && e.indexOf(r) > -1, a = !this.options.userDefinedKeySeparator && !n.keySeparator && !this.options.userDefinedNsSeparator && !n.nsSeparator && !xs(e, r, s);
    if (o && !a) {
  ...
  extendTranslation(e, n, r, s, i) {
    ...
    return e != null && l && l.length && r.applyPostProcessor !== !1 && (e = ur.handle(l, e, n, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...s,
  ...
  resolve(e) {
    ...
    return I(e) && (e = [e]), e.forEach((l) => {
      ...
      d.forEach((h) => {
        this.isValidLookup(r) || (a = h, !wn[`${m[0]}-${h}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(a) && (wn[`${m[0]}-${h}`] = !0, this.logger.warn(`key "${s}" for languages "${m.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach((w) => {
          if (this.isValidLookup(r)) return;
          o = w;
          const S = [u];
...
class Ns {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.languageUtils = e, this.options = n, this.logger = we.create("pluralResolver"), (!this.options.compatibilityJSON || Ls.includes(this.options.compatibilityJSON)) && (typeof Intl > "u" || !Intl.PluralRules) && (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = As(), this.pluralRulesCache = {};
  }
  addRule(e, n) {
    this.rules[e] = n;
  }
  ...
  getSuffixes(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const r = this.getRule(e, n);
    return r ? this.shouldUseIntlApi() ? r.resolvedOptions().pluralCategories.sort((s, i) => Tn[s] - Tn[i]).map((s) => `${this.options.prepend}${n.ordinal ? `ordinal${this.options.prepend}` : ""}${s}`) : r.numbers.map((s) => this.getSuffix(e, s, n)) : [];
  }
  getSuffix(e, n) {
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  ...
  shouldUseIntlApi() {
    return !Ps.includes(this.options.compatibilityJSON);
  }
}
const xn = function(t, e, n) {
  let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : ".", s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, i = vs(t, e, n);
...
class _s {
  ...
  init() {
    ...
    this.escape = n !== void 0 ? n : Es, this.escapeValue = r !== void 0 ? r : !0, this.useRawValueToEscape = s !== void 0 ? s : !1, this.prefix = i ? De(i) : o || "{{", this.suffix = a ? De(a) : l || "}}", this.formatSeparator = c || ",", this.unescapePrefix = u ? "" : d || "-", this.unescapeSuffix = this.unescapePrefix ? "" : u || "", this.nestingPrefix = f ? De(f) : y || De("$t("), this.nestingSuffix = p ? De(p) : m || De(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = w || 1e3, this.alwaysFormat = S !== void 0 ? S : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, n, r, s) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (y) => {
      if (y.indexOf(this.formatSeparator) < 0) {
        const w = xn(n, l, y, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      return this.format(xn(n, l, m, this.options.keySeparator, this.options.ignoreJSONStructure), h, r, {
        ...s,
        ...n,
        interpolationkey: m
      });
  ...
  nest(e, n) {
    ...
    for (; s = this.nestingRegexp.exec(e); ) {
      ...
      I(i) || (i = mn(i)), i || (this.logger.warn(`missed to resolve ${s[1]} for nesting ${e}`), i = ""), c && (i = l.reduce((u, d) => this.format(u, d, r.lng, {
        ...r,
...
class $s extends vt {
  ...
  loaded(e, n, r) {
    ...
    this.queue.forEach((l) => {
      ys(l.loaded, [i], o), ks(l, e), n && l.errors.push(n), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((c) => {
        a[c] || (a[c] = {});
        const u = l.loaded[c];
...
}), Rn = (t) => (I(t.ns) && (t.ns = [t.ns]), I(t.fallbackLng) && (t.fallbackLng = [t.fallbackLng]), I(t.fallbackNS) && (t.fallbackNS = [t.fallbackNS]), t.supportedLngs && t.supportedLngs.indexOf("cimode") < 0 && (t.supportedLngs = t.supportedLngs.concat(["cimode"])), t), Ge = () => {
}, Bs = (t) => {
...
class Ve extends vt {
  constructor() {
    ...
    if (super(), this.options = Rn(e), this.services = {}, this.logger = we, this.modules = {
      external: []
    }, Bs(this), n && !this.isInitialized && !e.isClone) {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      let u;
      this.modules.formatter ? u = this.modules.formatter : typeof Intl < "u" && (u = Ds);
      const d = new Sn(this.options);
      this.store = new En(this.options.resources, this.options);
      const f = this.services;
      f.logger = we, f.resourceStore = this.store, f.languageUtils = d, f.pluralResolver = new Ns(d, {
        prepend: this.options.pluralSeparator,
        compatibilityJSON: this.options.compatibilityJSON,
        simplifyPluralSuffix: this.options.simplifyPluralSuffix
      }), u && (!this.options.interpolation.format || this.options.interpolation.format === s.interpolation.format) && (f.formatter = i(u), f.formatter.init(f, this.options), this.options.interpolation.format = f.formatter.format.bind(f.formatter)), f.interpolator = new _s(this.options), f.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, f.backendConnector = new $s(i(this.modules.backend), f.resourceStore, f, this.options), f.backendConnector.on("*", function(y) {
  ...
  dir(e) {
    ...
    const n = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], r = this.services && this.services.languageUtils || new Sn(On());
  ...
  cloneInstance() {
    ...
    }, r && (i.store = new En(this.store.data, s), i.services.resourceStore = i.store), i.translator = new dt(i.services, s), i.translator.on("*", function(a) {
...
const Ms = (...t) => {
  ...
  Ne(t[0]) && Cn[t[0]] || (Ne(t[0]) && (Cn[t[0]] = /* @__PURE__ */ new Date()), Ms(...t));
}, cr = (t, e) => () => {
  if (t.isInitialized)
    e();
  else {
  ...
  t.loadNamespaces(e, cr(t, n));
}, Ln = (t, e, n, r) => {
  Ne(n) && (n = [n]), n.forEach((s) => {
    t.options.ns.indexOf(s) < 0 && t.options.ns.push(s);
  }), t.loadLanguages(e, cr(t, r));
}, Fs = (t, e, n = {}) => !e.languages || !e.languages.length ? (Vt("i18n.languages were undefined or empty", e.languages), !0) : e.hasLoadedNamespace(t, {
  lng: n.lng,
  precheck: (r, s) => {
    var i;
...
}), Ne = (t) => typeof t == "string", js = (t) => typeof t == "object" && t !== null, Us = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Hs = {
  "&amp;": "&",
  "&#38;": "&",
  "&lt;": "<",
  "&#60;": "<",
  ...
  "&#x2F;": "/",
  "&#47;": "/"
}, zs = (t) => Hs[t], Vs = (t) => t.replace(Us, zs);
let Kt = {
...
const Qs = (t, e) => {
...
}, pr = (t, e, n, r) => t.getFixedT(e, n, r), Xs = (t, e, n, r) => M.useCallback(pr(t, e, n, r), [t, e, n, r]), ka = (t, e = {}) => {
  var T, v, B, L;
  const {
    i18n: n
  } = e, {
    i18n: r,
    defaultNS: s
  } = M.useContext(dr) || {}, i = n || r || Ws();
  if (i && !i.reportNamespaces && (i.reportNamespaces = new Ys()), !i) {
    Vt("You will need to pass in an i18next instance by using initReactI18next");
    const R = (U, H) => Ne(H) ? H : js(H) && Ne(H.defaultValue) ? H.defaultValue : Array.isArray(U) ? U[U.length - 1] : U, _ = [R, {}, !1];
  ...
  const u = (i.isInitialized || i.initializedStoreOnce) && c.every((R) => Fs(R, i, o)), d = Xs(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), f = () => d, y = () => pr(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), [p, m] = M.useState(f);
  let h = c.join();
  e.lng && (h = `${e.lng}${h}`);
  const w = Qs(h), S = M.useRef(!0);
  M.useEffect(() => {
    const {
      bindI18n: R,
      bindI18nStore: _
    } = o;
    S.current = !0, !u && !a && (e.lng ? Ln(i, e.lng, c, () => {
      S.current && m(y);
    }) : Pn(i, c, () => {
      S.current && m(y);
...
const { toString: Gs } = Object.prototype, { getPrototypeOf: rn } = Object, bt = /* @__PURE__ */ ((t) => (e) => {
  const n = Gs.call(e);
...
const gr = ve("ArrayBuffer");
function ei(t) {
  let e;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? e = ArrayBuffer.isView(t) : e = t && t.buffer && gr(t.buffer), e;
}
const ti = Et("string"), de = Et("function"), mr = Et("number"), wt = (t) => t !== null && typeof t == "object", ni = (t) => t === !0 || t === !1, it = (t) => {
  if (bt(t) !== "object")
    return !1;
  const e = rn(t);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(Symbol.toStringTag in t) && !(Symbol.iterator in t);
}, ri = ve("Date"), si = ve("File"), ii = ve("Blob"), oi = ve("FileList"), ai = (t) => wt(t) && de(t.pipe), li = (t) => {
  let e;
...
}, ui = ve("URLSearchParams"), [ci, fi, di, pi] = ["ReadableStream", "Request", "Response", "Headers"].map(ve), hi = (t) => t.trim ? t.trim() : t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const Le = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : ns, vr = (t) => !Ke(t) && t !== Le;
function qt() {
  const { caseless: t } = vr(this) && this || {}, e = {}, n = (r, s) => {
    const i = t && yr(e, s) || s;
...
const gi = (t, e, n, { allOwnKeys: r } = {}) => (qe(e, (s, i) => {
  n && de(s) ? t[i] = hr(s, n) : t[i] = s;
}, { allOwnKeys: r }), t), mi = (t) => (t.charCodeAt(0) === 65279 && (t = t.slice(1)), t), yi = (t, e, n, r) => {
  ...
  for (; e-- > 0; )
    n[e] = t[e];
  return n;
}, wi = /* @__PURE__ */ ((t) => (e) => t && e instanceof t)(typeof Uint8Array < "u" && rn(Uint8Array)), Si = (t, e) => {
  ...
  for (; (n = t.exec(e)) !== null; )
    r.push(n);
  return r;
}, xi = ve("HTMLFormElement"), Oi = (t) => t.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), An = (({ hasOwnProperty: t }) => (e, n) => t.call(e, n))(Object.prototype), Ri = ve("RegExp"), br = (t, e) => {
...
}, Ai = (t, e) => t != null && Number.isFinite(t = +t) ? t : e, At = "abcdefghijklmnopqrstuvwxyz", Nn = "0123456789", Er = {
  DIGIT: Nn,
  ALPHA: At,
  ALPHA_DIGIT: At + At.toUpperCase() + Nn
}, Ni = (t = 16, e = Er.ALPHA_DIGIT) => {
  let n = "";
  const { length: r } = e;
  for (; t--; )
    n += e[Math.random() * r | 0];
...
const Ii = (t) => {
  ...
  return n(t, 0);
}, Di = ve("AsyncFunction"), ki = (t) => t && (wt(t) || de(t)) && de(t.then) && de(t.catch), wr = ((t, e) => t ? setImmediate : e ? ((n, r) => (Le.addEventListener("message", ({ source: s, data: i }) => {
  ...
  de(Le.postMessage)
), $i = typeof queueMicrotask < "u" ? queueMicrotask.bind(Le) : typeof ce < "u" && ce.nextTick || wr, g = {
  isArray: $e,
  isArrayBuffer: gr,
  isBuffer: Zs,
  isFormData: li,
...
function _n(t, e, n) {
  return t ? t.concat(e).map(function(s, i) {
    return s = xr(s), !n && i ? "[" + s + "]" : s;
  }).join(n ? "." : "") : e;
}
function Mi(t) {
  return g.isArray(t) && !t.some(Jt);
}
const Fi = g.toFlatObject(g, {}, null, function(e) {
...
function St(t, e, n) {
  ...
  function u(p, m, h) {
    ...
    if (p && !h && typeof p == "object") {
      ...
      else if (g.isArray(p) && Mi(p) || (g.isFileList(p) || g.endsWith(m, "[]")) && (w = g.toArray(p)))
        return m = xr(m), w.forEach(function(E, T) {
          !(g.isUndefined(E) || E === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            o === !0 ? _n([m], T, i) : o === null ? m : m + "[]",
            c(E)
          );
        }), !1;
    }
    return Jt(p) ? !0 : (e.append(_n(h, m, i), c(p)), !1);
  }
  const d = [], f = Object.assign(Fi, {
    defaultVisitor: u,
    convertValue: c,
    isVisitable: Jt
  });
...
function Rr(t, e, n) {
  if (!e)
    return t;
  const r = n && n.encode || ji, s = n && n.serialize;
  let i;
...
}, Ui = typeof URLSearchParams < "u" ? URLSearchParams : sn, Hi = typeof FormData < "u" ? FormData : null, zi = typeof Blob < "u" ? Blob : null, Vi = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Ui,
    FormData: Hi,
...
}, on = typeof window < "u" && typeof document < "u", Wt = typeof navigator == "object" && navigator || void 0, Ki = on && (!Wt || ["ReactNative", "NativeScript", "NS"].indexOf(Wt.product) < 0), qi = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", Ji = on && window.location.href || "http://localhost", Wi = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: on,
...
function Pr(t) {
  function e(n, r, s, i) {
    ...
    return o = !o && g.isArray(s) ? s.length : o, l ? (g.hasOwnProp(s, o) ? s[o] = [s[o], r] : s[o] = r, !a) : ((!s[o] || !g.isObject(s[o])) && (s[o] = []), e(n, r, s[o], i) && g.isArray(s[o]) && (s[o] = Xi(s[o])), !a);
  }
  ...
  transformRequest: [function(e, n) {
    ...
    if (i) {
      if (r.indexOf("application/x-www-form-urlencoded") > -1)
        return Yi(e, this.formSerializer).toString();
...
const Zi = g.toObjectSet([
  ...
  return t && t.split(`
`).forEach(function(o) {
    s = o.indexOf(":"), n = o.substring(0, s).trim().toLowerCase(), r = o.substring(s + 1).trim(), !(!n || e[n] && Zi[n]) && (n === "set-cookie" ? e[n] ? e[n].push(r) : e[n] = [r] : e[n] = e[n] ? e[n] + ", " + r : r);
  }), e;
}, kn = Symbol("internals");
function Fe(t) {
...
const no = (t) => /^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());
...
class le {
  ...
  set(e, n, r) {
    ...
    if (g.isPlainObject(e) || e instanceof this.constructor)
      o(e, n);
    else if (g.isString(e) && (e = e.trim()) && !no(e))
      o(eo(e), n);
...
}, Bn = (t) => (...e) => g.asap(() => t(...e)), lo = ae.hasStandardBrowserEnv ? (
...
function Nr(t, e) {
  return t && !co(e) ? fo(t, e) : e;
}
const Mn = (t) => t instanceof le ? { ...t } : t;
function Ie(t, e) {
  e = e || {};
  const n = {};
  function r(c, u, d) {
...
const _r = (t) => {
  ...
  e.headers = o = le.from(o), e.url = Rr(Nr(e.baseURL, e.url), t.params, t.paramsSerializer), a && o.set(
    "Authorization",
  ...
  if (ae.hasStandardBrowserEnv && (r && g.isFunction(r) && (r = r(e)), r || r !== !1 && lo(e.url))) {
    const c = s && i && uo.read(i);
    c && o.set(s, c);
  }
  return e;
}, po = typeof XMLHttpRequest < "u", ho = po && function(t) {
...
}, Tt = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", Ir = Tt && typeof ReadableStream == "function", bo = Tt && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((t) => (e) => t.encode(e))(new TextEncoder()) : async (t) => new Uint8Array(await new Response(t).arrayBuffer())), Dr = (t, ...e) => {
  try {
    return !!t(...e);
  } catch {
    return !1;
  ...
  return t && !e;
}), jn = 64 * 1024, Yt = Ir && Dr(() => g.isReadableStream(new Response("").body)), ht = {
  stream: Yt && ((t) => t.body)
};
Tt && ((t) => {
...
const wo = async (t) => {
  ...
  let y = go([s, i && i.toAbortSignal()], o), p;
  const m = y && y.unsubscribe && (() => {
    y.unsubscribe();
  });
  let h;
  try {
    if (l && Eo && n !== "get" && n !== "head" && (h = await So(u, r)) !== 0) {
      let v = new Request(e, {
        method: "POST",
        body: r,
        duplex: "half"
    ...
    if (Yt && (a || E && m)) {
      ...
      const B = g.toFiniteNumber(S.headers.get("content-length")), [L, R] = a && $n(
        B,
        pt(Bn(a), !0)
      ) || [];
      S = new Response(
...
const Un = (t) => `- ${t}`, xo = (t) => g.isFunction(t) || t === null || t === !1, kr = {
  getAdapter: (t) => {
    t = g.isArray(t) ? t : [t];
    const { length: e } = t;
    let n, r;
    ...
    for (let i = 0; i < e; i++) {
      n = t[i];
      let o;
      if (r = n, !xo(n) && (r = Qt[(o = String(n)).toLowerCase()], r === void 0))
...
function Hn(t) {
  return It(t), t.headers = le.from(t.headers), t.data = _t.call(
    t,
    t.transformRequest
  ), ["post", "put", "patch"].indexOf(t.method) !== -1 && t.headers.setContentType("application/x-www-form-urlencoded", !1), kr.getAdapter(t.adapter || Je.adapter)(t).then(function(r) {
    ...
    return Lr(r) || (It(t), r && r.response && (r.response.data = _t.call(
      t,
      t.transformResponse,
      r.response
...
an.transitional = function(e, n, r) {
  function s(i, o) {
    return "[Axios v" + $r + "] Transitional option '" + i + "'" + o + (r ? ". " + r : "");
  }
  return (i, o, a) => {
    if (e === !1)
      throw new $(
...
function Br(t) {
  const e = new _e(t), n = hr(_e.prototype.request, e);
...
G.mergeConfig = Ie;
G.AxiosHeaders = le;
G.formToJSON = (t) => Pr(g.isHTMLForm(t) ? new FormData(t) : t);
G.getAdapter = kr.getAdapter;
G.HttpStatusCode = Gt;
G.default = G;
var xt = {}, Po = function() {
