...
import { k as C, f as L, r as n } from "./vendor-react-X5c0QESR.js";
import { B as i, a as A } from "./vendor-utils-avI_LICu.js";
import { i as o, l as O, L as d, B as f, o as U, a as V, h as v } from "./main-BVot_80u.js";
import { f as W } from "./vendor-web3-A0hL30sH.js";
function H() {
  const [l] = C(), E = L(), [u, b] = n.useState(!1), [p, h] = n.useState(!1), [x, g] = n.useState(!1), [w, j] = n.useState(!1), [t, I] = n.useState(), [m, S] = n.useState("PENDING"), [T, k] = n.useState("");
  n.useEffect(() => {
    G();
  }, [l]), n.useEffect(() => {
    t && S(t.status);
