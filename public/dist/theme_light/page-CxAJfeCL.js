...
import { B as i, a as O } from "./vendor-utils-Q0yJ_o1H.js";
import { f as o, g as U, B as f, L as u, k as V, a as M, h as N, o as W } from "./main-DV2eeK4Q.js";
import { L as E } from "./index-CS0Zbm51.js";
import { k as Y } from "./vendor-web3-CQEmmIwE.js";
function Q() {
  const [l] = C(), I = A(), [x, b] = r.useState(!1), [p, h] = r.useState(!1), [g, j] = r.useState(!1), [w, v] = r.useState(!1), [t, S] = r.useState(), [m, T] = r.useState("PENDING"), [k, R] = r.useState("");
  r.useEffect(() => {
    G();
  }, [l]), r.useEffect(() => {
    t && T(t.status);
  ...
  const G = async () => {
    ...
    a && s ? (R(s), P(a)) : i.error("inviteInfoId or otp is not existed.");
  }, P = async (a) => {
    try {
      v(!0);
      const s = await c(a);
