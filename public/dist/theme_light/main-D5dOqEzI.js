    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: t } = await import("./main-layout-Db1FJUZd.js");
          return { Component: t };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: t } = await import("./page-DRXBLLuZ.js");
              return { Component: t };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: t } = await import("./page-D2SRPUbA.js");
              return { Component: t };
            }
          },
          {
            ...
            async lazy() {
              const { default: t } = await import("./page-DVg3e8Vo.js");
              return { Component: t };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: t } = await import("./page-it_DamDV.js");
              return { Component: t };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-lXKnVGZZ.js");
                  return { Component: t };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: t } = await import("./page-C31hPMOs.js");
                  return { Component: t };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: t } = await import("./page-Ads6U7ik.js");
                  return { Component: t };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-C2LUK1sB.js");
                  return { Component: t };
                },
                loader: za
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: t } = await import("./page-cmhlKKOg.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-CjB_Ek8-.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-C6k0qEvB.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: t } = await import("./page-Dmb43aTo.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: t } = await import("./page-Iz7j82Us.js");
                  return { Component: t };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: t } = await import("./page-CYcMOft3.js");
                  return { Component: t };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: t } = await import("./page-Lc_JI6LG.js");
                          return { Component: t };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: t } = await import("./page-J__BNuWh.js");
                          return { Component: t };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: t } = await import("./page-C4RBG91O.js");
                  return { Component: t };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: t } = await import("./page-D74u6Nnk.js");
                  return { Component: t };
                }
              }
            ]
