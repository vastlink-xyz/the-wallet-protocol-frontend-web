...
import { C as y } from "./index-3rWate4W.js";
import { ae as C, c as l, B as g, L as T, f as v, h as P, ag as B, a as S, t as E, a4 as I } from "./main-COWkWeS2.js";
import { L as M } from "./index-D56WlHL9.js";
import { u as A } from "./useTransaction-CgxDhq0R.js";
import { r as d, b as O, m as R } from "./vendor-react-CuOkI7kW.js";
import { u as V, B as j } from "./vendor-utils-DMWa-Mp_.js";
import { X as $ } from "./vendor-ui-utils-2_WY-nJY.js";
import { u as w } from "./vendor-web3-DDgB3Js4.js";
import { D as L } from "./dialog-CIWwhWGs.js";
import { B as k } from "./index-06GKtG4d.js";
import { C as U } from "./index-Beee2VQg.js";
const W = ({ isOpen: s, onClose: r, product: i, balance: a }) => {
  const x = C(), [n, o] = d.useState(!1), { signTransaction: m, waitForTransactionExection: c } = A(), { t: u } = V(), h = i.discount ? i.price * (1 - i.discount / 100) : i.price, b = async () => {
    if (w(a) < w(String(h))) {
...
function ne() {
  const { productId: s } = R(), [r, i] = d.useState(""), [a, x] = d.useState(null), [n, o] = d.useState(!1), [m, c] = d.useState({
    title: "",
    buttonText: "",
    redirectUrl: "",
    description: "",
