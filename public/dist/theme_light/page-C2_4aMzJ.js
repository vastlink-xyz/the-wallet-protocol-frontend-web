...
import { c as p, v as z, g as C, j as B, w as k } from "./main-aLpcFRdZ.js";
import { S as I, P as M } from "./ProductList-Cnl6hcNt.js";
import { u as O } from "./MarketplaceProvider-CCBnEQPv.js";
import { j as S, b as E } from "./vendor-ui-utils-DB1608yX.js";
import { u as F, B as _ } from "./vendor-utils-y1QZaLEY.js";
import { E as D } from "./index-fnWk4Gz8.js";
const L = [
  "Most popular",
  "Free",
  "Latest",
...
function G({
  ...
  const { checkNewProducts: h, hasNewProducts: l } = O(), i = T(), m = L, [o, x] = a.useState(!1), [r, v] = a.useState(!1), n = a.useRef(null), [j, g] = a.useState(!1), b = a.useRef(0), f = () => {
    const e = n.current;
    if (e) {
