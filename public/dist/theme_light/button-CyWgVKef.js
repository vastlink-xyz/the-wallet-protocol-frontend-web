import { r as d, p as W, R as g } from "./vendor-react-wyPiRY-L.js";
import { aw as Ht, at as Ve, z as Bt, ax as Rt, ay as Ot, az as _t, w as ie, ar as Je, aA as wt, aB as xe, q as I, p as ae, aC as Qe, r as $e, aD as Lt, aE as Nt, A as Ke, an as Pt, ao as It, P as Ze, O as ke, _ as Z, Q as se, aF as fe, T as Dt, y as re, aG as jt, aH as zt, $ as Tt } from "./main-CPzCMQxT.js";
import { o as Mt } from "./CheckOutlined-BMJAqmnV.js";
import { f as et, a as At, h as Wt, u as Gt, c as Vt } from "./index-BFYmRswb.js";
import { _ as ne } from "./vendor-ui-utils-BbSwUILz.js";
import { q as L, r as tt, p as A, _ as Ft } from "./vendor-web3-CFt7IwTK.js";
const io = (e, t) => {
...
const Qr = {
  ...
  const {
    ...
    direction: D,
    button: f
  } = d.useContext(ae), X = (r = j ?? (f == null ? void 0 : f.autoInsertSpace)) !== null && r !== void 0 ? r : !0, $ = U("btn", s), [Le, vt, bt] = Mr($), pt = d.useContext(Tt), J = S ?? pt, Ct = d.useContext(it), ee = d.useMemo(() => Jr(a), [a]), [q, Ne] = d.useState(ee.loading), [ue, Pe] = d.useState(!1), Q = xe(t, /* @__PURE__ */ d.createRef()), Ie = d.Children.count(B) === 1 && !y && !oe(N);
  d.useEffect(() => {
    let R = null;
