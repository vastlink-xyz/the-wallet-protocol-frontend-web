...
import { C as w } from "./index-B4x5zB6j.js";
import { c as t, B as u, g as j, j as y, a as C, T as B } from "./main-aLpcFRdZ.js";
import { C as E } from "./checkbox-BCqJTYP3.js";
import { u as P } from "./useTransaction-Db6jmW6G.js";
import { r as x, b as S, m as T } from "./vendor-react-U4DfHahV.js";
import { u as I, B as b } from "./vendor-utils-y1QZaLEY.js";
import { X as A } from "./vendor-ui-utils-DB1608yX.js";
import { p as k } from "./vendor-web3-BOznxXNv.js";
import { D as M } from "./dialog-C8TKAoO2.js";
import { B as v } from "./index-DrQ9bDzQ.js";
import { C as z } from "./index-BpteYW_5.js";
function O() {
...
const R = ({ isOpen: s, onClose: i, product: n, balance: a }) => {
  const [l, r] = x.useState(!1), { signTransaction: h, waitForTransactionExection: f } = P(), { t: d } = I(), m = n.discount ? n.price * (1 - n.discount / 100) : n.price, c = async () => {
    if (k(a) < k(String(m))) {
...
function ee() {
  const { productId: s } = T(), [i, n] = x.useState(""), [a, l] = x.useState(null), [r, h] = x.useState(!1);
  x.useEffect(() => {
    f();
  }, [s]);
  const f = async () => {
    ...
    const c = C.all().address, o = await B.getInstance().createToken("TVWT").getBalance(c);
    n(o);
  }, m = () => {
    h(!0);
  };
