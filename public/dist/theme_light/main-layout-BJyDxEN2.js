...
import { a as Fa, c as et, l as Wl, B as Qs, u as Os, D as Zl, b as Gl, d as _l, e as vr, f as As, h as js, S as Fs, g as Pl, G as Ls, t as Yl, i as Hs } from "./main-CeYGBtxc.js";
import { k as CA, l as Ml, L as Ns, a as k, b as Us, r as DA, p as Ql, O as zs } from "./vendor-react-DSEtE0wE.js";
import { u as Ol, B as Ws } from "./vendor-utils-BPVAmMsZ.js";
import { X as Zs } from "./vendor-ui-utils-CGOon9_P.js";
import { W as Xl, V as Gs } from "./index-Dk-gTRE_.js";
import { S as _s } from "./SendButton-wlMFU0zI.js";
import { W as Ys, M as Xs } from "./MarketplaceProvider-BcAGnSpg.js";
...
function Vl({
  ...
  const { i18n: c } = Ol(), [g, m] = k.useState(!1);
  k.useEffect(() => {
    const P = Wl.getData();
...
function Js() {
  const { t: f } = Ol(), [c, g] = k.useState(!1), m = Fa.isAuthenticated(), A = Ml(), { pathname: w } = CA(), { data: P } = Os(), [E, y] = k.useState("");
  k.useEffect(() => {
    ...
    for (var S in h) if (B.call(h, S)) {
      ...
      if (j != null && typeof j != "boolean" && j !== "") {
        if (S.indexOf("--") === 0) {
          ...
          M = S;
          var z = Se.get(M);
          z !== void 0 || (z = C(Z(M.replace(ne, "-$1").toLowerCase().replace(te, "-ms-"))), Se.set(M, z)), M = z, j = typeof j == "number" ? j === 0 || B.call(X, S) ? y("" + j) : y(j + "px") : y(Z(("" + j).trim()));
        }
...
` + o.stack;
    ...
    var Da = g.ReactCurrentDispatcher, xo = g.ReactDebugCurrentFrame, Pa = 0, Zr = 1, ka = 2, Ba = 3, Ta = 4, Gr = 0, mi = 1, ur = 2, tA = 12800;
    function ul(e) {
    ...
    var rA = {}, Bo = {}, bi = {}, oA = {}, Si = !1, To = {}, xi = !1, Ei = !1, Ci = !1;
    function aA(e, t, n, o) {
      var l;
...
` && r.push(yn), o;
    ...
    function Ri(r, e, t, n) {
      ...
      return B(r, t), B(r, QA), B(r, e.segmentPrefix), B(r, o), Q(r, Ii);
    }
...
` + n.stack;
    ...
    var ka = g.ReactCurrentDispatcher, Ba = g.ReactDebugCurrentFrame, Ta = 0, Gr = 1, mi = 2, ur = 3, tA = 4, ul = 0, _r = 1, Yr = 2, cl = 12800;
    function dl(r) {
...
}, nu = (f, c) => /* @__PURE__ */ k.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 32, height: 32, viewBox: "0 0 42 42", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { style: {
  fill: "none",
  strokeWidth: 2,
  strokeLinecap: "butt",
...
const iu = "data:image/svg+xml;base64,", Au = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 0 637 637", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "m478 113-13 2-4 1h4l14-2c10-2 35-2 42-1l6 3 3 1c3 0-4-3-8-5-7-1-34-1-44 1m56 6 8 6c7 5 20 17 20 19s7 12 8 12l-3-6-4-6c0-3-15-17-25-24-5-3-8-4-4-1m-198 16-9 1a512 512 0 0 1 9-1m-180 30a412 412 0 0 0-23 4 167 167 0 0 0-32 8 439 439 0 0 1 46-9 304 304 0 0 1 11-2l6-1h-8m369 8 4 3-7-6c-1 0 0 2 3 3m-439 9c-7 3-18 13-18 15l6-5c5-5 9-8 14-10l6-4-8 4m442 12-10 11-7 6 7-6c7-5 14-14 13-16l-3 5M65 205l-1 11c0 9 0 10 4 17 5 10 7 12 22 11 10 0 15 0 38-5l5-1-6 1-16 2-21 2c-13 1-16-1-21-10-3-5-4-6-4-15l1-12c1-4 1-5-1-1m335 1c3 0 3 1 3 3l-2 6c-2 5-35 39-76 80-53 51-120 117-138 137-21 24-22 25-22 27 0 3 6 9 9 9 4 0 14-8 38-27a5073 5073 0 0 1 15-16 1421 1421 0 0 0-17 15l-31 25-6 2-4-3c-3-3-3-4-2-6 3-8 79-85 160-163 57-57 79-80 79-86 0-2-3-4-7-4-2 0-2 0 1 1m165 18c-9 17-25 32-57 53l-10 8 16-11 12-8c15-10 27-22 39-39 5-7 6-8 4-8l-4 5m-221 2a199 199 0 0 0-19 10 183 183 0 0 1 27-12c0-1-1-1-8 2m-34 16c-3 3-2 3 2 0l1-2-3 2m151 3-1 2 2-2c3-3 2-3-1 0m-16 12-11 10a281 281 0 0 0 11-10m-24 18-7 5-7 5-42 31c-10 7-24 19-22 19l7-6 16-12a343 343 0 0 0 35-25 573 573 0 0 0 20-17m-187 0-2 2 4-2 3-2-5 2m-14 6-3 2 4-1 4-3-5 2m-7 3-8 4-18 8 18-7 7-3 3-1c1-2 0-2-2-1m254 24a2672 2672 0 0 1-71 54 601 601 0 0 0 39-29 1352 1352 0 0 1 32-25m-291-8-2 2 4-2 3-2-5 2m-13 5-2 2h3c5-3 4-4-1-2m-19 9-7 3-13 6c-10 5-13 7-14 10-3 4-2 5 1 0 2-3 5-5 14-9l13-6 12-6-6 2m178 36c-17 12-21 16-21 17a390 390 0 0 1 20-17m-206 34 1 4 1 3 1 5 2 8 1 5v-6l-1-8-2-5-1-4-1-2c-1-2-1-2-1 0m222 23-9 7a683 683 0 0 0-56 44 261 261 0 0 0-26 20 1345 1345 0 0 0-46 34c-6 3-7 3-19 3-11 0-12 0-18-3-8-4-10-8-17-20l-5-10 4 10c5 10 12 18 19 22 4 2 6 2 17 2 13 0 14 0 21-3l26-19 42-33a2183 2183 0 0 0 43-34 643 643 0 0 1 24-20", fill: "#fff", fillRule: "evenodd" }), /* @__PURE__ */ k.createElement("path", { d: "M478 114a620 620 0 0 1-39 6l-21 3a5481 5481 0 0 0-19 3 870 870 0 0 1-54 8l-1 1-6 1-12 2-13 2a992 992 0 0 0-76 12 400 400 0 0 1-45 8l-6 1-5 1h-3l-3 1-2 1-26 4-13 2-17 3c-23 5-33 9-43 19-7 8-9 13-9 27 0 8 1 9 4 14 5 9 8 11 21 10l21-2a1133 1133 0 0 1 23-4 659 659 0 0 0 74-14l3-1h3l3-1h3l2-1 2-1h3l2-1h2l24-5 38-7a2100 2100 0 0 1 93-18l3-1 10-1a2082 2082 0 0 1 120-17l2 1c2 0 8 5 8 7l1 2 1 6c0 4 0 6-3 10-2 4-16 16-18 16l-7 5-10 8a1070 1070 0 0 0-11 7 113 113 0 0 1-20 14l-2 2-3 2-2 2h-1a154 154 0 0 1-28 21l-5 4-5 4a573 573 0 0 1-50 37 175 175 0 0 0-24 18l-1 2-2 1-2 1-2 1-1 1-12 10a396 396 0 0 0-32 25l-8 6-6 5-9 7a326 326 0 0 1-25 20l-13 12a5073 5073 0 0 0-17 15c-24 20-34 27-39 27-2 0-8-6-8-9 0-2 1-3 22-27 18-20 85-86 138-137 41-41 74-75 76-80l2-6c0-2 0-3-2-3l-7 1a233 233 0 0 1-26 9l-1 1-1 1h-1l-1 1h-2l-3 2-1 1h-2l-3 2h-1l-5 2-22 10-9 4-4 2-5 2-10 4-2 1-2 1-2 1-13 6a334 334 0 0 1-38 17 75 75 0 0 0-14 6l-5 2-4 1-2 1-3 2-7 3-16 6a247 247 0 0 0-32 14l-1 1h-2l-1 1h-2l-1 1-12 6a103 103 0 0 0-27 15l-2 5-1 1v11l1 5 1 5 1 4c0 3 0 4 2 4v3l1 3 1 2 2 10 1 4 1 5 2 10 2 8 1 4 1 4c3 3 9 25 11 38l1 7v2l1 4v1l1 1v2l1 2 1 3v1l5 10c7 13 9 16 17 20 6 3 7 3 18 3 12 0 13 0 19-3 8-4 11-6 26-18a1345 1345 0 0 1 85-67 683 683 0 0 1 50-39l12-9a513 513 0 0 1 44-33 201 201 0 0 0 22-17 2270 2270 0 0 0 73-54 158 158 0 0 0 58-59c2 0 3-9 4-27l-1-19-1-4-1-6-1-3-4-6-4-6c0-2-6-8-13-14a77 77 0 0 0-28-18c-6-1-34-1-43 1" })), ts = k.forwardRef(Au), lu = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "M765-321q0 117-84 196-83 80-200 80-118 0-200-80t-83-196v-392q0-85 61-144 61-58 146-58 86 0 147 58 61 59 61 144v374q0 54-39 92-39 37-93 37-55 0-93-37-38-38-38-92v-372h110v372q0 9 6 14t15 5q8 0 15-5t7-14v-374q0-39-29-66t-68-27q-40 0-69 27t-29 66v392q0 71 51 119t122 48q71 0 122-48t51-119v-426h111v426Z" })), ns = k.forwardRef(lu), su = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "M125-165v-113h77v-273q0-93 55-167 56-75 146-100v-19q0-32 22-55 23-23 55-23t55 23q22 23 22 55v19q90 25 146 99 56 73 56 168v273h77v113H125ZM480-32q-38 0-66-27-27-27-27-66h186q0 39-27 66t-66 27Z" })), uu = k.forwardRef(su), cu = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "M137-190v-113h78v-253q0-41 11-79 11-39 35-71l-9 150h10L17-802l74-74L873-92l-74 74-175-172H137Zm609-149L319-769q20-15 41-25t44-16v-28q0-32 22-54t54-22q32 0 55 22t22 54v28q85 23 137 94t52 160v217ZM481-47q-38 0-65-27t-27-65h184q0 38-27 65t-65 27Z" })), du = k.forwardRef(cu), fu = (f, c) => /* @__PURE__ */ k.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", ref: c, ...f }, /* @__PURE__ */ k.createElement("g", { strokeLinecap: "round", strokeWidth: 10 }, /* @__PURE__ */ k.createElement("path", { d: "m19 19 61 61M80 19 19 80" }))), hu = k.forwardRef(fu), pu = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "M94-136v-255l351-93-351-92v-253l816 346L94-136Z" })), vu = k.forwardRef(pu), gu = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "M480-372q-61 0-105-43-43-43-43-105v-240q0-61 43-105 43-43 105-43 61 0 105 43 43 44 43 105v240q0 62-43 105t-105 43ZM425-76v-122q-121-16-197-108t-76-214h109q0 91 64 154t155 63q91 0 155-63t64-154h109q0 122-77 214T534-198v122H425Z" })), mu = k.forwardRef(gu), yu = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "m763-343-80-79q8-20 13-44 5-23 5-54h109q0 49-11 95t-36 82ZM625-482 336-770v-2q3-56 45-96t101-40q62 0 105 43t43 105v249l-1 17q-1 7-4 12ZM427-76v-122q-120-16-196-108-77-92-77-214h109q0 91 64 154t155 63q43 0 80-14 37-15 67-41l78 79q-35 32-78 53t-93 28v122H427Zm362 27L41-796l75-75 748 748-75 74Z" })), wu = k.forwardRef(yu), bu = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "M625-511q29 0 50-21t20-50q0-29-20-50-21-20-50-20t-50 20-20 50q0 29 20 50 21 21 50 21Zm-290 0q29 0 50-21t20-49q0-30-20-50t-50-21q-29 0-50 20-20 21-20 50 0 30 20 50 21 21 50 21Zm145 268q75 0 137-43t85-115H258q24 72 85 115 62 43 137 43Zm0 198q-90 0-170-34-79-34-138-93T79-310q-34-80-34-170t34-170q34-79 93-138t138-93q80-34 170-34t170 34q79 34 138 93t93 138q34 80 34 170t-34 170q-34 79-93 138T650-79q-80 34-170 34Zm0-435Zm0 322q134 0 228-94t94-228q0-134-94-228t-228-94q-134 0-228 94t-94 228q0 134 94 228t228 94Z" })), rs = k.forwardRef(bu), Su = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "M553-64v-108q107-27 173-113 67-87 67-197 0-109-67-195T553-789v-108q152 26 249 144 97 117 97 271 0 155-97 273T553-64ZM61-335v-290h176l236-237v764L237-335H61Zm492 28v-346q51 23 82 70t31 103-31 103q-31 47-82 70Z" })), xu = k.forwardRef(Su), Eu = (f, c) => /* @__PURE__ */ k.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ k.createElement("path", { d: "M807-15 700-123q-33 21-71 37-38 15-80 22v-108q20-4 38-12l35-17-153-154v257L234-335H57v-290h144L10-818l74-75L882-90l-75 75Zm37-264-80-79q13-30 19-60 7-31 7-64 0-109-68-195-67-86-173-112v-108q152 26 249 144 98 117 98 271 0 55-14 107-13 51-38 96ZM661-462 549-575v-78q51 23 83 70 31 47 31 103l-1 9-1 9ZM469-655 366-759l103-103v207Z" })), Cu = k.forwardRef(Eu), Du = "data:audio/wav;base64,", ls = {
...
}, ss = k.createContext({ settings: {}, setSettings: () => null }), De = () => k.useContext(ss), Pu = ({
  children: f,
  settings: c = ls,
  setSettings: g
...
}, cs = k.createContext({ styles: {}, setStyles: () => null }), Ye = () => k.useContext(cs), ku = ({
  children: f,
  styles: c = us,
  setStyles: g
...
}, ds = k.createContext({}), bt = () => k.useContext(ds), Tu = ({
  children: f,
  botIdRef: c,
  flowRef: g
}) => {
...
}, fs = k.createContext({}), gt = () => k.useContext(fs), Iu = ({
  children: f,
  settings: c
}) => {
  var g, m, A, w, P, E;
  ...
  ), [K, re] = k.useState(!1), [X, G] = k.useState(!1), [$, Z] = k.useState(!0), [ne, te] = k.useState(!1), [Ae, ae] = k.useState(!1), [ce, ve] = k.useState(!1), [de, Me] = k.useState(0), [Ce, ee] = k.useState(0), [se, fe] = k.useState(!1), [be, oe] = k.useState(null), [me, Oe] = k.useState(((P = window.visualViewport) == null ? void 0 : P.height) ?? window.innerHeight), [Se, le] = k.useState(((E = window.visualViewport) == null ? void 0 : E.width) ?? window.innerWidth);
...
}, hs = k.createContext({ paths: [], setPaths: () => null }), jl = () => k.useContext(hs), Qu = ({ children: f }) => {
...
}, ps = k.createContext({ toasts: [], setToasts: () => null }), vs = () => k.useContext(ps), ju = ({ children: f }) => {
  const [c, g] = k.useState([]);
  return /* @__PURE__ */ b.jsx(ps.Provider, { value: { toasts: c, setToasts: g }, children: f });
}, kA = () => {
  const { settings: f } = De(), { toasts: c, setToasts: g } = vs(), { callRcbEvent: m } = Wn(), A = k.useRef(c);
  k.useEffect(() => {
    A.current = c;
  }, [c]);
...
}, gs = k.createContext({ messages: [], setMessages: () => null }), Fl = () => k.useContext(gs), Lu = ({ children: f }) => {
  const [c, g] = k.useState([]);
  ...
  const { settings: L } = De(), { styles: _ } = Ye(), { paths: F } = jl(), { handleSubmitText: T } = Ha(), [K, re] = k.useState(/* @__PURE__ */ new Set()), [X, G] = k.useState(!1), $ = {
  ...
  var g, m, A, w, P, E;
  const { settings: y } = De(), { styles: C } = Ye(), { paths: H } = jl(), { handleSubmitText: B } = Ha(), [Q, U] = k.useState([]), [L, _] = k.useState(!1), F = {
    ...
    return /* @__PURE__ */ b.jsx(
      "div",
      {
        ...
        onMouseDown: (Z) => {
          ...
          _(!f.reusable);
          let te;
          f.sendOutput != null ? te = f.sendOutput : te = ((ne = y.chatInput) == null ? void 0 : ne.sendOptionOutput) ?? !0, B(X, te);
        },
        children: X
      },
      X
...
const wA = async (f) => {
...
}, Ac = (f) => k.isValidElement(f.content) ? structuredClone({
  id: f.id,
    ...
    try {
      ...
      setTimeout(() => {
        m((C) => {
          ...
          C.shift();
          let B;
          return (H = f.chatHistory) != null && H.autoLoad ? B = Oo(/* @__PURE__ */ b.jsx(b.Fragment, {}), "system") : B = Oo(/* @__PURE__ */ b.jsx(tc, {}), "system"), [...y, B, ...C];
        });
      }, 500), setTimeout(() => {
        if (!A.current)
          return;
  ...
  const { settings: A } = De(), { messages: w, setMessages: P } = Fl(), {
    ...
    setIsBotTyping: H,
    setUnreadCount: B
  } = gt(), { streamMessageMap: Q, chatBodyRef: U } = bt(), { callRcbEvent: L } = Wn(), { playNotificationSound: _ } = Ll(), F = k.useCallback(async (Z, ne, te) => {
    H(!1), P((ve) => {
      const de = [...ve, Z];
      return $(de), de;
  ...
  }, [w, Q]), T = k.useCallback(async (Z, ne = "bot") => {
  ...
  }, [L, w, (f = A.event) == null ? void 0 : f.rcbRemoveMessage]), re = k.useCallback(async (Z, ne = "bot") => {
    var te, Ae;
    if (!Q.current.has(ne)) {
      const ce = Oo(Z, ne);
      return (te = A.event) != null && te.rcbStartStreamMessage && L(Ee.START_STREAM_MESSAGE, { message: ce }).defaultPrevented ? null : (H(!1), P((ve) => {
        const de = [...ve, ce];
        return $(de), [...ve, ce];
      }), B((ve) => ve + 1), Q.current.set(ne, ce.id), ce.id);
    }
...
const Hl = () => {
  ...
  C.onresult = (Q) => {
    ...
    Un = setTimeout(() => Bl(c, w), H), (L = f.voice) != null && L.autoSendDisabled || (bA = setTimeout(g, B));
  }, C.onend = () => {
  ...
  const { settings: A } = De(), { endStreamMessage: w, injectMessage: P, removeMessage: E, streamMessage: y } = BA(), { getCurrPath: C, getPrevPath: H, goToPath: B } = PA(), {
    ...
    setInputLength: re
  } = gt(), { flowRef: X, chatBodyRef: G, inputRef: $, keepVoiceOnRef: Z, paramsInputRef: ne } = bt(), { showToast: te, dismissToast: Ae } = kA(), { callRcbEvent: ae } = Wn(), { syncVoice: ce } = Ul(), { setTextAreaValue: ve } = La(), { openChat: de } = gr(), Me = k.useCallback(async (ee) => {
    var se, fe, be;
    const oe = C();
    if (!(!oe || !X.current[oe])) {
      if (_) {
  ...
  const Q = TA(), { settings: U } = De(), { styles: L } = Ye(), {
    ...
    setInputLength: X
  } = gt(), { inputRef: G } = bt(), [$, Z] = k.useState(!1), [ne, te] = k.useState(!1), { handleSubmitText: Ae } = Ha(), { setTextAreaValue: ae } = La(), ce = {
  ...
  var f, c, g, m, A, w;
  const { settings: P } = De(), { styles: E } = Ye(), { injectMessage: y, streamMessage: C, removeMessage: H, endStreamMessage: B } = BA(), { getCurrPath: Q, getPrevPath: U, goToPath: L, blockAllowsAttachment: _ } = PA(), { flowRef: F, inputRef: T } = bt(), K = F.current, { showToast: re, dismissToast: X } = kA(), { callRcbEvent: G } = Wn(), { openChat: $ } = gr(), { setTextAreaValue: Z } = La(), { handleSubmitText: ne } = Ha(), te = {
  ...
  k.useEffect(() => {
    const G = (ne) => {
      ...
      B.current && !te.includes(B.current) && Q.current && !te.includes(Q.current) && L(!1);
    }, $ = () => {
      if (B.current && Q.current) {
        const ne = Q.current.getBoundingClientRect(), te = B.current.offsetHeight, Ae = ne.top - te - 8;
        B.current.style.left = `${ne.left}px`, B.current.style.top = `${Ae}px`;
      }
    }, Z = () => {
      $();
    };
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { injectMessage: w } = BA(), { inputRef: P } = bt(), { voiceToggledOn: E, toggleVoice: y } = Ul(), { setInputLength: C, setTextAreaValue: H, textAreaDisabled: B } = La(), { handleSubmitText: Q } = Ha(), U = k.useRef([]), [L, _] = k.useState(!1);
  k.useEffect(() => {
    var G;
...
}, Mc = () => /* @__PURE__ */ b.jsx(Cc, {}), Qc = () => /* @__PURE__ */ b.jsx(kc, {}), Oc = () => /* @__PURE__ */ b.jsx(Dc, {}), jc = () => /* @__PURE__ */ b.jsx(Bc, {}), Fc = () => /* @__PURE__ */ b.jsx(Tc, {}), Lc = () => /* @__PURE__ */ b.jsx(Sc, {}), Hc = () => /* @__PURE__ */ b.jsx(xc, {}), Nc = () => {
  ...
  }), []), { header: g, chatInput: m, footer: A } = k.useMemo(() => Rc(f, c), [f, c]), w = k.useMemo(() => g, [g]), P = k.useMemo(() => m, [m]), E = k.useMemo(() => A, [A]);
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { showChatHistory: w } = Ds(), [P, E] = k.useState(!1), y = {
    color: (f = m.general) == null ? void 0 : f.primaryColor,
    borderColor: (c = m.general) == null ? void 0 : c.primaryColor,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ b.jsxs("div", { style: re(), className: "rcb-chat-window", children: [
          ...
          /* @__PURE__ */ b.jsx(Hu, { setChatScrollHeight: B }),
  ...
  let F = {};
  _.ok ? F = await _.json() : console.info(`Could not fetch styles.json from ${H}`), Xc(g, P, L, F, B);
  const T = as(f, B);
...
`), ks = () => Bs(ls), Jc = () => Bs(us), Kc = async (f, c, g, m) => {
  var A, w;
  let P = ks(), E = Jc(), y = "";
  if (m != null)
    if (Array.isArray(m))
  ...
  return c;
}, Ts = k.createContext(void 0), Is = () => k.useContext(Ts), $c = ({
  children: f
}) => {
  var c;
  ...
  const y = k.useMemo(() => f, []), C = Is(), { flowRef: H } = bt();
  ...
  const P = k.useMemo(() => f || "rcb-" + SA(), []), E = !c || Object.keys(c).length === 0 ? ed : c, y = g || {}, C = m || {}, H = w || [], [B, Q] = k.useState(!1), U = Is(), L = k.useRef(null), [_, F] = k.useState(A || []);
  k.useEffect(() => {
    A && F(A);
  }, [A]);
