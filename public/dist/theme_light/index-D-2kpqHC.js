...
import { D as f, a as b, b as g, c as W, d as N, e as M } from "./dialog-CimelOdQ.js";
import { c as T, I as E, B as m, g as x, L as y } from "./main-D5sRvz5I.js";
import { u as k } from "./MarketplaceProvider-Dy1SitKL.js";
import { r as h, k as R } from "./vendor-react-BA5A8Axg.js";
import { u as w } from "./vendor-utils-7AahqLO2.js";
function A({
  onPair: l,
  isModalOpen: d,
  dappInfo: o,
...
function U({ className: l, buttonClassName: d }) {
  const { t: o } = w(), { isAuthenticated: n, isConnected: c, handleConnect: a } = k(), i = R();
  return /* @__PURE__ */ e.jsx(
    "div",
    {
      className: T([
