import { j as e, E as V, F as z, G, H as Q } from "./vendor-radix-DUwj-Z7L.js";
import { a as o, j as H } from "./vendor-react-DV6Kf_ot.js";
import { a as J, ae as K, c as y, af as X, ag as Y, B as v, n as Z, V as ee, f as O, t as te, L as ae, g as A, ah as se, o as ne, m as ie, h as oe, ai as re } from "./main-DvSwU80m.js";
import { u as le, B as u } from "./vendor-utils-24jm1iP0.js";
import { u as ce } from "./useTransaction-BzsoDgir.js";
import { S as de, A as me } from "./vendor-ui-utils-C4kABIJo.js";
import { k as fe } from "./vendor-web3-DfGKzT89.js";
import { u as xe, a as pe } from "./MarketplaceProvider-BWPbWWvl.js";
function Re({
  text: r,
...
function Ie({
  ...
  const { t: n } = le(), [t, f] = o.useState(!1), [p, g] = o.useState(!1), [w, j] = o.useState(""), [b, k] = o.useState(""), [a, m] = o.useState(!1), h = o.useRef(), N = o.useRef(), { signTransaction: E, waitForTransactionExection: ye } = ce(), [L, C] = o.useState(!1), [M, S] = o.useState(!1), [T, B] = o.useState(null);
  o.useEffect(() => {
    F();
  }, []);
  const F = async () => {
    ...
    k(x);
  }, R = async (s) => (await O.get(`/thirdparty/sign-moonpay-params?url=${encodeURIComponent(s)}`)).data.signature, D = () => {
    l(!1), f(!1), g(!1);
  }, I = async (s) => {
    if (m(!1), await W()) {
      const c = te.getToken(s.cryptoCurrency.code.toUpperCase());
        ...
        /* @__PURE__ */ e.jsxs("div", { className: "mt-4 flex justify-end", children: [
          ...
          /* @__PURE__ */ e.jsx(
            v,
            {
              ...
              disabled: a,
              children: a ? /* @__PURE__ */ e.jsx(ae, {}) : n("/marketplace.moonpayRamp.depositConfirmation.confirmButton")
            }
          )
        ] })
      ] }),
  ...
  async function $(s) {
    try {
      ...
      const x = await E({
        ...
        amount: c,
        token: i,
        transactionType: se.SELL,
        data: ""
      });
      if (x != null && x.needOtp && ne.getVerifyMethod() === "email-by-sendgrid") {
        B(x.transactionId), C(!0);
        return;
      }
  ...
  const _ = async (s) => {
    ...
    try {
      S(!0);
      const { hash: i } = await ie.signTransactionWithOTP({
        transactionId: T,
        otp: s
      });
      i && (C(!1), u.success("Transaction submitted successfully"));
    } catch (i) {
      const c = oe(i);
      u.error(c.message);
    } finally {
...
const ue = z, he = G, ge = Q, U = o.forwardRef(({ className: r, sideOffset: d = 4, ...l }, n) => /* @__PURE__ */ e.jsx(
  V,
  {
    ref: n,
    sideOffset: d,
...
const be = ({
  ...
  const l = H(), n = re(), t = o.useRef(null), {
    setIsModalOpen: f,
    setDappInfo: p,
    isConnected: g,
  ...
  return {
    handleClick: async (a) => {
      ...
      if (t.current = window.setTimeout(async () => {
        try {
          await O.post("/user/products/update-usage-status", {
            productId: a.id
