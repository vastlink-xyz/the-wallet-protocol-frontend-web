...
import { l as C, k as A, r as i } from "./vendor-react-BA5A8Axg.js";
import { B as n, a as O } from "./vendor-utils-DbEkyxvy.js";
import { f as o, g as V, B as f, L as u, a as U, h as E, o as W } from "./main-D4-Rhh9a.js";
import { L as b } from "./index-HmKfL7_P.js";
import { k as Y } from "./vendor-web3-DbPIok2u.js";
function J() {
  const [l] = C(), x = A(), [p, I] = i.useState(!1), [h, g] = i.useState(!1), [j, v] = i.useState(!1), [w, y] = i.useState(!1), [t, S] = i.useState(), [m, k] = i.useState("PENDING"), [T, R] = i.useState("");
  i.useEffect(() => {
    G();
  }, [l]), i.useEffect(() => {
    t && k(t.status);
