...
import { l as w, k, a as o } from "./vendor-react-BdtkaT_f.js";
import { g as m, T as C, B as d, L as u, q as S, f as h } from "./main-CDK5RuLO.js";
import { B as R } from "./vendor-utils-CISROZyj.js";
import { u as B } from "./useTransaction-DDcs0bde.js";
import { f as x } from "./vendor-web3-CfO0z015.js";
function A() {
  const [i] = w(), p = k(), { signTransaction: g, waitForTransactionExection: I } = B(), [e, v] = o.useState(), [r, T] = o.useState("PENDING"), [c, l] = o.useState(!1), j = o.useRef();
  o.useEffect(() => {
    y();
  }, [i]), o.useEffect(() => {
    e && T(e.status);
