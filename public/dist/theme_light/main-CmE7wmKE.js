...
import { j as u, S as Jn, d as Ks, g as $s, P as ea, C as Vs, I as Gs, i as Ys, k as Xs, l as Zs, L as Js, m as en, n as ta, T as sa, o as tn, p as sn, q as nn, r as na } from "./vendor-radix-nT--cb5B.js";
import { p as ze, a as an, r as v, b as rn, R as H, O as aa, u as ra, e as ia, f as oa } from "./vendor-react-CwfAKKXk.js";
import { t as la, c as ca, C as ua, a as da, b as ha, d as fa, e as pa, X as on, L as ma, f as Dt, g as ln, h as ya, i as ga, j as ba, I as va } from "./vendor-ui-utils-Cm_-IfYd.js";
import { a as it, u as is, C as xa, B as ve, Q as wa, X as Ca, i as cn, b as Ea, I as Sa } from "./vendor-utils-BMKgA_3H.js";
import { d as un, c as mt, h as Tt, e as Aa, C as xs, f as os, E as Ra, m as Ta, a as Na, b as ws, p as jt, i as Cs } from "./vendor-web3-SIldcrZc.js";
    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: t } = await import("./main-layout-CZD-sNHw.js");
          return { Component: t };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: t } = await import("./page-BJA5EWWi.js");
              return { Component: t };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: t } = await import("./page-BjCCjhRj.js");
              return { Component: t };
            }
          },
          {
            ...
            async lazy() {
              const { default: t } = await import("./page-DjTRsIsi.js");
              return { Component: t };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: t } = await import("./page-DUPHeK8j.js");
              return { Component: t };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page--rPC7dPb.js");
                  return { Component: t };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: t } = await import("./page-DFvTu-H1.js");
                  return { Component: t };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: t } = await import("./page-Clp7bXbo.js");
                  return { Component: t };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-CCaH8GQu.js");
                  return { Component: t };
                },
                loader: si
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: t } = await import("./page-C3_sMGoo.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-DASyHW0I.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-DAYSE96-.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: t } = await import("./page-D-I_LNNJ.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: t } = await import("./page-D63lRuM-.js");
                  return { Component: t };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: t } = await import("./page-Dp0B_BwS.js");
                  return { Component: t };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: t } = await import("./page-C9mbkhYp.js");
                          return { Component: t };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: t } = await import("./page-C-20YRGx.js");
                          return { Component: t };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: t } = await import("./page-BHSLXUtT.js");
                  return { Component: t };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: t } = await import("./page-CMGET28Z.js");
                  return { Component: t };
                }
              }
            ]
