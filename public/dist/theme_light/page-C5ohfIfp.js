...
import { N as nt, M as st, O as at, q as ke, m as rt, n as it, v as ot, c as M, g as $e, I as qe, aH as lt, aa as ct, B as _e, t as R, aI as dt, i as je, aJ as Ne, f as Re, j as De, a as ut, aK as ht, ag as ft, aq as pt, aL as ze, a4 as pe, $ as be, h as mt, ad as gt, ar as xt, G as bt, D as vt, b as yt, d as kt, e as wt, aM as _t } from "./main-BMueK7Y5.js";
import { a as S, p as Me, q as Tt, s as jt, e as Et, g as Nt, l as Ge } from "./vendor-react-DSEtE0wE.js";
import { u as Ct, i as He, L as St, f as Ke, g as Fe, T as At, P as It, I as Ot } from "./vendor-ui-utils-CGOon9_P.js";
import { u as Qe, B as Ie } from "./vendor-utils-BPVAmMsZ.js";
import { u as Rt } from "./useTransaction-VHvYAUlZ.js";
import { w as Pe, x as Dt, j as Mt, l as Ft, n as Vt, i as Te, u as Ce } from "./vendor-web3-CQEmmIwE.js";
import { d as $t } from "./index--ryC6Jp2.js";
const Lt = (i) => {
  const {
    componentCls: r,
...
const Je = (i) => {
  const {
    ...
    plain: Z,
    style: B
  } = i, re = Bt(i, ["prefixCls", "type", "orientation", "orientationMargin", "className", "rootClassName", "children", "dashed", "variant", "plain", "style"]), D = r("divider", l), [ee, z, P] = Pt(D), H = !!j, te = b === "left" && m != null, K = b === "right" && m != null, A = it(D, a == null ? void 0 : a.className, z, P, `${D}-${f}`, {
    [`${D}-with-text`]: H,
    [`${D}-with-text-${b}`]: H,
    [`${D}-dashed`]: !!I,
    [`${D}-${F}`]: F !== "solid",
    ...
    [`${D}-no-default-orientation-margin-right`]: K
...
function Wt({
  ...
  const [f, b] = S.useState(!1), [m, c] = S.useState(0), [_, j] = S.useState(!1), I = S.useRef(null), F = S.useRef(null), Z = S.useRef(0), B = () => {
    const z = Date.now();
    z - Z.current >= 1e3 ? (Z.current = z, j(!0), b(!1), $e("onSuccess"), r == null || r()) : (c(0), b(!1));
  }, re = (z, P) => {
    u || a || b(!0);
  }, D = (z) => {
    if (!f || !I.current || !F.current) return;
    const P = I.current, H = F.current, te = P.getBoundingClientRect();
    let K = z - te.left - H.offsetWidth / 2;
    if (z - te.left < H.offsetWidth / 2) {
      c(0);
      return;
    }
    K + H.offsetWidth >= Oe && (K = Oe - H.offsetWidth - 2, B()), c(K);
  }, ee = () => {
    _ || c(0), b(!1);
  };
  return S.useEffect(() => {
    const z = (H) => D(H.clientX), P = (H) => {
      H.preventDefault(), D(H.touches[0].clientX);
    };
...
async function Jt({
  ...
  const f = Kt({ tokenType: i, transferParams: r, fromAddress: u });
  return Qt.getOrCreate(f, async () => {
    const b = Ue.get(f);
    if (b)
      return b.result;
    try {
      ...
      const I = await c.estimateGas({
        ...j,
        account: u
      }), F = a || await c.getGasPrice(), B = (l || await c.getBlock()).baseFeePerGas || BigInt(0), re = F > B ? F - B : BigInt(1e9), D = B + re * BigInt(2), ee = I * D, z = je(
...
(function(i, r) {
  (function(u, a) {
    ...
    var a = typeof self < "u" ? self : typeof window < "u" ? window : a !== void 0 ? a : {}, l = !a.document && !!a.postMessage, f = a.IS_PAPA_WORKER || !1, b = {}, m = 0, c = { parse: function(t, e) {
      ...
      if (A(o) && (e.dynamicTypingFunction = o, o = {}), e.dynamicTyping = o, e.transform = !!A(e.transform) && e.transform, e.worker && c.WORKERS_SUPPORTED) {
        var x = function() {
...
`, '"', c.BYTE_ORDER_MARK], c.WORKERS_SUPPORTED = !l && !!a.Worker, c.NODE_STREAM_INPUT = 1, c.LocalChunkSize = 10485760, c.RemoteChunkSize = 5242880, c.DefaultDelimiter = ",", c.Parser = ee, c.ParserHandle = re, c.NetworkStreamer = I, c.FileStreamer = F, c.StringStreamer = Z, c.ReadableStreamStreamer = B, a.jQuery) {
      var _ = a.jQuery;
    ...
    function j(t) {
      this._handle = null, this._finished = !1, this._completed = !1, this._halted = !1, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = !0, this._completeResults = { data: [], errors: [], meta: {} }, (function(e) {
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          ...
          if (f) a.postMessage({ results: w, workerId: c.WORKER_ID, finished: W });
          else if (A(this._config.chunk) && !o) {
        ...
        A(this._config.error) ? this._config.error(e) : f && this._config.error && a.postMessage({ workerId: c.WORKER_ID, error: e, finished: !1 });
      };
    }
    function I(t) {
      var e;
      (t = t || {}).chunkSize || (t.chunkSize = c.RemoteChunkSize), j.call(this, t), this._nextChunk = l ? function() {
        ...
        if (this._finished) this._chunkLoaded();
          ...
          if (e = new XMLHttpRequest(), this._config.withCredentials && (e.withCredentials = this._config.withCredentials), l || (e.onload = K(this._chunkLoaded, this), e.onerror = K(this._chunkError, this)), e.open(this._config.downloadRequestBody ? "POST" : "GET", this._input, !l), this._config.downloadRequestHeaders) {
    ...
    function F(t) {
      ...
      this.stream = function(v) {
        this._input = v, o = v.slice || v.webkitSlice || v.mozSlice, x ? ((e = new FileReader()).onload = K(this._chunkLoaded, this), e.onerror = K(this._chunkError, this)) : e = new FileReaderSync(), this._nextChunk();
    ...
    function re(t) {
      var e, o, x, v = Math.pow(2, 53), w = -v, T = /^\s*-?(\d+\.?|\.\d+|\d+\.\d+)([eE][-+]?\d+)?\s*$/, W = /^((\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z)))$/, V = this, k = 0, U = 0, E = !1, oe = !1, ne = [], y = { data: [], errors: [], meta: {} };
      if (A(t.step)) {
        var L = t.step;
        t.step = function(s) {
          if (y = s, ae()) q();
      ...
      function q() {
        return y && x && (X("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + c.DefaultDelimiter + "'"), x = !1), t.skipEmptyLines && (y.data = y.data.filter(function(s) {
          ...
          if (!y) return;
          function s(d, p) {
            A(t.transformHeader) && (d = t.transformHeader(d, p)), ne.push(d);
          }
          ...
          function s(d, p) {
            ...
            for (g = 0; g < d.length; g++) {
              var C = g, O = d[g];
              t.header && (C = g >= ne.length ? "__parsed_extra" : ne[g]), t.transform && (O = t.transform(O, C)), O = Y(C, O), C === "__parsed_extra" ? (N[C] = N[C] || [], N[C].push(O)) : N[C] = O;
            }
            return t.header && (g > ne.length ? X("FieldMismatch", "TooManyFields", "Too many fields: expected " + ne.length + " fields but parsed " + g, U + p) : g < ne.length && X("FieldMismatch", "TooFewFields", "Too few fields: expected " + ne.length + " fields but parsed " + g, U + p)), N;
          }
          var h = 1;
      ...
      this.parse = function(s, h, d) {
        ...
        if (t.newline || (t.newline = function(C, O) {
          ...
          var Q = new RegExp(D(O) + "([^]*?)" + D(O), "gm"), ie = (C = C.replace(Q, "")).split("\r"), ue = C.split(`
`), he = 1 < ue.length && ue[0].length < ie[0].length;
          if (ie.length === 1 || he) return `
`;
          for (var le = 0, G = 0; G < ie.length; G++) ie[G][0] === `
` && le++;
          return le >= ie.length / 2 ? `\r
` : "\r";
        }(s, p)), x = !1, t.delimiter) A(t.delimiter) && (t.delimiter = t.delimiter(s), y.meta.delimiter = t.delimiter);
        else {
          var g = function(C, O, Q, ie, ue) {
            var he, le, G, J;
            ...
            for (var ve = 0; ve < ue.length; ve++) {
              ...
              for (var me = new ee({ comments: ie, delimiter: $, newline: O, preview: 10 }).parse(C), ge = 0; ge < me.data.length; ge++) if (Q && se(me.data[ge])) ye++;
                ...
                fe += xe, G !== void 0 ? 0 < xe && (we += Math.abs(xe - G), G = xe) : G = xe;
              }
        ...
        var N = te(t);
        return t.preview && t.header && N.preview++, e = s, o = new ee(N), y = o.parse(e, h, d), q(), E ? { meta: { paused: !0 } } : y || { meta: { paused: !1 } };
      }, this.paused = function() {
        return E;
      }, this.pause = function() {
        E = !0, o.abort(), e = A(t.chunk) ? "" : e.substring(o.getCharIndex());
      }, this.resume = function() {
        V.streamer._halted ? (E = !1, V.streamer.parseChunk(e, !0)) : setTimeout(V.resume, 3);
      }, this.aborted = function() {
        return oe;
      }, this.abort = function() {
        oe = !0, o.abort(), y.meta.aborted = !0, A(t.complete) && t.complete(y), e = "";
      };
    }
    function D(t) {
      return t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    ...
    function ee(t) {
      var e, o = (t = t || {}).delimiter, x = t.newline, v = t.comments, w = t.step, T = t.preview, W = t.fastMode, V = e = t.quoteChar === void 0 || t.quoteChar === null ? '"' : t.quoteChar;
...
`);
      ...
      this.parse = function(E, oe, ne) {
        ...
        var y = E.length, L = o.length, se = x.length, q = v.length, ae = A(w), Y = [], X = [], s = [], h = k = 0;
        if (!E) return ce();
        if (t.header && !oe) {
          ...
          for (var C in d) {
            ...
            var Q = O, ie = g[O] || 0;
            for (0 < ie && (N = !0, Q = O + "_" + ie), g[O] = ie + 1; p.includes(Q); ) Q = Q + "_" + ie;
            p.push(Q);
          }
          if (N) {
            var ue = E.split(x);
        ...
        if (W || W !== !1 && E.indexOf(e) === -1) {
          for (var he = E.split(x), le = 0; le < he.length; le++) {
            ...
            if (!v || s.substring(0, q) !== v) {
              if (ae) {
                if (Y = [], ye(s.split(o)), Ee(), U) return ce();
              } else ye(s.split(o));
        ...
        for (var G = E.indexOf(o, k), J = E.indexOf(x, k), ve = new RegExp(D(V) + D(e), "g"), $ = E.indexOf(e, k); ; ) if (E[k] !== e) if (v && s.length === 0 && E.substring(k, k + q) === v) {
          if (J === -1) return ce();
          k = J + se, J = E.indexOf(x, k), G = E.indexOf(o, k);
        } else if (G !== -1 && (G < J || J === -1)) s.push(E.substring(k, G)), k = G + L, G = E.indexOf(o, k);
        else {
          if (J === -1) break;
          ...
          if (e !== V || E[$ + 1] !== V) {
            if (e === V || $ === 0 || E[$ - 1] !== V) {
              G !== -1 && G < $ + 1 && (G = E.indexOf(o, $ + 1)), J !== -1 && J < $ + 1 && (J = E.indexOf(x, $ + 1));
              var we = me(J === -1 ? G : Math.min(G, J));
              if (E.substr($ + 1 + we, L) === o) {
                s.push(E.substring(k, $).replace(ve, e)), E[k = $ + 1 + we + L] !== e && ($ = E.indexOf(e, k)), G = E.indexOf(o, k), J = E.indexOf(x, k);
                break;
              }
              var fe = me(J);
              if (E.substring($ + 1 + fe, $ + 1 + fe + se) === x) {
                if (s.push(E.substring(k, $).replace(ve, e)), xe($ + 1 + fe + se), G = E.indexOf(o, k), $ = E.indexOf(e, k), ae && (Ee(), U)) return ce();
                if (T && Y.length >= T) return ce(!0);
                break;
              }
        ...
        function ce(de) {
          return { data: Y, errors: X, meta: { delimiter: o, linebreak: x, aborted: U, truncated: !!de, cursor: h + (oe || 0) } };
        }
        function Ee() {
          w(ce()), Y = [], X = [];
        }
    ...
    function z(t) {
      ...
      if (e.error) o.userError(e.error, e.file);
        ...
        if (A(o.userStep)) {
          ...
          delete e.results;
        } else A(o.userChunk) && (o.userChunk(e.results, v, e.file), delete e.results);
      }
      e.finished && !x && P(e.workerId, e.results);
    }
    function P(t, e) {
      var o = b[t];
      A(o.userComplete) && o.userComplete(e), o.terminate(), delete b[t];
    }
    function H() {
...
function sn({
  ...
  const { address: r } = ut.all(), { t: u } = Qe(), { data: a, isFetched: l } = ht(), { data: f } = ft(), { data: b } = pt(), [m, c] = S.useState(null), [_, j] = S.useState([]), [I, F] = S.useState([]), [Z, B] = S.useState([]), [re, D] = S.useState(!1), [ee, z] = S.useState(!1), [P, H] = S.useState({
    ...R.createTokenMap(() => "0"),
    usdValue: "0"
  ...
  }), [_, I, o]), w = S.useMemo(() => _.some((s) => s.to || s.note || s.amount), [_]);
  S.useEffect(() => {
    A.forEach((s, h) => {
      s.to && V(s.to, h);
    });
  ...
  const T = S.useCallback(async () => {
    ...
    z(!0);
    try {
      const s = R.getAllTokens().map((g) => g.tokenType), h = {}, d = (g) => A.filter((N, C) => {
        var Q;
        return N.token === g && N.amount && (Te(N.to) || ((Q = t[C]) == null ? void 0 : Q.fullAddress));
      }).map((N, C) => {
        var O;
        return {
      ...
      const p = R.getAllTokens().reduce((g, N) => {
        const C = h[N.tokenType], O = f == null ? void 0 : f[N.tokenType];
        return g + (C && O ? parseFloat(C) * parseFloat(O) : 0);
      }, 0);
      h.usdValue = be(p.toString(), 2), K(h);
    } catch (s) {
      ...
      try {
        ...
        for (let h = 0; h < _.length; h++) {
          ...
          try {
            ...
            const g = x({ transfer: d, validation: I[h] }) ? "invitation" : "transaction", N = mt(p);
...
function rn({
  ...
  return /* @__PURE__ */ n.jsx("div", { className: "bg-black/5 rounded-lg border-b border-[#dbdbdb] py-[12px] px-[16px] mb-[24px]", children: /* @__PURE__ */ n.jsxs("div", { className: "flex items-start gap-[12px]", children: [
    ...
    /* @__PURE__ */ n.jsxs("div", { children: [
      ...
      Object.keys(i).map((b) => {
        const m = b, c = parseFloat(i[m] || "0"), _ = parseFloat(u[m] || "0"), j = l && l[m] ? parseFloat(l[m]) : 0, I = _ + j;
...
const on = R.getAllTokens().map((i) => i.tokenType);
function ln({
  ...
  return /* @__PURE__ */ n.jsxs(vt, { children: [
    ...
    /* @__PURE__ */ n.jsx(kt, { align: "start", className: "bg-white", children: on.map((l) => /* @__PURE__ */ n.jsxs(
      wt,
      {
        disabled: a,
        onClick: () => i(l, r),
...
function cn({
  ...
  return S.useEffect(() => {
    m.current && setTimeout(() => {
      var I;
      const j = (I = m.current) == null ? void 0 : I.getBoundingClientRect().width;
      j && _(j + 12);
    }, 0);
...
function dn({
  ...
  const {
    ...
    onSent: i
  }), { showExitPrompt: e, handleExitPrompt: o } = Gt({
    shouldBlock: f
  }), x = Ge(), v = () => {
    x(-1);
  };
  return /* @__PURE__ */ n.jsxs("div", { className: M(
    ...
    /* @__PURE__ */ n.jsxs("div", { className: "mt-[120px]", children: [
      ...
      H ? /* @__PURE__ */ n.jsx("div", { className: "flex items-center justify-end mt-0.5", children: /* @__PURE__ */ n.jsx(He, { className: "animate-spin", size: 14 }) }) : P ? /* @__PURE__ */ n.jsxs("p", { className: "text-black text-sm font-medium leading-none text-right mt-0.5", children: [
        (() => {
          const w = Ye(P);
