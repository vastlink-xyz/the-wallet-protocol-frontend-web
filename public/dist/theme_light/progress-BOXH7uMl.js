import { r as s, p as _ } from "./vendor-react-wyPiRY-L.js";
import { aI as pe, _ as me, q as B, aJ as te, T as ye, Q as ve, U as he, y as Ce, K as be, A as le, X as $e, p as Se, R as ke, E as xe, aK as Ee } from "./main-CPzCMQxT.js";
import { o as Pe, R as we } from "./CheckOutlined-BMJAqmnV.js";
import { _ as Ne } from "./vendor-ui-utils-BbSwUILz.js";
import { _ as G, p as ne, r as Oe } from "./vendor-web3-CFt7IwTK.js";
import { d as Ie } from "./index-BFYmRswb.js";
var _e = {
  percent: 0,
...
var K = 100, ee = function(t, r, n, o, a, i, l, c, f, d) {
...
var ue = function(t) {
  var r = ne(ne({}, _e), t), n = r.id, o = r.prefixCls, a = r.steps, i = r.strokeWidth, l = r.trailWidth, c = r.gapDegree, f = c === void 0 ? 0 : c, d = r.gapPosition, g = r.trailColor, p = r.strokeLinecap, C = r.style, m = r.className, h = r.strokeColor, y = r.percent, b = Oe(r, Le), v = K / 2, I = Ae(n), P = "".concat(I, "-gradient"), $ = v - i / 2, S = Math.PI * 2 * $, O = f > 0 ? 90 + f / 2 : -90, x = S * ((360 - f) / 360), w = G(a) === "object" ? a : {
    count: a,
    gap: 2
  }, u = w.count, F = w.gap, z = ce(y), W = ce(h), A = W.find(function(N) {
    return N && G(N) === "object";
  }), L = A && G(A) === "object", D = L ? "butt" : p, X = ee(S, x, 0, 100, O, f, d, g, D, i), H = De(), k = function() {
    var R = 0;
...
const et = ["normal", "exception", "active", "success"], tt = /* @__PURE__ */ s.forwardRef((e, t) => {
  const {
    ...
    direction: x,
    progress: w
  } = s.useContext(Se), u = O("progress", r), [F, z, W] = He(u), A = d === "line", L = A && !a, D = s.useMemo(() => {
    if (!f)
      return null;
    const k = q(e);
    let E;
