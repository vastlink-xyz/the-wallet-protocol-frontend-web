...
import { l as F, k as C, a as r } from "./vendor-react-DM3ZG7W6.js";
import { B as i, a as A } from "./vendor-utils-ZATHw6Y5.js";
import { f as o, g as O, B as d, L as U, k as V, a as W, h as y } from "./main-Bd6o8N0r.js";
import { L as N } from "./index-CLZU21on.js";
import { f as Y } from "./vendor-web3-DmEdZR0k.js";
function K() {
  const [l] = F(), E = C(), [f, b] = r.useState(!1), [u, p] = r.useState(!1), [x, h] = r.useState(!1), [w, g] = r.useState(!1), [t, I] = r.useState(), [m, S] = r.useState("PENDING"), [T, k] = r.useState("");
  r.useEffect(() => {
    G();
  }, [l]), r.useEffect(() => {
    t && S(t.status);
