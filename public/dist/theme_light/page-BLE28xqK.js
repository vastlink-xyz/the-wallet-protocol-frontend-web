...
import { B as n, a as O } from "./vendor-utils-BfzDPiRN.js";
import { f as o, g as U, B as f, L as u, k as V, a as M, h as N, o as W } from "./main-Cs8rq8oH.js";
import { L as E } from "./index-CMEmOasf.js";
import { k as Y } from "./vendor-web3-DDgB3Js4.js";
function Q() {
  const [l] = C(), b = A(), [x, w] = r.useState(!1), [p, h] = r.useState(!1), [g, j] = r.useState(!1), [I, v] = r.useState(!1), [t, S] = r.useState(), [m, k] = r.useState("PENDING"), [T, R] = r.useState("");
  r.useEffect(() => {
    G();
  }, [l]), r.useEffect(() => {
    t && k(t.status);
  ...
  async function B() {
    ...
    try {
      h(!0), await L(a, T), await V.signUp({
        username: a
      });
