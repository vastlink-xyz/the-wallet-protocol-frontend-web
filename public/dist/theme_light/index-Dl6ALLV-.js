import { j as e, E as I, F as M, G as O, H as $ } from "./vendor-radix-BYJ0AyiX.js";
import { r as l, k as W } from "./vendor-react-CuOkI7kW.js";
import { a as V, aa as _, c as g, ab as q, ac as z, B as w, f as P, t as G, L as Q, g as S, ad as H, ae as J } from "./main-COWkWeS2.js";
import { u as K, B as j } from "./vendor-utils-DMWa-Mp_.js";
import { u as X } from "./useTransaction-CgxDhq0R.js";
import { L as Y } from "./index-D56WlHL9.js";
import { S as Z, A as ee } from "./vendor-ui-utils-2_WY-nJY.js";
import { k as te } from "./vendor-web3-DDgB3Js4.js";
import { u as se, a as ae } from "./MarketplaceProvider-ZmG6yuSr.js";
function be({
  text: i,
...
function ye({
  ...
  const { t: a } = K(), [t, m] = l.useState(!1), [x, u] = l.useState(!1), [b, y] = l.useState(""), [h, N] = l.useState(""), [s, d] = l.useState(!1), p = l.useRef(), v = l.useRef(), { signTransaction: U, waitForTransactionExection: le } = X();
  l.useEffect(() => {
    E();
  }, []);
  const E = async () => {
    ...
    N(R);
  }, k = async (n) => (await P.get(`/thirdparty/sign-moonpay-params?url=${encodeURIComponent(n)}`)).data.signature, B = () => {
    o(!1), m(!1), u(!1);
  }, C = async (n) => {
    if (d(!1), await L()) {
...
const ne = M, ie = O, oe = $, A = l.forwardRef(({ className: i, sideOffset: c = 4, ...o }, a) => /* @__PURE__ */ e.jsx(
  I,
  {
    ref: a,
    sideOffset: c,
...
const re = ({
  ...
  return {
    handleClick: async (s) => {
      if (h(s) !== "active") {
        o(`/marketplace/feature-detail/${s.id}`);
        return;
      }
