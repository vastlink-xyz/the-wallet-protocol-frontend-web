import { j as b } from "./vendor-radix-DUwj-Z7L.js";
import { a as Fa, c as et, l as Wl, B as Qs, u as Os, D as Zl, b as Gl, d as _l, e as vr, f as As, h as js, S as Fs, g as Pl, G as Ls, t as Yl, i as Hs } from "./main-DvSwU80m.js";
import { i as CA, j as Ml, L as Ns, a as B, b as Us, r as DA, p as Ql, O as zs } from "./vendor-react-DV6Kf_ot.js";
import { u as Ol, B as Ws } from "./vendor-utils-24jm1iP0.js";
import { X as Zs } from "./vendor-ui-utils-C4kABIJo.js";
import { W as Xl, V as Gs } from "./index-88MUIFxq.js";
import { S as _s } from "./SendButton-BEoJVUl3.js";
import { W as Ys, M as Xs } from "./MarketplaceProvider-BWPbWWvl.js";
function Vs({ routes: f, currentRouteName: c }) {
...
function Js() {
  const { t: f } = Ol(), [c, g] = B.useState(!1), m = Fa.isAuthenticated(), A = Ml(), { pathname: w } = CA(), { data: P } = Os(), [E, y] = B.useState("");
  B.useEffect(() => {
          ...
          children: [
            ...
            /* @__PURE__ */ b.jsxs(_l, { className: "bg-white border-none", children: [
              ...
              /* @__PURE__ */ b.jsx(
                ...
                {
                  onSelect: (k) => k.preventDefault(),
                  children: /* @__PURE__ */ b.jsx(Vl, { onLanguageChange: () => g(!1) })
                }
              ),
...
` && i.push(Rt), M;
  ...
  var Mt = C('<div hidden id="'), qt = C('">'), Re = C("</div>"), en = C('<svg aria-hidden="true" style="display:none" id="'), Dn = C('">'), hn = C("</svg>"), Qt = C('<math aria-hidden="true" style="display:none" id="'), Pn = C('">'), _t = C("</math>"), Ve = C('<table hidden id="'), Kn = C('">'), $n = C("</table>"), Sr = C('<table hidden><tbody id="'), Ze = C('">'), qn = C("</tbody></table>"), $r = C('<table hidden><tr id="'), qr = C('">'), Ot = C("</tr></table>"), er = C('<table hidden><colgroup id="'), Bn = C('">'), tn = C("</colgroup></table>");
  function ct(i, s, h, S) {
  ...
  var za = typeof Object.is == "function" ? Object.is : Wt, Vt = null, eo = null, Dr = null, Qe = null, mn = !1, Pr = !1, yn = 0, un = null, Br = 0;
  function cn() {
    if (Vt === null) throw Error(c(321));
    return Vt;
  }
  function Et() {
    if (0 < Br) throw Error(c(312));
    return { memoizedState: null, queue: null, next: null };
  }
  function to() {
  ...
  function tr() {
    eo = Vt = null, Pr = !1, Dr = null, Br = 0, Qe = un = null;
  }
  function Lo(i, s) {
  ...
  }, useMemo: Ho, useReducer: kr, useRef: function(i) {
    Vt = cn(), Qe = to();
  ...
  function Uo(i, s, h, S, j) {
    for (Vt = {}, eo = s, yn = 0, i = h(S, j); Pr; ) Pr = !1, yn = 0, Br += 1, Qe = null, i = h(S, j);
    return tr(), i;
  }
  function zo(i, s, h, S) {
...
` && e.push(gn), l;
    ...
    var Br = "<!--$-->", cn = '<!--$?--><template id="', Et = '"></template>', to = "<!--$!-->", tr = "<!--/$-->", Lo = "<template", kr = '"', Ho = ' data-dgst="', Wa = ' data-msg="', Za = ' data-stck="', Tr = "></template>";
    function No(e, t) {
      return C(e, Br);
    }
    function nr(e, t, n) {
    ...
    function no(e, t, n, o, l) {
      var d;
      return d = C(e, to), y(e, Lo), n && (y(e, Ho), y(e, Ve(n)), y(e, kr)), o && (y(e, Wa), y(e, Ve(o)), y(e, kr)), l && (y(e, Za), y(e, Ve(l)), y(e, kr)), d = C(e, Tr), d;
    }
    function Ga(e, t) {
      return C(e, tr);
    }
    ...
    function Fi() {
      {
        if (lo === 0) {
          ji = console.log, $a = console.info, He = console.warn, Hr = console.error, qa = console.group, ei = console.groupCollapsed, ti = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: ni,
...
` + D[W].replace(" at new ", " at ");
    ...
    var Zi = {}, Ur = {}, go, si, ha, pa, va, zr, mo, yo, ga;
    {
...
Please update the following components: %s`,
    ...
    var $A = typeof Object.is == "function" ? Object.is : KA, wn = null, fi = null, ba = null, Fe = null, Bt = !1, Wr = !1, lr = 0, ke = null, Hn = 0, Sa = 25, kt = !1, Tt;
    function dn() {
      if (wn === null)
...
Incoming: %s`, Tt, "[" + e.join(", ") + "]", "[" + t.join(", ") + "]");
    ...
    function So() {
      kt = !1, wn = null, fi = null, Wr = !1, ba = null, Hn = 0, ke = null, Fe = null;
    }
    function tl(e) {
...
` + o.stack;
    ...
    var Da = g.ReactCurrentDispatcher, xo = g.ReactDebugCurrentFrame, Pa = 0, Zr = 1, Ba = 2, ka = 3, Ta = 4, Gr = 0, mi = 1, ur = 2, tA = 12800;
    function ul(e) {
    ...
    function Do(e, t, n) {
      ...
      try {
        if (vt(e, t, p), Ri(q.chunks, e.responseState, q.lastPushedText, q.textEmbedded), q.status = Zr, Xr(R, q), R.pendingTasks === 0) {
          fn(t);
          return;
        }
      } catch (Te) {
    ...
    function fl(e, t, n, o) {
      Sn(t, n);
      var l = ho(n, t.legacyContext), d = Gi(n, o, l);
      Xi(d, n, o, l), nA(e, t, d, n, o), fn(t);
    }
    var rA = {}, ko = {}, bi = {}, oA = {}, Si = !1, To = {}, xi = !1, Ei = !1, Ci = !1;
    function aA(e, t, n, o) {
      var l;
    ...
    function AA(e, t, n, o, l) {
      Eo(t, n.render);
      var d = Bo(e, t, n.render, o, l), p = hi();
      if (p) {
    ...
    function cA(e, t, n) {
      if (t === null) {
        ...
        if (t.pendingTasks === 0)
          n.parentFlushed && n.status === Zr && Xr(t, n), t.parentFlushed && e.completedBoundaries.push(t), t.fallbackAbortableTasks.forEach(sA, e), t.fallbackAbortableTasks.clear();
    ...
    function bl(e, t) {
      ...
      if (n.status === Pa) {
        ...
        o = bn, bn = t;
        try {
          It(e, t, t.node), Ri(n.chunks, e.responseState, n.lastPushedText, n.textEmbedded), t.abortSet.delete(t), n.status = Zr, cA(e, t.blockedBoundary, n);
        } catch (d) {
          if (So(), typeof d == "object" && d !== null && typeof d.then == "function") {
            var l = t.ping;
            d.then(l, l);
    ...
    function Bi(e) {
      if (e.status !== ur) {
        ...
        try {
          ...
          eA(l), Da.current = n, xo.getCurrentStack = o, n === qi && vo(t);
        }
      }
    }
    function fr(e, t, n) {
...
var mA = {}, ql;
function tu() {
  return ql || (ql = 1, Ql.env.NODE_ENV !== "production" && function() {
    var f = DA(), c = "18.3.1", g = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function m(r) {
      {
...
` && r.push(yn), o;
    ...
    var Br = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, cn = /* @__PURE__ */ new Map();
    function Et(r) {
      var e = cn.get(r);
      if (e === void 0) {
        if (!Br.test(r))
    ...
    function ht(r, e, t, n, o) {
      var l;
      return l = Q(r, Qn), k(r, oo), t && (k(r, rr), k(r, F(Ze(t))), k(r, On)), n && (k(r, Ir), k(r, F(Ze(n))), k(r, On)), o && (k(r, Uo), k(r, F(Ze(o))), k(r, On)), l = Q(r, zo), l;
    }
    function Zo(r, e) {
      return Q(r, ro);
    }
    ...
    function ye(r, e, t, n) {
      switch (t.insertionMode) {
        case Yt:
        case Ge:
          return k(r, Go), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, Qr);
        case Lt:
          return k(r, Yo), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, Or);
        case Ht:
          return k(r, Xo), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, Vo);
        case an:
          return k(r, ao), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, Ko);
        case Tn:
    ...
    function RA(r, e, t) {
      k(r, e.startInlineScript), e.sentCompleteSegmentFunction ? k(r, $o) : (e.sentCompleteSegmentFunction = !0, k(r, Fr)), k(r, e.segmentPrefix);
      var n = F(t.toString(16));
...
` + p[R].replace(" at new ", " at ");
    ...
    function Wi(r, e) {
      ...
      if (t === null)
        throw new Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");
      r.depth === t.depth ? po(r, t) : Wi(r, t), fa(e);
    }
    function Ln(r) {
      var e = Fn, t = r;
      e !== t && (e === null ? Ui(t) : t === null ? vo(e) : e.depth === t.depth ? po(e, t) : e.depth > t.depth ? zi(e, t) : Wi(e, t), Fn = t);
    }
    function li(r, e) {
      var t;
...
Please check the code for the %s component.`, e, e, n), ha[o] = !0;
    ...
    var Yi = {
      ...
      enqueueSetState: function(r, e, t) {
        var n = go(r);
        n.queue === null ? _i(r, "setState") : (n.queue.push(e), t != null && wo(t, "setState"));
      },
      ...
      enqueueForceUpdate: function(r, e) {
        var t = go(r);
        t.queue === null ? _i(r, "forceUpdate") : e != null && wo(e, "setState");
      }
    };
...
Please update the following components: %s`,
    ...
    var Fe = typeof Object.is == "function" ? Object.is : ba, Bt = null, Wr = null, lr = null, ke = null, Hn = !1, Sa = !1, kt = 0, Tt = null, dn = 0, qA = 25, Jt = !1, Nn;
    function sr() {
      if (Bt === null)
        throw new Error(`Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
...
Incoming: %s`, Nn, "[" + r.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function pi() {
      Jt = !1, Bt = null, Wr = null, Sa = !1, lr = null, dn = 0, Tt = null, ke = null;
    }
    function Vi(r) {
    ...
    function Ki(r, e, t) {
      if (r !== vi && (Nn = "useReducer"), Bt = sr(), ke = So(), Hn) {
...
` + n.stack;
    ...
    var Ba = g.ReactCurrentDispatcher, ka = g.ReactDebugCurrentFrame, Ta = 0, Gr = 1, mi = 2, ur = 3, tA = 4, ul = 0, _r = 1, Yr = 2, cl = 12800;
    function dl(r) {
    ...
    function nA(r, e, t) {
      ...
      try {
        ...
        Y.status = tA, D.forceClientRender = !0, D.errorDigest = Po(r, ge), wi(D, ge);
      } finally {
    ...
    var Si = {}, To = {}, xi = {}, Ei = {}, Ci = !1, aA = {}, iA = !1, Di = !1, AA = !1;
    function hl(r, e, t, n) {
      var o;
    ...
    function vl(r, e, t, n, o) {
      Ra(e, t.render);
      var l = ko(r, e, t.render, n, o), d = xa();
      if (d) {
...
var jo, Il;
Ql.env.NODE_ENV === "production" ? (jo = $s(), Il = qs()) : (jo = eu(), Il = tu());
...
}, nu = (f, c) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 32, height: 32, viewBox: "0 0 42 42", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { style: {
  fill: "none",
  strokeWidth: 2,
  strokeLinecap: "butt",
...
const iu = "data:image/svg+xml;base64,", Au = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 0 637 637", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m478 113-13 2-4 1h4l14-2c10-2 35-2 42-1l6 3 3 1c3 0-4-3-8-5-7-1-34-1-44 1m56 6 8 6c7 5 20 17 20 19s7 12 8 12l-3-6-4-6c0-3-15-17-25-24-5-3-8-4-4-1m-198 16-9 1a512 512 0 0 1 9-1m-180 30a412 412 0 0 0-23 4 167 167 0 0 0-32 8 439 439 0 0 1 46-9 304 304 0 0 1 11-2l6-1h-8m369 8 4 3-7-6c-1 0 0 2 3 3m-439 9c-7 3-18 13-18 15l6-5c5-5 9-8 14-10l6-4-8 4m442 12-10 11-7 6 7-6c7-5 14-14 13-16l-3 5M65 205l-1 11c0 9 0 10 4 17 5 10 7 12 22 11 10 0 15 0 38-5l5-1-6 1-16 2-21 2c-13 1-16-1-21-10-3-5-4-6-4-15l1-12c1-4 1-5-1-1m335 1c3 0 3 1 3 3l-2 6c-2 5-35 39-76 80-53 51-120 117-138 137-21 24-22 25-22 27 0 3 6 9 9 9 4 0 14-8 38-27a5073 5073 0 0 1 15-16 1421 1421 0 0 0-17 15l-31 25-6 2-4-3c-3-3-3-4-2-6 3-8 79-85 160-163 57-57 79-80 79-86 0-2-3-4-7-4-2 0-2 0 1 1m165 18c-9 17-25 32-57 53l-10 8 16-11 12-8c15-10 27-22 39-39 5-7 6-8 4-8l-4 5m-221 2a199 199 0 0 0-19 10 183 183 0 0 1 27-12c0-1-1-1-8 2m-34 16c-3 3-2 3 2 0l1-2-3 2m151 3-1 2 2-2c3-3 2-3-1 0m-16 12-11 10a281 281 0 0 0 11-10m-24 18-7 5-7 5-42 31c-10 7-24 19-22 19l7-6 16-12a343 343 0 0 0 35-25 573 573 0 0 0 20-17m-187 0-2 2 4-2 3-2-5 2m-14 6-3 2 4-1 4-3-5 2m-7 3-8 4-18 8 18-7 7-3 3-1c1-2 0-2-2-1m254 24a2672 2672 0 0 1-71 54 601 601 0 0 0 39-29 1352 1352 0 0 1 32-25m-291-8-2 2 4-2 3-2-5 2m-13 5-2 2h3c5-3 4-4-1-2m-19 9-7 3-13 6c-10 5-13 7-14 10-3 4-2 5 1 0 2-3 5-5 14-9l13-6 12-6-6 2m178 36c-17 12-21 16-21 17a390 390 0 0 1 20-17m-206 34 1 4 1 3 1 5 2 8 1 5v-6l-1-8-2-5-1-4-1-2c-1-2-1-2-1 0m222 23-9 7a683 683 0 0 0-56 44 261 261 0 0 0-26 20 1345 1345 0 0 0-46 34c-6 3-7 3-19 3-11 0-12 0-18-3-8-4-10-8-17-20l-5-10 4 10c5 10 12 18 19 22 4 2 6 2 17 2 13 0 14 0 21-3l26-19 42-33a2183 2183 0 0 0 43-34 643 643 0 0 1 24-20", fill: "#fff", fillRule: "evenodd" }), /* @__PURE__ */ B.createElement("path", { d: "M478 114a620 620 0 0 1-39 6l-21 3a5481 5481 0 0 0-19 3 870 870 0 0 1-54 8l-1 1-6 1-12 2-13 2a992 992 0 0 0-76 12 400 400 0 0 1-45 8l-6 1-5 1h-3l-3 1-2 1-26 4-13 2-17 3c-23 5-33 9-43 19-7 8-9 13-9 27 0 8 1 9 4 14 5 9 8 11 21 10l21-2a1133 1133 0 0 1 23-4 659 659 0 0 0 74-14l3-1h3l3-1h3l2-1 2-1h3l2-1h2l24-5 38-7a2100 2100 0 0 1 93-18l3-1 10-1a2082 2082 0 0 1 120-17l2 1c2 0 8 5 8 7l1 2 1 6c0 4 0 6-3 10-2 4-16 16-18 16l-7 5-10 8a1070 1070 0 0 0-11 7 113 113 0 0 1-20 14l-2 2-3 2-2 2h-1a154 154 0 0 1-28 21l-5 4-5 4a573 573 0 0 1-50 37 175 175 0 0 0-24 18l-1 2-2 1-2 1-2 1-1 1-12 10a396 396 0 0 0-32 25l-8 6-6 5-9 7a326 326 0 0 1-25 20l-13 12a5073 5073 0 0 0-17 15c-24 20-34 27-39 27-2 0-8-6-8-9 0-2 1-3 22-27 18-20 85-86 138-137 41-41 74-75 76-80l2-6c0-2 0-3-2-3l-7 1a233 233 0 0 1-26 9l-1 1-1 1h-1l-1 1h-2l-3 2-1 1h-2l-3 2h-1l-5 2-22 10-9 4-4 2-5 2-10 4-2 1-2 1-2 1-13 6a334 334 0 0 1-38 17 75 75 0 0 0-14 6l-5 2-4 1-2 1-3 2-7 3-16 6a247 247 0 0 0-32 14l-1 1h-2l-1 1h-2l-1 1-12 6a103 103 0 0 0-27 15l-2 5-1 1v11l1 5 1 5 1 4c0 3 0 4 2 4v3l1 3 1 2 2 10 1 4 1 5 2 10 2 8 1 4 1 4c3 3 9 25 11 38l1 7v2l1 4v1l1 1v2l1 2 1 3v1l5 10c7 13 9 16 17 20 6 3 7 3 18 3 12 0 13 0 19-3 8-4 11-6 26-18a1345 1345 0 0 1 85-67 683 683 0 0 1 50-39l12-9a513 513 0 0 1 44-33 201 201 0 0 0 22-17 2270 2270 0 0 0 73-54 158 158 0 0 0 58-59c2 0 3-9 4-27l-1-19-1-4-1-6-1-3-4-6-4-6c0-2-6-8-13-14a77 77 0 0 0-28-18c-6-1-34-1-43 1" })), ts = B.forwardRef(Au), lu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M765-321q0 117-84 196-83 80-200 80-118 0-200-80t-83-196v-392q0-85 61-144 61-58 146-58 86 0 147 58 61 59 61 144v374q0 54-39 92-39 37-93 37-55 0-93-37-38-38-38-92v-372h110v372q0 9 6 14t15 5q8 0 15-5t7-14v-374q0-39-29-66t-68-27q-40 0-69 27t-29 66v392q0 71 51 119t122 48q71 0 122-48t51-119v-426h111v426Z" })), ns = B.forwardRef(lu), su = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M125-165v-113h77v-273q0-93 55-167 56-75 146-100v-19q0-32 22-55 23-23 55-23t55 23q22 23 22 55v19q90 25 146 99 56 73 56 168v273h77v113H125ZM480-32q-38 0-66-27-27-27-27-66h186q0 39-27 66t-66 27Z" })), uu = B.forwardRef(su), cu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M137-190v-113h78v-253q0-41 11-79 11-39 35-71l-9 150h10L17-802l74-74L873-92l-74 74-175-172H137Zm609-149L319-769q20-15 41-25t44-16v-28q0-32 22-54t54-22q32 0 55 22t22 54v28q85 23 137 94t52 160v217ZM481-47q-38 0-65-27t-27-65h184q0 38-27 65t-65 27Z" })), du = B.forwardRef(cu), fu = (f, c) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", ref: c, ...f }, /* @__PURE__ */ B.createElement("g", { strokeLinecap: "round", strokeWidth: 10 }, /* @__PURE__ */ B.createElement("path", { d: "m19 19 61 61M80 19 19 80" }))), hu = B.forwardRef(fu), pu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M94-136v-255l351-93-351-92v-253l816 346L94-136Z" })), vu = B.forwardRef(pu), gu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M480-372q-61 0-105-43-43-43-43-105v-240q0-61 43-105 43-43 105-43 61 0 105 43 43 44 43 105v240q0 62-43 105t-105 43ZM425-76v-122q-121-16-197-108t-76-214h109q0 91 64 154t155 63q91 0 155-63t64-154h109q0 122-77 214T534-198v122H425Z" })), mu = B.forwardRef(gu), yu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m763-343-80-79q8-20 13-44 5-23 5-54h109q0 49-11 95t-36 82ZM625-482 336-770v-2q3-56 45-96t101-40q62 0 105 43t43 105v249l-1 17q-1 7-4 12ZM427-76v-122q-120-16-196-108-77-92-77-214h109q0 91 64 154t155 63q43 0 80-14 37-15 67-41l78 79q-35 32-78 53t-93 28v122H427Zm362 27L41-796l75-75 748 748-75 74Z" })), wu = B.forwardRef(yu), bu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M625-511q29 0 50-21t20-50q0-29-20-50-21-20-50-20t-50 20-20 50q0 29 20 50 21 21 50 21Zm-290 0q29 0 50-21t20-49q0-30-20-50t-50-21q-29 0-50 20-20 21-20 50 0 30 20 50 21 21 50 21Zm145 268q75 0 137-43t85-115H258q24 72 85 115 62 43 137 43Zm0 198q-90 0-170-34-79-34-138-93T79-310q-34-80-34-170t34-170q34-79 93-138t138-93q80-34 170-34t170 34q79 34 138 93t93 138q34 80 34 170t-34 170q-34 79-93 138T650-79q-80 34-170 34Zm0-435Zm0 322q134 0 228-94t94-228q0-134-94-228t-228-94q-134 0-228 94t-94 228q0 134 94 228t228 94Z" })), rs = B.forwardRef(bu), Su = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M553-64v-108q107-27 173-113 67-87 67-197 0-109-67-195T553-789v-108q152 26 249 144 97 117 97 271 0 155-97 273T553-64ZM61-335v-290h176l236-237v764L237-335H61Zm492 28v-346q51 23 82 70t31 103-31 103q-31 47-82 70Z" })), xu = B.forwardRef(Su), Eu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M807-15 700-123q-33 21-71 37-38 15-80 22v-108q20-4 38-12l35-17-153-154v257L234-335H57v-290h144L10-818l74-75L882-90l-75 75Zm37-264-80-79q13-30 19-60 7-31 7-64 0-109-68-195-67-86-173-112v-108q152 26 249 144 98 117 98 271 0 55-14 107-13 51-38 96ZM661-462 549-575v-78q51 23 83 70 31 47 31 103l-1 9-1 9ZM469-655 366-759l103-103v207Z" })), Cu = B.forwardRef(Eu), Du = "data:audio/wav;base64,", ls = {
...
}, ss = B.createContext({ settings: {}, setSettings: () => null }), De = () => B.useContext(ss), Pu = ({
  children: f,
  settings: c = ls,
  setSettings: g
...
}, cs = B.createContext({ styles: {}, setStyles: () => null }), Ye = () => B.useContext(cs), Bu = ({
  children: f,
  styles: c = us,
  setStyles: g
}) => /* @__PURE__ */ b.jsx(cs.Provider, { value: { styles: c, setStyles: g }, children: f }), ku = ({ buttons: f }) => {
  var c, g, m, A, w;
...
}, ds = B.createContext({}), bt = () => B.useContext(ds), Tu = ({
  children: f,
  botIdRef: c,
  flowRef: g
}) => {
...
}, fs = B.createContext({}), gt = () => B.useContext(fs), Iu = ({
  children: f,
  settings: c
}) => {
  var g, m, A, w, P, E;
...
}, hs = B.createContext({ paths: [], setPaths: () => null }), jl = () => B.useContext(hs), Qu = ({ children: f }) => {
  ...
  const { getCurrPath: f, getPrevPath: c, paths: g } = Ou(), { botIdRef: m } = bt();
  return { callRcbEvent: B.useCallback((A, w) => {
    const P = { botId: m.current, currPath: f(), prevPath: c() };
    return xA(A, P, w);
  }, [g]) };
}, ps = B.createContext({ toasts: [], setToasts: () => null }), vs = () => B.useContext(ps), ju = ({ children: f }) => {
  const [c, g] = B.useState([]);
...
}, gs = B.createContext({ messages: [], setMessages: () => null }), Fl = () => B.useContext(gs), Lu = ({ children: f }) => {
  const [c, g] = B.useState([]);
  ...
  const { settings: U } = De(), { styles: L } = Ye(), { messages: _ } = Fl(), { toasts: F } = vs(), { isChatWindowOpen: T } = gr(), {
    isBotTyping: K,
    isScrolling: re,
    setIsScrolling: X,
    setUnreadCount: G
  ...
  const { settings: L } = De(), { styles: _ } = Ye(), { paths: F } = jl(), { handleSubmitText: T } = Ha(), [K, re] = B.useState(/* @__PURE__ */ new Set()), [X, G] = B.useState(!1), $ = {
  ...
  const P = /* @__PURE__ */ b.jsx(Nu, { checkboxes: w, checkedItems: /* @__PURE__ */ new Set(), path: g });
  ...
  for (const P of w)
    P === "function" && await zu(A, g);
  return w.includes("path") ? await _u(A, g, m) : !1;
}, Ku = (f) => {
  const c = [];
  let g = "", m = !1;
  ...
  return g !== "" && c.push(g), c;
}, $u = (f) => typeof window.DOMParser < "u" ? new DOMParser().parseFromString(f, "text/html").body.textContent || "" : f.replace(/<\/?[^>]+(>|$)/g, ""), qu = (f, c, g, m, A) => {
...
let ws = !1, Rl = "rcb-history", yA = 30, bs = !1, EA = [];
const wA = async (f) => {
  if (bs)
    return;
  ...
  var c, g, m;
  Rl = (c = f.chatHistory) == null ? void 0 : c.storageKey, yA = (g = f.chatHistory) == null ? void 0 : g.maxEntries, bs = (m = f.chatHistory) == null ? void 0 : m.disabled, EA = rc(localStorage.getItem(Rl));
  ...
  if (ws = !0, g != null)
    try {
      m((C) => {
        const H = Oo(/* @__PURE__ */ b.jsx(nc, {}), "system");
        return C.shift(), [H, ...C];
      });
      const y = g.map((C) => {
        if (C.type === "object") {
      ...
      setTimeout(() => {
        m((C) => {
          ...
          C.shift();
          let k;
          return (H = f.chatHistory) != null && H.autoLoad ? k = Oo(/* @__PURE__ */ b.jsx(b.Fragment, {}), "system") : k = Oo(/* @__PURE__ */ b.jsx(tc, {}), "system"), [...y, k, ...C];
        });
      }, 500), setTimeout(() => {
        if (!A.current)
          return;
  ...
  return Array.from(m.body.childNodes).map((A, w) => {
      ...
      return A.textContent;
    {
      ...
      const C = A.classList;
      if ((P = c.botBubble) != null && P.showAvatar && (y = sc(C, y)), y = uc(C, y, c, g), y = cc(C, y, c, g), y = dc(C, y, c, g), y = fc(C, y, c, g), [
        "area",
        "base",
        "br",
        "col",
...
}, sc = (f, c) => ((f.contains("rcb-options-container") || f.contains("rcb-checkbox-container")) && (Object.prototype.hasOwnProperty.call(c, "class") ? c.class = `${f.toString()} rcb-options-offset` : c.class = "rcb-options-offset"), c), uc = (f, c, g, m) => {
  var A, w, P, E, y;
  ...
  const { settings: A } = De(), { messages: w, setMessages: P } = Fl(), {
    ...
    setIsBotTyping: H,
    setUnreadCount: k
  } = gt(), { streamMessageMap: Q, chatBodyRef: U } = bt(), { callRcbEvent: L } = Wn(), { playNotificationSound: _ } = Ll(), F = B.useCallback(async (Z, ne, te) => {
    H(!1), P((ve) => {
      const de = [...ve, Z];
      return $(de), de;
    ...
    let se = !1;
    ne === "bot" ? se = (Ae = A.botBubble) == null ? void 0 : Ae.dangerouslySetInnerHtml : ne === "user" && (se = (ae = A.userBubble) == null ? void 0 : ae.dangerouslySetInnerHtml), ec(A, E, y, ee, se);
    ...
    wA(Z);
    let Ae = !0;
    (Z.length === 0 || y && !C) && (Ae = !1), (ne = A.general) != null && ne.embedded && xs(U.current) && (Ae = !1);
...
const Hl = () => {
  ...
  var E;
  (E = f.voice) != null && E.sendAsAudio ? vc(g, w) : pc(
    f,
    c,
    g,
    m,
  ...
  C.onresult = (Q) => {
    ...
    Jr ? (C.start(), Un || (Un = setTimeout(() => kl(c, w), H))) : (clearTimeout(Un), Un = null, clearTimeout(bA));
  ...
  const f = Hl();
  f && (Jr = !1, f && f.stop(), zn && zn.state !== "inactive" && (zn.stop(), zn = null), clearTimeout(Un), Un = null, clearTimeout(bA));
}, gc = (f, c) => {
  var g, m, A;
  const w = Hl();
  (g = c.voice) != null && g.disabled || !((m = c.chatInput) != null && m.blockSpam) || !w || (f && !Jr ? (Jr = !0, (A = c.voice) != null && A.sendAsAudio ? zn == null || zn.start() : w.start()) : f || Nl());
}, kl = (f, c) => {
  var g;
  ...
  const { settings: f } = De(), {
    ...
    (F = E.current) != null && F.disabled || setTimeout(() => {
      var T, K, re;
      (T = f.general) != null && T.embedded ? xs(y == null ? void 0 : y.current) && ((K = E.current) == null || K.focus()) : _ !== "start" && ((re = E.current) == null || re.focus());
    }, 100);
  }, []), U = B.useCallback(() => {
  ...
  const { settings: A } = De(), { endStreamMessage: w, injectMessage: P, removeMessage: E, streamMessage: y } = kA(), { getCurrPath: C, getPrevPath: H, goToPath: k } = PA(), {
    ...
    setInputLength: re
  } = gt(), { flowRef: X, chatBodyRef: G, inputRef: $, keepVoiceOnRef: Z, paramsInputRef: ne } = bt(), { showToast: te, dismissToast: Ae } = BA(), { callRcbEvent: ae } = Wn(), { syncVoice: ce } = Ul(), { setTextAreaValue: ve } = La(), { openChat: de } = gr(), Me = B.useCallback(async (ee) => {
    var se, fe, be;
    const oe = C();
    if (!(!oe || !X.current[oe])) {
      if (_) {
    ...
    se = se.trim(), se !== "" && (fe && await Me(se), Q && clearTimeout(Q), ne.current = se, G.current && (G.current.scrollTop = G.current.scrollHeight), $.current && (ve(""), re(0)), (be = A.chatInput) != null && be.blockSpam && F(!0), Z.current = U, ce(!1), setTimeout(() => {
      ...
      if (!await ys(X.current, ee, Oe, k)) {
        ...
        if (!le)
          return;
        le.chatDisabled || F((me = A.chatInput) == null ? void 0 : me.disabled), ms(le, L, Oe), K(typeof le.file == "function"), ce(Z.current), T(!1);
      }
  ...
  var f, c, g, m, A, w, P;
  const { settings: E } = De(), { styles: y } = Ye(), { unreadCount: C } = gt(), { isChatWindowOpen: H, toggleChatWindow: k } = gr(), Q = {
  ...
  var f, c, g, m;
  const A = TA(), { settings: w } = De(), { styles: P } = Ye(), { isChatWindowOpen: E, openChat: y } = gr(), [C, H] = B.useState(!1), [k, Q] = B.useState(!1), [U, L] = B.useState(0);
  B.useEffect(() => {
    var T, K, re;
  ...
  var f, c, g, m, A, w;
  const { settings: P } = De(), { styles: E } = Ye(), { injectMessage: y, streamMessage: C, removeMessage: H, endStreamMessage: k } = kA(), { getCurrPath: Q, getPrevPath: U, goToPath: L, blockAllowsAttachment: _ } = PA(), { flowRef: F, inputRef: T } = bt(), K = F.current, { showToast: re, dismissToast: X } = BA(), { callRcbEvent: G } = Wn(), { openChat: $ } = gr(), { setTextAreaValue: Z } = La(), { handleSubmitText: ne } = Ha(), te = {
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { audioToggledOn: w, toggleAudio: P } = Ec(), E = {
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { notificationsToggledOn: w, toggleNotifications: P } = Pc(), E = {
...
}, Ic = (f) => Object.values(Je).includes(f), Rc = (f, c) => {
...
}, Mc = () => /* @__PURE__ */ b.jsx(Cc, {}), Qc = () => /* @__PURE__ */ b.jsx(Bc, {}), Oc = () => /* @__PURE__ */ b.jsx(Dc, {}), jc = () => /* @__PURE__ */ b.jsx(kc, {}), Fc = () => /* @__PURE__ */ b.jsx(Tc, {}), Lc = () => /* @__PURE__ */ b.jsx(Sc, {}), Hc = () => /* @__PURE__ */ b.jsx(xc, {}), Nc = () => {
  const { settings: f } = De(), c = B.useMemo(() => ({
    [Je.CLOSE_CHAT_BUTTON]: () => Oc(),
    [Je.AUDIO_BUTTON]: () => Mc(),
    [Je.NOTIFICATION_BUTTON]: () => Qc(),
    [Je.EMOJI_PICKER_BUTTON]: () => Hc(),
    [Je.FILE_ATTACHMENT_BUTTON]: () => Lc(),
    [Je.SEND_MESSAGE_BUTTON]: () => Fc(),
    [Je.VOICE_MESSAGE_BUTTON]: () => jc()
  }), []), { header: g, chatInput: m, footer: A } = B.useMemo(() => Rc(f, c), [f, c]), w = B.useMemo(() => g, [g]), P = B.useMemo(() => m, [m]), E = B.useMemo(() => A, [A]);
  ...
  } = gt(), { chatBodyRef: w } = bt(), { callRcbEvent: P } = Wn(), { chatScrollHeight: E } = gr(), y = B.useCallback(() => {
    var C;
    const H = oc();
    H && ((C = f.event) != null && C.rcbLoadChatHistory && P(Ee.LOAD_CHAT_HISTORY, {}).defaultPrevented || (A(!0), lc(
      f,
      c,
      H,
      g,
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { showChatHistory: w } = Ds(), [P, E] = B.useState(!1), y = {
    color: (f = m.general) == null ? void 0 : f.primaryColor,
    borderColor: (c = m.general) == null ? void 0 : c.primaryColor,
  ...
  B.useEffect(() => (window.addEventListener("click", le), window.addEventListener("keydown", le), window.addEventListener("touchstart", le), () => {
    ...
    else if (ic(w), localStorage.getItem((Pe = w.chatHistory) == null ? void 0 : Pe.storageKey) != null) {
      const Ke = Oo(/* @__PURE__ */ b.jsx(Uc, {}), "system");
  ...
  const w = TA(), { settings: P } = De(), { styles: E } = Ye(), { hasFlowStarted: y, setHasFlowStarted: C } = gt(), { inputRef: H } = bt(), {
    ...
    viewportWidth: U,
    isChatWindowOpen: L
  } = gr(), { headerButtons: _, chatInputButtons: F, footerButtons: T } = Nc();
  Wc();
  const K = B.useMemo(() => {
    var X;
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ b.jsxs("div", { style: re(), className: "rcb-chat-window", children: [
          ...
          /* @__PURE__ */ b.jsx(Hu, { setChatScrollHeight: k }),
          ((m = P.general) == null ? void 0 : m.showInputRow) && /* @__PURE__ */ b.jsx(mc, { buttons: F }),
          ((A = P.general) == null ? void 0 : A.showFooter) && /* @__PURE__ */ b.jsx(yc, { buttons: T })
        ] })
      ]
    }
  ) });
...
}, Gc = zl.DEFAULT_URL, _c = zl.DEFAULT_EXPIRATION, Ps = zl.CACHE_KEY_PREFIX, Yc = (f, c, g) => {
  ...
  const { id: g, version: m, baseUrl: A = Gc, cacheDuration: w = _c } = c, P = m || await Vc(g, A);
  if (!P)
  ...
  let F = {};
  _.ok ? F = await _.json() : console.info(`Could not fetch styles.json from ${H}`), Xc(g, P, L, F, k);
  const T = as(f, k);
  return { settings: L, inlineStyles: F, cssStylesText: T };
}, as = (f, c) => c.split(new RegExp("(?<=})")).map((g) => {
  const m = g.trim();
  return m.startsWith("@import") || m.startsWith("@keyframes") || m.startsWith("@media") ? m : m ? `#${f} ${m}` : "";
}).join(`
`), Bs = () => ks(ls), Jc = () => ks(us), Kc = async (f, c, g, m) => {
  var A, w;
  let P = Bs(), E = Jc(), y = "";
  if (m != null)
    if (Array.isArray(m))
  ...
  return c;
}, Ts = B.createContext(void 0), Is = () => B.useContext(Ts), $c = ({
  children: f
}) => {
  var c;
  ...
  const H = async (k, Q, U, L, _, F) => {
    ...
    const T = await Kc(k, U, L, _);
    F.current && (F.current.textContent = T.cssStylesText), w(T.settings), E(T.inlineStyles);
  };
  return y ? /* @__PURE__ */ b.jsx("div", { style: { fontFamily: (c = A.general) == null ? void 0 : c.fontFamily }, children: /* @__PURE__ */ b.jsx(Ts.Provider, { value: { loadConfig: H }, children: /* @__PURE__ */ b.jsx(Pu, { settings: A, setSettings: w, children: /* @__PURE__ */ b.jsx(Bu, { styles: P, setStyles: E, children: /* @__PURE__ */ b.jsx(ju, { children: /* @__PURE__ */ b.jsx(Tu, { botIdRef: g, flowRef: m, children: /* @__PURE__ */ b.jsx(Qu, { children: /* @__PURE__ */ b.jsx(Iu, { settings: A, children: /* @__PURE__ */ b.jsx(Lu, { children: f }) }) }) }) }) }) }) }) }) : null;
}, qc = ({
  id: f,
  flow: c,
  settings: g,
...
}, Tl = ["Quickstart", "API Docs", "Examples", "Github", "Discord"], ed = {
  start: {
  ...
  const P = B.useMemo(() => f || "rcb-" + SA(), []), E = !c || Object.keys(c).length === 0 ? ed : c, y = g || {}, C = m || {}, H = w || [], [k, Q] = B.useState(!1), U = Is(), L = B.useRef(null), [_, F] = B.useState(A || []);
  B.useEffect(() => {
    A && F(A);
  }, [A]);
  ...
  return U == null ? /* @__PURE__ */ b.jsxs($c, { children: [
...
function rd() {
  ...
  const L = async (K) => {
    ...
    c(re);
    let G = await Yl.getToken(K).getBalance(re);
    G = Hs(G), m(G);
  }, _ = async (K) => {
    Pl("handleQuestion params", K);
    const re = await As.post("/ai/chat", {
    ...
    if (!X)
      ...
      let ne = G;
      if (typeof G == "string") {
        const te = Object.values(Ls).find(
          (Ae) => Ae.toUpperCase() === G
        );
        te && (ne = Yl.getNativeTokenTypeByGasSymbol(te));
      }
      U({
        action: X,
        toEmail: Z,
    ...
    transfer: {
      ...
      component: (K) => {
        if (Q.action === "transfer")
          return Pl(P, f, g, Q.token, Q.toEmail, Q.amount), /* @__PURE__ */ b.jsx("div", { className: "pl-4 pt-2", children: P && f && g && Q.token && Q.toEmail && Q.amount && /* @__PURE__ */ b.jsx(_s, { onClick: () => w(!0) }) });
      },
      // chatDisabled: true,
      path: "transfer"
    }
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: H && /* @__PURE__ */ b.jsx(B.Suspense, { fallback: null, children: /* @__PURE__ */ b.jsxs("div", { children: [
    /* @__PURE__ */ b.jsx(nd.Provider, { value: { settings: y, setSettings: C }, children: /* @__PURE__ */ b.jsx(td, { id: "vastlink-chatbot", settings: y, flow: F, styles: T }) }),
    /* @__PURE__ */ b.jsx(
      Fs,
      {
        open: A,
...
function gd() {
  const { hideChatbot: f } = id();
  return /* @__PURE__ */ b.jsx("section", { className: "bg-background w-full flex flex-col min-h-screen", children: /* @__PURE__ */ b.jsxs(Ys, { children: [
    /* @__PURE__ */ b.jsx(Ks, {}),
    ...
    /* @__PURE__ */ b.jsx("div", { className: "flex-grow min-h-custom-main", children: /* @__PURE__ */ b.jsx(Xs, { children: /* @__PURE__ */ b.jsx(zs, {}) }) }),
    !f && /* @__PURE__ */ b.jsx(rd, {}),
    /* @__PURE__ */ b.jsx(Gs, {}),
    /* @__PURE__ */ b.jsx(ld, {})
  ] }) });
