import { H as A, J as G, V as L, j as e, K as g, M, N as j, O as N, Q as Y, U as y, W as _, X as w, Y as S, Z as $, $ as q, a0 as b } from "./vendor-radix-CjL5_ZCn.js";
import { a as o } from "./vendor-react-D6ZgZFQ5.js";
import { B as u } from "./button-CQRi4ddT.js";
import { I as H } from "./input-CKttCQxA.js";
import { l as f } from "./main-DrvVrxeO.js";
import { a as J } from "./auth-D53HHgot.js";
import { C as K } from "./card-CbHBAfSW.js";
import { c as d } from "./style-CX3mXOu3.js";
import { i as v, j as O, a as Q, T as W, k as X } from "./vendor-ui-utils-CwlQOkPE.js";
import { a as h } from "./index-Dr7PNsrq.js";
import { v as x } from "./vendor-utils-RvkaSVWD.js";
const Z = A, F = G, ee = L, C = o.forwardRef(({ className: s, children: r, ...l }, c) => /* @__PURE__ */ e.jsxs(
  g,
  {
    ref: c,
    className: d(
...
const V = o.forwardRef(({ className: s, ...r }, l) => /* @__PURE__ */ e.jsx(
  j,
  {
    ref: l,
    className: d(
...
const R = o.forwardRef(({ className: s, ...r }, l) => /* @__PURE__ */ e.jsx(
  N,
  {
    ref: l,
    className: d(
...
const B = o.forwardRef(({ className: s, children: r, position: l = "popper", ...c }, m) => /* @__PURE__ */ e.jsx(Y, { children: /* @__PURE__ */ e.jsxs(
  y,
  {
    ref: m,
    className: d(
...
const se = o.forwardRef(({ className: s, ...r }, l) => /* @__PURE__ */ e.jsx(
  w,
  {
    ref: l,
...
const I = o.forwardRef(({ className: s, children: r, ...l }, c) => /* @__PURE__ */ e.jsxs(
  S,
  {
    ref: c,
    className: d(
...
const ae = o.forwardRef(({ className: s, ...r }, l) => /* @__PURE__ */ e.jsx(
  b,
  {
    ref: l,
...
function fe() {
  const [s, r] = o.useState([]), [l, c] = o.useState(1);
  o.useState(!1), o.useEffect(() => {
    m();
  }, []);
  const m = async () => {
    ...
    const n = [...s], i = n[a];
    try {
      const p = await h.get("/address/", {
        params: { email: t }
      });
      if (p.data.success) {
        const P = p.data.address;
  ...
  return /* @__PURE__ */ e.jsx("div", { children: /* @__PURE__ */ e.jsxs(K, { className: "p-8", children: [
    ...
    /* @__PURE__ */ e.jsxs(u, { onClick: () => T(), size: "sm", children: [
    ...
    /* @__PURE__ */ e.jsx("div", { className: "flex justify-end items-center mt-8", children: /* @__PURE__ */ e.jsx(u, { onClick: () => z(), children: "Save" }) })
  ] }) });
}
export {
  fe as default
