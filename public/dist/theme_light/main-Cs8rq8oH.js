...
import { d as Nd, f as kd, h as er, a as Pd, b as Rd, s as Md, t as Ia, c as Od, e as Id, i as Jr, I as Bi, g as fi, j as zn, k as qt, l as Vn, m as _d, n as jd, _ as me, o as Ld, p as U, q as J, r as hn, u as zr } from "./vendor-web3-DDgB3Js4.js";
var Xa, Mr = ci;
...
const ef = 1e3 * 60 * 60 * 24, tf = 1e3 * 60 * 60 * 24, Nc = 1e3 * 60 * 60;
...
function lh(e, t) {
  var n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, r = p.useContext(ya), a = r.cache.instanceId, o = r.container, s = n.salt, l = s === void 0 ? "" : s, i = n.override, c = i === void 0 ? nh : i, u = n.formatToken, d = n.getComputedToken, f = n.cssVar, g = Uf(function() {
    ...
    var E, b = d ? d(g, c, e) : ch(g, c, e, u), N = U({}, b), x = "";
    if (f) {
      var w = qc(b, f.key, {
        prefix: f.prefix,
        ignore: f.ignore,
...
`);
      ...
      Object.keys(w).forEach(function(S) {
        ...
        if (me(T) === "object" && T && (S !== "animationName" || !T._keyframe) && !Ih(T)) {
          ...
          let M = function(j, D) {
            Q.env.NODE_ENV !== "production" && (me(T) !== "object" || !(T != null && T[sl])) && [kh, Ph].concat(Xe(v)).forEach(function(H) {
              return H(j, D, {
                path: c,
                hashId: l,
                parentSelectors: s
...
const El = oo(Cp), ko = {
  ...
  hashed: !0
}, wl = /* @__PURE__ */ q.createContext(ko), Po = "ant", Ai = "anticon", cy = ["outlined", "borderless", "filled"], Sp = (e, t) => t || (e ? `${Po}-${e}` : Po), Kt = /* @__PURE__ */ p.createContext({
...
function $p(e) {
  ...
  function u(f, g, v) {
    ...
    return function(x) {
      var w = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : x, S = r(), T = S.theme, P = S.realToken, L = S.hashId, _ = S.token, B = S.cssVar, O = a(), I = O.rootPrefixCls, $ = O.iconPrefixCls, R = n(), k = B ? "css" : "js", M = Dp(function() {
        var G = /* @__PURE__ */ new Set();
        return B && Object.keys(m.unitless || {}).forEach(function(K) {
          G.add(Wr(K, B.prefix)), G.add(Wr(K, xs(E, B.prefix)));
        }), Op(k, G);
      }, [k, E, B == null ? void 0 : B.prefix]), j = jp(k), D = j.max, F = j.min, z = {
        theme: T,
        token: _,
        hashId: L,
        nonce: function() {
      ...
      var H = uo(U(U({}, z), {}, {
        ...
        if (m.injectStyle === !1)
          return [];
        var G = _p(_), K = G.token, te = G.flush, Z = Es(E, P, v), Ne = ".".concat(x), be = Cs(E, P, Z, {
...
var fm = [ut, Sn, En, ki], hm = [ut, Il], $l = !1, pm = !0;
function Hl(e) {
  return e === En || e === ki;
}
const mm = function(e, t, n) {
  var r = Oo(Ns), a = Y(r, 2), o = a[0], s = a[1], l = dm(), i = Y(l, 2), c = i[0], u = i[1];
  function d() {
    s(ut, !0);
  }
  var f = t ? hm : fm;
...
function gm(e, t, n, r) {
  ...
  }), Ne = um(Z), be = Y(Ne, 1), ye = be[0], Ke = function(he) {
    switch (he) {
      case Dr:
...
function vm(e) {
  ...
  var r = /* @__PURE__ */ p.forwardRef(function(a, o) {
    ...
    var x = gm(A, l, N, a), w = Y(x, 4), S = w[0], T = w[1], P = w[2], L = w[3], _ = p.useRef(L);
    L && (_.current = !0);
    ...
    return wt(o, [{
      ...
      value: function() {
        ...
        return Em.forEach(function(h) {
          ...
          var E = h.status, b = hn(h, Sm), N = E === _o || E === jo;
...
const Im = (e) => {
  ...
  const Ku = p.useMemo(() => {
    const Te = Zn || {}, {
      ...
      components: vt,
      cssVar: Pr
    } = Te, Qu = km(Te, ["algorithm", "token", "components", "cssVar"]), Li = _e && (!Array.isArray(_e) || _e.length > 0) ? oo(_e) : El, Ma = {};
  ...
  return b && (Ie = /* @__PURE__ */ p.createElement(wl.Provider, {
    ...
    value: bn.warning
  }, Ie)), N !== void 0 && (Ie = /* @__PURE__ */ p.createElement(Ap, {
    disabled: N
...
var X = {
  ...
  }), S = lg(u), T = Y(S, 2), P = T[0], L = T[1], _ = L.offset, B = L.threshold, O = L.gap, I = P && (N.length > 0 || w.length <= B), $ = typeof l == "function" ? l(r) : l;
  return p.useEffect(function() {
    ...
    var M = R.config, j = R.className, D = R.style, F = R.index, z = M, H = z.key, G = z.times, K = String(H), te = M, Z = te.className, Ne = te.style, be = te.classNames, ye = te.styles, Ke = hn(te, ug), ke = w.findIndex(function(Ue) {
      return Ue.key === K;
    }), xe = {};
    if (P) {
...
const Hs = 24, zg = 4.5, Vg = "topRight", Wg = (e) => {
  ...
  const {
    ...
    notification: m,
    direction: h
  } = p.useContext(Kt), [, A] = Qn(), E = a || g("notification"), b = (T) => $g(T, n ?? Hs, r ?? Hs), N = () => tt({
    [`${E}-rtl`]: l ?? h === "rtl"
  }), x = () => Hg(E), [w, S] = pg({
    prefixCls: E,
    style: b,
...
var tn, jt, Nn, ec, i0 = (ec = class extends Tr {
  constructor() {
    super();
    ne(this, tn);
    ne(this, jt);
...
}, tn = new WeakMap(), jt = new WeakMap(), Nn = new WeakMap(), ec), Oi = new i0(), kn, Lt, Pn, tc, s0 = (tc = class extends Tr {
  constructor() {
    super();
    ne(this, kn, !0);
    ne(this, Lt);
...
}, kn = new WeakMap(), Lt = new WeakMap(), Pn = new WeakMap(), tc), da = new s0();
function Qo() {
  let e, t;
...
function Eu(e) {
  ...
  const o = Qo(), s = (m) => {
    ...
    Promise.resolve(m).then(d).catch((A) => {
      ...
      if (r)
        return;
      const E = e.retry ?? (pn ? 0 : 3), b = e.retryDelay ?? c0, N = typeof b == "function" ? b(n, A) : b, x = E === !0 || typeof E == "number" && n < E || typeof E == "function" && E(n, A);
      if (t || !x) {
        f(A);
        return;
      }
      n++, (w = e.onFail) == null || w.call(e, n, A), r0(N).then(() => c() ? void 0 : g()).then(() => {
        t ? f(A) : v();
      });
    });
  };
...
}, nn = new WeakMap(), nc), Rn, Mn, at, Be, br, rn, lt, kt, rc, u0 = (rc = class extends wu {
  constructor(t) {
    super();
    ne(this, lt);
    ne(this, Rn);
  ...
  return {
    onFetch: (t, n) => {
      ...
      const c = async () => {
        ...
        if (a && o.length) {
          const b = a === "backward", N = b ? g0 : Qs, x = {
            pages: o,
            pageParams: s
          }, w = N(r, x);
          l = await E(x, w, b);
...
var Nu = p.createContext(
  ...
  e.unmount();
}), [e]), /* @__PURE__ */ y.jsx(Nu.Provider, { value: e, children: t })), Pu = p.createContext(!1), S0 = () => p.useContext(Pu);
Pu.Provider;
function E0() {
  let e = !1;
  return {
...
function _0(e, t, n) {
  ...
  const r = ku(), a = S0(), o = T0(), s = r.defaultQueryOptions(e);
  (d = (u = r.getDefaultOptions().queries) == null ? void 0 : u._experimental_beforeQuery) == null || d.call(
    u,
    s
  ), s._optimisticResults = a ? "isRestoring" : "optimistic", M0(s), k0(s, o), P0(o);
...
function U0({
  ...
  const r = ku(), { data: a } = B0(), { data: o } = L0(), [s, l] = p.useState(null), [i, c] = p.useState(!1), [u, d] = p.useState(Ee.createTokenMap(() => "")), [f, g] = p.useState(!1), [v, m] = p.useState(!1), [h, A] = p.useState([]);
  p.useEffect(() => {
    e && b();
  }, [e]);
...
function K0({
  ...
  const [c, u] = p.useState(""), [d, f] = p.useState(""), [g, v] = p.useState(""), [m, h] = p.useState(!1), A = p.useRef(), [E, b] = p.useState(!1), { data: N } = W0(), [x, w] = p.useState(null), [S, T] = p.useState(a), [P, L] = p.useState("0"), [_, B] = p.useState(""), [O, I] = p.useState(!1), [$, R] = p.useState(!1), [k, M] = p.useState(!1), [j, D] = p.useState(!1), [F, z] = p.useState(""), [H, G] = p.useState(""), [K, te] = p.useState(""), { t: Z } = di(), Ne = Gi(d, 800), be = Gi(c, 800), ye = p.useRef(null), [Ke, ke] = p.useState(0), xe = p.useMemo(() => S ? Ee.getToken(S).symbol : "", [S]), V = p.useMemo(() => S ? Ee.getToken(S).gasSymbol : "", [S]), [De, fe] = p.useState(!1), [Oe, Qe] = p.useState(!1), [Me, ge] = p.useState(null);
  p.useEffect(() => {
      ...
      /* @__PURE__ */ y.jsx("div", { className: "p-6 border-b border-[#EBEBEB] max-h-[70vh] overflow-y-auto", children: /* @__PURE__ */ y.jsxs("form", { children: [
        /* @__PURE__ */ y.jsxs("div", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ y.jsxs("div", { className: "relative", children: [
            ...
            k && /* @__PURE__ */ y.jsx("div", { className: "absolute right-3 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ y.jsx(vd, { className: "animate-spin", size: 16 }) }),
    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: e } = await import("./main-layout-DTLxLuyl.js");
          return { Component: e };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: e } = await import("./page-CLd1RWD_.js");
              return { Component: e };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: e } = await import("./page-BeczxHeA.js");
              return { Component: e };
            }
          },
          {
            ...
            async lazy() {
              const { default: e } = await import("./page-C_AxZTvA.js");
              return { Component: e };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: e } = await import("./page-Ccj4IAJv.js");
              return { Component: e };
            }
          },
          {
            ...
            async lazy() {
              const { default: e } = await import("./page-Dnmhugtb.js");
              return { Component: e };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-DF0kVIyr.js");
                  return { Component: e };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: e } = await import("./page-BEPjdHXw.js");
                  return { Component: e };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: e } = await import("./page-M_fR9Egu.js");
                  return { Component: e };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-Cau-hcN7.js");
                  return { Component: e };
                },
                loader: mv
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: e } = await import("./page-Cn4OrVSG.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-d1tTGHpg.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-BZwnpIPw.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: e } = await import("./page-6mFmsWvM.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: e } = await import("./page-kDZMrERN.js");
                  return { Component: e };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: e } = await import("./page-CjvsmKUP.js");
                  return { Component: e };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: e } = await import("./page-C0snN0EX.js");
                          return { Component: e };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: e } = await import("./page-C_UYtYFQ.js");
                          return { Component: e };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: e } = await import("./page-DxXGvMlb.js");
                  return { Component: e };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: e } = await import("./page-BLE28xqK.js");
                  return { Component: e };
                }
              }
            ]
          },
          {
            path: "profile",
            async lazy() {
              const { default: e } = await import("./index-S2ACOqRi.js");
              return { Component: e };
            }
          },
          {
            path: "multisender",
            async lazy() {
              const { default: e } = await import("./page-CGbV57Ki.js");
              return { Component: e };
            }
          },
          {
            path: "my-rewards",
            async lazy() {
              const { default: e } = await import("./page-BmQEIWyq.js");
              return { Component: e };
            }
          }
        ]
...
const kv = "pk_test_GGxTJn499WJaHQZ6faHNOacvCqYZuM";
