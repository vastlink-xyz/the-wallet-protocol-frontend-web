...
import { a as rt, u as ts, C as lr, B as fe, Q as cr, X as ur, i as rn, b as dr, I as hr } from "./vendor-utils-BxJrQXPu.js";
import { d as an, C as fs, c as Rt, f as ss, h as ns, E as fr, m as pr, a as mr, b as ps, i as ms, p as ys } from "./vendor-web3-BOaXhAzJ.js";
    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: t } = await import("./main-layout-C2NVJETx.js");
          return { Component: t };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: t } = await import("./page-DnZ5l3A_.js");
              return { Component: t };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: t } = await import("./page-BIFPqGSu.js");
              return { Component: t };
            }
          },
          {
            ...
            async lazy() {
              const { default: t } = await import("./page-V8pzT525.js");
              return { Component: t };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: t } = await import("./page-DIl2sbCz.js");
              return { Component: t };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-CtM1c-HW.js");
                  return { Component: t };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: t } = await import("./page-TW5ZwBF2.js");
                  return { Component: t };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: t } = await import("./page-_KXkw92Z.js");
                  return { Component: t };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-CHMMd9zj.js");
                  return { Component: t };
                },
                loader: za
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: t } = await import("./page-BnQrXKNC.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-6SIjcPCC.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-CsVzk59R.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: t } = await import("./page-CSFLx2PS.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: t } = await import("./page-Da-1AwAg.js");
                  return { Component: t };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: t } = await import("./page-D07vEKoQ.js");
                  return { Component: t };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: t } = await import("./page-DG57MuXi.js");
                          return { Component: t };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: t } = await import("./page-DNWI0cKx.js");
                          return { Component: t };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: t } = await import("./page-Cj7RUzSH.js");
                  return { Component: t };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: t } = await import("./page-uQKSxSBr.js");
                  return { Component: t };
                }
              }
            ]
