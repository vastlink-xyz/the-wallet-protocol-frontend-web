import { y as B, A as H, B as M, j as n, D as w, E as P, F as O, G as K, H as L } from "./vendor-radix-BMBq7gbN.js";
import { r as s } from "./vendor-react-BA5A8Axg.js";
import { c as j } from "./main-D5sRvz5I.js";
import { d as q } from "./vendor-ui-utils-CNDLbdLA.js";
var g = "Checkbox", [z, W] = B(g), [F, T] = z(g), N = s.forwardRef(
  (e, i) => {
    const {
      ...
      form: l,
      ...C
    } = e, [a, k] = s.useState(null), v = H(i, (r) => k(r)), y = s.useRef(!1), R = a ? l || !!a.closest("form") : !0, [f = !1, E] = M({
      prop: p,
      defaultProp: o,
      onChange: x
    }), A = s.useRef(f);
...
var S = "CheckboxIndicator", I = s.forwardRef(
  (e, i) => {
    ...
    return /* @__PURE__ */ n.jsx(O, { present: u || c(o.state) || o.state === !0, children: /* @__PURE__ */ n.jsx(
      w.span,
      {
