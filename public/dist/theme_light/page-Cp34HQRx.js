...
import { I as t, B as x, L as B, f as w, g as v, h as R, c as le } from "./main-DGj32xDv.js";
import { C as ae } from "./card-DXzFDuFR.js";
import { L as W } from "./label-DitefO_Y.js";
import { B as j } from "./vendor-utils-Ca3Nf2P-.js";
import { K as J, c as re } from "./helper-C3A8L7vk.js";
import { u as te } from "./useFlowData-WRYUTYVq.js";
import { j as ne, E as oe, m as ce } from "./vendor-ui-utils-CO-kYQvn.js";
import { S as de, v as me } from "./frankieone-DPaKqNKi.js";
import { L as ue } from "./index-BQ3tz-nv.js";
const Z = {
  registered_name: "",
  ABN: "",
  ACN: "",
...
function xe() {
  const p = se(), [h, N] = n.useState(1), [y, C] = n.useState(""), [k, F] = n.useState(!1), [d, u] = n.useState(!1), [l, S] = n.useState(null), [m, f] = n.useState(Z), [i, I] = n.useState({
    sourceOfCapital: "",
    industry: "",
    websiteUrl: "",
    socialMediaUrl: "",
...
const he = re.map((p) => ({
  ...
  const p = se(), { flowId: h, flowIndex: N, serviceUrl: y, nextIndex: C } = te(), [k, F] = n.useState(!1), [d, u] = n.useState(1), [l, S] = n.useState(""), [m, f] = n.useState(!1), [i, I] = n.useState(null), [r, Y] = n.useState(ee), [b, P] = n.useState({
    sourceOfCapital: "",
    industry: "",
    websiteUrl: "",
    socialMediaUrl: "",
