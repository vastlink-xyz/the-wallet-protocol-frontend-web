...
var l = (t, e, s) => (Pt(t, e, "read from private field"), s ? s.call(t) : e.get(t)), S = (t, e, s) => e.has(t) ? hs("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), w = (t, e, s, n) => (Pt(t, e, "write to private field"), n ? n.call(t, s) : e.set(t, s), s), M = (t, e, s) => (Pt(t, e, "access private method"), s);
var gt = (t, e, s, n) => ({
  set _(o) {
    w(t, e, o, s);
  },
...
import { j as u, S as _n, d as _s, g as Hs, P as Hn, C as qs, I as Ks, i as Ws, k as $s, l as Vs, L as Gs, m as Ys, n as qn, T as Kn, o as Xs, p as Zs, q as Js, r as Wn } from "./vendor-radix-hWeKeDdS.js";
import { p as Qe, b as en, a as x, c as tn, R as K, O as $n, u as Vn, f as Gn, h as Yn } from "./vendor-react-DM3ZG7W6.js";
import { t as Xn, c as Zn, C as Jn, a as er, b as tr, d as sr, e as nr, X as sn, L as rr, f as jt, g as nn, h as ar, i as ir, I as or } from "./vendor-ui-utils-DxmL71y2.js";
import { a as rt, u as ts, C as lr, B as be, Q as cr, X as ur, i as rn, b as dr, I as hr } from "./vendor-utils-ZATHw6Y5.js";
import { d as an, C as fs, c as Rt, f as ss, h as ns, E as fr, m as pr, a as mr, b as ps, i as ms, p as ys } from "./vendor-web3-DmEdZR0k.js";
...
const vr = er(
  ...
  ({ className: t, variant: e, size: s, asChild: n = !1, ...o }, d) => {
    ...
    return /* @__PURE__ */ u.jsx(
      f,
      {
        className: N(vr({ variant: e, size: s, className: t })),
        ref: d,
        ...o
      }
    );
...
const Pr = Tt.WEB3AUTH_WITH_MPC, Mr = Nr.getService(Pr), kr = qn, jr = Kn, Ir = x.forwardRef(({ className: t, inset: e, children: s, ...n }, o) => /* @__PURE__ */ u.jsxs(
  _s,
  {
    ref: o,
    className: N(
...
Or.displayName = Hs.displayName;
const hn = x.forwardRef(({ className: t, sideOffset: e = 4, ...s }, n) => /* @__PURE__ */ u.jsx(Hn, { children: /* @__PURE__ */ u.jsx(
  qs,
  {
    ref: n,
    sideOffset: e,
...
function Qr({
  ...
  const [i, a] = x.useState(""), [c, h] = x.useState(""), [g, m] = x.useState(""), [b, y] = x.useState(!1), [A, C] = x.useState(""), v = x.useRef(), [E, j] = x.useState(o), [F, B] = x.useState("0"), [R, P] = x.useState(!1), [H, O] = x.useState(!1), [Z, ee] = x.useState(""), [U, q] = x.useState(""), [pe, ne] = x.useState(""), { t: L } = ts();
  x.useEffect(() => {
    t ? ye(o) : lt();
  }, [t]), x.useEffect(() => {
    t && (d && a(d), f && h(f), p && m(p));
  ...
  async function Me(D) {
    try {
      ...
      ds ? (e(!1), at(ds)) : te && (be.error(Ln), e(!1));
    } catch (W) {
      const te = xt(W);
      ...
      /* @__PURE__ */ u.jsx("div", { className: "p-6 border-b border-[#EBEBEB]", children: /* @__PURE__ */ u.jsxs("form", { children: [
        /* @__PURE__ */ u.jsxs("div", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ u.jsxs("div", { className: "relative", children: [
            ...
            R && /* @__PURE__ */ u.jsx("div", { className: "absolute right-3 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ u.jsx(rr, { className: "animate-spin", size: 16 }) }),
            H && !R && !U && /* @__PURE__ */ u.jsx(jt, { className: "absolute right-3 top-1/2 transform -translate-y-1/2 text-green-500", size: 16 }),
            U && !R && /* @__PURE__ */ u.jsx(nn, { className: N(
          ...
          H && Z && /* @__PURE__ */ u.jsx("p", { className: "mt-1 text-xs text-primary/60", children: Z }),
        ...
        /* @__PURE__ */ u.jsxs("div", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ u.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ u.jsx("div", { className: "absolute left-2 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ u.jsxs(kr, { children: [
              ...
              /* @__PURE__ */ u.jsx(hn, { align: "start", className: "bg-white", children: Lr.map((D) => /* @__PURE__ */ u.jsx(fn, { onClick: () => ye(D), children: D }, D)) })
            ] }) })
          ] }),
      ...
      /* @__PURE__ */ u.jsxs("footer", { className: "flex justify-end items-center gap-3 px-5 py-[14px]", children: [
        ...
        /* @__PURE__ */ u.jsx(
          wt,
          {
            ...
            className: N("py-12px"),
            disabled: me,
            children: b ? /* @__PURE__ */ u.jsx("div", { className: "", children: /* @__PURE__ */ u.jsx(Rr, {}) }) : /* @__PURE__ */ u.jsx("span", { children: L("/dashboard.[token].sendModal.title") })
          }
        )
      ] })
    ] }) })
...
}, gn = 128, bn = "L", vn = "#FFFFFF", xn = "#000000", wn = !1, Cn = 1, qr = 4, Kr = 0, Wr = 0.1;
function En(t, e = 0) {
  const s = [];
...
function Vr(t, e) {
  return e != null ? Math.max(Math.floor(e), 0) : t ? qr : Kr;
}
function An({
  value: t,
  level: e,
  ...
  const { cells: i, margin: a, numCells: c, calculatedImageSettings: h } = K.useMemo(() => {
    let g = r.getModules();
    const m = Vr(n, o), b = g.length + m * 2, y = $r(
      g,
      f,
      m,
      d
...
var Gr = function() {
  ...
  function(e, s) {
    const n = e, {
      ...
      "marginSize",
      "imageSettings"
    ]), { style: y } = b, A = Lt(b, ["style"]), C = g == null ? void 0 : g.src, v = K.useRef(null), E = K.useRef(null), j = K.useCallback(
      (U) => {
        v.current = U, typeof s == "function" ? s(U) : s && (s.current = U);
      },
      [s]
    ), [F, B] = K.useState(!1), { margin: R, cells: P, numCells: H, calculatedImageSettings: O } = An({
      value: o,
      level: f,
      minVersion: a,
      boostLevel: c,
    ...
    K.useEffect(() => {
      if (v.current != null) {
        ...
        const ye = d / H * me;
        q.scale(ye, ye), q.fillStyle = p, q.fillRect(0, 0, H, H), q.fillStyle = r, Gr ? q.fill(new Path2D(En(pe, R))) : P.forEach(function(Ne, Pe) {
...
var Qt = K.forwardRef(
  function(e, s) {
    const n = e, {
      ...
      "marginSize",
      "imageSettings"
    ]), { margin: y, cells: A, numCells: C, calculatedImageSettings: v } = An({
      value: o,
      level: f,
      minVersion: a,
      boostLevel: c,
    ...
    let E = A, j = null;
    m != null && v != null && (v.excavation != null && (E = Sn(
      A,
      v.excavation
...
function Mn(t) {
  ...
  const d = Wt(), f = (b) => {
    var y;
    n || (h(new Pn(b)), (y = t.abort) == null || y.call(t));
  }, p = () => {
    e = !0;
  }, r = () => {
    e = !1;
  }, i = () => ls.isFocused() && (t.networkMode === "always" || At.isOnline()) && t.canRun(), a = () => Nn(t.networkMode) && t.canRun(), c = (b) => {
    var y;
    n || (n = !0, (y = t.onSuccess) == null || y.call(t, b), o == null || o(), d.resolve(b));
  }, h = (b) => {
    var y;
    n || (n = !0, (y = t.onError) == null || y.call(t, b), o == null || o(), d.reject(b));
  }, g = () => new Promise((b) => {
    var y;
    o = (A) => {
      (n || i()) && b(A);
    ...
    Promise.resolve(b).then(c).catch((A) => {
      ...
      if (n)
        return;
      const C = t.retry ?? (_e ? 0 : 3), v = t.retryDelay ?? ra, E = typeof v == "function" ? v(s, A) : v, j = C === !0 || typeof C == "number" && s < C || typeof C == "function" && C(s, A);
      if (e || !j) {
        h(A);
        return;
      }
      s++, (F = t.onFail) == null || F.call(t, s, A), Jr(E).then(() => i() ? void 0 : g()).then(() => {
        e ? h(A) : m();
      });
    });
  };
...
}, Oe = new WeakMap(), Ds), Ve, Ge, re, G, ht, De, ie, ge, Fs, ia = (Fs = class extends kn {
  constructor(e) {
    super();
    S(this, ie);
    S(this, Ve);
...
var ce, Bs, la = (Bs = class extends yt {
  ...
  async execute(e) {
    var o, d, f, p, r, i, a, c, h, g, m, b, y, A, C, v, E, j, F, B;
    w(this, Fe, Mn({
...
function Ts(t) {
  return {
    onFetch: (e, s) => {
      var a, c, h, g, m;
      const n = e.options, o = (h = (c = (a = e.fetchOptions) == null ? void 0 : a.meta) == null ? void 0 : c.fetchMore) == null ? void 0 : h.direction, d = ((g = e.state.data) == null ? void 0 : g.pages) || [], f = ((m = e.state.data) == null ? void 0 : m.pageParams) || [];
      ...
      const i = async () => {
        ...
        const y = (v) => {
        ...
        }, A = Tn(e.options, e.fetchOptions), C = async (v, E, j) => {
          if (b)
          ...
          const B = await A(
            F
          ), { maxPages: R } = e.options, P = j ? ta : ea;
          return {
            pages: P(v.pages, B, R),
        ...
        if (o && d.length) {
          const v = o === "backward", E = v ? ha : Ns, j = {
            pages: d,
            pageParams: f
          }, F = E(n, j);
          p = await C(j, F, v);
...
var z, Ee, Se, Ye, Xe, Ae, Ze, Je, Qs, fa = (Qs = class {
...
}, z = new WeakMap(), Ee = new WeakMap(), Se = new WeakMap(), Ye = new WeakMap(), Xe = new WeakMap(), Ae = new WeakMap(), Ze = new WeakMap(), Je = new WeakMap(), Qs), J, k, pt, X, Be, et, Re, he, mt, tt, st, Ue, Le, Te, nt, I, ct, $t, Vt, Gt, Yt, Xt, Zt, Jt, In, zs, pa = (zs = class extends yt {
  constructor(e, s) {
    super();
    S(this, I);
    S(this, J);
  ...
  onSubscribe() {
    this.listeners.size === 1 && (l(this, k).addObserver(this), Ps(l(this, k), this.options) ? M(this, I, ct).call(this) : this.updateResult(), M(this, I, Yt).call(this));
  }
  onUnsubscribe() {
  ...
  destroy() {
    this.listeners = /* @__PURE__ */ new Set(), M(this, I, Xt).call(this), M(this, I, Zt).call(this), l(this, k).removeObserver(this);
  }
  setOptions(e, s) {
    ...
    M(this, I, Jt).call(this), l(this, k).setOptions(this.options), n._defaulted && !Ht(this.options, n) && l(this, J).getQueryCache().notify({
    ...
    d && Ms(
      ...
      this.options,
      n
    ) && M(this, I, ct).call(this), this.updateResult(s), d && (l(this, k) !== o || oe(this.options.enabled, l(this, k)) !== oe(n.enabled, l(this, k)) || qe(this.options.staleTime, l(this, k)) !== qe(n.staleTime, l(this, k))) && M(this, I, $t).call(this);
    const f = M(this, I, Vt).call(this);
    d && (l(this, k) !== o || oe(this.options.enabled, l(this, k)) !== oe(n.enabled, l(this, k)) || f !== l(this, Te)) && M(this, I, Gt).call(this, f);
  }
  getOptimisticResult(e) {
    const s = l(this, J).getQueryCache().build(l(this, J), e), n = this.createResult(s, e);
    return ya(this, n) && (w(this, X, n), w(this, et, this.options), w(this, Be, l(this, k).state)), n;
  }
  getCurrentResult() {
    return l(this, X);
  }
  ...
  createResult(e, s) {
    ...
    if (s.select && c.data !== void 0)
      if (d && c.data === (f == null ? void 0 : f.data) && s.select === l(this, mt))
        ...
        try {
          w(this, mt, s.select), g = s.select(c.data), g = Kt(d == null ? void 0 : d.data, g, s), w(this, tt, g), w(this, he, null);
        } catch (P) {
          w(this, he, P);
        }
    else
  ...
  updateResult(e) {
    ...
    if (w(this, Be, l(this, k).state), w(this, et, this.options), l(this, Be).data !== void 0 && w(this, st, l(this, k)), Ht(n, s))
      return;
    w(this, X, n);
    const o = {}, d = () => {
      if (!s)
    ...
    (e == null ? void 0 : e.listeners) !== !1 && d() && (o.listeners = !0), M(this, I, In).call(this, { ...o, ...e });
  }
  onQueryUpdate() {
    this.updateResult(), this.hasListeners() && M(this, I, Yt).call(this);
  }
  ...
  M(this, I, Zt).call(this), w(this, Te, e), !(_e || oe(this.options.enabled, l(this, k)) === !1 || !zt(l(this, Te)) || l(this, Te) === 0) && w(this, Le, setInterval(() => {
    (this.options.refetchIntervalInBackground || ls.isFocused()) && M(this, I, ct).call(this);
  }, l(this, Te)));
}, Yt = function() {
  M(this, I, $t).call(this), M(this, I, Gt).call(this, M(this, I, Vt).call(this));
}, Xt = function() {
    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: t } = await import("./main-layout-Bkdjxc12.js");
          return { Component: t };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: t } = await import("./page-C9kCDqfU.js");
              return { Component: t };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: t } = await import("./page-DSV5rU6g.js");
              return { Component: t };
            }
          },
          {
            ...
            async lazy() {
              const { default: t } = await import("./page-B5b8FGRb.js");
              return { Component: t };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: t } = await import("./page-Dm0llKju.js");
              return { Component: t };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-B84vf8Yw.js");
                  return { Component: t };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: t } = await import("./page-CLDouYvP.js");
                  return { Component: t };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: t } = await import("./page-CiyNy14F.js");
                  return { Component: t };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: t } = await import("./page-DDpLObQ6.js");
                  return { Component: t };
                },
                loader: za
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: t } = await import("./page-D3TIRMUs.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-DWvO030G.js");
                  return { Component: t };
                }
              },
              {
                ...
                async lazy() {
                  const { default: t } = await import("./page-BOpDjcuW.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: t } = await import("./page-Cqh6l-YM.js");
                  return { Component: t };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: t } = await import("./page-CCwAKbTs.js");
                  return { Component: t };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: t } = await import("./page-TpQal24E.js");
                  return { Component: t };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: t } = await import("./page-BUso1BwE.js");
                          return { Component: t };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: t } = await import("./page-JvoT8fTX.js");
                          return { Component: t };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: t } = await import("./page-BhOWTCGJ.js");
                  return { Component: t };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: t } = await import("./page-B40ssde4.js");
                  return { Component: t };
                }
              }
            ]
...
var us = "moonpay-react-sdk-embedded-frame", qa = ({
  props: t,
  apiKey: e,
  debug: s,
  environment: n,
...
function mi() {
  return /* @__PURE__ */ u.jsx("div", { className: "font-['Roboto']", children: /* @__PURE__ */ u.jsx(x.Suspense, { children: /* @__PURE__ */ u.jsx(ba, { client: pi, children: /* @__PURE__ */ u.jsxs(hr, { i18n: rn, children: [
    /* @__PURE__ */ u.jsx(ti, { children: /* @__PURE__ */ u.jsx(Yn, { router: _a }) }),
    /* @__PURE__ */ u.jsx(Ha, {})
  ] }) }) }) });
}
const yi = "theme_light", gi = "0.0.0", bi = "module", vi = {
  dev: "vite",
...
cn ? js("root") : typeof window < "u" && (window[`mount_${Ci.name}`] = js);
export {
  wt as B,
  Ot as C,
  kr as D,
