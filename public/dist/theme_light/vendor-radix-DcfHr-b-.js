import { r as c, p as uo, a as Zt, R as ze, $ as ba, b as Ca } from "./vendor-react-Cqw-pUgZ.js";
var Ln = { exports: {} }, ht = {};
/**
 * @license React
...
uo.env.NODE_ENV === "production" ? Ln.exports = Ea() : Ln.exports = Sa();
var h = Ln.exports;
function Ra(e, t) {
...
var Ma = "Label", vo = c.forwardRef((e, t) => /* @__PURE__ */ h.jsx(
  F.label,
  {
    ...e,
    ref: t,
...
function Fe({
  ...
  const [r, o] = Da({ defaultProp: t, onChange: n }), i = e !== void 0, s = i ? e : r, a = xe(n), l = c.useCallback(
    (u) => {
      if (i) {
...
var ye = "MenuContent", [vu, dr] = Qe(ye), ri = c.forwardRef(
  ...
  (e, t) => {
    const {
      ...
      ...v
    } = e, x = et(ye, n), b = Mt(ye, n), y = dn(n), C = Qo(n), S = cu(n), [R, O] = c.useState(null), P = c.useRef(null), M = q(t, P, x.onContentChange), $ = c.useRef(0), W = c.useRef(""), G = c.useRef(0), V = c.useRef(null), k = c.useRef("right"), L = c.useRef(0), z = w ? _t : c.Fragment, N = w ? { as: Le, allowPinchZoom: !0 } : void 0, H = (A) => {
      var I, Y;
...
var Xi = "DialogTitleWarning", [_d, qi] = Oa(Xi, {
  contentName: qe,
  titleName: xr,
  docsSlug: "dialog"
}), mf = ({ titleId: e }) => {
...
}, Ad = ki, Md = Fi, Od = Wi, Id = Bi, Dd = Vi, Nd = Ui, jd = Gi, kd = zi, Cr = "Tabs", [wf, Ld] = Je(Cr, [
  ln
]), Zi = ln(), [yf, Er] = wf(Cr), Ji = c.forwardRef(
  (e, t) => {
    const {
      __scopeTabs: n,
      value: r,
...
Ji.displayName = Cr;
var Qi = "TabsList", es = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, loop: r = !0, ...o } = e, i = Er(Qi, n), s = Zi(n);
    return /* @__PURE__ */ h.jsx(
      Bo,
      {
        asChild: !0,
...
es.displayName = Qi;
var ts = "TabsTrigger", ns = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, value: r, disabled: o = !1, ...i } = e, s = Er(ts, n), a = Zi(n), l = is(s.baseId, r), u = ss(s.baseId, r), f = r === s.value;
    return /* @__PURE__ */ h.jsx(
      Vo,
      {
        asChild: !0,
...
ns.displayName = ts;
var rs = "TabsContent", os = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, value: r, forceMount: o, children: i, ...s } = e, a = Er(rs, n), l = is(a.baseId, r), u = ss(a.baseId, r), f = r === a.value, d = c.useRef(f);
    return c.useEffect(() => {
...
var Fd = Ji, $d = es, Wd = ns, Bd = os, xf = "VisuallyHidden", Sr = c.forwardRef(
  (e, t) => /* @__PURE__ */ h.jsx(
    F.span,
    {
      ...e,
...
Sr.displayName = xf;
var bf = Sr, [vn, Vd] = Je("Tooltip", [
  He
]), mn = He(), as = "TooltipProvider", Cf = 700, Yn = "tooltip.open", [Ef, Rr] = vn(as), cs = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Cf,
...
cs.displayName = as;
var hn = "Tooltip", [Sf, gn] = vn(hn), ls = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
...
us.displayName = zn;
var Rf = "TooltipPortal", [Hd, Pf] = vn(Rf, {
  forceMount: void 0
}), lt = "TooltipContent", fs = c.forwardRef(
  (e, t) => {
    const n = Pf(lt, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...i } = e, s = gn(lt, e.__scopeTooltip);
    return /* @__PURE__ */ h.jsx(be, { present: r || s.open, children: s.disableHoverableContent ? /* @__PURE__ */ h.jsx(ds, { side: o, ...i, ref: t }) : /* @__PURE__ */ h.jsx(Tf, { side: o, ...i, ref: t }) });
  }
), Tf = c.forwardRef((e, t) => {
  const n = gn(lt, e.__scopeTooltip), r = Rr(lt, e.__scopeTooltip), o = c.useRef(null), i = q(t, o), [s, a] = c.useState(null), { trigger: l, onClose: u } = n, f = o.current, { onPointerInTransitChange: d } = r, m = c.useCallback(() => {
    ...
    (w, v) => {
      const x = w.currentTarget, b = { x: w.clientX, y: w.clientY }, y = Of(b, x.getBoundingClientRect()), C = If(b, y), S = Df(v.getBoundingClientRect()), R = jf([...C, ...S]);
      a(R), d(!0);
    },
    [d]
  );
  return c.useEffect(() => () => m(), [m]), c.useEffect(() => {
    ...
    if (s) {
      const w = (v) => {
        const x = v.target, b = { x: v.clientX, y: v.clientY }, y = (l == null ? void 0 : l.contains(x)) || (f == null ? void 0 : f.contains(x)), C = !Nf(b, s);
        y ? m() : C && (m(), u());
      };
...
}), [_f, Af] = vn(hn, { isInside: !1 }), ds = c.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
        ...
        children: /* @__PURE__ */ h.jsxs(
          sn,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ h.jsx(_f, { scope: n, isInside: !0, children: /* @__PURE__ */ h.jsx(bf, { id: l.contentId, role: "tooltip", children: o || r }) })
            ]
          }
        )
      }
...
fs.displayName = lt;
var ps = "TooltipArrow", Mf = c.forwardRef(
  (e, t) => {
...
function jf(e) {
  const t = e.slice();
  return t.sort((n, r) => n.x < r.x ? -1 : n.x > r.x ? 1 : n.y < r.y ? -1 : n.y > r.y ? 1 : 0), kf(t);
}
function kf(e) {
...
var Ff = [" ", "Enter", "ArrowUp", "ArrowDown"], $f = [" ", "Enter"], Ot = "Select", [wn, yn, Wf] = tr(Ot), [vt, zd] = Je(Ot, [
  Wf,
  He
]), xn = He(), [Bf, Ue] = vt(Ot), [Vf, Hf] = vt(Ot), vs = (e) => {
  const {
    __scopeSelect: t,
    children: n,
    open: r,
...
ws.displayName = gs;
var Uf = "SelectIcon", ys = c.forwardRef(
  (e, t) => {
...
ys.displayName = Uf;
var Kf = "SelectPortal", xs = (e) => /* @__PURE__ */ h.jsx(Tt, { asChild: !0, ...e });
xs.displayName = Kf;
...
bs.displayName = Ze;
var Se = 10, [Cs, Ke] = vt(Ze), Gf = "SelectContentImpl", Es = c.forwardRef(
  (e, t) => {
    const {
      __scopeSelect: n,
...
Es.displayName = Gf;
var Yf = "SelectItemAlignedPosition", Ss = c.forwardRef((e, t) => {
...
Xn.displayName = zf;
var [Xf, Pr] = vt(Ze, {}), qn = "SelectViewport", Rs = c.forwardRef(
  (e, t) => {
...
Rs.displayName = qn;
var Ps = "SelectGroup", [qf, Zf] = vt(Ps), Ts = c.forwardRef(
  (e, t) => {
...
var _s = "SelectLabel", As = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, ...r } = e, o = Zf(_s, n);
    return /* @__PURE__ */ h.jsx(F.div, { id: o.id, ...r, ref: t });
  }
);
As.displayName = _s;
var qt = "SelectItem", [Jf, Ms] = vt(qt), Os = c.forwardRef(
  (e, t) => {
    const {
      __scopeSelect: n,
      value: r,
...
var yt = "SelectItemText", Is = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, className: r, style: o, ...i } = e, s = Ue(yt, n), a = Ke(yt, n), l = Ms(yt, n), u = Hf(yt, n), [f, d] = c.useState(null), m = q(
      t,
      (b) => d(b),
      l.onItemTextChange,
      (b) => {
...
}), Qf = "SelectSeparator", Fs = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, ...r } = e;
...
var Ws = c.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = c.useRef(null), i = q(t, o), s = Lf(n);
    return c.useEffect(() => {
...
var Xd = vs, qd = hs, Zd = ws, Jd = ys, Qd = xs, ep = bs, tp = Rs, np = Ts, rp = As, op = Os, ip = Is, sp = Ns, ap = js, cp = ks, lp = Fs, Tr = "Popover", [Hs, up] = Je(Tr, [
  He
]), It = He(), [nd, Ge] = Hs(Tr), Us = (e) => {
  const {
    __scopePopover: t,
    children: n,
    open: r,
...
Us.displayName = Tr;
var Ks = "PopoverAnchor", rd = c.forwardRef(
  (e, t) => {
...
Ys.displayName = Gs;
var _r = "PopoverPortal", [od, id] = Hs(_r, {
  forceMount: void 0
}), zs = (e) => {
...
), Zs = "PopoverClose", cd = c.forwardRef(
  (e, t) => {
