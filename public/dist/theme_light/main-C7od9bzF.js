...
import { j as v, S as Hu, d as Vs, g as Ws, P as Uu, C as Ks, I as Gs, i as Qs, k as qs, l as Xs, L as Ys, m as Zs, n as zu, T as Vu, o as Js, p as ec, q as tc, r as Wu } from "./vendor-radix-DAGGyvqc.js";
import { p as K, b as Uo, a as p, e as Ku, R as q, c as Kn, $ as zo, f as Gu, O as Qu, u as qu, h as Xu, i as Yu } from "./vendor-react-BNvQ9I2c.js";
import { t as Zu, c as Ju, C as ed, a as td, b as nd, d as rd, e as ad, _ as Ze, X as Vo, L as od, f as Pa, g as nc, h as id, i as sd, j as cd, I as ld } from "./vendor-ui-utils-CsaM-dHT.js";
import { a as jn, u as Wo, C as ud, B as st, Q as dd, X as fd, i as rc, b as hd, I as pd } from "./vendor-utils-B-eF5hYT.js";
import { d as ac, c as lr, h as Xr, e as md, C as Ci, f as Jt, E as gd, m as vd, a as yd, b as Si, _ as ue, t as bd, g as $, i as Z, j as an, p as gn, k as Ei } from "./vendor-web3-DanlmASa.js";
import "./vendor-walletconnect-CMJerlJy.js";
var Ra, vr = Uo;
...
const Td = td(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, o) => {
    ...
    return /* @__PURE__ */ v.jsx(
      i,
      {
        className: te(Td({ variant: t, size: n, className: e })),
        ref: o,
        ...a
      }
    );
...
function lc({
  ...
  const s = n === "breathe" ? /* @__PURE__ */ v.jsxs("div", { className: "flex items-center justify-center", children: [
    /* @__PURE__ */ v.jsx(Md, { className: te(
  ...
  function u(f, g, y) {
    ...
    return function(T) {
      ...
      var F = Va($($({}, U), {}, {
        ...
        if (m.injectStyle === !1)
          return [];
        var G = sp(j), Q = G.token, ne = G.flush, ee = as(S, M, y), Pe = ".".concat(T), xe = ns(S, M, ee, {
  ...
  var ee = uo(function(fe) {
    ...
    if (de !== Nt) {
      ...
      if (!(fe && !fe.deadline && fe.target !== Ee)) {
        var Ge = Q.current, Be;
        de === wr && Ge ? Be = T == null ? void 0 : T(Ee, fe) : de === Tr && Ge ? Be = N == null ? void 0 : N(Ee, fe) : de === Ar && Ge && (Be = C == null ? void 0 : C(Ee, fe)), Ge && Be !== !1 && ne();
      }
    }
...
var X = {
  ...
  p.useEffect(function() {
    ...
    if (!R && P && (c || D === 0)) {
      var G = performance.now(), Q, ne = function ee() {
  ...
  return /* @__PURE__ */ p.createElement("div", Ze({}, m, {
    ...
    onMouseEnter: function(Q) {
      var ne;
      C(!0), m == null || (ne = m.onMouseEnter) === null || ne === void 0 || ne.call(m, Q);
    },
    onMouseLeave: function(Q) {
      var ne;
      C(!1), m == null || (ne = m.onMouseLeave) === null || ne === void 0 || ne.call(m, Q);
    },
    onClick: h
  ...
  return p.useEffect(function() {
    ...
    var k = R.config, O = R.className, _ = R.style, L = R.index, U = k, F = U.key, G = U.times, Q = String(F), ne = k, ee = ne.className, Pe = ne.style, xe = ne.classNames, Se = ne.styles, We = an(ne, Dm), ge = N.findIndex(function(Be) {
      return Be.key === Q;
    }), ke = {};
    if (M) {
...
function tr() {
  ...
  function M(R, P) {
    function k(_, L, U, F) {
      var G = d(R[_], R, L);
      if (G.type !== "throw") {
        var Q = G.arg, ne = Q.value;
        return ne && ue(ne) == "object" && r.call(ne, "__await") ? P.resolve(ne.__await).then(function(ee) {
          k("next", ee, U, F);
        }, function(ee) {
          k("throw", ee, U, F);
        }) : P.resolve(ne).then(function(ee) {
          Q.value = ee, U(Q);
        }, function(ee) {
  ...
  return S.prototype = x, a(C, "constructor", {
    ...
    dispatchException: function(P) {
      ...
      var k = this;
      function O(Q, ne) {
        return U.type = "throw", U.arg = P, k.next = Q, ne && (k.method = "next", k.arg = e), !!ne;
      }
...
function yv({
  ...
  const [c, u] = p.useState(""), [d, f] = p.useState(""), [g, y] = p.useState(""), [m, h] = p.useState(!1), [E, S] = p.useState(""), x = p.useRef(), [w, T] = p.useState(!1), { data: N } = gv(), [C, A] = p.useState(a), [M, I] = p.useState("0"), [j, H] = p.useState(""), [B, D] = p.useState(!1), [W, R] = p.useState(!1), [P, k] = p.useState(!1), [O, _] = p.useState(!1), [L, U] = p.useState(""), [F, G] = p.useState(""), [Q, ne] = p.useState(""), { t: ee } = Wo(), Pe = Ni(d, 800), xe = Ni(c, 800);
  p.useEffect(() => {
  ...
  const et = (re) => {
    ...
    f(re.target.value.trim()), parseFloat(d) > parseFloat(M) ? ne("Amount exceeded") : ne("");
      ...
      /* @__PURE__ */ v.jsx("div", { className: "p-6 border-b border-[#EBEBEB]", children: /* @__PURE__ */ v.jsxs("form", { children: [
        /* @__PURE__ */ v.jsxs("div", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ v.jsxs("div", { className: "relative", children: [
            ...
            F && !P && /* @__PURE__ */ v.jsx(nc, { className: te(
          ...
          F && /* @__PURE__ */ v.jsx("p", { className: te(
      ...
      children: [
        ...
        /* @__PURE__ */ v.jsxs("div", { className: te(
          ...
          /* @__PURE__ */ v.jsxs("div", { children: [
            ...
            /* @__PURE__ */ v.jsxs("div", { className: "flex items-start gap-2 tablet:w-[350px]", children: [
              /* @__PURE__ */ v.jsx(
                "img",
                {
                  src: a,
...
const $v = 30, Bv = async () => {
...
}, Hv = Xu([
  {
    path: "/",
    async lazy() {
      const { RootLayout: e } = await import("./root-layout-BpLcoYB1.js");
      return { Component: e };
    },
    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: e } = await import("./main-layout-CD-IWNzt.js");
          return { Component: e };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: e } = await import("./page-AG9hO0NF.js");
              return { Component: e };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: e } = await import("./page-QnR-HJNk.js");
              return { Component: e };
            }
          },
          {
            ...
            async lazy() {
              const { default: e } = await import("./page-fp2dKpsE.js");
              return { Component: e };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: e } = await import("./page-B_drRgCT.js");
              return { Component: e };
            }
          },
          {
            ...
            async lazy() {
              const { default: e } = await import("./page-BTGujyY-.js");
              return { Component: e };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-DLrMsdjw.js");
                  return { Component: e };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: e } = await import("./page-DRZB9CT1.js");
                  return { Component: e };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: e } = await import("./page--DzJptdi.js");
                  return { Component: e };
                }
              },
              {
                path: "multisender",
                async lazy() {
                  const { default: e } = await import("./page-Cz2027OB.js");
                  return { Component: e };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-Co2Gt5-S.js");
                  return { Component: e };
                },
                loader: Bv
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: e } = await import("./page-DhMzUdGi.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-CRFt4ZW4.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-Xs3po7-r.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: e } = await import("./page-CVPNrrbn.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: e } = await import("./page-2dCXbC9m.js");
                  return { Component: e };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: e } = await import("./page-DIQEa_J-.js");
                  return { Component: e };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: e } = await import("./page-QoZzhkwc.js");
                          return { Component: e };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: e } = await import("./page-CPhsyIzw.js");
                          return { Component: e };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: e } = await import("./page-0FrSqH5u.js");
                  return { Component: e };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: e } = await import("./page-CRUBiXfd.js");
                  return { Component: e };
                }
              }
            ]
          },
          {
            path: "profile",
            async lazy() {
              const { default: e } = await import("./index-zkWGSHLi.js");
              return { Component: e };
            }
          }
        ]
