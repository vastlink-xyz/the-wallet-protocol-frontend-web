import { g as ts, B as ns } from "./vendor-web3-A0hL30sH.js";
import { p as ce, r as M, e as J, g as rs } from "./vendor-react-X5c0QESR.js";
import { c as Re } from "./vendor-ui-utils-5hin2QBi.js";
function sr(t, e) {
  return function() {
    return t.apply(e, arguments);
  };
}
const { toString: ss } = Object.prototype, { getPrototypeOf: rn } = Object, mt = /* @__PURE__ */ ((t) => (e) => {
  const n = ss.call(e);
  return t[n] || (t[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), ve = (t) => (t = t.toLowerCase(), (e) => mt(e) === t), yt = (t) => (e) => typeof e === t, { isArray: $e } = Array, He = yt("undefined");
function is(t) {
  return t !== null && !He(t) && t.constructor !== null && !He(t.constructor) && de(t.constructor.isBuffer) && t.constructor.isBuffer(t);
}
const ir = ve("ArrayBuffer");
function os(t) {
  let e;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? e = ArrayBuffer.isView(t) : e = t && t.buffer && ir(t.buffer), e;
}
const as = yt("string"), de = yt("function"), or = yt("number"), vt = (t) => t !== null && typeof t == "object", ls = (t) => t === !0 || t === !1, st = (t) => {
  if (mt(t) !== "object")
    return !1;
  const e = rn(t);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(Symbol.toStringTag in t) && !(Symbol.iterator in t);
}, us = ve("Date"), cs = ve("File"), fs = ve("Blob"), ds = ve("FileList"), ps = (t) => vt(t) && de(t.pipe), hs = (t) => {
  let e;
  return t && (typeof FormData == "function" && t instanceof FormData || de(t.append) && ((e = mt(t)) === "formdata" || // detect form-data instance
  e === "object" && de(t.toString) && t.toString() === "[object FormData]"));
}, gs = ve("URLSearchParams"), [ms, ys, vs, bs] = ["ReadableStream", "Request", "Response", "Headers"].map(ve), Es = (t) => t.trim ? t.trim() : t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const Le = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : ts, lr = (t) => !He(t) && t !== Le;
function Ut() {
  const { caseless: t } = lr(this) && this || {}, e = {}, n = (r, s) => {
    const i = t && ar(e, s) || s;
    st(e[i]) && st(r) ? e[i] = Ut(e[i], r) : st(r) ? e[i] = Ut({}, r) : $e(r) ? e[i] = r.slice() : e[i] = r;
  };
  for (let r = 0, s = arguments.length; r < s; r++)
    arguments[r] && qe(arguments[r], n);
  return e;
}
const ws = (t, e, n, { allOwnKeys: r } = {}) => (qe(e, (s, i) => {
  n && de(s) ? t[i] = sr(s, n) : t[i] = s;
}, { allOwnKeys: r }), t), Ss = (t) => (t.charCodeAt(0) === 65279 && (t = t.slice(1)), t), Ts = (t, e, n, r) => {
  ...
  for (; e-- > 0; )
    n[e] = t[e];
  return n;
}, Cs = /* @__PURE__ */ ((t) => (e) => t && e instanceof t)(typeof Uint8Array < "u" && rn(Uint8Array)), Ps = (t, e) => {
  ...
  for (; (n = t.exec(e)) !== null; )
    r.push(n);
  return r;
}, As = ve("HTMLFormElement"), Ns = (t) => t.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), hn = (({ hasOwnProperty: t }) => (e, n) => t.call(e, n))(Object.prototype), _s = ve("RegExp"), ur = (t, e) => {
...
}, $s = (t, e) => t != null && Number.isFinite(t = +t) ? t : e, Ct = "abcdefghijklmnopqrstuvwxyz", gn = "0123456789", cr = {
  DIGIT: gn,
  ALPHA: Ct,
  ALPHA_DIGIT: Ct + Ct.toUpperCase() + gn
}, Bs = (t = 16, e = cr.ALPHA_DIGIT) => {
  let n = "";
  const { length: r } = e;
  for (; t--; )
    n += e[Math.random() * r | 0];
...
const Fs = (t) => {
  ...
  return n(t, 0);
}, js = ve("AsyncFunction"), Us = (t) => t && (vt(t) || de(t)) && de(t.then) && de(t.catch), fr = ((t, e) => t ? setImmediate : e ? ((n, r) => (Le.addEventListener("message", ({ source: s, data: i }) => {
  ...
  de(Le.postMessage)
), Hs = typeof queueMicrotask < "u" ? queueMicrotask.bind(Le) : typeof ce < "u" && ce.nextTick || fr, g = {
  isArray: $e,
  isArrayBuffer: ir,
  isBuffer: is,
  isFormData: hs,
...
function mn(t, e, n) {
  return t ? t.concat(e).map(function(s, i) {
    return s = hr(s), !n && i ? "[" + s + "]" : s;
  }).join(n ? "." : "") : e;
}
function Vs(t) {
  return g.isArray(t) && !t.some(Ht);
}
const Ks = g.toFlatObject(g, {}, null, function(e) {
...
function bt(t, e, n) {
  ...
  function c(p) {
    ...
    return g.isArrayBuffer(p) || g.isTypedArray(p) ? l && typeof Blob == "function" ? new Blob([p]) : ns.from(p) : p;
  }
  function u(p, m, h) {
    let w = p;
    if (p && !h && typeof p == "object") {
      ...
      else if (g.isArray(p) && Vs(p) || (g.isFileList(p) || g.endsWith(m, "[]")) && (w = g.toArray(p)))
        return m = hr(m), w.forEach(function(E, T) {
          !(g.isUndefined(E) || E === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            o === !0 ? mn([m], T, i) : o === null ? m : m + "[]",
            c(E)
          );
        }), !1;
    }
    return Ht(p) ? !0 : (e.append(mn(h, m, i), c(p)), !1);
  }
  const d = [], f = Object.assign(Ks, {
    defaultVisitor: u,
    convertValue: c,
    isVisitable: Ht
  });
...
function mr(t, e, n) {
  ...
  let i;
  if (s ? i = s(e, n) : i = g.isURLSearchParams(e) ? e.toString() : new sn(e, n).toString(r), i) {
    const o = t.indexOf("#");
...
}, Js = typeof URLSearchParams < "u" ? URLSearchParams : sn, Ws = typeof FormData < "u" ? FormData : null, Ys = typeof Blob < "u" ? Blob : null, Qs = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Js,
    FormData: Ws,
...
}, on = typeof window < "u" && typeof document < "u", zt = typeof navigator == "object" && navigator || void 0, Xs = on && (!zt || ["ReactNative", "NativeScript", "NS"].indexOf(zt.product) < 0), Gs = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", Zs = on && window.location.href || "http://localhost", ei = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: on,
...
function ti(t, e) {
  return bt(t, new ae.classes.URLSearchParams(), Object.assign({
...
function vr(t) {
  function e(n, r, s, i) {
    ...
    return o = !o && g.isArray(s) ? s.length : o, l ? (g.hasOwnProp(s, o) ? s[o] = [s[o], r] : s[o] = r, !a) : ((!s[o] || !g.isObject(s[o])) && (s[o] = []), e(n, r, s[o], i) && g.isArray(s[o]) && (s[o] = ri(s[o])), !a);
  }
...
const Je = {
  ...
  transformRequest: [function(e, n) {
    ...
    return i || s ? (n.setContentType("application/json", !1), si(e)) : e;
  }],
...
const ii = g.toObjectSet([
  ...
  return t && t.split(`
`).forEach(function(o) {
    s = o.indexOf(":"), n = o.substring(0, s).trim().toLowerCase(), r = o.substring(s + 1).trim(), !(!n || e[n] && ii[n]) && (n === "set-cookie" ? e[n] ? e[n].push(r) : e[n] = [r] : e[n] = e[n] ? e[n] + ", " + r : r);
  }), e;
}, bn = Symbol("internals");
function Me(t) {
...
function it(t) {
  return t === !1 || t == null ? t : g.isArray(t) ? t.map(it) : String(t);
}
function ai(t) {
...
class le {
  ...
  normalize(e) {
    ...
    return g.forEach(this, (s, i) => {
      ...
      const a = e ? ui(i) : String(i).trim();
      a !== i && delete n[i], n[a] = it(s), r[a] = !0;
    }), this;
  }
  concat(...e) {
...
}, wn = (t) => (...e) => g.asap(() => t(...e)), hi = ae.hasStandardBrowserEnv ? (
...
function wr(t, e) {
  return t && !mi(e) ? yi(t, e) : e;
}
const Sn = (t) => t instanceof le ? { ...t } : t;
function Ie(t, e) {
  e = e || {};
  const n = {};
  function r(c, u, d) {
...
const Sr = (t) => {
  ...
  e.headers = o = le.from(o), e.url = mr(wr(e.baseURL, e.url), t.params, t.paramsSerializer), a && o.set(
    "Authorization",
  ...
  if (ae.hasStandardBrowserEnv && (r && g.isFunction(r) && (r = r(e)), r || r !== !1 && hi(e.url))) {
    const c = s && i && gi.read(i);
    c && o.set(s, c);
  }
  return e;
}, vi = typeof XMLHttpRequest < "u", bi = vi && function(t) {
  return new Promise(function(n, r) {
    ...
    }), g.isUndefined(s.withCredentials) || (h.withCredentials = !!s.withCredentials), a && a !== "json" && (h.responseType = s.responseType), c && ([f, p] = lt(c, !0), h.addEventListener("progress", f)), l && h.upload && ([d, y] = lt(l), h.upload.addEventListener("progress", d), h.upload.addEventListener("loadend", y)), (s.cancelToken || s.signal) && (u = (E) => {
...
}, Et = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", Tr = Et && typeof ReadableStream == "function", xi = Et && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((t) => (e) => t.encode(e))(new TextEncoder()) : async (t) => new Uint8Array(await new Response(t).arrayBuffer())), xr = (t, ...e) => {
  try {
    return !!t(...e);
  } catch {
    return !1;
  ...
  return t && !e;
}), xn = 64 * 1024, Vt = Tr && xr(() => g.isReadableStream(new Response("").body)), ut = {
  stream: Vt && ((t) => t.body)
};
Et && ((t) => {
  ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((e) => {
    !ut[e] && (ut[e] = g.isFunction(t[e]) ? (n) => n[e]() : (n, r) => {
...
const Ri = async (t) => {
  ...
  let y = Ei([s, i && i.toAbortSignal()], o), p;
  const m = y && y.unsubscribe && (() => {
    y.unsubscribe();
  });
  let h;
  try {
    if (l && Oi && n !== "get" && n !== "head" && (h = await Ci(u, r)) !== 0) {
      let v = new Request(e, {
        method: "POST",
        body: r,
        duplex: "half"
    ...
    let S = await fetch(p);
    const E = Vt && (c === "stream" || c === "response");
    if (Vt && (a || E && m)) {
      const v = {};
      ["status", "statusText", "headers"].forEach((_) => {
        v[_] = S[_];
      });
      const B = g.toFiniteNumber(S.headers.get("content-length")), [L, R] = a && En(
        B,
        lt(wn(a), !0)
      ) || [];
      S = new Response(
    ...
    c = c || "text";
    let T = await ut[g.findKey(ut, c) || "text"](S, t);
...
const On = (t) => `- ${t}`, Li = (t) => g.isFunction(t) || t === null || t === !1, Or = {
  getAdapter: (t) => {
    t = g.isArray(t) ? t : [t];
    const { length: e } = t;
    let n, r;
    ...
    for (let i = 0; i < e; i++) {
      n = t[i];
      let o;
      if (r = n, !Li(n) && (r = Kt[(o = String(n)).toLowerCase()], r === void 0))
...
function Rn(t) {
  return At(t), t.headers = le.from(t.headers), t.data = Lt.call(
    t,
    t.transformRequest
  ), ["post", "put", "patch"].indexOf(t.method) !== -1 && t.headers.setContentType("application/x-www-form-urlencoded", !1), Or.getAdapter(t.adapter || Je.adapter)(t).then(function(r) {
    return At(t), r.data = Lt.call(
      t,
      t.transformResponse,
      r
    ), r.headers = le.from(r.headers), r;
  }, function(r) {
    return br(r) || (At(t), r && r.response && (r.response.data = Lt.call(
      t,
      t.transformResponse,
      r.response
...
const Cn = {};
an.transitional = function(e, n, r) {
  function s(i, o) {
    return "[Axios v" + Rr + "] Transitional option '" + i + "'" + o + (r ? ". " + r : "");
  }
  return (i, o, a) => {
    if (e === !1)
      throw new $(
    ...
    return n && !Cn[o] && (Cn[o] = !0, console.warn(
      s(
        o,
...
` + i) : r.stack = i;
  ...
  getUri(e) {
    ...
    return mr(n, e.params, e.paramsSerializer);
  }
}
...
function Cr(t) {
  const e = new Ae(t), n = sr(Ae.prototype.request, e);
  return g.extend(n, Ae.prototype, e, { allOwnKeys: !0 }), g.extend(n, e, null, { allOwnKeys: !0 }), n.create = function(s) {
    return Cr(Ie(t, s));
  }, n;
}
const G = Cr(Je);
...
G.mergeConfig = Ie;
G.AxiosHeaders = le;
G.formToJSON = (t) => vr(g.isHTMLForm(t) ? new FormData(t) : t);
...
const Ii = (...t) => {
  ...
  Ne(t[0]) && Pn[t[0]] || (Ne(t[0]) && (Pn[t[0]] = /* @__PURE__ */ new Date()), Ii(...t));
}, Pr = (t, e) => () => {
  if (t.isInitialized)
    e();
  else {
  ...
  t.loadNamespaces(e, Pr(t, n));
}, An = (t, e, n, r) => {
  Ne(n) && (n = [n]), n.forEach((s) => {
    t.options.ns.indexOf(s) < 0 && t.options.ns.push(s);
  }), t.loadLanguages(e, Pr(t, r));
}, Di = (t, e, n = {}) => !e.languages || !e.languages.length ? (Wt("i18n.languages were undefined or empty", e.languages), !0) : e.hasLoadedNamespace(t, {
  lng: n.lng,
  precheck: (r, s) => {
    var i;
...
}), Ne = (t) => typeof t == "string", ki = (t) => typeof t == "object" && t !== null, $i = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Bi = {
  "&amp;": "&",
  "&#38;": "&",
  "&lt;": "<",
  "&#60;": "<",
...
const Ki = (t, e) => {
...
}, Nr = (t, e, n, r) => t.getFixedT(e, n, r), qi = (t, e, n, r) => M.useCallback(Nr(t, e, n, r), [t, e, n, r]), Ia = (t, e = {}) => {
  var T, v, B, L;
  const {
    i18n: n
  } = e, {
    i18n: r,
    defaultNS: s
  } = M.useContext(Ar) || {}, i = n || r || zi();
  if (i && !i.reportNamespaces && (i.reportNamespaces = new Vi()), !i) {
    Wt("You will need to pass in an i18next instance by using initReactI18next");
    const R = (U, H) => Ne(H) ? H : ki(H) && Ne(H.defaultValue) ? H.defaultValue : Array.isArray(U) ? U[U.length - 1] : U, _ = [R, {}, !1];
    return _.t = R, _.i18n = {}, _.ready = !1, _;
  }
  (T = i.options.react) != null && T.wait && Wt("It seems you are still using the old wait option, you may migrate to the new useSuspense behaviour.");
  const o = {
    ...Ui(),
    ...i.options.react,
    ...e
  ...
  const u = (i.isInitialized || i.initializedStoreOnce) && c.every((R) => Di(R, i, o)), d = qi(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), f = () => d, y = () => Nr(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), [p, m] = M.useState(f);
  let h = c.join();
  e.lng && (h = `${e.lng}${h}`);
  const w = Ki(h), S = M.useRef(!0);
  M.useEffect(() => {
    const {
      bindI18n: R,
      bindI18nStore: _
...
const ze = (t) => typeof t == "number" && !isNaN(t), _e = (t) => typeof t == "string", fe = (t) => typeof t == "function", ot = (t) => _e(t) || fe(t) ? t : null, Qt = (t) => M.isValidElement(t) || _e(t) || fe(t) || ze(t);
function Ji(t, e, n) {
  n === void 0 && (n = 300);
...
function wt(t) {
  ...
  return function(o) {
    ...
    const p = r ? `${e}--${l}` : e, m = r ? `${n}--${l}` : n, h = M.useRef(0);
    return M.useLayoutEffect(() => {
      ...
      const w = d.current, S = () => {
        w.removeEventListener("animationend", S), s ? Ji(w, u, i) : u();
      };
...
let Ve = [];
const Xt = /* @__PURE__ */ new Set(), Wi = (t) => Xt.forEach((e) => e(t)), _r = () => se.size > 0;
function Ir(t, e) {
  var n;
...
function Dr(t, e) {
  Qt(t) && (_r() || Ve.push({ content: t, options: e }), se.forEach((n) => {
    n.buildToast(t, e);
  }));
}
function _n(t, e) {
...
function Yi(t) {
  const { subscribe: e, getSnapshot: n, setProps: r } = M.useRef(function(i) {
    ...
    return { subscribe(a) {
      const l = /* @__PURE__ */ function(u, d, f) {
        ...
        const E = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Set(), v = () => {
          ...
          R.staleId && E.delete(R.staleId), E.set(_, R), h = [...h, R.props.toastId].filter((Y) => Y !== R.staleId), v(), f(Nn(R, he ? "added" : "updated")), he && fe(U) && U(M.isValidElement(ue) && ue.props);
        };
        return { id: u, props: S, observe: (R) => (T.add(R), () => T.delete(R)), toggle: (R, _) => {
          ...
          const X = { ...S, style: S.toastStyle, key: y++, ...Object.fromEntries(Object.entries(_).filter((A) => {
            let [P, C] = A;
            return C != null;
          })), toastId: U, updateId: H, data: ue, closeToast: re, isIn: !1, className: ot(_.className || S.toastClassName), bodyClassName: ot(_.bodyClassName || S.bodyClassName), progressClassName: ot(_.progressClassName || S.progressClassName), autoClose: !_.isLoading && (q = _.autoClose, Z = S.autoClose, q === !1 || ze(q) && q > 0 ? q : Z), deleteToast() {
            const A = E.get(U), { onClose: P, children: C } = A.props;
            fe(P) && P(M.isValidElement(C) && C.props), f(Nn(A, "removed")), E.delete(U), p--, p < 0 && (p = 0), m.length > 0 ? L(m.shift()) : v();
          } };
          var q, Z;
          X.closeButton = S.closeButton, _.closeButton === !1 || Qt(_.closeButton) ? X.closeButton = _.closeButton : _.closeButton === !0 && (X.closeButton = !Qt(S.closeButton) || S.closeButton);
          let b = R;
          M.isValidElement(R) && !_e(R.type) ? b = M.cloneElement(R, { closeToast: re, toastProps: X, data: ue }) : fe(R) && (b = R({ closeToast: re, toastProps: X, data: ue }));
          const x = { content: b, props: X, staleId: he };
          S.limit && S.limit > 0 && p > S.limit && Q ? m.push(x) : ze(Y) ? setTimeout(() => {
            L(x);
          }, Y) : L(x);
        }, setProps(R) {
          S = R;
      ...
      se.set(o, l);
      const c = l.observe(a);
      return Ve.forEach((u) => Dr(u.content, u.options)), Ve = [], () => {
        c(), se.delete(o);
      };
    }, setProps(a) {
      var l;
  ...
  r(t);
  const s = M.useSyncExternalStore(e, n, n);
  ...
  }, isToastActive: Ir, count: s == null ? void 0 : s.length };
}
function Qi(t) {
  const [e, n] = M.useState(!1), [r, s] = M.useState(!1), i = M.useRef(null), o = M.useRef({ start: 0, delta: 0, removalDistance: 0, canCloseOnClick: !0, canDrag: !1, didMove: !1 }).current, { autoClose: a, pauseOnHover: l, closeToast: c, onClick: u, closeOnClick: d } = t;
  var f, y;
  function p() {
    n(!0);
  }
  ...
  (y = se.get((f = { id: t.toastId, containerId: t.containerId, fn: n }).containerId || 1)) == null || y.setToggle(f.id, f.fn), M.useEffect(() => {
...
const kr = () => "" + Gi++;
function Zi(t) {
  return t && (_e(t.toastId) || ze(t.toastId)) ? t.toastId : kr();
}
function je(t, e) {
  return Dr(t, e), e.toastId;
}
function ct(t, e) {
  return { ...e, type: e && e.type || t, toastId: Zi(e) };
}
function Qe(t) {
  return (e, n) => je(e, ct(t, n));
}
function W(t, e) {
  return je(t, ct("default", e));
}
W.loading = (t, e) => je(t, ct("default", { isLoading: !0, autoClose: !1, closeOnClick: !1, closeButton: !1, draggable: !1, ...e })), W.promise = function(t, e, n) {
  let r, { pending: s, error: i, success: o } = e;
  s && (r = _e(s) ? W.loading(s, n) : W.loading(s.render, { ...n, ...s }));
  const a = { isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null }, l = (u, d, f) => {
    ...
    const y = { type: u, ...a, ...n, data: f }, p = _e(d) ? { render: d } : d;
    return r ? W.update(r, { ...y, ...p }) : W(p.render, { ...y, ...p }), f;
  }, c = fe(t) ? t() : t;
  return c.then((u) => l("success", o, u)).catch((u) => l("error", i, u)), c;
}, W.success = Qe("success"), W.info = Qe("info"), W.error = Qe("error"), W.warning = Qe("warning"), W.warn = W.warning, W.dark = (t, e) => je(t, ct("default", { theme: "dark", ...e })), W.dismiss = function(t) {
  (function(e) {
    var n;
    if (_r()) {
      if (e == null || _e(n = e) || ze(n)) se.forEach((r) => {
        r.removeToast(e);
      });
  ...
  if (n) {
    const { props: r, content: s } = n, i = { delay: 100, ...r, ...e, toastId: e.toastId || t, updateId: kr() };
...
}, W.play = (t) => _n(!0, t), W.pause = (t) => _n(!1, t);
const eo = typeof window < "u" ? M.useLayoutEffect : M.useEffect, Xe = (t) => {
  ...
  const { isRunning: e, preventExitTransition: n, toastRef: r, eventHandlers: s, playToast: i } = Qi(t), { closeButton: o, children: a, autoClose: l, onClick: c, type: u, hideProgressBar: d, closeToast: f, transition: y, position: p, className: m, style: h, bodyClassName: w, bodyStyle: S, progressClassName: E, progressStyle: T, updateId: v, role: B, progress: L, rtl: R, toastId: _, deleteToast: U, isIn: H, isLoading: ue, closeOnClick: he, theme: Y } = t, re = Re("Toastify__toast", `Toastify__toast-theme--${Y}`, `Toastify__toast--${u}`, { "Toastify__toast--rtl": R }, { "Toastify__toast--close-on-click": he }), Q = fe(m) ? m({ rtl: R, position: p, type: u, defaultClassName: re }) : Re(re, m), X = function(x) {
    let { theme: A, type: P, isLoading: C, icon: D } = x, N = null;
    const k = { theme: A, type: P };
    return D === !1 || (fe(D) ? N = D({ ...k, isLoading: C }) : M.isValidElement(D) ? N = M.cloneElement(D, k) : C ? N = Nt.spinner() : ((F) => F in Nt)(P) && (N = Nt[P](k))), N;
  }(t), q = !!L || !l, Z = { closeToast: f, type: u, theme: Y };
  let b = null;
  return o === !1 || (b = fe(o) ? o(Z) : M.isValidElement(o) ? M.cloneElement(o, Z) : function(x) {
  ...
  }(Z)), J.createElement(y, { isIn: H, done: U, position: p, preventExitTransition: n, nodeRef: r, playToast: i }, J.createElement("div", { id: _, onClick: c, "data-in": H, className: Q, ...s, style: h, ref: r }, J.createElement("div", { ...H && { role: B }, className: fe(w) ? w({ type: u }) : Re("Toastify__toast-body", w), style: S }, X != null && J.createElement("div", { className: Re("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !ue }) }, X), J.createElement("div", null, a)), b, J.createElement(Xi, { ...v && !q ? { key: `pb-${v}` } : {}, rtl: R, theme: Y, delay: l, isRunning: e, isIn: H, closeToast: f, hide: d, type: u, style: T, className: E, controlledProgress: q, progress: L || 0 })));
}, St = function(t, e) {
...
const ka = wt(St("zoom"));
wt(St("flip"));
const ro = { position: "top-right", transition: no, autoClose: 5e3, closeButton: !0, pauseOnHover: !0, pauseOnFocusLoss: !0, draggable: "touch", draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light" };
function $a(t) {
  let e = { ...ro, ...t };
  const n = t.stacked, [r, s] = M.useState(!0), i = M.useRef(null), { getToastToRender: o, isToastActive: a, count: l } = Yi(e), { className: c, style: u, rtl: d, containerId: f } = e;
  function y(m) {
    const h = Re("Toastify__toast-container", `Toastify__toast-container--${m}`, { "Toastify__toast-container--rtl": d });
    return fe(c) ? c({ position: m, rtl: d, defaultClassName: h }) : Re(h, ot(c));
  }
  function p() {
    n && (s(!0), W.play());
  }
  return eo(() => {
    ...
    return J.createElement("div", { className: y(m), style: w, key: `container-${m}` }, h.map((S) => {
      ...
      return J.createElement(to, { ...T, stacked: n, collapseAll: p, isIn: a(T.toastId, T.containerId), style: T.style, key: `toast-${T.key}` }, E);
    }));
  }));
}
const I = (t) => typeof t == "string", Fe = () => {
  let t, e;
  const n = new Promise((r, s) => {
    t = r, e = s;
  });
  return n.resolve = t, n.reject = e, n;
}, In = (t) => t == null ? "" : "" + t, so = (t, e, n) => {
  t.forEach((r) => {
    e[r] && (n[r] = e[r]);
  });
}, io = /###/g, Dn = (t) => t && t.indexOf("###") > -1 ? t.replace(io, ".") : t, kn = (t) => !t || I(t), Ue = (t, e, n) => {
  ...
  const r = ft(t, n);
  return r !== void 0 ? r : ft(e, n);
}, $r = (t, e, n) => {
  for (const r in e)
    r !== "__proto__" && r !== "constructor" && (r in t ? I(t[r]) || t[r] instanceof String || I(e[r]) || e[r] instanceof String ? n && (t[r] = e[r]) : $r(t[r], e[r], n) : t[r] = e[r]);
  return t;
}, De = (t) => t.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
var lo = {
  "&": "&amp;",
...
const uo = (t) => I(t) ? t.replace(/[&<>"'\/]/g, (e) => lo[e]) : t;
class co {
  constructor(e) {
...
const fo = [" ", ",", "?", "!", ";"], po = new co(20), ho = (t, e, n) => {
  e = e || "", n = n || "";
  const r = fo.filter((o) => e.indexOf(o) < 0 && n.indexOf(o) < 0);
  if (r.length === 0) return !0;
  const s = po.getRegExp(`(${r.map((o) => o === "?" ? "\\?" : o).join("|")})`);
  let i = !s.test(t);
  if (!i) {
    const o = t.indexOf(n);
...
class pt {
  ...
  init(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.prefix = n.prefix || "i18next:", this.logger = e || go, this.options = n, this.debug = n.debug;
  }
  log() {
...
class Bn extends Tt {
  ...
  getResource(e, n, r) {
    ...
    const l = ft(this.data, a);
    return !l && !n && !r && e.indexOf(".") > -1 && (e = a[0], n = a[1], r = a.slice(2).join(".")), l || !o || !I(r) ? l : Gt(this.data && this.data[e] && this.data[e][n], r, i);
  }
  addResource(e, n, r, s) {
    ...
    let a = [e, n];
    r && (a = a.concat(o ? r.split(o) : r)), e.indexOf(".") > -1 && (a = e.split("."), s = n, n = a[1]), this.addNamespaces(n), $n(this.data, a, s), i.silent || this.emit("added", e, n, r, s);
  }
  addResources(e, n, r) {
    let s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {
      silent: !1
  ...
  addResourceBundle(e, n, r, s, i) {
    ...
    let l = ft(this.data, a) || {};
    o.skipCopy || (r = JSON.parse(JSON.stringify(r))), s ? $r(l, r, i) : l = {
      ...l,
      ...r
    }, $n(this.data, a, l), o.silent || this.emit("added", e, n, r);
  }
...
class ht extends Tt {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    super(), so(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = n, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = we.create("translator");
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  extractFromKey(e, n) {
    ...
    const o = r && e.indexOf(r) > -1, a = !this.options.userDefinedKeySeparator && !n.keySeparator && !this.options.userDefinedNsSeparator && !n.nsSeparator && !ho(e, r, s);
    if (o && !a) {
  ...
  translate(e, n, r) {
    ...
    if (S && f && E && h.indexOf(m) < 0 && !(I(w) && Array.isArray(f))) {
      ...
      let T = !1, v = !1;
      const B = n.count !== void 0 && !I(n.count), L = ht.hasDefaultValue(n), R = B ? this.pluralResolver.getSuffix(c, n.count, n) : "", _ = n.ordinal && B ? this.pluralResolver.getSuffix(c, n.count, {
        ordinal: !1
  ...
  extendTranslation(e, n, r, s, i) {
    ...
    return e != null && l && l.length && r.applyPostProcessor !== !1 && (e = Br.handle(l, e, n, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...s,
  ...
  resolve(e) {
    ...
    return I(e) && (e = [e]), e.forEach((l) => {
      ...
      d.forEach((h) => {
        this.isValidLookup(r) || (a = h, !Mn[`${m[0]}-${h}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(a) && (Mn[`${m[0]}-${h}`] = !0, this.logger.warn(`key "${s}" for languages "${m.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach((w) => {
          if (this.isValidLookup(r)) return;
          o = w;
          const S = [u];
...
class Fn {
  ...
  formatLanguageCode(e) {
    if (I(e) && e.indexOf("-") > -1) {
      ...
      let r = e.split("-");
      return this.options.lowerCaseLng ? r = r.map((s) => s.toLowerCase()) : r.length === 2 ? (r[0] = r[0].toLowerCase(), r[1] = r[1].toUpperCase(), n.indexOf(r[1].toLowerCase()) > -1 && (r[1] = _t(r[1].toLowerCase()))) : r.length === 3 && (r[0] = r[0].toLowerCase(), r[1].length === 2 && (r[1] = r[1].toUpperCase()), r[0] !== "sgn" && r[2].length === 2 && (r[2] = r[2].toUpperCase()), n.indexOf(r[1].toLowerCase()) > -1 && (r[1] = _t(r[1].toLowerCase())), n.indexOf(r[2].toLowerCase()) > -1 && (r[2] = _t(r[2].toLowerCase()))), r.join("-");
    }
...
class wo {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.languageUtils = e, this.options = n, this.logger = we.create("pluralResolver"), (!this.options.compatibilityJSON || bo.includes(this.options.compatibilityJSON)) && (typeof Intl > "u" || !Intl.PluralRules) && (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = Eo(), this.pluralRulesCache = {};
  }
  addRule(e, n) {
    this.rules[e] = n;
  }
  ...
  getRule(e) {
    ...
    if (this.shouldUseIntlApi())
      try {
        const r = dt(e === "dev" ? "en" : e), s = n.ordinal ? "ordinal" : "cardinal", i = JSON.stringify({
          cleanedCode: r,
          type: s
        });
  ...
  getSuffixes(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const r = this.getRule(e, n);
    return r ? this.shouldUseIntlApi() ? r.resolvedOptions().pluralCategories.sort((s, i) => jn[s] - jn[i]).map((s) => `${this.options.prepend}${n.ordinal ? `ordinal${this.options.prepend}` : ""}${s}`) : r.numbers.map((s) => this.getSuffix(e, s, n)) : [];
  }
  getSuffix(e, n) {
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  ...
  shouldUseIntlApi() {
    return !vo.includes(this.options.compatibilityJSON);
  }
}
const Un = function(t, e, n) {
  let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : ".", s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, i = ao(t, e, n);
  return !i && s && I(n) && (i = Gt(t, n, r), i === void 0 && (i = Gt(e, n, r))), i;
}, It = (t) => t.replace(/\$/g, "$$$$");
class So {
  constructor() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  ...
  init() {
    ...
    this.escape = n !== void 0 ? n : uo, this.escapeValue = r !== void 0 ? r : !0, this.useRawValueToEscape = s !== void 0 ? s : !1, this.prefix = i ? De(i) : o || "{{", this.suffix = a ? De(a) : l || "}}", this.formatSeparator = c || ",", this.unescapePrefix = u ? "" : d || "-", this.unescapeSuffix = this.unescapePrefix ? "" : u || "", this.nestingPrefix = f ? De(f) : y || De("$t("), this.nestingSuffix = p ? De(p) : m || De(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = w || 1e3, this.alwaysFormat = S !== void 0 ? S : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, n, r, s) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (y) => {
      if (y.indexOf(this.formatSeparator) < 0) {
        const w = Un(n, l, y, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      return this.format(Un(n, l, m, this.options.keySeparator, this.options.ignoreJSONStructure), h, r, {
        ...s,
        ...n,
        interpolationkey: m
      });
    ...
    return [{
      ...
      regex: this.regexp,
      safeValue: (y) => this.escapeValue ? It(this.escape(y)) : It(y)
    }].forEach((y) => {
      for (a = 0; i = y.regex.exec(e); ) {
        ...
        else !I(o) && !this.useRawValueToEscape && (o = In(o));
  ...
  nest(e, n) {
    ...
    for (; s = this.nestingRegexp.exec(e); ) {
      ...
      I(i) || (i = In(i)), i || (this.logger.warn(`missed to resolve ${s[1]} for nesting ${e}`), i = ""), c && (i = l.reduce((u, d) => this.format(u, d, r.lng, {
        ...r,
...
class Ro extends Tt {
  ...
  loaded(e, n, r) {
    ...
    this.queue.forEach((l) => {
      oo(l.loaded, [i], o), Oo(l, e), n && l.errors.push(n), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((c) => {
        a[c] || (a[c] = {});
        const u = l.loaded[c];
...
}), zn = (t) => (I(t.ns) && (t.ns = [t.ns]), I(t.fallbackLng) && (t.fallbackLng = [t.fallbackLng]), I(t.fallbackNS) && (t.fallbackNS = [t.fallbackNS]), t.supportedLngs && t.supportedLngs.indexOf("cimode") < 0 && (t.supportedLngs = t.supportedLngs.concat(["cimode"])), t), Ge = () => {
}, Co = (t) => {
...
class Ke extends Tt {
  constructor() {
    ...
    if (super(), this.options = zn(e), this.services = {}, this.logger = we, this.modules = {
      external: []
    }, Co(this), n && !this.isInitialized && !e.isClone) {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      const d = new Fn(this.options);
      this.store = new Bn(this.options.resources, this.options);
      const f = this.services;
      f.logger = we, f.resourceStore = this.store, f.languageUtils = d, f.pluralResolver = new wo(d, {
      ...
      }, f.backendConnector = new Ro(i(this.modules.backend), f.resourceStore, f, this.options), f.backendConnector.on("*", function(y) {
        for (var p = arguments.length, m = new Array(p > 1 ? p - 1 : 0), h = 1; h < p; h++)
          m[h - 1] = arguments[h];
        e.emit(y, ...m);
      }), this.modules.languageDetector && (f.languageDetector = i(this.modules.languageDetector), f.languageDetector.init && f.languageDetector.init(f, this.options.detection, this.options)), this.modules.i18nFormat && (f.i18nFormat = i(this.modules.i18nFormat), f.i18nFormat.init && f.i18nFormat.init(this)), this.translator = new ht(this.services, this.options), this.translator.on("*", function(y) {
        for (var p = arguments.length, m = new Array(p > 1 ? p - 1 : 0), h = 1; h < p; h++)
          m[h - 1] = arguments[h];
        e.emit(y, ...m);
  ...
  dir(e) {
    ...
    const n = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], r = this.services && this.services.languageUtils || new Fn(Hn());
  ...
  cloneInstance() {
    ...
    }, r && (i.store = new Bn(this.store.data, s), i.services.resourceStore = i.store), i.translator = new ht(i.services, s), i.translator.on("*", function(a) {
...
var xt = {}, Po = function() {
  ...
  "text/html": "Url",
  default: "Text"
}, Ao = "Copy to clipboard: #{key}, Enter";
function No(t) {
...
function _o(t, e) {
  ...
  try {
    ...
    try {
      ...
      n && console.error("unable to copy using clipboardData: ", d), n && console.error("falling back to prompt"), r = No("message" in e ? e.message : Ao), window.prompt(r, t);
    }
  } finally {
...
var Ze = Mr(M), Do = Mr(Io), ko = ["text", "onCopy", "options", "children"];
function Mr(t) {
...
var jr = /* @__PURE__ */ function(t) {
  ...
  function n() {
    ...
    for (var s = arguments.length, i = new Array(s), o = 0; o < s; o++)
      i[o] = arguments[o];
    return r = e.call.apply(e, [this].concat(i)), un(Fr(r), "onClick", function(a) {
      var l = r.props, c = l.text, u = l.onCopy, d = l.children, f = l.options, y = Ze.default.Children.only(d), p = (0, Do.default)(c, f);
  ...
  return jo(n, [{
    ...
    value: function() {
      ...
      var i = s.children, o = $o(s, ko), a = Ze.default.Children.only(i);
      return /* @__PURE__ */ Ze.default.cloneElement(a, qn(qn({}, o), {}, {
        onClick: this.onClick
      }));
    }
  }]), n;
}(Ze.default.PureComponent);
xt.CopyToClipboard = jr;
un(jr, "defaultProps", {
  onCopy: void 0,
  options: void 0
});
var Ko = xt, tn = Ko.CopyToClipboard;
tn.CopyToClipboard = tn;
var qo = tn;
const Ba = /* @__PURE__ */ rs(qo);
...
var V = {}, Wn;
function Wo() {
  return Wn || (Wn = 1, ce.env.NODE_ENV !== "production" && function() {
    var t = typeof Symbol == "function" && Symbol.for, e = t ? Symbol.for("react.element") : 60103, n = t ? Symbol.for("react.portal") : 60106, r = t ? Symbol.for("react.fragment") : 60107, s = t ? Symbol.for("react.strict_mode") : 60108, i = t ? Symbol.for("react.profiler") : 60114, o = t ? Symbol.for("react.provider") : 60109, a = t ? Symbol.for("react.context") : 60110, l = t ? Symbol.for("react.async_mode") : 60111, c = t ? Symbol.for("react.concurrent_mode") : 60111, u = t ? Symbol.for("react.forward_ref") : 60112, d = t ? Symbol.for("react.suspense") : 60113, f = t ? Symbol.for("react.suspense_list") : 60120, y = t ? Symbol.for("react.memo") : 60115, p = t ? Symbol.for("react.lazy") : 60116, m = t ? Symbol.for("react.block") : 60121, h = t ? Symbol.for("react.fundamental") : 60117, w = t ? Symbol.for("react.responder") : 60118, S = t ? Symbol.for("react.scope") : 60119;
    function E(O) {
    ...
    V.AsyncMode = v, V.ConcurrentMode = B, V.ContextConsumer = L, V.ContextProvider = R, V.Element = _, V.ForwardRef = U, V.Fragment = H, V.Lazy = ue, V.Memo = he, V.Portal = Y, V.Profiler = re, V.StrictMode = Q, V.Suspense = X, V.isAsyncMode = Z, V.isConcurrentMode = b, V.isContextConsumer = x, V.isContextProvider = A, V.isElement = P, V.isForwardRef = C, V.isFragment = D, V.isLazy = N, V.isMemo = k, V.isPortal = F, V.isProfiler = K, V.isStrictMode = j, V.isSuspense = oe, V.isValidElementType = E, V.typeOf = T;
  }()), V;
}
var Yn;
function Ur() {
  return Yn || (Yn = 1, ce.env.NODE_ENV === "production" ? et.exports = Jo() : et.exports = Wo()), et.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var $t, Gn;
function Hr() {
  return Gn || (Gn = 1, $t = Function.call.bind(Object.prototype.hasOwnProperty)), $t;
}
var Bt, Zn;
function Qo() {
  if (Zn) return Bt;
...
function Xo() {
  if (er) return Mt;
  er = 1;
  var t = Ur(), e = Yo(), n = cn(), r = Hr(), s = Qo(), i = function() {
  };
  ...
  return Mt = function(a, l) {
    ...
    function h(b) {
      ...
      function P(D, N, k, F, K, j, oe) {
        ...
        return N[k] == null ? D ? N[k] === null ? new m("The " + K + " `" + j + "` is marked as required " + ("in `" + F + "`, but its value is `null`.")) : new m("The " + K + " `" + j + "` is marked as required in " + ("`" + F + "`, but its value is `undefined`.")) : null : b(N, k, F, K, j);
      }
      var C = P.bind(null, !1);
    ...
    function E(b) {
      function x(A, P, C, D, N) {
        ...
        if (!Array.isArray(k)) {
          var F = Q(k);
          return new m("Invalid " + D + " `" + N + "` of type " + ("`" + F + "` supplied to `" + C + "`, expected an array."));
        }
    ...
    function B(b) {
      function x(A, P, C, D, N) {
        if (!(A[P] instanceof b)) {
          var k = b.name || f, F = Z(A[P]);
          return new m("Invalid " + D + " `" + N + "` of type " + ("`" + F + "` supplied to `" + C + "`, expected ") + ("instance of `" + k + "`."));
        }
        return null;
      }
      return h(x);
    ...
    function L(b) {
      ...
      function x(A, P, C, D, N) {
        for (var k = A[P], F = 0; F < b.length; F++)
          if (p(k, b[F]))
            return null;
    ...
    function R(b) {
      function x(A, P, C, D, N) {
        ...
        var k = A[P], F = Q(k);
        if (F !== "object")
          return new m("Invalid " + D + " `" + N + "` of type " + ("`" + F + "` supplied to `" + C + "`, expected an object."));
        for (var K in k)
          if (r(k, K)) {
            var j = b(k, K, C, D, N + "." + K, n);
            if (j instanceof Error)
    ...
    function ue(b) {
      function x(A, P, C, D, N) {
        var k = A[P], F = Q(k);
        if (F !== "object")
          return new m("Invalid " + D + " `" + N + "` of type `" + F + "` " + ("supplied to `" + C + "`, expected `object`."));
        for (var K in b) {
          var j = b[K];
...
if (ce.env.NODE_ENV !== "production") {
  var Zo = Ur(), ea = !0;
  nn.exports = Xo()(Zo.isElement, ea);
} else
  nn.exports = Go()();
var zr = nn.exports, Vr = {
  L: 1,
  M: 0,
  Q: 3,
  H: 2
...
function qr(t) {
  this.mode = ta.MODE_8BIT_BYTE, this.data = t;
}
qr.prototype = {
...
var Yr = at, ge = Kr, nr = Yr, ia = Wr, Oe = {
  PATTERN000: 0,
  PATTERN001: 1,
  PATTERN010: 2,
  PATTERN011: 3,
  ...
  getErrorCorrectPolynomial: function(t) {
    for (var e = new nr([1], 0), n = 0; n < t; n++)
      e = e.multiply(new nr([1, ia.gexp(n)], 0));
    return e;
  },
...
}, oa = ee, aa = na, Qr = ra, Xr = sa, Ce = oa, la = Yr;
function Se(t, e) {
...
pe.make = function() {
  if (this.typeNumber < 1) {
    var t = 1;
    for (t = 1; t < 40; t++) {
      for (var e = Qr.getRSBlocks(t, this.errorCorrectLevel), n = new Xr(), r = 0, s = 0; s < e.length; s++)
        r += e[s].dataCount;
...
Se.createData = function(t, e, n) {
  for (var r = Qr.getRSBlocks(t, e), s = new Xr(), i = 0; i < n.length; i++) {
    var o = n[i];
...
Se.createBytes = function(t, e) {
  for (var n = 0, r = 0, s = 0, i = new Array(e.length), o = new Array(e.length), a = 0; a < e.length; a++) {
    ...
    n += l;
    var d = Ce.getErrorCorrectPolynomial(c), f = new la(i[a], d.getLength() - 1), y = f.mod(d);
...
}, dn = (0, Gr.forwardRef)(function(t, e) {
  var n = t.bgColor, r = t.bgD, s = t.fgD, i = t.fgColor, o = t.size, a = t.title, l = t.viewBoxSize, c = t.xmlns, u = c === void 0 ? "http://www.w3.org/2000/svg" : c, d = da(t, ["bgColor", "bgD", "fgD", "fgColor", "size", "title", "viewBoxSize", "xmlns"]);
  return nt.default.createElement(
    "svg",
    ca({}, d, { height: o, ref: e, viewBox: "0 0 " + l + " " + l, width: o, xmlns: u }),
...
Ot.QRCode = void 0;
var ha = Object.assign || function(t) {
  for (var e = 1; e < arguments.length; e++) {
    var n = arguments[e];
    for (var r in n)
      Object.prototype.hasOwnProperty.call(n, r) && (t[r] = n[r]);
  ...
  return t;
}, ga = zr, Te = We(ga), ma = Vr, ya = We(ma), va = ua, ba = We(va), es = M, Ea = We(es), wa = fn, Sa = We(wa);
function We(t) {
  return t && t.__esModule ? t : { default: t };
}
function Ta(t, e) {
...
}, Rt = (0, es.forwardRef)(function(t, e) {
  var n = t.bgColor, r = n === void 0 ? "#FFFFFF" : n, s = t.fgColor, i = s === void 0 ? "#000000" : s, o = t.level, a = o === void 0 ? "L" : o, l = t.size, c = l === void 0 ? 256 : l, u = t.value, d = Ta(t, ["bgColor", "fgColor", "level", "size", "value"]), f = new ba.default(-1, ya.default[a]);
  f.addData(u), f.make();
  var y = f.modules;
  return Ea.default.createElement(Sa.default, ha({}, d, {
    bgColor: r,
...
function Fa(t, e, n) {
  if (rr.randomUUID && !e && !t)
    return rr.randomUUID();
  t = t || {};
  var r = t.random || (t.rng || Ca)();
