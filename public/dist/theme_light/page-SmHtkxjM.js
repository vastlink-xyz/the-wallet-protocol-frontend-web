...
import { j as T, r as l, k as A, l as R, n as z } from "./vendor-react-BA5A8Axg.js";
import { c as p, a7 as C, f as B, h as I, a8 as S } from "./main-D5sRvz5I.js";
import { S as M, P as O } from "./ProductList-ClN9kJZu.js";
import { a as F } from "./MarketplaceProvider-Dy1SitKL.js";
import { l as E, b as P } from "./vendor-ui-utils-CNDLbdLA.js";
import { B as _ } from "./vendor-utils-7AahqLO2.js";
import { E as D } from "./index-DtB773Aa.js";
const L = [
  "Most popular",
  "Free",
  "Latest",
...
function G({
  ...
  const { checkNewProducts: m, hasNewProducts: n } = F(), i = T(), h = L, [a, w] = l.useState(!1), [o, x] = l.useState(!1), d = l.useRef(null), [v, y] = l.useState(!1), b = l.useRef(0), f = () => {
    const t = d.current;
    if (t) {
...
function W({
  ...
  return /* @__PURE__ */ e.jsx("div", { className: "h-8 justify-start items-center gap-4 inline-flex", children: /* @__PURE__ */ e.jsxs("div", { className: "justify-start items-center gap-2 flex", children: [
    ...
    /* @__PURE__ */ e.jsx(
      "div",
      {
        onClick: () => r < i && (n == null ? void 0 : n(r + 1)),
        className: p(
          "w-8 h-8 bg-white rounded-2xl border border-[#d9d9d9] flex items-center justify-center",
...
const $ = "It looks like you haven’t added any items yet. Head over to the marketplace and discover new products to add!";
function X() {
  const r = A(), [u] = R(), m = u.get("category"), [n, i] = l.useState(!1), [h, a] = l.useState(L[0]), {
    pagination: w,
    handlePageChange: o,
    updateTotal: x,
    updatePageSize: d
  } = C(), { products: v, total: y } = z(), [b, f] = l.useState(v), g = l.useCallback(async (s) => {
    try {
      i(!0);
