...
import { a as Qt, B as We, u as di, C as Ed, Q as wd, X as Td, i as Ec, b as Ad, I as kd } from "./vendor-utils-Q0yJ_o1H.js";
import { d as Nd, f as Pd, h as er, a as Rd, b as Md, s as Od, t as Ia, c as Id, e as _d, i as Jr, I as Bi, g as fi, j as zn, k as qt, l as Vn, m as jd, n as Ld, _ as me, o as Fd, p as U, q as J, r as hn, u as zr } from "./vendor-web3-CQEmmIwE.js";
var Xa, Mr = ci;
...
const tf = 1e3 * 60 * 60 * 24, nf = 1e3 * 60 * 60 * 24, kc = 1e3 * 60 * 60;
...
function uh(e, t) {
  var n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, r = p.useContext(ya), a = r.cache.instanceId, o = r.container, s = n.salt, l = s === void 0 ? "" : s, i = n.override, c = i === void 0 ? rh : i, u = n.formatToken, d = n.getComputedToken, f = n.cssVar, g = zf(function() {
    ...
    var E, b = d ? d(g, c, e) : lh(g, c, e, u), k = U({}, b), x = "";
    if (f) {
      var w = qc(b, f.key, {
        prefix: f.prefix,
        ignore: f.ignore,
    ...
    switch (v = E, E = pt()) {
      ...
      case 47:
        switch (zt()) {
          case 42:
          case 47:
            Or(kh(wh(pt(), Kr()), t, n, i), i), (dr(v || 1) == 5 || dr(zt() || 1) == 5) && yt(S) && Hn(S, -1, void 0) !== " " && (S += " ");
            break;
          default:
            S += "/";
        }
...
const El = oo(Sp), No = {
  ...
  hashed: !0
}, wl = /* @__PURE__ */ q.createContext(No), Po = "ant", Ai = "anticon", ly = ["outlined", "borderless", "filled"], Ep = (e, t) => t || (e ? `${Po}-${e}` : Po), Kt = /* @__PURE__ */ p.createContext({
...
const Ro = /* @__PURE__ */ p.createContext(!1), kp = (e) => {
  let {
    children: t,
    disabled: n
  } = e;
...
}, pr = /* @__PURE__ */ p.createContext(void 0), Np = (e) => {
  let {
    children: t,
    size: n
  } = e;
...
function Hp(e) {
  ...
  function u(f, g, v) {
    ...
    return function(x) {
      var w = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : x, S = r(), T = S.theme, P = S.realToken, L = S.hashId, _ = S.token, B = S.cssVar, O = a(), I = O.rootPrefixCls, $ = O.iconPrefixCls, R = n(), N = B ? "css" : "js", M = Bp(function() {
        var G = /* @__PURE__ */ new Set();
        return B && Object.keys(m.unitless || {}).forEach(function(K) {
          G.add(Wr(K, B.prefix)), G.add(Wr(K, xs(E, B.prefix)));
        }), Ip(N, G);
      }, [N, E, B == null ? void 0 : B.prefix]), j = Lp(N), D = j.max, F = j.min, z = {
        theme: T,
        token: _,
        hashId: L,
        nonce: function() {
      ...
      var H = uo(U(U({}, z), {}, {
        ...
        if (m.injectStyle === !1)
          return [];
        var G = jp(_), K = G.token, te = G.flush, Z = Es(E, P, v), ke = ".".concat(x), be = Cs(E, P, Z, {
...
var hm = [ut, Sn, En, Ni], pm = [ut, Il], $l = !1, mm = !0;
function Hl(e) {
  return e === En || e === Ni;
}
const gm = function(e, t, n) {
  var r = Oo(ks), a = Y(r, 2), o = a[0], s = a[1], l = fm(), i = Y(l, 2), c = i[0], u = i[1];
  function d() {
    s(ut, !0);
  }
  var f = t ? pm : hm;
...
function vm(e, t, n, r) {
  ...
  }), ke = dm(Z), be = Y(ke, 1), ye = be[0], Ke = function(he) {
    switch (he) {
      case Dr:
...
function ym(e) {
  ...
  var r = /* @__PURE__ */ p.forwardRef(function(a, o) {
    ...
    var x = vm(A, l, k, a), w = Y(x, 4), S = w[0], T = w[1], P = w[2], L = w[3], _ = p.useRef(L);
    L && (_.current = !0);
    ...
    if (/* @__PURE__ */ p.isValidElement(O) && kf(O)) {
      var N = O, M = N.ref;
    ...
    return wt(o, [{
      ...
      value: function() {
        ...
        return wm.forEach(function(h) {
          ...
          var E = h.status, b = hn(h, Em), k = E === _o || E === jo;
...
const Nm = Q.env.NODE_ENV !== "production" ? Ul : () => null;
var Pm = function(e, t) {
  var n = {};
  for (var r in e) Object.prototype.hasOwnProperty.call(e, r) && t.indexOf(r) < 0 && (n[r] = e[r]);
  if (e != null && typeof Object.getOwnPropertySymbols == "function") for (var a = 0, r = Object.getOwnPropertySymbols(e); a < r.length; a++)
...
const _m = (e) => {
  ...
  let Ie = /* @__PURE__ */ p.createElement(p.Fragment, null, /* @__PURE__ */ p.createElement(Nm, {
    dropdownMatchSelectWidth: g
  }), t);
  const ji = p.useMemo(() => {
    var Te, _e, gt, vt;
  ...
  Object.keys(ji).length > 0 && (Ie = /* @__PURE__ */ p.createElement(Wh.Provider, {
    ...
    value: Gu
  }, Ie)), i && (Ie = /* @__PURE__ */ p.createElement(Np, {
    size: i
  }, Ie)), Ie = /* @__PURE__ */ p.createElement(km, null, Ie);
  const Ku = p.useMemo(() => {
    const Te = Zn || {}, {
      algorithm: _e,
      token: gt,
  ...
  return b && (Ie = /* @__PURE__ */ p.createElement(wl.Provider, {
    ...
    value: bn.warning
  }, Ie)), k !== void 0 && (Ie = /* @__PURE__ */ p.createElement(kp, {
    disabled: k
...
var X = {
  ...
  }), S = ug(u), T = Y(S, 2), P = T[0], L = T[1], _ = L.offset, B = L.threshold, O = L.gap, I = P && (k.length > 0 || w.length <= B), $ = typeof l == "function" ? l(r) : l;
  return p.useEffect(function() {
    ...
    var M = R.config, j = R.className, D = R.style, F = R.index, z = M, H = z.key, G = z.times, K = String(H), te = M, Z = te.className, ke = te.style, be = te.classNames, ye = te.styles, Ke = hn(te, dg), Ne = w.findIndex(function(Ue) {
      return Ue.key === K;
    }), xe = {};
    if (P) {
...
const Hs = 24, Vg = 4.5, Wg = "topRight", Gg = (e) => {
  ...
  const {
    ...
    notification: m,
    direction: h
  } = p.useContext(Kt), [, A] = Qn(), E = a || g("notification"), b = (T) => Hg(T, n ?? Hs, r ?? Hs), k = () => tt({
    [`${E}-rtl`]: l ?? h === "rtl"
  }), x = () => Ug(E), [w, S] = mg({
    prefixCls: E,
    style: b,
...
var tn, jt, kn, ec, s0 = (ec = class extends Tr {
  constructor() {
    super();
    ne(this, tn);
    ne(this, jt);
...
}, tn = new WeakMap(), jt = new WeakMap(), kn = new WeakMap(), ec), Oi = new s0(), Nn, Lt, Pn, tc, c0 = (tc = class extends Tr {
  constructor() {
    super();
    ne(this, Nn, !0);
    ne(this, Lt);
...
}, Nn = new WeakMap(), Lt = new WeakMap(), Pn = new WeakMap(), tc), da = new c0();
function Qo() {
  let e, t;
...
function Eu(e) {
  ...
  const o = Qo(), s = (m) => {
    ...
    Promise.resolve(m).then(d).catch((A) => {
      ...
      if (r)
        return;
      const E = e.retry ?? (pn ? 0 : 3), b = e.retryDelay ?? l0, k = typeof b == "function" ? b(n, A) : b, x = E === !0 || typeof E == "number" && n < E || typeof E == "function" && E(n, A);
      if (t || !x) {
        f(A);
        return;
      }
      n++, (w = e.onFail) == null || w.call(e, n, A), a0(k).then(() => c() ? void 0 : g()).then(() => {
        t ? f(A) : v();
      });
    });
  };
...
}, nn = new WeakMap(), nc), Rn, Mn, at, Be, br, rn, lt, Nt, rc, d0 = (rc = class extends wu {
  constructor(t) {
    super();
    ne(this, lt);
    ne(this, Rn);
  ...
  return {
    onFetch: (t, n) => {
      ...
      const c = async () => {
        ...
        if (a && o.length) {
          const b = a === "backward", k = b ? v0 : Qs, x = {
            pages: o,
            pageParams: s
          }, w = k(r, x);
          l = await E(x, w, b);
...
var ku = p.createContext(
  ...
  e.unmount();
}), [e]), /* @__PURE__ */ y.jsx(ku.Provider, { value: e, children: t })), Pu = p.createContext(!1), E0 = () => p.useContext(Pu);
Pu.Provider;
function w0() {
  let e = !1;
  return {
...
var P0 = (e, t) => {
  ...
  throwOnError: n,
  query: r
}) => e.isError && !t.isReset() && !e.isFetching && r && k0(n, [e.error, r]), O0 = (e) => {
...
function j0(e, t, n) {
  ...
  const r = Nu(), a = E0(), o = A0(), s = r.defaultQueryOptions(e);
...
function z0({
  ...
  const r = Nu(), { data: a } = $0(), { data: o } = F0(), [s, l] = p.useState(null), [i, c] = p.useState(!1), [u, d] = p.useState(Ee.createTokenMap(() => "")), [f, g] = p.useState(!1), [v, m] = p.useState(!1), [h, A] = p.useState([]);
  p.useEffect(() => {
    e && b();
  }, [e]);
...
function Q0({
  ...
  const [c, u] = p.useState(""), [d, f] = p.useState(""), [g, v] = p.useState(""), [m, h] = p.useState(!1), A = p.useRef(), [E, b] = p.useState(!1), { data: k } = G0(), [x, w] = p.useState(null), [S, T] = p.useState(a), [P, L] = p.useState("0"), [_, B] = p.useState(""), [O, I] = p.useState(!1), [$, R] = p.useState(!1), [N, M] = p.useState(!1), [j, D] = p.useState(!1), [F, z] = p.useState(""), [H, G] = p.useState(""), [K, te] = p.useState(""), { t: Z } = di(), ke = Gi(d, 800), be = Gi(c, 800), ye = p.useRef(null), [Ke, Ne] = p.useState(0), xe = p.useMemo(() => S ? Ee.getToken(S).symbol : "", [S]), V = p.useMemo(() => S ? Ee.getToken(S).gasSymbol : "", [S]), [De, fe] = p.useState(!1), [Oe, Qe] = p.useState(!1), [Me, ge] = p.useState(null);
  p.useEffect(() => {
      ...
      /* @__PURE__ */ y.jsx("div", { className: "p-6 border-b border-[#EBEBEB] max-h-[70vh] overflow-y-auto", children: /* @__PURE__ */ y.jsxs("form", { children: [
        /* @__PURE__ */ y.jsxs("div", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ y.jsxs("div", { className: "relative", children: [
            ...
            N && /* @__PURE__ */ y.jsx("div", { className: "absolute right-3 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ y.jsx(yd, { className: "animate-spin", size: 16 }) }),
    ...
    children: [
      {
        path: "/",
        async lazy() {
          const { default: e } = await import("./main-layout-BPQh4QAN.js");
          return { Component: e };
        },
        children: [
          {
            path: "/",
            async lazy() {
              const { default: e } = await import("./page-CF6u9yb-.js");
              return { Component: e };
            }
          },
          {
            path: "/auth",
            async lazy() {
              const { default: e } = await import("./page-CcJKQXwH.js");
              return { Component: e };
            }
          },
          {
            ...
            async lazy() {
              const { default: e } = await import("./page-HyzscntC.js");
              return { Component: e };
            }
          },
          {
            path: "/verify-auth",
            async lazy() {
              const { default: e } = await import("./page-B0vNkmHo.js");
              return { Component: e };
            }
          },
          {
            ...
            async lazy() {
              const { default: e } = await import("./page-Qiy8JIuo.js");
              return { Component: e };
            }
          },
          {
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-oQV2sNe0.js");
                  return { Component: e };
                }
              },
              {
                path: "viewall",
                async lazy() {
                  const { default: e } = await import("./page-JU17eIRy.js");
                  return { Component: e };
                }
              },
              {
                path: ":token",
                async lazy() {
                  const { default: e } = await import("./page-moLwBK7N.js");
                  return { Component: e };
                }
              }
            ]
            ...
            children: [
              {
                index: !0,
                async lazy() {
                  const { default: e } = await import("./page-xK-9KqR8.js");
                  return { Component: e };
                },
                loader: gv
              },
              {
                path: "search-result",
                async lazy() {
                  const { default: e } = await import("./page-DPbJYard.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-VMtdzyho.js");
                  return { Component: e };
                }
              },
              {
                ...
                async lazy() {
                  const { default: e } = await import("./page-C6_NGKwc.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-proxy",
                async lazy() {
                  const { default: e } = await import("./page-D1O0CHxh.js");
                  return { Component: e };
                }
              },
              {
                path: "kyb-self",
                async lazy() {
                  const { default: e } = await import("./page-CbnYBRIO.js");
                  return { Component: e };
                }
              },
              {
                path: "kyc",
                async lazy() {
                  const { default: e } = await import("./page-hubBFa4m.js");
                  return { Component: e };
                }
              },
              {
                    ...
                    children: [
                      {
                        path: "starting",
                        async lazy() {
                          const { default: e } = await import("./page-Cc5j252g.js");
                          return { Component: e };
                        }
                      },
                      {
                        path: "ending",
                        async lazy() {
                          const { default: e } = await import("./page-BmQFmetp.js");
                          return { Component: e };
                        }
                      }
                    ]
            ...
            children: [
              {
                path: "transfer",
                async lazy() {
                  const { default: e } = await import("./page-CKSVJhgr.js");
                  return { Component: e };
                }
              },
              {
                path: "register",
                async lazy() {
                  const { default: e } = await import("./page-CxAJfeCL.js");
                  return { Component: e };
                }
              }
            ]
          },
          {
            path: "profile",
            async lazy() {
              const { default: e } = await import("./index-Bnlda7m6.js");
              return { Component: e };
            }
          },
          {
            path: "multisender",
            async lazy() {
              const { default: e } = await import("./page-BldF0php.js");
              return { Component: e };
            }
          },
          {
            path: "my-rewards",
            async lazy() {
              const { default: e } = await import("./page-DJGcCkSd.js");
              return { Component: e };
            }
          }
        ]
...
function Wu({
  ...
  return kv(e, n, t), n ? /* @__PURE__ */ y.jsx(
    "div",
    {
      id: _i,
      className: r,
...
function Wv() {
  return /* @__PURE__ */ y.jsxs(y.Fragment, { children: [
    /* @__PURE__ */ y.jsx("div", { className: "font-['Roboto']", children: /* @__PURE__ */ y.jsx(p.Suspense, { children: /* @__PURE__ */ y.jsx(S0, { client: Vv, children: /* @__PURE__ */ y.jsxs(kd, { i18n: Ec, children: [
