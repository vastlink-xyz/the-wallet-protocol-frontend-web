import { j as e, t as I, v as M, w as W, x as D } from "./vendor-radix-hWeKeDdS.js";
import { c as O, a as d, k as V } from "./vendor-react-DM3ZG7W6.js";
import { c as h, a as z, M as _, t as q, B as b, f as A, T as Q, L as X, g as T, v as G, w as J } from "./main-Bd6o8N0r.js";
import { X as K, S as H, A as Y } from "./vendor-ui-utils-DxmL71y2.js";
import { u as Z, B as w } from "./vendor-utils-ZATHw6Y5.js";
import { u as ee } from "./useTransaction-CvOKsxXt.js";
import { L as te } from "./index-CLZU21on.js";
import { f as se } from "./vendor-web3-DmEdZR0k.js";
import { u as ae, b as ne } from "./MarketplaceProvider-DsJGUUBB.js";
function we({
  text: i,
...
function je({
  ...
  const { t: a } = Z(), [t, l] = d.useState(!1), [x, p] = d.useState(!1), [g, y] = d.useState(""), [u, N] = d.useState(""), [s, m] = d.useState(!1), j = d.useRef(), v = d.useRef(), { signTransaction: U, waitForTransactionExection: de } = ee();
  d.useEffect(() => {
    B();
  }, []);
  const B = async () => {
    ...
    N(R);
  }, C = async (r) => (await A.get(`/thirdparty/sign-moonpay-params?url=${encodeURIComponent(r)}`)).data.signature, E = () => {
    n(!1), l(!1), p(!1);
  }, k = async (r) => {
    if (m(!1), await L()) {
