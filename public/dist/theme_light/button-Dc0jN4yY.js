import { a as d, p as W, R as g } from "./vendor-react-BNvQ9I2c.js";
import { aq as Ht, an as Ve, s as Bt, ar as Rt, as as Ot, at as _t, w as ie, al as Je, au as wt, av as xe, n as I, m as ae, aw as Ke, o as $e, ax as Lt, ay as Nt, t as Qe, ah as Pt, ai as It, G as Ze, F as ke, _ as Z, H as se, az as fe, J as jt, q as re, aA as Dt, aB as zt, U as Tt } from "./main-C7od9bzF.js";
import { h as et, b as Mt, j as At, u as Wt, d as Gt, o as Vt } from "./index--OK2eXqO.js";
import { _ as ne } from "./vendor-ui-utils-CsaM-dHT.js";
import { i as L, j as tt, g as A, _ as Ft } from "./vendor-web3-DanlmASa.js";
const no = (e, t) => {
...
const Kr = {
  ...
  const {
    ...
    direction: j,
    button: f
  } = d.useContext(ae), X = (r = D ?? (f == null ? void 0 : f.autoInsertSpace)) !== null && r !== void 0 ? r : !0, $ = U("btn", s), [Le, vt, bt] = Mr($), pt = d.useContext(Tt), J = S ?? pt, Ct = d.useContext(it), ee = d.useMemo(() => Jr(a), [a]), [q, Ne] = d.useState(ee.loading), [ue, Pe] = d.useState(!1), K = xe(t, /* @__PURE__ */ d.createRef()), Ie = d.Children.count(B) === 1 && !y && !oe(N);
  d.useEffect(() => {
    let R = null;
