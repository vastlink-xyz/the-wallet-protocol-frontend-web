import { j as $ } from "./vendor-radix-BMBq7gbN.js";
import { r as s } from "./vendor-react-BA5A8Axg.js";
import { a as O, ae as ye, g as r, ac as ge, u as ke } from "./main-D5sRvz5I.js";
import { W as xe, h as Te, i as Ee, U as Pe } from "./vendor-walletconnect-Bh9Uj1j6.js";
import { u as _e, B as C } from "./vendor-utils-7AahqLO2.js";
import { u as we } from "./useTransaction-Bnh4SJ28.js";
import { f as je, n as Re } from "./vendor-web3-CqtRdeC5.js";
const F = s.createContext(void 0);
function Ae({ children: c }) {
  const { t: k } = _e(), m = O.isAuthenticated(), [x, l] = s.useState(""), [T, E] = s.useState(), [p, d] = s.useState(), [V] = s.useState(ye), [H, S] = s.useState(!1), [L, v] = s.useState(!1), [P, z] = s.useState({ method: "", message: "", topic: "", response: {} }), [_, w] = s.useState(null), j = s.useRef(null), [G, y] = s.useState(!1), [u, K] = s.useState(null), { signTransaction: Q, waitForTransactionExection: X, tokenTypeByChainId: Y } = we(), [Z, R] = s.useState(!1), [ee, M] = s.useState(!1), [se, te] = s.useState({ name: "", url: "" }), [W, q] = s.useState(!1), [t, ne] = s.useState(), I = s.useRef(), oe = (e) => {
    ne(e), I.current = e;
  }, f = s.useCallback(() => {
    var n;
    const e = (n = I.current) == null ? void 0 : n.getActiveSessions();
  ...
  s.useEffect(() => (ae(), re(), () => {
    t && (t.off("session_proposal", A), t.off("proposal_expire", D), t.off("session_request", b), t.off("session_delete", N));
  }), []), s.useEffect(() => {
    t && (t.on("session_proposal", A), t.on("proposal_expire", D), t.on("session_request", b), t.on("session_delete", N), f());
  }, [t, b, N, f]);
  const ce = async (e) => {
    ...
    try {
      ...
      v(!0);
      const Ce = await ((g = I.current) == null ? void 0 : g.approveSession({ id: n, namespaces: Se }));
      d(Ce), q(!0), S(!1), R(!1), w(null), C.success(k("toastSuccess.connectSuccess"));
    } catch (a) {
