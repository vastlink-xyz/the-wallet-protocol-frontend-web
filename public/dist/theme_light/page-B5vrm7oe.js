...
import { j as T, a as l, k as A, l as R, o as z } from "./vendor-react-DM3ZG7W6.js";
import { c as p, r as C, f as B, h as I, s as S } from "./main-DvzXJLQE.js";
import { S as M, P as O } from "./ProductList-FiAU67Dq.js";
import { b as F } from "./MarketplaceProvider-DIjx3ZbW.js";
import { l as E, b as P } from "./vendor-ui-utils-BIQ1poue.js";
import { B as _ } from "./vendor-utils-CV-CuKFW.js";
import { E as D } from "./index-C79W5kXk.js";
const L = [
  "Most popular",
  "Free",
  "Latest",
...
function G({
  ...
  const { checkNewProducts: m, hasNewProducts: n } = F(), i = T(), h = L, [a, w] = l.useState(!1), [o, x] = l.useState(!1), d = l.useRef(null), [b, y] = l.useState(!1), v = l.useRef(0), f = () => {
    const t = d.current;
    if (t) {
...
function X() {
  const r = A(), [u] = R(), m = u.get("category"), [n, i] = l.useState(!1), [h, a] = l.useState(L[0]), {
    ...
    updateTotal: x,
    updatePageSize: d
  } = C(), { products: b, total: y } = z(), [v, f] = l.useState(b), g = l.useCallback(async (s) => {
    try {
      i(!0);
