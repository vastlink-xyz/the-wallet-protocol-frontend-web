...
import { c as p, B as j } from "./main-aWh1b37I.js";
import { i as g, r as n } from "./vendor-react-wyPiRY-L.js";
function v({
  title: i,
  buttonText: l,
  redirectUrl: t,
  ...
  const c = g(), [o, d] = n.useState(m), [s, r] = n.useState(!1);
  return n.useEffect(() => {
    const f = setInterval(() => {
      s || d((u) => u - 1);
    }, 1e3);
    ...
    o === 0 && !s && (a ? (window.open(t, "_blank"), r(!0)) : c(t));
  }, [o, c, t, a, s]), /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    /* @__PURE__ */ e.jsx("div", { className: "mt-[48px] mb-[27px] text-center text-black text-[28px] font-bold leading-[36.96px]", children: i }),
