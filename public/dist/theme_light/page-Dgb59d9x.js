import { B as P, G as A, V as L, j as e, E as g, F as M, H as j, J as N, K as Y, M as y, N as _, Q as w, U as S, W as q, X as F, Y as b } from "./vendor-radix-C4qF-rbz.js";
import { a as n } from "./vendor-react-KTk2TwQ7.js";
import { c as d, a as H, I as J, B as p, i as h, l as f } from "./main-Cnoo90sq.js";
import { C as K } from "./card-73JawrGP.js";
import { j as v, k as Q, a as W, T as X, l as $ } from "./vendor-ui-utils-C5-iOwQy.js";
import { v as x } from "./vendor-utils-D1d8vwmL.js";
const O = P, Z = A, ee = L, C = n.forwardRef(({ className: s, children: r, ...l }, c) => /* @__PURE__ */ e.jsxs(
  g,
  {
    ref: c,
    className: d(
...
const B = n.forwardRef(({ className: s, ...r }, l) => /* @__PURE__ */ e.jsx(
  N,
  {
    ref: l,
    className: d(
...
const R = n.forwardRef(({ className: s, children: r, position: l = "popper", ...c }, m) => /* @__PURE__ */ e.jsx(Y, { children: /* @__PURE__ */ e.jsxs(
  y,
  {
    ref: m,
    className: d(
...
const I = n.forwardRef(({ className: s, children: r, ...l }, c) => /* @__PURE__ */ e.jsxs(
  S,
  {
    ...
    ...l,
    children: [
      /* @__PURE__ */ e.jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ e.jsx(q, { children: /* @__PURE__ */ e.jsx(W, { className: "h-4 w-4" }) }) }),
...
function de() {
  ...
  const m = async () => {
    const { address: a, username: t } = H.all();
    r([{
      id: x(),
      email: t,
      address: a,
    ...
    try {
      ...
      if (u.data.success) {
        const G = u.data.address;
        o.address = G, o.isValid = !0;
      } else
    ...
    s.map((a, t) => /* @__PURE__ */ e.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ e.jsx("div", { className: "ml-4 cursor-pointer text-destructive", onClick: () => E(t), children: /* @__PURE__ */ e.jsx(X, { size: 20, className: "hover:scale-105" }) })
        ]
      },
      a.id
    )),
    /* @__PURE__ */ e.jsxs(p, { onClick: () => T(), size: "sm", children: [
      /* @__PURE__ */ e.jsx($, { className: "mr-2", size: 18 }),
      "Add New Signer"
    ] }),
    /* @__PURE__ */ e.jsx("h2", { className: "mb-4 mt-10 font-bold text-2xl", children: "Threshold" }),
    /* @__PURE__ */ e.jsxs("div", { className: "flex items-center", children: [
      /* @__PURE__ */ e.jsxs(O, { onValueChange: U, value: l.toString(), children: [
        /* @__PURE__ */ e.jsx(C, { className: "w-[60px]", children: /* @__PURE__ */ e.jsx(ee, { placeholder: "Select threshold" }) }),
        /* @__PURE__ */ e.jsx(R, { children: /* @__PURE__ */ e.jsx(Z, { children: s.map((a, t) => /* @__PURE__ */ e.jsx(I, { value: (t + 1).toString(), children: t + 1 }, t + 1)) }) })
      ] }),
