import { r as c, p as uo, a as Zt, R as ze, $ as xa, b as ba } from "./vendor-react-lU71vM3H.js";
var Ln = { exports: {} }, ht = {};
/**
 * @license React
...
function Ca() {
  if (Wr) return ht;
  Wr = 1;
  var e = c, t = Symbol.for("react.element"), n = Symbol.for("react.fragment"), r = Object.prototype.hasOwnProperty, o = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, i = { key: !0, ref: !0, __self: !0, __source: !0 };
  function s(a, l, u) {
...
var gt = {}, Br;
function Ea() {
  return Br || (Br = 1, uo.env.NODE_ENV !== "production" && function() {
    ...
    var S = !1, R = !1, O = !1, P = !1, M = !1, $;
    $ = Symbol.for("react.module.reference");
    function W(p) {
      return !!(typeof p == "string" || typeof p == "function" || p === r || p === i || M || p === o || p === u || p === f || P || p === g || S || R || O || typeof p == "object" && p !== null && (p.$$typeof === m || p.$$typeof === d || p.$$typeof === s || p.$$typeof === a || p.$$typeof === l || // This needs to include all possible module reference object
...
` + B[re].replace(" at new ", " at ");
    ...
    function Mr(p) {
      if (ta(p))
        return y("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", ea(p)), Ar(p);
    }
    var mt = b.ReactCurrentOwner, na = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    var ca = function(p, E, T, j, ee, te, K) {
      var B = {
    ...
    function la(p, E, T, j, ee) {
      {
        var te, K = {}, B = null, ce = null;
        T !== void 0 && (Mr(T), B = "" + T), oa(E) && (Mr(E.key), B = "" + E.key), ra(E) && (ce = E.ref, ia(E, ee));
        for (te in E)
          Ee.call(E, te) && !na.hasOwnProperty(te) && (K[te] = E[te]);
        if (p && p.defaultProps) {
        ...
        if (B || ce) {
          ...
          B && sa(K, oe), ce && aa(K, oe);
        }
        return ca(p, B, ce, ee, j, mt.current, K);
      }
    }
    ...
    function da(p) {
      {
        ...
        if (T) {
          var j = k(E);
          Js(T, p.props, "prop", j, p);
        } else if (E.PropTypes !== void 0 && !Sn) {
          Sn = !0;
          var ee = k(E);
    ...
    function $r(p, E, T, j, ee, te) {
      {
        ...
        if (Ee.call(E, "key")) {
          var Ye = k(p), de = Object.keys(E).filter(function(ya) {
            return ya !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Pn, Ye, wa, Ye), Fr[Ye + Pn] = !0;
          }
        }
        return p === r ? pa(oe) : da(oe), oe;
      }
    }
    function va(p, E, T) {
      return $r(p, E, T, !0);
    ...
    var ha = ma, ga = va;
    gt.Fragment = r, gt.jsx = ha, gt.jsxs = ga;
  }()), gt;
}
uo.env.NODE_ENV === "production" ? Ln.exports = Ca() : Ln.exports = Ea();
var h = Ln.exports;
...
function Le({
  ...
  const [r, o] = Ta({ defaultProp: t, onChange: n }), i = e !== void 0, s = i ? e : r, a = xe(n), l = c.useCallback(
    (u) => {
      if (i) {
...
var Fe = c.forwardRef((e, t) => {
  const { children: n, ...r } = e, o = c.Children.toArray(n), i = o.find(_a);
  if (i) {
...
var fo = ({ children: e }) => /* @__PURE__ */ h.jsx(h.Fragment, { children: e });
function _a(e) {
...
function tr(e) {
  ...
  const a = e + "CollectionSlot", l = ze.forwardRef(
    (g, w) => {
      ...
      return /* @__PURE__ */ h.jsx(Fe, { ref: y, children: x });
    }
  );
  l.displayName = a;
  const u = e + "CollectionItemSlot", f = "data-radix-collection-item", d = ze.forwardRef(
    (g, w) => {
      const { scope: v, children: x, ...b } = g, y = ze.useRef(null), C = q(w, y), S = i(u, v);
      return ze.useEffect(() => (S.itemMap.set(y, { ref: y, ...b }), () => void S.itemMap.delete(y))), /* @__PURE__ */ h.jsx(Fe, { [f]: "", ref: C, children: x });
    }
  );
  d.displayName = u;
  function m(g) {
    ...
    return ze.useCallback(() => {
      ...
      return Array.from(w.itemMap.values()).sort(
        (S, R) => b.indexOf(S.ref.current) - b.indexOf(R.ref.current)
      );
...
var Da = c.createContext(void 0);
function Qt(e) {
  const t = c.useContext(Da);
  return e || t || "ltr";
}
...
var ja = "DismissableLayer", $n = "dismissableLayer.update", ka = "dismissableLayer.pointerDownOutside", La = "dismissableLayer.focusOutside", Vr, vo = c.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...l
    } = e, u = c.useContext(vo), [f, d] = c.useState(null), m = (f == null ? void 0 : f.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, g] = c.useState({}), w = q(t, (P) => d(P)), v = Array.from(u.layers), [x] = [...u.layersWithOutsidePointerEventsDisabled].slice(-1), b = v.indexOf(x), y = f ? v.indexOf(f) : -1, C = u.layersWithOutsidePointerEventsDisabled.size > 0, S = y >= b, R = Wa((P) => {
      const M = P.target, $ = [...u.branches].some((W) => W.contains(M));
      !S || $ || (o == null || o(P), s == null || s(P), P.defaultPrevented || a == null || a());
    }, m), O = Ba((P) => {
      const M = P.target;
...
ft.displayName = ja;
var Fa = "DismissableLayerBranch", $a = c.forwardRef((e, t) => {
  const n = c.useContext(vo), r = c.useRef(null), o = q(t, r);
  return c.useEffect(() => {
    const i = r.current;
    if (i)
...
function Ba(e, t = globalThis == null ? void 0 : globalThis.document) {
  ...
  return c.useEffect(() => {
    const o = (i) => {
      i.target && !r.current && mo(La, n, { originalEvent: i }, {
        discrete: !1
      });
    };
...
var _n = "focusScope.autoFocusOnMount", An = "focusScope.autoFocusOnUnmount", Kr = { bubbles: !1, cancelable: !0 }, Va = "FocusScope", St = c.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  c.useEffect(() => {
    if (r) {
      let v = function(C) {
        ...
        const S = C.target;
        a.contains(S) ? d.current = S : ke(d.current, { select: !0 });
      }, x = function(C) {
        if (g.paused || !a) return;
        const S = C.relatedTarget;
        S !== null && (a.contains(S) || ke(d.current, { select: !0 }));
      }, b = function(C) {
    ...
    if (a) {
      ...
      if (!a.contains(v)) {
        ...
        a.addEventListener(_n, u), a.dispatchEvent(b), b.defaultPrevented || (Ha(za(ho(a)), { select: !0 }), document.activeElement === v && ke(a));
      }
      return () => {
  ...
  const w = c.useCallback(
    (v) => {
      ...
      if (x && b) {
        const y = v.currentTarget, [C, S] = Ua(y);
        C && S ? !v.shiftKey && b === S ? (v.preventDefault(), n && ke(C, { select: !0 })) : v.shiftKey && b === C && (v.preventDefault(), n && ke(S, { select: !0 })) : b === y && v.preventDefault();
      }
    },
    [n, r, g.paused]
  );
...
function Ua(e) {
  const t = ho(e), n = Gr(t, e), r = Gr(t.reverse(), e);
  return [n, r];
}
function ho(e) {
...
function we(e) {
  const [t, n] = c.useState(Xa());
  return le(() => {
    e || n((r) => r ?? String(qa++));
  }, [e]), e || (t ? `radix-${t}` : "");
}
const Za = ["top", "right", "bottom", "left"], $e = Math.min, pe = Math.max, Ht = Math.round, Nt = Math.floor, We = (e) => ({
  x: e,
  y: e
}), Ja = {
  left: "right",
...
const ic = async (e, t, n) => {
  ...
  for (let v = 0; v < a.length; v++) {
    ...
    }, R && w <= 50 && (w++, typeof R == "object" && (R.placement && (m = R.placement), R.rects && (u = R.rects === !0 ? await s.getElementRects({
      reference: e,
      floating: t,
      strategy: o
    }) : R.rects), {
...
async function xt(e, t) {
  ...
  const {
    ...
    altBoundary: m = !1,
    padding: g = 0
  } = De(t, e), w = go(g), x = a[m ? d === "floating" ? "reference" : "floating" : d], b = Kt(await i.getClippingRect({
  ...
  } : s.reference, C = await (i.getOffsetParent == null ? void 0 : i.getOffsetParent(a.floating)), S = await (i.isElement == null ? void 0 : i.isElement(C)) ? await (i.getScale == null ? void 0 : i.getScale(C)) || {
    x: 1,
    y: 1
  } : {
    x: 1,
    y: 1
  }, R = Kt(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
    elements: a,
    rect: y,
    offsetParent: C,
    strategy: l
  ...
  return {
    top: (b.top - R.top + w.top) / S.y,
    bottom: (R.bottom - b.bottom + w.bottom) / S.y,
    left: (b.left - R.left + w.left) / S.x,
...
const sc = (e) => ({
  ...
  async fn(t) {
    ...
    const d = go(f), m = {
      x: n,
      y: r
    }, g = or(o), w = rr(g), v = await s.getDimensions(u), x = g === "y", b = x ? "top" : "left", y = x ? "bottom" : "right", C = x ? "clientHeight" : "clientWidth", S = i.reference[w] + i.reference[g] - m[g] - i.floating[w], R = m[g] - i.reference[g], O = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(u));
    let P = O ? O[C] : 0;
    (!P || !await (s.isElement == null ? void 0 : s.isElement(O))) && (P = a.floating[C] || i.floating[w]);
    const M = S / 2 - R / 2, $ = P / 2 - v[w] / 2 - 1, W = $e(d[b], $), G = $e(d[y], $), V = W, k = P - v[w] - G, L = P / 2 - v[w] / 2 + M, z = Wn(V, L, k), N = !l.arrow && dt(o) != null && L !== z && i.reference[w] / 2 - (L < V ? W : G) - v[w] / 2 < 0, H = N ? L < V ? L - V : L - k : 0;
    return {
      [g]: m[g] + H,
      data: {
        [g]: z,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = i.arrow) != null && n.alignmentOffset)
        return {};
      const b = Ne(o), y = Be(a), C = Ne(a) === a, S = await (l.isRTL == null ? void 0 : l.isRTL(u.floating)), R = m || (C || !v ? [Ut(a)] : tc(a)), O = w !== "none";
      !m && O && R.push(...rc(a, v, w, S));
      const P = [a, ...R], M = await xt(t, x), $ = [];
...
const uc = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (l) {
        const C = m === "y" ? "height" : "width", S = i.reference[m] - i.floating[C] + x.mainAxis, R = i.reference[m] + i.reference[C] - x.mainAxis;
        g < S ? g = S : g > R && (g = R);
      }
      if (u) {
        var b, y;
        const C = m === "y" ? "width" : "height", S = ["top", "left"].includes(Ne(o)), R = i.reference[d] - i.floating[C] + (S && ((b = s.offset) == null ? void 0 : b[d]) || 0) + (S ? 0 : x.crossAxis), O = i.reference[d] + i.reference[C] + (S ? 0 : ((y = s.offset) == null ? void 0 : y[d]) || 0) - (S ? x.crossAxis : 0);
        w < R ? w = R : w > O && (w = O);
      }
      return {
        [m]: g,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const y = v - f.top - f.bottom, C = w - f.left - f.right, S = $e(v - f[x], y), R = $e(w - f[b], C), O = !t.middlewareData.shift;
      let P = S, M = R;
...
function yo(e) {
  const t = Ve(e);
  return ct(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Me(t) && Rt(t) ? t : yo(t);
}
function bt(e, t, n) {
  var r;
  t === void 0 && (t = []), n === void 0 && (n = !0);
  const o = yo(e), i = o === ((r = e.ownerDocument) == null ? void 0 : r.body), s = ve(o);
  if (i) {
    const a = Vn(s);
    return t.concat(s, s.visualViewport || [], Rt(o) ? o : [], a && n ? bt(a) : []);
  }
...
const hc = /* @__PURE__ */ We(0);
function bo(e) {
  const t = ve(e);
  return !sr() || !t.visualViewport ? hc : {
...
function Xe(e, t, n, r) {
  ...
  let s = We(1);
  t && (r ? Re(r) && (s = st(r)) : s = st(e));
  const a = gc(i, n, r) ? bo(i) : We(0);
  let l = (o.left + a.x) / s.x, u = (o.top + a.y) / s.y, f = o.width / s.x, d = o.height / s.y;
  if (i) {
    const m = ve(i), g = r && Re(r) ? ve(r) : r;
    let w = m, v = Vn(w);
    for (; v && r && g !== w; ) {
      const x = st(v), b = v.getBoundingClientRect(), y = Pe(v), C = b.left + (v.clientLeft + parseFloat(y.paddingLeft)) * x.x, S = b.top + (v.clientTop + parseFloat(y.paddingTop)) * x.y;
      l *= x.x, u *= x.y, f *= x.x, d *= x.y, l += C, u += S, w = ve(v), v = Vn(w);
    }
  }
  return Kt({
    width: f,
...
function wc(e) {
  ...
  const f = We(0), d = Me(r);
  if ((d || !d && !i) && ((pt(r) !== "body" || Rt(s)) && (l = rn(r)), Me(r))) {
    const m = Xe(r);
...
function Co(e, t) {
  const n = Ve(e);
  return n === t || !Re(n) || ct(n) ? !1 : Pe(n).position === "fixed" || Co(n, t);
}
function Ec(e, t) {
  const n = t.get(e);
  if (n)
    return n;
  let r = bt(e, [], !1).filter((a) => Re(a) && pt(a) !== "body"), o = null;
  const i = Pe(e).position === "fixed";
  let s = i ? Ve(e) : e;
  for (; Re(s) && !ct(s); ) {
    const a = Pe(s), l = ir(s);
    !l && a.position === "fixed" && (o = null), (i ? !l && !o : !l && a.position === "static" && !!o && ["absolute", "fixed"].includes(o.position) || Rt(s) && !l && Co(e, s)) ? r = r.filter((f) => f !== s) : o = a, s = Ve(s);
  }
  return t.set(e, r), r;
}
function Sc(e) {
  ...
  const s = [...n === "clippingAncestors" ? nn(t) ? [] : Ec(t, this._c) : [].concat(n), r], a = s[0], l = s.reduce((u, f) => {
    const d = Qr(t, f, o);
...
function Eo(e, t) {
  ...
  for (; r && vc(r) && Mn(r); )
    r = eo(r, t);
  return r && ct(r) && Mn(r) && !ir(r) ? n : r || mc(e) || n;
}
...
const Ic = uc, Dc = fc, Nc = ac, jc = pc, kc = cc, to = sc, Lc = dc, Fc = (e, t, n) => {
...
function $c(e) {
  ...
  const [w, v] = c.useState(null), [x, b] = c.useState(null), y = c.useCallback((D) => {
  ...
  }, []), S = i || w, R = s || x, O = c.useRef(null), P = c.useRef(null), M = c.useRef(f), $ = l != null, W = On(l), G = On(o), V = On(u), k = c.useCallback(() => {
    ...
    G.current && (D.platform = G.current), Fc(O.current, P.current, D).then((A) => {
      const Z = {
        ...A,
  ...
  Wt(() => (L.current = !0, () => {
    ...
    if (S && (O.current = S), R && (P.current = R), S && R) {
      if (W.current)
        return W.current(S, R, k);
      k();
    }
  }, [S, R, k, W, $]);
  const z = c.useMemo(() => ({
...
var zc = "Arrow", Ro = c.forwardRef((e, t) => {
...
var cr = "Popper", [Po, He] = er(cr), [Zc, To] = Po(cr), _o = (e) => {
  const { __scopePopper: t, children: n } = e, [r, o] = c.useState(null);
  return /* @__PURE__ */ h.jsx(Zc, { scope: t, anchor: r, onAnchorChange: o, children: n });
};
_o.displayName = cr;
var Ao = "PopperAnchor", Mo = c.forwardRef(
  (e, t) => {
    const { __scopePopper: n, virtualRef: r, ...o } = e, i = To(Ao, n), s = c.useRef(null), a = q(t, s);
    return c.useEffect(() => {
...
Mo.displayName = Ao;
var lr = "PopperContent", [Jc, Qc] = Po(lr), Oo = c.forwardRef(
  (e, t) => {
    var I, Y, J, U, Q, X;
    const {
      __scopePopper: n,
      ...
      onPlaced: w,
      ...v
    } = e, x = To(lr, n), [b, y] = c.useState(null), C = q(t, (ae) => y(ae)), [S, R] = c.useState(null), O = qc(S), P = (O == null ? void 0 : O.width) ?? 0, M = (O == null ? void 0 : O.height) ?? 0, $ = r + (i !== "center" ? "-" + i : ""), W = typeof f == "number" ? f : { top: 0, right: 0, bottom: 0, left: 0, ...f }, G = Array.isArray(u) ? u : [u], V = G.length > 0, k = {
      padding: W,
      boundary: G.filter(tl),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: V
    }, { refs: L, floatingStyles: z, placement: N, isPositioned: H, middlewareData: D } = $c({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: $,
      whileElementsMounted: (...ae) => Oc(...ae, {
      ...
      middleware: [
        Bc({ mainAxis: o + M, alignmentAxis: s }),
        l && Vc({
          mainAxis: !0,
          crossAxis: !1,
        ...
        S && Yc({ element: S, padding: a }),
        nl({ arrowWidth: P, arrowHeight: M }),
        m && Gc({ strategy: "referenceHidden", ...k })
      ]
    }), [A, Z] = No(N), ne = xe(w);
    le(() => {
      H && (ne == null || ne());
...
Oo.displayName = lr;
var Io = "PopperArrow", el = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, Do = c.forwardRef(function(t, n) {
  const { __scopePopper: r, ...o } = t, i = Qc(Io, r), s = el[i.placedSide];
  return (
...
var nl = (e) => ({
  ...
  fn(t) {
    var x, b, y;
    const { placement: n, rects: r, middlewareData: o } = t, s = ((x = o.arrow) == null ? void 0 : x.centerOffset) !== 0, a = s ? 0 : e.arrowWidth, l = s ? 0 : e.arrowHeight, [u, f] = No(n), d = { start: "0%", center: "50%", end: "100%" }[f], m = (((b = o.arrow) == null ? void 0 : b.x) ?? 0) + a / 2, g = (((y = o.arrow) == null ? void 0 : y.y) ?? 0) + l / 2;
    let w = "", v = "";
...
var on = _o, Pt = Mo, sn = Oo, an = Do, rl = "Portal", Tt = c.forwardRef((e, t) => {
  var a;
  const { container: n, ...r } = e, [o, i] = c.useState(!1);
  le(() => i(!0), []);
  const s = n || o && ((a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : a.body);
  return s ? ba.createPortal(/* @__PURE__ */ h.jsx(F.div, { ...r, ref: t }), s) : null;
});
Tt.displayName = rl;
function ol(e, t) {
...
var be = (e) => {
  const { present: t, children: n } = e, r = il(t), o = typeof n == "function" ? n({ present: r.isPresent }) : c.Children.only(n), i = q(r.ref, sl(o));
  return typeof n == "function" || r.isPresent ? c.cloneElement(o, { ref: i }) : null;
};
be.displayName = "Presence";
function il(e) {
  const [t, n] = c.useState(), r = c.useRef({}), o = c.useRef(e), i = c.useRef("none"), s = e ? "mounted" : "unmounted", [a, l] = ol(s, {
    mounted: {
      UNMOUNT: "unmounted",
...
var In = "rovingFocusGroup.onEntryFocus", al = { bubbles: !1, cancelable: !0 }, cn = "RovingFocusGroup", [Un, jo, cl] = tr(cn), [ll, ln] = er(
  cn,
  [cl]
), [ul, fl] = ll(cn), ko = c.forwardRef(
  (e, t) => /* @__PURE__ */ h.jsx(Un.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ h.jsx(Un.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ h.jsx(dl, { ...e, ref: t }) }) })
);
ko.displayName = cn;
var dl = c.forwardRef((e, t) => {
  const {
    ...
    ...d
  } = e, m = c.useRef(null), g = q(t, m), w = Qt(i), [v = null, x] = Le({
    prop: s,
    defaultProp: a,
    onChange: l
  }), [b, y] = c.useState(!1), C = xe(u), S = jo(n), R = c.useRef(!1), [O, P] = c.useState(0);
  return c.useEffect(() => {
    const M = m.current;
    if (M)
        ...
        F.div,
        {
          ...
          onFocus: _(e.onFocus, (M) => {
            ...
            if (M.target === M.currentTarget && $ && !b) {
              const W = new CustomEvent(In, al);
              if (M.currentTarget.dispatchEvent(W), !W.defaultPrevented) {
                const G = S().filter((N) => N.focusable), V = G.find((N) => N.active), k = G.find((N) => N.id === v), z = [V, k, ...G].filter(
                  Boolean
                ).map((N) => N.ref.current);
                $o(z, f);
              }
...
}), Lo = "RovingFocusGroupItem", Fo = c.forwardRef(
  (e, t) => {
    const {
      __scopeRovingFocusGroup: n,
      focusable: r = !0,
      ...
      tabStopId: i,
      ...s
    } = e, a = we(), l = i || a, u = fl(Lo, n), f = u.currentTabStopId === l, d = jo(n), { onFocusableItemAdd: m, onFocusableItemRemove: g } = u;
    return c.useEffect(() => {
      if (r)
        return m(), () => g();
        ...
        children: /* @__PURE__ */ h.jsx(
          F.span,
          {
            ...
            onKeyDown: _(e.onKeyDown, (w) => {
              ...
              const v = ml(w, u.orientation, u.dir);
              if (v !== void 0) {
...
var Wo = ko, Bo = Fo, gl = function(e) {
  if (typeof document > "u")
    return null;
  var t = Array.isArray(e) ? e[0] : e;
  return t.ownerDocument.body;
}, rt = /* @__PURE__ */ new WeakMap(), kt = /* @__PURE__ */ new WeakMap(), Lt = {}, Dn = 0, Vo = function(e) {
...
var Bt = "right-scroll-bar-position", Vt = "width-before-scroll-bar", bl = "with-scroll-bars-hidden", Cl = "--removed-body-scroll-bar-size";
function Nn(e, t) {
...
var Ko = _l(), jn = function() {
}, fn = c.forwardRef(function(e, t) {
  var n = c.useRef(null), r = c.useState({
    onScrollCapture: jn,
    onWheelCapture: jn,
    onTouchMoveCapture: jn
  }), o = r[0], i = r[1], s = e.forwardProps, a = e.children, l = e.className, u = e.removeScrollBar, f = e.enabled, d = e.shards, m = e.sideCar, g = e.noIsolation, w = e.inert, v = e.allowPinchZoom, x = e.as, b = x === void 0 ? "div" : x, y = e.gapMode, C = Ho(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), S = m, R = Rl([n, t]), O = Ae(Ae({}, C), o);
  return c.createElement(
    c.Fragment,
    null,
    f && c.createElement(S, { sideCar: Ko, removeScrollBar: u, shards: d, noIsolation: g, inert: w, setCallbacks: i, allowPinchZoom: !!v, lockRef: n, gapMode: y }),
    s ? c.cloneElement(c.Children.only(a), Ae(Ae({}, O), { ref: R })) : c.createElement(b, Ae({}, O, { className: l, ref: R }), a)
  );
});
fn.defaultProps = {
  enabled: !0,
...
}, $l = Go(), at = "data-scroll-locked", Wl = function(e, t, n, r) {
...
`);
  ...
  return c.createElement($l, { styles: Wl(i, !t, o, n ? "" : "!important") });
}, Kn = !1;
if (typeof window < "u")
  try {
...
var ot = Kn ? { passive: !1 } : !1, Hl = function(e) {
  ...
  return Yo(e, "overflowY");
}, Kl = function(e) {
  return Yo(e, "overflowX");
}, io = function(e, t) {
  ...
  var i = zl(e, window.getComputedStyle(t).direction), s = i * r, a = n.target, l = t.contains(a), u = !1, f = s > 0, d = 0, m = 0;
  do {
    var g = Xo(e, a), w = g[0], v = g[1], x = g[2], b = v - x - i * w;
    (w || b) && zo(e, a) && (d += b, m += w), a instanceof ShadowRoot ? a = a.host : a = a.parentNode;
  } while (
    // portaled content
...
function Ql(e) {
  var t = c.useRef([]), n = c.useRef([0, 0]), r = c.useRef(), o = c.useState(Jl++)[0], i = c.useState(Go)[0], s = c.useRef(e);
  c.useEffect(function() {
    s.current = e;
  }, [e]), c.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var v = xl([e.lockRef.current], (e.shards || []).map(ao), !0).filter(Boolean);
  ...
  var a = c.useCallback(function(v, x) {
    ...
    var b = $t(v), y = n.current, C = "deltaX" in v ? v.deltaX : y[0] - b[0], S = "deltaY" in v ? v.deltaY : y[1] - b[1], R, O = v.target, P = Math.abs(C) > Math.abs(S) ? "h" : "v";
    if ("touches" in v && P === "h" && O.type === "range")
      return !1;
    var M = io(P, O);
    if (!M)
      return !0;
    if (M ? R = P : (R = P === "v" ? "h" : "v", M = io(P, O)), !M)
      return !1;
    if (!r.current && "changedTouches" in v && (C || S) && (r.current = R), !R)
      return !0;
    var $ = r.current || R;
    return Xl($, x, v, $ === "h" ? C : S, !0);
  }, []), l = c.useCallback(function(v) {
    var x = v;
    if (!(!it.length || it[it.length - 1] !== i)) {
      var b = "deltaY" in x ? so(x) : $t(x), y = t.current.filter(function(R) {
        return R.name === x.type && (R.target === x.target || x.target === R.shadowParent) && ql(R.delta, b);
      })[0];
      if (y && y.should) {
      ...
      if (!y) {
        var C = (s.current.shards || []).map(ao).filter(Boolean).filter(function(R) {
          return R.contains(x.target);
        }), S = C.length > 0 ? a(x, C[0]) : !s.current.noIsolation;
        S && x.cancelable && x.preventDefault();
      }
    }
  }, []), u = c.useCallback(function(v, x, b, y) {
    var C = { name: v, delta: x, target: b, should: y, shadowParent: eu(b) };
  ...
  return c.createElement(
    c.Fragment,
    null,
    w ? c.createElement(i, { styles: Zl(o) }) : null,
    g ? c.createElement(Vl, { gapMode: e.gapMode }) : null
  );
}
function eu(e) {
...
var _t = c.forwardRef(function(e, t) {
  return c.createElement(fn, Ae({}, e, { ref: t, sideCar: tu }));
});
_t.classNames = fn.classNames;
var Gn = ["Enter", " "], nu = ["ArrowDown", "PageUp", "Home"], qo = ["ArrowUp", "PageDown", "End"], ru = [...nu, ...qo], ou = {
  ltr: [...Gn, "ArrowRight"],
  rtl: [...Gn, "ArrowLeft"]
}, iu = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, At = "Menu", [Ct, su, au] = tr(At), [Qe, Zo] = Je(At, [
  au,
  He,
  ln
]), dn = He(), Jo = ln(), [cu, et] = Qe(At), [lu, Mt] = Qe(At), Qo = (e) => {
...
Qo.displayName = At;
var uu = "MenuAnchor", ur = c.forwardRef(
  (e, t) => {
...
ur.displayName = uu;
var fr = "MenuPortal", [fu, ei] = Qe(fr, {
  forceMount: void 0
}), ti = (e) => {
  const { __scopeMenu: t, forceMount: n, children: r, container: o } = e, i = et(fr, t);
  return /* @__PURE__ */ h.jsx(fu, { scope: t, forceMount: n, children: /* @__PURE__ */ h.jsx(be, { present: n || i.open, children: /* @__PURE__ */ h.jsx(Tt, { asChild: !0, container: o, children: r }) }) });
};
ti.displayName = fr;
var ye = "MenuContent", [du, dr] = Qe(ye), ni = c.forwardRef(
  (e, t) => {
    const n = ei(ye, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, i = et(ye, e.__scopeMenu), s = Mt(ye, e.__scopeMenu);
    return /* @__PURE__ */ h.jsx(Ct.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: /* @__PURE__ */ h.jsx(Ct.Slot, { scope: e.__scopeMenu, children: s.modal ? /* @__PURE__ */ h.jsx(pu, { ...o, ref: t }) : /* @__PURE__ */ h.jsx(vu, { ...o, ref: t }) }) }) });
  }
), pu = c.forwardRef(
  (e, t) => {
  ...
  (e, t) => {
    const {
      ...
      ...v
    } = e, x = et(ye, n), b = Mt(ye, n), y = dn(n), C = Jo(n), S = su(n), [R, O] = c.useState(null), P = c.useRef(null), M = q(t, P, x.onContentChange), $ = c.useRef(0), W = c.useRef(""), G = c.useRef(0), V = c.useRef(null), k = c.useRef("right"), L = c.useRef(0), z = w ? _t : c.Fragment, N = w ? { as: Fe, allowPinchZoom: !0 } : void 0, H = (A) => {
      var I, Y;
      const Z = W.current + A, ne = S().filter((J) => !J.disabled), ie = document.activeElement, me = (I = ne.find((J) => J.ref.current === ie)) == null ? void 0 : I.textValue, fe = ne.map((J) => J.textValue), Ce = Pu(fe, Z, me), se = (Y = ne.find((J) => J.textValue === Ce)) == null ? void 0 : Y.ref.current;
      (function J(U) {
    ...
    const D = c.useCallback((A) => {
      var ne, ie;
      return k.current === ((ne = V.current) == null ? void 0 : ne.side) && _u(A, (ie = V.current) == null ? void 0 : ie.area);
    }, []);
    return /* @__PURE__ */ h.jsx(
      du,
      {
                    ...
                    children: /* @__PURE__ */ h.jsx(
                      sn,
                      {
                        ...
                        onKeyDown: _(v.onKeyDown, (A) => {
                          ...
                          const fe = P.current;
                          if (A.target !== fe || !ru.includes(A.key)) return;
                          A.preventDefault();
                          const se = S().filter((I) => !I.disabled).map((I) => I.ref.current);
                          qo.includes(A.key) && se.reverse(), Su(se);
                        }),
                        onBlur: _(e.onBlur, (A) => {
...
ni.displayName = ye;
var mu = "MenuGroup", vr = c.forwardRef(
  (e, t) => {
...
vr.displayName = mu;
var hu = "MenuLabel", ri = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
  ...
  (e, t) => {
    const { disabled: n = !1, onSelect: r, ...o } = e, i = c.useRef(null), s = Mt(Yt, e.__scopeMenu), a = dr(Yt, e.__scopeMenu), l = q(t, i), u = c.useRef(!1), f = () => {
      ...
      if (!n && d) {
        ...
        d.addEventListener(co, (g) => r == null ? void 0 : r(g), { once: !0 }), po(d, m), m.defaultPrevented ? u.current = !1 : s.onClose();
      }
    };
    return /* @__PURE__ */ h.jsx(
      oi,
...
var oi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: r = !1, textValue: o, ...i } = e, s = dr(Yt, n), a = Jo(n), l = c.useRef(null), u = q(t, l), [f, d] = c.useState(!1), [m, g] = c.useState("");
    return c.useEffect(() => {
      const w = l.current;
      ...
      Ct.ItemSlot,
      {
        ...
        disabled: r,
        textValue: o ?? m,
        children: /* @__PURE__ */ h.jsx(Bo, { asChild: !0, ...a, focusable: !r, children: /* @__PURE__ */ h.jsx(
          F.div,
          {
            role: "menuitem",
...
), gu = "MenuCheckboxItem", ii = c.forwardRef(
  (e, t) => {
    const { checked: n = !1, onCheckedChange: r, ...o } = e;
    return /* @__PURE__ */ h.jsx(ui, { scope: e.__scopeMenu, checked: n, children: /* @__PURE__ */ h.jsx(
      pn,
      {
...
ii.displayName = gu;
var si = "MenuRadioGroup", [wu, yu] = Qe(
  si,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ h.jsx(wu, { scope: e.__scopeMenu, value: n, onValueChange: i, children: /* @__PURE__ */ h.jsx(vr, { ...o, ref: t }) });
  }
);
ai.displayName = si;
var ci = "MenuRadioItem", li = c.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = yu(ci, e.__scopeMenu), i = n === o.value;
    return /* @__PURE__ */ h.jsx(ui, { scope: e.__scopeMenu, checked: i, children: /* @__PURE__ */ h.jsx(
      pn,
      {
        role: "menuitemradio",
        "aria-checked": i,
...
li.displayName = ci;
var mr = "MenuItemIndicator", [ui, xu] = Qe(
  mr,
  { checked: !1 }
), fi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: r, ...o } = e, i = xu(mr, n);
    return /* @__PURE__ */ h.jsx(
      be,
      {
...
var bu = "MenuSeparator", di = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
    return /* @__PURE__ */ h.jsx(
      F.div,
...
di.displayName = bu;
var Cu = "MenuArrow", pi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = dn(n);
...
pi.displayName = Cu;
var Eu = "MenuSub", [dd, vi] = Qe(Eu), wt = "MenuSubTrigger", mi = c.forwardRef(
  (e, t) => {
    const n = et(wt, e.__scopeMenu), r = Mt(wt, e.__scopeMenu), o = vi(wt, e.__scopeMenu), i = dr(wt, e.__scopeMenu), s = c.useRef(null), { pointerGraceTimerRef: a, onPointerGraceIntentChange: l } = i, u = { __scopeMenu: e.__scopeMenu }, f = c.useCallback(() => {
    ...
    return c.useEffect(() => f, [f]), c.useEffect(() => {
      ...
      oi,
      {
        ...
        onKeyDown: _(e.onKeyDown, (d) => {
          ...
          e.disabled || m && d.key === " " || ou[r.dir].includes(d.key) && (n.onOpenChange(!0), (g = n.content) == null || g.focus(), d.preventDefault());
        })
      }
    ) });
  }
...
mi.displayName = wt;
var hi = "MenuSubContent", gi = c.forwardRef(
  (e, t) => {
    const n = ei(ye, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, i = et(ye, e.__scopeMenu), s = Mt(ye, e.__scopeMenu), a = vi(hi, e.__scopeMenu), l = c.useRef(null), u = q(t, l);
    return /* @__PURE__ */ h.jsx(Ct.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: /* @__PURE__ */ h.jsx(Ct.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ h.jsx(
      pr,
      {
        ...
        onKeyDown: _(e.onKeyDown, (f) => {
          var g;
          const d = f.currentTarget.contains(f.target), m = iu[s.dir].includes(f.key);
...
var Au = Qo, Mu = ur, Ou = ti, Iu = ni, Du = vr, Nu = ri, ju = pn, ku = ii, Lu = ai, Fu = li, $u = fi, Wu = di, Bu = pi, Vu = mi, Hu = gi, gr = "DropdownMenu", [Uu, pd] = Je(
  gr,
  [Zo]
), ue = Zo(), [Ku, yi] = Uu(gr), xi = (e) => {
  const {
    ...
    onOpenChange: s,
    modal: a = !0
  } = e, l = ue(t), u = c.useRef(null), [f = !1, d] = Le({
    prop: o,
    defaultProp: i,
    onChange: s
  });
  return /* @__PURE__ */ h.jsx(
    Ku,
    {
      ...
      modal: a,
      children: /* @__PURE__ */ h.jsx(Au, { ...l, open: f, onOpenChange: d, dir: r, modal: a, children: n })
    }
  );
};
xi.displayName = gr;
var bi = "DropdownMenuTrigger", Ci = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, disabled: r = !1, ...o } = e, i = yi(bi, n), s = ue(n);
    return /* @__PURE__ */ h.jsx(Mu, { asChild: !0, ...s, children: /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
        id: i.triggerId,
...
Ci.displayName = bi;
var Gu = "DropdownMenuPortal", Ei = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, r = ue(t);
  return /* @__PURE__ */ h.jsx(Ou, { ...r, ...n });
};
Ei.displayName = Gu;
var Si = "DropdownMenuContent", Ri = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = yi(Si, n), i = ue(n), s = c.useRef(!1);
    return /* @__PURE__ */ h.jsx(
      Iu,
      {
        id: o.contentId,
...
Ri.displayName = Si;
var Yu = "DropdownMenuGroup", zu = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
    return /* @__PURE__ */ h.jsx(Du, { ...o, ...r, ref: t });
  }
);
zu.displayName = Yu;
var Xu = "DropdownMenuLabel", Pi = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
Pi.displayName = Xu;
var qu = "DropdownMenuItem", Ti = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
Ti.displayName = qu;
var Zu = "DropdownMenuCheckboxItem", _i = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(ku, { ...o, ...r, ref: t });
});
_i.displayName = Zu;
var Ju = "DropdownMenuRadioGroup", Qu = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Lu, { ...o, ...r, ref: t });
});
Qu.displayName = Ju;
var ef = "DropdownMenuRadioItem", Ai = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Fu, { ...o, ...r, ref: t });
});
Ai.displayName = ef;
var tf = "DropdownMenuItemIndicator", Mi = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx($u, { ...o, ...r, ref: t });
});
Mi.displayName = tf;
var nf = "DropdownMenuSeparator", Oi = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Wu, { ...o, ...r, ref: t });
});
Oi.displayName = nf;
var rf = "DropdownMenuArrow", of = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
of.displayName = rf;
var sf = "DropdownMenuSubTrigger", Ii = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Vu, { ...o, ...r, ref: t });
});
Ii.displayName = sf;
var af = "DropdownMenuSubContent", Di = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(
    Hu,
    {
...
Di.displayName = af;
var vd = xi, md = Ci, hd = Ei, gd = Ri, wd = Pi, yd = Ti, xd = _i, bd = Ai, Cd = Mi, Ed = Oi, Sd = Ii, Rd = Di, wr = "Dialog", [Ni, Pd] = Je(wr), [cf, Te] = Ni(wr), ji = (e) => {
  const {
    __scopeDialog: t,
    children: n,
    open: r,
    ...
    onOpenChange: i,
    modal: s = !0
  } = e, a = c.useRef(null), l = c.useRef(null), [u = !1, f] = Le({
    prop: r,
    defaultProp: o,
    onChange: i
  });
...
ji.displayName = wr;
var ki = "DialogTrigger", lf = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(ki, n), i = q(t, o.triggerRef);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
lf.displayName = ki;
var yr = "DialogPortal", [uf, Li] = Ni(yr, {
  forceMount: void 0
}), Fi = (e) => {
  const { __scopeDialog: t, forceMount: n, children: r, container: o } = e, i = Te(yr, t);
  return /* @__PURE__ */ h.jsx(uf, { scope: t, forceMount: n, children: c.Children.map(r, (s) => /* @__PURE__ */ h.jsx(be, { present: n || i.open, children: /* @__PURE__ */ h.jsx(Tt, { asChild: !0, container: o, children: s }) })) });
};
Fi.displayName = yr;
var Xt = "DialogOverlay", $i = c.forwardRef(
  (e, t) => {
    const n = Li(Xt, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(Xt, e.__scopeDialog);
    return i.modal ? /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: /* @__PURE__ */ h.jsx(ff, { ...o, ref: t }) }) : null;
  }
);
$i.displayName = Xt;
var ff = c.forwardRef(
  (e, t) => {
    ...
    return (
      ...
      /* @__PURE__ */ h.jsx(_t, { as: Fe, allowPinchZoom: !0, shards: [o.contentRef], children: /* @__PURE__ */ h.jsx(
        F.div,
        {
          "data-state": br(o.open),
          ...r,
...
), qe = "DialogContent", Wi = c.forwardRef(
  (e, t) => {
    const n = Li(qe, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(qe, e.__scopeDialog);
    return /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: i.modal ? /* @__PURE__ */ h.jsx(df, { ...o, ref: t }) : /* @__PURE__ */ h.jsx(pf, { ...o, ref: t }) });
  }
);
Wi.displayName = qe;
var df = c.forwardRef(
  ...
  (e, t) => {
    ...
    return en(), /* @__PURE__ */ h.jsxs(h.Fragment, { children: [
      ...
      /* @__PURE__ */ h.jsxs(h.Fragment, { children: [
        /* @__PURE__ */ h.jsx(vf, { titleId: a.titleId }),
        /* @__PURE__ */ h.jsx(hf, { contentRef: l, descriptionId: a.descriptionId })
      ] })
    ] });
  }
), xr = "DialogTitle", Vi = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(xr, n);
    return /* @__PURE__ */ h.jsx(F.h2, { id: o.titleId, ...r, ref: t });
  }
);
Vi.displayName = xr;
var Hi = "DialogDescription", Ui = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(Hi, n);
    return /* @__PURE__ */ h.jsx(F.p, { id: o.descriptionId, ...r, ref: t });
  }
);
Ui.displayName = Hi;
var Ki = "DialogClose", Gi = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(Ki, n);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
var Yi = "DialogTitleWarning", [Td, zi] = Ra(Yi, {
  contentName: qe,
  titleName: xr,
  docsSlug: "dialog"
}), vf = ({ titleId: e }) => {
  const t = zi(Yi), n = `\`${t.contentName}\` requires a \`${t.titleName}\` for the component to be accessible for screen reader users.
...
}, mf = "DialogDescriptionWarning", hf = ({ contentRef: e, descriptionId: t }) => {
  const r = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${zi(mf).contentName}}.`;
  return c.useEffect(() => {
    var i;
    const o = (i = e.current) == null ? void 0 : i.getAttribute("aria-describedby");
    t && o && (document.getElementById(t) || console.warn(r));
  }, [r, e, t]), null;
}, _d = ji, Ad = Fi, Md = $i, Od = Wi, Id = Vi, Dd = Ui, Nd = Gi, gf = "Label", Xi = c.forwardRef((e, t) => /* @__PURE__ */ h.jsx(
  F.label,
  {
    ...e,
    ref: t,
...
var Cr = "Tabs", [yf, kd] = Je(Cr, [
  ln
]), qi = ln(), [xf, Er] = yf(Cr), Zi = c.forwardRef(
  (e, t) => {
    const {
      __scopeTabs: n,
      value: r,
...
Zi.displayName = Cr;
var Ji = "TabsList", Qi = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, loop: r = !0, ...o } = e, i = Er(Ji, n), s = qi(n);
    return /* @__PURE__ */ h.jsx(
      Wo,
      {
        asChild: !0,
...
Qi.displayName = Ji;
var es = "TabsTrigger", ts = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, value: r, disabled: o = !1, ...i } = e, s = Er(es, n), a = qi(n), l = os(s.baseId, r), u = is(s.baseId, r), f = r === s.value;
    return /* @__PURE__ */ h.jsx(
      Bo,
      {
        asChild: !0,
...
ts.displayName = es;
var ns = "TabsContent", rs = c.forwardRef(
  (e, t) => {
    const { __scopeTabs: n, value: r, forceMount: o, children: i, ...s } = e, a = Er(ns, n), l = os(a.baseId, r), u = is(a.baseId, r), f = r === a.value, d = c.useRef(f);
    return c.useEffect(() => {
...
var Ld = Zi, Fd = Qi, $d = ts, Wd = rs, bf = "VisuallyHidden", Sr = c.forwardRef(
  (e, t) => /* @__PURE__ */ h.jsx(
    F.span,
    {
      ...e,
...
Sr.displayName = bf;
var Cf = Sr, [vn, Bd] = Je("Tooltip", [
  He
]), mn = He(), ss = "TooltipProvider", Ef = 700, Yn = "tooltip.open", [Sf, Rr] = vn(ss), as = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Ef,
...
as.displayName = ss;
var hn = "Tooltip", [Rf, gn] = vn(hn), cs = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
    ...
    delayDuration: a
  } = e, l = Rr(hn, e.__scopeTooltip), u = mn(t), [f, d] = c.useState(null), m = we(), g = c.useRef(0), w = s ?? l.disableHoverableContent, v = a ?? l.delayDuration, x = c.useRef(!1), [b = !1, y] = Le({
    prop: r,
    defaultProp: o,
    onChange: (P) => {
      P ? (l.onOpen(), document.dispatchEvent(new CustomEvent(Yn))) : l.onClose(), i == null || i(P);
    }
  }), C = c.useMemo(() => b ? x.current ? "delayed-open" : "instant-open" : "closed", [b]), S = c.useCallback(() => {
  ...
  return c.useEffect(() => () => window.clearTimeout(g.current), []), /* @__PURE__ */ h.jsx(on, { ...u, children: /* @__PURE__ */ h.jsx(
    Rf,
    {
      ...
      onTriggerLeave: c.useCallback(() => {
        w ? R() : window.clearTimeout(g.current);
      }, [R, w]),
      onOpen: S,
      onClose: R,
...
cs.displayName = hn;
var zn = "TooltipTrigger", ls = c.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...r } = e, o = gn(zn, n), i = Rr(zn, n), s = mn(n), a = c.useRef(null), l = q(t, a, o.onTriggerChange), u = c.useRef(!1), f = c.useRef(!1), d = c.useCallback(() => u.current = !1, []);
...
ls.displayName = zn;
var Pf = "TooltipPortal", [Vd, Tf] = vn(Pf, {
  forceMount: void 0
}), lt = "TooltipContent", us = c.forwardRef(
  (e, t) => {
    const n = Tf(lt, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...i } = e, s = gn(lt, e.__scopeTooltip);
    return /* @__PURE__ */ h.jsx(be, { present: r || s.open, children: s.disableHoverableContent ? /* @__PURE__ */ h.jsx(fs, { side: o, ...i, ref: t }) : /* @__PURE__ */ h.jsx(_f, { side: o, ...i, ref: t }) });
  }
), _f = c.forwardRef((e, t) => {
  const n = gn(lt, e.__scopeTooltip), r = Rr(lt, e.__scopeTooltip), o = c.useRef(null), i = q(t, o), [s, a] = c.useState(null), { trigger: l, onClose: u } = n, f = o.current, { onPointerInTransitChange: d } = r, m = c.useCallback(() => {
    a(null), d(!1);
  }, [d]), g = c.useCallback(
    (w, v) => {
      const x = w.currentTarget, b = { x: w.clientX, y: w.clientY }, y = If(b, x.getBoundingClientRect()), C = Df(b, y), S = Nf(v.getBoundingClientRect()), R = kf([...C, ...S]);
      a(R), d(!0);
    },
    [d]
  );
  return c.useEffect(() => () => m(), [m]), c.useEffect(() => {
    ...
    if (s) {
      const w = (v) => {
        const x = v.target, b = { x: v.clientX, y: v.clientY }, y = (l == null ? void 0 : l.contains(x)) || (f == null ? void 0 : f.contains(x)), C = !jf(b, s);
        y ? m() : C && (m(), u());
      };
      return document.addEventListener("pointermove", w), () => document.removeEventListener("pointermove", w);
    }
  }, [l, f, s, u, m]), /* @__PURE__ */ h.jsx(fs, { ...e, ref: i });
}), [Af, Mf] = vn(hn, { isInside: !1 }), fs = c.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
      ...
      ft,
      {
        ...
        children: /* @__PURE__ */ h.jsxs(
          sn,
          {
            ...
            children: [
              /* @__PURE__ */ h.jsx(fo, { children: r }),
              /* @__PURE__ */ h.jsx(Af, { scope: n, isInside: !0, children: /* @__PURE__ */ h.jsx(Cf, { id: l.contentId, role: "tooltip", children: o || r }) })
            ]
          }
        )
      }
...
us.displayName = lt;
var ds = "TooltipArrow", Of = c.forwardRef(
  (e, t) => {
...
function kf(e) {
  const t = e.slice();
  return t.sort((n, r) => n.x < r.x ? -1 : n.x > r.x ? 1 : n.y < r.y ? -1 : n.y > r.y ? 1 : 0), Lf(t);
}
function Lf(e) {
...
var Hd = as, Ud = cs, Kd = ls, Gd = us;
function lo(e, [t, n]) {
  return Math.min(n, Math.max(t, e));
}
var Ff = [" ", "Enter", "ArrowUp", "ArrowDown"], $f = [" ", "Enter"], Ot = "Select", [wn, yn, Wf] = tr(Ot), [vt, Yd] = Je(Ot, [
  Wf,
  He
]), xn = He(), [Bf, Ue] = vt(Ot), [Vf, Hf] = vt(Ot), ps = (e) => {
  const {
    __scopeSelect: t,
    children: n,
    open: r,
    ...
    required: g,
    form: w
  } = e, v = xn(t), [x, b] = c.useState(null), [y, C] = c.useState(null), [S, R] = c.useState(!1), O = Qt(u), [P = !1, M] = Le({
    prop: r,
    defaultProp: o,
    onChange: i
  }), [$, W] = Le({
...
ps.displayName = Ot;
var vs = "SelectTrigger", ms = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, disabled: r = !1, ...o } = e, i = xn(n), s = Ue(vs, n), a = s.disabled || r, l = q(t, s.onTriggerChange), u = yn(n), f = c.useRef("touch"), [d, m, g] = Ws((v) => {
      const x = u().filter((C) => !C.disabled), b = x.find((C) => C.value === s.value), y = Bs(x, v, b);
    ...
    return /* @__PURE__ */ h.jsx(Pt, { asChild: !0, ...i, children: /* @__PURE__ */ h.jsx(
      F.button,
      {
        ...
        onKeyDown: _(o.onKeyDown, (v) => {
          const x = d.current !== "";
          !(v.ctrlKey || v.altKey || v.metaKey) && v.key.length === 1 && m(v.key), !(x && v.key === " ") && Ff.includes(v.key) && (w(), v.preventDefault());
        })
      }
    ) });
  }
...
ms.displayName = vs;
var hs = "SelectValue", gs = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, className: r, style: o, children: i, placeholder: s = "", ...a } = e, l = Ue(hs, n), { onValueNodeHasChildrenChange: u } = l, f = i !== void 0, d = q(t, l.onValueNodeChange);
    return le(() => {
      u(f);
    }, [u, f]), /* @__PURE__ */ h.jsx(
      F.span,
      {
        ...
        children: Fs(l.value) ? /* @__PURE__ */ h.jsx(h.Fragment, { children: s }) : i
      }
    );
  }
);
gs.displayName = hs;
var Uf = "SelectIcon", ws = c.forwardRef(
  (e, t) => {
...
ws.displayName = Uf;
var Kf = "SelectPortal", ys = (e) => /* @__PURE__ */ h.jsx(Tt, { asChild: !0, ...e });
ys.displayName = Kf;
  ...
  (e, t) => {
    ...
    if (le(() => {
      ...
      return i ? Zt.createPortal(
        /* @__PURE__ */ h.jsx(bs, { scope: e.__scopeSelect, children: /* @__PURE__ */ h.jsx(wn.Slot, { scope: e.__scopeSelect, children: /* @__PURE__ */ h.jsx("div", { children: e.children }) }) }),
        i
      ) : null;
    }
    return /* @__PURE__ */ h.jsx(Cs, { ...e, ref: t });
  }
);
xs.displayName = Ze;
var Se = 10, [bs, Ke] = vt(Ze), Gf = "SelectContentImpl", Cs = c.forwardRef(
  (e, t) => {
    const {
      __scopeSelect: n,
      ...
      //
      ...b
    } = e, y = Ue(Ze, n), [C, S] = c.useState(null), [R, O] = c.useState(null), P = q(t, (I) => S(I)), [M, $] = c.useState(null), [W, G] = c.useState(
      null
    ...
    const N = c.useCallback(
      (I) => {
        ...
        for (const X of I)
          if (X === Q || (X == null || X.scrollIntoView({ block: "nearest" }), X === Y && R && (R.scrollTop = 0), X === U && R && (R.scrollTop = R.scrollHeight), X == null || X.focus(), document.activeElement !== Q)) return;
      },
      [V, R]
    ), H = c.useCallback(
      () => N([M, C]),
    ...
    const [Z, ne] = Ws((I) => {
      const Y = V().filter((Q) => !Q.disabled), J = Y.find((Q) => Q.ref.current === document.activeElement), U = Bs(Y, I, J);
    ...
    return /* @__PURE__ */ h.jsx(
      bs,
      {
        ...
        isPositioned: k,
        searchRef: Z,
        children: /* @__PURE__ */ h.jsx(_t, { as: Fe, allowPinchZoom: !0, children: /* @__PURE__ */ h.jsx(
          St,
          {
            asChild: !0,
            trapped: y.open,
...
Cs.displayName = Gf;
var Yf = "SelectItemAlignedPosition", Es = c.forwardRef((e, t) => {
  const { __scopeSelect: n, onPlaced: r, ...o } = e, i = Ue(Ze, n), s = Ke(Ze, n), [a, l] = c.useState(null), [u, f] = c.useState(null), d = q(t, (P) => f(P)), m = yn(n), g = c.useRef(!1), w = c.useRef(!0), { viewport: v, selectedItem: x, selectedItemText: b, focusSelectedItem: y } = s, C = c.useCallback(() => {
    if (i.trigger && i.valueNode && a && u && v && x && b) {
      ...
      if (i.dir !== "rtl") {
        const Q = W.left - M.left, X = $.left - Q, ae = P.left - X, he = P.width + ae, _e = Math.max(he, M.width), Ee = window.innerWidth - Se, je = lo(X, [
          Se,
      ...
      a.style.margin = `${Se}px 0`, a.style.minHeight = Z + "px", a.style.maxHeight = V + "px", r == null || r(), requestAnimationFrame(() => g.current = !0);
    }
  }, [
    m,
    i.trigger,
...
Es.displayName = Yf;
var zf = "SelectPopperPosition", Xn = c.forwardRef((e, t) => {
  const {
    __scopeSelect: n,
    align: r = "start",
...
Xn.displayName = zf;
var [Xf, Pr] = vt(Ze, {}), qn = "SelectViewport", Ss = c.forwardRef(
  (e, t) => {
        ...
        F.div,
        {
          ...
          onScroll: _(o.onScroll, (u) => {
            ...
            if (m != null && m.current && d) {
              ...
              if (g > 0) {
                const w = window.innerHeight - Se * 2, v = parseFloat(d.style.minHeight), x = parseFloat(d.style.height), b = Math.max(v, x);
                if (b < w) {
                  const y = b + g, C = Math.min(w, y), S = y - C;
                  d.style.height = C + "px", d.style.bottom === "0px" && (f.scrollTop = S > 0 ? S : 0, d.style.justifyContent = "flex-end");
                }
              }
            }
...
Ss.displayName = qn;
var Rs = "SelectGroup", [qf, Zf] = vt(Rs), Ps = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, ...r } = e, o = we();
    return /* @__PURE__ */ h.jsx(qf, { scope: n, id: o, children: /* @__PURE__ */ h.jsx(F.div, { role: "group", "aria-labelledby": o, ...r, ref: t }) });
  }
);
Ps.displayName = Rs;
var Ts = "SelectLabel", _s = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, ...r } = e, o = Zf(Ts, n);
    return /* @__PURE__ */ h.jsx(F.div, { id: o.id, ...r, ref: t });
  }
);
_s.displayName = Ts;
var qt = "SelectItem", [Jf, As] = vt(qt), Ms = c.forwardRef(
  (e, t) => {
    const {
      __scopeSelect: n,
      value: r,
            ...
            children: /* @__PURE__ */ h.jsx(
              F.div,
              {
                ...
                onKeyDown: _(s.onKeyDown, (y) => {
                  var S;
                  ((S = l.searchRef) == null ? void 0 : S.current) !== "" && y.key === " " || ($f.includes(y.key) && b(), y.key === " " && y.preventDefault());
                })
              }
            )
          }
...
Ms.displayName = qt;
var yt = "SelectItemText", Os = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, className: r, style: o, ...i } = e, s = Ue(yt, n), a = Ke(yt, n), l = As(yt, n), u = Hf(yt, n), [f, d] = c.useState(null), m = q(
      t,
      (b) => d(b),
      l.onItemTextChange,
      (b) => {
...
Os.displayName = yt;
var Is = "SelectItemIndicator", Ds = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, ...r } = e;
    return As(Is, n).isSelected ? /* @__PURE__ */ h.jsx(F.span, { "aria-hidden": !0, ...r, ref: t }) : null;
  }
);
Ds.displayName = Is;
var Zn = "SelectScrollUpButton", Ns = c.forwardRef((e, t) => {
...
Ns.displayName = Zn;
var Jn = "SelectScrollDownButton", js = c.forwardRef((e, t) => {
...
}), Qf = "SelectSeparator", Ls = c.forwardRef(
  (e, t) => {
    const { __scopeSelect: n, ...r } = e;
...
Ls.displayName = Qf;
var Qn = "SelectArrow", ed = c.forwardRef(
  (e, t) => {
...
var $s = c.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = c.useRef(null), i = q(t, o), s = wf(n);
    return c.useEffect(() => {
    ...
    }, [s, n]), /* @__PURE__ */ h.jsx(Sr, { asChild: !0, children: /* @__PURE__ */ h.jsx("select", { ...r, ref: i, defaultValue: n }) });
  }
);
$s.displayName = "BubbleSelect";
function Ws(e) {
...
var zd = ps, Xd = ms, qd = gs, Zd = ws, Jd = ys, Qd = xs, ep = Ss, tp = Ps, np = _s, rp = Ms, op = Os, ip = Ds, sp = Ns, ap = js, cp = Ls, Tr = "Popover", [Vs, lp] = Je(Tr, [
  He
]), It = He(), [nd, Ge] = Vs(Tr), Hs = (e) => {
  const {
    __scopePopover: t,
    children: n,
    open: r,
    ...
    onOpenChange: i,
    modal: s = !1
  } = e, a = It(t), l = c.useRef(null), [u, f] = c.useState(!1), [d = !1, m] = Le({
    prop: r,
    defaultProp: o,
    onChange: i
  });
...
Hs.displayName = Tr;
var Us = "PopoverAnchor", rd = c.forwardRef(
  (e, t) => {
    const { __scopePopover: n, ...r } = e, o = Ge(Us, n), i = It(n), { onCustomAnchorAdd: s, onCustomAnchorRemove: a } = o;
    return c.useEffect(() => (s(), () => a()), [s, a]), /* @__PURE__ */ h.jsx(Pt, { ...i, ...r, ref: t });
  }
);
rd.displayName = Us;
var Ks = "PopoverTrigger", Gs = c.forwardRef(
  (e, t) => {
    const { __scopePopover: n, ...r } = e, o = Ge(Ks, n), i = It(n), s = q(t, o.triggerRef), a = /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
        "aria-haspopup": "dialog",
...
Gs.displayName = Ks;
var _r = "PopoverPortal", [od, id] = Vs(_r, {
  forceMount: void 0
}), Ys = (e) => {
  const { __scopePopover: t, forceMount: n, children: r, container: o } = e, i = Ge(_r, t);
  return /* @__PURE__ */ h.jsx(od, { scope: t, forceMount: n, children: /* @__PURE__ */ h.jsx(be, { present: n || i.open, children: /* @__PURE__ */ h.jsx(Tt, { asChild: !0, container: o, children: r }) }) });
};
Ys.displayName = _r;
var ut = "PopoverContent", zs = c.forwardRef(
  (e, t) => {
    const n = id(ut, e.__scopePopover), { forceMount: r = n.forceMount, ...o } = e, i = Ge(ut, e.__scopePopover);
    return /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: i.modal ? /* @__PURE__ */ h.jsx(sd, { ...o, ref: t }) : /* @__PURE__ */ h.jsx(ad, { ...o, ref: t }) });
  }
);
zs.displayName = ut;
var sd = c.forwardRef(
  (e, t) => {
    ...
    return c.useEffect(() => {
      const s = r.current;
      if (s) return un(s);
    }, []), /* @__PURE__ */ h.jsx(_t, { as: Fe, allowPinchZoom: !0, children: /* @__PURE__ */ h.jsx(
      Xs,
      {
        ...e,
        ref: o,
...
), qs = "PopoverClose", cd = c.forwardRef(
  (e, t) => {
    const { __scopePopover: n, ...r } = e, o = Ge(qs, n);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
cd.displayName = qs;
var ld = "PopoverArrow", ud = c.forwardRef(
  (e, t) => {
