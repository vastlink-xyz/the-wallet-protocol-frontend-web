...
import { D as f, a as b, b as g, c as W, d as N, e as M } from "./dialog-Z1SodXwS.js";
import { c as T, I as E, B as m, g as x, L as y } from "./main-DA6B0E96.js";
import { u as O } from "./MarketplaceProvider-DjqDka5d.js";
import { r as h } from "./vendor-react-U4DfHahV.js";
import { u as w } from "./vendor-utils-BclDYac0.js";
function R({
  onPair: l,
  isModalOpen: o,
  dappInfo: i,
  ...
  const { t: a } = w(), [d, u] = h.useState(""), [p, s] = h.useState(""), r = h.useRef(null);
  h.useEffect(() => () => {
  ...
  const j = () => {
    ...
    try {
      ...
      x("read", t), setTimeout(async () => {
        await navigator.clipboard.writeText(""), x("Clipboard cleared"), j(), window.open(i.url, "_blank");
      }, 500);
    } catch (t) {
...
function V({ className: l, buttonClassName: o }) {
  const { t: i } = w(), { isAuthenticated: n, isConnected: c, handleConnect: a } = O();
  return /* @__PURE__ */ e.jsx(
    "div",
    {
      className: T([
      ...
      children: /* @__PURE__ */ e.jsx("div", { className: T(
        ...
        o
      ), children: i(c ? "vastWalletConnect.disconnectSession" : "vastWalletConnect.connectDApps") })
    }
  );
}
function U() {
      ...
      f,
      {
        ...
        children: /* @__PURE__ */ e.jsxs(b, { className: "sm:max-w-[425px] text-primary", children: [
          ...
          /* @__PURE__ */ e.jsxs(M, { children: [
            ...
            /* @__PURE__ */ e.jsx(m, { onClick: a, children: d ? /* @__PURE__ */ e.jsx(y, {}) : l("vastWalletConnect.approve") })
          ] })
        ] })
      }
    ),
      ...
      f,
      {
        ...
        children: /* @__PURE__ */ e.jsxs(b, { className: "sm:max-w-[425px] text-primary", children: [
          ...
          /* @__PURE__ */ e.jsxs(M, { children: [
            ...
            /* @__PURE__ */ e.jsx(m, { onClick: j, disabled: d, children: d ? /* @__PURE__ */ e.jsx(y, {}) : "Confirm" })
          ] })
        ] })
      }
    ),
