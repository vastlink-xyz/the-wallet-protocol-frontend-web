...
import { a as s, c as t } from "./main-BjushY0K.js";
import { j as n } from "./vendor-react-U4DfHahV.js";
function o() {
  const a = n(), l = s.isAuthenticated(), p = () => {
    a(l ? "/dashboard" : "/auth");
  };
  return /* @__PURE__ */ e.jsxs("div", { className: t(
    ...
    /* @__PURE__ */ e.jsx("div", { className: "bg-[linear-gradient(85deg,#082103_-7.26%,#020501_94.58%)] h-1/2 w-full absolute top-1/2 left-0" }),
    /* @__PURE__ */ e.jsx("div", { className: t(
      ...
      /* @__PURE__ */ e.jsxs("div", { className: t(
        ...
        ), children: "Built for the community, driven by the community, powered by tokenomics." }),
        /* @__PURE__ */ e.jsx("div", { className: t(
