...
import { a as bA, c as Ne, D as kl, b as Tl, d as Il, e as ja, l as Wl, B as Ms, f as os, h as Qs, S as Os, g as Cl, T as js, i as Fs } from "./main-D5dOqEzI.js";
import { i as Ql, j as as, L as Zl, r as B, a as Ls, p as Ol, O as Hs } from "./vendor-react-CwfAKKXk.js";
import { h as Ns, X as Us } from "./vendor-ui-utils-ERHZUJ9g.js";
import { u as is, B as zs } from "./vendor-utils-DOORVzle.js";
import { W as Gl, V as Ws } from "./index-DyaWTg1P.js";
import { S as Zs } from "./SendButton-js2q8opU.js";
import { W as Gs, M as _s } from "./MarketplaceProvider-BDuVZf9D.js";
function Ys({ routes: f, currentRouteName: c }) {
  const { pathname: g } = Ql(), m = as(), A = bA.isAuthenticated();
  return /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
    /* @__PURE__ */ b.jsx("div", { className: Ne(
      "hidden tablet:flex",
      "justify-start items-center gap-6"
    ), children: f.map((y) => {
      const P = g.startsWith(y.href);
    ...
    /* @__PURE__ */ b.jsx("div", { className: Ne("flex tablet:hidden"), children: /* @__PURE__ */ b.jsxs(kl, { children: [
      ...
      /* @__PURE__ */ b.jsx(Il, { className: "bg-white", children: f.map((y) => {
        const P = g.startsWith(y.href);
        return /* @__PURE__ */ b.jsx(
          ja,
          {
            ...
            children: P ? /* @__PURE__ */ b.jsxs(Zl, { to: y.href, className: "flex items-center gap-2", children: [
              /* @__PURE__ */ b.jsx("div", { className: "text-brand-foreground", children: y.name }),
              /* @__PURE__ */ b.jsx("img", { src: "/imgs/icons/checked.svg", alt: "" })
            ] }) : /* @__PURE__ */ b.jsx("div", { className: "", children: y.name })
          },
          y.name
        );
      }) })
...
function _l({
  ...
  const { i18n: c } = is(), [g, m] = B.useState(!1);
  B.useEffect(() => {
    const P = Wl.getData();
    P && c.changeLanguage(P);
  }, [c]);
  const A = (P) => {
    c.changeLanguage(P), Wl.setData(P), m(!1), f == null || f();
  }, y = /* @__PURE__ */ b.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center font-['Roboto']", children: [
...
function Xs() {
  const [f, c] = B.useState(!1), g = bA.isAuthenticated(), m = async () => {
    try {
      await os.post("/auth/logout"), bA.clearAllAuthData(), window.location.href = "/auth";
    } catch (A) {
      const y = Qs(A);
      zs.error(y.message);
    }
  ...
  return /* @__PURE__ */ b.jsxs("div", { className: "justify-start items-center gap-[21px] flex", children: [
    /* @__PURE__ */ b.jsx("div", { className: "hidden tablet:flex", children: /* @__PURE__ */ b.jsx(Gl, {}) }),
    /* @__PURE__ */ b.jsxs("div", { className: "justify-start items-center gap-7 flex", children: [
            ...
            /* @__PURE__ */ b.jsxs(Il, { className: "bg-white border-none", children: [
              /* @__PURE__ */ b.jsx(
                ja,
                {
                  ...
                  children: /* @__PURE__ */ b.jsx(Gl, { className: "p-0 bg-transparent" })
                }
              ),
              /* @__PURE__ */ b.jsx(
                ja,
              ...
              /* @__PURE__ */ b.jsx(
                ...
                {
                  onSelect: (A) => A.preventDefault(),
                  children: /* @__PURE__ */ b.jsx(_l, { onLanguageChange: () => c(!1) })
                }
              ),
              /* @__PURE__ */ b.jsx(
                ja,
                {
                  ...
                  children: /* @__PURE__ */ b.jsx("div", { onClick: () => m(), children: "Logout" })
                }
              )
            ] })
          ]
      ...
      /* @__PURE__ */ b.jsx("div", { className: Ne(
        ...
        /* @__PURE__ */ b.jsx(Il, { className: Ne(
          "bg-white",
          !g && "hidden"
        ), children: /* @__PURE__ */ b.jsx(ja, { onSelect: () => m(), children: "Logout" }) })
      ] }) }),
      /* @__PURE__ */ b.jsx("div", { className: Ne(
        "hidden laptop:block",
...
function Vs() {
  const { pathname: f } = Ql(), { t: c } = is(), g = as(), m = [
    {
...
function Js() {
  ...
  var g = Object.prototype.hasOwnProperty, m = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, A = {}, y = {};
  function P(a) {
    return g.call(y, a) ? !0 : g.call(A, a) ? !1 : m.test(a) ? y[a] = !0 : (A[a] = !0, !1);
  }
...
` && i.push(Rt), M;
  ...
  function ct(i, s, h, S) {
    switch (h.insertionMode) {
      case 0:
      case 1:
        return A(i, Mt), A(i, s.segmentPrefix), A(i, w(S.toString(16))), y(i, qt);
      case 2:
        return A(i, en), A(i, s.segmentPrefix), A(i, w(S.toString(16))), y(i, Dn);
      case 3:
        return A(i, Qt), A(i, s.segmentPrefix), A(i, w(S.toString(16))), y(i, Pn);
      case 4:
        return A(i, Je), A(i, s.segmentPrefix), A(i, w(S.toString(16))), y(i, Kn);
      case 5:
        return A(i, br), A(i, s.segmentPrefix), A(i, w(S.toString(16))), y(i, Ge);
      case 6:
        return A(i, Kr), A(i, s.segmentPrefix), A(i, w(S.toString(16))), y(i, $r);
      case 7:
        return A(
          i,
          er
        ), A(i, s.segmentPrefix), A(i, w(S.toString(16))), y(i, Bn);
      default:
        throw Error(c(397));
    }
  }
  ...
  function Qr(i, s, h) {
    switch (h.parentFlushed = !0, h.status) {
      case 0:
        ...
        return h.lastPushedText = !1, h.textEmbedded = !1, i = i.responseState, A(s, Ze), A(s, i.placeholderPrefix), i = w(S.toString(16)), A(s, i), y(s, Yn);
      case 1:
        h.status = 2;
        var O = !0;
        S = h.chunks;
  ...
  function Or(i, s, h) {
    ...
    if (S.parentFlushed = !0, S.forceClientRender) S = S.errorDigest, y(s, Cn), A(s, Vn), S && (A(s, Jn), A(s, w(Z(S))), A(s, $t)), y(s, wr), Qr(i, s, h);
      ...
      if (y(s, mr), h = S.completedSegments, h.length !== 1) throw Error(c(391));
      Or(i, s, h[0]);
    }
    return y(s, Jr);
  }
  ...
  function Xo(i, s, h) {
    ...
    return h = w(h.toString(16)), A(s, S), A(s, Sr), A(s, i.segmentPrefix), A(s, h), y(s, xr);
  }
  function Vo(i, s, h, S) {
    ...
    return Yo(i, s, S), i = i.responseState, A(s, i.startInlineScript), i.sentCompleteSegmentFunction ? A(s, nn) : (i.sentCompleteSegmentFunction = !0, A(s, kn)), A(s, i.segmentPrefix), O = w(O.toString(16)), A(s, O), A(s, rn), A(s, i.placeholderPrefix), A(s, O), y(s, Ft);
  }
  function oo(i, s) {
    ...
    try {
      ...
      for (M = 0; M < O.length; M++) {
        ...
        A(S, pe), A(S, Lt), (we || ye || je) && (A(S, an), A(S, w(xt(we || "")))), (ye || je) && (A(S, an), A(S, w(xt(ye || "")))), je && (A(S, an), A(S, w(xt(je)))), y(S, Ht);
      }
      O.splice(0, M);
...
var Mo = {}, Vl;
function $s() {
  return Vl || (Vl = 1, Ol.env.NODE_ENV !== "production" && function() {
...
var gA = {}, Jl;
function qs() {
  return Jl || (Jl = 1, Ol.env.NODE_ENV !== "production" && function() {
    var f = B, c = "18.3.1", g = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function m(r) {
      {
...
var Oo, Rl;
Ol.env.NODE_ENV === "production" ? (Oo = Js(), Rl = Ks()) : (Oo = $s(), Rl = qs());
...
const ou = "data:image/svg+xml;base64,", au = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 0 637 637", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m478 113-13 2-4 1h4l14-2c10-2 35-2 42-1l6 3 3 1c3 0-4-3-8-5-7-1-34-1-44 1m56 6 8 6c7 5 20 17 20 19s7 12 8 12l-3-6-4-6c0-3-15-17-25-24-5-3-8-4-4-1m-198 16-9 1a512 512 0 0 1 9-1m-180 30a412 412 0 0 0-23 4 167 167 0 0 0-32 8 439 439 0 0 1 46-9 304 304 0 0 1 11-2l6-1h-8m369 8 4 3-7-6c-1 0 0 2 3 3m-439 9c-7 3-18 13-18 15l6-5c5-5 9-8 14-10l6-4-8 4m442 12-10 11-7 6 7-6c7-5 14-14 13-16l-3 5M65 205l-1 11c0 9 0 10 4 17 5 10 7 12 22 11 10 0 15 0 38-5l5-1-6 1-16 2-21 2c-13 1-16-1-21-10-3-5-4-6-4-15l1-12c1-4 1-5-1-1m335 1c3 0 3 1 3 3l-2 6c-2 5-35 39-76 80-53 51-120 117-138 137-21 24-22 25-22 27 0 3 6 9 9 9 4 0 14-8 38-27a5073 5073 0 0 1 15-16 1421 1421 0 0 0-17 15l-31 25-6 2-4-3c-3-3-3-4-2-6 3-8 79-85 160-163 57-57 79-80 79-86 0-2-3-4-7-4-2 0-2 0 1 1m165 18c-9 17-25 32-57 53l-10 8 16-11 12-8c15-10 27-22 39-39 5-7 6-8 4-8l-4 5m-221 2a199 199 0 0 0-19 10 183 183 0 0 1 27-12c0-1-1-1-8 2m-34 16c-3 3-2 3 2 0l1-2-3 2m151 3-1 2 2-2c3-3 2-3-1 0m-16 12-11 10a281 281 0 0 0 11-10m-24 18-7 5-7 5-42 31c-10 7-24 19-22 19l7-6 16-12a343 343 0 0 0 35-25 573 573 0 0 0 20-17m-187 0-2 2 4-2 3-2-5 2m-14 6-3 2 4-1 4-3-5 2m-7 3-8 4-18 8 18-7 7-3 3-1c1-2 0-2-2-1m254 24a2672 2672 0 0 1-71 54 601 601 0 0 0 39-29 1352 1352 0 0 1 32-25m-291-8-2 2 4-2 3-2-5 2m-13 5-2 2h3c5-3 4-4-1-2m-19 9-7 3-13 6c-10 5-13 7-14 10-3 4-2 5 1 0 2-3 5-5 14-9l13-6 12-6-6 2m178 36c-17 12-21 16-21 17a390 390 0 0 1 20-17m-206 34 1 4 1 3 1 5 2 8 1 5v-6l-1-8-2-5-1-4-1-2c-1-2-1-2-1 0m222 23-9 7a683 683 0 0 0-56 44 261 261 0 0 0-26 20 1345 1345 0 0 0-46 34c-6 3-7 3-19 3-11 0-12 0-18-3-8-4-10-8-17-20l-5-10 4 10c5 10 12 18 19 22 4 2 6 2 17 2 13 0 14 0 21-3l26-19 42-33a2183 2183 0 0 0 43-34 643 643 0 0 1 24-20", fill: "#fff", fillRule: "evenodd" }), /* @__PURE__ */ B.createElement("path", { d: "M478 114a620 620 0 0 1-39 6l-21 3a5481 5481 0 0 0-19 3 870 870 0 0 1-54 8l-1 1-6 1-12 2-13 2a992 992 0 0 0-76 12 400 400 0 0 1-45 8l-6 1-5 1h-3l-3 1-2 1-26 4-13 2-17 3c-23 5-33 9-43 19-7 8-9 13-9 27 0 8 1 9 4 14 5 9 8 11 21 10l21-2a1133 1133 0 0 1 23-4 659 659 0 0 0 74-14l3-1h3l3-1h3l2-1 2-1h3l2-1h2l24-5 38-7a2100 2100 0 0 1 93-18l3-1 10-1a2082 2082 0 0 1 120-17l2 1c2 0 8 5 8 7l1 2 1 6c0 4 0 6-3 10-2 4-16 16-18 16l-7 5-10 8a1070 1070 0 0 0-11 7 113 113 0 0 1-20 14l-2 2-3 2-2 2h-1a154 154 0 0 1-28 21l-5 4-5 4a573 573 0 0 1-50 37 175 175 0 0 0-24 18l-1 2-2 1-2 1-2 1-1 1-12 10a396 396 0 0 0-32 25l-8 6-6 5-9 7a326 326 0 0 1-25 20l-13 12a5073 5073 0 0 0-17 15c-24 20-34 27-39 27-2 0-8-6-8-9 0-2 1-3 22-27 18-20 85-86 138-137 41-41 74-75 76-80l2-6c0-2 0-3-2-3l-7 1a233 233 0 0 1-26 9l-1 1-1 1h-1l-1 1h-2l-3 2-1 1h-2l-3 2h-1l-5 2-22 10-9 4-4 2-5 2-10 4-2 1-2 1-2 1-13 6a334 334 0 0 1-38 17 75 75 0 0 0-14 6l-5 2-4 1-2 1-3 2-7 3-16 6a247 247 0 0 0-32 14l-1 1h-2l-1 1h-2l-1 1-12 6a103 103 0 0 0-27 15l-2 5-1 1v11l1 5 1 5 1 4c0 3 0 4 2 4v3l1 3 1 2 2 10 1 4 1 5 2 10 2 8 1 4 1 4c3 3 9 25 11 38l1 7v2l1 4v1l1 1v2l1 2 1 3v1l5 10c7 13 9 16 17 20 6 3 7 3 18 3 12 0 13 0 19-3 8-4 11-6 26-18a1345 1345 0 0 1 85-67 683 683 0 0 1 50-39l12-9a513 513 0 0 1 44-33 201 201 0 0 0 22-17 2270 2270 0 0 0 73-54 158 158 0 0 0 58-59c2 0 3-9 4-27l-1-19-1-4-1-6-1-3-4-6-4-6c0-2-6-8-13-14a77 77 0 0 0-28-18c-6-1-34-1-43 1" })), $l = B.forwardRef(au), iu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M765-321q0 117-84 196-83 80-200 80-118 0-200-80t-83-196v-392q0-85 61-144 61-58 146-58 86 0 147 58 61 59 61 144v374q0 54-39 92-39 37-93 37-55 0-93-37-38-38-38-92v-372h110v372q0 9 6 14t15 5q8 0 15-5t7-14v-374q0-39-29-66t-68-27q-40 0-69 27t-29 66v392q0 71 51 119t122 48q71 0 122-48t51-119v-426h111v426Z" })), ql = B.forwardRef(iu), Au = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M125-165v-113h77v-273q0-93 55-167 56-75 146-100v-19q0-32 22-55 23-23 55-23t55 23q22 23 22 55v19q90 25 146 99 56 73 56 168v273h77v113H125ZM480-32q-38 0-66-27-27-27-27-66h186q0 39-27 66t-66 27Z" })), lu = B.forwardRef(Au), su = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M137-190v-113h78v-253q0-41 11-79 11-39 35-71l-9 150h10L17-802l74-74L873-92l-74 74-175-172H137Zm609-149L319-769q20-15 41-25t44-16v-28q0-32 22-54t54-22q32 0 55 22t22 54v28q85 23 137 94t52 160v217ZM481-47q-38 0-65-27t-27-65h184q0 38-27 65t-65 27Z" })), uu = B.forwardRef(su), cu = (f, c) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", ref: c, ...f }, /* @__PURE__ */ B.createElement("g", { strokeLinecap: "round", strokeWidth: 10 }, /* @__PURE__ */ B.createElement("path", { d: "m19 19 61 61M80 19 19 80" }))), du = B.forwardRef(cu), fu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M94-136v-255l351-93-351-92v-253l816 346L94-136Z" })), hu = B.forwardRef(fu), pu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M480-372q-61 0-105-43-43-43-43-105v-240q0-61 43-105 43-43 105-43 61 0 105 43 43 44 43 105v240q0 62-43 105t-105 43ZM425-76v-122q-121-16-197-108t-76-214h109q0 91 64 154t155 63q91 0 155-63t64-154h109q0 122-77 214T534-198v122H425Z" })), vu = B.forwardRef(pu), gu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m763-343-80-79q8-20 13-44 5-23 5-54h109q0 49-11 95t-36 82ZM625-482 336-770v-2q3-56 45-96t101-40q62 0 105 43t43 105v249l-1 17q-1 7-4 12ZM427-76v-122q-120-16-196-108-77-92-77-214h109q0 91 64 154t155 63q43 0 80-14 37-15 67-41l78 79q-35 32-78 53t-93 28v122H427Zm362 27L41-796l75-75 748 748-75 74Z" })), mu = B.forwardRef(gu), yu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M625-511q29 0 50-21t20-50q0-29-20-50-21-20-50-20t-50 20-20 50q0 29 20 50 21 21 50 21Zm-290 0q29 0 50-21t20-49q0-30-20-50t-50-21q-29 0-50 20-20 21-20 50 0 30 20 50 21 21 50 21Zm145 268q75 0 137-43t85-115H258q24 72 85 115 62 43 137 43Zm0 198q-90 0-170-34-79-34-138-93T79-310q-34-80-34-170t34-170q34-79 93-138t138-93q80-34 170-34t170 34q79 34 138 93t93 138q34 80 34 170t-34 170q-34 79-93 138T650-79q-80 34-170 34Zm0-435Zm0 322q134 0 228-94t94-228q0-134-94-228t-228-94q-134 0-228 94t-94 228q0 134 94 228t228 94Z" })), es = B.forwardRef(yu), wu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M553-64v-108q107-27 173-113 67-87 67-197 0-109-67-195T553-789v-108q152 26 249 144 97 117 97 271 0 155-97 273T553-64ZM61-335v-290h176l236-237v764L237-335H61Zm492 28v-346q51 23 82 70t31 103-31 103q-31 47-82 70Z" })), bu = B.forwardRef(wu), Su = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M807-15 700-123q-33 21-71 37-38 15-80 22v-108q20-4 38-12l35-17-153-154v257L234-335H57v-290h144L10-818l74-75L882-90l-75 75Zm37-264-80-79q13-30 19-60 7-31 7-64 0-109-68-195-67-86-173-112v-108q152 26 249 144 98 117 98 271 0 55-14 107-13 51-38 96ZM661-462 549-575v-78q51 23 83 70 31 47 31 103l-1 9-1 9ZM469-655 366-759l103-103v207Z" })), xu = B.forwardRef(Su), Eu = "data:audio/wav;base64,", As = {
        ...
        children: [
          ...
          /* @__PURE__ */ b.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ b.jsx($l, { style: { width: "80%", height: "80%", fill: "#fff" } })
            },
            1
          ),
  ...
  var g, m, A, y, P, E;
  const [w, C] = B.useState(!1), [H, k] = B.useState(((g = c == null ? void 0 : c.chatWindow) == null ? void 0 : g.defaultOpen) ?? !1), [F, U] = B.useState(((m = c == null ? void 0 : c.audio) == null ? void 0 : m.defaultToggledOn) ?? !1), [L, _] = B.useState(((A = c == null ? void 0 : c.voice) == null ? void 0 : A.defaultToggledOn) ?? !1), [j, T] = B.useState(
    ((y = c == null ? void 0 : c.notification) == null ? void 0 : y.defaultToggledOn) ?? !0
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Xe(), { unreadCount: y, isScrolling: P, setIsScrolling: E } = gt(), { chatBodyRef: w } = bt(), [C, H] = B.useState(!1), k = {
...
}, fs = B.createContext({ paths: [], setPaths: () => null }), jl = () => B.useContext(fs), Ru = ({ children: f }) => {
  const [c, g] = B.useState([]);
  return /* @__PURE__ */ b.jsx(fs.Provider, { value: { paths: c, setPaths: g }, children: f });
}, CA = () => {
  const { settings: f } = De(), { paths: c, setPaths: g } = jl(), {
    setIsBotTyping: m,
    ...
    return m(!0), (L = f.chatInput) != null && L.blockSpam && A(!0), y(!1), g((_) => [..._, F]), !0;
  }, [c, g, f]);
  return {
    getCurrPath: C,
    getPrevPath: H,
  ...
  const { getCurrPath: f, getPrevPath: c, paths: g } = Mu(), { botIdRef: m } = bt();
  ...
  const { settings: f } = De(), { toasts: c, setToasts: g } = ps(), { callRcbEvent: m } = Wn(), A = B.useRef(c);
  B.useEffect(() => {
    A.current = c;
  }, [c]);
  const y = B.useCallback((E, w) => {
    ...
    return !C || (w = f.event) != null && w.rcbDismissToast && m(Ee.DISMISS_TOAST, { toast: C }).defaultPrevented ? null : (g((H) => H.filter((k) => k.id !== E)), E);
  }, [m, g]);
  return {
    showToast: y,
    dismissToast: P,
  ...
  var m, A;
  const { settings: y } = De(), { styles: P } = Xe(), { dismissToast: E } = DA(), [w, C] = B.useState(!1), H = {
...
}, vs = B.createContext({ messages: [], setMessages: () => null }), Fl = () => B.useContext(vs), ju = ({ children: f }) => {
  const [c, g] = B.useState([]);
  return /* @__PURE__ */ b.jsx(vs.Provider, { value: { messages: c, setMessages: g }, children: f });
}, Fu = ({
  setChatScrollHeight: f
}) => {
  var c, g, m, A, y, P, E, w, C, H, k, F;
  const { settings: U } = De(), { styles: L } = Xe(), { messages: _ } = Fl(), { toasts: j } = ps(), { isChatWindowOpen: T } = vr(), {
    isBotTyping: K,
    isScrolling: te,
    setIsScrolling: X,
    setUnreadCount: G
  ...
  const { settings: L } = De(), { styles: _ } = Xe(), { paths: j } = jl(), { handleSubmitText: T } = La(), [K, te] = B.useState(/* @__PURE__ */ new Set()), [X, G] = B.useState(!1), $ = {
  ...
  const P = /* @__PURE__ */ b.jsx(Lu, { checkboxes: y, checkedItems: /* @__PURE__ */ new Set(), path: g });
  ...
  var g, m, A, y, P, E;
  const { settings: w } = De(), { styles: C } = Xe(), { paths: H } = jl(), { handleSubmitText: k } = La(), [F, U] = B.useState([]), [L, _] = B.useState(!1), j = {
  ...
  const P = /* @__PURE__ */ b.jsx(zu, { options: y, path: g });
  await m.injectMessage(P);
}, Zu = async (f, c, g) => {
  const m = f.path;
  if (!m)
  ...
  return y.includes("path") ? await Zu(A, g, m) : !1;
}, Vu = (f) => {
  const c = [];
  let g = "", m = !1;
  for (let A = 0; A < f.length; A++) {
    const y = f[A];
    y === "<" ? m ? (c.push(g), g = y) : (m = !0, g = y) : y === ">" ? (g += y, c.push(g), g = "", m = !1) : m ? g += y : c.push(y);
  }
  return g !== "" && c.push(g), c;
}, Ju = (f) => typeof window.DOMParser < "u" ? new DOMParser().parseFromString(f, "text/html").body.textContent || "" : f.replace(/<\/?[^>]+(>|$)/g, ""), Ku = (f, c, g, m, A) => {
  const y = new SpeechSynthesisUtterance();
  y.text = f, y.lang = c, y.rate = m, y.volume = A;
  let P = !1;
  for (const E of g)
  ...
  var y, P, E, w, C, H;
  if ((y = f.audio) != null && y.disabled || m.sender === "user" || typeof m.content != "string" || !g && !((P = f.general) != null && P.embedded) || !c || m.content.trim() === "")
    return;
  let k = m.content;
  A && (k = Ju(m.content)), Ku(
    k,
  ...
  var f;
  const { settings: c } = De(), { styles: g } = Xe(), m = {
...
const yA = async (f) => {
  ...
  for (let A = f.length - 1; A >= g; A--) {
    const y = f[A];
    if (y.sender === "system" || (y.content !== "" && c.unshift(y), c.length === mA))
      break;
  }
  let m = c.map(ac);
  if (m.length < mA) {
  ...
  var c, g, m;
  Ml = (c = f.chatHistory) == null ? void 0 : c.storageKey, mA = (g = f.chatHistory) == null ? void 0 : g.maxEntries, ws = (m = f.chatHistory) == null ? void 0 : m.disabled, EA = tc(localStorage.getItem(Ml));
...
}, Ac = (f, c) => ((f.contains("rcb-options-container") || f.contains("rcb-checkbox-container")) && (Object.prototype.hasOwnProperty.call(c, "class") ? c.class = `${f.toString()} rcb-options-offset` : c.class = "rcb-options-offset"), c), lc = (f, c, g, m) => {
  var A, y, P, E, w;
  return f.contains("rcb-options") && (c.style = {
    ...c.style,
    color: ((A = m.botOptionStyle) == null ? void 0 : A.color) ?? ((y = g.general) == null ? void 0 : y.primaryColor),
  ...
  return f.contains("rcb-checkbox-row-container") && (c.style = {
    ...c.style,
    color: ((A = m.botCheckboxRowStyle) == null ? void 0 : A.color) ?? ((y = g.general) == null ? void 0 : y.primaryColor),
  ...
  return f.contains("rcb-checkbox-next-button") && (c.style = {
    ...c.style,
    color: ((A = m.botCheckboxNextStyle) == null ? void 0 : A.color) ?? ((y = g.general) == null ? void 0 : y.primaryColor),
  ...
  return (f.contains("rcb-media-display-image-container") || f.contains("rcb-media-display-video-container")) && (c.style = {
    ...
    maxWidth: (y = g.userBubble) != null && y.showAvatar ? "65%" : "70%",
  ...
  var f, c, g, m;
  const { settings: A } = De(), { messages: y, setMessages: P } = Fl(), {
    audioToggledOn: E,
    isChatWindowOpen: w,
    isScrolling: C,
    setIsBotTyping: H,
    setUnreadCount: k
  } = gt(), { streamMessageMap: F, chatBodyRef: U } = bt(), { callRcbEvent: L } = Wn(), { playNotificationSound: _ } = Ll(), j = B.useCallback(async (Z, re, ne) => {
    H(!1), P((ve) => {
      const de = [...ve, Z];
      return $(de), de;
    ...
    return (re = A.event) != null && re.rcbStopStreamMessage && L(Ee.STOP_STREAM_MESSAGE, { messageToEndStreamFor: ue }).defaultPrevented ? !1 : (F.current.delete(Z), yA(y), !0);
...
const Hl = () => {
  ...
  var E;
  (E = f.voice) != null && E.sendAsAudio ? hc(g, y) : fc(
    f,
    c,
    g,
    m,
  ...
  C.onresult = (F) => {
    ...
    Un = setTimeout(() => Pl(c, y), H), (L = f.voice) != null && L.autoSendDisabled || (wA = setTimeout(g, k));
  }, C.onend = () => {
    Vr ? (C.start(), Un || (Un = setTimeout(() => Pl(c, y), H))) : (clearTimeout(Un), Un = null, clearTimeout(wA));
  }, Un = setTimeout(() => Pl(c, y), H);
}, hc = (f, c) => {
  ...
  var g, m, A;
  const y = Hl();
  (g = c.voice) != null && g.disabled || !((m = c.chatInput) != null && m.blockSpam) || !y || (f && !Vr ? (Vr = !0, (A = c.voice) != null && A.sendAsAudio ? zn == null || zn.start() : y.start()) : f || Nl());
}, Pl = (f, c) => {
  var g;
  (g = c.current) != null && g.disabled || f(), Nl();
}, Ul = () => {
  const { settings: f } = De(), { voiceToggledOn: c, setVoiceToggledOn: g } = gt(), { callRcbEvent: m } = Wn(), A = B.useCallback(() => {
    var P;
  ...
  var f, c, g, m;
  const { settings: A } = De(), { endStreamMessage: y, injectMessage: P, removeMessage: E, streamMessage: w } = PA(), { getCurrPath: C, getPrevPath: H, goToPath: k } = CA(), {
    timeoutId: F,
    voiceToggledOn: U,
    ...
    setInputLength: te
  } = gt(), { flowRef: X, chatBodyRef: G, inputRef: $, keepVoiceOnRef: Z, paramsInputRef: re } = bt(), { showToast: ne, dismissToast: ue } = DA(), { callRcbEvent: ae } = Wn(), { syncVoice: ce } = Ul(), { setTextAreaValue: ve } = Fa(), { openChat: de } = vr(), Me = B.useCallback(async (ee) => {
    var le, fe, be;
    const oe = C();
    if (!(!oe || !X.current[oe])) {
      if (_) {
  ...
  return /* @__PURE__ */ b.jsxs("div", { "data-testid": "chatbot-footer-container", style: m.footerStyle, className: "rcb-chat-footer-container", children: [
    /* @__PURE__ */ b.jsx("div", { className: "rcb-chat-footer", children: f == null ? void 0 : f.map(
      (A, y) => /* @__PURE__ */ b.jsx(B.Fragment, { children: A }, y)
    ) }),
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: !((m = E.general) != null && m.embedded) && /* @__PURE__ */ b.jsxs(
    "div",
    {
      ...
      children: [
        L(),
        !((y = E.notification) != null && y.disabled) && ((P = E.notification) == null ? void 0 : P.showCount) && /* @__PURE__ */ b.jsx("span", { style: w.notificationBadgeStyle, className: "rcb-badge", children: C })
      ]
    }
  ) });
}, yc = () => {
  var f, c, g, m;
  const A = BA(), { settings: y } = De(), { styles: P } = Xe(), { isChatWindowOpen: E, openChat: w } = vr(), [C, H] = B.useState(!1), [k, F] = B.useState(!1), [U, L] = B.useState(0);
  B.useEffect(() => {
    var T, K, te;
  ...
  const _ = {
    ...
    bottom: 30,
    backgroundColor: (c = y.general) == null ? void 0 : c.secondaryColor,
    color: "#fff",
    ...P.tooltipStyle
  }, j = {
    borderColor: `transparent transparent transparent ${_.backgroundColor}`
  };
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: !((g = y.general) != null && g.embedded) && /* @__PURE__ */ b.jsxs(
    "div",
    {
      ...
      onClick: () => w(!0),
      children: [
        /* @__PURE__ */ b.jsx("span", { children: (m = y.tooltip) == null ? void 0 : m.text }),
  ...
  return /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
    ...
    U && /* @__PURE__ */ b.jsx("div", { className: "rcb-emoji-button-popup", ref: k, children: (y = (A = P.emoji) == null ? void 0 : A.list) == null ? void 0 : y.map((G, $) => /* @__PURE__ */ b.jsx(
      "span",
      {
        className: "rcb-emoji",
        onMouseDown: (Z) => K(Z, G),
  ...
  const { settings: f } = De(), { audioToggledOn: c, setAudioToggledOn: g } = gt(), { callRcbEvent: m } = Wn(), A = B.useCallback(() => {
    var y;
    (y = f.event) != null && y.rcbToggleAudio && m(Ee.TOGGLE_AUDIO, { currState: c, newState: !c }).defaultPrevented || g((P) => !P);
  }, []);
  return {
    audioToggledOn: c,
    toggleAudio: A
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Xe(), { audioToggledOn: y, toggleAudio: P } = Sc(), E = {
  ...
  var f, c;
  const { settings: g } = De(), { styles: m } = Xe(), { openChat: A } = vr(), y = {
    ...
    ) : w && /* @__PURE__ */ b.jsx("span", { className: "rcb-close-chat-icon", "data-testid": "rcb-close-chat-icon", children: /* @__PURE__ */ b.jsx(w, { style: y }) });
  };
  return /* @__PURE__ */ b.jsx(
    "div",
    {
  ...
  const { notificationsToggledOn: f, toggleNotifications: c, playNotificationSound: g } = Ll();
  return {
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Xe(), { notificationsToggledOn: y, toggleNotifications: P } = Cc(), E = {
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Xe(), { injectMessage: y } = PA(), { inputRef: P } = bt(), { voiceToggledOn: E, toggleVoice: w } = Ul(), { setInputLength: C, setTextAreaValue: H, textAreaDisabled: k } = Fa(), { handleSubmitText: F } = La(), U = B.useRef([]), [L, _] = B.useState(!1);
  B.useEffect(() => {
    var G;
  ...
  const j = {
    ...
    !Z.fileType || !Z.fileUrl || await y(/* @__PURE__ */ b.jsx(
      xs,
      {
        file: $,
        fileType: Z.fileType,
  ...
  const k = {
    ...
    [Ke.FILE_ATTACHMENT_BUTTON]: (y = f.fileAttachment) == null ? void 0 : y.disabled,
  ...
  }), []), { header: g, chatInput: m, footer: A } = B.useMemo(() => Tc(f, c), [f, c]), y = B.useMemo(() => g, [g]), P = B.useMemo(() => m, [m]), E = B.useMemo(() => A, [A]);
  return { headerButtons: y, chatInputButtons: P, footerButtons: E };
}, Cs = () => {
  const { settings: f } = De(), { styles: c } = Xe(), { setMessages: g } = Fl(), {
    isLoadingChatHistory: m,
    setIsLoadingChatHistory: A
  } = gt(), { chatBodyRef: y } = bt(), { callRcbEvent: P } = Wn(), { chatScrollHeight: E } = vr(), w = B.useCallback(() => {
    var C;
    const H = nc();
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Xe(), { showChatHistory: y } = Cs(), [P, E] = B.useState(!1), w = {
    color: (f = m.general) == null ? void 0 : f.primaryColor,
    borderColor: (c = m.general) == null ? void 0 : c.primaryColor,
  ...
  var f;
  const { settings: c } = De(), { hasInteractedPage: g, setHasInteractedPage: m, hasFlowStarted: A, setHasFlowStarted: y } = gt(), P = B.useCallback(() => {
    var E;
    m(!0), !A && ((E = c.general) == null ? void 0 : E.flowStartTrigger) === "ON_PAGE_INTERACT" && y(!0);
  ...
  const A = BA(), { settings: y } = De(), {
    ...
    setTimeoutId: ve
  } = gt(), { chatBodyRef: de, flowRef: Me, streamMessageMap: Ce, paramsInputRef: ee, keepVoiceOnRef: le } = bt(), fe = Me.current, { viewportHeight: be, setViewportHeight: oe, setViewportWidth: me, openChat: Oe } = vr(), { setUpNotifications: Se } = Ll(), { handleFirstInteraction: Ae } = Nc(), { showChatHistory: Le } = Cs(), { updateTextAreaFocus: Zt, setTextAreaValue: Gt } = Fa(), { syncVoice: tt } = Ul(), mt = B.useRef(0);
  B.useEffect(() => (window.addEventListener("click", Ae), window.addEventListener("keydown", Ae), window.addEventListener("touchstart", Ae), () => {
    ...
    var xe, ze, Pe;
    Se(), Z((xe = y.chatInput) == null ? void 0 : xe.disabled), $((ze = y.chatWindow) == null ? void 0 : ze.defaultOpen), re((Pe = y.audio) == null ? void 0 : Pe.defaultToggledOn), setTimeout(() => {
      var Ie;
    ...
    if ((xe = y.chatHistory) != null && xe.disabled)
      localStorage.removeItem((ze = y.chatHistory) == null ? void 0 : ze.storageKey);
    else if (oc(y), localStorage.getItem((Pe = y.chatHistory) == null ? void 0 : Pe.storageKey) != null) {
      const $e = Qo(/* @__PURE__ */ b.jsx(Hc, {}), "system");
      k([$e]), (Ie = y.chatHistory) != null && Ie.autoLoad && Le();
    }
  }, [(f = y.chatHistory) == null ? void 0 : f.storageKey, (c = y.chatHistory) == null ? void 0 : c.maxEntries, (g = y.chatHistory) == null ? void 0 : g.disabled]), B.useEffect(() => {
    var xe;
    A || (xe = y.general) != null && xe.embedded || !navigator.virtualKeyboard || (navigator.virtualKeyboard.overlaysContent = !0, navigator.virtualKeyboard.addEventListener("geometrychange", (ze) => {
      if (!ze.target)
        return;
    ...
    (async (Ie, $e, nt) => {
      ...
      await Xu(
        ...
        L,
        ve
      ), ue(!1), "chatDisabled" in $e || Z((We = y.chatInput) == null ? void 0 : We.disabled), ce(typeof $e.file == "function"), Zt(Ie), tt(le.current && !$e.chatDisabled), Ce.current.clear(), yA(H);
    })(xe, ze, Pe);
  }, [_]), B.useEffect(() => {
    var xe;
  ...
  var c, g, m, A;
  f == null || f.map((X) => X());
  const y = BA(), { settings: P } = De(), { styles: E } = Xe(), { hasFlowStarted: w, setHasFlowStarted: C } = gt(), { inputRef: H } = bt(), {
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: (() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ b.jsx(yc, {}),
        /* @__PURE__ */ b.jsx(mc, {}),
        L && !y && !((c = P.general) != null && c.embedded) && /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
        ...
        /* @__PURE__ */ b.jsxs("div", { style: te(), className: "rcb-chat-window", children: [
          ...
          ((m = P.general) == null ? void 0 : m.showInputRow) && /* @__PURE__ */ b.jsx(vc, { buttons: j }),
...
}, Wc = zl.DEFAULT_URL, Zc = zl.DEFAULT_EXPIRATION, Ds = zl.CACHE_KEY_PREFIX, Gc = (f, c, g) => {
  const m = localStorage.getItem(`${Ds}_${f}_${c}`);
  if (!m)
    return null;
  try {
  ...
  const { id: g, version: m, baseUrl: A = Wc, cacheDuration: y = Zc } = c, P = m || await Yc(g, A);
  if (!P)
    return console.error(`Unable to find version for theme: ${g}`), { settings: {}, inlineStyles: {}, cssStylesText: "" };
  const E = Gc(g, P, y);
  if (E) {
    const K = ns(f, E.cssStylesText);
...
}, ns = (f, c) => c.split(new RegExp("(?<=})")).map((g) => {
  const m = g.trim();
  return m.startsWith("@import") || m.startsWith("@keyframes") || m.startsWith("@media") ? m : m ? `#${f} ${m}` : "";
}).join(`
`), Ps = () => Bs(As), Xc = () => Bs(ss), Vc = async (f, c, g, m) => {
  var A, y;
  let P = Ps(), E = Xc(), w = "";
  if (m != null)
    if (Array.isArray(m))
      for (const C of m) {
        const H = await ts(f, C);
        P = Oa(H.settings, P), E = Oa(H.inlineStyles, E), w += H.cssStylesText;
      }
    else {
      const C = await ts(f, m);
      P = Oa(C.settings, P), E = Oa(C.inlineStyles, E), w += C.cssStylesText;
    }
  return c != null && (P = Oa(c, P)), g != null && (E = Oa(g, E)), ((A = P.chatInput) == null ? void 0 : A.botDelay) != null && ((y = P.chatInput) == null ? void 0 : y.botDelay) < 500 && (P.chatInput.botDelay = 500), { settings: P, inlineStyles: E, cssStylesText: w };
}, Oa = (f, c) => {
      ...
      if (Object.prototype.hasOwnProperty.call(y, E)) {
        ...
        if (w && typeof w == "object")
          if (m.has(w))
            ...
            m.set(w, C), P[E] = C, g.push({ source: w, target: C });
          }
        else
          P[E] = w;
      }
  ...
  var c;
  const g = B.useRef(""), m = B.useRef({}), [A, y] = B.useState({}), [P, E] = B.useState({}), [w, C] = B.useState(!1);
  B.useEffect(() => {
    C(!0);
  }, []);
  ...
  const k = async () => {
    ...
    ).defaultPrevented || (C != null && C.loadConfig && (await C.loadConfig(w, c, g, m, A, E), P(!0)), (U = g.event) != null && U.rcbPostLoadChatBot && xA(
  ...
  const P = B.useMemo(() => f || "rcb-" + SA(), []), E = !c || Object.keys(c).length === 0 ? $c : c, w = g || {}, C = m || {}, H = y || [], [k, F] = B.useState(!1), U = Ts(), L = B.useRef(null), [_, j] = B.useState(A || []);
  B.useEffect(() => {
    A && j(A);
  }, [A]);
...
function td() {
  const [f, c] = B.useState(""), [g, m] = B.useState(""), [A, y] = B.useState(!1), [P, E] = B.useState(!1), [w, C] = B.useState({
    ...Is,
    voice: {
      disabled: !0
    },
  ...
  const L = async (K) => {
    ...
    const te = await os.post("/ai/chat", {
    ...
    transfer: {
      ...
      component: (K) => {
        if (F.action === "transfer")
          return Cl(P, f, g, F.token, F.toEmail, F.amount), /* @__PURE__ */ b.jsx("div", { className: "pl-4 pt-2", children: P && f && g && F.token && F.toEmail && F.amount && /* @__PURE__ */ b.jsx(Zs, { onClick: () => y(!0) }) });
      },
      // chatDisabled: true,
      path: "transfer"
    }
