import { j as h } from "./vendor-radix-nT--cb5B.js";
import { c as L, d as O, h as M, i as U, r as E, O as j } from "./vendor-react-CwfAKKXk.js";
var w = { exports: {} };
...
function z() {
  const p = M(), { pathname: b } = U();
  return E.useEffect(() => {
    p.state !== "idle" ? S.start() : S.done();
  }, [p]), E.useEffect(() => {
    window.scrollTo(0, 0);
  }, [b]), /* @__PURE__ */ h.jsx(h.Fragment, { children: /* @__PURE__ */ h.jsx(j, {}) });
}
export {
  z as RootLayout
};
