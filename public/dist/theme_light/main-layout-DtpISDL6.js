import { j as b } from "./vendor-radix-J-HUYjfF.js";
import { a as Ti, c as et, l as zl, B as Rs, D as Wl, b as Zl, d as Gl, e as Ro, f as as, h as Ms, S as Qs, g as Dl, T as Os, i as js } from "./main-CUT_4fhD.js";
import { j as CA, k as Rl, L as Fs, r as B, a as Ls, p as Ml, O as Hs } from "./vendor-react-BG344YhI.js";
import { u as Ql, B as Ns } from "./vendor-utils-C0Sc_Wei.js";
import { X as Us } from "./vendor-ui-utils-BXvI5fwV.js";
import { W as _l, V as zs } from "./index-G8ZW7zv2.js";
import { S as Ws } from "./SendButton-CQS9-J9j.js";
import { W as Zs, M as Gs } from "./MarketplaceProvider-Ci7a6I4e.js";
function _s({ routes: f, currentRouteName: c }) {
  const { pathname: g } = CA(), y = Rl(), A = Ti.isAuthenticated();
...
function Yl({
  ...
  const { i18n: c } = Ql(), [g, y] = B.useState(!1);
  B.useEffect(() => {
    const P = zl.getData();
    P && c.changeLanguage(P);
  }, [c]);
  const A = (P) => {
    c.changeLanguage(P), zl.setData(P), y(!1), f == null || f();
...
function Ys() {
  const { t: f } = Ql(), [c, g] = B.useState(!1), y = Ti.isAuthenticated(), A = Rl(), { pathname: w } = CA(), P = [
    {
    ...
    try {
      await as.post("/auth/logout"), Ti.clearAllAuthData(), window.location.href = "/auth";
    } catch (m) {
      const x = Ms(m);
      Ns.error(x.message);
    }
        ...
        Wl,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ b.jsxs(Gl, { className: "bg-white border-none", children: [
              P.map((m) => {
                const x = w.startsWith(m.href);
                return /* @__PURE__ */ b.jsx(
                  Ro,
                  {
                    onClick: (H) => {
                      if (!y) {
                        H.preventDefault(), A("/auth");
                        return;
                      }
                      A(m.href);
                    },
                    children: x ? /* @__PURE__ */ b.jsxs("div", { className: "w-full flex items-center justify-between gap-2", children: [
                      /* @__PURE__ */ b.jsx("div", { className: "text-brand-foreground", children: m.name }),
                      /* @__PURE__ */ b.jsx("img", { src: "/imgs/icons/checked.svg", alt: "" })
                    ] }) : /* @__PURE__ */ b.jsx("div", { className: "", children: m.name })
                  },
                  m.name
                );
              }),
              ...
              /* @__PURE__ */ b.jsx(
                ...
                {
                  onSelect: (m) => m.preventDefault(),
                  children: /* @__PURE__ */ b.jsx(Yl, { onLanguageChange: () => g(!1) })
                }
              ),
              /* @__PURE__ */ b.jsx(Ro, { onSelect: () => A("/profile"), children: w === "/profile" ? /* @__PURE__ */ b.jsxs("div", { className: "w-full flex items-center justify-between gap-2", children: [
              ...
              /* @__PURE__ */ b.jsx(
                Ro,
                {
                  ...
                  children: /* @__PURE__ */ b.jsx("div", { onClick: () => C(), children: "Logout" })
                }
              )
            ] })
          ]
        ...
        Wl,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ b.jsxs(Gl, { className: "bg-white", children: [
              ...
              /* @__PURE__ */ b.jsx(Ro, { onSelect: () => C(), children: "Logout" })
            ] })
          ]
        }
      ) }),
...
function Xs() {
  const { pathname: f } = CA(), { t: c } = Ql(), g = Rl(), y = Ti.isAuthenticated(), A = [
    {
    ...
    //   href: '/community',
    // },
  ], w = A.find((C) => f.startsWith(C.href)), P = (w == null ? void 0 : w.name) || "Home";
...
function Vs() {
  ...
  var g = Object.prototype.hasOwnProperty, y = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, A = {}, w = {};
  function P(a) {
    return g.call(w, a) ? !0 : g.call(A, a) ? !1 : y.test(a) ? w[a] = !0 : (A[a] = !0, !1);
  }
  function C(a, u, v, E, Q, I, N) {
    this.acceptsBooleans = u === 2 || u === 3 || u === 4, this.attributeName = E, this.attributeNamespace = Q, this.mustUseProperty = v, this.propertyName = a, this.type = u, this.sanitizeURL = I, this.removeEmptyString = N;
  }
  var m = {};
  "children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(a) {
    m[a] = new C(a, 0, !1, a, null, !1, !1);
  }), [["acceptCharset", "accept-charset"], ["className", "class"], ["htmlFor", "for"], ["httpEquiv", "http-equiv"]].forEach(function(a) {
    var u = a[0];
    m[u] = new C(u, 1, !1, a[1], null, !1, !1);
  }), ["contentEditable", "draggable", "spellCheck", "value"].forEach(function(a) {
    m[a] = new C(a, 2, !1, a.toLowerCase(), null, !1, !1);
  }), ["autoReverse", "externalResourcesRequired", "focusable", "preserveAlpha"].forEach(function(a) {
    m[a] = new C(a, 2, !1, a, null, !1, !1);
  }), "allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(a) {
    m[a] = new C(a, 3, !1, a.toLowerCase(), null, !1, !1);
  }), ["checked", "multiple", "muted", "selected"].forEach(function(a) {
    m[a] = new C(a, 3, !0, a, null, !1, !1);
  }), ["capture", "download"].forEach(function(a) {
    m[a] = new C(a, 4, !1, a, null, !1, !1);
  }), ["cols", "rows", "size", "span"].forEach(function(a) {
    m[a] = new C(a, 6, !1, a, null, !1, !1);
  }), ["rowSpan", "start"].forEach(function(a) {
    m[a] = new C(a, 5, !1, a.toLowerCase(), null, !1, !1);
  });
  var x = /[\-:]([a-z])/g;
  function H(a) {
  ...
  "accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(a) {
    ...
    m[u] = new C(u, 1, !1, a, null, !1, !1);
  }), "xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(a) {
    var u = a.replace(x, H);
    m[u] = new C(u, 1, !1, a, "http://www.w3.org/1999/xlink", !1, !1);
  }), ["xml:base", "xml:lang", "xml:space"].forEach(function(a) {
    var u = a.replace(x, H);
    m[u] = new C(u, 1, !1, a, "http://www.w3.org/XML/1998/namespace", !1, !1);
  }), ["tabIndex", "crossOrigin"].forEach(function(a) {
    m[a] = new C(a, 1, !1, a.toLowerCase(), null, !1, !1);
  }), m.xlinkHref = new C("xlinkHref", 1, !1, "xlink:href", "http://www.w3.org/1999/xlink", !0, !1), ["src", "href", "action", "formAction"].forEach(function(a) {
    m[a] = new C(a, 1, !1, a.toLowerCase(), null, !0, !0);
  });
  var k = {
  ...
  Object.keys(k).forEach(function(a) {
    F.forEach(function(u) {
      u = u + a.charAt(0).toUpperCase() + a.substring(1), k[u] = k[a];
    });
  });
  var U = /["'&<>]/;
  function L(a) {
    ...
    if (u) {
      ...
      for (E = u.index; E < a.length; E++) {
        ...
        Q !== E && (v += a.substring(Q, E)), Q = E + 1, v += u;
      }
      a = Q !== E ? v + a.substring(Q, E) : v;
    }
    return a;
  }
    ...
    for (var E in v) if (g.call(v, E)) {
      ...
      if (Q != null && typeof Q != "boolean" && Q !== "") {
        if (E.indexOf("--") === 0) {
          ...
          I = E;
          var N = X.get(I);
          N !== void 0 || (N = L(I.replace(_, "-$1").toLowerCase().replace(j, "-ms-")), X.set(I, N)), I = N, Q = typeof Q == "number" ? Q === 0 || g.call(k, E) ? "" + Q : Q + "px" : L(("" + Q).trim());
        }
        u ? (u = !1, a.push(' style="', I, ":", Q)) : a.push(";", I, ":", Q);
      }
    }
    u || a.push('"');
  }
  function $(a, u, v, E) {
    ...
    if (!(2 < v.length) || v[0] !== "o" && v[0] !== "O" || v[1] !== "n" && v[1] !== "N") {
      if (u = m.hasOwnProperty(v) ? m[v] : null, u !== null) {
        switch (typeof E) {
          case "function":
          case "symbol":
            return;
        ...
        switch (v = u.attributeName, u.type) {
          case 3:
            ...
            break;
          case 4:
            E === !0 ? a.push(" ", v, '=""') : E !== !1 && a.push(" ", v, '="', L(E), '"');
            break;
          case 5:
            isNaN(E) || a.push(" ", v, '="', L(E), '"');
            break;
          case 6:
            !isNaN(E) && 1 <= E && a.push(" ", v, '="', L(E), '"');
            break;
          default:
            u.sanitizeURL && (E = "" + E), a.push(" ", v, '="', L(E), '"');
        }
      } else if (P(v)) {
        switch (typeof E) {
          case "function":
  ...
  function ce(a) {
    var u = ae.get(a);
    if (u === void 0) {
      if (!ue.test(a)) throw Error(c(65, a));
      u = "<" + a, ae.set(a, u);
    }
    return u;
  }
  function ve(a, u, v, E, Q) {
    switch (u) {
      case "select":
        a.push(ce("select"));
        var I = null, N = null;
      ...
      case "textarea":
        ...
        if (I === null && N !== null && (I = N), a.push(">"), se != null) {
          ...
          if (T(se) && 1 < se.length) throw Error(c(93));
          I = "" + se;
        }
...
`), I !== null && a.push(L("" + I)), null;
      case "input":
        ...
        return se !== null ? $(a, E, "checked", se) : ie !== null && $(a, E, "checked", ie), I !== null ? $(a, E, "value", I) : V !== null && $(a, E, "value", V), a.push("/>"), null;
      case "menuitem":
        a.push(ce("menuitem"));
...
`), I;
      ...
      case "html":
        return Q.insertionMode === 0 && a.push("<!DOCTYPE html>"), ne(a, v, u, E);
      default:
        if (u.indexOf("-") === -1 && typeof v.is != "string") return ne(a, v, u, E);
        a.push(ce(u)), N = I = null;
  ...
  function Me(a, u, v, E) {
    switch (v.insertionMode) {
      case 0:
      case 1:
        return a.push('<div hidden id="'), a.push(u.segmentPrefix), u = E.toString(16), a.push(u), a.push('">');
      case 2:
        return a.push('<svg aria-hidden="true" style="display:none" id="'), a.push(u.segmentPrefix), u = E.toString(16), a.push(u), a.push('">');
      case 3:
        return a.push('<math aria-hidden="true" style="display:none" id="'), a.push(u.segmentPrefix), u = E.toString(16), a.push(u), a.push('">');
      case 4:
        return a.push('<table hidden id="'), a.push(u.segmentPrefix), u = E.toString(16), a.push(u), a.push('">');
      case 5:
        return a.push('<table hidden><tbody id="'), a.push(u.segmentPrefix), u = E.toString(16), a.push(u), a.push('">');
      case 6:
        return a.push('<table hidden><tr id="'), a.push(u.segmentPrefix), u = E.toString(16), a.push(u), a.push('">');
      case 7:
        return a.push('<table hidden><colgroup id="'), a.push(u.segmentPrefix), u = E.toString(16), a.push(u), a.push('">');
      default:
        throw Error(c(397));
    }
  }
  ...
  function be(a, u, v, E) {
    return v.generateStaticMarkup ? (a.push(L(u)), !1) : (u === "" ? a = E : (E && a.push("<!-- -->"), a.push(L(u)), a = !0), a);
  }
  ...
  function mr(a, u, v, E) {
    ...
    a._reactInternals = I;
    var N = u.contextType;
    if (a.context = typeof N == "object" && N !== null ? N._currentValue2 : E, N = u.getDerivedStateFromProps, typeof N == "function" && (N = N(v, Q), Q = N == null ? Q : oe({}, Q, N), a.state = Q), typeof u.getDerivedStateFromProps != "function" && typeof a.getSnapshotBeforeUpdate != "function" && (typeof a.UNSAFE_componentWillMount == "function" || typeof a.componentWillMount == "function")) if (u = a.state, typeof a.componentWillMount == "function" && a.componentWillMount(), typeof a.UNSAFE_componentWillMount == "function" && a.UNSAFE_componentWillMount(), u !== a.state && Yn.enqueueReplaceState(a, a.state, null), I.queue !== null && 0 < I.queue.length) if (u = I.queue, N = I.replace, I.queue = null, I.replace = !1, N && u.length === 1) a.state = u[0];
    else {
      for (I = N ? u[0] : a.state, Q = !0, N = N ? 1 : 0; N < u.length; N++) {
        var V = u[N];
        V = typeof V == "function" ? V.call(a, I, v, E) : V, V != null && (Q ? (Q = !1, I = oe({}, I, V)) : oe(I, V));
      }
      a.state = I;
    }
    else I.queue = null;
  ...
  function Xn(a, u, v) {
    ...
    if (30 < I) {
      var N = Q - Q % 5;
      return I = (E & (1 << N) - 1).toString(32), E >>= N, Q -= N, { id: 1 << 32 - Cn(u) + Q | v << Q | E, overflow: I + a };
    }
    return { id: 1 << I | v << Q | E, overflow: a };
  }
  ...
  function Ze(a, u, v) {
    if (ot = _t(), Re = Kn(), en) {
      var E = Re.queue;
      if (u = E.dispatch, Qt !== null && (v = Qt.get(E), v !== void 0)) {
        Qt.delete(E), E = Re.memoizedState;
        do
          E = a(E, v.action), v = v.next;
        while (v !== null);
        return Re.memoizedState = E, [E, u];
      }
      return [Re.memoizedState, u];
    }
    return a = a === br ? typeof u == "function" ? u() : u : v !== void 0 ? v(u) : u, Re.memoizedState = a, a = Re.queue = { last: null, dispatch: null }, a = a.dispatch = Kr.bind(null, ot, a), [Re.memoizedState, a];
  }
  function qn(a, u) {
    if (ot = _t(), Re = Kn(), u = u === void 0 ? null : u, Re !== null) {
      ...
      if (v !== null && u !== null) {
        ...
        e: if (E === null) E = !1;
          ...
          for (var Q = 0; Q < E.length && Q < u.length; Q++) if (!wr(u[Q], E[Q])) {
            E = !1;
            break e;
          }
          E = !0;
  ...
  function kn(a, u, v, E, Q, I, N, V, ie) {
    var he = [], se = /* @__PURE__ */ new Set();
    return u = { destination: null, responseState: u, progressiveChunkSize: E === void 0 ? 12800 : E, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: se, pingedTasks: he, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: Q === void 0 ? ct : Q, onAllReady: jt, onShellReady: N === void 0 ? jt : N, onShellError: jt, onFatalError: jt }, v = rn(u, 0, null, v, !1, !1), v.parentFlushed = !0, a = nn(u, a, null, v, se, Rt, null, yr), he.push(a), u;
  }
  function nn(a, u, v, E, Q, I, N, V) {
    ...
    }, blockedBoundary: v, blockedSegment: E, abortSet: Q, legacyContext: I, context: N, treeContext: V };
    return Q.add(ie), ie;
  }
  function rn(a, u, v, E, Q, I) {
    return { status: 0, id: -1, index: u, parentFlushed: !1, chunks: [], children: [], formatContext: E, boundary: v, lastPushedText: Q, textEmbedded: I };
  }
  function Ft(a, u) {
  ...
  function dt(a, u, v, E, Q) {
    for (ot = {}, Mt = u, hn = 0, a = v(E, Q); Dn; ) Dn = !1, hn = 0, Pn += 1, Re = null, a = v(E, Q);
    return $n(), a;
  }
  function Sr(a, u, v, E) {
    var Q = v.render(), I = E.childContextTypes;
    if (I != null) {
      var N = u.legacyContext;
      if (typeof v.getChildContext != "function") E = N;
      else {
        v = v.getChildContext();
        for (var V in v) if (!(V in I)) throw Error(c(108, ut(E) || "Unknown", V));
        E = oe({}, N, v);
      }
      u.legacyContext = E, Ge(a, u, Q), u.legacyContext = N;
    } else Ge(a, u, Q);
  }
  function xr(a, u) {
    if (a && a.defaultProps) {
  ...
  function Yt(a, u, v, E, Q) {
    if (typeof v == "function") if (v.prototype && v.prototype.isReactComponent) {
      Q = gr(v, u.legacyContext);
      var I = v.contextType;
      I = new v(E, typeof I == "object" && I !== null ? I._currentValue2 : Q), mr(I, v, E, Q), Sr(a, u, I, v);
    } else {
      I = gr(v, u.legacyContext), Q = dt(a, u, v, E, I);
      var N = hn !== 0;
      if (typeof Q == "object" && Q !== null && typeof Q.render == "function" && Q.$$typeof === void 0) mr(Q, v, E, I), Sr(a, u, Q, v);
      else if (N) {
        E = u.treeContext, u.treeContext = Xn(E, 1, 0);
        try {
          Ge(a, u, Q);
        } finally {
          u.treeContext = E;
      ...
      switch (Q = u.blockedSegment, I = ve(Q.chunks, v, E, a.responseState, Q.formatContext), Q.lastPushedText = !1, N = Q.formatContext, Q.formatContext = te(N, v, E), Ht(a, u, I), Q.formatContext = N, v) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      switch (v) {
        ...
        case mt:
          e: {
            v = u.blockedBoundary, Q = u.blockedSegment, I = E.fallback, E = E.children, N = /* @__PURE__ */ new Set();
            ...
            try {
              ...
              u.blockedBoundary = v, u.blockedSegment = Q;
            }
      ...
      if (typeof v == "object" && v !== null) switch (v.$$typeof) {
        case tt:
          ...
          return;
        case Ue:
          v = v.type, E = xr(v, E), Yt(a, u, v, E, Q);
          return;
        case Zt:
          if (Q = E.children, v = v._context, E = E.value, I = v._currentValue2, v._currentValue2 = E, N = St, St = E = { parent: N, depth: N === null ? 0 : N.depth + 1, context: v, parentValue: I, value: E }, u.context = E, Ge(a, u, Q), a = St, a === null) throw Error(c(403));
          E = a.parentValue, a.context._currentValue2 = E === ze ? a.context._defaultValue : E, a = St = a.parent, u.context = a;
          return;
        case Gt:
          E = E.children, E = E(v._currentValue2), Ge(a, u, E);
          return;
        case Pe:
          Q = v._init, v = Q(v._payload), E = xr(v, E), Yt(
            a,
            u,
            v,
            E,
  ...
  function Ge(a, u, v) {
    if (u.node = v, typeof v == "object" && v !== null) {
      ...
      if (v === null || typeof v != "object" ? E = null : (E = Xe && v[Xe] || v["@@iterator"], E = typeof E == "function" ? E : null), E && (E = E.call(v))) {
        if (v = E.next(), !v.done) {
          var Q = [];
          do
            Q.push(v.value), v = E.next();
          while (!v.done);
          Lt(a, u, Q);
        }
        return;
    ...
    typeof v == "string" ? (E = u.blockedSegment, E.lastPushedText = be(u.blockedSegment.chunks, v, a.responseState, E.lastPushedText)) : typeof v == "number" && (E = u.blockedSegment, E.lastPushedText = be(u.blockedSegment.chunks, "" + v, a.responseState, E.lastPushedText));
  }
  function Lt(a, u, v) {
    for (var E = v.length, Q = 0; Q < E; Q++) {
      var I = u.treeContext;
      u.treeContext = Xn(I, E, Q);
      try {
        Ht(a, u, v[Q]);
      } finally {
        u.treeContext = I;
  ...
  function Ht(a, u, v) {
    var E = u.blockedSegment.formatContext, Q = u.legacyContext, I = u.context;
    try {
      return Ge(a, u, v);
    } catch (ie) {
      if ($n(), typeof ie == "object" && ie !== null && typeof ie.then == "function") {
        ...
        N.children.push(V), N.lastPushedText = !1, a = nn(a, u.node, u.blockedBoundary, V, u.abortSet, u.legacyContext, u.context, u.treeContext).ping, v.then(a, a), u.blockedSegment.formatContext = E, u.legacyContext = Q, u.context = I, We(I);
      } else throw u.blockedSegment.formatContext = E, u.legacyContext = Q, u.context = I, We(I), ie;
    }
  }
  function an(a) {
  ...
  function Tn(a, u, v) {
    ...
    a.blockedSegment.status = 3, E === null ? (u.allPendingTasks--, u.status !== 2 && (u.status = 2, u.destination !== null && u.destination.push(null))) : (E.pendingTasks--, E.forceClientRender || (E.forceClientRender = !0, a = v === void 0 ? Error(c(432)) : v, E.errorDigest = u.onError(a), E.parentFlushed && u.clientRenderedBoundaries.push(E)), E.fallbackAbortableTasks.forEach(function(Q) {
      return Tn(Q, u, v);
    }), E.fallbackAbortableTasks.clear(), u.allPendingTasks--, u.allPendingTasks === 0 && (E = u.onAllReady, E()));
  }
  function xt(a, u) {
  ...
  function An(a, u, v) {
    switch (v.parentFlushed = !0, v.status) {
      case 0:
        var E = v.id = a.nextSegmentId++;
        return v.lastPushedText = !1, v.textEmbedded = !1, a = a.responseState, u.push('<template id="'), u.push(a.placeholderPrefix), a = E.toString(16), u.push(a), u.push('"></template>');
      case 1:
        v.status = 2;
        var Q = !0;
        E = v.chunks;
        ...
        for (var N = 0; N < v.length; N++) {
          for (Q = v[N]; I < Q.index; I++) u.push(E[I]);
          Q = pn(a, u, Q);
        }
        for (; I < E.length - 1; I++) u.push(E[I]);
        return I < E.length && (Q = u.push(E[I])), Q;
      default:
        throw Error(c(390));
    }
  }
  function pn(a, u, v) {
    var E = v.boundary;
    if (E === null) return An(a, u, v);
    if (E.parentFlushed = !0, E.forceClientRender) return a.responseState.generateStaticMarkup || (E = E.errorDigest, u.push("<!--$!-->"), u.push("<template"), E && (u.push(' data-dgst="'), E = L(E), u.push(E), u.push('"')), u.push("></template>")), An(a, u, v), a = a.responseState.generateStaticMarkup ? !0 : u.push("<!--/$-->"), a;
    if (0 < E.pendingTasks) {
      ...
      return Q = Q.boundaryPrefix + I.toString(16), E = E.id = Q, de(u, a.responseState, E), An(a, u, v), u.push("<!--/$-->");
    }
    if (E.byteSize > a.progressiveChunkSize) return E.rootSegmentID = a.nextSegmentId++, a.completedBoundaries.push(E), de(u, a.responseState, E.id), An(a, u, v), u.push("<!--/$-->");
    if (a.responseState.generateStaticMarkup || u.push("<!--$-->"), v = E.completedSegments, v.length !== 1) throw Error(c(391));
  ...
  function yt(a, u, v) {
    for (var E = v.completedSegments, Q = 0; Q < E.length; Q++) Ut(a, u, v, E[Q]);
    if (E.length = 0, a = a.responseState, E = v.id, v = v.rootSegmentID, u.push(a.startInlineScript), a.sentCompleteBoundaryFunction ? u.push('$RC("') : (a.sentCompleteBoundaryFunction = !0, u.push('function $RC(a,b){a=document.getElementById(a);b=document.getElementById(b);b.parentNode.removeChild(b);if(a){a=a.previousSibling;var f=a.parentNode,c=a.nextSibling,e=0;do{if(c&&8===c.nodeType){var d=c.data;if("/$"===d)if(0===e)break;else e--;else"$"!==d&&"$?"!==d&&"$!"!==d||e++}d=c.nextSibling;f.removeChild(c);c=d}while(c);for(;b.firstChild;)f.insertBefore(b.firstChild,c);a.data="$";a._reactRetry&&a._reactRetry()}};$RC("')), E === null) throw Error(c(395));
    return v = v.toString(16), u.push(E), u.push('","'), u.push(a.segmentPrefix), u.push(v), u.push('")<\/script>');
  }
  function Ut(a, u, v, E) {
    if (E.status === 2) return !0;
    var Q = E.id;
    if (Q === -1) {
      if ((E.id = v.rootSegmentID) === -1) throw Error(c(392));
      return In(a, u, E);
    }
    return In(a, u, E), a = a.responseState, u.push(a.startInlineScript), a.sentCompleteSegmentFunction ? u.push('$RS("') : (a.sentCompleteSegmentFunction = !0, u.push('function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("')), u.push(a.segmentPrefix), Q = Q.toString(16), u.push(Q), u.push('","'), u.push(a.placeholderPrefix), u.push(Q), u.push('")<\/script>');
  }
  function it(a, u) {
    try {
      ...
      if (v !== null && a.pendingRootTasks === 0) {
        ...
        for (v = 0; v < E.length - 1; v++) u.push(E[v]);
        v < E.length && u.push(E[v]);
      }
      ...
      for (I = 0; I < Q.length; I++) {
        ...
        if (E.push(V.startInlineScript), V.sentClientRenderFunction ? E.push('$RX("') : (V.sentClientRenderFunction = !0, E.push('function $RX(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())};$RX("')), ie === null) throw Error(c(395));
        if (E.push(ie), E.push('"'), he || se || Be) {
          E.push(",");
          var At = le(he || "");
          E.push(At);
        }
  ...
  function ft(a, u, v, E) {
    ...
    if (a = kn(a, fe(v, u ? u.identifierPrefix : void 0), { insertionMode: 1, selectedValue: null }, 1 / 0, $e, void 0, function() {
      ie = !0;
    }), at(a), Rn(a, E), a.status === 1) a.status = 2, V.destroy(a.fatalError);
...
function Js() {
  ...
  var g = null, y = 0;
  function A(i, s) {
    if (s.length !== 0) if (512 < s.length) 0 < y && (i.enqueue(new Uint8Array(g.buffer, 0, y)), g = new Uint8Array(512), y = 0), i.enqueue(s);
    else {
      var h = g.length - y;
      h < s.length && (h === 0 ? i.enqueue(g) : (g.set(s.subarray(0, h), y), i.enqueue(g), s = s.subarray(h)), g = new Uint8Array(512), y = 0), g.set(s, y), y += s.length;
    }
  }
  function w(i, s) {
    return A(i, s), !0;
  ...
  function P(i) {
    g && 0 < y && (i.enqueue(new Uint8Array(g.buffer, 0, y)), g = null, y = 0);
  }
  ...
  var re = /([A-Z])/g, ne = /^ms-/, ue = Array.isArray, ae = x("<script>"), ce = x("<\/script>"), ve = x('<script src="'), de = x('<script type="module" src="'), Me = x('" async=""><\/script>'), Ce = /(<\/|<)(s)(cript)/gi;
  function ee(i, s, h, S) {
    return "" + s + (h === "s" ? "\\u0073" : "\\u0053") + S;
  }
  function le(i, s, h, S, O) {
    i = i === void 0 ? "" : i, s = s === void 0 ? ae : x('<script nonce="' + Z(s) + '">');
    var M = [];
    if (h !== void 0 && M.push(s, m(("" + h).replace(Ce, ee)), ce), S !== void 0) for (h = 0; h < S.length; h++) M.push(ve, m(Z(S[h])), Me);
    if (O !== void 0) for (S = 0; S < O.length; S++) M.push(de, m(Z(O[S])), Me);
    return { bootstrapChunks: M, startInlineScript: s, placeholderPrefix: x(i + "P:"), segmentPrefix: x(i + "S:"), boundaryPrefix: i + "B:", idPrefix: i, nextSuspenseID: 0, sentCompleteSegmentFunction: !1, sentCompleteBoundaryFunction: !1, sentClientRenderFunction: !1 };
  }
  function fe(i, s) {
  ...
  var me = x("<!-- -->");
  function Oe(i, s, h, S) {
    return s === "" ? S : (S && i.push(me), i.push(m(Z(s))), !0);
  }
  var Se = /* @__PURE__ */ new Map(), Ae = x(' style="'), Le = x(":"), Zt = x(";");
  function Gt(i, s, h) {
    ...
    for (var S in h) if (k.call(h, S)) {
      ...
      if (O != null && typeof O != "boolean" && O !== "") {
        if (S.indexOf("--") === 0) {
          ...
          M = S;
          var z = Se.get(M);
          z !== void 0 || (z = x(Z(M.replace(re, "-$1").toLowerCase().replace(ne, "-ms-"))), Se.set(M, z)), M = z, O = typeof O == "number" ? O === 0 || k.call(X, S) ? m("" + O) : m(O + "px") : m(Z(("" + O).trim()));
        }
  ...
  function Pe(i, s, h, S) {
    ...
    if (!(2 < h.length) || h[0] !== "o" && h[0] !== "O" || h[1] !== "n" && h[1] !== "N") {
      if (s = T.hasOwnProperty(h) ? T[h] : null, s !== null) {
        ...
        switch (h = m(s.attributeName), s.type) {
          case 3:
            S && i.push(tt, h, Ue);
            break;
          case 4:
            S === !0 ? i.push(tt, h, Ue) : S !== !1 && i.push(tt, h, mt, m(Z(S)), xe);
            break;
          case 5:
            isNaN(S) || i.push(tt, h, mt, m(Z(S)), xe);
            break;
          case 6:
            !isNaN(S) && 1 <= S && i.push(tt, h, mt, m(Z(S)), xe);
            break;
          default:
            s.sanitizeURL && (S = "" + S), i.push(tt, h, mt, m(Z(S)), xe);
        }
      } else if (_(h)) {
        switch (typeof S) {
          case "function":
  ...
  function ut(i, s, h, S) {
    ...
    return i.push(Ie), nt(i, O, h), typeof h == "string" ? (i.push(m(Z(h))), null) : h;
  }
  var Rt = x(`
`), gr = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, St = /* @__PURE__ */ new Map();
  function qe(i) {
    var s = St.get(i);
    if (s === void 0) {
      if (!gr.test(i)) throw Error(c(65, i));
      s = x("<" + i), St.set(i, s);
    }
    return s;
  }
  var _e = x("<!DOCTYPE html>");
  function Zn(i, s, h, S, O) {
    switch (s) {
      ...
      case "option":
        z = O.selectedValue, i.push(qe("option"));
        ...
        if (z != null) if (h = pe !== null ? "" + pe : ze(J), ue(z)) {
      ...
      case "textarea":
        ...
        if (M === null && z !== null && (M = z), i.push(Ie), ye != null) {
          ...
          if (ue(ye) && 1 < ye.length) throw Error(c(93));
          M = "" + ye;
        }
        return typeof M == "string" && M[0] === `
` && i.push(Rt), M !== null && i.push(m(Z("" + M))), null;
      case "input":
...
` && i.push(Rt), M;
      ...
      case "missing-glyph":
        return ut(i, h, s, S);
      case "html":
        return O.insertionMode === 0 && i.push(_e), ut(i, h, s, S);
      default:
        ...
        for (we in h) if (k.call(h, we) && (J = h[we], J != null)) switch (we) {
          ...
          case "suppressHydrationWarning":
            break;
          default:
            _(we) && typeof J != "function" && typeof J != "symbol" && i.push(tt, m(we), mt, m(Z(J)), xe);
        }
        return i.push(Ie), nt(i, z, M), M;
    }
  }
  var Gn = x("</"), _n = x(">"), We = x('<template id="'), Yn = x('"></template>'), mr = x("<!--$-->"), yr = x('<!--$?--><template id="'), Xn = x('"></template>'), Cn = x("<!--$!-->"), Jr = x("<!--/$-->"), Vn = x("<template"), $t = x('"'), Jn = x(' data-dgst="');
  x(' data-msg="'), x(' data-stck="');
  var wr = x("></template>");
  function ot(i, s, h) {
    if (A(i, yr), h === null) throw Error(c(395));
    return A(i, h), w(i, Xn);
  }
  var Mt = x('<div hidden id="'), qt = x('">'), Re = x("</div>"), en = x('<svg aria-hidden="true" style="display:none" id="'), Dn = x('">'), hn = x("</svg>"), Qt = x('<math aria-hidden="true" style="display:none" id="'), Pn = x('">'), _t = x("</math>"), Ve = x('<table hidden id="'), Kn = x('">'), $n = x("</table>"), br = x('<table hidden><tbody id="'), Ze = x('">'), qn = x("</tbody></table>"), Kr = x('<table hidden><tr id="'), $r = x('">'), Ot = x("</tr></table>"), er = x('<table hidden><colgroup id="'), Bn = x('">'), tn = x("</colgroup></table>");
  function ct(i, s, h, S) {
    switch (h.insertionMode) {
      case 0:
      case 1:
        return A(i, Mt), A(i, s.segmentPrefix), A(i, m(S.toString(16))), w(i, qt);
      case 2:
        return A(i, en), A(i, s.segmentPrefix), A(i, m(S.toString(16))), w(i, Dn);
      case 3:
        return A(i, Qt), A(i, s.segmentPrefix), A(i, m(S.toString(16))), w(i, Pn);
      case 4:
        return A(i, Ve), A(i, s.segmentPrefix), A(i, m(S.toString(16))), w(i, Kn);
      case 5:
        return A(i, br), A(i, s.segmentPrefix), A(i, m(S.toString(16))), w(i, Ze);
      case 6:
        return A(i, Kr), A(i, s.segmentPrefix), A(i, m(S.toString(16))), w(i, $r);
      case 7:
        return A(
          i,
          er
        ), A(i, s.segmentPrefix), A(i, m(S.toString(16))), w(i, Bn);
      default:
        throw Error(c(397));
    }
  }
  ...
  var kn = x('function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("'), nn = x('$RS("'), rn = x('","'), Ft = x('")<\/script>'), on = x('function $RC(a,b){a=document.getElementById(a);b=document.getElementById(b);b.parentNode.removeChild(b);if(a){a=a.previousSibling;var f=a.parentNode,c=a.nextSibling,e=0;do{if(c&&8===c.nodeType){var d=c.data;if("/$"===d)if(0===e)break;else e--;else"$"!==d&&"$?"!==d&&"$!"!==d||e++}d=c.nextSibling;f.removeChild(c);c=d}while(c);for(;b.firstChild;)f.insertBefore(b.firstChild,c);a.data="$";a._reactRetry&&a._reactRetry()}};$RC("'), dt = x('$RC("'), Sr = x('","'), xr = x('")<\/script>'), Yt = x('function $RX(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())};$RX("'), Ge = x('$RX("'), Lt = x('"'), Ht = x(")<\/script>"), an = x(","), Tn = /[<\u2028\u2029]/g;
  function xt(i) {
    ...
    if (typeof h == "function") if (h.prototype && h.prototype.isReactComponent) {
      ...
      if (typeof h == "object" && h !== null) switch (h.$$typeof) {
        ...
        case a:
          ...
          return;
        case Ut:
          if (O = S.children, h = h._context, S = S.value, M = h._currentValue, h._currentValue = S, z = se, se = S = { parent: z, depth: z === null ? 0 : z.depth + 1, context: h, parentValue: M, value: S }, s.context = S, ht(i, s, O), i = se, i === null) throw Error(c(403));
  ...
  function Go(i, s, h) {
    var S = i.blockedBoundary;
    i.blockedSegment.status = 3, S === null ? (s.allPendingTasks--, s.status !== 2 && (s.status = 2, s.destination !== null && s.destination.close())) : (S.pendingTasks--, S.forceClientRender || (S.forceClientRender = !0, i = h === void 0 ? Error(c(432)) : h, S.errorDigest = s.onError(i), S.parentFlushed && s.clientRenderedBoundaries.push(S)), S.fallbackAbortableTasks.forEach(function(O) {
      return Go(O, s, h);
  ...
  function Qr(i, s, h) {
    switch (h.parentFlushed = !0, h.status) {
      case 0:
        ...
        return h.lastPushedText = !1, h.textEmbedded = !1, i = i.responseState, A(s, We), A(s, i.placeholderPrefix), i = m(S.toString(16)), A(s, i), w(s, Yn);
      case 1:
        h.status = 2;
        var O = !0;
        S = h.chunks;
  ...
  function Or(i, s, h) {
    ...
    if (S.parentFlushed = !0, S.forceClientRender) S = S.errorDigest, w(s, Cn), A(s, Vn), S && (A(s, Jn), A(s, m(Z(S))), A(s, $t)), w(s, wr), Qr(i, s, h);
      ...
      O = x(O.boundaryPrefix + M.toString(16)), S = S.id = O, ot(s, i.responseState, S), Qr(i, s, h);
      ...
      if (w(s, mr), h = S.completedSegments, h.length !== 1) throw Error(c(391));
      Or(i, s, h[0]);
    }
    return w(s, Jr);
  }
  ...
  function Vo(i, s, h) {
    ...
    return h = m(h.toString(16)), A(s, S), A(s, Sr), A(s, i.segmentPrefix), A(s, h), w(s, xr);
  }
  function Jo(i, s, h, S) {
    ...
    return Xo(i, s, S), i = i.responseState, A(s, i.startInlineScript), i.sentCompleteSegmentFunction ? A(s, nn) : (i.sentCompleteSegmentFunction = !0, A(s, kn)), A(s, i.segmentPrefix), O = m(O.toString(16)), A(s, O), A(s, rn), A(s, i.placeholderPrefix), A(s, O), w(s, Ft);
  }
  function oo(i, s) {
    g = new Uint8Array(512), y = 0;
    try {
      ...
      for (M = 0; M < O.length; M++) {
        ...
        A(S, pe), A(S, Lt), (we || ye || je) && (A(S, an), A(S, m(xt(we || "")))), (ye || je) && (A(S, an), A(S, m(xt(ye || "")))), je && (A(S, an), A(S, m(xt(je)))), w(S, Ht);
      }
      O.splice(0, M);
      var pt = i.completedBoundaries;
      for (M = 0; M < pt.length; M++) Vo(i, s, pt[M]);
      pt.splice(0, M), P(s), g = new Uint8Array(512), y = 0;
  ...
  return gA.renderToReadableStream = function(i, s) {
  ...
  }, gA.version = "18.3.1", gA;
}
var Qo = {}, Jl;
function Ks() {
  return Jl || (Jl = 1, Ml.env.NODE_ENV !== "production" && function() {
    var f = B, c = "18.3.1", g = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function y(e) {
      {
        ...
        if (l !== null) {
          ...
          switch (l.type) {
            ...
            case ce:
              ...
              break;
            default:
              l.sanitizeURL && (K(o, d), o = "" + o, Kr(o)), e.push(yt, p, Ut, Ve(o), it);
          }
        } else if (le(n)) {
          switch (typeof o) {
            case "function":
    ...
    var v = !1, E = !1, Q = !1, I = !1, N = !1, V = !1, ie = !1;
    function he(e, t) {
      {
        var n = e[t];
        if (n != null) {
    ...
    function st(e, t, n) {
      xe("input", t), t.checked !== void 0 && t.defaultChecked !== void 0 && !E && (A("%s contains an input of type %s with both checked and defaultChecked props. Input elements must be either controlled or uncontrolled (specify either the checked prop, or the defaultChecked prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", t.type), E = !0), t.value !== void 0 && t.defaultValue !== void 0 && !v && (A("%s contains an input of type %s with both value and defaultValue props. Input elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", t.type), v = !0), e.push(Wt("input"));
        ...
        if (G.call(t, p)) {
          ...
          switch (p) {
            ...
            case "suppressHydrationWarning":
              break;
            default:
              le(p) && typeof D != "function" && typeof D != "symbol" && e.push(yt, p, Ut, Ve(D), it);
              break;
          }
        }
...
` && e.push(gn), l;
    ...
    function un(e, t, n) {
      m(e, Dr), m(e, t.placeholderPrefix);
      var o = n.toString(16);
      return m(e, o), x(e, yn);
    }
    ...
    function to(e, t, n, o, l) {
      var d;
      return d = x(e, eo), m(e, Lo), n && (m(e, Ho), m(e, Ve(n)), m(e, Br)), o && (m(e, za), m(e, Ve(o)), m(e, Br)), l && (m(e, Wa), m(e, Ve(l)), m(e, Br)), d = x(e, kr), d;
    }
    function Za(e, t) {
      return x(e, tr);
    }
    ...
    function oo(e, t, n, o) {
      switch (n.insertionMode) {
        case tn:
        case ct:
          return m(e, ro), m(e, t.segmentPrefix), m(e, o.toString(16)), x(e, On);
        case jt:
          return m(e, Tr), m(e, t.segmentPrefix), m(e, o.toString(16)), x(e, Uo);
        case kn:
          return m(e, Wo), m(e, t.segmentPrefix), m(e, o.toString(16)), x(e, Ir);
        case nn:
          return m(e, Zo), m(e, t.segmentPrefix), m(e, o.toString(16)), x(e, Rr);
        case rn:
          return m(e, Go), m(e, t.segmentPrefix), m(e, o.toString(16)), x(e, Mr);
        case Ft:
          return m(e, Yo), m(e, t.segmentPrefix), m(e, o.toString(16)), x(e, Qr);
        case on:
          return m(e, Xo), m(e, t.segmentPrefix), m(e, o.toString(16)), x(e, Vo);
        default:
    ...
    function J(e, t, n) {
      m(e, t.startInlineScript), t.sentCompleteSegmentFunction ? m(e, O) : (t.sentCompleteSegmentFunction = !0, m(e, S)), m(e, t.segmentPrefix);
      var o = n.toString(16);
      return m(e, o), m(e, M), m(e, t.placeholderPrefix), m(e, o), x(e, z);
    }
    var pe = s + ';$RC("', we = '$RC("', ye = '","', je = '")<\/script>';
    function pt(e, t, n, o) {
      if (m(e, t.startInlineScript), t.sentCompleteBoundaryFunction ? m(e, we) : (t.sentCompleteBoundaryFunction = !0, m(e, pe)), n === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      var l = o.toString(16);
      return m(e, n), m(e, ye), m(e, t.segmentPrefix), m(e, l), x(e, je);
    }
    var Ct = h + ';$RX("', Dt = '$RX("', jr = '"', $o = ")<\/script>", or = ",";
    function TA(e, t, n, o, l, d) {
      if (m(e, t.startInlineScript), t.sentClientRenderFunction ? m(e, Dt) : (t.sentClientRenderFunction = !0, m(e, Ct)), n === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return m(e, n), m(e, jr), (o || l || d) && (m(e, or), m(e, _a(o || ""))), (l || d) && (m(e, or), m(e, _a(l || ""))), d && (m(e, or), m(e, _a(d))), x(e, $o);
    }
    var IA = /[<\u2028\u2029]/g;
    function _a(e) {
    ...
    var wt = Object.assign, LA = Symbol.for("react.element"), Mi = Symbol.for("react.portal"), qo = Symbol.for("react.fragment"), Pt = Symbol.for("react.strict_mode"), Qi = Symbol.for("react.profiler"), ea = Symbol.for("react.provider"), ta = Symbol.for("react.context"), na = Symbol.for("react.forward_ref"), ra = Symbol.for("react.suspense"), ao = Symbol.for("react.suspense_list"), io = Symbol.for("react.memo"), Fr = Symbol.for("react.lazy"), Ya = Symbol.for("react.scope"), Xa = Symbol.for("react.debug_trace_mode"), Va = Symbol.for("react.legacy_hidden"), oa = Symbol.for("react.default_value"), Oi = Symbol.iterator, HA = "@@iterator";
    function NA(e) {
    ...
    function Fi() {
      {
        if (Ao === 0) {
          ji = console.log, Ka = console.info, He = console.warn, Lr = console.error, $a = console.group, qa = console.groupCollapsed, ei = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: ti,
...
` + ia + e;
    ...
    function ar(e, t) {
      ...
      var d;
      d = aa.current, aa.current = null, Fi();
      try {
        if (t) {
          var p = function() {
            throw Error();
...
` + D[W].replace(" at new ", " at ");
        ...
        ni = !1, aa.current = d, Li(), Error.prepareStackTrace = l;
      }
    ...
    var Hi = {}, ai = g.ReactDebugCurrentFrame;
    function Aa(e) {
      if (e) {
    ...
    var Zi = {}, Nr = {}, vo, li, ha, pa, va, Ur, go, mo, ga;
    {
...
Please check the code for the %s component.`, t, t, o), Zi[l] = !0;
      }
    }
    var ya = {
...
Please update the following components: %s`,
    ...
    function Xi(e, t, n, o) {
      ...
      typeof R == "function" && (e.state = si(e, t, R, l, n)), typeof t.getDerivedStateFromProps != "function" && typeof e.getSnapshotBeforeUpdate != "function" && (typeof e.UNSAFE_componentWillMount == "function" || typeof e.componentWillMount == "function") && (Yi(t, e), ZA(d, e, n, o));
    }
    var GA = {
      id: 1,
      overflow: ""
    ...
    var XA = Math.clz32 ? Math.clz32 : VA, ci = Math.log, wa = Math.LN2;
    function VA(e) {
      var t = e >>> 0;
    ...
    var KA = typeof Object.is == "function" ? Object.is : JA, wn = null, di = null, ba = null, Fe = null, Bt = !1, zr = !1, lr = 0, ke = null, Hn = 0, Sa = 25, kt = !1, Tt;
    function dn() {
      if (wn === null)
...
Incoming: %s`, Tt, "[" + e.join(", ") + "]", "[" + t.join(", ") + "]");
    ...
    function Vi(e, t, n) {
      if (e !== xa && (Tt = "useReducer"), wn = dn(), Fe = Nn(), Bt) {
        ...
        var Y = Fe.queue = {
          last: null,
          dispatch: null
        }, q = Y.dispatch = Ki.bind(null, wn, Y);
    ...
    function ll() {
      var e = di, t = _A(e.treeContext), n = vi;
      if (n === null)
...
` + o.stack;
    ...
    var Da = g.ReactCurrentDispatcher, So = g.ReactDebugCurrentFrame, Pa = 0, Wr = 1, Ba = 2, ka = 3, Ta = 4, Zr = 0, gi = 1, ur = 2, tA = 12800;
    function sl(e) {
    ...
    function _r(e, t, n, o, l, d, p, D, R) {
      var W = [], Y = /* @__PURE__ */ new Set(), q = {
        destination: null,
        responseState: t,
        progressiveChunkSize: o === void 0 ? tA : o,
        status: Zr,
        fatalError: null,
        nextSegmentId: 0,
        allPendingTasks: 0,
      ...
      ge.parentFlushed = !0;
      var Te = cr(q, e, null, ge, Y, co, ua, GA);
      return W.push(Te), q;
    }
    function ul(e, t) {
      var n = e.pingedTasks;
    ...
    function Co(e, t, n) {
      dr(t, "Suspense");
      var o = t.blockedBoundary, l = t.blockedSegment, d = n.fallback, p = n.children, D = /* @__PURE__ */ new Set(), R = cl(e, D), W = l.chunks.length, Y = Ia(
        e,
        W,
        R,
        l.formatContext,
      ...
      try {
        if (vt(e, t, p), Ri(q.chunks, e.responseState, q.lastPushedText, q.textEmbedded), q.status = Wr, Yr(R, q), R.pendingTasks === 0) {
          fn(t);
          return;
        }
      } catch (Te) {
    ...
    function nA(e, t, n, o, l) {
      ...
      n.props !== l && (bi || A("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", Ne(o) || "a component"), bi = !0);
      {
        ...
        if (p != null) {
          var D = t.legacyContext, R = Ni(n, o, D, p);
    ...
    function dl(e, t, n, o) {
      Sn(t, n);
      var l = fo(n, t.legacyContext), d = Gi(n, o, l);
      Xi(d, n, o, l), nA(e, t, d, n, o), fn(t);
    }
    var rA = {}, Bo = {}, wi = {}, oA = {}, bi = !1, ko = {}, Si = !1, xi = !1, Ei = !1;
    function aA(e, t, n, o) {
      var l;
      if (l = fo(n, t.legacyContext), xo(t, n), n.prototype && typeof n.prototype.render == "function") {
        var d = Ne(n) || "Unknown";
        rA[d] || (A("The <%s /> component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.", d, d), rA[d] = !0);
      }
    ...
    function iA(e) {
      {
        ...
        if (typeof e.getDerivedStateFromProps == "function") {
          var n = Ne(e) || "Unknown";
          oA[n] || (A("%s: Function components do not support getDerivedStateFromProps.", n), oA[n] = !0);
        }
    ...
    function lA(e, t, n, o) {
      ...
      D = t.context, t.context = Ui(l, d), It(e, t, p), t.context = zi(l), D !== t.context && A("Popping the context provider did not return back to the original snapshot. This is a bug in React.");
    }
    ...
    function gl(e, t, n) {
      ...
      if (typeof n == "string") {
        ...
        pr.lastPushedText = Ii(t.blockedSegment.chunks, n, e.responseState, pr.lastPushedText);
        return;
      }
      if (typeof n == "number") {
        var En = t.blockedSegment;
        En.lastPushedText = Ii(t.blockedSegment.chunks, "" + n, e.responseState, En.lastPushedText);
        return;
      }
    ...
    function vt(e, t, n) {
      ...
      try {
        ...
        if (bo(), typeof D == "object" && D !== null && typeof D.then == "function") {
          ml(e, t, D), t.blockedSegment.formatContext = o, t.legacyContext = l, t.context = d, po(d), t.componentStack = p;
          return;
        } else
    ...
    function cA(e, t, n) {
      if (t === null) {
        ...
        if (t.pendingTasks === 0)
          n.parentFlushed && n.status === Wr && Yr(t, n), t.parentFlushed && e.completedBoundaries.push(t), t.fallbackAbortableTasks.forEach(sA, e), t.fallbackAbortableTasks.clear();
    ...
    function wl(e, t) {
      ...
      if (n.status === Pa) {
        ...
        o = bn, bn = t;
        try {
          It(e, t, t.node), Ri(n.chunks, e.responseState, n.lastPushedText, n.textEmbedded), t.abortSet.delete(t), n.status = Wr, cA(e, t.blockedBoundary, n);
        } catch (d) {
          if (bo(), typeof d == "object" && d !== null && typeof d.then == "function") {
            var l = t.ping;
            d.then(l, l);
          } else
            t.abortSet.delete(t), n.status = Ta, yl(e, t.blockedBoundary, n, d);
        } finally {
          bn = o;
        }
      }
    ...
    function Pi(e) {
      if (e.status !== ur) {
        ...
        try {
          ...
          eA(l), Da.current = n, So.getCurrentStack = o, n === qi && po(t);
        }
      }
    }
    function fr(e, t, n) {
    ...
    function To(e, t, n) {
      ...
      if (o.parentFlushed = !0, o.forceClientRender)
        return OA(t, e.responseState, o.errorDigest, o.errorMessage, o.errorComponentStack), fr(e, t, n), FA(t, e.responseState);
      if (o.pendingTasks > 0) {
        ...
        var p = d[0];
        return To(e, t, p), jA(t, e.responseState);
      }
    }
    function bl(e, t, n) {
    ...
    function pA(e, t, n, o) {
      ...
      var Y = _r(e, RA(n, t ? t.identifierPrefix : void 0), MA(), 1 / 0, ki, void 0, W);
      if (fA(Y), hA(Y, o), Sl(Y, D), l)
        throw d;
      if (!R)
    ...
    Qo.renderToNodeStream = El, Qo.renderToStaticMarkup = vA, Qo.renderToStaticNodeStream = r, Qo.renderToString = xl, Qo.version = c;
  }()), Qo;
}
var mA = {}, Kl;
function $s() {
  return Kl || (Kl = 1, Ml.env.NODE_ENV !== "production" && function() {
    ...
    var C = 512, m = null, x = 0;
    function H(r) {
      m = new Uint8Array(C), x = 0;
    }
    function k(r, e) {
      if (e.length !== 0) {
        if (e.length > C) {
          x > 0 && (r.enqueue(new Uint8Array(m.buffer, 0, x)), m = new Uint8Array(C), x = 0), r.enqueue(e);
          return;
        }
        var t = e, n = m.length - x;
        n < t.length && (n === 0 ? r.enqueue(m) : (m.set(t.subarray(0, n), x), r.enqueue(m), t = t.subarray(n)), m = new Uint8Array(C), x = 0), m.set(t, x), x += t.length;
      }
    }
    function F(r, e) {
      return k(r, e), !0;
    ...
    function U(r) {
      m && x > 0 && (r.enqueue(new Uint8Array(m.buffer, 0, x)), m = null, x = 0);
    }
    function L(r) {
      r.close();
    }
    ...
    var ze = {
      ...
      "aria-rowspan": 0,
      "aria-setsize": 0
    }, Xe = {}, ut = new RegExp("^(aria)-[" + le + "]*$"), Rt = new RegExp("^(aria)[A-Z][" + le + "]*$");
    function gr(r, e) {
      {
    ...
    {
      var We = {}, Yn = /^on./, mr = /^on[^A-Z]/, yr = new RegExp("^(aria)-[" + le + "]*$"), Xn = new RegExp("^(aria)[A-Z][" + le + "]*$");
      _n = function(r, e, t, n) {
        ...
        if (n != null) {
          ...
          return mr.test(e) && A("Invalid event handler property `%s`. React events use the camelCase naming convention, for example `onClick`.", e), We[e] = !0, !0;
    ...
    function xr(r, e, t, n, o) {
      ...
      if (t !== void 0 && p.push(d, j(on(t)), kn), n !== void 0)
        for (var D = 0; D < n.length; D++)
          p.push(nn, j(Ze(n[D])), Ft);
      if (o !== void 0)
        for (var R = 0; R < o.length; R++)
          p.push(rn, j(Ze(o[R])), Ft);
      return {
        bootstrapChunks: p,
        startInlineScript: d,
      ...
      for (var o in t)
        if (ne.call(t, o)) {
          ...
          if (!(l == null || typeof l == "boolean" || l === "")) {
            ...
            D ? (d = j(Ze(o)), Z(l, o), p = j(Ze(("" + l).trim()))) : (Kn(o, l), d = u(o), typeof l == "number" ? l !== 0 && !ne.call(xe, o) ? p = j(l + "px") : p = j("" + l) : (Z(l, o), p = j(Ze(("" + l).trim())))), n ? (n = !1, r.push(v, d, E, p)) : r.push(Q, d, E, p);
          }
        }
      n || r.push(ie);
    }
        ...
        if (o !== null) {
          ...
          switch (o.type) {
            case ve:
              ...
              return;
            case de:
              n === !0 ? r.push(N, d, he) : n === !1 || r.push(N, d, V, j(Ze(n)), ie);
              return;
            case Me:
              isNaN(n) || r.push(N, d, V, j(Ze(n)), ie);
              break;
            case Ce:
              !isNaN(n) && n >= 1 && r.push(N, d, V, j(Ze(n)), ie);
              break;
            default:
              o.sanitizeURL && ($(n, l), n = "" + n, Bn(n)), r.push(N, d, V, j(Ze(n)), ie);
          }
        } else if (me(t)) {
          switch (typeof n) {
            case "function":
        ...
        if (ne.call(e, d)) {
          ...
          switch (d) {
            ...
            case "suppressHydrationWarning":
              break;
            default:
              me(d) && typeof p != "function" && typeof p != "symbol" && r.push(N, j(d), V, j(Ze(p)), ie);
              break;
          }
        }
...
` && r.push(yn), o;
    ...
    function ht(r, e, t, n, o) {
      var l;
      return l = F(r, Qn), k(r, ro), t && (k(r, rr), k(r, j(Ze(t))), k(r, On)), n && (k(r, Tr), k(r, j(Ze(n))), k(r, On)), o && (k(r, Uo), k(r, j(Ze(o))), k(r, On)), l = F(r, zo), l;
    }
    function Zo(r, e) {
      return F(r, no);
    }
    ...
    function LA(r, e, t, n, o, l) {
      if (k(r, e.startInlineScript), e.sentClientRenderFunction ? k(r, OA) : (e.sentClientRenderFunction = !0, k(r, QA)), t === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return k(r, t), k(r, jA), (n || o || l) && (k(r, wt), k(r, j(qo(n || "")))), (o || l) && (k(r, wt), k(r, j(qo(o || "")))), l && (k(r, wt), k(r, j(qo(l)))), F(r, FA);
    }
    var Mi = /[<\u2028\u2029]/g;
    function qo(r) {
    ...
    var Pt = Object.assign, Qi = Symbol.for("react.element"), ea = Symbol.for("react.portal"), ta = Symbol.for("react.fragment"), na = Symbol.for("react.strict_mode"), ra = Symbol.for("react.profiler"), ao = Symbol.for("react.provider"), io = Symbol.for("react.context"), Fr = Symbol.for("react.forward_ref"), Ya = Symbol.for("react.suspense"), Xa = Symbol.for("react.suspense_list"), Va = Symbol.for("react.memo"), oa = Symbol.for("react.lazy"), Oi = Symbol.for("react.scope"), HA = Symbol.for("react.debug_trace_mode"), NA = Symbol.for("react.legacy_hidden"), UA = Symbol.for("react.default_value"), Ja = Symbol.iterator, Ne = "@@iterator";
    function Ao(r) {
    ...
    function He(r) {
      ...
      if (typeof r == "object")
        switch (r.$$typeof) {
          ...
          case Fr:
            return ji(r, r.render, "ForwardRef");
          case Va:
    ...
    function lo() {
      {
        if (Lr === 0) {
          $a = console.log, qa = console.info, ei = console.warn, ti = console.error, Fi = console.group, Li = console.groupCollapsed, aa = console.groupEnd;
          var r = {
            configurable: !0,
            enumerable: !0,
            value: ia,
...
` + p[R].replace(" at new ", " at ");
    ...
    function zi(r, e) {
      ...
      if (t === null)
        throw new Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");
      t.depth === e.depth ? ho(t, e) : zi(t, e);
    }
    function Wi(r, e) {
      var t = e.parent;
      if (t === null)
        throw new Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");
      r.depth === t.depth ? ho(r, t) : Wi(r, t), fa(e);
    }
    function Ln(r) {
      var e = Fn, t = r;
      e !== t && (e === null ? Ui(t) : t === null ? po(e) : e.depth === t.depth ? ho(e, t) : e.depth > t.depth ? zi(e, t) : Wi(e, t), Fn = t);
    }
    function Ai(r, e) {
      var t;
    ...
    function WA(r) {
      ...
      {
        var t = e.parentValue;
        t === UA ? e.context._currentValue = e.context._defaultValue : e.context._currentValue = t, r._currentRenderer !== void 0 && r._currentRenderer !== null && r._currentRenderer !== Ar && A("Detected multiple renderers concurrently rendering the same context provider. This is currently unsupported."), r._currentRenderer = Ar;
      }
      return Fn = e.parent;
    }
    function Zi() {
    ...
    var ha = {}, pa = {}, va, Ur, go, mo, ga, yo, ma, ya, si;
    {
      ...
      yo = function(r, e) {
        if (!(r === null || typeof r == "function")) {
          var t = e + "_" + r;
          Gi.has(t) || (Gi.add(t), A("%s(...): Expected the last optional `callback` argument to be a function. Instead received: %s.", e, r));
        }
      }, ga = function(r, e) {
        if (e === void 0) {
...
Please check the code for the %s component.`, e, e, n), ha[o] = !0;
    ...
    var Yi = {
      ...
      enqueueSetState: function(r, e, t) {
        var n = vo(r);
        n.queue === null ? _i(r, "setState") : (n.queue.push(e), t != null && yo(t, "setState"));
      },
      ...
      enqueueForceUpdate: function(r, e) {
        var t = vo(r);
        t.queue === null ? _i(r, "forceUpdate") : e != null && yo(e, "setState");
      }
    };
...
Please update the following components: %s`,
      ...
      typeof e.UNSAFE_componentWillMount == "function" && e.UNSAFE_componentWillMount(), t !== e.state && (A("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", He(r) || "Component"), Yi.enqueueReplaceState(e, e.state, null));
    }
    function ui(r, e, t, n) {
    ...
    function wo(r, e, t, n) {
      ...
      r.updater = Yi, r.props = t, r.state = o;
      var l = {
        queue: [],
        replace: !1
      };
      ...
      typeof D == "function" && (r.state = ZA(r, e, D, o, t)), typeof e.getDerivedStateFromProps != "function" && typeof r.getSnapshotBeforeUpdate != "function" && (typeof r.UNSAFE_componentWillMount == "function" || typeof r.componentWillMount == "function") && (_A(e, r), ui(l, r, t, n));
    }
    var YA = {
      id: 1,
      overflow: ""
    ...
    var JA = Math.clz32 ? Math.clz32 : di, KA = Math.log, wn = Math.LN2;
    function di(r) {
      var e = r >>> 0;
    ...
    var Fe = typeof Object.is == "function" ? Object.is : ba, Bt = null, zr = null, lr = null, ke = null, Hn = !1, Sa = !1, kt = 0, Tt = null, dn = 0, $A = 25, Jt = !1, Nn;
    function sr() {
      if (Bt === null)
        throw new Error(`Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
...
Incoming: %s`, Nn, "[" + r.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function eA() {
      var r = zr, e = XA(r.treeContext), t = So;
      if (t === null)
        throw new Error("Invalid hook call. Hooks can only be called inside of the body of a function component.");
      var n = kt++;
      return Ut(t, e, n);
...
` + n.stack;
    ...
    var Ba = g.ReactCurrentDispatcher, ka = g.ReactDebugCurrentFrame, Ta = 0, Zr = 1, gi = 2, ur = 3, tA = 4, sl = 0, Gr = 1, _r = 2, ul = 12800;
    function cl(r) {
    ...
    function Ia(r, e, t, n, o, l, d, p, D) {
      ...
      q.parentFlushed = !0;
      var ge = dr(Y, r, null, q, W, ua, ca, YA);
      return R.push(ge), Y;
    }
    function bn(r, e) {
      var t = r.pingedTasks;
    ...
    function nA(r, e, t) {
      ...
      try {
        ...
        Y.status = tA, D.forceClientRender = !0, D.errorDigest = Do(r, ge), yi(D, ge);
      } finally {
    ...
    function oA(r, e, t, n) {
      Eo(e, t);
      var o = jn(t, e.legacyContext), l = Xi(t, n, o);
      wo(l, t, n, o), wi(r, e, l, t, n), Kt(e);
    }
    var bi = {}, ko = {}, Si = {}, xi = {}, Ei = !1, aA = {}, iA = !1, Ci = !1, AA = !1;
    function fl(r, e, t, n) {
      var o;
    ...
    function Di(r, e, t, n, o) {
      var l = t.type, d = lA(l, n);
      Ma(r, e, l, d, o);
    }
    function vl(r, e, t, n) {
      t._context === void 0 ? t !== t.Consumer && (AA || (AA = !0, A("Rendering <Context> directly is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?"))) : t = t._context;
      var o = n.children;
    ...
    function It(r, e, t, n) {
      ...
      p = e.context, e.context = Ai(o, l), vt(r, e, d), e.context = WA(o), p !== e.context && A("Popping the context provider did not return back to the original snapshot. This is a bug in React.");
    }
    function gl(r, e, t, n, o) {
      xn(e, "Lazy");
      var l = t._payload, d = t._init, p = d(l), D = lA(p, n);
      Ma(r, e, p, D, o), Kt(e);
    }
    ...
    function ml(r, e) {
      typeof Symbol == "function" && // $FlowFixMe Flow doesn't know about toStringTag
      r[Symbol.toStringTag] === "Generator" && (iA || A("Using Generators as children is unsupported and will likely yield unexpected results because enumerating a generator mutates it. You may convert it to an array with `Array.from()` or the `[...spread]` operator before rendering. Keep in mind you might need to polyfill these features for older browsers."), iA = !0), r.entries === e && (Ci || A("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Ci = !0);
    }
    function vt(r, e, t) {
      try {
        return yl(r, e, t);
    ...
    function Yr(r, e, t) {
      ...
      try {
        ...
        if (hi(), typeof p == "object" && p !== null && typeof p.then == "function") {
          uA(r, e, p), e.blockedSegment.formatContext = n, e.legacyContext = o, e.context = l, Ln(l), e.componentStack = d;
          return;
        } else
    ...
    function To(r, e, t) {
      if (e === null) {
        ...
        if (e.pendingTasks === 0)
          t.parentFlushed && t.status === Zr && fr(e, t), e.parentFlushed && r.completedBoundaries.push(e), e.fallbackAbortableTasks.forEach(wl, r), e.fallbackAbortableTasks.clear();
      ...
      if (t.status === Ta) {
        ...
        try {
          ...
          if (hi(), typeof l == "object" && l !== null && typeof l.then == "function") {
            ...
            e.abortSet.delete(e), t.status = tA, cA(r, e.blockedBoundary, t, l);
        } finally {
          Sn = n;
        }
      }
    ...
    function fA(r, e, t) {
      ...
      return n.length = 0, Ri(e, r.responseState, t.id, t.rootSegmentID);
    }
    function Sl(r, e, t) {
      for (var n = t.completedSegments, o = 0; o < n.length; o++) {
        var l = n[o];
    ...
    function hA(r, e, t, n) {
      ...
      if (o === -1) {
        ...
        return Oa(r, e, n), IA(e, r.responseState, o);
    }
    function ki(r, e) {
      H();
      try {
      ...
      return new Promise(function(t, n) {
        ...
        if (e && e.signal) {
          var W = e.signal, Y = function() {
            vA(R, W.reason), W.removeEventListener("abort", Y);
          };
    ...
    mA.renderToReadableStream = El, mA.version = c;
  }()), mA;
}
var jo, Tl;
Ml.env.NODE_ENV === "production" ? (jo = Vs(), Tl = Js()) : (jo = Ks(), Tl = $s());
...
}, qs = (f, c) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 32, height: 32, viewBox: "0 0 42 42", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { style: {
  fill: "none",
  strokeWidth: 2,
  strokeLinecap: "butt",
...
const ru = "data:image/svg+xml;base64,", ou = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 0 637 637", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m478 113-13 2-4 1h4l14-2c10-2 35-2 42-1l6 3 3 1c3 0-4-3-8-5-7-1-34-1-44 1m56 6 8 6c7 5 20 17 20 19s7 12 8 12l-3-6-4-6c0-3-15-17-25-24-5-3-8-4-4-1m-198 16-9 1a512 512 0 0 1 9-1m-180 30a412 412 0 0 0-23 4 167 167 0 0 0-32 8 439 439 0 0 1 46-9 304 304 0 0 1 11-2l6-1h-8m369 8 4 3-7-6c-1 0 0 2 3 3m-439 9c-7 3-18 13-18 15l6-5c5-5 9-8 14-10l6-4-8 4m442 12-10 11-7 6 7-6c7-5 14-14 13-16l-3 5M65 205l-1 11c0 9 0 10 4 17 5 10 7 12 22 11 10 0 15 0 38-5l5-1-6 1-16 2-21 2c-13 1-16-1-21-10-3-5-4-6-4-15l1-12c1-4 1-5-1-1m335 1c3 0 3 1 3 3l-2 6c-2 5-35 39-76 80-53 51-120 117-138 137-21 24-22 25-22 27 0 3 6 9 9 9 4 0 14-8 38-27a5073 5073 0 0 1 15-16 1421 1421 0 0 0-17 15l-31 25-6 2-4-3c-3-3-3-4-2-6 3-8 79-85 160-163 57-57 79-80 79-86 0-2-3-4-7-4-2 0-2 0 1 1m165 18c-9 17-25 32-57 53l-10 8 16-11 12-8c15-10 27-22 39-39 5-7 6-8 4-8l-4 5m-221 2a199 199 0 0 0-19 10 183 183 0 0 1 27-12c0-1-1-1-8 2m-34 16c-3 3-2 3 2 0l1-2-3 2m151 3-1 2 2-2c3-3 2-3-1 0m-16 12-11 10a281 281 0 0 0 11-10m-24 18-7 5-7 5-42 31c-10 7-24 19-22 19l7-6 16-12a343 343 0 0 0 35-25 573 573 0 0 0 20-17m-187 0-2 2 4-2 3-2-5 2m-14 6-3 2 4-1 4-3-5 2m-7 3-8 4-18 8 18-7 7-3 3-1c1-2 0-2-2-1m254 24a2672 2672 0 0 1-71 54 601 601 0 0 0 39-29 1352 1352 0 0 1 32-25m-291-8-2 2 4-2 3-2-5 2m-13 5-2 2h3c5-3 4-4-1-2m-19 9-7 3-13 6c-10 5-13 7-14 10-3 4-2 5 1 0 2-3 5-5 14-9l13-6 12-6-6 2m178 36c-17 12-21 16-21 17a390 390 0 0 1 20-17m-206 34 1 4 1 3 1 5 2 8 1 5v-6l-1-8-2-5-1-4-1-2c-1-2-1-2-1 0m222 23-9 7a683 683 0 0 0-56 44 261 261 0 0 0-26 20 1345 1345 0 0 0-46 34c-6 3-7 3-19 3-11 0-12 0-18-3-8-4-10-8-17-20l-5-10 4 10c5 10 12 18 19 22 4 2 6 2 17 2 13 0 14 0 21-3l26-19 42-33a2183 2183 0 0 0 43-34 643 643 0 0 1 24-20", fill: "#fff", fillRule: "evenodd" }), /* @__PURE__ */ B.createElement("path", { d: "M478 114a620 620 0 0 1-39 6l-21 3a5481 5481 0 0 0-19 3 870 870 0 0 1-54 8l-1 1-6 1-12 2-13 2a992 992 0 0 0-76 12 400 400 0 0 1-45 8l-6 1-5 1h-3l-3 1-2 1-26 4-13 2-17 3c-23 5-33 9-43 19-7 8-9 13-9 27 0 8 1 9 4 14 5 9 8 11 21 10l21-2a1133 1133 0 0 1 23-4 659 659 0 0 0 74-14l3-1h3l3-1h3l2-1 2-1h3l2-1h2l24-5 38-7a2100 2100 0 0 1 93-18l3-1 10-1a2082 2082 0 0 1 120-17l2 1c2 0 8 5 8 7l1 2 1 6c0 4 0 6-3 10-2 4-16 16-18 16l-7 5-10 8a1070 1070 0 0 0-11 7 113 113 0 0 1-20 14l-2 2-3 2-2 2h-1a154 154 0 0 1-28 21l-5 4-5 4a573 573 0 0 1-50 37 175 175 0 0 0-24 18l-1 2-2 1-2 1-2 1-1 1-12 10a396 396 0 0 0-32 25l-8 6-6 5-9 7a326 326 0 0 1-25 20l-13 12a5073 5073 0 0 0-17 15c-24 20-34 27-39 27-2 0-8-6-8-9 0-2 1-3 22-27 18-20 85-86 138-137 41-41 74-75 76-80l2-6c0-2 0-3-2-3l-7 1a233 233 0 0 1-26 9l-1 1-1 1h-1l-1 1h-2l-3 2-1 1h-2l-3 2h-1l-5 2-22 10-9 4-4 2-5 2-10 4-2 1-2 1-2 1-13 6a334 334 0 0 1-38 17 75 75 0 0 0-14 6l-5 2-4 1-2 1-3 2-7 3-16 6a247 247 0 0 0-32 14l-1 1h-2l-1 1h-2l-1 1-12 6a103 103 0 0 0-27 15l-2 5-1 1v11l1 5 1 5 1 4c0 3 0 4 2 4v3l1 3 1 2 2 10 1 4 1 5 2 10 2 8 1 4 1 4c3 3 9 25 11 38l1 7v2l1 4v1l1 1v2l1 2 1 3v1l5 10c7 13 9 16 17 20 6 3 7 3 18 3 12 0 13 0 19-3 8-4 11-6 26-18a1345 1345 0 0 1 85-67 683 683 0 0 1 50-39l12-9a513 513 0 0 1 44-33 201 201 0 0 0 22-17 2270 2270 0 0 0 73-54 158 158 0 0 0 58-59c2 0 3-9 4-27l-1-19-1-4-1-6-1-3-4-6-4-6c0-2-6-8-13-14a77 77 0 0 0-28-18c-6-1-34-1-43 1" })), ql = B.forwardRef(ou), au = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M765-321q0 117-84 196-83 80-200 80-118 0-200-80t-83-196v-392q0-85 61-144 61-58 146-58 86 0 147 58 61 59 61 144v374q0 54-39 92-39 37-93 37-55 0-93-37-38-38-38-92v-372h110v372q0 9 6 14t15 5q8 0 15-5t7-14v-374q0-39-29-66t-68-27q-40 0-69 27t-29 66v392q0 71 51 119t122 48q71 0 122-48t51-119v-426h111v426Z" })), es = B.forwardRef(au), iu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M125-165v-113h77v-273q0-93 55-167 56-75 146-100v-19q0-32 22-55 23-23 55-23t55 23q22 23 22 55v19q90 25 146 99 56 73 56 168v273h77v113H125ZM480-32q-38 0-66-27-27-27-27-66h186q0 39-27 66t-66 27Z" })), Au = B.forwardRef(iu), lu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M137-190v-113h78v-253q0-41 11-79 11-39 35-71l-9 150h10L17-802l74-74L873-92l-74 74-175-172H137Zm609-149L319-769q20-15 41-25t44-16v-28q0-32 22-54t54-22q32 0 55 22t22 54v28q85 23 137 94t52 160v217ZM481-47q-38 0-65-27t-27-65h184q0 38-27 65t-65 27Z" })), su = B.forwardRef(lu), uu = (f, c) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", ref: c, ...f }, /* @__PURE__ */ B.createElement("g", { strokeLinecap: "round", strokeWidth: 10 }, /* @__PURE__ */ B.createElement("path", { d: "m19 19 61 61M80 19 19 80" }))), cu = B.forwardRef(uu), du = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M94-136v-255l351-93-351-92v-253l816 346L94-136Z" })), fu = B.forwardRef(du), hu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M480-372q-61 0-105-43-43-43-43-105v-240q0-61 43-105 43-43 105-43 61 0 105 43 43 44 43 105v240q0 62-43 105t-105 43ZM425-76v-122q-121-16-197-108t-76-214h109q0 91 64 154t155 63q91 0 155-63t64-154h109q0 122-77 214T534-198v122H425Z" })), pu = B.forwardRef(hu), vu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m763-343-80-79q8-20 13-44 5-23 5-54h109q0 49-11 95t-36 82ZM625-482 336-770v-2q3-56 45-96t101-40q62 0 105 43t43 105v249l-1 17q-1 7-4 12ZM427-76v-122q-120-16-196-108-77-92-77-214h109q0 91 64 154t155 63q43 0 80-14 37-15 67-41l78 79q-35 32-78 53t-93 28v122H427Zm362 27L41-796l75-75 748 748-75 74Z" })), gu = B.forwardRef(vu), mu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M625-511q29 0 50-21t20-50q0-29-20-50-21-20-50-20t-50 20-20 50q0 29 20 50 21 21 50 21Zm-290 0q29 0 50-21t20-49q0-30-20-50t-50-21q-29 0-50 20-20 21-20 50 0 30 20 50 21 21 50 21Zm145 268q75 0 137-43t85-115H258q24 72 85 115 62 43 137 43Zm0 198q-90 0-170-34-79-34-138-93T79-310q-34-80-34-170t34-170q34-79 93-138t138-93q80-34 170-34t170 34q79 34 138 93t93 138q34 80 34 170t-34 170q-34 79-93 138T650-79q-80 34-170 34Zm0-435Zm0 322q134 0 228-94t94-228q0-134-94-228t-228-94q-134 0-228 94t-94 228q0 134 94 228t228 94Z" })), ts = B.forwardRef(mu), yu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M553-64v-108q107-27 173-113 67-87 67-197 0-109-67-195T553-789v-108q152 26 249 144 97 117 97 271 0 155-97 273T553-64ZM61-335v-290h176l236-237v764L237-335H61Zm492 28v-346q51 23 82 70t31 103-31 103q-31 47-82 70Z" })), wu = B.forwardRef(yu), bu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M807-15 700-123q-33 21-71 37-38 15-80 22v-108q20-4 38-12l35-17-153-154v257L234-335H57v-290h144L10-818l74-75L882-90l-75 75Zm37-264-80-79q13-30 19-60 7-31 7-64 0-109-68-195-67-86-173-112v-108q152 26 249 144 98 117 98 271 0 55-14 107-13 51-38 96ZM661-462 549-575v-78q51 23 83 70 31 47 31 103l-1 9-1 9ZM469-655 366-759l103-103v207Z" })), Su = B.forwardRef(bu), xu = "data:audio/wav;base64,", is = {
...
}, As = B.createContext({ settings: {}, setSettings: () => null }), De = () => B.useContext(As), Eu = ({
  children: f,
  settings: c = is,
  setSettings: g
}) => /* @__PURE__ */ b.jsx(As.Provider, { value: { settings: c, setSettings: g }, children: f }), ls = {
  tooltipStyle: {},
...
}, ss = B.createContext({ styles: {}, setStyles: () => null }), Ye = () => B.useContext(ss), Cu = ({
  children: f,
  styles: c = ls,
  setStyles: g
}) => /* @__PURE__ */ b.jsx(ss.Provider, { value: { styles: c, setStyles: g }, children: f }), Du = ({ buttons: f }) => {
  var c, g, y, A, w;
  const { settings: P } = De(), { styles: C } = Ye(), m = {
    backgroundImage: `linear-gradient(to right, ${(c = P.general) == null ? void 0 : c.secondaryColor},
			${(g = P.general) == null ? void 0 : g.primaryColor})`,
    ...C.headerStyle
  };
  return /* @__PURE__ */ b.jsxs("div", { style: m, className: "rcb-chat-header-container", children: [
    /* @__PURE__ */ b.jsxs("div", { className: "rcb-chat-header", children: [
      ((y = P.header) == null ? void 0 : y.showAvatar) && /* @__PURE__ */ b.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ b.jsx("div", { className: "rcb-chat-header", children: f == null ? void 0 : f.map(
      (x, H) => /* @__PURE__ */ b.jsx(B.Fragment, { children: x }, H)
    ) })
  ] });
}, us = B.createContext({}), bt = () => B.useContext(us), Pu = ({
  children: f,
  botIdRef: c,
  flowRef: g
}) => {
  const y = B.useRef(null), A = B.useRef(""), w = B.useRef(/* @__PURE__ */ new Map()), P = B.useRef(null), C = B.useRef(""), m = B.useRef(!1), x = B.useRef(null), H = B.useRef(null), k = B.useRef(null);
  return /* @__PURE__ */ b.jsx(us.Provider, { value: {
    botIdRef: c,
    flowRef: g,
    inputRef: y,
    streamMessageMap: w,
...
}, cs = B.createContext({}), gt = () => B.useContext(cs), Bu = ({
  children: f,
  settings: c
}) => {
  var g, y, A, w, P, C;
  const [m, x] = B.useState(!1), [H, k] = B.useState(((g = c == null ? void 0 : c.chatWindow) == null ? void 0 : g.defaultOpen) ?? !1), [F, U] = B.useState(((y = c == null ? void 0 : c.audio) == null ? void 0 : y.defaultToggledOn) ?? !1), [L, _] = B.useState(((A = c == null ? void 0 : c.voice) == null ? void 0 : A.defaultToggledOn) ?? !1), [j, T] = B.useState(
    ((w = c == null ? void 0 : c.notification) == null ? void 0 : w.defaultToggledOn) ?? !0
  ), [K, te] = B.useState(!1), [X, G] = B.useState(!1), [$, Z] = B.useState(!0), [re, ne] = B.useState(!1), [ue, ae] = B.useState(!1), [ce, ve] = B.useState(!1), [de, Me] = B.useState(0), [Ce, ee] = B.useState(0), [le, fe] = B.useState(!1), [be, oe] = B.useState(null), [me, Oe] = B.useState(((P = window.visualViewport) == null ? void 0 : P.height) ?? window.innerHeight), [Se, Ae] = B.useState(((C = window.visualViewport) == null ? void 0 : C.width) ?? window.innerWidth);
  return /* @__PURE__ */ b.jsx(cs.Provider, { value: {
    isBotTyping: m,
    setIsBotTyping: x,
    isChatWindowOpen: H,
  ...
  var f, c, g;
  const { settings: y } = De(), { styles: A } = Ye(), { unreadCount: w, isScrolling: P, setIsScrolling: C } = gt(), { chatBodyRef: m } = bt(), [x, H] = B.useState(!1), k = {
    color: (f = y.general) == null ? void 0 : f.primaryColor,
    borderColor: (c = y.general) == null ? void 0 : c.primaryColor,
  ...
  function L(j) {
    if (!m.current)
      return;
    const T = m.current.scrollTop, K = m.current.scrollHeight - m.current.clientHeight - T, te = 20;
    let X = 0;
    function G() {
      if (!m.current)
        return;
      X += te;
      const $ = _(X, T, K, j);
      m.current.scrollTop = $, X < j ? requestAnimationFrame(G) : C(!1);
    }
    G();
  }
  ...
  return /* @__PURE__ */ b.jsx("div", { className: `rcb-message-prompt-container ${(() => {
    var j;
    return m.current && ((j = y.chatWindow) != null && j.showMessagePrompt) && P && w > 0 ? "visible" : "hidden";
  })()}`, children: /* @__PURE__ */ b.jsx(
    "div",
    {
      onMouseEnter: F,
      onMouseLeave: U,
      style: x ? k : A.chatMessagePromptStyle,
      onMouseDown: (j) => {
        j.preventDefault(), L(600);
      },
      className: "rcb-message-prompt-text",
      children: (g = y.chatWindow) == null ? void 0 : g.messagePromptText
    }
  ) });
}, SA = () => {
  try {
  ...
  return y.data = g, window.dispatchEvent(y), y;
}, ds = B.createContext({ paths: [], setPaths: () => null }), Ol = () => B.useContext(ds), Iu = ({ children: f }) => {
  const [c, g] = B.useState([]);
  return /* @__PURE__ */ b.jsx(ds.Provider, { value: { paths: c, setPaths: g }, children: f });
}, DA = () => {
  ...
  } = gt(), { botIdRef: m } = bt(), x = B.useCallback(() => c.length > 0 ? c[c.length - 1] : null, [c]), H = B.useCallback(() => c.length > 1 ? c[c.length - 2] : null, [c]), k = B.useCallback((F) => {
    var U, L;
    if ((U = f.event) != null && U.rcbChangePath) {
      const _ = x(), j = H(), T = { botId: m.current, currPath: _, prevPath: j };
      if (event = xA(Ee.CHANGE_PATH, T, { currPath: _, prevPath: j, nextPath: F }), event.defaultPrevented)
        return !1;
    }
    return y(!0), (L = f.chatInput) != null && L.blockSpam && A(!0), w(!1), g((_) => [..._, F]), !0;
  }, [c, g, f]);
  return {
    getCurrPath: x,
    getPrevPath: H,
  ...
  const { getCurrPath: f, getPrevPath: c, paths: g } = Ru(), { botIdRef: y } = bt();
  return { callRcbEvent: B.useCallback((A, w) => {
    const P = { botId: y.current, currPath: f(), prevPath: c() };
    return xA(A, P, w);
  }, [g]) };
}, fs = B.createContext({ toasts: [], setToasts: () => null }), hs = () => B.useContext(fs), Mu = ({ children: f }) => {
  const [c, g] = B.useState([]);
  return /* @__PURE__ */ b.jsx(fs.Provider, { value: { toasts: c, setToasts: g }, children: f });
}, PA = () => {
  const { settings: f } = De(), { toasts: c, setToasts: g } = hs(), { callRcbEvent: y } = Wn(), A = B.useRef(c);
  B.useEffect(() => {
    A.current = c;
  }, [c]);
  const w = B.useCallback((C, m) => {
    var x, H, k, F;
    let U = null;
    if (A.current.length >= (((x = f.toast) == null ? void 0 : x.maxCount) ?? 3)) {
      if ((H = f.toast) != null && H.forbidOnMax)
        return null;
      U = SA();
      let _ = { id: U, content: C, timeout: m };
      if ((k = f.event) != null && k.rcbShowToast) {
        const j = y(Ee.SHOW_TOAST, { toast: _ });
    ...
    U = SA();
    let L = { id: U, content: C, timeout: m };
    if ((F = f.event) != null && F.rcbShowToast) {
      const _ = y(Ee.SHOW_TOAST, { toast: L });
      if (_.defaultPrevented)
        return null;
      L = _.data.toast;
    }
    return g((_) => [..._, L]), U;
  }, [f, y, g]), P = B.useCallback((C) => {
    var m;
    const x = c.find((H) => H.id === C);
    return !x || (m = f.event) != null && m.rcbDismissToast && y(Ee.DISMISS_TOAST, { toast: x }).defaultPrevented ? null : (g((H) => H.filter((k) => k.id !== C)), C);
  }, [y, g]);
  return {
    showToast: w,
    dismissToast: P,
  ...
  var y, A;
  const { settings: w } = De(), { styles: P } = Ye(), { dismissToast: C } = PA(), [m, x] = B.useState(!1), H = {
  ...
  }, [f, C, g]), typeof c == "string" ? /* @__PURE__ */ b.jsx(
    "div",
    {
      onMouseEnter: () => {
        x(!0);
      ...
      style: m ? H : P.toastPromptStyle,
      onMouseDown: (k) => {
        var F;
        (F = w.toast) != null && F.dismissOnClick && (k.preventDefault(), C(f));
      },
  ...
  const { settings: f } = De(), {
    ...
    setViewportWidth: P,
    setUnreadCount: C
  } = gt(), { callRcbEvent: m } = Wn(), [x, H] = B.useState(0), k = B.useCallback(() => {
    var U;
    (U = f.event) != null && U.rcbToggleChatWindow && m(
      Ee.TOGGLE_CHAT_WINDOW,
      { currState: c, newState: !c }
    ).defaultPrevented || g((L) => (L || C(0), !L));
  }, []), F = B.useCallback((U) => {
    c !== U && k();
  }, [c]);
  return {
...
}, ps = B.createContext({ messages: [], setMessages: () => null }), jl = () => B.useContext(ps), Ou = ({ children: f }) => {
  const [c, g] = B.useState([]);
  return /* @__PURE__ */ b.jsx(ps.Provider, { value: { messages: c, setMessages: g }, children: f });
}, ju = ({
  setChatScrollHeight: f
}) => {
  var c, g, y, A, w, P, C, m, x, H, k, F;
  const { settings: U } = De(), { styles: L } = Ye(), { messages: _ } = jl(), { toasts: j } = hs(), { isChatWindowOpen: T } = vr(), {
    isBotTyping: K,
    isScrolling: te,
    setIsScrolling: X,
    setUnreadCount: G
    ...
    color: "#fff",
    maxWidth: (y = U.userBubble) != null && y.showAvatar ? "65%" : "70%",
    ...L.userBubbleStyle
    ...
    ...L.botBubbleStyle
  }, ae = (C = U.botBubble) != null && C.animate ? "rcb-bot-message-entry" : "", ce = {
    bottom: 20,
    width: 300,
    minWidth: (((m = L.chatWindowStyle) == null ? void 0 : m.width) ?? 375) / 2,
    maxWidth: (((x = L.chatWindowStyle) == null ? void 0 : x.width) ?? 375) - 50,
  ...
  var y, A, w, P, C, m, x, H, k, F, U;
  const { settings: L } = De(), { styles: _ } = Ye(), { paths: j } = Ol(), { handleSubmitText: T } = La(), [K, te] = B.useState(/* @__PURE__ */ new Set()), [X, G] = B.useState(!1), $ = {
    cursor: X ? `url(${(y = L.general) == null ? void 0 : y.actionDisabledIcon}), auto` : "pointer",
    ...
    color: (C = L.general) == null ? void 0 : C.primaryColor,
    borderColor: (m = L.general) == null ? void 0 : m.primaryColor,
    ..._.botCheckboxNextStyle
  }, re = {
    cursor: X ? `url(${(x = L.general) == null ? void 0 : x.actionDisabledIcon}), auto` : "pointer",
    color: "transparent",
    ..._.botCheckMarkStyle
  }, ne = {
  ...
  if (!A)
    return;
  let w;
  if (typeof A == "function" ? (w = A(y), w instanceof Promise && (w = await w)) : w = A, Array.isArray(w) && (w = { items: w }), !("items" in w) || w.items.length == 0)
    return;
  w.min == null && (w.min = 1), w.max == null && (w.max = w.items.length), w.min > w.max && (w.min = w.max), w.reusable == null && (w.reusable = !1);
  const P = /* @__PURE__ */ b.jsx(Fu, { checkboxes: w, checkedItems: /* @__PURE__ */ new Set(), path: g });
  await y.injectMessage(P);
}, Hu = async (f, c) => {
  const g = f.function;
  if (!g)
    return;
  ...
  let y = g(c);
  y instanceof Promise && (y = await y), y && y.trim() !== "" && await c.injectMessage(y);
}, Uu = ({
  options: f,
  path: c
}) => {
  var g, y, A, w, P, C;
  const { settings: m } = De(), { styles: x } = Ye(), { paths: H } = Ol(), { handleSubmitText: k } = La(), [F, U] = B.useState([]), [L, _] = B.useState(!1), j = {
    cursor: L ? `url(${(g = m.general) == null ? void 0 : g.actionDisabledIcon}), auto` : "pointer",
    color: (y = m.general) == null ? void 0 : y.primaryColor,
    borderColor: (A = m.general) == null ? void 0 : A.primaryColor,
    backgroundColor: "#fff",
    ...x.botOptionStyle
  }, T = {
    color: "#fff",
    borderColor: (w = m.general) == null ? void 0 : w.primaryColor,
    backgroundColor: (P = m.general) == null ? void 0 : P.primaryColor,
  ...
  return /* @__PURE__ */ b.jsx("div", { className: `rcb-options-container ${(C = m.botBubble) != null && C.showAvatar ? "rcb-options-offset" : ""}`, children: f.items.map((X, G) => {
    const $ = F[G] && !L;
    return /* @__PURE__ */ b.jsx(
      "div",
      {
        ...
        onMouseDown: (Z) => {
          ...
          _(!f.reusable);
          let ne;
          f.sendOutput != null ? ne = f.sendOutput : ne = ((re = m.chatInput) == null ? void 0 : re.sendOptionOutput) ?? !0, k(X, ne);
        },
        children: X
      },
      X
  ...
  const P = /* @__PURE__ */ b.jsx(Uu, { options: w, path: g });
  await y.injectMessage(P);
}, Wu = async (f, c, g) => {
  const y = f.path;
  if (!y)
  ...
  let C;
  if (typeof P == "function" ? (C = P(g), C instanceof Promise && (C = await C)) : C = P, typeof C == "number" && (C = { duration: C }), !C || C instanceof Promise || C.duration == null || typeof C.duration != "number")
    return;
  ...
  if (y == null)
    return;
  let A;
  typeof y == "function" ? (A = y(g), A instanceof Promise && (A = await A)) : A = y, c(A);
}, vs = async (f, c, g) => {
  ...
  for (const P of w)
    P === "function" && await Hu(A, g);
  return w.includes("path") ? await Wu(A, g, y) : !1;
}, Xu = (f) => {
  const c = [];
  let g = "", y = !1;
  for (let A = 0; A < f.length; A++) {
    const w = f[A];
    w === "<" ? y ? (c.push(g), g = w) : (y = !0, g = w) : w === ">" ? (g += w, c.push(g), g = "", y = !1) : y ? g += w : c.push(w);
  }
  return g !== "" && c.push(g), c;
}, Vu = (f) => typeof window.DOMParser < "u" ? new DOMParser().parseFromString(f, "text/html").body.textContent || "" : f.replace(/<\/?[^>]+(>|$)/g, ""), Ju = (f, c, g, y, A) => {
  const w = new SpeechSynthesisUtterance();
  w.text = f, w.lang = c, w.rate = y, w.volume = A;
  let P = !1;
  for (const C of g)
    if (window.speechSynthesis.getVoices().find((m) => {
      if (m.name === C) {
        w.voice = m, window.speechSynthesis.speak(w), P = !0;
        return;
      }
    }), P)
      break;
  ...
  var w, P, C, m, x, H;
  if ((w = f.audio) != null && w.disabled || y.sender === "user" || typeof y.content != "string" || !g && !((P = f.general) != null && P.embedded) || !c || y.content.trim() === "")
    return;
  let k = y.content;
  A && (k = Vu(y.content)), Ju(
    k,
    (C = f.audio) == null ? void 0 : C.language,
    (m = f.audio) == null ? void 0 : m.voiceNames,
  ...
  var f;
  const { settings: c } = De(), { styles: g } = Ye(), y = {
    borderTop: `4px solid ${(f = c.general) == null ? void 0 : f.primaryColor}`,
    ...g.loadingSpinnerStyle
  };
  return /* @__PURE__ */ b.jsx("div", { className: "rcb-spinner-container", children: /* @__PURE__ */ b.jsx("div", { style: y, className: "rcb-spinner" }) });
}, Oo = (f, c) => ({
  id: SA(),
  content: f,
  sender: c,
...
let ms = !1, Il = "rcb-history", yA = 30, ys = !1, EA = [];
const wA = async (f) => {
  if (ys)
    return;
  const c = [], g = ms ? EA.length : 0;
  for (let A = f.length - 1; A >= g; A--) {
    const w = f[A];
    if (w.sender === "system" || (w.content !== "" && c.unshift(w), c.length === yA))
      break;
  }
  let y = c.map(oc);
  if (y.length < yA) {
  ...
  var c, g, y;
  Il = (c = f.chatHistory) == null ? void 0 : c.storageKey, yA = (g = f.chatHistory) == null ? void 0 : g.maxEntries, ys = (y = f.chatHistory) == null ? void 0 : y.disabled, EA = ec(localStorage.getItem(Il));
}, oc = (f) => B.isValidElement(f.content) ? structuredClone({
  id: f.id,
  ...
  if (ms = !0, g != null)
    try {
      y((x) => {
        const H = Oo(/* @__PURE__ */ b.jsx(qu, {}), "system");
        return x.shift(), [H, ...x];
      });
      const m = g.map((x) => {
        if (x.type === "object") {
          const H = ws(x.content, f, c);
          return { ...x, content: H };
        }
        return x;
      });
      setTimeout(() => {
        y((x) => {
          ...
          x.shift();
          let k;
          return (H = f.chatHistory) != null && H.autoLoad ? k = Oo(/* @__PURE__ */ b.jsx(b.Fragment, {}), "system") : k = Oo(/* @__PURE__ */ b.jsx($u, {}), "system"), [...m, k, ...x];
        });
      }, 500), setTimeout(() => {
        if (!A.current)
          return;
        const { scrollHeight: x } = A.current, H = x - w;
  ...
  return Array.from(y.body.childNodes).map((A, w) => {
    var P;
    if (A.nodeType === Node.TEXT_NODE)
      return A.textContent;
    {
      const C = A.tagName.toLowerCase();
      let m = Array.from(A.attributes).reduce((H, k) => {
        ...
        if (F === "style") {
          ...
          (C === "audio" || C === "video") && F === "controls" && k.value === "" ? H[F] = "true" : H[F] = k.value;
        return H;
      }, {});
      const x = A.classList;
      if ((P = c.botBubble) != null && P.showAvatar && (m = ic(x, m)), m = Ac(x, m, c, g), m = lc(x, m, c, g), m = sc(x, m, c, g), m = uc(x, m, c, g), [
        "area",
        "base",
        "br",
        "col",
        ...
        return B.createElement(C, { key: w, ...m });
      {
        const H = ws(A.innerHTML, c, g);
        return B.createElement(C, { key: w, ...m }, ...H);
      }
    }
  });
}, ic = (f, c) => ((f.contains("rcb-options-container") || f.contains("rcb-checkbox-container")) && (Object.prototype.hasOwnProperty.call(c, "class") ? c.class = `${f.toString()} rcb-options-offset` : c.class = "rcb-options-offset"), c), Ac = (f, c, g, y) => {
  var A, w, P, C, m;
  return f.contains("rcb-options") && (c.style = {
    ...c.style,
    color: ((A = y.botOptionStyle) == null ? void 0 : A.color) ?? ((w = g.general) == null ? void 0 : w.primaryColor),
    borderColor: ((P = y.botOptionStyle) == null ? void 0 : P.color) ?? ((C = g.general) == null ? void 0 : C.primaryColor),
    cursor: `url(${(m = g.general) == null ? void 0 : m.actionDisabledIcon}), auto`,
    ...y.botOptionStyle
  }), c;
}, lc = (f, c, g, y) => {
  var A, w, P, C, m;
  return f.contains("rcb-checkbox-row-container") && (c.style = {
    ...c.style,
    color: ((A = y.botCheckboxRowStyle) == null ? void 0 : A.color) ?? ((w = g.general) == null ? void 0 : w.primaryColor),
    borderColor: ((P = y.botCheckboxRowStyle) == null ? void 0 : P.color) ?? ((C = g.general) == null ? void 0 : C.primaryColor),
    cursor: `url(${(m = g.general) == null ? void 0 : m.actionDisabledIcon}), auto`,
  ...
  return f.contains("rcb-checkbox-next-button") && (c.style = {
    ...c.style,
    color: ((A = y.botCheckboxNextStyle) == null ? void 0 : A.color) ?? ((w = g.general) == null ? void 0 : w.primaryColor),
    borderColor: ((P = y.botCheckboxNextStyle) == null ? void 0 : P.color) ?? ((C = g.general) == null ? void 0 : C.primaryColor),
    cursor: `url(${(m = g.general) == null ? void 0 : m.actionDisabledIcon}), auto`,
  ...
  if (!f)
    return !1;
  const c = f.getBoundingClientRect(), g = window.innerHeight ?? document.documentElement.clientHeight, y = window.innerWidth ?? document.documentElement.clientWidth;
  return c.top >= 0 && c.left >= 0 && c.bottom <= g && c.right <= y;
}, Fl = () => {
  const { settings: f } = De(), {
    ...
    unreadCount: A,
    setUnreadCount: w
  } = gt(), { audioBufferRef: P, audioContextRef: C, gainNodeRef: m } = bt(), { callRcbEvent: x } = Wn(), H = B.useCallback(async () => {
    var U, L;
    const _ = (U = f.notification) == null ? void 0 : U.sound;
    C.current = new AudioContext();
    const j = C.current.createGain();
    j.gain.value = ((L = f.notification) == null ? void 0 : L.volume) ?? 0.2, m.current = j;
    let T;
    ...
    P.current = await C.current.decodeAudioData(T);
  }, [f.notification]), k = B.useCallback(() => {
    var U;
    if ((U = f.notification) != null && U.disabled || !c || !y || !C.current || !P.current)
      return;
    const L = C.current.createBufferSource();
    L.buffer = P.current, L.connect(m.current).connect(C.current.destination), L.start();
  }, [
    f.notification,
    c,
    y,
    ...
    var U;
    (U = f.event) != null && U.rcbToggleNotifications && x(
  ...
  const { settings: A } = De(), { messages: w, setMessages: P } = jl(), {
    ...
    setIsBotTyping: H,
    setUnreadCount: k
  } = gt(), { streamMessageMap: F, chatBodyRef: U } = bt(), { callRcbEvent: L } = Wn(), { playNotificationSound: _ } = Fl(), j = B.useCallback(async (Z, re, ne) => {
    H(!1), P((ve) => {
      const de = [...ve, Z];
      return $(de), de;
    ...
    let le = !1;
    re === "bot" ? le = (ue = A.botBubble) == null ? void 0 : ue.dangerouslySetInnerHtml : re === "user" && (le = (ae = A.userBubble) == null ? void 0 : ae.dangerouslySetInnerHtml), Ku(A, C, m, ee, le);
    ...
    return ee.id;
  }, [A, C, m, L, j]), K = B.useCallback(async (Z) => {
    var re;
  ...
  }, [L, (c = A.event) == null ? void 0 : c.rcbChunkStreamMessage, (g = A.event) == null ? void 0 : g.rcbStartStreamMessage, F]), X = B.useCallback(async (Z = "bot") => {
    var re;
    if (!F.current.has(Z))
      return !0;
    const ne = F.current.get(Z), ue = w.find((ae) => ae.id === ne);
    return (re = A.event) != null && re.rcbStopStreamMessage && L(Ee.STOP_STREAM_MESSAGE, { messageToEndStreamFor: ue }).defaultPrevented ? !1 : (F.current.delete(Z), wA(w), !0);
  }, [L, w, (y = A.event) == null ? void 0 : y.rcbStopStreamMessage, F]), G = (Z) => {
    $(Z), P(Z);
  }, $ = (Z) => {
    var re, ne;
    wA(Z);
    let ue = !0;
    (Z.length === 0 || m && !x) && (ue = !1), (re = A.general) != null && re.embedded && bs(U.current) && (ue = !1);
    const ae = Z[Z.length - 1];
    (!ae || ae.sender === "user") && (ue = !1), ue && _(), ((ne = A.chatWindow) != null && ne.autoJumpToBottom || !x) && setTimeout(() => {
...
const Ll = () => {
  ...
  var C;
  (C = f.voice) != null && C.sendAsAudio ? fc(g, w) : dc(
    f,
    c,
    g,
    y,
  ...
  if (!Vr)
    try {
      Vr = !0, x.lang = (P = f.voice) == null ? void 0 : P.language, x.start();
    } catch {
    }
  const H = (C = f.voice) == null ? void 0 : C.timeoutPeriod, k = (m = f.voice) == null ? void 0 : m.autoSendPeriod;
  x.onresult = (F) => {
    var U, L;
    clearTimeout(Un), Un = null, clearTimeout(bA);
    const _ = F.results[F.results.length - 1][0].transcript;
    if (w.current) {
      const j = (U = f.chatInput) == null ? void 0 : U.characterLimit, T = w.current.value + _;
      j != null && j >= 0 && T.length > j ? y(T.slice(0, j)) : y(T), A(w.current.value.length);
    }
    Un = setTimeout(() => Bl(c, w), H), (L = f.voice) != null && L.autoSendDisabled || (bA = setTimeout(g, k));
  }, x.onend = () => {
    Vr ? (x.start(), Un || (Un = setTimeout(() => Bl(c, w), H))) : (clearTimeout(Un), Un = null, clearTimeout(bA));
  }, Un = setTimeout(() => Bl(c, w), H);
}, fc = (f, c) => {
  navigator.mediaDevices.getUserMedia({ audio: !0 }).then((g) => {
    ...
    zn.ondataavailable = (y) => {
      c.current && c.current.push(y.data);
    }, zn.onstop = () => {
      f(), g.getTracks().forEach((y) => y.stop());
    };
  }).catch((g) => {
  ...
  const f = Ll();
  f && (Vr = !1, f && f.stop(), zn && zn.state !== "inactive" && (zn.stop(), zn = null), clearTimeout(Un), Un = null, clearTimeout(bA));
}, hc = (f, c) => {
  var g, y, A;
  const w = Ll();
  (g = c.voice) != null && g.disabled || !((y = c.chatInput) != null && y.blockSpam) || !w || (f && !Vr ? (Vr = !0, (A = c.voice) != null && A.sendAsAudio ? zn == null || zn.start() : w.start()) : f || Hl());
}, Bl = (f, c) => {
  var g;
  (g = c.current) != null && g.disabled || f(), Hl();
}, Nl = () => {
  const { settings: f } = De(), { voiceToggledOn: c, setVoiceToggledOn: g } = gt(), { callRcbEvent: y } = Wn(), A = B.useCallback(() => {
    var P;
    (P = f.event) != null && P.rcbToggleVoice && y(Ee.TOGGLE_VOICE, { currState: c, newState: !c }).defaultPrevented || g((C) => !C);
  }, []), w = B.useCallback((P) => {
    hc(P, f);
  }, [f]);
  return {
  ...
  const { settings: f } = De(), {
  ...
  } = gt(), { inputRef: C, chatBodyRef: m, prevInputRef: x } = bt(), { callRcbEvent: H } = Wn(), k = (_) => {
    var j, T, K;
    if (y && C.current) {
      C.current.value = "";
      return;
    ...
    if (C.current && x.current !== null) {
      ...
      if (te != null && te >= 0 && X.length > te ? C.current.value = X.slice(0, te) : C.current.value = X, (K = f.event) != null && K.rcbTextAreaChangeValue && H(
    ...
    (j = C.current) != null && j.disabled || setTimeout(() => {
      var T, K, te;
      (T = f.general) != null && T.embedded ? bs(m == null ? void 0 : m.current) && ((K = C.current) == null || K.focus()) : _ !== "start" && ((te = C.current) == null || te.focus());
    }, 100);
  }, []), U = B.useCallback(() => {
    !y && C.current && C.current.focus();
  }, [y]), L = B.useCallback(() => C && C.current ? C.current.value : "", []);
  return {
    textAreaDisabled: y,
    setTextAreaDisabled: A,
    textAreaSensitiveMode: w,
  ...
  var f, c, g, y;
  const { settings: A } = De(), { endStreamMessage: w, injectMessage: P, removeMessage: C, streamMessage: m } = BA(), { getCurrPath: x, getPrevPath: H, goToPath: k } = DA(), {
    timeoutId: F,
    voiceToggledOn: U,
    ...
    setInputLength: te
  } = gt(), { flowRef: X, chatBodyRef: G, inputRef: $, keepVoiceOnRef: Z, paramsInputRef: re } = bt(), { showToast: ne, dismissToast: ue } = PA(), { callRcbEvent: ae } = Wn(), { syncVoice: ce } = Nl(), { setTextAreaValue: ve } = Fa(), { openChat: de } = vr(), Me = B.useCallback(async (ee) => {
    var le, fe, be;
    const oe = x();
    if (!(!oe || !X.current[oe])) {
      if (_) {
  ...
  }, [X, x, A, P, _]), Ce = B.useCallback(async (ee, le, fe = !0) => {
    var be, oe;
    le = le.trim(), le !== "" && (fe && await Me(le), F && clearTimeout(F), re.current = le, G.current && (G.current.scrollTop = G.current.scrollHeight), $.current && (ve(""), te(0)), (be = A.chatInput) != null && be.blockSpam && j(!0), Z.current = U, ce(!1), setTimeout(() => {
      ...
      if (!await gs(X.current, ee, Oe, k)) {
        ...
        if (!Ae)
          return;
        Ae.chatDisabled || j((me = A.chatInput) == null ? void 0 : me.disabled), vs(Ae, L, Oe), K(typeof Ae.file == "function"), ce(Z.current), T(!1);
      }
  ...
  return { handleSubmitText: B.useCallback(async (ee, le = !0) => {
    ...
    const oe = x();
    oe && Ce(oe, ee, le);
  }, [ae, x, Ce, $, (y = A.event) == null ? void 0 : y.rcbUserSubmitText]) };
}, kA = () => {
  var f;
  const { settings: c } = De();
  return B.useMemo(() => {
    ...
    if (!((g = c.device) != null && g.applyMobileOptimizations))
      return !0;
    const y = navigator.userAgent, A = !/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(y), w = window.innerWidth >= 768;
    return A && w;
  }, [(f = c.device) == null ? void 0 : f.applyMobileOptimizations]);
}, pc = ({ buttons: f }) => {
  var c, g, y, A, w, P, C, m, x, H, k;
  const F = kA(), { settings: U } = De(), { styles: L } = Ye(), {
    textAreaDisabled: _,
  ...
  }, ee = _ ? (y = U.chatInput) == null ? void 0 : y.disabledPlaceholderText : (A = U.chatInput) == null ? void 0 : A.enabledPlaceholderText, le = () => {
    _ || Z(!0);
  }, fe = () => {
    Z(!1);
  }, be = () => {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ b.jsxs("div", { className: "rcb-chat-input-button-container", children: [
          ...
          ((C = U.chatInput) == null ? void 0 : C.showCharacterCount) && ((m = U.chatInput) == null ? void 0 : m.characterLimit) != null && ((x = U.chatInput) == null ? void 0 : x.characterLimit) > 0 && /* @__PURE__ */ b.jsxs(
            "div",
            {
  ...
  var c;
  const { settings: g } = De(), { styles: y } = Ye();
  return /* @__PURE__ */ b.jsxs("div", { "data-testid": "chatbot-footer-container", style: y.footerStyle, className: "rcb-chat-footer-container", children: [
  ...
  var f, c, g, y, A, w, P;
  const { settings: C } = De(), { styles: m } = Ye(), { unreadCount: x } = gt(), { isChatWindowOpen: H, toggleChatWindow: k } = vr(), F = {
    backgroundImage: `linear-gradient(to right, ${(f = C.general) == null ? void 0 : f.secondaryColor},
			${(c = C.general) == null ? void 0 : c.primaryColor})`,
    ...m.chatButtonStyle
  }, U = {
    backgroundImage: `url(${(g = C.chatButton) == null ? void 0 : g.icon})`,
    fill: "#fff",
    width: 75,
    height: 75,
    ...m.chatIconStyle
    ...
    var _;
    const j = (_ = C.chatButton) == null ? void 0 : _.icon;
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: !((y = C.general) != null && y.embedded) && /* @__PURE__ */ b.jsxs(
    "div",
    {
      ...
      children: [
        L(),
        !((w = C.notification) != null && w.disabled) && ((P = C.notification) == null ? void 0 : P.showCount) && /* @__PURE__ */ b.jsx("span", { style: m.notificationBadgeStyle, className: "rcb-badge", children: x })
      ]
    }
  ) });
}, mc = () => {
  var f, c, g, y;
  const A = kA(), { settings: w } = De(), { styles: P } = Ye(), { isChatWindowOpen: C, openChat: m } = vr(), [x, H] = B.useState(!1), [k, F] = B.useState(!1), [U, L] = B.useState(0);
  B.useEffect(() => {
    var T, K, te;
    ...
    if (X === "ALWAYS")
      if (A) {
        let G;
        C ? G = (((K = P.chatWindowStyle) == null ? void 0 : K.width) ?? 375) - (((te = P.chatButtonStyle) == null ? void 0 : te.width) ?? 75) : G = 0, L(G), H(!0);
      } else
        H(!C);
    else
      X === "NEVER" ? H(!1) : X === "START" ? k ? H(!1) : (F(!0), H(!0)) : X === "CLOSE" && H(!C);
  }, [C]);
  const _ = {
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: !((g = w.general) != null && g.embedded) && /* @__PURE__ */ b.jsxs(
    "div",
    {
      ...
      onClick: () => m(!0),
      children: [
        /* @__PURE__ */ b.jsx("span", { children: (y = w.tooltip) == null ? void 0 : y.text }),
  ...
  var y, A, w;
  const { settings: P } = De(), { styles: C } = Ye(), m = {
    backgroundColor: (y = P.general) == null ? void 0 : y.primaryColor,
  ...
  if (!["image", "video", "audio"].includes(c))
    return { fileType: null, fileUrl: null };
  try {
    const g = await new Promise((y, A) => {
      const w = new FileReader();
      w.onload = () => y(w.result), w.onerror = () => A(new Error("File reading failed")), w.readAsDataURL(f);
    });
  ...
  var f, c, g, y, A, w;
  const { settings: P } = De(), { styles: C } = Ye(), { injectMessage: m, streamMessage: x, removeMessage: H, endStreamMessage: k } = BA(), { getCurrPath: F, getPrevPath: U, goToPath: L, blockAllowsAttachment: _ } = DA(), { flowRef: j, inputRef: T } = bt(), K = j.current, { showToast: te, dismissToast: X } = PA(), { callRcbEvent: G } = Wn(), { openChat: $ } = vr(), { setTextAreaValue: Z } = Fa(), { handleSubmitText: re } = La(), ne = {
    ...
    if (me != null) {
      ...
      for (let Se = 0; Se < fe.length; Se++) {
        if (Oe.push(fe[Se].name), !((Ce = P.fileAttachment) != null && Ce.showMediaDisplay))
          continue;
        const Ae = await xs(fe[Se]);
        !Ae.fileType || !Ae.fileUrl || await m(/* @__PURE__ */ b.jsx(
          Ss,
          {
            file: fe[Se],
  ...
  return /* @__PURE__ */ b.jsxs(
    "label",
    {
      "aria-label": ((y = P.ariaLabel) == null ? void 0 : y.fileAttachmentButton) ?? "upload file",
      role: "button",
      className: _ ? "rcb-attach-button-enabled" : "rcb-attach-button-disabled",
      style: _ ? C.fileAttachmentButtonStyle : ne,
      children: [
        /* @__PURE__ */ b.jsx(
          "input",
          {
  ...
  var f, c, g, y, A, w;
  const { settings: P } = De(), { styles: C } = Ye(), { inputRef: m } = bt(), { textAreaDisabled: x, setTextAreaValue: H } = Fa(), k = B.useRef(null), F = B.useRef(null), [U, L] = B.useState(!1), _ = {
    cursor: `url(${(f = P.general) == null ? void 0 : f.actionDisabledIcon}), auto`,
    ...C.emojiButtonStyle,
    // by default inherit the base style
  ...
  const K = (G, $) => {
    G.preventDefault(), m.current && (H(m.current.value + $), setTimeout(() => {
      const Z = m.current;
      if (Z) {
        Z.focus();
    ...
    G.preventDefault(), L(x ? !1 : !U);
  }, X = () => {
    var G, $;
    const Z = x ? (G = P.emoji) == null ? void 0 : G.iconDisabled : ($ = P.emoji) == null ? void 0 : $.icon;
    ...
    ) : Z && /* @__PURE__ */ b.jsx("span", { className: `${x ? "rcb-emoji-icon-disabled" : "rcb-emoji-icon-enabled"}`, children: /* @__PURE__ */ b.jsx(Z, { style: x ? T : j }) });
  };
  return /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
    /* @__PURE__ */ b.jsx(
      "div",
      {
        "aria-label": ((y = P.ariaLabel) == null ? void 0 : y.emojiButton) ?? "emoji picker",
        role: "button",
        ref: F,
        className: `${x ? "rcb-emoji-button-disabled" : "rcb-emoji-button-enabled"}`,
        style: x ? _ : C.emojiButtonStyle,
        onMouseDown: te,
        children: X()
      }
    ),
  ...
  const { settings: f } = De(), { audioToggledOn: c, setAudioToggledOn: g } = gt(), { callRcbEvent: y } = Wn(), A = B.useCallback(() => {
    var w;
    (w = f.event) != null && w.rcbToggleAudio && y(Ee.TOGGLE_AUDIO, { currState: c, newState: !c }).defaultPrevented || g((P) => !P);
  }, []);
  return {
    audioToggledOn: c,
    toggleAudio: A
  ...
  var f, c, g;
  const { settings: y } = De(), { styles: A } = Ye(), { audioToggledOn: w, toggleAudio: P } = bc(), C = {
    backgroundImage: `url(${(f = y.audio) == null ? void 0 : f.icon})`,
    fill: "#fcec3d",
    ...A.audioIconStyle
  }, m = {
    backgroundImage: `url(${(c = y.audio) == null ? void 0 : c.iconDisabled})`,
    fill: "#e8eaed",
    ...A.audioIconStyle,
    // by default inherit the base style
    ...
    var H, k;
    const F = w ? (H = y.audio) == null ? void 0 : H.icon : (k = y.audio) == null ? void 0 : k.iconDisabled;
  ...
  return /* @__PURE__ */ b.jsx(
    "div",
    {
      "aria-label": ((g = y.ariaLabel) == null ? void 0 : g.audioButton) ?? "toggle audio",
      role: "button",
      onMouseDown: (H) => {
        H.preventDefault(), P();
      },
  ...
  var f, c;
  const { settings: g } = De(), { styles: y } = Ye(), { openChat: A } = vr(), w = {
    ...
    var C;
    const m = (C = g.header) == null ? void 0 : C.closeChatIcon;
    return !m || typeof m == "string" ? /* @__PURE__ */ b.jsx(
      "span",
      {
    ...
    ) : m && /* @__PURE__ */ b.jsx("span", { className: "rcb-close-chat-icon", "data-testid": "rcb-close-chat-icon", children: /* @__PURE__ */ b.jsx(m, { style: w }) });
  };
  return /* @__PURE__ */ b.jsx(
    "div",
    {
  ...
  var f, c, g;
  const { settings: y } = De(), { styles: A } = Ye(), { notificationsToggledOn: w, toggleNotifications: P } = Ec(), C = {
    backgroundImage: `url(${(f = y.notification) == null ? void 0 : f.icon})`,
    fill: "#fcec3d",
    ...A.notificationIconStyle
  }, m = {
    backgroundImage: `url(${(c = y.notification) == null ? void 0 : c.iconDisabled})`,
    fill: "#e8eaed",
    ...A.notificationIconStyle,
    // by default inherit the base style
    ...
    var H, k;
    const F = w ? (H = y.notification) == null ? void 0 : H.icon : (k = y.notification) == null ? void 0 : k.iconDisabled;
    return !F || typeof F == "string" ? /* @__PURE__ */ b.jsx(
      "span",
      {
  ...
  return /* @__PURE__ */ b.jsx(
    "div",
    {
      "aria-label": ((g = y.ariaLabel) == null ? void 0 : g.notificationButton) ?? "toggle notifications",
      role: "button",
      onMouseDown: (H) => {
        H.preventDefault(), P();
      },
  ...
  var f, c, g;
  const { settings: y } = De(), { styles: A } = Ye(), { injectMessage: w } = BA(), { inputRef: P } = bt(), { voiceToggledOn: C, toggleVoice: m } = Nl(), { setInputLength: x, setTextAreaValue: H, textAreaDisabled: k } = Fa(), { handleSubmitText: F } = La(), U = B.useRef([]), [L, _] = B.useState(!1);
  B.useEffect(() => {
    var G;
    (G = y.voice) != null && G.sendAsAudio ? (te(), U.current = []) : F();
  }, [L]), B.useEffect(() => {
    C ? cc(
      y,
      m,
  ...
  const j = {
    ...
    backgroundImage: `url(${(c = y.voice) == null ? void 0 : c.iconDisabled})`,
    fill: "#9aa0a6",
    ...A.voiceIconStyle,
    // by default inherit the base style
    ...
    const G = new Blob(U.current, { type: "audio/wav" }), $ = new File([G], "voice-input.wav", { type: "audio/wav" }), Z = await xs($);
    ...
    var G, $;
    const Z = C ? (G = y.voice) == null ? void 0 : G.icon : ($ = y.voice) == null ? void 0 : $.iconDisabled;
    return !Z || typeof Z == "string" ? /* @__PURE__ */ b.jsx(
      "span",
      {
    ...
    ) : Z && /* @__PURE__ */ b.jsx("span", { className: `rcb-voice-icon ${C && !k ? "on" : ""}`, children: /* @__PURE__ */ b.jsx(Z, { style: C && !k ? j : T }) });
  };
  return /* @__PURE__ */ b.jsx(
    "div",
    {
      "aria-label": ((g = y.ariaLabel) == null ? void 0 : g.voiceButton) ?? "toggle voice",
      role: "button",
      onMouseDown: (G) => {
        G.preventDefault(), !k && m();
      },
  ...
  var f, c, g, y, A, w, P, C;
  const { settings: m } = De(), { styles: x } = Ye(), { textAreaDisabled: H } = gt(), [k, F] = B.useState(!1), { handleSubmitText: U } = La(), L = {
    backgroundColor: (f = m.general) == null ? void 0 : f.primaryColor,
    ...x.sendButtonStyle
  }, _ = {
    cursor: `url(${(c = m.general) == null ? void 0 : c.actionDisabledIcon}), auto`,
    backgroundColor: (g = m.general) == null ? void 0 : g.primaryColor,
    ...x.sendButtonStyle,
    // by default inherit the base style
    ...x.sendButtonDisabledStyle
  }, j = {
    backgroundColor: (y = m.general) == null ? void 0 : y.secondaryColor,
    ...x.sendButtonStyle,
    // by default inherit the base style
    ...
    backgroundImage: `url(${(w = m.chatInput) == null ? void 0 : w.sendButtonIcon})`,
    fill: "#fff",
    ...x.sendIconStyle,
    // by default inherit the base style
    ...x.sendIconDisabledStyle
  }, te = {
    backgroundImage: `url(${(P = m.chatInput) == null ? void 0 : P.sendButtonIcon})`,
    fill: "#fff",
    ...x.sendIconStyle,
    // by default inherit the base style
    ...
    var Z;
    const re = (Z = m.chatInput) == null ? void 0 : Z.sendButtonIcon;
...
}, Bc = (f) => Object.values(Je).includes(f), kc = (f, c) => {
  var g, y, A, w, P, C, m, x, H;
  const k = {
    [Je.AUDIO_BUTTON]: (g = f.audio) == null ? void 0 : g.disabled,
    [Je.CLOSE_CHAT_BUTTON]: (y = f.general) == null ? void 0 : y.embedded,
    ...
    [Je.VOICE_MESSAGE_BUTTON]: (C = f.voice) == null ? void 0 : C.disabled
  }, F = {}, U = (T) => T ? T.map((K) => {
    if (typeof K == "string") {
      if (Bc(K) && !k[K]) {
        if (F[K])
    ...
    return K;
  }).filter((K) => K !== null) : [], L = U((m = f.header) == null ? void 0 : m.buttons), _ = U((x = f.chatInput) == null ? void 0 : x.buttons), j = U((H = f.footer) == null ? void 0 : H.buttons);
  return { header: L, chatInput: _, footer: j };
}, Tc = () => /* @__PURE__ */ b.jsx(Sc, {}), Ic = () => /* @__PURE__ */ b.jsx(Cc, {}), Rc = () => /* @__PURE__ */ b.jsx(xc, {}), Mc = () => /* @__PURE__ */ b.jsx(Dc, {}), Qc = () => /* @__PURE__ */ b.jsx(Pc, {}), Oc = () => /* @__PURE__ */ b.jsx(yc, {}), jc = () => /* @__PURE__ */ b.jsx(wc, {}), Fc = () => {
  const { settings: f } = De(), c = B.useMemo(() => ({
    [Je.CLOSE_CHAT_BUTTON]: () => Rc(),
    [Je.AUDIO_BUTTON]: () => Tc(),
    [Je.NOTIFICATION_BUTTON]: () => Ic(),
    [Je.EMOJI_PICKER_BUTTON]: () => jc(),
    [Je.FILE_ATTACHMENT_BUTTON]: () => Oc(),
    [Je.SEND_MESSAGE_BUTTON]: () => Qc(),
    [Je.VOICE_MESSAGE_BUTTON]: () => Mc()
  }), []), { header: g, chatInput: y, footer: A } = B.useMemo(() => kc(f, c), [f, c]), w = B.useMemo(() => g, [g]), P = B.useMemo(() => y, [y]), C = B.useMemo(() => A, [A]);
  return { headerButtons: w, chatInputButtons: P, footerButtons: C };
}, Es = () => {
  const { settings: f } = De(), { styles: c } = Ye(), { setMessages: g } = jl(), {
    isLoadingChatHistory: y,
    setIsLoadingChatHistory: A
  } = gt(), { chatBodyRef: w } = bt(), { callRcbEvent: P } = Wn(), { chatScrollHeight: C } = vr(), m = B.useCallback(() => {
    var x;
    const H = tc();
    H && ((x = f.event) != null && x.rcbLoadChatHistory && P(Ee.LOAD_CHAT_HISTORY, {}).defaultPrevented || (A(!0), ac(
      f,
      c,
      H,
      g,
  ...
  return { isLoadingChatHistory: y, setIsLoadingChatHistory: A, showChatHistory: m };
}, Lc = () => {
  var f, c, g;
  const { settings: y } = De(), { styles: A } = Ye(), { showChatHistory: w } = Es(), [P, C] = B.useState(!1), m = {
    color: (f = y.general) == null ? void 0 : f.primaryColor,
    borderColor: (c = y.general) == null ? void 0 : c.primaryColor,
  ...
  return /* @__PURE__ */ b.jsx("div", { className: "rcb-view-history-container", children: /* @__PURE__ */ b.jsx(
    "div",
    {
      ...
      style: P ? m : A.chatHistoryButtonStyle,
      onMouseDown: (x) => {
        x.preventDefault(), w();
      },
      ...
      role: "button",
      tabIndex: 0,
      children: /* @__PURE__ */ b.jsx("p", { children: (g = y.chatHistory) == null ? void 0 : g.viewChatHistoryButtonText })
    }
  ) });
}, Hc = () => {
  var f;
  const { settings: c } = De(), { hasInteractedPage: g, setHasInteractedPage: y, hasFlowStarted: A, setHasFlowStarted: w } = gt(), P = B.useCallback(() => {
    var C;
    y(!0), !A && ((C = c.general) == null ? void 0 : C.flowStartTrigger) === "ON_PAGE_INTERACT" && w(!0);
  ...
  const A = kA(), { settings: w } = De(), {
    ...
    messages: H,
    replaceMessages: k
  } = BA(), { getCurrPath: F, getPrevPath: U, goToPath: L, paths: _ } = DA(), { showToast: j, dismissToast: T } = PA(), {
    isBotTyping: K,
    isChatWindowOpen: te,
    isScrolling: X,
    hasFlowStarted: G,
    ...
    setTimeoutId: ve
  } = gt(), { chatBodyRef: de, flowRef: Me, streamMessageMap: Ce, paramsInputRef: ee, keepVoiceOnRef: le } = bt(), fe = Me.current, { viewportHeight: be, setViewportHeight: oe, setViewportWidth: me, openChat: Oe } = vr(), { setUpNotifications: Se } = Fl(), { handleFirstInteraction: Ae } = Hc(), { showChatHistory: Le } = Es(), { updateTextAreaFocus: Zt, setTextAreaValue: Gt } = Fa(), { syncVoice: tt } = Nl(), mt = B.useRef(0);
  B.useEffect(() => (window.addEventListener("click", Ae), window.addEventListener("keydown", Ae), window.addEventListener("touchstart", Ae), () => {
    ...
    else if (rc(w), localStorage.getItem((Pe = w.chatHistory) == null ? void 0 : Pe.storageKey) != null) {
      const Ke = Oo(/* @__PURE__ */ b.jsx(Lc, {}), "system");
      k([Ke]), (Ie = w.chatHistory) != null && Ie.autoLoad && Le();
    }
  }, [(f = w.chatHistory) == null ? void 0 : f.storageKey, (c = w.chatHistory) == null ? void 0 : c.maxEntries, (g = w.chatHistory) == null ? void 0 : g.disabled]), B.useEffect(() => {
    var xe;
    ...
    (async (Ie, Ke, nt) => {
      ...
      await Yu(
        ...
        L,
        ve
      ), ue(!1), "chatDisabled" in Ke || Z((ze = w.chatInput) == null ? void 0 : ze.disabled), ce(typeof Ke.file == "function"), Zt(Ie), tt(le.current && !Ke.chatDisabled), Ce.current.clear(), wA(H);
    })(xe, Ue, Pe);
  }, [_]), B.useEffect(() => {
    var xe;
    (G || ((xe = w.general) == null ? void 0 : xe.flowStartTrigger) === "ON_LOAD") && L("start");
  }, [G, (y = w.general) == null ? void 0 : y.flowStartTrigger]);
}, Uc = ({
  plugins: f
}) => {
  var c, g, y, A;
  f == null || f.map((X) => X());
  const w = kA(), { settings: P } = De(), { styles: C } = Ye(), { hasFlowStarted: m, setHasFlowStarted: x } = gt(), { inputRef: H } = bt(), {
    setChatScrollHeight: k,
    viewportHeight: F,
    viewportWidth: U,
    isChatWindowOpen: L
  } = vr(), { headerButtons: _, chatInputButtons: j, footerButtons: T } = Fc();
  Nc();
  const K = B.useMemo(() => {
    var X;
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: (() => {
    ...
    "div",
    {
      onMouseDown: (X) => {
        var G, $;
        !m && ((G = P.general) == null ? void 0 : G.flowStartTrigger) === "ON_CHATBOT_INTERACT" && x(!0), w ? ($ = H.current) == null || $.blur() : X == null || X.preventDefault();
      },
      className: K,
      children: [
        /* @__PURE__ */ b.jsx(mc, {}),
        ...
        /* @__PURE__ */ b.jsxs("div", { style: te(), className: "rcb-chat-window", children: [
          ((g = P.general) == null ? void 0 : g.showHeader) && /* @__PURE__ */ b.jsx(Du, { buttons: _ }),
          /* @__PURE__ */ b.jsx(ju, { setChatScrollHeight: k }),
          ((y = P.general) == null ? void 0 : y.showInputRow) && /* @__PURE__ */ b.jsx(pc, { buttons: j }),
          ((A = P.general) == null ? void 0 : A.showFooter) && /* @__PURE__ */ b.jsx(vc, { buttons: T })
        ] })
      ]
    }
  ) });
...
}, zc = Ul.DEFAULT_URL, Wc = Ul.DEFAULT_EXPIRATION, Cs = Ul.CACHE_KEY_PREFIX, Zc = (f, c, g) => {
  const y = localStorage.getItem(`${Cs}_${f}_${c}`);
  if (!y)
    return null;
  try {
    const A = JSON.parse(y), w = (/* @__PURE__ */ new Date()).getTime(), P = Math.floor(w / 1e3);
    return A.cacheDate + g >= P ? A : null;
  } catch (A) {
    return console.error(`Unable to fetch cache for ${f}`, A), null;
  }
}, Gc = (f, c, g, y, A) => {
  const w = (/* @__PURE__ */ new Date()).getTime(), P = Math.floor(w / 1e3), C = {
    settings: g,
    inlineStyles: y,
    cssStylesText: A,
    cacheDate: P
  };
  localStorage.setItem(`${Cs}_${f}_${c}`, JSON.stringify(C));
}, _c = async (f, c) => {
  const g = `${c}/${f}/meta.json`;
  try {
    const y = await fetch(g);
    return y.ok ? (await y.json()).version : (console.error(`Failed to fetch meta.json from ${g}`), null);
  } catch (y) {
    return console.error(`Failed to fetch meta.json from ${g}`, y), null;
  }
}, ns = async (f, c) => {
  const { id: g, version: y, baseUrl: A = zc, cacheDuration: w = Wc } = c, P = y || await _c(g, A);
  if (!P)
    return console.error(`Unable to find version for theme: ${g}`), { settings: {}, inlineStyles: {}, cssStylesText: "" };
  const C = Zc(g, P, w);
  if (C) {
    const K = rs(f, C.cssStylesText);
    return { settings: C.settings, inlineStyles: C.inlineStyles, cssStylesText: K };
  }
  const m = `${A}/${g}/${P}/styles.css`, x = `${A}/${g}/${P}/settings.json`, H = `${A}/${g}/${P}/styles.json`;
  let k = "";
  const F = await fetch(m);
  F.ok ? k = await F.text() : console.info(`Could not fetch styles.css from ${m}`);
  const U = await fetch(x);
  let L = {};
  U.ok ? L = await U.json() : console.info(`Could not fetch settings.json from ${x}`);
  const _ = await fetch(H);
  let j = {};
  _.ok ? j = await _.json() : console.info(`Could not fetch styles.json from ${H}`), Gc(g, P, L, j, k);
  const T = rs(f, k);
  return { settings: L, inlineStyles: j, cssStylesText: T };
}, rs = (f, c) => c.split(new RegExp("(?<=})")).map((g) => {
  const y = g.trim();
  return y.startsWith("@import") || y.startsWith("@keyframes") || y.startsWith("@media") ? y : y ? `#${f} ${y}` : "";
}).join(`
`), Ds = () => Ps(is), Yc = () => Ps(ls), Xc = async (f, c, g, y) => {
  var A, w;
  let P = Ds(), C = Yc(), m = "";
  if (y != null)
    if (Array.isArray(y))
      for (const x of y) {
        const H = await ns(f, x);
        P = ja(H.settings, P), C = ja(H.inlineStyles, C), m += H.cssStylesText;
      }
    else {
      const x = await ns(f, y);
      P = ja(x.settings, P), C = ja(x.inlineStyles, C), m += x.cssStylesText;
    }
  return c != null && (P = ja(c, P)), g != null && (C = ja(g, C)), ((A = P.chatInput) == null ? void 0 : A.botDelay) != null && ((w = P.chatInput) == null ? void 0 : w.botDelay) < 500 && (P.chatInput.botDelay = 500), { settings: P, inlineStyles: C, cssStylesText: m };
}, ja = (f, c) => {
  ...
  for (; g.length; ) {
    ...
    if (y == null)
      continue;
    const { source: A, target: w } = y;
    for (const P of Object.keys(A)) {
      const C = P;
      if (B.isValidElement(A[C]))
        w[C] = A[C];
      else if (typeof A[C] == "object" && A[C] !== null && !Array.isArray(A[C]))
        g.push({ source: A[C], target: w[C] });
      else
        try {
          w[C] = A[C];
        } catch {
  ...
  if (f === null || typeof f != "object")
    return f;
  const c = Array.isArray(f) ? [] : {}, g = [{ source: f, target: c }], y = /* @__PURE__ */ new WeakMap();
  for (y.set(f, c); g.length; ) {
    const A = g.pop();
    if (A == null)
      continue;
      ...
      if (Object.prototype.hasOwnProperty.call(w, C)) {
        ...
        if (m && typeof m == "object")
          if (y.has(m))
            ...
            y.set(m, x), P[C] = x, g.push({ source: m, target: x });
          }
        else
          P[C] = m;
      }
  ...
  return c;
}, Bs = B.createContext(void 0), ks = () => B.useContext(Bs), Vc = ({
  children: f
}) => {
  var c;
  const g = B.useRef(""), y = B.useRef({}), [A, w] = B.useState({}), [P, C] = B.useState({}), [m, x] = B.useState(!1);
  B.useEffect(() => {
    x(!0);
  }, []);
  const H = async (k, F, U, L, _, j) => {
    g.current = k, y.current = F;
    const T = await Xc(k, U, L, _);
    j.current && (j.current.textContent = T.cssStylesText), w(T.settings), C(T.inlineStyles);
  };
  return m ? /* @__PURE__ */ b.jsx("div", { style: { fontFamily: (c = A.general) == null ? void 0 : c.fontFamily }, children: /* @__PURE__ */ b.jsx(Bs.Provider, { value: { loadConfig: H }, children: /* @__PURE__ */ b.jsx(Eu, { settings: A, setSettings: w, children: /* @__PURE__ */ b.jsx(Cu, { styles: P, setStyles: C, children: /* @__PURE__ */ b.jsx(Mu, { children: /* @__PURE__ */ b.jsx(Pu, { botIdRef: g, flowRef: y, children: /* @__PURE__ */ b.jsx(Iu, { children: /* @__PURE__ */ b.jsx(Bu, { settings: A, children: /* @__PURE__ */ b.jsx(Ou, { children: f }) }) }) }) }) }) }) }) }) : null;
}, Jc = ({
  id: f,
  flow: c,
  settings: g,
  ...
  const m = B.useMemo(() => f, []), x = ks(), { flowRef: H } = bt();
  H && H.current !== c && (H.current = c);
  const k = async () => {
    var F, U;
    (F = g.event) != null && F.rcbPreLoadChatBot && xA(
      Ee.PRE_LOAD_CHATBOT,
    ...
    ).defaultPrevented || (x != null && x.loadConfig && (await x.loadConfig(m, c, g, y, A, C), P(!0)), (U = g.event) != null && U.rcbPostLoadChatBot && xA(
...
}, kl = ["Quickstart", "API Docs", "Examples", "Github", "Discord"], Kc = {
  start: {
  ...
  const P = B.useMemo(() => f || "rcb-" + SA(), []), C = !c || Object.keys(c).length === 0 ? Kc : c, m = g || {}, x = y || {}, H = w || [], [k, F] = B.useState(!1), U = ks(), L = B.useRef(null), [_, j] = B.useState(A || []);
  B.useEffect(() => {
    A && j(A);
  }, [A]);
  const T = () => /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
    ...
    k && /* @__PURE__ */ b.jsx(Uc, { plugins: w })
  ] });
  return U == null ? /* @__PURE__ */ b.jsxs(Vc, { children: [
...
}, Ts = Ds(), qc = B.createContext({
  settings: Ts,
  setSettings: () => {
  }
});
function ed() {
  const [f, c] = B.useState(""), [g, y] = B.useState(""), [A, w] = B.useState(!1), [P, C] = B.useState(!1), [m, x] = B.useState({
    ...Ts,
    voice: {
      disabled: !0
    },
  ...
  const L = async (K) => {
    const { address: te } = Ti.all();
    c(te);
    let G = await Os.getInstance().createToken(K).getBalance(te);
    G = js(G), y(G);
  }, _ = async (K) => {
    ...
    transfer: {
      ...
      component: (K) => {
        if (F.action === "transfer")
          return Dl(P, f, g, F.token, F.toEmail, F.amount), /* @__PURE__ */ b.jsx("div", { className: "pl-4 pt-2", children: P && f && g && F.token && F.toEmail && F.amount && /* @__PURE__ */ b.jsx(Ws, { onClick: () => w(!0) }) });
      },
      // chatDisabled: true,
      path: "transfer"
    }
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: H && /* @__PURE__ */ b.jsx(B.Suspense, { fallback: null, children: /* @__PURE__ */ b.jsxs("div", { children: [
    /* @__PURE__ */ b.jsx(qc.Provider, { value: { settings: m, setSettings: x }, children: /* @__PURE__ */ b.jsx($c, { settings: m, flow: j, styles: T }) }),
    /* @__PURE__ */ b.jsx(
      Qs,
      {
        open: A,
  ...
  return f.some((y) => {
    ...
    switch (y.match) {
      case "exact":
        return c === y.path;
      case "startsWith":
        return c.startsWith(y.path);
      case "endsWith":
        return c.endsWith(y.path);
      case "includes":
        return c.includes(y.path);
      case "pattern":
        return (A = y.pattern) == null ? void 0 : A.test(c);
      default:
        return !1;
    }
  });
...
function ad() {
  return /* @__PURE__ */ b.jsxs("div", { className: "bg-black text-center h-[300px] pt-[55px] border-t border-black", children: [
    /* @__PURE__ */ b.jsx("div", { className: "flex justify-center gap-4 mb-[32px]", children: od.map((f) => /* @__PURE__ */ b.jsx("a", { href: f.url, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ b.jsx("img", { src: f.icon, alt: f.url }) }, f.url)) }),
    /* @__PURE__ */ b.jsx(
      "a",
      {
...
function hd() {
  const { hideChatbot: f } = rd();
  return /* @__PURE__ */ b.jsx("section", { className: "bg-background w-full flex flex-col min-h-screen", children: /* @__PURE__ */ b.jsxs(Zs, { children: [
    /* @__PURE__ */ b.jsx(Xs, {}),
    /* @__PURE__ */ b.jsx("div", { className: "flex-grow min-h-[calc(100vh-60px)]", children: /* @__PURE__ */ b.jsx(Gs, { children: /* @__PURE__ */ b.jsx(Hs, {}) }) }),
    !f && /* @__PURE__ */ b.jsx(ed, {}),
    /* @__PURE__ */ b.jsx(zs, {}),
    /* @__PURE__ */ b.jsx(ad, {})
  ] }) });
