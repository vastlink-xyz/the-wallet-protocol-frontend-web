import { j as e, t as A, v as L, w as W, x as $ } from "./vendor-radix-BcySUdtt.js";
import { a as o, k as V, c as z } from "./vendor-react-BdtkaT_f.js";
import { c as b, u as _, g as k, a as q, M as K, v as X, B as j, L as I, T as G, f as R, q as J } from "./main-CDK5RuLO.js";
import { u as H } from "./MarketplaceProvider-N7SHg3sd.js";
import { X as Q, S as Y, A as Z } from "./vendor-ui-utils-D5jysYH4.js";
import { u as ee, B as N } from "./vendor-utils-CISROZyj.js";
import { u as te } from "./useTransaction-DDcs0bde.js";
import { f as se } from "./vendor-web3-CfO0z015.js";
const be = ({ className: l, onSearch: i, defaultValue: c = "", ...s }) => {
  const [t, n] = o.useState(c), x = (d) => {
    var m;
...
function T({ variant: l }) {
  ...
  }, { bgColor: c, text: s, width: t, textAlign: n, showIcon: x } = i[l];
...
function le({
  ...
  const { t: s } = ee(), [t, n] = o.useState(!1), [x, p] = o.useState(!1), [g, d] = o.useState(""), [m, y] = o.useState(""), [w, a] = o.useState(!1), v = o.useRef(), u = o.useRef(), { signTransaction: F, waitForTransactionExection: ce } = te();
  o.useEffect(() => {
    M();
  }, []);
  const M = async () => {
    ...
    y(S);
  }, C = async (r) => (await k.get(`/thirdparty/sign-moonpay-params?url=${encodeURIComponent(r)}`)).data.signature, O = () => {
    c(!1), n(!1), p(!1);
  }, P = async (r) => {
    if (a(!1), await E()) {
  ...
  async function B(r) {
    try {
      const f = r.cryptoCurrency.code.toUpperCase(), h = se(BigInt(r.cryptoCurrencyAmountSmallestDenomination));
      R("amt", h), a(!0);
      const S = await F({
...
function we({
  ...
  const [t, n] = o.useState([]), [x, p] = o.useState(!1), [g, d] = o.useState({});
  o.useEffect(() => {
    m();
  }, []);
  const m = async () => {
    ...
    n(v);
  }, y = async () => (await k.get("/user/purchasedProducts")).data, w = (a) => {
    p(!0), d(a);
  };
