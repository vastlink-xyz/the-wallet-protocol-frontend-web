...
import { u as _, M as q, b as K, l as S } from "./main-DrvVrxeO.js";
import { c as y } from "./style-CX3mXOu3.js";
import { a as C } from "./index-Dr7PNsrq.js";
import { u as X } from "./MarketplaceProvider-D5NCrQ1N.js";
import { B as j } from "./button-CQRi4ddT.js";
import { a as G } from "./auth-D53HHgot.js";
import { X as J, S as H, A as Q } from "./vendor-ui-utils-CwlQOkPE.js";
import { u as Y, B as N } from "./vendor-utils-RvkaSVWD.js";
import { T as Z } from "./TokenService-CBSYqvR8.js";
import { L as I } from "./index-BO59AZ-D.js";
import { T as ee } from "./transaction-Dz01ddzF.js";
import { u as te } from "./useTransaction-BDwwSswq.js";
import { f as se } from "./vendor-web3-B_6NVwwj.js";
...
function le({
  ...
  const { t: s } = Y(), [t, o] = c.useState(!1), [x, p] = c.useState(!1), [g, d] = c.useState(""), [m, w] = c.useState(""), [b, a] = c.useState(!1), v = c.useRef(), u = c.useRef(), { signTransaction: E, waitForTransactionExection: ce } = te();
  c.useEffect(() => {
    F();
  }, []);
  const F = async () => {
...
function Pe({
  ...
  const m = async () => {
    const v = (await w()).filter((u) => u.status === "active").map((u) => u.productId);
    o(v);
