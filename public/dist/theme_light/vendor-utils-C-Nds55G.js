import { r as M, R as J, p as ce, g as ts } from "./vendor-react-CA5sEv1f.js";
import { c as Re } from "./vendor-ui-utils-BGnsFFgj.js";
import { g as ns, B as rs } from "./vendor-web3-4JjHsX86.js";
const He = (t) => typeof t == "number" && !isNaN(t), Ae = (t) => typeof t == "string", fe = (t) => typeof t == "function", st = (t) => Ae(t) || fe(t) ? t : null, Ut = (t) => M.isValidElement(t) || Ae(t) || fe(t) || He(t);
function ss(t, e, n) {
  n === void 0 && (n = 300);
...
function mt(t) {
  ...
  return function(o) {
    ...
    return M.useLayoutEffect(() => {
      ...
      const w = d.current, S = () => {
        w.removeEventListener("animationend", S), s ? ss(w, u, i) : u();
      };
...
let ze = [];
const Ht = /* @__PURE__ */ new Set(), is = (t) => Ht.forEach((e) => e(t)), sr = () => se.size > 0;
function ir(t, e) {
  var n;
...
function or(t, e) {
  Ut(t) && (sr() || ze.push({ content: t, options: e }), se.forEach((n) => {
    n.buildToast(t, e);
  }));
}
function gn(t, e) {
    ...
    return { subscribe(a) {
      const l = /* @__PURE__ */ function(u, d, f) {
        ...
        const E = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Set(), v = () => {
          ...
          R.staleId && E.delete(R.staleId), E.set(_, R), h = [...h, R.props.toastId].filter((Y) => Y !== R.staleId), v(), f(hn(R, he ? "added" : "updated")), he && fe(U) && U(M.isValidElement(ue) && ue.props);
        };
        return { id: u, props: S, observe: (R) => (T.add(R), () => T.delete(R)), toggle: (R, _) => {
          ...
          const X = { ...S, style: S.toastStyle, key: y++, ...Object.fromEntries(Object.entries(_).filter((A) => {
            ...
            fe(P) && P(M.isValidElement(C) && C.props), f(hn(A, "removed")), E.delete(U), p--, p < 0 && (p = 0), m.length > 0 ? L(m.shift()) : v();
          } };
          var q, Z;
          ...
          let b = R;
          M.isValidElement(R) && !Ae(R.type) ? b = M.cloneElement(R, { closeToast: re, toastProps: X, data: ue }) : fe(R) && (b = R({ closeToast: re, toastProps: X, data: ue }));
      ...
      se.set(o, l);
      const c = l.observe(a);
      return ze.forEach((u) => or(u.content, u.options)), ze = [], () => {
        c(), se.delete(o);
      };
    }, setProps(a) {
      var l;
...
const ar = () => "" + us++;
function cs(t) {
  return t && (Ae(t.toastId) || He(t.toastId)) ? t.toastId : ar();
}
function je(t, e) {
  return or(t, e), e.toastId;
}
function lt(t, e) {
  return { ...e, type: e && e.type || t, toastId: cs(e) };
}
function Qe(t) {
...
W.loading = (t, e) => je(t, lt("default", { isLoading: !0, autoClose: !1, closeOnClick: !1, closeButton: !1, draggable: !1, ...e })), W.promise = function(t, e, n) {
  ...
  if (n) {
    const { props: r, content: s } = n, i = { delay: 100, ...r, ...e, toastId: e.toastId || t, updateId: ar() };
...
const fs = typeof window < "u" ? M.useLayoutEffect : M.useEffect, Xe = (t) => {
  ...
  }(Z)), J.createElement(y, { isIn: H, done: U, position: p, preventExitTransition: n, nodeRef: r, playToast: i }, J.createElement("div", { id: _, onClick: c, "data-in": H, className: Q, ...s, style: h, ref: r }, J.createElement("div", { ...H && { role: B }, className: fe(w) ? w({ type: u }) : Re("Toastify__toast-body", w), style: S }, X != null && J.createElement("div", { className: Re("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !ue }) }, X), J.createElement("div", null, a)), b, J.createElement(ls, { ...v && !q ? { key: `pb-${v}` } : {}, rtl: R, theme: Y, delay: l, isRunning: e, isIn: H, closeToast: f, hide: d, type: u, style: T, className: E, controlledProgress: q, progress: L || 0 })));
}, yt = function(t, e) {
...
const _a = mt(yt("zoom"));
mt(yt("flip"));
const hs = { position: "top-right", transition: ps, autoClose: 5e3, closeButton: !0, pauseOnHover: !0, pauseOnFocusLoss: !0, draggable: "touch", draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light" };
function Ia(t) {
  let e = { ...hs, ...t };
  const n = t.stacked, [r, s] = M.useState(!0), i = M.useRef(null), { getToastToRender: o, isToastActive: a, count: l } = os(e), { className: c, style: u, rtl: d, containerId: f } = e;
  function y(m) {
  ...
  return fs(() => {
    ...
    return J.createElement("div", { className: y(m), style: w, key: `container-${m}` }, h.map((S) => {
      ...
      return J.createElement(ds, { ...T, stacked: n, collapseAll: p, isIn: a(T.toastId, T.containerId), style: T.style, key: `toast-${T.key}` }, E);
    }));
  }));
}
function lr(t, e) {
...
const { toString: gs } = Object.prototype, { getPrototypeOf: rn } = Object, vt = /* @__PURE__ */ ((t) => (e) => {
  const n = gs.call(e);
  return t[n] || (t[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), ve = (t) => (t = t.toLowerCase(), (e) => vt(e) === t), bt = (t) => (e) => typeof e === t, { isArray: $e } = Array, Ve = bt("undefined");
function ms(t) {
  return t !== null && !Ve(t) && t.constructor !== null && !Ve(t.constructor) && de(t.constructor.isBuffer) && t.constructor.isBuffer(t);
}
const ur = ve("ArrayBuffer");
function ys(t) {
  let e;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? e = ArrayBuffer.isView(t) : e = t && t.buffer && ur(t.buffer), e;
}
const vs = bt("string"), de = bt("function"), cr = bt("number"), Et = (t) => t !== null && typeof t == "object", bs = (t) => t === !0 || t === !1, it = (t) => {
  if (vt(t) !== "object")
    return !1;
  const e = rn(t);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(Symbol.toStringTag in t) && !(Symbol.iterator in t);
}, Es = ve("Date"), ws = ve("File"), Ss = ve("Blob"), Ts = ve("FileList"), xs = (t) => Et(t) && de(t.pipe), Os = (t) => {
  let e;
  return t && (typeof FormData == "function" && t instanceof FormData || de(t.append) && ((e = vt(t)) === "formdata" || // detect form-data instance
  e === "object" && de(t.toString) && t.toString() === "[object FormData]"));
}, Rs = ve("URLSearchParams"), [Cs, Ps, Ls, As] = ["ReadableStream", "Request", "Response", "Headers"].map(ve), Ns = (t) => t.trim ? t.trim() : t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const Le = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : ns, dr = (t) => !Ve(t) && t !== Le;
function zt() {
  const { caseless: t } = dr(this) && this || {}, e = {}, n = (r, s) => {
    const i = t && fr(e, s) || s;
    it(e[i]) && it(r) ? e[i] = zt(e[i], r) : it(r) ? e[i] = zt({}, r) : $e(r) ? e[i] = r.slice() : e[i] = r;
  };
  for (let r = 0, s = arguments.length; r < s; r++)
    arguments[r] && qe(arguments[r], n);
  return e;
}
const _s = (t, e, n, { allOwnKeys: r } = {}) => (qe(e, (s, i) => {
  n && de(s) ? t[i] = lr(s, n) : t[i] = s;
}, { allOwnKeys: r }), t), Is = (t) => (t.charCodeAt(0) === 65279 && (t = t.slice(1)), t), Ds = (t, e, n, r) => {
  ...
  for (; e-- > 0; )
    n[e] = t[e];
  return n;
}, Ms = /* @__PURE__ */ ((t) => (e) => t && e instanceof t)(typeof Uint8Array < "u" && rn(Uint8Array)), Fs = (t, e) => {
  ...
  for (; (n = t.exec(e)) !== null; )
    r.push(n);
  return r;
}, Us = ve("HTMLFormElement"), Hs = (t) => t.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), mn = (({ hasOwnProperty: t }) => (e, n) => t.call(e, n))(Object.prototype), zs = ve("RegExp"), pr = (t, e) => {
...
}, Js = (t, e) => t != null && Number.isFinite(t = +t) ? t : e, Pt = "abcdefghijklmnopqrstuvwxyz", yn = "0123456789", hr = {
  DIGIT: yn,
  ALPHA: Pt,
  ALPHA_DIGIT: Pt + Pt.toUpperCase() + yn
}, Ws = (t = 16, e = hr.ALPHA_DIGIT) => {
  let n = "";
  const { length: r } = e;
  for (; t--; )
    n += e[Math.random() * r | 0];
...
const Qs = (t) => {
  ...
  return n(t, 0);
}, Xs = ve("AsyncFunction"), Gs = (t) => t && (Et(t) || de(t)) && de(t.then) && de(t.catch), gr = ((t, e) => t ? setImmediate : e ? ((n, r) => (Le.addEventListener("message", ({ source: s, data: i }) => {
  ...
  de(Le.postMessage)
), Zs = typeof queueMicrotask < "u" ? queueMicrotask.bind(Le) : typeof ce < "u" && ce.nextTick || gr, g = {
  isArray: $e,
  isArrayBuffer: ur,
  isBuffer: ms,
  isFormData: Os,
...
function vn(t, e, n) {
  return t ? t.concat(e).map(function(s, i) {
    return s = vr(s), !n && i ? "[" + s + "]" : s;
  }).join(n ? "." : "") : e;
}
function ti(t) {
  return g.isArray(t) && !t.some(Vt);
}
const ni = g.toFlatObject(g, {}, null, function(e) {
...
function wt(t, e, n) {
  ...
  function c(p) {
    ...
    return g.isArrayBuffer(p) || g.isTypedArray(p) ? l && typeof Blob == "function" ? new Blob([p]) : rs.from(p) : p;
  }
  function u(p, m, h) {
    let w = p;
    if (p && !h && typeof p == "object") {
      ...
      else if (g.isArray(p) && ti(p) || (g.isFileList(p) || g.endsWith(m, "[]")) && (w = g.toArray(p)))
        return m = vr(m), w.forEach(function(E, T) {
          !(g.isUndefined(E) || E === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            o === !0 ? vn([m], T, i) : o === null ? m : m + "[]",
            c(E)
          );
        }), !1;
    }
    return Vt(p) ? !0 : (e.append(vn(h, m, i), c(p)), !1);
  }
  const d = [], f = Object.assign(ni, {
    defaultVisitor: u,
    convertValue: c,
    isVisitable: Vt
  });
...
function Er(t, e, n) {
  if (!e)
    return t;
  const r = n && n.encode || ri, s = n && n.serialize;
  let i;
...
}, si = typeof URLSearchParams < "u" ? URLSearchParams : sn, ii = typeof FormData < "u" ? FormData : null, oi = typeof Blob < "u" ? Blob : null, ai = {
  isBrowser: !0,
  classes: {
    URLSearchParams: si,
    FormData: ii,
...
}, on = typeof window < "u" && typeof document < "u", Kt = typeof navigator == "object" && navigator || void 0, li = on && (!Kt || ["ReactNative", "NativeScript", "NS"].indexOf(Kt.product) < 0), ui = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", ci = on && window.location.href || "http://localhost", fi = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: on,
...
function di(t, e) {
  return wt(t, new ae.classes.URLSearchParams(), Object.assign({
...
function Sr(t) {
  function e(n, r, s, i) {
    ...
    return o = !o && g.isArray(s) ? s.length : o, l ? (g.hasOwnProp(s, o) ? s[o] = [s[o], r] : s[o] = r, !a) : ((!s[o] || !g.isObject(s[o])) && (s[o] = []), e(n, r, s[o], i) && g.isArray(s[o]) && (s[o] = hi(s[o])), !a);
  }
...
const Je = {
  ...
  transformRequest: [function(e, n) {
    ...
    return i || s ? (n.setContentType("application/json", !1), gi(e)) : e;
  }],
...
const mi = g.toObjectSet([
  ...
  return t && t.split(`
`).forEach(function(o) {
    s = o.indexOf(":"), n = o.substring(0, s).trim().toLowerCase(), r = o.substring(s + 1).trim(), !(!n || e[n] && mi[n]) && (n === "set-cookie" ? e[n] ? e[n].push(r) : e[n] = [r] : e[n] = e[n] ? e[n] + ", " + r : r);
  }), e;
}, wn = Symbol("internals");
function Me(t) {
...
class le {
  ...
  set(e, n, r) {
    ...
    if (g.isPlainObject(e) || e instanceof this.constructor)
      o(e, n);
    else if (g.isString(e) && (e = e.trim()) && !bi(e))
      o(yi(e), n);
  ...
  delete(e, n) {
    ...
    function i(o) {
      if (o = Me(o), o) {
        ...
        a && (!n || Lt(r, r[a], a, n)) && (delete r[a], s = !0);
      }
    }
  ...
  clear(e) {
    ...
    for (; r--; ) {
      const i = n[r];
      (!e || Lt(this, this[i], i, e, !0)) && (delete this[i], s = !0);
    }
    return s;
  }
  normalize(e) {
...
}, Tn = (t) => (...e) => g.asap(() => t(...e)), Oi = ae.hasStandardBrowserEnv ? (
...
function Or(t, e) {
  return t && !Ci(e) ? Pi(t, e) : e;
}
const xn = (t) => t instanceof le ? { ...t } : t;
function Ie(t, e) {
  e = e || {};
  const n = {};
  function r(c, u, d) {
...
const Rr = (t) => {
  ...
  e.headers = o = le.from(o), e.url = Er(Or(e.baseURL, e.url), t.params, t.paramsSerializer), a && o.set(
    "Authorization",
  ...
  if (ae.hasStandardBrowserEnv && (r && g.isFunction(r) && (r = r(e)), r || r !== !1 && Oi(e.url))) {
    const c = s && i && Ri.read(i);
    c && o.set(s, c);
  }
  return e;
}, Li = typeof XMLHttpRequest < "u", Ai = Li && function(t) {
  return new Promise(function(n, r) {
    ...
    }), g.isUndefined(s.withCredentials) || (h.withCredentials = !!s.withCredentials), a && a !== "json" && (h.responseType = s.responseType), c && ([f, p] = ut(c, !0), h.addEventListener("progress", f)), l && h.upload && ([d, y] = ut(l), h.upload.addEventListener("progress", d), h.upload.addEventListener("loadend", y)), (s.cancelToken || s.signal) && (u = (E) => {
...
}, St = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", Cr = St && typeof ReadableStream == "function", ki = St && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((t) => (e) => t.encode(e))(new TextEncoder()) : async (t) => new Uint8Array(await new Response(t).arrayBuffer())), Pr = (t, ...e) => {
  try {
    return !!t(...e);
  } catch {
    return !1;
  ...
  return t && !e;
}), Rn = 64 * 1024, qt = Cr && Pr(() => g.isReadableStream(new Response("").body)), ct = {
  stream: qt && ((t) => t.body)
};
St && ((t) => {
  ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((e) => {
    !ct[e] && (ct[e] = g.isFunction(t[e]) ? (n) => n[e]() : (n, r) => {
...
const Bi = async (t) => {
  ...
  let y = Ni([s, i && i.toAbortSignal()], o), p;
  const m = y && y.unsubscribe && (() => {
    y.unsubscribe();
  });
  let h;
  try {
    if (l && $i && n !== "get" && n !== "head" && (h = await Mi(u, r)) !== 0) {
      let v = new Request(e, {
        method: "POST",
        body: r,
        duplex: "half"
    ...
    let S = await fetch(p);
    const E = qt && (c === "stream" || c === "response");
    if (qt && (a || E && m)) {
      const v = {};
      ["status", "statusText", "headers"].forEach((_) => {
        v[_] = S[_];
      });
      const B = g.toFiniteNumber(S.headers.get("content-length")), [L, R] = a && Sn(
        B,
        ut(Tn(a), !0)
      ) || [];
      S = new Response(
    ...
    c = c || "text";
    let T = await ct[g.findKey(ct, c) || "text"](S, t);
...
const Cn = (t) => `- ${t}`, ji = (t) => g.isFunction(t) || t === null || t === !1, Lr = {
  getAdapter: (t) => {
    t = g.isArray(t) ? t : [t];
    const { length: e } = t;
    let n, r;
    ...
    for (let i = 0; i < e; i++) {
      n = t[i];
      let o;
      if (r = n, !ji(n) && (r = Jt[(o = String(n)).toLowerCase()], r === void 0))
...
` + i.map(Cn).join(`
`) : " " + Cn(i[0]) : "as no adapter specified";
      throw new $(
...
function Pn(t) {
  return Nt(t), t.headers = le.from(t.headers), t.data = At.call(
    t,
    t.transformRequest
  ), ["post", "put", "patch"].indexOf(t.method) !== -1 && t.headers.setContentType("application/x-www-form-urlencoded", !1), Lr.getAdapter(t.adapter || Je.adapter)(t).then(function(r) {
    return Nt(t), r.data = At.call(
      t,
      t.transformResponse,
      r
    ), r.headers = le.from(r.headers), r;
  }, function(r) {
    return Tr(r) || (Nt(t), r && r.response && (r.response.data = At.call(
      t,
      t.transformResponse,
      r.response
...
an.transitional = function(e, n, r) {
  function s(i, o) {
    return "[Axios v" + Ar + "] Transitional option '" + i + "'" + o + (r ? ". " + r : "");
  }
  return (i, o, a) => {
    if (e === !1)
      throw new $(
...
function Nr(t) {
  const e = new Ne(t), n = lr(Ne.prototype.request, e);
  return g.extend(n, Ne.prototype, e, { allOwnKeys: !0 }), g.extend(n, e, null, { allOwnKeys: !0 }), n.create = function(s) {
    return Nr(Ie(t, s));
  }, n;
}
const G = Nr(Je);
...
G.mergeConfig = Ie;
G.AxiosHeaders = le;
G.formToJSON = (t) => Sr(g.isHTMLForm(t) ? new FormData(t) : t);
G.getAdapter = Lr.getAdapter;
G.HttpStatusCode = Yt;
G.default = G;
const I = (t) => typeof t == "string", Fe = () => {
...
}, An = (t) => t == null ? "" : "" + t, Vi = (t, e, n) => {
  t.forEach((r) => {
    e[r] && (n[r] = e[r]);
  });
}, Ki = /###/g, Nn = (t) => t && t.indexOf("###") > -1 ? t.replace(Ki, ".") : t, _n = (t) => !t || I(t), Ue = (t, e, n) => {
  ...
  for (const r in e)
    r !== "__proto__" && r !== "constructor" && (r in t ? I(t[r]) || t[r] instanceof String || I(e[r]) || e[r] instanceof String ? n && (t[r] = e[r]) : _r(t[r], e[r], n) : t[r] = e[r]);
  return t;
}, De = (t) => t.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
var Wi = {
  "&": "&amp;",
...
const Yi = (t) => I(t) ? t.replace(/[&<>"'\/]/g, (e) => Wi[e]) : t;
class Qi {
  constructor(e) {
...
const Xi = [" ", ",", "?", "!", ";"], Gi = new Qi(20), Zi = (t, e, n) => {
  e = e || "", n = n || "";
  const r = Xi.filter((o) => e.indexOf(o) < 0 && n.indexOf(o) < 0);
  if (r.length === 0) return !0;
  const s = Gi.getRegExp(`(${r.map((o) => o === "?" ? "\\?" : o).join("|")})`);
  let i = !s.test(t);
  if (!i) {
    const o = t.indexOf(n);
...
class pt {
  ...
  init(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.prefix = n.prefix || "i18next:", this.logger = e || eo, this.options = n, this.debug = n.debug;
  }
  log() {
...
class Dn extends Tt {
  ...
  getResource(e, n, r) {
    ...
    return !l && !n && !r && e.indexOf(".") > -1 && (e = a[0], n = a[1], r = a.slice(2).join(".")), l || !o || !I(r) ? l : Qt(this.data && this.data[e] && this.data[e][n], r, i);
  }
  addResource(e, n, r, s) {
    ...
    let a = [e, n];
    r && (a = a.concat(o ? r.split(o) : r)), e.indexOf(".") > -1 && (a = e.split("."), s = n, n = a[1]), this.addNamespaces(n), In(this.data, a, s), i.silent || this.emit("added", e, n, r, s);
  }
  addResources(e, n, r) {
    let s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {
      silent: !1
  ...
  addResourceBundle(e, n, r, s, i) {
    ...
    o.skipCopy || (r = JSON.parse(JSON.stringify(r))), s ? _r(l, r, i) : l = {
      ...l,
      ...r
    }, In(this.data, a, l), o.silent || this.emit("added", e, n, r);
  }
...
class ht extends Tt {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    super(), Vi(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = n, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = we.create("translator");
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  extractFromKey(e, n) {
    ...
    const o = r && e.indexOf(r) > -1, a = !this.options.userDefinedKeySeparator && !n.keySeparator && !this.options.userDefinedNsSeparator && !n.nsSeparator && !Zi(e, r, s);
    if (o && !a) {
  ...
  extendTranslation(e, n, r, s, i) {
    ...
    return e != null && l && l.length && r.applyPostProcessor !== !1 && (e = Ir.handle(l, e, n, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...s,
  ...
  resolve(e) {
    ...
    return I(e) && (e = [e]), e.forEach((l) => {
      ...
      d.forEach((h) => {
        this.isValidLookup(r) || (a = h, !kn[`${m[0]}-${h}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(a) && (kn[`${m[0]}-${h}`] = !0, this.logger.warn(`key "${s}" for languages "${m.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach((w) => {
          if (this.isValidLookup(r)) return;
          o = w;
          const S = [u];
...
class oo {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.languageUtils = e, this.options = n, this.logger = we.create("pluralResolver"), (!this.options.compatibilityJSON || so.includes(this.options.compatibilityJSON)) && (typeof Intl > "u" || !Intl.PluralRules) && (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = io(), this.pluralRulesCache = {};
  }
  addRule(e, n) {
    this.rules[e] = n;
  }
  ...
  getSuffixes(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const r = this.getRule(e, n);
    return r ? this.shouldUseIntlApi() ? r.resolvedOptions().pluralCategories.sort((s, i) => Bn[s] - Bn[i]).map((s) => `${this.options.prepend}${n.ordinal ? `ordinal${this.options.prepend}` : ""}${s}`) : r.numbers.map((s) => this.getSuffix(e, s, n)) : [];
  }
  getSuffix(e, n) {
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  ...
  shouldUseIntlApi() {
    return !ro.includes(this.options.compatibilityJSON);
  }
}
const Mn = function(t, e, n) {
  let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : ".", s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, i = Ji(t, e, n);
  return !i && s && I(n) && (i = Qt(t, n, r), i === void 0 && (i = Qt(e, n, r))), i;
}, It = (t) => t.replace(/\$/g, "$$$$");
class ao {
  constructor() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  ...
  init() {
    ...
    this.escape = n !== void 0 ? n : Yi, this.escapeValue = r !== void 0 ? r : !0, this.useRawValueToEscape = s !== void 0 ? s : !1, this.prefix = i ? De(i) : o || "{{", this.suffix = a ? De(a) : l || "}}", this.formatSeparator = c || ",", this.unescapePrefix = u ? "" : d || "-", this.unescapeSuffix = this.unescapePrefix ? "" : u || "", this.nestingPrefix = f ? De(f) : y || De("$t("), this.nestingSuffix = p ? De(p) : m || De(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = w || 1e3, this.alwaysFormat = S !== void 0 ? S : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, n, r, s) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (y) => {
      if (y.indexOf(this.formatSeparator) < 0) {
        const w = Mn(n, l, y, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      return this.format(Mn(n, l, m, this.options.keySeparator, this.options.ignoreJSONStructure), h, r, {
        ...s,
        ...n,
        interpolationkey: m
      });
    ...
    return [{
      ...
      for (a = 0; i = y.regex.exec(e); ) {
        ...
        else !I(o) && !this.useRawValueToEscape && (o = An(o));
  ...
  nest(e, n) {
    ...
    for (; s = this.nestingRegexp.exec(e); ) {
      ...
      I(i) || (i = An(i)), i || (this.logger.warn(`missed to resolve ${s[1]} for nesting ${e}`), i = ""), c && (i = l.reduce((u, d) => this.format(u, d, r.lng, {
        ...r,
...
class fo extends Tt {
  ...
  loaded(e, n, r) {
    ...
    this.queue.forEach((l) => {
      qi(l.loaded, [i], o), co(l, e), n && l.errors.push(n), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((c) => {
        a[c] || (a[c] = {});
        const u = l.loaded[c];
...
}), jn = (t) => (I(t.ns) && (t.ns = [t.ns]), I(t.fallbackLng) && (t.fallbackLng = [t.fallbackLng]), I(t.fallbackNS) && (t.fallbackNS = [t.fallbackNS]), t.supportedLngs && t.supportedLngs.indexOf("cimode") < 0 && (t.supportedLngs = t.supportedLngs.concat(["cimode"])), t), Ge = () => {
}, po = (t) => {
...
class Ke extends Tt {
  constructor() {
    ...
    if (super(), this.options = jn(e), this.services = {}, this.logger = we, this.modules = {
      external: []
    }, po(this), n && !this.isInitialized && !e.isClone) {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      let u;
      this.modules.formatter ? u = this.modules.formatter : typeof Intl < "u" && (u = uo);
      const d = new $n(this.options);
      this.store = new Dn(this.options.resources, this.options);
      const f = this.services;
      f.logger = we, f.resourceStore = this.store, f.languageUtils = d, f.pluralResolver = new oo(d, {
        prepend: this.options.pluralSeparator,
        compatibilityJSON: this.options.compatibilityJSON,
        simplifyPluralSuffix: this.options.simplifyPluralSuffix
      }), u && (!this.options.interpolation.format || this.options.interpolation.format === s.interpolation.format) && (f.formatter = i(u), f.formatter.init(f, this.options), this.options.interpolation.format = f.formatter.format.bind(f.formatter)), f.interpolator = new ao(this.options), f.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, f.backendConnector = new fo(i(this.modules.backend), f.resourceStore, f, this.options), f.backendConnector.on("*", function(y) {
  ...
  use(e) {
    ...
    return e.type === "backend" && (this.modules.backend = e), (e.type === "logger" || e.log && e.warn && e.error) && (this.modules.logger = e), e.type === "languageDetector" && (this.modules.languageDetector = e), e.type === "i18nFormat" && (this.modules.i18nFormat = e), e.type === "postProcessor" && Ir.addPostProcessor(e), e.type === "formatter" && (this.modules.formatter = e), e.type === "3rdParty" && this.modules.external.push(e), this;
  }
  ...
  dir(e) {
    ...
    const n = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], r = this.services && this.services.languageUtils || new $n(Fn());
  ...
  cloneInstance() {
    ...
    }, r && (i.store = new Dn(this.store.data, s), i.services.resourceStore = i.store), i.translator = new ht(i.services, s), i.translator.on("*", function(a) {
...
ie.loadLanguages;
const ho = (...t) => {
  console != null && console.warn && (_e(t[0]) && (t[0] = `react-i18next:: ${t[0]}`), console.warn(...t));
}, Un = {}, Xt = (...t) => {
  _e(t[0]) && Un[t[0]] || (_e(t[0]) && (Un[t[0]] = /* @__PURE__ */ new Date()), ho(...t));
}, Dr = (t, e) => () => {
  if (t.isInitialized)
    e();
  else {
  ...
  t.loadNamespaces(e, Dr(t, n));
}, zn = (t, e, n, r) => {
  _e(n) && (n = [n]), n.forEach((s) => {
    t.options.ns.indexOf(s) < 0 && t.options.ns.push(s);
  }), t.loadLanguages(e, Dr(t, r));
}, go = (t, e, n = {}) => !e.languages || !e.languages.length ? (Xt("i18n.languages were undefined or empty", e.languages), !0) : e.hasLoadedNamespace(t, {
  lng: n.lng,
  precheck: (r, s) => {
    var i;
...
}), _e = (t) => typeof t == "string", mo = (t) => typeof t == "object" && t !== null, yo = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, vo = {
  "&amp;": "&",
  "&#38;": "&",
  "&lt;": "<",
  "&#60;": "<",
  ...
  "&#x2F;": "/",
  "&#47;": "/"
}, bo = (t) => vo[t], Eo = (t) => t.replace(yo, bo);
let Gt = {
...
const Ro = (t, e) => {
...
}, Br = (t, e, n, r) => t.getFixedT(e, n, r), Co = (t, e, n, r) => M.useCallback(Br(t, e, n, r), [t, e, n, r]), ka = (t, e = {}) => {
  var T, v, B, L;
  const {
    i18n: n
  } = e, {
  ...
  if (i && !i.reportNamespaces && (i.reportNamespaces = new Oo()), !i) {
    ...
    const R = (U, H) => _e(H) ? H : mo(H) && _e(H.defaultValue) ? H.defaultValue : Array.isArray(U) ? U[U.length - 1] : U, _ = [R, {}, !1];
    return _.t = R, _.i18n = {}, _.ready = !1, _;
  }
  (T = i.options.react) != null && T.wait && Xt("It seems you are still using the old wait option, you may migrate to the new useSuspense behaviour.");
  const o = {
    ...So(),
    ...i.options.react,
    ...e
  ...
  c = _e(c) ? [c] : c || ["translation"], (L = (B = i.reportNamespaces).addUsedNamespaces) == null || L.call(B, c);
  const u = (i.isInitialized || i.initializedStoreOnce) && c.every((R) => go(R, i, o)), d = Co(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), f = () => d, y = () => Br(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), [p, m] = M.useState(f);
  let h = c.join();
  e.lng && (h = `${e.lng}${h}`);
  const w = Ro(h), S = M.useRef(!0);
  M.useEffect(() => {
    const {
      bindI18n: R,
      bindI18nStore: _
    } = o;
    S.current = !0, !u && !a && (e.lng ? zn(i, e.lng, c, () => {
      S.current && m(y);
    }) : Hn(i, c, () => {
      S.current && m(y);
...
function $a({
  ...
  return M.createElement($r.Provider, {
    value: r
  }, n);
}
var xt = {}, Po = function() {
