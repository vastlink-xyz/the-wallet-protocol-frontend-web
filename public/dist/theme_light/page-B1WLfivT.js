...
import { i as C, j as L, r as n } from "./vendor-react-Cqw-pUgZ.js";
import { B as i, b as A } from "./vendor-utils-BEOEHg0B.js";
import { l as O } from "./main-BQRn5y6W.js";
import { a as U } from "./auth-BKVikp7y.js";
import { h as v } from "./error-BOjt9hlf.js";
import { B as d } from "./button-CkT6Skev.js";
import { L as f } from "./index-YZ-oGsCe.js";
import { a as o } from "./index-DEOj28UY.js";
import { k as V } from "./index-BE51hq0_.js";
import { f as W } from "./vendor-web3-DM8VQNRv.js";
function _() {
  const [l] = C(), b = L(), [u, E] = n.useState(!1), [p, h] = n.useState(!1), [x, g] = n.useState(!1), [w, j] = n.useState(!1), [t, I] = n.useState(), [m, S] = n.useState("PENDING"), [T, k] = n.useState("");
  n.useEffect(() => {
    G();
  }, [l]), n.useEffect(() => {
    t && S(t.status);
