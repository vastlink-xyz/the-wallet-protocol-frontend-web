import { j as e, E as V, F as z, G, H as Q } from "./vendor-radix-BYJ0AyiX.js";
import { c as y, ae as H, f as L, a as J, af as K, ag as X, ah as Y, B as v, V as Z, t as ee, L as te, g as A, ai as ae, o as se, k as ne, h as ie } from "./main-DVFfqeHd.js";
import { r as o, k as oe } from "./vendor-react-CuOkI7kW.js";
import { u as re, a as le } from "./MarketplaceProvider-C6tT7vUg.js";
import { u as ce, B as u } from "./vendor-utils-BfzDPiRN.js";
import { u as de } from "./useTransaction-uYb1mf7Q.js";
import { L as me } from "./index-BIjJoPgM.js";
import { S as fe, A as xe } from "./vendor-ui-utils-2_WY-nJY.js";
import { k as pe } from "./vendor-web3-DDgB3Js4.js";
function Ie({
  text: r,
...
const be = ({
  ...
  const l = oe(), n = H(), t = o.useRef(null), {
    setIsModalOpen: f,
    setDappInfo: p,
    isConnected: g,
    setDisplayUriInput: w
  } = re(), { checkNewProducts: j } = le();
  o.useEffect(() => () => {
...
function Pe({
  ...
  const { t: n } = ce(), [t, f] = o.useState(!1), [p, g] = o.useState(!1), [w, j] = o.useState(""), [b, C] = o.useState(""), [a, m] = o.useState(!1), h = o.useRef(), N = o.useRef(), { signTransaction: U, waitForTransactionExection: ye } = de(), [E, k] = o.useState(!1), [M, S] = o.useState(!1), [T, B] = o.useState(null);
  o.useEffect(() => {
    F();
  }, []);
  const F = async () => {
  ...
  async function $(s) {
    try {
      const i = s.cryptoCurrency.code.toUpperCase(), c = pe(BigInt(s.cryptoCurrencyAmountSmallestDenomination));
      A("amt", c), m(!0);
      const x = await U({
        ...
        /* @__PURE__ */ e.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ e.jsxs(
            v,
            {
              ...
              onClick: () => f(!0),
              children: [
                /* @__PURE__ */ e.jsx(fe, { className: "hidden tablet:block tablet:mr-2" }),
          ...
          /* @__PURE__ */ e.jsxs(
            v,
            {
              ...
              onClick: () => g(!0),
              children: [
                /* @__PURE__ */ e.jsx(xe, { className: "hidden tablet:block tablet:mr-2" }),
