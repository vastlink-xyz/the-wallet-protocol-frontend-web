...
import { a as bA, c as Ne, D as kl, b as Tl, d as Il, e as ja, l as Zl, B as Ms, f as as, h as Qs, S as Os, g as Cl, T as js, i as Fs } from "./main-BY45iJ-a.js";
...
import { W as _l, V as Ws } from "./index-Dg8i5CvM.js";
import { S as Zs } from "./SendButton-js2q8opU.js";
import { W as Gs, M as _s } from "./MarketplaceProvider-T5PuS7pe.js";
function Ys({ routes: f, currentRouteName: c }) {
  const { pathname: g } = Ql(), y = Ol(), A = bA.isAuthenticated();
...
function Xs() {
  const [f, c] = B.useState(!1), g = bA.isAuthenticated(), y = Ol(), A = async () => {
    try {
      await as.post("/auth/logout"), bA.clearAllAuthData(), window.location.href = "/auth";
    } catch (m) {
      const P = Qs(m);
      zs.error(P.message);
    }
...
function Vs() {
  const { pathname: f } = Ql(), { t: c } = is(), g = Ol(), y = [
    {
    ...
    //   href: '/community',
    // },
  ], A = y.find((P) => f.startsWith(P.href)), m = (A == null ? void 0 : A.name) || "Home";
...
` && e.push(gn), l;
    ...
    var wt = Object.assign, FA = Symbol.for("react.element"), Ri = Symbol.for("react.portal"), $o = Symbol.for("react.fragment"), Pt = Symbol.for("react.strict_mode"), Mi = Symbol.for("react.profiler"), qo = Symbol.for("react.provider"), ea = Symbol.for("react.context"), ta = Symbol.for("react.forward_ref"), na = Symbol.for("react.suspense"), ao = Symbol.for("react.suspense_list"), io = Symbol.for("react.memo"), Fr = Symbol.for("react.lazy"), Ya = Symbol.for("react.scope"), Xa = Symbol.for("react.debug_trace_mode"), Va = Symbol.for("react.legacy_hidden"), ra = Symbol.for("react.default_value"), Qi = Symbol.iterator, LA = "@@iterator";
    function HA(e) {
...
` + aa + e;
    ...
    function ar(e, t) {
      ...
      var d;
      d = oa.current, oa.current = null, ji();
      try {
        if (t) {
          var p = function() {
            throw Error();
...
` + D[W].replace(" at new ", " at ");
        ...
        ni = !1, oa.current = d, Fi(), Error.prepareStackTrace = l;
      }
    ...
    var Wi = {}, Nr = {}, vo, li, fa, ha, pa, Ur, go, mo, va;
    {
...
` + o.stack;
    ...
    var Ca = g.ReactCurrentDispatcher, So = g.ReactDebugCurrentFrame, Da = 0, Wr = 1, Pa = 2, Ba = 3, ka = 4, Zr = 0, gi = 1, ur = 2, eA = 12800;
    function ll(e) {
    ...
    function Pi(e) {
      if (e.status !== ur) {
        ...
        try {
          ...
          qi(l), Ca.current = n, So.getCurrentStack = o, n === $i && po(t);
        }
      }
    }
    function fr(e, t, n) {
    ...
    Mo.renderToNodeStream = xl, Mo.renderToStaticMarkup = pA, Mo.renderToStaticNodeStream = r, Mo.renderToString = Sl, Mo.version = c;
  }()), Mo;
}
var gA = {}, Kl;
function qs() {
...
` && r.push(yn), o;
    ...
    var Pt = Object.assign, Mi = Symbol.for("react.element"), qo = Symbol.for("react.portal"), ea = Symbol.for("react.fragment"), ta = Symbol.for("react.strict_mode"), na = Symbol.for("react.profiler"), ao = Symbol.for("react.provider"), io = Symbol.for("react.context"), Fr = Symbol.for("react.forward_ref"), Ya = Symbol.for("react.suspense"), Xa = Symbol.for("react.suspense_list"), Va = Symbol.for("react.memo"), ra = Symbol.for("react.lazy"), Qi = Symbol.for("react.scope"), LA = Symbol.for("react.debug_trace_mode"), HA = Symbol.for("react.legacy_hidden"), NA = Symbol.for("react.default_value"), Ja = Symbol.iterator, Ue = "@@iterator";
    function Ao(r) {
    ...
    function lo() {
      {
        if (Lr === 0) {
          $a = console.log, qa = console.info, ei = console.warn, ti = console.error, ji = console.group, Fi = console.groupCollapsed, oa = console.groupEnd;
          var r = {
            configurable: !0,
            enumerable: !0,
            value: aa,
...
` + p[R].replace(" at new ", " at ");
    ...
    function zi(r, e) {
      ...
      if (t === null)
        throw new Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");
      r.depth === t.depth ? ho(r, t) : zi(r, t), da(e);
    }
    function Ln(r) {
      var e = Fn, t = r;
...
` + n.stack;
    ...
    var Pa = g.ReactCurrentDispatcher, Ba = g.ReactDebugCurrentFrame, ka = 0, Zr = 1, gi = 2, ur = 3, eA = 4, ll = 0, Gr = 1, _r = 2, sl = 12800;
    function ul(r) {
    ...
    gA.renderToReadableStream = xl, gA.version = c;
  }()), gA;
}
var Oo, Rl;
...
let ys = !1, Ml = "rcb-history", mA = 30, ws = !1, EA = [];
const yA = async (f) => {
  if (ws)
    return;
  ...
  for (let A = f.length - 1; A >= g; A--) {
    const m = f[A];
    if (m.sender === "system" || (m.content !== "" && c.unshift(m), c.length === mA))
      break;
  }
  let y = c.map(ac);
  if (y.length < mA) {
  ...
  var c, g, y;
  Ml = (c = f.chatHistory) == null ? void 0 : c.storageKey, mA = (g = f.chatHistory) == null ? void 0 : g.maxEntries, ws = (y = f.chatHistory) == null ? void 0 : y.disabled, EA = tc(localStorage.getItem(Ml));
  ...
  const { settings: A } = De(), { messages: m, setMessages: P } = Ll(), {
    ...
    return (re = A.event) != null && re.rcbStopStreamMessage && L(Ee.STOP_STREAM_MESSAGE, { messageToEndStreamFor: ue }).defaultPrevented ? !1 : (F.current.delete(Z), yA(m), !0);
...
const Nl = () => {
  ...
  C.onresult = (F) => {
    ...
    Un = setTimeout(() => Pl(c, m), H), (L = f.voice) != null && L.autoSendDisabled || (wA = setTimeout(g, k));
  }, C.onend = () => {
    Vr ? (C.start(), Un || (Un = setTimeout(() => Pl(c, m), H))) : (clearTimeout(Un), Un = null, clearTimeout(wA));
  ...
  B.useEffect(() => (window.addEventListener("click", Ae), window.addEventListener("keydown", Ae), window.addEventListener("touchstart", Ae), () => {
    ...
    (async (Ie, $e, nt) => {
      ...
      await Xu(
        ...
        L,
        ve
      ), ue(!1), "chatDisabled" in $e || Z((We = m.chatInput) == null ? void 0 : We.disabled), ce(typeof $e.file == "function"), Zt(Ie), tt(le.current && !$e.chatDisabled), Ce.current.clear(), yA(H);
    })(xe, ze, Pe);
  }, [_]), B.useEffect(() => {
    var xe;
