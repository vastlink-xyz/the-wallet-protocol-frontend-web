...
import { m as C, l as A, a as i } from "./vendor-react-DSEtE0wE.js";
import { B as r, a as O } from "./vendor-utils-Q0yJ_o1H.js";
import { f as o, g as U, B as f, L as u, k as V, a as M, h as N, o as W } from "./main-CXGbnggO.js";
import { L as E } from "./index-DHGdJzDo.js";
import { k as Y } from "./vendor-web3-CQEmmIwE.js";
function Q() {
  const [l] = C(), I = A(), [x, b] = i.useState(!1), [p, g] = i.useState(!1), [h, j] = i.useState(!1), [w, v] = i.useState(!1), [t, S] = i.useState(), [m, k] = i.useState("PENDING"), [T, R] = i.useState("");
  i.useEffect(() => {
    G();
  }, [l]), i.useEffect(() => {
    t && k(t.status);
  ...
  const G = async () => {
    ...
    a && s ? (R(s), P(a)) : r.error("inviteInfoId or otp is not existed.");
  }, P = async (a) => {
    try {
      v(!0);
      const s = await c(a);
  ...
  async function B() {
    ...
    try {
      g(!0), await L(a, T), await V.signUp({
        username: a
      });
  ...
  return /* @__PURE__ */ e.jsx("div", { className: "min-h-custom-main flex items-center justify-center", children: /* @__PURE__ */ e.jsxs("div", { className: "bg-white rounded-2xl px-4 md:px-12 py-8 mx-6 max-w-md w-full", children: [
    ...
    w ? /* @__PURE__ */ e.jsx(E, {}) : /* @__PURE__ */ e.jsx(e.Fragment, { children: t ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        ...
        /* @__PURE__ */ e.jsxs("div", { className: "text-center", children: [
          ...
          /* @__PURE__ */ e.jsx(
            f,
            {
              ...
              onClick: () => F(),
              disabled: h,
              children: h ? /* @__PURE__ */ e.jsx(u, {}) : "Accept Transfer"
            }
          )
        ] })
      ] }),
