...
import { r as s } from "./vendor-react-wyPiRY-L.js";
import { a as V, aj as je, g as c, V as Ie, m as _e, h as Re, ah as We, o as we, u as Oe } from "./main-CPzCMQxT.js";
import { W as qe, b as be, i as Me, U as Ne } from "./vendor-walletconnect-DUw8LJuH.js";
import { u as Ve, B as p } from "./vendor-utils-BSjbfJFn.js";
import { u as Ae } from "./useTransaction-15OHkkS7.js";
import { k as De, h as Ue } from "./vendor-web3-CFt7IwTK.js";
const J = s.createContext(void 0);
function Ge({ children: i }) {
  const { t: k } = Ve(), S = V.isAuthenticated(), [x, d] = s.useState(""), [E, P] = s.useState(), [f, h] = s.useState(), [H] = s.useState(je), [G, y] = s.useState(!1), [K, g] = s.useState(!1), [C, Q] = s.useState({ method: "", message: "", topic: "", response: {} }), [j, I] = s.useState(null), _ = s.useRef(null), [X, v] = s.useState(!1), [u, Y] = s.useState(null), { signTransaction: Z, waitForTransactionExection: ee, tokenTypeByChainId: se } = Ae(), [te, R] = s.useState(!1), [ne, A] = s.useState(!1), [oe, ae] = s.useState({ name: "", url: "" }), [W, w] = s.useState(!1), [t, re] = s.useState(), O = s.useRef(), [ce, q] = s.useState(!1), [ie, D] = s.useState(!1), [U, ue] = s.useState(null), le = (e) => {
    re(e), O.current = e;
  }, m = s.useCallback(() => {
    var n;
    ...
    c("proposal received", e), I(e), _.current = e, y(!0);
  }, []), L = (e) => {
    c("proposal_expire", e), $();
  }, M = s.useCallback(() => {
  ...
  const fe = async (e) => {
    ...
    try {
      ...
      h(Ee), w(!0), y(!1), R(!1), I(null), p.success(k("toastSuccess.connectSuccess"));
    } catch (r) {
    ...
    try {
      D(!0);
      const { hash: n } = await _e.signTransactionWithOTP({
        transactionId: U,
        otp: e
      });
      if (n) {
