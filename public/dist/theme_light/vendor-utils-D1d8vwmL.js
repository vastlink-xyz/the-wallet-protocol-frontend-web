import { g as ns, B as rs } from "./vendor-web3-CjewkP9U.js";
import { p as ce, a as F, e as J, r as rn, g as ss } from "./vendor-react-KTk2TwQ7.js";
import { c as Re } from "./vendor-ui-utils-C5-iOwQy.js";
function ir(t, e) {
  return function() {
    return t.apply(e, arguments);
  };
}
const { toString: is } = Object.prototype, { getPrototypeOf: sn } = Object, mt = /* @__PURE__ */ ((t) => (e) => {
  const n = is.call(e);
...
const or = ve("ArrayBuffer");
function as(t) {
  let e;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? e = ArrayBuffer.isView(t) : e = t && t.buffer && or(t.buffer), e;
}
const ls = yt("string"), de = yt("function"), ar = yt("number"), vt = (t) => t !== null && typeof t == "object", us = (t) => t === !0 || t === !1, st = (t) => {
  if (mt(t) !== "object")
    return !1;
  const e = sn(t);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(Symbol.toStringTag in t) && !(Symbol.iterator in t);
}, cs = ve("Date"), fs = ve("File"), ds = ve("Blob"), ps = ve("FileList"), hs = (t) => vt(t) && de(t.pipe), gs = (t) => {
  let e;
...
}, ms = ve("URLSearchParams"), [ys, vs, bs, Es] = ["ReadableStream", "Request", "Response", "Headers"].map(ve), ws = (t) => t.trim ? t.trim() : t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const Le = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : ns, ur = (t) => !He(t) && t !== Le;
function Ut() {
  const { caseless: t } = ur(this) && this || {}, e = {}, n = (r, s) => {
    const i = t && lr(e, s) || s;
...
const Ss = (t, e, n, { allOwnKeys: r } = {}) => (qe(e, (s, i) => {
  n && de(s) ? t[i] = ir(s, n) : t[i] = s;
}, { allOwnKeys: r }), t), Ts = (t) => (t.charCodeAt(0) === 65279 && (t = t.slice(1)), t), xs = (t, e, n, r) => {
  ...
  for (; e-- > 0; )
    n[e] = t[e];
  return n;
}, Ps = /* @__PURE__ */ ((t) => (e) => t && e instanceof t)(typeof Uint8Array < "u" && sn(Uint8Array)), Ls = (t, e) => {
  ...
  for (; (n = t.exec(e)) !== null; )
    r.push(n);
  return r;
}, Ns = ve("HTMLFormElement"), _s = (t) => t.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), gn = (({ hasOwnProperty: t }) => (e, n) => t.call(e, n))(Object.prototype), Is = ve("RegExp"), cr = (t, e) => {
...
}, Bs = (t, e) => t != null && Number.isFinite(t = +t) ? t : e, Ct = "abcdefghijklmnopqrstuvwxyz", mn = "0123456789", fr = {
  DIGIT: mn,
  ALPHA: Ct,
  ALPHA_DIGIT: Ct + Ct.toUpperCase() + mn
}, Ms = (t = 16, e = fr.ALPHA_DIGIT) => {
  let n = "";
  const { length: r } = e;
  for (; t--; )
    n += e[Math.random() * r | 0];
...
const js = (t) => {
  ...
  return n(t, 0);
}, Us = ve("AsyncFunction"), Hs = (t) => t && (vt(t) || de(t)) && de(t.then) && de(t.catch), dr = ((t, e) => t ? setImmediate : e ? ((n, r) => (Le.addEventListener("message", ({ source: s, data: i }) => {
  ...
  de(Le.postMessage)
), zs = typeof queueMicrotask < "u" ? queueMicrotask.bind(Le) : typeof ce < "u" && ce.nextTick || dr, g = {
  isArray: $e,
  isArrayBuffer: or,
  isBuffer: os,
  isFormData: gs,
...
function yn(t, e, n) {
  return t ? t.concat(e).map(function(s, i) {
    return s = gr(s), !n && i ? "[" + s + "]" : s;
  }).join(n ? "." : "") : e;
}
function Ks(t) {
  return g.isArray(t) && !t.some(Ht);
}
const qs = g.toFlatObject(g, {}, null, function(e) {
...
function bt(t, e, n) {
  ...
  function u(p, m, h) {
    ...
    if (p && !h && typeof p == "object") {
      ...
      else if (g.isArray(p) && Ks(p) || (g.isFileList(p) || g.endsWith(m, "[]")) && (w = g.toArray(p)))
        return m = gr(m), w.forEach(function(E, T) {
          !(g.isUndefined(E) || E === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            o === !0 ? yn([m], T, i) : o === null ? m : m + "[]",
            c(E)
          );
        }), !1;
    }
    return Ht(p) ? !0 : (e.append(yn(h, m, i), c(p)), !1);
  }
  const d = [], f = Object.assign(qs, {
    defaultVisitor: u,
    convertValue: c,
    isVisitable: Ht
  });
...
}, Ws = typeof URLSearchParams < "u" ? URLSearchParams : on, Ys = typeof FormData < "u" ? FormData : null, Qs = typeof Blob < "u" ? Blob : null, Xs = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Ws,
    FormData: Ys,
...
}, an = typeof window < "u" && typeof document < "u", zt = typeof navigator == "object" && navigator || void 0, Gs = an && (!zt || ["ReactNative", "NativeScript", "NS"].indexOf(zt.product) < 0), Zs = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", ei = an && window.location.href || "http://localhost", ti = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: an,
...
function br(t) {
  function e(n, r, s, i) {
    ...
    return o = !o && g.isArray(s) ? s.length : o, l ? (g.hasOwnProp(s, o) ? s[o] = [s[o], r] : s[o] = r, !a) : ((!s[o] || !g.isObject(s[o])) && (s[o] = []), e(n, r, s[o], i) && g.isArray(s[o]) && (s[o] = si(s[o])), !a);
  }
...
const Je = {
  ...
  transformRequest: [function(e, n) {
    ...
    if (i && g.isHTMLForm(e) && (e = new FormData(e)), g.isFormData(e))
      return s ? JSON.stringify(br(e)) : e;
    ...
    return i || s ? (n.setContentType("application/json", !1), ii(e)) : e;
  }],
...
const oi = g.toObjectSet([
  ...
  return t && t.split(`
`).forEach(function(o) {
    s = o.indexOf(":"), n = o.substring(0, s).trim().toLowerCase(), r = o.substring(s + 1).trim(), !(!n || e[n] && oi[n]) && (n === "set-cookie" ? e[n] ? e[n].push(r) : e[n] = [r] : e[n] = e[n] ? e[n] + ", " + r : r);
  }), e;
}, En = Symbol("internals");
function Me(t) {
...
class le {
  ...
  set(e, n, r) {
    ...
    if (g.isPlainObject(e) || e instanceof this.constructor)
      o(e, n);
    else if (g.isString(e) && (e = e.trim()) && !ui(e))
      o(ai(e), n);
...
}, Sn = (t) => (...e) => g.asap(() => t(...e)), gi = ae.hasStandardBrowserEnv ? (
...
function Sr(t, e) {
  return t && !yi(e) ? vi(t, e) : e;
}
const Tn = (t) => t instanceof le ? { ...t } : t;
function Ie(t, e) {
  e = e || {};
  const n = {};
  function r(c, u, d) {
...
const Tr = (t) => {
  ...
  e.headers = o = le.from(o), e.url = yr(Sr(e.baseURL, e.url), t.params, t.paramsSerializer), a && o.set(
    "Authorization",
  ...
  if (ae.hasStandardBrowserEnv && (r && g.isFunction(r) && (r = r(e)), r || r !== !1 && gi(e.url))) {
    const c = s && i && mi.read(i);
    c && o.set(s, c);
  }
  return e;
...
}, Et = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", xr = Et && typeof ReadableStream == "function", Oi = Et && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((t) => (e) => t.encode(e))(new TextEncoder()) : async (t) => new Uint8Array(await new Response(t).arrayBuffer())), Or = (t, ...e) => {
  try {
    return !!t(...e);
  } catch {
    return !1;
  ...
  return t && !e;
}), On = 64 * 1024, Vt = xr && Or(() => g.isReadableStream(new Response("").body)), ut = {
  stream: Vt && ((t) => t.body)
};
Et && ((t) => {
...
const Ci = async (t) => {
  ...
  let y = wi([s, i && i.toAbortSignal()], o), p;
  const m = y && y.unsubscribe && (() => {
    y.unsubscribe();
  });
  let h;
  try {
    if (l && Ri && n !== "get" && n !== "head" && (h = await Pi(u, r)) !== 0) {
      let v = new Request(e, {
        method: "POST",
        body: r,
        duplex: "half"
    ...
    if (Vt && (a || E && m)) {
      ...
      const B = g.toFiniteNumber(S.headers.get("content-length")), [L, R] = a && wn(
        B,
        lt(Sn(a), !0)
      ) || [];
      S = new Response(
...
const Rn = (t) => `- ${t}`, Ai = (t) => g.isFunction(t) || t === null || t === !1, Rr = {
  getAdapter: (t) => {
    t = g.isArray(t) ? t : [t];
    const { length: e } = t;
    let n, r;
    ...
    for (let i = 0; i < e; i++) {
      n = t[i];
      let o;
      if (r = n, !Ai(n) && (r = Kt[(o = String(n)).toLowerCase()], r === void 0))
...
function Cn(t) {
  return At(t), t.headers = le.from(t.headers), t.data = Lt.call(
    t,
    t.transformRequest
  ), ["post", "put", "patch"].indexOf(t.method) !== -1 && t.headers.setContentType("application/x-www-form-urlencoded", !1), Rr.getAdapter(t.adapter || Je.adapter)(t).then(function(r) {
    ...
    return Er(r) || (At(t), r && r.response && (r.response.data = Lt.call(
      t,
      t.transformResponse,
      r.response
...
ln.transitional = function(e, n, r) {
  function s(i, o) {
    return "[Axios v" + Cr + "] Transitional option '" + i + "'" + o + (r ? ". " + r : "");
  }
  return (i, o, a) => {
    if (e === !1)
      throw new $(
    ...
    return n && !Pn[o] && (Pn[o] = !0, console.warn(
      s(
        o,
...
function Pr(t) {
  const e = new Ae(t), n = ir(Ae.prototype.request, e);
...
G.mergeConfig = Ie;
G.AxiosHeaders = le;
G.formToJSON = (t) => br(g.isHTMLForm(t) ? new FormData(t) : t);
G.getAdapter = Rr.getAdapter;
G.HttpStatusCode = Jt;
G.default = G;
const Di = (...t) => {
  console != null && console.warn && (Ne(t[0]) && (t[0] = `react-i18next:: ${t[0]}`), console.warn(...t));
}, Ln = {}, Wt = (...t) => {
  Ne(t[0]) && Ln[t[0]] || (Ne(t[0]) && (Ln[t[0]] = /* @__PURE__ */ new Date()), Di(...t));
}, Lr = (t, e) => () => {
  if (t.isInitialized)
    e();
  else {
...
}, ki = (t, e, n = {}) => !e.languages || !e.languages.length ? (Wt("i18n.languages were undefined or empty", e.languages), !0) : e.hasLoadedNamespace(t, {
  lng: n.lng,
  precheck: (r, s) => {
    var i;
...
}), Ne = (t) => typeof t == "string", $i = (t) => typeof t == "object" && t !== null, Bi = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Mi = {
  "&amp;": "&",
  "&#38;": "&",
  "&lt;": "<",
  "&#60;": "<",
  ...
  "&#x2F;": "/",
  "&#47;": "/"
}, Fi = (t) => Mi[t], ji = (t) => t.replace(Bi, Fi);
let Yt = {
...
const qi = (t, e) => {
...
}, _r = (t, e, n, r) => t.getFixedT(e, n, r), Ji = (t, e, n, r) => F.useCallback(_r(t, e, n, r), [t, e, n, r]), Da = (t, e = {}) => {
  var T, v, B, L;
  const {
    i18n: n
  } = e, {
  ...
  if (i && !i.reportNamespaces && (i.reportNamespaces = new Ki()), !i) {
    ...
    const R = (U, H) => Ne(H) ? H : $i(H) && Ne(H.defaultValue) ? H.defaultValue : Array.isArray(U) ? U[U.length - 1] : U, _ = [R, {}, !1];
  ...
  const u = (i.isInitialized || i.initializedStoreOnce) && c.every((R) => ki(R, i, o)), d = Ji(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), f = () => d, y = () => _r(i, e.lng || null, o.nsMode === "fallback" ? c : c[0], l), [p, m] = F.useState(f);
  let h = c.join();
  e.lng && (h = `${e.lng}${h}`);
  const w = qi(h), S = F.useRef(!0);
  F.useEffect(() => {
    const {
      bindI18n: R,
      bindI18nStore: _
    } = o;
    S.current = !0, !u && !a && (e.lng ? Nn(i, e.lng, c, () => {
      S.current && m(y);
    }) : An(i, c, () => {
      S.current && m(y);
...
function ka({
  ...
  return F.createElement(Nr.Provider, {
    value: r
  }, n);
}
const ze = (t) => typeof t == "number" && !isNaN(t), _e = (t) => typeof t == "string", fe = (t) => typeof t == "function", ot = (t) => _e(t) || fe(t) ? t : null, Qt = (t) => F.isValidElement(t) || _e(t) || fe(t) || ze(t);
function Wi(t, e, n) {
  n === void 0 && (n = 300);
...
function wt(t) {
  ...
  return function(o) {
    ...
    return F.useLayoutEffect(() => {
      ...
      const w = d.current, S = () => {
        w.removeEventListener("animationend", S), s ? Wi(w, u, i) : u();
      };
...
let Ve = [];
const Xt = /* @__PURE__ */ new Set(), Yi = (t) => Xt.forEach((e) => e(t)), Ir = () => se.size > 0;
function Dr(t, e) {
  var n;
...
function kr(t, e) {
  Qt(t) && (Ir() || Ve.push({ content: t, options: e }), se.forEach((n) => {
    n.buildToast(t, e);
  }));
}
function In(t, e) {
...
function Qi(t) {
    ...
    return { subscribe(a) {
      const l = /* @__PURE__ */ function(u, d, f) {
        ...
        const E = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Set(), v = () => {
          ...
          R.staleId && E.delete(R.staleId), E.set(_, R), h = [...h, R.props.toastId].filter((Y) => Y !== R.staleId), v(), f(_n(R, he ? "added" : "updated")), he && fe(U) && U(F.isValidElement(ue) && ue.props);
        };
        return { id: u, props: S, observe: (R) => (T.add(R), () => T.delete(R)), toggle: (R, _) => {
          ...
          const X = { ...S, style: S.toastStyle, key: y++, ...Object.fromEntries(Object.entries(_).filter((A) => {
            ...
            fe(P) && P(F.isValidElement(C) && C.props), f(_n(A, "removed")), E.delete(U), p--, p < 0 && (p = 0), m.length > 0 ? L(m.shift()) : v();
          } };
          var q, Z;
          ...
          let b = R;
          F.isValidElement(R) && !_e(R.type) ? b = F.cloneElement(R, { closeToast: re, toastProps: X, data: ue }) : fe(R) && (b = R({ closeToast: re, toastProps: X, data: ue }));
      ...
      se.set(o, l);
      const c = l.observe(a);
      return Ve.forEach((u) => kr(u.content, u.options)), Ve = [], () => {
        c(), se.delete(o);
      };
    }, setProps(a) {
      var l;
  ...
  }, isToastActive: Dr, count: s == null ? void 0 : s.length };
}
function Xi(t) {
...
const $r = () => "" + Zi++;
function eo(t) {
  return t && (_e(t.toastId) || ze(t.toastId)) ? t.toastId : $r();
}
function je(t, e) {
  return kr(t, e), e.toastId;
}
function ct(t, e) {
  return { ...e, type: e && e.type || t, toastId: eo(e) };
}
function Qe(t) {
...
W.loading = (t, e) => je(t, ct("default", { isLoading: !0, autoClose: !1, closeOnClick: !1, closeButton: !1, draggable: !1, ...e })), W.promise = function(t, e, n) {
...
}, W.isActive = Dr, W.update = function(t, e) {
  e === void 0 && (e = {});
  const n = ((r, s) => {
    var i;
    let { containerId: o } = s;
  ...
  if (n) {
    const { props: r, content: s } = n, i = { delay: 100, ...r, ...e, toastId: e.toastId || t, updateId: $r() };
...
}, W.play = (t) => In(!0, t), W.pause = (t) => In(!1, t);
const to = typeof window < "u" ? F.useLayoutEffect : F.useEffect, Xe = (t) => {
  ...
  }(Z)), J.createElement(y, { isIn: H, done: U, position: p, preventExitTransition: n, nodeRef: r, playToast: i }, J.createElement("div", { id: _, onClick: c, "data-in": H, className: Q, ...s, style: h, ref: r }, J.createElement("div", { ...H && { role: B }, className: fe(w) ? w({ type: u }) : Re("Toastify__toast-body", w), style: S }, X != null && J.createElement("div", { className: Re("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !ue }) }, X), J.createElement("div", null, a)), b, J.createElement(Gi, { ...v && !q ? { key: `pb-${v}` } : {}, rtl: R, theme: Y, delay: l, isRunning: e, isIn: H, closeToast: f, hide: d, type: u, style: T, className: E, controlledProgress: q, progress: L || 0 })));
}, St = function(t, e) {
...
const $a = wt(St("zoom"));
wt(St("flip"));
const so = { position: "top-right", transition: ro, autoClose: 5e3, closeButton: !0, pauseOnHover: !0, pauseOnFocusLoss: !0, draggable: "touch", draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light" };
function Ba(t) {
  let e = { ...so, ...t };
  const n = t.stacked, [r, s] = F.useState(!0), i = F.useRef(null), { getToastToRender: o, isToastActive: a, count: l } = Qi(e), { className: c, style: u, rtl: d, containerId: f } = e;
  function y(m) {
  ...
  return to(() => {
    ...
    return J.createElement("div", { className: y(m), style: w, key: `container-${m}` }, h.map((S) => {
      ...
      return J.createElement(no, { ...T, stacked: n, collapseAll: p, isIn: a(T.toastId, T.containerId), style: T.style, key: `toast-${T.key}` }, E);
    }));
  }));
}
const I = (t) => typeof t == "string", Fe = () => {
...
}, Dn = (t) => t == null ? "" : "" + t, io = (t, e, n) => {
  t.forEach((r) => {
    e[r] && (n[r] = e[r]);
  });
}, oo = /###/g, kn = (t) => t && t.indexOf("###") > -1 ? t.replace(oo, ".") : t, $n = (t) => !t || I(t), Ue = (t, e, n) => {
  ...
  for (const r in e)
    r !== "__proto__" && r !== "constructor" && (r in t ? I(t[r]) || t[r] instanceof String || I(e[r]) || e[r] instanceof String ? n && (t[r] = e[r]) : Br(t[r], e[r], n) : t[r] = e[r]);
  return t;
}, De = (t) => t.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
var uo = {
  "&": "&amp;",
...
const co = (t) => I(t) ? t.replace(/[&<>"'\/]/g, (e) => uo[e]) : t;
class fo {
  constructor(e) {
...
const po = [" ", ",", "?", "!", ";"], ho = new fo(20), go = (t, e, n) => {
  e = e || "", n = n || "";
  const r = po.filter((o) => e.indexOf(o) < 0 && n.indexOf(o) < 0);
  if (r.length === 0) return !0;
  const s = ho.getRegExp(`(${r.map((o) => o === "?" ? "\\?" : o).join("|")})`);
  let i = !s.test(t);
  if (!i) {
    const o = t.indexOf(n);
...
class pt {
  ...
  init(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.prefix = n.prefix || "i18next:", this.logger = e || mo, this.options = n, this.debug = n.debug;
  }
  log() {
...
class Mn extends Tt {
  ...
  addResourceBundle(e, n, r, s, i) {
    ...
    o.skipCopy || (r = JSON.parse(JSON.stringify(r))), s ? Br(l, r, i) : l = {
      ...l,
      ...r
...
class ht extends Tt {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    super(), io(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = n, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = we.create("translator");
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  extractFromKey(e, n) {
    ...
    const o = r && e.indexOf(r) > -1, a = !this.options.userDefinedKeySeparator && !n.keySeparator && !this.options.userDefinedNsSeparator && !n.nsSeparator && !go(e, r, s);
    if (o && !a) {
  ...
  extendTranslation(e, n, r, s, i) {
    ...
    return e != null && l && l.length && r.applyPostProcessor !== !1 && (e = Mr.handle(l, e, n, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...s,
  ...
  resolve(e) {
    ...
    return I(e) && (e = [e]), e.forEach((l) => {
      ...
      d.forEach((h) => {
        this.isValidLookup(r) || (a = h, !Fn[`${m[0]}-${h}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(a) && (Fn[`${m[0]}-${h}`] = !0, this.logger.warn(`key "${s}" for languages "${m.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach((w) => {
          if (this.isValidLookup(r)) return;
          o = w;
          const S = [u];
...
class So {
  constructor(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.languageUtils = e, this.options = n, this.logger = we.create("pluralResolver"), (!this.options.compatibilityJSON || Eo.includes(this.options.compatibilityJSON)) && (typeof Intl > "u" || !Intl.PluralRules) && (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = wo(), this.pluralRulesCache = {};
  }
  addRule(e, n) {
    this.rules[e] = n;
  }
  ...
  getSuffixes(e) {
    let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const r = this.getRule(e, n);
    return r ? this.shouldUseIntlApi() ? r.resolvedOptions().pluralCategories.sort((s, i) => Un[s] - Un[i]).map((s) => `${this.options.prepend}${n.ordinal ? `ordinal${this.options.prepend}` : ""}${s}`) : r.numbers.map((s) => this.getSuffix(e, s, n)) : [];
  }
  getSuffix(e, n) {
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  ...
  shouldUseIntlApi() {
    return !bo.includes(this.options.compatibilityJSON);
  }
}
const Hn = function(t, e, n) {
  let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : ".", s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, i = lo(t, e, n);
...
class To {
  ...
  init() {
    ...
    this.escape = n !== void 0 ? n : co, this.escapeValue = r !== void 0 ? r : !0, this.useRawValueToEscape = s !== void 0 ? s : !1, this.prefix = i ? De(i) : o || "{{", this.suffix = a ? De(a) : l || "}}", this.formatSeparator = c || ",", this.unescapePrefix = u ? "" : d || "-", this.unescapeSuffix = this.unescapePrefix ? "" : u || "", this.nestingPrefix = f ? De(f) : y || De("$t("), this.nestingSuffix = p ? De(p) : m || De(")"), this.nestingOptionsSeparator = h || ",", this.maxReplaces = w || 1e3, this.alwaysFormat = S !== void 0 ? S : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, n, r, s) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = (y) => {
      if (y.indexOf(this.formatSeparator) < 0) {
        const w = Hn(n, l, y, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      return this.format(Hn(n, l, m, this.options.keySeparator, this.options.ignoreJSONStructure), h, r, {
        ...s,
        ...n,
        interpolationkey: m
      });
    ...
    return [{
      ...
      for (a = 0; i = y.regex.exec(e); ) {
        ...
        else !I(o) && !this.useRawValueToEscape && (o = Dn(o));
  ...
  nest(e, n) {
    ...
    for (; s = this.nestingRegexp.exec(e); ) {
      ...
      I(i) || (i = Dn(i)), i || (this.logger.warn(`missed to resolve ${s[1]} for nesting ${e}`), i = ""), c && (i = l.reduce((u, d) => this.format(u, d, r.lng, {
        ...r,
...
class Co extends Tt {
  ...
  loaded(e, n, r) {
    ...
    this.queue.forEach((l) => {
      ao(l.loaded, [i], o), Ro(l, e), n && l.errors.push(n), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((c) => {
        a[c] || (a[c] = {});
        const u = l.loaded[c];
...
}), Vn = (t) => (I(t.ns) && (t.ns = [t.ns]), I(t.fallbackLng) && (t.fallbackLng = [t.fallbackLng]), I(t.fallbackNS) && (t.fallbackNS = [t.fallbackNS]), t.supportedLngs && t.supportedLngs.indexOf("cimode") < 0 && (t.supportedLngs = t.supportedLngs.concat(["cimode"])), t), Ge = () => {
}, Po = (t) => {
...
class Ke extends Tt {
  constructor() {
    ...
    if (super(), this.options = Vn(e), this.services = {}, this.logger = we, this.modules = {
      external: []
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      let u;
      this.modules.formatter ? u = this.modules.formatter : typeof Intl < "u" && (u = Oo);
      const d = new jn(this.options);
      this.store = new Mn(this.options.resources, this.options);
      const f = this.services;
      f.logger = we, f.resourceStore = this.store, f.languageUtils = d, f.pluralResolver = new So(d, {
        prepend: this.options.pluralSeparator,
        compatibilityJSON: this.options.compatibilityJSON,
        simplifyPluralSuffix: this.options.simplifyPluralSuffix
      }), u && (!this.options.interpolation.format || this.options.interpolation.format === s.interpolation.format) && (f.formatter = i(u), f.formatter.init(f, this.options), this.options.interpolation.format = f.formatter.format.bind(f.formatter)), f.interpolator = new To(this.options), f.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, f.backendConnector = new Co(i(this.modules.backend), f.resourceStore, f, this.options), f.backendConnector.on("*", function(y) {
  ...
  use(e) {
    ...
    return e.type === "backend" && (this.modules.backend = e), (e.type === "logger" || e.log && e.warn && e.error) && (this.modules.logger = e), e.type === "languageDetector" && (this.modules.languageDetector = e), e.type === "i18nFormat" && (this.modules.i18nFormat = e), e.type === "postProcessor" && Mr.addPostProcessor(e), e.type === "formatter" && (this.modules.formatter = e), e.type === "3rdParty" && this.modules.external.push(e), this;
  }
  ...
  dir(e) {
    ...
    const n = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], r = this.services && this.services.languageUtils || new jn(zn());
  ...
  cloneInstance() {
    ...
    }, r && (i.store = new Mn(this.store.data, s), i.services.resourceStore = i.store), i.translator = new ht(i.services, s), i.translator.on("*", function(a) {
