...
import { k as b, j as w, r as o } from "./vendor-react-CwfAKKXk.js";
import { f, T as k, B as d, L as C, v as S, g as u } from "./main-BgKFo9t1.js";
import { B as L } from "./vendor-utils-BxJrQXPu.js";
import { u as R } from "./useTransaction-KCBu6XjJ.js";
import { L as B } from "./index-Cdpry7qW.js";
import { f as x } from "./vendor-web3-BOaXhAzJ.js";
function V() {
  const [i] = b(), h = w(), { signTransaction: p, waitForTransactionExection: g } = R(), [s, v] = o.useState(), [r, I] = o.useState("PENDING"), [c, l] = o.useState(!1), j = o.useRef();
  o.useEffect(() => {
    T();
  }, [i]), o.useEffect(() => {
    s && I(s.status);
