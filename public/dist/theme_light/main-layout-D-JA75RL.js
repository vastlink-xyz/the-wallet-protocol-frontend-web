import { j as g, S as dA, d as fA, P as ru, C as pA, I as hA, g as vA, i as gA, k as mA, L as yA, l as wA, m as ou, T as au } from "./vendor-radix-DcfHr-b-.js";
import { l as at, a as Jl, u as bA } from "./main-BQRn5y6W.js";
import { c as Oe } from "./style-JRa9Y8f9.js";
import { r as D, k as SA, j as iu, L as Kl, a as su, p as Nl, O as lu } from "./vendor-react-Cqw-pUgZ.js";
import { C as Au, a as uu, b as cu, X as du } from "./vendor-ui-utils-D8A1AlyV.js";
import { B as La } from "./button-CkT6Skev.js";
import { u as Bs, B as Qi } from "./vendor-utils-BEOEHg0B.js";
import { a as xA } from "./auth-BKVikp7y.js";
import { f as fu, h as pu, W as hu, b as vu, i as gu, U as mu } from "./vendor-web3-DM8VQNRv.js";
import { D as Ml, a as Ql, b as jl, c as Ol, d as Fl, e as $l } from "./dialog-DaOj3jrs.js";
import { u as yu } from "./useTransaction-BAI2GgHF.js";
import { I as wu } from "./input-DUNQ4sEs.js";
import { L as ql } from "./index-YZ-oGsCe.js";
import { T as bu } from "./transaction-Dz01ddzF.js";
import { s as Su, f as xu } from "./transaction-CEOvBeKV.js";
import { T as Eu } from "./TokenService-hl2efiyX.js";
import { a as Cu } from "./index-DEOj28UY.js";
import { S as Du, a as Pu } from "./SendModal-C1KU5wb4.js";
import { M as Tu } from "./MarketplaceProvider-CPl4YILM.js";
const EA = ou, CA = au, ku = D.forwardRef(({ className: f, inset: A, children: p, ...y }, s) => /* @__PURE__ */ g.jsxs(
  dA,
  {
    ref: s,
    className: Oe(
    ...
    children: [
      p,
      /* @__PURE__ */ g.jsx(Au, { className: "ml-auto h-4 w-4" })
    ]
  }
));
ku.displayName = dA.displayName;
const Bu = D.forwardRef(({ className: f, ...A }, p) => /* @__PURE__ */ g.jsx(
  fA,
  {
    ref: p,
    className: Oe(
...
const Ul = D.forwardRef(({ className: f, sideOffset: A = 4, ...p }, y) => /* @__PURE__ */ g.jsx(ru, { children: /* @__PURE__ */ g.jsx(
  pA,
  {
    ref: y,
    sideOffset: A,
...
Ha.displayName = hA.displayName;
const Iu = D.forwardRef(({ className: f, children: A, checked: p, ...y }, s) => /* @__PURE__ */ g.jsxs(
  vA,
  {
    ref: s,
    className: Oe(
    ...
    ...y,
    children: [
      /* @__PURE__ */ g.jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ g.jsx(gA, { children: /* @__PURE__ */ g.jsx(uu, { className: "h-4 w-4" }) }) }),
      A
    ]
  }
));
Iu.displayName = vA.displayName;
const Ru = D.forwardRef(({ className: f, children: A, ...p }, y) => /* @__PURE__ */ g.jsxs(
  mA,
  {
    ref: y,
    className: Oe(
    ...
    ...p,
    children: [
      /* @__PURE__ */ g.jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ g.jsx(gA, { children: /* @__PURE__ */ g.jsx(cu, { className: "h-2 w-2 fill-current" }) }) }),
      A
    ]
  }
));
Ru.displayName = mA.displayName;
const Mu = D.forwardRef(({ className: f, inset: A, ...p }, y) => /* @__PURE__ */ g.jsx(
  yA,
  {
    ref: y,
    className: Oe(
...
const Qu = D.forwardRef(({ className: f, ...A }, p) => /* @__PURE__ */ g.jsx(
  wA,
  {
    ref: p,
...
function ju({ routes: f, currentRouteName: A }) {
  const { pathname: p } = SA(), y = iu();
  return /* @__PURE__ */ g.jsxs(g.Fragment, { children: [
    /* @__PURE__ */ g.jsx("div", { className: Oe(
      ...
      return /* @__PURE__ */ g.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ g.jsx(Kl, { className: Oe(
    ...
    /* @__PURE__ */ g.jsx("div", { className: Oe("flex tablet:hidden"), children: /* @__PURE__ */ g.jsxs(EA, { children: [
      /* @__PURE__ */ g.jsx(CA, { asChild: !0, children: /* @__PURE__ */ g.jsxs("div", { className: "h-7 justify-start items-center gap-1 inline-flex", children: [
      ...
      /* @__PURE__ */ g.jsx(Ul, { className: "bg-white", children: f.map((s) => {
        const b = p.startsWith(s.href);
        return /* @__PURE__ */ g.jsx(
          Ha,
          {
            ...
            children: b ? /* @__PURE__ */ g.jsxs(Kl, { to: s.href, className: "flex items-center gap-2", children: [
...
function eA({
  ...
  const { i18n: A } = Bs(), [p, y] = D.useState(!1);
  D.useEffect(() => {
    const T = Jl.getData();
    T && A.changeLanguage(T);
  }, [A]);
  const s = (T) => {
    A.changeLanguage(T), Jl.setData(T), y(!1), f == null || f();
...
function Ou({
  ...
  const { t: A } = Bs(), [p, y] = D.useState(""), [s, b] = D.useState(""), {
    isModalOpen: T,
    dappInfo: C,
    setIsModalOpen: w,
    displayUriInput: x
    ...
    Ml,
    {
      ...
      children: /* @__PURE__ */ g.jsxs(
        Ql,
        {
          ...
          children: [
            /* @__PURE__ */ g.jsxs(jl, { children: [
              /* @__PURE__ */ g.jsx(Ol, { children: A("vastWalletConnect.pairModal.title") }),
              /* @__PURE__ */ g.jsx(Fl, {})
            ] }),
...
function tA({ className: f }) {
  const { t: A } = Bs(), [p, y] = D.useState(""), [s, b] = D.useState(), [T, C] = D.useState(), [w] = D.useState(Su), [x, L] = D.useState(!1), [k, Q] = D.useState(!1), [N, H] = D.useState({ method: "", message: "", topic: "", response: {} }), [W, j] = D.useState(null), B = D.useRef(null), [V, ne] = D.useState(!1), [Y, _] = D.useState(null), { signTransaction: $, waitForTransactionExection: Z, tokenTypeByChainId: oe } = yu(), {
    setIsModalOpen: re,
    isConnected: Ae,
    setIsConnected: ie,
    web3wallet: q,
    ...
    const ve = new vu({ projectId: "b3feb6b7c0ea5530a6eaa11d45fb4293" }), ue = await gu.init({
      core: ve,
  ...
  return /* @__PURE__ */ g.jsxs("div", { className: "", children: [
    ...
    /* @__PURE__ */ g.jsx(
      Ml,
      {
        ...
        children: /* @__PURE__ */ g.jsxs(Ql, { className: "sm:max-w-[425px] text-primary", children: [
          /* @__PURE__ */ g.jsxs(jl, { children: [
            /* @__PURE__ */ g.jsx(Ol, { children: A("vastWalletConnect.connectAccount") }),
            /* @__PURE__ */ g.jsx(Fl, { children: W == null ? void 0 : W.params.proposer.metadata.name })
          ] }),
          ...
          /* @__PURE__ */ g.jsxs($l, { children: [
            /* @__PURE__ */ g.jsx(La, { onClick: le, variant: "outline", children: A("vastWalletConnect.reject") }),
            /* @__PURE__ */ g.jsx(La, { onClick: De, children: k ? /* @__PURE__ */ g.jsx(ql, {}) : A("vastWalletConnect.approve") })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ g.jsx(
      Ml,
      {
        ...
        children: /* @__PURE__ */ g.jsxs(Ql, { className: "sm:max-w-[425px] text-primary", children: [
          /* @__PURE__ */ g.jsxs(jl, { children: [
            /* @__PURE__ */ g.jsx(Ol, { children: "Confirm Transfer" }),
            /* @__PURE__ */ g.jsx(Fl, { children: "Please review the transfer details below" })
          ] }),
          ...
          /* @__PURE__ */ g.jsxs($l, { children: [
            ...
            /* @__PURE__ */ g.jsx(La, { onClick: He, disabled: k, children: k ? /* @__PURE__ */ g.jsx(ql, {}) : "Confirm" })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ g.jsx(Ou, { onPair: Fe })
  ] });
}
function Fu() {
  const [f, A] = D.useState(!1);
  return /* @__PURE__ */ g.jsxs("div", { className: "justify-start items-center gap-[21px] flex", children: [
    /* @__PURE__ */ g.jsx("div", { className: "hidden tablet:flex", children: /* @__PURE__ */ g.jsx(tA, {}) }),
    /* @__PURE__ */ g.jsxs("div", { className: "justify-start items-center gap-7 flex", children: [
      /* @__PURE__ */ g.jsx("div", { className: Oe(
        "hidden tablet:flex",
        "justify-start items-center gap-6"
      ), children: /* @__PURE__ */ g.jsx("div", { className: "py-2 justify-start items-center gap-2 flex", children: /* @__PURE__ */ g.jsx("div", { className: "text-[#a1a1a1] text-base font-medium leading-none", children: "Learn" }) }) }),
      /* @__PURE__ */ g.jsx("div", { className: "laptop:hidden", children: /* @__PURE__ */ g.jsxs(
        EA,
        {
          ...
          onOpenChange: A,
          children: [
            /* @__PURE__ */ g.jsx(CA, { asChild: !0, children: /* @__PURE__ */ g.jsx("button", { className: "w-6 h-6 flex items-center justify-center", children: /* @__PURE__ */ g.jsx("img", { src: "/imgs/icons/menu.svg", className: "w-6 h-6" }) }) }),
            /* @__PURE__ */ g.jsxs(Ul, { className: "bg-white border-none", children: [
              /* @__PURE__ */ g.jsx(
                Ha,
                {
                  className: Oe("flex tablet:hidden"),
                  onSelect: (p) => p.preventDefault(),
                  children: /* @__PURE__ */ g.jsx(tA, { className: "p-0 bg-transparent" })
                }
              ),
              /* @__PURE__ */ g.jsx(
                Ha,
              ...
              /* @__PURE__ */ g.jsx(
                ...
                {
                  onSelect: (p) => p.preventDefault(),
                  children: /* @__PURE__ */ g.jsx(eA, { onLanguageChange: () => A(!1) })
                }
              )
            ] })
          ]
      ...
      ), children: /* @__PURE__ */ g.jsx(eA, {}) })
    ] })
  ] });
}
function Lu() {
  const { pathname: f } = SA(), { t: A } = Bs(), p = [
    {
...
var jo = {}, oA;
function Uu() {
  return oA || (oA = 1, Nl.env.NODE_ENV !== "production" && function() {
    var f = D, A = "18.3.1", p = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function y(e) {
      {
...
` && e.push(mn), l;
    ...
    function Ja(e) {
      ...
      return t.replace(js, function(n) {
        switch (n) {
          case "<":
            return "\\u003c";
          case "\u2028":
    ...
    function Ze(e) {
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          ...
          case oa:
            return Gs(e, e.render, "ForwardRef");
          case lo:
...
Please update the following components: %s`,
    ...
    function qi(e, t, n, o) {
      ...
      typeof R == "function" && (e.state = fi(e, t, R, l, n)), typeof t.getDerivedStateFromProps != "function" && typeof e.getSnapshotBeforeUpdate != "function" && (typeof e.UNSAFE_componentWillMount == "function" || typeof e.componentWillMount == "function") && ($i(t, e), Xs(d, e, n, o));
    }
    var Vs = {
      id: 1,
      overflow: ""
    ...
    function Js(e) {
      var t = e.overflow, n = e.id, o = n & ~Ks(n);
    ...
    var $s = Math.clz32 ? Math.clz32 : qs, hi = Math.log, Sa = Math.LN2;
    function qs(e) {
      var t = e >>> 0;
    ...
    var tl = typeof Object.is == "function" ? Object.is : el, bn = null, vi = null, xa = null, ze = null, It = !1, Wr = !1, ur = 0, Re = null, Nn = 0, Ea = 25, Rt = !1, Mt;
    function fn() {
      if (bn === null)
...
Incoming: %s`, Mt, "[" + e.join(", ") + "]", "[" + t.join(", ") + "]");
    ...
    function dl() {
      var e = vi, t = Js(e.treeContext), n = wi;
      if (n === null)
...
` + o.stack;
    ...
    function Yr(e, t, n, o, l, d, v, P, R) {
      ...
      we.parentFlushed = !0;
      var Me = fr(te, e, null, we, X, po, da, Vs);
      return G.push(Me), te;
    }
    function pl(e, t) {
      var n = e.pingedTasks;
    ...
    function Po(e, t, n) {
      pr(t, "Suspense");
      var o = t.blockedBoundary, l = t.blockedSegment, d = n.fallback, v = n.children, P = /* @__PURE__ */ new Set(), R = hl(e, P), G = l.chunks.length, X = Ma(
        e,
        G,
        R,
        l.formatContext,
    ...
    function wt(e, t, n) {
      ...
      try {
        ...
        if (xo(), typeof P == "object" && P !== null && typeof P.then == "function") {
          Sl(e, t, P), t.blockedSegment.formatContext = o, t.legacyContext = l, t.context = d, go(d), t.componentStack = v;
          return;
        } else
      ...
      if (n.status === ka) {
        ...
        try {
          ...
          if (xo(), typeof d == "object" && d !== null && typeof d.then == "function") {
            ...
            t.abortSet.delete(t), n.status = Ra, xl(e, t.blockedBoundary, n, d);
        } finally {
          Sn = o;
        }
      }
    ...
    function Ro(e, t, n) {
      ...
      if (o.parentFlushed = !0, o.forceClientRender)
        return Hs(t, e.responseState, o.errorDigest, o.errorMessage, o.errorComponentStack), hr(e, t, n), Us(t, e.responseState);
      if (o.pendingTasks > 0) {
        ...
        Ls(t, e.responseState);
        var d = o.completedSegments;
        if (d.length !== 1)
          throw new Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");
        var v = d[0];
        return Ro(e, t, v), Ns(t, e.responseState);
      }
    }
    function Cl(e, t, n) {
      return Qs(t, e.responseState, n.id, n.errorDigest, n.errorMessage, n.errorComponentStack);
    }
    function Ri(e, t, n) {
    ...
    function ws(e, t, n, o) {
      ...
      var X = Yr(e, Os(n, t ? t.identifierPrefix : void 0), Fs(), 1 / 0, Mi, void 0, G);
      if (ms(X), ys(X, o), Dl(X, P), l)
        throw d;
      if (!R)
    ...
    jo.renderToNodeStream = Tl, jo.renderToStaticMarkup = bs, jo.renderToStaticNodeStream = r, jo.renderToString = Pl, jo.version = A;
  }()), jo;
}
var xs = {}, aA;
function zu() {
  return aA || (aA = 1, Nl.env.NODE_ENV !== "production" && function() {
    var f = D, A = "18.3.1", p = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function y(r) {
      {
...
` && r.push(wn), o;
    ...
    var yt = "function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)}", Tt = 'function $RC(a,b){a=document.getElementById(a);b=document.getElementById(b);b.parentNode.removeChild(b);if(a){a=a.previousSibling;var f=a.parentNode,c=a.nextSibling,e=0;do{if(c&&8===c.nodeType){var d=c.data;if("/$"===d)if(0===e)break;else e--;else"$"!==d&&"$?"!==d&&"$!"!==d||e++}d=c.nextSibling;f.removeChild(c);c=d}while(c);for(;b.firstChild;)f.insertBefore(b.firstChild,c);a.data="$";a._reactRetry&&a._reactRetry()}}', kt = 'function $RX(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())}', Fr = B(yt + ';$RS("'), ea = B('$RS("'), ir = B('","'), Qs = B('")<\/script>');
    function js(r, e, t) {
      k(r, e.startInlineScript), e.sentCompleteSegmentFunction ? k(r, ea) : (e.sentCompleteSegmentFunction = !0, k(r, Fr)), k(r, e.segmentPrefix);
      var n = j(t.toString(16));
      return k(r, n), k(r, ir), k(r, e.placeholderPrefix), k(r, n), Q(r, Qs);
    }
    var Ja = B(Tt + ';$RC("'), Os = B('$RC("'), Fs = B('","'), Oi = B('")<\/script>');
    function Fi(r, e, t, n) {
      if (k(r, e.startInlineScript), e.sentCompleteBoundaryFunction ? k(r, Os) : (e.sentCompleteBoundaryFunction = !0, k(r, Ja)), t === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      var o = j(n.toString(16));
      return k(r, t), k(r, Fs), k(r, e.segmentPrefix), k(r, o), Q(r, Oi);
    }
    var Ls = B(kt + ';$RX("'), Hs = B('$RX("'), Ns = B('"'), Us = B(")<\/script>"), xt = B(",");
    function zs(r, e, t, n, o, l) {
      if (k(r, e.startInlineScript), e.sentClientRenderFunction ? k(r, Hs) : (e.sentClientRenderFunction = !0, k(r, Ls)), t === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return k(r, t), k(r, Ns), (n || o || l) && (k(r, xt), k(r, j(ta(n || "")))), (o || l) && (k(r, xt), k(r, j(ta(o || "")))), l && (k(r, xt), k(r, j(ta(l)))), Q(r, Us);
    }
    var Li = /[<\u2028\u2029]/g;
    function ta(r) {
    ...
    var Bt = Object.assign, Hi = Symbol.for("react.element"), na = Symbol.for("react.portal"), ra = Symbol.for("react.fragment"), oa = Symbol.for("react.strict_mode"), aa = Symbol.for("react.profiler"), so = Symbol.for("react.provider"), lo = Symbol.for("react.context"), Lr = Symbol.for("react.forward_ref"), Ka = Symbol.for("react.suspense"), $a = Symbol.for("react.suspense_list"), qa = Symbol.for("react.memo"), ia = Symbol.for("react.lazy"), Ni = Symbol.for("react.scope"), Ws = Symbol.for("react.debug_trace_mode"), Zs = Symbol.for("react.legacy_hidden"), Gs = Symbol.for("react.default_value"), ei = Symbol.iterator, Ze = "@@iterator";
    function Ao(r) {
...
` + v[R].replace(" at new ", " at ");
    ...
    function Ys(r) {
      ...
      {
        var t = e.parentValue;
        t === Gs ? e.context._currentValue = e.context._defaultValue : e.context._currentValue = t, r._currentRenderer !== void 0 && r._currentRenderer !== null && r._currentRenderer !== Ar && s("Detected multiple renderers concurrently rendering the same context provider. This is currently unsupported."), r._currentRenderer = Ar;
      }
      return Ln = e.parent;
    }
    function Vi() {
...
Please update the following components: %s`,
    ...
    function So(r, e, t, n) {
      ...
      typeof P == "function" && (r.state = Xs(r, e, P, o, t)), typeof e.getDerivedStateFromProps != "function" && typeof r.getSnapshotBeforeUpdate != "function" && (typeof r.UNSAFE_componentWillMount == "function" || typeof r.componentWillMount == "function") && (Js(e, r), pi(l, r, t, n));
    }
    var Ks = {
      id: 1,
      overflow: ""
    ...
    function $s(r) {
      var e = r.overflow, t = r.id, n = t & ~qs(t);
    ...
    var el = Math.clz32 ? Math.clz32 : vi, tl = Math.log, bn = Math.LN2;
    function vi(r) {
      var e = r >>> 0;
      return e === 0 ? 32 : 31 - (tl(e) / bn | 0) | 0;
    }
    function xa(r, e) {
      return r === e && (r !== 0 || 1 / r === 1 / e) || r !== r && e !== e;
    }
    var ze = typeof Object.is == "function" ? Object.is : xa, It = null, Wr = null, ur = null, Re = null, Nn = !1, Ea = !1, Rt = 0, Mt = null, fn = 0, nl = 25, Kt = !1, Un;
    function cr() {
      if (It === null)
        throw new Error(`Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
...
Incoming: %s`, Un, "[" + r.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function ns(r, e, t) {
      if (r !== yi && (Un = "useReducer"), It = cr(), Re = xo(), Nn) {
        ...
        var G = Re.queue = {
          last: null,
          dispatch: null
        }, X = G.dispatch = Al.bind(null, It, G);
    ...
    function as() {
      var r = Wr, e = $s(r.treeContext), t = Eo;
      if (t === null)
        throw new Error("Invalid hook call. Hooks can only be called inside of the body of a function component.");
      var n = Rt++;
      return Zt(t, e, n);
...
` + n.stack;
    ...
    var Ba = p.ReactCurrentDispatcher, Ia = p.ReactDebugCurrentFrame, Ra = 0, Gr = 1, bi = 2, dr = 3, is = 4, fl = 0, _r = 1, Yr = 2, pl = 12800;
    function hl(r) {
    ...
    function Ma(r, e, t, n, o, l, d, v, P) {
      ...
      te.parentFlushed = !0;
      var we = pr(X, r, null, te, G, da, fa, Ks);
      return R.push(we), X;
    }
    function Sn(r, e) {
      var t = r.pingedTasks;
    ...
    function Qt(r, e, t, n) {
      ...
      v = e.context, e.context = ci(o, l), wt(r, e, d), e.context = Ys(o), v !== e.context && s("Popping the context provider did not return back to the original snapshot. This is a bug in React.");
    }
    function bl(r, e, t, n, o) {
      En(e, "Lazy");
    ...
    function Ro(r, e, t) {
      if (e === null) {
        ...
        if (e.pendingTasks === 0)
          t.parentFlushed && t.status === Gr && hr(e, t), e.parentFlushed && r.completedBoundaries.push(e), e.fallbackAbortableTasks.forEach(El, r), e.fallbackAbortableTasks.clear();
    ...
    function gs(r, e, t) {
      return zs(e, r.responseState, t.id, t.errorDigest, t.errorMessage, t.errorComponentStack);
    }
    function Fa(r, e, t) {
    ...
    function ys(r, e, t, n) {
      ...
      if (o === -1) {
        ...
        return Fa(r, e, n), js(e, r.responseState, o);
    }
    function Mi(r, e) {
      L();
      try {
    ...
    xs.renderToReadableStream = Tl, xs.version = A;
  }()), xs;
}
var Fo, Ll;
Nl.env.NODE_ENV === "production" ? (Fo = Hu(), Ll = Nu()) : (Fo = Uu(), Ll = zu());
...
Lo.renderToReadableStream = Ll.renderToReadableStream;
const $e = {
...
}, Wu = (f, A) => /* @__PURE__ */ D.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 32, height: 32, viewBox: "0 0 42 42", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { style: {
  fill: "none",
  strokeWidth: 2,
  strokeLinecap: "butt",
...
const Yu = "data:image/svg+xml;base64,", Xu = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 0 637 637", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "m478 113-13 2-4 1h4l14-2c10-2 35-2 42-1l6 3 3 1c3 0-4-3-8-5-7-1-34-1-44 1m56 6 8 6c7 5 20 17 20 19s7 12 8 12l-3-6-4-6c0-3-15-17-25-24-5-3-8-4-4-1m-198 16-9 1a512 512 0 0 1 9-1m-180 30a412 412 0 0 0-23 4 167 167 0 0 0-32 8 439 439 0 0 1 46-9 304 304 0 0 1 11-2l6-1h-8m369 8 4 3-7-6c-1 0 0 2 3 3m-439 9c-7 3-18 13-18 15l6-5c5-5 9-8 14-10l6-4-8 4m442 12-10 11-7 6 7-6c7-5 14-14 13-16l-3 5M65 205l-1 11c0 9 0 10 4 17 5 10 7 12 22 11 10 0 15 0 38-5l5-1-6 1-16 2-21 2c-13 1-16-1-21-10-3-5-4-6-4-15l1-12c1-4 1-5-1-1m335 1c3 0 3 1 3 3l-2 6c-2 5-35 39-76 80-53 51-120 117-138 137-21 24-22 25-22 27 0 3 6 9 9 9 4 0 14-8 38-27a5073 5073 0 0 1 15-16 1421 1421 0 0 0-17 15l-31 25-6 2-4-3c-3-3-3-4-2-6 3-8 79-85 160-163 57-57 79-80 79-86 0-2-3-4-7-4-2 0-2 0 1 1m165 18c-9 17-25 32-57 53l-10 8 16-11 12-8c15-10 27-22 39-39 5-7 6-8 4-8l-4 5m-221 2a199 199 0 0 0-19 10 183 183 0 0 1 27-12c0-1-1-1-8 2m-34 16c-3 3-2 3 2 0l1-2-3 2m151 3-1 2 2-2c3-3 2-3-1 0m-16 12-11 10a281 281 0 0 0 11-10m-24 18-7 5-7 5-42 31c-10 7-24 19-22 19l7-6 16-12a343 343 0 0 0 35-25 573 573 0 0 0 20-17m-187 0-2 2 4-2 3-2-5 2m-14 6-3 2 4-1 4-3-5 2m-7 3-8 4-18 8 18-7 7-3 3-1c1-2 0-2-2-1m254 24a2672 2672 0 0 1-71 54 601 601 0 0 0 39-29 1352 1352 0 0 1 32-25m-291-8-2 2 4-2 3-2-5 2m-13 5-2 2h3c5-3 4-4-1-2m-19 9-7 3-13 6c-10 5-13 7-14 10-3 4-2 5 1 0 2-3 5-5 14-9l13-6 12-6-6 2m178 36c-17 12-21 16-21 17a390 390 0 0 1 20-17m-206 34 1 4 1 3 1 5 2 8 1 5v-6l-1-8-2-5-1-4-1-2c-1-2-1-2-1 0m222 23-9 7a683 683 0 0 0-56 44 261 261 0 0 0-26 20 1345 1345 0 0 0-46 34c-6 3-7 3-19 3-11 0-12 0-18-3-8-4-10-8-17-20l-5-10 4 10c5 10 12 18 19 22 4 2 6 2 17 2 13 0 14 0 21-3l26-19 42-33a2183 2183 0 0 0 43-34 643 643 0 0 1 24-20", fill: "#fff", fillRule: "evenodd" }), /* @__PURE__ */ D.createElement("path", { d: "M478 114a620 620 0 0 1-39 6l-21 3a5481 5481 0 0 0-19 3 870 870 0 0 1-54 8l-1 1-6 1-12 2-13 2a992 992 0 0 0-76 12 400 400 0 0 1-45 8l-6 1-5 1h-3l-3 1-2 1-26 4-13 2-17 3c-23 5-33 9-43 19-7 8-9 13-9 27 0 8 1 9 4 14 5 9 8 11 21 10l21-2a1133 1133 0 0 1 23-4 659 659 0 0 0 74-14l3-1h3l3-1h3l2-1 2-1h3l2-1h2l24-5 38-7a2100 2100 0 0 1 93-18l3-1 10-1a2082 2082 0 0 1 120-17l2 1c2 0 8 5 8 7l1 2 1 6c0 4 0 6-3 10-2 4-16 16-18 16l-7 5-10 8a1070 1070 0 0 0-11 7 113 113 0 0 1-20 14l-2 2-3 2-2 2h-1a154 154 0 0 1-28 21l-5 4-5 4a573 573 0 0 1-50 37 175 175 0 0 0-24 18l-1 2-2 1-2 1-2 1-1 1-12 10a396 396 0 0 0-32 25l-8 6-6 5-9 7a326 326 0 0 1-25 20l-13 12a5073 5073 0 0 0-17 15c-24 20-34 27-39 27-2 0-8-6-8-9 0-2 1-3 22-27 18-20 85-86 138-137 41-41 74-75 76-80l2-6c0-2 0-3-2-3l-7 1a233 233 0 0 1-26 9l-1 1-1 1h-1l-1 1h-2l-3 2-1 1h-2l-3 2h-1l-5 2-22 10-9 4-4 2-5 2-10 4-2 1-2 1-2 1-13 6a334 334 0 0 1-38 17 75 75 0 0 0-14 6l-5 2-4 1-2 1-3 2-7 3-16 6a247 247 0 0 0-32 14l-1 1h-2l-1 1h-2l-1 1-12 6a103 103 0 0 0-27 15l-2 5-1 1v11l1 5 1 5 1 4c0 3 0 4 2 4v3l1 3 1 2 2 10 1 4 1 5 2 10 2 8 1 4 1 4c3 3 9 25 11 38l1 7v2l1 4v1l1 1v2l1 2 1 3v1l5 10c7 13 9 16 17 20 6 3 7 3 18 3 12 0 13 0 19-3 8-4 11-6 26-18a1345 1345 0 0 1 85-67 683 683 0 0 1 50-39l12-9a513 513 0 0 1 44-33 201 201 0 0 0 22-17 2270 2270 0 0 0 73-54 158 158 0 0 0 58-59c2 0 3-9 4-27l-1-19-1-4-1-6-1-3-4-6-4-6c0-2-6-8-13-14a77 77 0 0 0-28-18c-6-1-34-1-43 1" })), sA = D.forwardRef(Xu), Vu = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 -960 960 960", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "M765-321q0 117-84 196-83 80-200 80-118 0-200-80t-83-196v-392q0-85 61-144 61-58 146-58 86 0 147 58 61 59 61 144v374q0 54-39 92-39 37-93 37-55 0-93-37-38-38-38-92v-372h110v372q0 9 6 14t15 5q8 0 15-5t7-14v-374q0-39-29-66t-68-27q-40 0-69 27t-29 66v392q0 71 51 119t122 48q71 0 122-48t51-119v-426h111v426Z" })), lA = D.forwardRef(Vu), Ju = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 -960 960 960", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "M125-165v-113h77v-273q0-93 55-167 56-75 146-100v-19q0-32 22-55 23-23 55-23t55 23q22 23 22 55v19q90 25 146 99 56 73 56 168v273h77v113H125ZM480-32q-38 0-66-27-27-27-27-66h186q0 39-27 66t-66 27Z" })), Ku = D.forwardRef(Ju), $u = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 -960 960 960", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "M137-190v-113h78v-253q0-41 11-79 11-39 35-71l-9 150h10L17-802l74-74L873-92l-74 74-175-172H137Zm609-149L319-769q20-15 41-25t44-16v-28q0-32 22-54t54-22q32 0 55 22t22 54v28q85 23 137 94t52 160v217ZM481-47q-38 0-65-27t-27-65h184q0 38-27 65t-65 27Z" })), qu = D.forwardRef($u), ec = (f, A) => /* @__PURE__ */ D.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", ref: A, ...f }, /* @__PURE__ */ D.createElement("g", { strokeLinecap: "round", strokeWidth: 10 }, /* @__PURE__ */ D.createElement("path", { d: "m19 19 61 61M80 19 19 80" }))), tc = D.forwardRef(ec), nc = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 -960 960 960", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "M94-136v-255l351-93-351-92v-253l816 346L94-136Z" })), rc = D.forwardRef(nc), oc = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 -960 960 960", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "M480-372q-61 0-105-43-43-43-43-105v-240q0-61 43-105 43-43 105-43 61 0 105 43 43 44 43 105v240q0 62-43 105t-105 43ZM425-76v-122q-121-16-197-108t-76-214h109q0 91 64 154t155 63q91 0 155-63t64-154h109q0 122-77 214T534-198v122H425Z" })), ac = D.forwardRef(oc), ic = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 -960 960 960", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "m763-343-80-79q8-20 13-44 5-23 5-54h109q0 49-11 95t-36 82ZM625-482 336-770v-2q3-56 45-96t101-40q62 0 105 43t43 105v249l-1 17q-1 7-4 12ZM427-76v-122q-120-16-196-108-77-92-77-214h109q0 91 64 154t155 63q43 0 80-14 37-15 67-41l78 79q-35 32-78 53t-93 28v122H427Zm362 27L41-796l75-75 748 748-75 74Z" })), sc = D.forwardRef(ic), lc = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 -960 960 960", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "M625-511q29 0 50-21t20-50q0-29-20-50-21-20-50-20t-50 20-20 50q0 29 20 50 21 21 50 21Zm-290 0q29 0 50-21t20-49q0-30-20-50t-50-21q-29 0-50 20-20 21-20 50 0 30 20 50 21 21 50 21Zm145 268q75 0 137-43t85-115H258q24 72 85 115 62 43 137 43Zm0 198q-90 0-170-34-79-34-138-93T79-310q-34-80-34-170t34-170q34-79 93-138t138-93q80-34 170-34t170 34q79 34 138 93t93 138q34 80 34 170t-34 170q-34 79-93 138T650-79q-80 34-170 34Zm0-435Zm0 322q134 0 228-94t94-228q0-134-94-228t-228-94q-134 0-228 94t-94 228q0 134 94 228t228 94Z" })), AA = D.forwardRef(lc), Ac = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 -960 960 960", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "M553-64v-108q107-27 173-113 67-87 67-197 0-109-67-195T553-789v-108q152 26 249 144 97 117 97 271 0 155-97 273T553-64ZM61-335v-290h176l236-237v764L237-335H61Zm492 28v-346q51 23 82 70t31 103-31 103q-31 47-82 70Z" })), uc = D.forwardRef(Ac), cc = (f, A) => /* @__PURE__ */ D.createElement("svg", { viewBox: "0 -960 960 960", ref: A, ...f }, /* @__PURE__ */ D.createElement("path", { d: "M807-15 700-123q-33 21-71 37-38 15-80 22v-108q20-4 38-12l35-17-153-154v257L234-335H57v-290h144L10-818l74-75L882-90l-75 75Zm37-264-80-79q13-30 19-60 7-31 7-64 0-109-68-195-67-86-173-112v-108q152 26 249 144 98 117 98 271 0 55-14 107-13 51-38 96ZM661-462 549-575v-78q51 23 83 70 31 47 31 103l-1 9-1 9ZM469-655 366-759l103-103v207Z" })), dc = D.forwardRef(cc), fc = "data:audio/wav;base64,", DA = {
        ...
        children: [
          ...
          /* @__PURE__ */ g.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ g.jsx(sA, { style: { width: "80%", height: "80%", fill: "#fff" } })
            },
            1
          ),
...
}, PA = D.createContext({ settings: {}, setSettings: () => null }), ke = () => D.useContext(PA), pc = ({
  children: f,
  settings: A = DA,
  setSettings: p
}) => /* @__PURE__ */ g.jsx(PA.Provider, { value: { settings: A, setSettings: p }, children: f }), TA = {
  tooltipStyle: {},
...
}, kA = D.createContext({ styles: {}, setStyles: () => null }), Je = () => D.useContext(kA), hc = ({
  children: f,
  styles: A = TA,
  setStyles: p
}) => /* @__PURE__ */ g.jsx(kA.Provider, { value: { styles: A, setStyles: p }, children: f }), vc = ({ buttons: f }) => {
  var A, p, y, s, b;
...
}, BA = D.createContext({}), it = () => D.useContext(BA), gc = ({
  children: f,
  botIdRef: A,
  flowRef: p
}) => {
  ...
  return /* @__PURE__ */ g.jsx(BA.Provider, { value: {
    botIdRef: A,
    flowRef: p,
    inputRef: y,
    streamMessageMap: b,
...
}, IA = D.createContext({}), ft = () => D.useContext(IA), mc = ({
  children: f,
  settings: A
}) => {
  var p, y, s, b, T, C;
...
}, RA = D.createContext({ paths: [], setPaths: () => null }), zl = () => D.useContext(RA), bc = ({ children: f }) => {
  const [A, p] = D.useState([]);
  return /* @__PURE__ */ g.jsx(RA.Provider, { value: { paths: A, setPaths: p }, children: f });
}, ji = () => {
  const { settings: f } = ke(), { paths: A, setPaths: p } = zl(), {
    setIsBotTyping: y,
  ...
  const { getCurrPath: f, getPrevPath: A, paths: p } = MA(), { botIdRef: y } = it();
  return { callRcbEvent: D.useCallback((s, b) => {
    const T = { botId: y.current, currPath: f(), prevPath: A() };
    return Ts(s, T, b);
  }, [p]) };
}, QA = D.createContext({ toasts: [], setToasts: () => null }), jA = () => D.useContext(QA), Sc = ({ children: f }) => {
  const [A, p] = D.useState([]);
  return /* @__PURE__ */ g.jsx(QA.Provider, { value: { toasts: A, setToasts: p }, children: f });
}, Na = () => {
  const { settings: f } = ke(), { toasts: A, setToasts: p } = jA(), { callRcbEvent: y } = Zn(), s = D.useRef(A);
  D.useEffect(() => {
    s.current = A;
  }, [A]);
...
}, OA = D.createContext({ messages: [], setMessages: () => null }), Wl = () => D.useContext(OA), Ec = ({ children: f }) => {
  const [A, p] = D.useState([]);
  return /* @__PURE__ */ g.jsx(OA.Provider, { value: { messages: A, setMessages: p }, children: f });
}, Cc = ({
  setChatScrollHeight: f
}) => {
  var A, p, y, s, b, T, C, w, x, L, k, Q;
  const { settings: N } = ke(), { styles: H } = Je(), { messages: W } = Wl(), { toasts: j } = jA(), { isChatWindowOpen: B } = Gn(), {
    isBotTyping: V,
    isScrolling: ne,
    setIsScrolling: Y,
    setUnreadCount: _
  ...
  const { settings: H } = ke(), { styles: W } = Je(), { paths: j } = zl(), { handleSubmitText: B } = za(), [V, ne] = D.useState(/* @__PURE__ */ new Set()), [Y, _] = D.useState(!1), $ = {
  ...
  const T = /* @__PURE__ */ g.jsx(Dc, { checkboxes: b, checkedItems: /* @__PURE__ */ new Set(), path: p });
  ...
  var p, y, s, b, T, C;
  const { settings: w } = ke(), { styles: x } = Je(), { paths: L } = zl(), { handleSubmitText: k } = za(), [Q, N] = D.useState([]), [H, W] = D.useState(!1), j = {
  ...
  const T = /* @__PURE__ */ g.jsx(Bc, { options: b, path: p });
  await y.injectMessage(T);
}, Rc = async (f, A, p) => {
  const y = f.path;
  if (!y)
  ...
  for (const T of b)
    T === "function" && await Tc(s, p);
  return b.includes("path") ? await Rc(s, p, y) : !1;
}, Fc = (f) => {
  const A = [];
  let p = "", y = !1;
  ...
  return p !== "" && A.push(p), A;
}, Lc = (f) => typeof window.DOMParser < "u" ? new DOMParser().parseFromString(f, "text/html").body.textContent || "" : f.replace(/<\/?[^>]+(>|$)/g, ""), Hc = (f, A, p, y, s) => {
...
let HA = !1, Hl = "rcb-history", Es = 30, NA = !1, ks = [];
const Cs = async (f) => {
  if (NA)
    return;
  const A = [], p = HA ? ks.length : 0;
  ...
  localStorage.setItem(Hl, JSON.stringify(f));
}, Zc = (f) => {
  var A, p, y;
  Hl = (A = f.chatHistory) == null ? void 0 : A.storageKey, Es = (p = f.chatHistory) == null ? void 0 : p.maxEntries, NA = (y = f.chatHistory) == null ? void 0 : y.disabled, ks = Wc(localStorage.getItem(Hl));
}, Gc = (f) => D.isValidElement(f.content) ? structuredClone({
  id: f.id,
  ...
  if (HA = !0, p != null)
    try {
      y((x) => {
        const L = Oo(/* @__PURE__ */ g.jsx(zc, {}), "system");
        return x.shift(), [L, ...x];
      });
      const w = p.map((x) => {
        if (x.type === "object") {
          const L = WA(x.content, f, A);
          return { ...x, content: L };
        }
        return x;
      });
      setTimeout(() => {
        y((x) => {
          ...
          x.shift();
          let k;
          return (L = f.chatHistory) != null && L.autoLoad ? k = Oo(/* @__PURE__ */ g.jsx(g.Fragment, {}), "system") : k = Oo(/* @__PURE__ */ g.jsx(Uc, {}), "system"), [...w, k, ...x];
        });
      }, 500), setTimeout(() => {
        if (!s.current)
          return;
  ...
  return Array.from(y.body.childNodes).map((s, b) => {
      ...
      return s.textContent;
    {
      ...
      const x = s.classList;
      if ((T = A.botBubble) != null && T.showAvatar && (w = Yc(x, w)), w = Xc(x, w, A, p), w = Vc(x, w, A, p), w = Jc(x, w, A, p), w = Kc(x, w, A, p), [
        "area",
        "base",
        "br",
        "col",
      ...
      {
        const L = WA(s.innerHTML, A, p);
        return D.createElement(C, { key: b, ...w }, ...L);
      }
    }
  });
}, Yc = (f, A) => ((f.contains("rcb-options-container") || f.contains("rcb-checkbox-container")) && (Object.prototype.hasOwnProperty.call(A, "class") ? A.class = `${f.toString()} rcb-options-offset` : A.class = "rcb-options-offset"), A), Xc = (f, A, p, y) => {
  var s, b, T, C, w;
  ...
  var f, A, p, y;
  const { settings: s } = ke(), { messages: b, setMessages: T } = Wl(), {
    audioToggledOn: C,
    isChatWindowOpen: w,
    isScrolling: x,
    setIsBotTyping: L,
    setUnreadCount: k
  } = ft(), { streamMessageMap: Q, chatBodyRef: N } = it(), { callRcbEvent: H } = Zn(), { playNotificationSound: W } = Zl(), j = D.useCallback(async (Z, oe, re) => {
    L(!1), T((he) => {
      const de = [...he, Z];
      return $(de), de;
    ...
    let se = !1;
    oe === "bot" ? se = (Ae = s.botBubble) == null ? void 0 : Ae.dangerouslySetInnerHtml : oe === "user" && (se = (ie = s.userBubble) == null ? void 0 : ie.dangerouslySetInnerHtml), Nc(s, C, w, ee, se);
    ...
    Cs(Z);
    let Ae = !0;
    (Z.length === 0 || w && !x) && (Ae = !1), (oe = s.general) != null && oe.embedded && ZA(N.current) && (Ae = !1);
...
const Gl = () => {
  ...
  var C;
  (C = f.voice) != null && C.sendAsAudio ? ed(p, b) : qc(
    f,
    A,
    p,
    y,
  ...
  x.onresult = (Q) => {
    ...
    zn = setTimeout(() => Il(A, b), L), (H = f.voice) != null && H.autoSendDisabled || (Ds = setTimeout(p, k));
  }, x.onend = () => {
    Kr ? (x.start(), zn || (zn = setTimeout(() => Il(A, b), L))) : (clearTimeout(zn), zn = null, clearTimeout(Ds));
  }, zn = setTimeout(() => Il(A, b), L);
}, ed = (f, A) => {
  ...
  var p, y, s;
  const b = Gl();
  (p = A.voice) != null && p.disabled || !((y = A.chatInput) != null && y.blockSpam) || !b || (f && !Kr ? (Kr = !0, (s = A.voice) != null && s.sendAsAudio ? Wn == null || Wn.start() : b.start()) : f || _l());
}, Il = (f, A) => {
  var p;
  (p = A.current) != null && p.disabled || f(), _l();
}, Is = () => {
  ...
  const { settings: f } = ke(), {
    ...
    (j = C.current) != null && j.disabled || setTimeout(() => {
      var B, V, ne;
      (B = f.general) != null && B.embedded ? ZA(w == null ? void 0 : w.current) && ((V = C.current) == null || V.focus()) : W !== "start" && ((ne = C.current) == null || ne.focus());
    }, 100);
  }, []), N = D.useCallback(() => {
  ...
  const { settings: s } = ke(), { endStreamMessage: b, injectMessage: T, removeMessage: C, streamMessage: w } = Ua(), { getCurrPath: x, getPrevPath: L, goToPath: k } = ji(), {
    ...
    setInputLength: ne
  } = ft(), { flowRef: Y, chatBodyRef: _, inputRef: $, keepVoiceOnRef: Z, paramsInputRef: oe } = it(), { showToast: re, dismissToast: Ae } = Na(), { callRcbEvent: ie } = Zn(), { syncVoice: q } = Is(), { setTextAreaValue: he } = Ho(), { openChat: de } = Gn(), Qe = D.useCallback(async (ee) => {
    var se, pe, be;
    const ae = x();
    if (!(!ae || !Y.current[ae])) {
      if (W) {
    ...
    se = se.trim(), se !== "" && (pe && await Qe(se), Q && clearTimeout(Q), oe.current = se, _.current && (_.current.scrollTop = _.current.scrollHeight), $.current && (he(""), ne(0)), (be = s.chatInput) != null && be.blockSpam && j(!0), Z.current = N, q(!1), setTimeout(() => {
      ...
      if (!await LA(Y.current, ee, Fe, k)) {
        ...
        if (!le)
          return;
        le.chatDisabled || j((ye = s.chatInput) == null ? void 0 : ye.disabled), FA(le, H, Fe), V(typeof le.file == "function"), q(Z.current), B(!1);
      }
  ...
  const Q = Rs(), { settings: N } = ke(), { styles: H } = Je(), {
    textAreaDisabled: W,
  ...
  var f, A, p, y;
  const s = Rs(), { settings: b } = ke(), { styles: T } = Je(), { isChatWindowOpen: C, openChat: w } = Gn(), [x, L] = D.useState(!1), [k, Q] = D.useState(!1), [N, H] = D.useState(0);
  D.useEffect(() => {
    var B, V, ne;
  ...
  var f, A, p;
  const { settings: y } = ke(), { styles: s } = Je(), { audioToggledOn: b, toggleAudio: T } = YA(), C = {
  ...
  const { notificationsToggledOn: f, toggleNotifications: A, playNotificationSound: p } = Zl();
  return {
  ...
  var f, A, p;
  const { settings: y } = ke(), { styles: s } = Je(), { notificationsToggledOn: b, toggleNotifications: T } = XA(), C = {
  ...
  var f, A, p;
  const { settings: y } = ke(), { styles: s } = Je(), { injectMessage: b } = Ua(), { inputRef: T } = it(), { voiceToggledOn: C, toggleVoice: w } = Is(), { setInputLength: x, setTextAreaValue: L, textAreaDisabled: k } = Ho(), { handleSubmitText: Q } = za(), N = D.useRef([]), [H, W] = D.useState(!1);
  D.useEffect(() => {
    var _;
  ...
  const j = {
    ...
    const _ = new Blob(N.current, { type: "audio/wav" }), $ = new File([_], "voice-input.wav", { type: "audio/wav" }), Z = await _A($);
...
}, fd = (f) => Object.values($e).includes(f), pd = (f, A) => {
...
}, hd = () => /* @__PURE__ */ g.jsx(ld, {}), vd = () => /* @__PURE__ */ g.jsx(ud, {}), gd = () => /* @__PURE__ */ g.jsx(Ad, {}), md = () => /* @__PURE__ */ g.jsx(cd, {}), yd = () => /* @__PURE__ */ g.jsx(dd, {}), wd = () => /* @__PURE__ */ g.jsx(id, {}), bd = () => /* @__PURE__ */ g.jsx(sd, {}), Sd = () => {
  const { settings: f } = ke(), A = D.useMemo(() => ({
    [$e.CLOSE_CHAT_BUTTON]: () => gd(),
    [$e.AUDIO_BUTTON]: () => hd(),
    [$e.NOTIFICATION_BUTTON]: () => vd(),
    [$e.EMOJI_PICKER_BUTTON]: () => bd(),
    [$e.FILE_ATTACHMENT_BUTTON]: () => wd(),
    [$e.SEND_MESSAGE_BUTTON]: () => yd(),
    [$e.VOICE_MESSAGE_BUTTON]: () => md()
  }), []), { header: p, chatInput: y, footer: s } = D.useMemo(() => pd(f, A), [f, A]), b = D.useMemo(() => p, [p]), T = D.useMemo(() => y, [y]), C = D.useMemo(() => s, [s]);
  return { headerButtons: b, chatInputButtons: T, footerButtons: C };
}, Yl = () => {
  const { settings: f } = ke(), { styles: A } = Je(), { setMessages: p } = Wl(), {
    ...
    var x;
    const L = UA();
    L && ((x = f.event) != null && x.rcbLoadChatHistory && T(Te.LOAD_CHAT_HISTORY, {}).defaultPrevented || (s(!0), _c(
      f,
      A,
      L,
      p,
  ...
  var f, A, p;
  const { settings: y } = ke(), { styles: s } = Je(), { showChatHistory: b } = Yl(), [T, C] = D.useState(!1), w = {
    color: (f = y.general) == null ? void 0 : f.primaryColor,
    borderColor: (A = y.general) == null ? void 0 : A.primaryColor,
  ...
  const s = Rs(), { settings: b } = ke(), {
    ...
    setTimeoutId: he
  } = ft(), { chatBodyRef: de, flowRef: Qe, streamMessageMap: xe, paramsInputRef: ee, keepVoiceOnRef: se } = it(), pe = Qe.current, { viewportHeight: be, setViewportHeight: ae, setViewportWidth: ye, openChat: Fe } = Gn(), { setUpNotifications: De } = Zl(), { handleFirstInteraction: le } = VA(), { showChatHistory: He } = Yl(), { updateTextAreaFocus: Et, setTextAreaValue: bt } = Ho(), { syncVoice: tt } = Is(), ve = D.useRef(0);
  D.useEffect(() => (window.addEventListener("click", le), window.addEventListener("keydown", le), window.addEventListener("touchstart", le), () => {
    ...
    else if (Zc(b), localStorage.getItem((Pe = b.chatHistory) == null ? void 0 : Pe.storageKey) != null) {
      const Ge = Oo(/* @__PURE__ */ g.jsx(xd, {}), "system");
  ...
  var A, p, y, s;
  f == null || f.map((Y) => Y());
  const b = Rs(), { settings: T } = ke(), { styles: C } = Je(), { hasFlowStarted: w, setHasFlowStarted: x } = ft(), { inputRef: L } = it(), {
    setChatScrollHeight: k,
    viewportHeight: Q,
    viewportWidth: N,
    isChatWindowOpen: H
  } = Gn(), { headerButtons: W, chatInputButtons: j, footerButtons: B } = Sd();
  Ed();
  const V = D.useMemo(() => {
    var Y;
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ g.jsxs("div", { style: ne(), className: "rcb-chat-window", children: [
          ((p = T.general) == null ? void 0 : p.showHeader) && /* @__PURE__ */ g.jsx(vc, { buttons: W }),
          /* @__PURE__ */ g.jsx(Cc, { setChatScrollHeight: k }),
          ((y = T.general) == null ? void 0 : y.showInputRow) && /* @__PURE__ */ g.jsx(nd, { buttons: j }),
          ((s = T.general) == null ? void 0 : s.showFooter) && /* @__PURE__ */ g.jsx(rd, { buttons: B })
        ] })
      ]
    }
  ) });
...
}, Dd = Xl.DEFAULT_URL, Pd = Xl.DEFAULT_EXPIRATION, JA = Xl.CACHE_KEY_PREFIX, Td = (f, A, p) => {
  const y = localStorage.getItem(`${JA}_${f}_${A}`);
  if (!y)
    return null;
  try {
  ...
  localStorage.setItem(`${JA}_${f}_${A}`, JSON.stringify(C));
}, Bd = async (f, A) => {
  ...
  const { id: p, version: y, baseUrl: s = Dd, cacheDuration: b = Pd } = A, T = y || await Bd(p, s);
  if (!T)
    return console.error(`Unable to find version for theme: ${p}`), { settings: {}, inlineStyles: {}, cssStylesText: "" };
  const C = Td(p, T, b);
  if (C) {
    const V = cA(f, C.cssStylesText);
  ...
  let j = {};
  W.ok ? j = await W.json() : console.info(`Could not fetch styles.json from ${L}`), kd(p, T, H, j, k);
  const B = cA(f, k);
  return { settings: H, inlineStyles: j, cssStylesText: B };
}, cA = (f, A) => A.split(new RegExp("(?<=})")).map((p) => {
  const y = p.trim();
  return y.startsWith("@import") || y.startsWith("@keyframes") || y.startsWith("@media") ? y : y ? `#${f} ${y}` : "";
}).join(`
`), Vl = () => Ms(DA), KA = () => Ms(TA), Id = async (f, A, p, y) => {
  var s, b;
  let T = Vl(), C = KA(), w = "";
  if (y != null)
    if (Array.isArray(y))
      for (const x of y) {
        const L = await uA(f, x);
        T = Jr(L.settings, T), C = Jr(L.inlineStyles, C), w += L.cssStylesText;
      }
    else {
      const x = await uA(f, y);
  ...
  return A;
}, $A = D.createContext(void 0), qA = () => D.useContext($A), eu = ({
  children: f
}) => {
  var A;
  ...
  const L = async (k, Q, N, H, W, j) => {
    ...
    const B = await Id(k, N, H, W);
    j.current && (j.current.textContent = B.cssStylesText), b(B.settings), C(B.inlineStyles);
  };
  return w ? /* @__PURE__ */ g.jsx("div", { style: { fontFamily: (A = s.general) == null ? void 0 : A.fontFamily }, children: /* @__PURE__ */ g.jsx($A.Provider, { value: { loadConfig: L }, children: /* @__PURE__ */ g.jsx(pc, { settings: s, setSettings: b, children: /* @__PURE__ */ g.jsx(hc, { styles: T, setStyles: C, children: /* @__PURE__ */ g.jsx(Sc, { children: /* @__PURE__ */ g.jsx(gc, { botIdRef: p, flowRef: y, children: /* @__PURE__ */ g.jsx(bc, { children: /* @__PURE__ */ g.jsx(mc, { settings: s, children: /* @__PURE__ */ g.jsx(Ec, { children: f }) }) }) }) }) }) }) }) }) : null;
}, Rd = ({
  id: f,
  flow: A,
  settings: p,
  ...
  const w = D.useMemo(() => f, []), x = qA(), { flowRef: L } = it();
...
}, Rl = ["Quickstart", "API Docs", "Examples", "Github", "Discord"], Md = {
  start: {
  ...
  const T = D.useMemo(() => f || "rcb-" + Ps(), []), C = !A || Object.keys(A).length === 0 ? Md : A, w = p || {}, x = y || {}, L = b || [], [k, Q] = D.useState(!1), N = qA(), H = D.useRef(null), [W, j] = D.useState(s || []);
  D.useEffect(() => {
    s && j(s);
  }, [s]);
  const B = () => /* @__PURE__ */ g.jsxs(g.Fragment, { children: [
    ...
    k && /* @__PURE__ */ g.jsx(Cd, { plugins: b })
  ] });
  return N == null ? /* @__PURE__ */ g.jsxs(eu, { children: [
  ...
  const { audioToggledOn: f, toggleAudio: A } = YA();
  return {
    audioToggledOn: f,
    toggleAudio: A
  };
  ...
  const { hasFlowStarted: f, restartFlow: A, getFlow: p } = Nd();
  return {
    hasFlowStarted: f,
    restartFlow: A,
    getFlow: p
  ...
  const { settings: f, replaceSettings: A, updateSettings: p } = Wd();
  return {
    settings: f,
    replaceSettings: A,
    updateSettings: p
  ...
  const { styles: f, replaceStyles: A, updateStyles: p } = Gd();
  return {
    styles: f,
    replaceStyles: A,
    updateStyles: p
  ...
  const { voiceToggledOn: f, toggleVoice: A } = Is();
  return {
    voiceToggledOn: f,
    toggleVoice: A
  };
}, Jd = () => {
  const { showChatHistory: f } = Yl();
  return {
    showChatHistory: f,
    getHistoryMessages: UA,
  ...
  ChatBotProvider: eu,
  default: Qd,
  getDefaultSettings: Vl,
  getDefaultStyles: KA,
  useAudio: jd,
  useBotId: Fd,
  useChatHistory: Jd,
  useChatWindow: Ld,
  useFirstInteraction: Hd,
  useFlow: Ud,
  useMessages: zd,
  useNotifications: XA,
  usePaths: MA,
  ...
  useToasts: Xd,
  useVoice: Vd
}, Symbol.toStringTag, { value: "Module" })), $d = D.lazy(() => Promise.resolve().then(() => Kd)), tu = Vl(), qd = D.createContext({
  settings: tu,
  setSettings: () => {
  }
});
function ef() {
  ...
  const H = async (V) => {
    const { address: ne } = xA.all();
    A(ne);
    let _ = await Eu.getInstance().createToken(V).getBalance(ne);
    _ = xu(_), y(_);
  }, W = async (V) => {
    at("handleQuestion params", V);
    const ne = await Cu.post("/ai/chat", {
    ...
    transfer: {
      ...
      component: (V) => {
        if (Q.action === "transfer")
          return at(T, f, p, Q.token, Q.toEmail, Q.amount), /* @__PURE__ */ g.jsx("div", { className: "pl-4 pt-2", children: T && f && p && Q.token && Q.toEmail && Q.amount && /* @__PURE__ */ g.jsx(Pu, { onClick: () => b(!0) }) });
      },
      // chatDisabled: true,
      path: "transfer"
    }
  ...
  return /* @__PURE__ */ g.jsx(g.Fragment, { children: L && /* @__PURE__ */ g.jsx(D.Suspense, { fallback: null, children: /* @__PURE__ */ g.jsxs("div", { children: [
    /* @__PURE__ */ g.jsx(qd.Provider, { value: { settings: w, setSettings: x }, children: /* @__PURE__ */ g.jsx($d, { settings: w, flow: j, styles: B }) }),
    /* @__PURE__ */ g.jsx(
      Du,
      {
        open: s,
...
function bf() {
  return /* @__PURE__ */ g.jsxs("section", { className: "bg-background w-full flex flex-col min-h-screen", children: [
    /* @__PURE__ */ g.jsx(Lu, {}),
    /* @__PURE__ */ g.jsx("div", { className: "flex-grow", children: /* @__PURE__ */ g.jsx(Tu, { children: /* @__PURE__ */ g.jsx(lu, {}) }) }),
    /* @__PURE__ */ g.jsx(ef, {})
  ] });
}
export {
