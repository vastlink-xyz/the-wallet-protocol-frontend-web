...
import { c as $, I as q, B as u, L as K, f as U, g as b, h as B } from "./main-Bd6o8N0r.js";
import { C as M } from "./card-mGv9f-kH.js";
import { L as O } from "./label-B9xx98zL.js";
import { T as te, a as se, b as H, c as j, d as oe, e as y } from "./table-CJ-htm9o.js";
import { B as c } from "./vendor-utils-ZATHw6Y5.js";
import { S as le, v as me, g as ue } from "./frankieone-CzWZziTD.js";
import { R as he, E as pe } from "./vendor-ui-utils-DxmL71y2.js";
const re = ({ steps: N, currentStep: l }) => /* @__PURE__ */ e.jsx("div", { className: "w-full mb-8", children: /* @__PURE__ */ e.jsx("div", { className: "flex items-center justify-between", children: N.map((p, o) => /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col items-center flex-1", children: [
  ...
  const o = N.replace(/^data:application\/pdf;base64,/, ""), f = atob(o), C = new Array(f.length);
...
function xe({
  ...
  const [l, p] = r.useState(!1), [o, f] = r.useState(1), [C, A] = r.useState(""), [v, k] = r.useState([]), [i, w] = r.useState(null), [V, Y] = r.useState(null), [S, R] = r.useState({
    asicExtract: "idle",
    uboReport: "idle"
  }), [I, W] = r.useState({
    asicExtract: null,
    ...
    const x = async () => {
      try {
        ...
        if (b("response", a.data), a.status === 202 || a.data.status === "pending")
          g < 60 ? (g++, setTimeout(x, 5e3)) : (R((n) => ({ ...n, [t]: "error" })), c.error(`Timeout while generating ${t} report`));
...
function Ne({
  ...
  const [l, p] = r.useState(!1), [o, f] = r.useState(1), [C, A] = r.useState(""), [v, k] = r.useState([]), [i, w] = r.useState(null), [V, Y] = r.useState(null), [S, R] = r.useState(""), [I, W] = r.useState(""), [P, T] = r.useState([]), [Z, E] = r.useState("idle"), D = (a) => {
    A(a);
  }, z = async () => {
    if (!S && !I) {
    ...
    try {
      ...
      b("data", a), k(a.Companies.CompanyDTO), f(2);
    } catch (a) {
      const n = B(a);
      c.error(n.message);
    } finally {
    ...
    if (i)
      try {
        ...
        b("data", h), c.info("Report order initiated. This may take a few minutes."), await g(h.requestId, n);
      } catch (d) {
        const h = B(d);
    ...
    const Q = async () => {
      var X, _;
      try {
        const { data: L } = await U.post("/marketplace/product/frankieone/international-business-entity-report-status", {
          entityId: V,
          requestId: a
        });
        if (L.reportStatus !== "Completed")
          ...
          const G = (_ = (X = (await U.post("/marketplace/product/frankieone/retrieve-document-scan-data-by-url", {
    ...
    o === 2 && /* @__PURE__ */ e.jsxs(M, { className: "p-8", children: [
      ...
      /* @__PURE__ */ e.jsxs(te, { children: [
        ...
        /* @__PURE__ */ e.jsx(oe, { children: v.map((a, n) => /* @__PURE__ */ e.jsxs(H, { children: [
          ...
          /* @__PURE__ */ e.jsx(y, { children: /* @__PURE__ */ e.jsx(u, { onClick: () => F(a), children: "Select" }) })
        ] }, n)) })
      ] })
    ] }),
    o === 3 && i && /* @__PURE__ */ e.jsxs(M, { className: "p-8", children: [
...
function Be() {
  return /* @__PURE__ */ e.jsx("div", { className: "bg-background", children: /* @__PURE__ */ e.jsx(ge, { showExternalLink: !0 }) });
}
export {
  Be as default
};
