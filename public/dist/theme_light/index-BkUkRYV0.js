import { j as e, E as I, F as M, G as O, H as $ } from "./vendor-radix-AvjOLIap.js";
import { a as l, l as W } from "./vendor-react-DSEtE0wE.js";
import { a as V, aa as _, c as g, ab as q, ac as z, B as w, f as P, t as G, L as Q, g as S, ad as H, ae as J } from "./main-kXKSh1Wy.js";
import { u as K, B as j } from "./vendor-utils-BPVAmMsZ.js";
import { u as X } from "./useTransaction-DFueDreS.js";
import { L as Y } from "./index-BOw7GLyK.js";
import { S as Z, A as ee } from "./vendor-ui-utils-CGOon9_P.js";
import { k as te } from "./vendor-web3-CQEmmIwE.js";
import { u as se, a as ae } from "./MarketplaceProvider-Dcm71KfC.js";
function be({
  text: i,
...
function ye({
  ...
  const E = async () => {
    ...
    N(R);
  }, C = async (n) => (await P.get(`/thirdparty/sign-moonpay-params?url=${encodeURIComponent(n)}`)).data.signature, L = () => {
    o(!1), m(!1), u(!1);
  }, k = async (n) => {
    if (d(!1), await B()) {
