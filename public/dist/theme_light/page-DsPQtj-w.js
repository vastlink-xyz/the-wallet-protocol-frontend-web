...
import { f as T, h as A, c as S, g as D, a7 as z, a8 as H, a9 as v, b7 as y } from "./main-aWh1b37I.js";
import { T as C, a as _, b as j, c as o, d as w, e as h } from "./table-BQftuF8c.js";
import { u as I, P as L } from "./usePagination-D-CDBNPq.js";
import { r as i, i as P } from "./vendor-react-wyPiRY-L.js";
import { B as k } from "./vendor-utils-BSjbfJFn.js";
import { d as R } from "./vendor-ui-utils-BbSwUILz.js";
function E() {
  const {
    pagination: a,
    handlePageChange: c,
    updateTotal: x,
    updatePageSize: p
  } = I(), [m, u] = i.useState([]), [g, l] = i.useState(!1);
  i.useEffect(() => {
    t({
      page: a.current,
      pageSize: a.pageSize
  ...
  return /* @__PURE__ */ e.jsxs("div", { children: [
    /* @__PURE__ */ e.jsxs(C, { className: S(g && "opacity-50"), children: [
      /* @__PURE__ */ e.jsx(_, { children: /* @__PURE__ */ e.jsxs(j, { className: "hover:bg-transparent", children: [
        /* @__PURE__ */ e.jsx(o, { children: "Type" }),
        /* @__PURE__ */ e.jsx(o, { children: "Status" }),
        /* @__PURE__ */ e.jsx(o, { children: "Created At" })
      ] }) }),
      /* @__PURE__ */ e.jsx(w, { children: m.map((s) => /* @__PURE__ */ e.jsxs(j, { className: "hover:bg-transparent", children: [
