import { r as c, p as uo, a as Zt, R as ze, $ as ba, b as Ca } from "./vendor-react-CA5sEv1f.js";
var Ln = { exports: {} }, ht = {};
/**
 * @license React
...
var Cr = "Tabs", [yf, Ld] = Je(Cr, [
  ln
]), Zi = ln(), [xf, Er] = yf(Cr), Ji = c.forwardRef(
  (e, t) => {
    const {
      __scopeTabs: n,
      value: r,
...
var Fd = Ji, $d = es, Wd = ns, Bd = os, bf = "VisuallyHidden", Sr = c.forwardRef(
  (e, t) => /* @__PURE__ */ h.jsx(
    F.span,
    {
      ...e,
...
Sr.displayName = bf;
var Cf = Sr, [vn, Vd] = Je("Tooltip", [
  He
]), mn = He(), as = "TooltipProvider", Ef = 700, Yn = "tooltip.open", [Sf, Rr] = vn(as), cs = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Ef,
...
cs.displayName = as;
var hn = "Tooltip", [Rf, gn] = vn(hn), ls = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
...
us.displayName = zn;
var Pf = "TooltipPortal", [Hd, Tf] = vn(Pf, {
  forceMount: void 0
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ h.jsx(be, { present: r || s.open, children: s.disableHoverableContent ? /* @__PURE__ */ h.jsx(ds, { side: o, ...i, ref: t }) : /* @__PURE__ */ h.jsx(_f, { side: o, ...i, ref: t }) });
  }
), _f = c.forwardRef((e, t) => {
...
}), [Af, Mf] = vn(hn, { isInside: !1 }), ds = c.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
...
fs.displayName = lt;
var ps = "TooltipArrow", Of = c.forwardRef(
  (e, t) => {
