import { j as b } from "./vendor-radix-BMBq7gbN.js";
import { a as Fa, c as et, l as zl, B as Rs, u as Ms, D as Wl, b as Zl, d as Gl, e as Ro, f as as, h as Qs, S as Os, g as Dl, T as js, i as Fs } from "./main-D5sRvz5I.js";
import { j as CA, k as Rl, L as Ls, r as B, a as Hs, p as Ml, O as Ns } from "./vendor-react-BA5A8Axg.js";
import { u as Ql, B as Us } from "./vendor-utils-7AahqLO2.js";
import { X as zs } from "./vendor-ui-utils-CNDLbdLA.js";
import { W as _l, V as Ws } from "./index-D-2kpqHC.js";
import { S as Zs } from "./SendButton-IZgbYqCR.js";
import { W as Gs, M as _s } from "./MarketplaceProvider-Dy1SitKL.js";
function Ys({ routes: f, currentRouteName: c }) {
  const { pathname: g } = CA(), m = Rl(), A = Fa.isAuthenticated();
...
function Yl({
  ...
  const { i18n: c } = Ql(), [g, m] = B.useState(!1);
  B.useEffect(() => {
    const P = zl.getData();
...
function Xs() {
  const { t: f } = Ql(), [c, g] = B.useState(!1), m = Fa.isAuthenticated(), A = Rl(), { pathname: w } = CA(), { data: P } = Ms(), [E, y] = B.useState("");
  B.useEffect(() => {
  ...
  const C = [
    ...
    try {
      await as.post("/auth/logout"), Fa.clearAllAuthData(), window.location.href = "/auth";
    } catch (k) {
      const Q = Qs(k);
      Us.error(Q.message);
    }
                ...
                return /* @__PURE__ */ b.jsx(
                  Ro,
                  {
                    ...
                    children: Q ? /* @__PURE__ */ b.jsxs("div", { className: "w-full flex items-center justify-between gap-2", children: [
                      /* @__PURE__ */ b.jsx("div", { className: "text-brand-foreground", children: k.name }),
                      /* @__PURE__ */ b.jsx("img", { src: "/imgs/icons/checked.svg", alt: "" })
                    ] }) : /* @__PURE__ */ b.jsx("div", { className: "", children: k.name })
                  },
                  k.name
                );
              }),
        ...
        Wl,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ b.jsxs(Gl, { className: "bg-white", children: [
              ...
              /* @__PURE__ */ b.jsx(Ro, { onSelect: () => H(), children: "Logout" })
            ] })
          ]
        }
      ) }),
...
function Vs() {
  const { pathname: f } = CA(), { t: c } = Ql(), g = Rl(), m = Fa.isAuthenticated(), A = [
    {
    ...
    for (var x in v) if (g.call(v, x)) {
      ...
      if (O != null && typeof O != "boolean" && O !== "") {
        if (x.indexOf("--") === 0) {
          ...
          I = x;
          var N = X.get(I);
          N !== void 0 || (N = L(I.replace(_, "-$1").toLowerCase().replace(F, "-ms-")), X.set(I, N)), I = N, O = typeof O == "number" ? O === 0 || g.call(k, x) ? "" + O : O + "px" : L(("" + O).trim());
        }
  ...
  function ve(a, u, v, x, O) {
    switch (u) {
      ...
      case "option":
        ...
        if (N != null) if (v = ie !== null ? "" + ie : te(V), T(N)) {
...
`), I;
      ...
      case "html":
        return O.insertionMode === 0 && a.push("<!DOCTYPE html>"), re(a, v, u, x);
      default:
        if (u.indexOf("-") === -1 && typeof v.is != "string") return re(a, v, u, x);
        a.push(ce(u)), N = I = null;
    ...
    if (ot = _t(), Re = Kn(), u = u === void 0 ? null : u, Re !== null) {
      ...
      if (v !== null && u !== null) {
        ...
        e: if (x === null) x = !1;
          ...
          for (var O = 0; O < x.length && O < u.length; O++) if (!wr(u[O], x[O])) {
            x = !1;
            break e;
          }
          x = !0;
  ...
  function kn(a, u, v, x, O, I, N, V, ie) {
    var he = [], se = /* @__PURE__ */ new Set();
    return u = { destination: null, responseState: u, progressiveChunkSize: x === void 0 ? 12800 : x, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: se, pingedTasks: he, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: O === void 0 ? ct : O, onAllReady: jt, onShellReady: N === void 0 ? jt : N, onShellError: jt, onFatalError: jt }, v = rn(u, 0, null, v, !1, !1), v.parentFlushed = !0, a = nn(u, a, null, v, se, Rt, null, yr), he.push(a), u;
  }
  ...
  function Yt(a, u, v, x, O) {
    if (typeof v == "function") if (v.prototype && v.prototype.isReactComponent) {
      O = gr(v, u.legacyContext);
      var I = v.contextType;
      I = new v(x, typeof I == "object" && I !== null ? I._currentValue2 : O), mr(I, v, x, O), Sr(a, u, I, v);
    } else {
      I = gr(v, u.legacyContext), O = dt(a, u, v, x, I);
      var N = hn !== 0;
      if (typeof O == "object" && O !== null && typeof O.render == "function" && O.$$typeof === void 0) mr(O, v, x, I), Sr(a, u, O, v);
      else if (N) {
      ...
      switch (O = u.blockedSegment, I = ve(O.chunks, v, x, a.responseState, O.formatContext), O.lastPushedText = !1, N = O.formatContext, O.formatContext = ne(N, v, x), Ht(a, u, I), O.formatContext = N, v) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      if (typeof v == "object" && v !== null) switch (v.$$typeof) {
        case tt:
          ...
          return;
        case Ue:
          v = v.type, x = xr(v, x), Yt(a, u, v, x, O);
          return;
        case Zt:
        ...
        case Gt:
          ...
          return;
        case Pe:
          O = v._init, v = O(v._payload), x = xr(v, x), Yt(
            a,
            u,
            v,
            x,
...
function Ks() {
  ...
  var k = Object.prototype.hasOwnProperty, Q = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, U = {}, L = {};
  function _(i) {
    return k.call(L, i) ? !0 : k.call(U, i) ? !1 : Q.test(i) ? L[i] = !0 : (U[i] = !0, !1);
  }
  ...
  var te = /([A-Z])/g, re = /^ms-/, ue = Array.isArray, ae = C("<script>"), ce = C("<\/script>"), ve = C('<script src="'), de = C('<script type="module" src="'), Me = C('" async=""><\/script>'), Ce = /(<\/|<)(s)(cript)/gi;
  function ee(i, s, h, S) {
    return "" + s + (h === "s" ? "\\u0073" : "\\u0053") + S;
  }
  function le(i, s, h, S, j) {
    ...
    for (var S in h) if (k.call(h, S)) {
      ...
      if (j != null && typeof j != "boolean" && j !== "") {
        if (S.indexOf("--") === 0) {
          ...
          M = S;
          var z = Se.get(M);
          z !== void 0 || (z = C(Z(M.replace(te, "-$1").toLowerCase().replace(re, "-ms-"))), Se.set(M, z)), M = z, j = typeof j == "number" ? j === 0 || k.call(X, S) ? y("" + j) : y(j + "px") : y(Z(("" + j).trim()));
        }
        s ? (s = !1, i.push(Ae, M, Le, j)) : i.push(Zt, M, Le, j);
      }
    }
    s || i.push(xe);
  }
...
` && i.push(Rt), M;
  ...
  var Gn = C("</"), _n = C(">"), We = C('<template id="'), Yn = C('"></template>'), mr = C("<!--$-->"), yr = C('<!--$?--><template id="'), Xn = C('"></template>'), Cn = C("<!--$!-->"), Jr = C("<!--/$-->"), Vn = C("<template"), $t = C('"'), Jn = C(' data-dgst="');
  ...
  var Mt = C('<div hidden id="'), qt = C('">'), Re = C("</div>"), en = C('<svg aria-hidden="true" style="display:none" id="'), Dn = C('">'), hn = C("</svg>"), Qt = C('<math aria-hidden="true" style="display:none" id="'), Pn = C('">'), _t = C("</math>"), Ve = C('<table hidden id="'), Kn = C('">'), $n = C("</table>"), br = C('<table hidden><tbody id="'), Ze = C('">'), qn = C("</tbody></table>"), Kr = C('<table hidden><tr id="'), $r = C('">'), Ot = C("</tr></table>"), er = C('<table hidden><colgroup id="'), Bn = C('">'), tn = C("</colgroup></table>");
  function ct(i, s, h, S) {
    switch (h.insertionMode) {
      ...
      case 5:
        return A(i, br), A(i, s.segmentPrefix), A(i, y(S.toString(16))), w(i, Ze);
      case 6:
  ...
  var za = typeof Object.is == "function" ? Object.is : Wt, Vt = null, qr = null, Cr = null, Qe = null, mn = !1, Dr = !1, yn = 0, un = null, Pr = 0;
  function cn() {
  ...
  function no(i, s, h, S, j, M, z, J, pe) {
    var we = [], ye = /* @__PURE__ */ new Set();
    return s = { destination: null, responseState: s, progressiveChunkSize: S === void 0 ? 12800 : S, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: ye, pingedTasks: we, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: j === void 0 ? Ga : j, onAllReady: M === void 0 ? Qn : M, onShellReady: z === void 0 ? Qn : z, onShellError: J === void 0 ? Qn : J, onFatalError: pe === void 0 ? Qn : pe }, h = On(s, 0, null, h, !1, !1), h.parentFlushed = !0, i = ro(s, i, null, h, ye, ie, null, vn), we.push(i), s;
  }
  function ro(i, s, h, S, j, M, z, J) {
  ...
  function Uo(i, s, h, S, j) {
    for (Vt = {}, qr = s, yn = 0, i = h(S, j); Dr; ) Dr = !1, yn = 0, Pr += 1, Qe = null, i = h(S, j);
    return tr(), i;
  }
  function zo(i, s, h, S) {
  ...
  function Ir(i, s, h, S, j) {
    if (typeof h == "function") if (h.prototype && h.prototype.isReactComponent) {
      ...
      switch (j = s.blockedSegment, M = Zn(j.chunks, h, S, i.responseState, j.formatContext), j.lastPushedText = !1, z = j.formatContext, j.formatContext = oe(z, h, S), Rr(i, s, M), j.formatContext = z, h) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      if (typeof h == "object" && h !== null) switch (h.$$typeof) {
        case Rn:
          ...
          return;
        case a:
          h = h.type, S = Wo(h, S), Ir(i, s, h, S, j);
          return;
        case Ut:
          if (j = S.children, h = h._context, S = S.value, M = h._currentValue, h._currentValue = S, z = se, se = S = { parent: z, depth: z === null ? 0 : z.depth + 1, context: h, parentValue: M, value: S }, s.context = S, ht(i, s, j), i = se, i === null) throw Error(c(403));
        ...
        case it:
          ...
          return;
        case u:
          j = h._init, h = j(h._payload), S = Wo(h, S), Ir(i, s, h, S, void 0);
          return;
      }
      throw Error(c(
        130,
  ...
  function Rr(i, s, h) {
    ...
    try {
      ...
      if (tr(), typeof pe == "object" && pe !== null && typeof pe.then == "function") {
        ...
        z.children.push(J), z.lastPushedText = !1, i = ro(i, s.node, s.blockedBoundary, J, s.abortSet, s.legacyContext, s.context, s.treeContext).ping, h.then(i, i), s.blockedSegment.formatContext = S, s.legacyContext = j, s.context = M, zt(M);
  ...
  function _o(i, s, h) {
    ...
    } else s.pendingTasks--, s.forceClientRender || (s.pendingTasks === 0 ? (h.parentFlushed && h.status === 1 && Mr(s, h), s.parentFlushed && i.completedBoundaries.push(s), s.fallbackAbortableTasks.forEach(_a, i), s.fallbackAbortableTasks.clear()) : h.parentFlushed && h.status === 1 && (Mr(s, h), s.completedSegments.length === 1 && s.parentFlushed && i.partialBoundaries.push(s)));
  ...
  function Yo(i) {
    if (i.status !== 2) {
      ...
      try {
        ...
        j.splice(0, M), i.destination !== null && oo(i, i.destination);
      } catch (Dt) {
        rr(i, Dt), Tr(i, Dt);
      } finally {
  ...
  function Or(i, s, h) {
    ...
    if (S.parentFlushed = !0, S.forceClientRender) S = S.errorDigest, w(s, Cn), A(s, Vn), S && (A(s, Jn), A(s, y(Z(S))), A(s, $t)), w(s, wr), Qr(i, s, h);
      ...
      j = C(j.boundaryPrefix + M.toString(16)), S = S.id = j, ot(s, i.responseState, S), Qr(i, s, h);
  ...
  function Jo(i, s, h, S) {
    ...
    return Xo(i, s, S), i = i.responseState, A(s, i.startInlineScript), i.sentCompleteSegmentFunction ? A(s, nn) : (i.sentCompleteSegmentFunction = !0, A(s, kn)), A(s, i.segmentPrefix), j = y(j.toString(16)), A(s, j), A(s, rn), A(s, i.placeholderPrefix), A(s, j), w(s, Ft);
  }
  function oo(i, s) {
...
function $s() {
  return Jl || (Jl = 1, Ml.env.NODE_ENV !== "production" && function() {
    ...
    var G = Object.prototype.hasOwnProperty, $ = 0, Z = 1, te = 2, re = 3, ue = 4, ae = 5, ce = 6, ve = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", de = ve + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", Me = new RegExp("^[" + ve + "][" + de + "]*$"), Ce = {}, ee = {};
    function le(e) {
    ...
    function oe(e, t, n, o, l, d, p) {
      this.acceptsBooleans = t === te || t === re || t === ue, this.attributeName = o, this.attributeNamespace = l, this.mustUseProperty = n, this.propertyName = e, this.type = t, this.sanitizeURL = d, this.removeEmptyString = p;
    }
    var me = {}, Oe = [
      "children",
      ...
      for (var l in n)
        if (G.call(n, l)) {
          ...
          if (!(d == null || typeof d == "boolean" || d === "")) {
            ...
            R ? (p = Ve(l), ne(d, l), D = Ve(("" + d).trim())) : (Qt(l, d), p = Nt(l), typeof d == "number" ? d !== 0 && !G.call(Zt, l) ? D = d + "px" : D = "" + d : (ne(d, l), D = Ve(("" + d).trim()))), o ? (o = !1, e.push(at, p, An, D)) : e.push(pn, p, An, D);
          }
        }
      o || e.push(it);
    }
...
` && e.push(gn), l;
    ...
    var Pr = "<!--$-->", cn = '<!--$?--><template id="', Et = '"></template>', eo = "<!--$!-->", tr = "<!--/$-->", Lo = "<template", Br = '"', Ho = ' data-dgst="', Wa = ' data-msg="', Za = ' data-stck="', kr = "></template>";
    function No(e, t) {
      return C(e, Pr);
    }
    function nr(e, t, n) {
    ...
    function to(e, t, n, o, l) {
      var d;
      return d = C(e, eo), y(e, Lo), n && (y(e, Ho), y(e, Ve(n)), y(e, Br)), o && (y(e, Wa), y(e, Ve(o)), y(e, Br)), l && (y(e, Za), y(e, Ve(l)), y(e, Br)), d = C(e, kr), d;
    }
    function Ga(e, t) {
      return C(e, tr);
    }
    ...
    var ro = '<div hidden id="', On = '">', rr = "</div>", Tr = '<svg aria-hidden="true" style="display:none" id="', Uo = '">', zo = "</svg>", Wo = '<math aria-hidden="true" style="display:none" id="', Ir = '">', ht = "</math>", Zo = '<table hidden id="', Rr = '">', _a = "</table>", Go = '<table hidden><tbody id="', Mr = '">', _o = "</tbody></table>", Yo = '<table hidden><tr id="', Qr = '">', Or = "</tr></table>", Xo = '<table hidden><colgroup id="', Vo = '">', Jo = "</colgroup></table>";
    function oo(e, t, n, o) {
    ...
    function TA(e, t, n, o, l, d) {
      if (y(e, t.startInlineScript), t.sentClientRenderFunction ? y(e, Dt) : (t.sentClientRenderFunction = !0, y(e, Ct)), n === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return y(e, n), y(e, jr), (o || l || d) && (y(e, or), y(e, Ya(o || ""))), (l || d) && (y(e, or), y(e, Ya(l || ""))), d && (y(e, or), y(e, Ya(d))), C(e, $o);
    }
    var IA = /[<\u2028\u2029]/g;
    function Ya(e) {
    ...
    var wt = Object.assign, LA = Symbol.for("react.element"), Mi = Symbol.for("react.portal"), qo = Symbol.for("react.fragment"), Pt = Symbol.for("react.strict_mode"), Qi = Symbol.for("react.profiler"), ea = Symbol.for("react.provider"), ta = Symbol.for("react.context"), na = Symbol.for("react.forward_ref"), ra = Symbol.for("react.suspense"), ao = Symbol.for("react.suspense_list"), io = Symbol.for("react.memo"), Fr = Symbol.for("react.lazy"), Xa = Symbol.for("react.scope"), Va = Symbol.for("react.debug_trace_mode"), Ja = Symbol.for("react.legacy_hidden"), oa = Symbol.for("react.default_value"), Oi = Symbol.iterator, HA = "@@iterator";
    function NA(e) {
    ...
    function Fi() {
      {
        if (Ao === 0) {
          ji = console.log, $a = console.info, He = console.warn, Lr = console.error, qa = console.group, ei = console.groupCollapsed, ti = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: ni,
...
` + D[W].replace(" at new ", " at ");
        ...
        ri = !1, aa.current = d, Li(), Error.prepareStackTrace = l;
      }
    ...
    var Hi = {}, ii = g.ReactDebugCurrentFrame;
    function Aa(e) {
      if (e) {
    ...
    var Zi = {}, Nr = {}, vo, si, ha, pa, va, Ur, go, mo, ga;
    {
      vo = /* @__PURE__ */ new Set(), si = /* @__PURE__ */ new Set(), ha = /* @__PURE__ */ new Set(), go = /* @__PURE__ */ new Set(), pa = /* @__PURE__ */ new Set(), mo = /* @__PURE__ */ new Set(), ga = /* @__PURE__ */ new Set();
...
Please update the following components: %s`,
    ...
    function Xi(e, t, n, o) {
      ...
      typeof R == "function" && (e.state = ui(e, t, R, l, n)), typeof t.getDerivedStateFromProps != "function" && typeof e.getSnapshotBeforeUpdate != "function" && (typeof e.UNSAFE_componentWillMount == "function" || typeof e.componentWillMount == "function") && (Yi(t, e), ZA(d, e, n, o));
    }
    var GA = {
      id: 1,
      overflow: ""
    ...
    var XA = Math.clz32 ? Math.clz32 : VA, di = Math.log, wa = Math.LN2;
    function VA(e) {
      var t = e >>> 0;
    ...
    var KA = typeof Object.is == "function" ? Object.is : JA, wn = null, fi = null, ba = null, Fe = null, Bt = !1, zr = !1, lr = 0, ke = null, Hn = 0, Sa = 25, kt = !1, Tt;
    function dn() {
      if (wn === null)
...
Incoming: %s`, Tt, "[" + e.join(", ") + "]", "[" + t.join(", ") + "]");
    ...
    function bo() {
      kt = !1, wn = null, fi = null, zr = !1, ba = null, Hn = 0, ke = null, Fe = null;
    }
    function el(e) {
...
` + o.stack;
    ...
    var Da = g.ReactCurrentDispatcher, So = g.ReactDebugCurrentFrame, Pa = 0, Wr = 1, Ba = 2, ka = 3, Ta = 4, Zr = 0, mi = 1, ur = 2, tA = 12800;
    function sl(e) {
    ...
    var rA = {}, Bo = {}, bi = {}, oA = {}, Si = !1, ko = {}, xi = !1, Ei = !1, Ci = !1;
    function aA(e, t, n, o) {
      var l;
    ...
    function AA(e, t, n, o, l) {
      xo(t, n.render);
      var d = Po(e, t, n.render, o, l), p = hi();
      if (p) {
    ...
    function Bi(e) {
      if (e.status !== ur) {
        ...
        Da.current = qi;
        var o;
        o = So.getCurrentStack, So.getCurrentStack = yi;
        var l = gi;
        eA(e.responseState);
        try {
...
function qs() {
  return Kl || (Kl = 1, Ml.env.NODE_ENV !== "production" && function() {
    ...
    function $(r, e) {
      if (X(r))
        return A("The provided `%s` attribute is an unsupported type %s. This value must be coerced to a string before before using it here.", e, ne(r)), G(r);
    }
    function Z(r, e) {
      if (X(r))
        return A("The provided `%s` CSS property is an unsupported type %s. This value must be coerced to a string before before using it here.", e, ne(r)), G(r);
    }
    function te(r) {
      if (X(r))
        return A("The provided HTML markup uses a value of unsupported type %s. This value must be coerced to a string before before using it here.", ne(r)), G(r);
    }
    var re = Object.prototype.hasOwnProperty, ue = 0, ae = 1, ce = 2, ve = 3, de = 4, Me = 5, Ce = 6, ee = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", le = ee + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", fe = new RegExp("^[" + ee + "][" + le + "]*$"), be = {}, oe = {};
    function me(r) {
      return re.call(oe, r) ? !0 : re.call(be, r) ? !1 : fe.test(r) ? (oe[r] = !0, !0) : (be[r] = !0, A("Invalid attribute name: `%s`", r), !1);
    }
    function Oe(r, e, t, n) {
      if (t !== null && t.type === ue)
        return !1;
    ...
    function xr(r, e, t, n, o) {
      ...
      if (t !== void 0 && p.push(d, F(on(t)), kn), n !== void 0)
      ...
      for (var o in t)
        if (re.call(t, o)) {
          ...
          if (!(l == null || typeof l == "boolean" || l === "")) {
            ...
            D ? (d = F(Ze(o)), Z(l, o), p = F(Ze(("" + l).trim()))) : (Kn(o, l), d = u(o), typeof l == "number" ? l !== 0 && !re.call(xe, o) ? p = F(l + "px") : p = F("" + l) : (Z(l, o), p = F(Ze(("" + l).trim())))), n ? (n = !1, r.push(v, d, x, p)) : r.push(O, d, x, p);
          }
        }
      n || r.push(ie);
    }
        ...
        if (o !== null) {
          ...
          switch (o.type) {
            ...
            case Ce:
              ...
              break;
            default:
              o.sanitizeURL && ($(n, l), n = "" + n, Bn(n)), r.push(N, d, V, F(Ze(n)), ie);
          }
        } else if (me(t)) {
          switch (typeof n) {
            case "function":
...
` && r.push(yn), n !== null && ($(n, "value"), r.push(F(it("" + n)))), null;
    ...
    function mn(r, e, t, n) {
      ...
      return r.push(Be), lt(r, l, o), typeof o == "string" ? (r.push(F(it(o))), null) : o;
    }
    function Dr(r, e, t, n) {
      r.push(Et(t));
      var o = null, l = null;
...
` && r.push(yn), o;
    ...
    var nr = T("<!--$-->"), to = T('<!--$?--><template id="'), Ga = T('"></template>'), Qn = T("<!--$!-->"), no = T("<!--/$-->"), ro = T("<template"), On = T('"'), rr = T(' data-dgst="'), Tr = T(' data-msg="'), Uo = T(' data-stck="'), zo = T("></template>");
    function Wo(r, e) {
      return Q(r, nr);
    }
    function Ir(r, e, t) {
    ...
    function ht(r, e, t, n, o) {
      var l;
      return l = Q(r, Qn), k(r, ro), t && (k(r, rr), k(r, F(Ze(t))), k(r, On)), n && (k(r, Tr), k(r, F(Ze(n))), k(r, On)), o && (k(r, Uo), k(r, F(Ze(o))), k(r, On)), l = Q(r, zo), l;
    }
    function Zo(r, e) {
      return Q(r, no);
    }
    ...
    var Go = T('<div hidden id="'), Mr = T('">'), _o = T("</div>"), Yo = T('<svg aria-hidden="true" style="display:none" id="'), Qr = T('">'), Or = T("</svg>"), Xo = T('<math aria-hidden="true" style="display:none" id="'), Vo = T('">'), Jo = T("</math>"), oo = T('<table hidden id="'), Ko = T('">'), i = T("</table>"), s = T('<table hidden><tbody id="'), h = T('">'), S = T("</tbody></table>"), j = T('<table hidden><tr id="'), M = T('">'), z = T("</tr></table>"), J = T('<table hidden><colgroup id="'), pe = T('">'), we = T("</colgroup></table>");
    function ye(r, e, t, n) {
      switch (t.insertionMode) {
        case Yt:
        case Ge:
          return k(r, Go), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, Mr);
        case Lt:
          return k(r, Yo), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, Qr);
        case Ht:
          return k(r, Xo), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, Vo);
        case an:
          return k(r, oo), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, Ko);
        case Tn:
          return k(r, s), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, h);
        case xt:
          return k(r, j), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, M);
        case Nt:
          return k(r, J), k(r, e.segmentPrefix), k(r, F(n.toString(16))), Q(r, pe);
        default:
          throw new Error("Unknown insertion mode. This is a bug in React.");
      }
    }
    ...
    function IA(r, e, t) {
      ...
      var n = F(t.toString(16));
      return k(r, n), k(r, or), k(r, e.placeholderPrefix), k(r, n), Q(r, TA);
    }
    var Ya = T(Ct + ';$RC("'), RA = T('$RC("'), MA = T('","'), Ii = T('")<\/script>');
    function Ri(r, e, t, n) {
      ...
      return k(r, t), k(r, MA), k(r, e.segmentPrefix), k(r, o), Q(r, Ii);
    }
    ...
    function LA(r, e, t, n, o, l) {
      if (k(r, e.startInlineScript), e.sentClientRenderFunction ? k(r, OA) : (e.sentClientRenderFunction = !0, k(r, QA)), t === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return k(r, t), k(r, jA), (n || o || l) && (k(r, wt), k(r, F(qo(n || "")))), (o || l) && (k(r, wt), k(r, F(qo(o || "")))), l && (k(r, wt), k(r, F(qo(l)))), Q(r, FA);
    }
    var Mi = /[<\u2028\u2029]/g;
    function qo(r) {
    ...
    function lo() {
      {
        if (Lr === 0) {
          qa = console.log, ei = console.info, ti = console.warn, ni = console.error, Fi = console.group, Li = console.groupCollapsed, aa = console.groupEnd;
          var r = {
            configurable: !0,
            enumerable: !0,
            value: ia,
    ...
    var Hr = g.ReactCurrentDispatcher, oi;
    function ar(r, e, t) {
      {
        if (oi === void 0)
          try {
...
` + p[R].replace(" at new ", " at ");
    ...
    var ha = {}, pa = {}, va, Ur, go, mo, ga, yo, ma, ya, ui;
    {
      va = /* @__PURE__ */ new Set(), Ur = /* @__PURE__ */ new Set(), go = /* @__PURE__ */ new Set(), ma = /* @__PURE__ */ new Set(), mo = /* @__PURE__ */ new Set(), ya = /* @__PURE__ */ new Set(), ui = /* @__PURE__ */ new Set();
...
Incoming: %s`, Nn, "[" + r.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function bo() {
      return ke === null ? lr === null ? (Hn = !1, lr = ke = hi()) : (Hn = !0, ke = lr) : ke.next === null ? (Hn = !1, ke = ke.next = hi()) : (Hn = !0, ke = ke.next), ke;
    }
    function el(r, e) {
      Bt = e, zr = r, Jt = !1, kt = 0;
    }
    ...
    function Ki(r, e, t) {
      if (r !== vi && (Nn = "useReducer"), Bt = sr(), ke = bo(), Hn) {
...
` + n.stack;
    ...
    var Ba = g.ReactCurrentDispatcher, ka = g.ReactDebugCurrentFrame, Ta = 0, Zr = 1, mi = 2, ur = 3, tA = 4, sl = 0, Gr = 1, _r = 2, ul = 12800;
    function cl(r) {
    ...
    function nA(r, e, t) {
      xn(e, "Suspense");
      var n = e.blockedBoundary, o = e.blockedSegment, l = t.fallback, d = t.children, p = /* @__PURE__ */ new Set(), D = yi(r, p), R = o.chunks.length, W = xo(
        r,
        R,
        D,
        o.formatContext,
      ...
      try {
        ...
        Y.status = tA, D.forceClientRender = !0, D.errorDigest = Do(r, ge), wi(D, ge);
      } finally {
    ...
    function oA(r, e, t, n) {
      ...
      wo(l, t, n, o), bi(r, e, l, t, n), Kt(e);
    }
    var Si = {}, ko = {}, xi = {}, Ei = {}, Ci = !1, aA = {}, iA = !1, Di = !1, AA = !1;
    function fl(r, e, t, n) {
      var o;
    ...
    function It(r, e, t, n) {
      ...
      p = e.context, e.context = li(o, l), vt(r, e, d), e.context = WA(o), p !== e.context && A("Popping the context provider did not return back to the original snapshot. This is a bug in React.");
    }
    ...
    function cA(r, e, t, n) {
      var o = Do(r, n);
      if (e === null ? Po(r, n) : (e.pendingTasks--, e.forceClientRender || (e.forceClientRender = !0, e.errorDigest = o, wi(e, n), e.parentFlushed && r.clientRenderedBoundaries.push(e))), r.allPendingTasks--, r.allPendingTasks === 0) {
        var l = r.onAllReady;
        l();
      }
    }
    ...
    function Qa(r, e, t) {
      ...
      if (n.parentFlushed = !0, n.forceClientRender)
        return ht(e, r.responseState, n.errorDigest, n.errorMessage, n.errorComponentStack), Io(r, e, t), _a(e, r.responseState);
      if (n.pendingTasks > 0) {
...
var jo, Tl;
Ml.env.NODE_ENV === "production" ? (jo = Js(), Tl = Ks()) : (jo = $s(), Tl = qs());
...
const ou = "data:image/svg+xml;base64,", au = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 0 637 637", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m478 113-13 2-4 1h4l14-2c10-2 35-2 42-1l6 3 3 1c3 0-4-3-8-5-7-1-34-1-44 1m56 6 8 6c7 5 20 17 20 19s7 12 8 12l-3-6-4-6c0-3-15-17-25-24-5-3-8-4-4-1m-198 16-9 1a512 512 0 0 1 9-1m-180 30a412 412 0 0 0-23 4 167 167 0 0 0-32 8 439 439 0 0 1 46-9 304 304 0 0 1 11-2l6-1h-8m369 8 4 3-7-6c-1 0 0 2 3 3m-439 9c-7 3-18 13-18 15l6-5c5-5 9-8 14-10l6-4-8 4m442 12-10 11-7 6 7-6c7-5 14-14 13-16l-3 5M65 205l-1 11c0 9 0 10 4 17 5 10 7 12 22 11 10 0 15 0 38-5l5-1-6 1-16 2-21 2c-13 1-16-1-21-10-3-5-4-6-4-15l1-12c1-4 1-5-1-1m335 1c3 0 3 1 3 3l-2 6c-2 5-35 39-76 80-53 51-120 117-138 137-21 24-22 25-22 27 0 3 6 9 9 9 4 0 14-8 38-27a5073 5073 0 0 1 15-16 1421 1421 0 0 0-17 15l-31 25-6 2-4-3c-3-3-3-4-2-6 3-8 79-85 160-163 57-57 79-80 79-86 0-2-3-4-7-4-2 0-2 0 1 1m165 18c-9 17-25 32-57 53l-10 8 16-11 12-8c15-10 27-22 39-39 5-7 6-8 4-8l-4 5m-221 2a199 199 0 0 0-19 10 183 183 0 0 1 27-12c0-1-1-1-8 2m-34 16c-3 3-2 3 2 0l1-2-3 2m151 3-1 2 2-2c3-3 2-3-1 0m-16 12-11 10a281 281 0 0 0 11-10m-24 18-7 5-7 5-42 31c-10 7-24 19-22 19l7-6 16-12a343 343 0 0 0 35-25 573 573 0 0 0 20-17m-187 0-2 2 4-2 3-2-5 2m-14 6-3 2 4-1 4-3-5 2m-7 3-8 4-18 8 18-7 7-3 3-1c1-2 0-2-2-1m254 24a2672 2672 0 0 1-71 54 601 601 0 0 0 39-29 1352 1352 0 0 1 32-25m-291-8-2 2 4-2 3-2-5 2m-13 5-2 2h3c5-3 4-4-1-2m-19 9-7 3-13 6c-10 5-13 7-14 10-3 4-2 5 1 0 2-3 5-5 14-9l13-6 12-6-6 2m178 36c-17 12-21 16-21 17a390 390 0 0 1 20-17m-206 34 1 4 1 3 1 5 2 8 1 5v-6l-1-8-2-5-1-4-1-2c-1-2-1-2-1 0m222 23-9 7a683 683 0 0 0-56 44 261 261 0 0 0-26 20 1345 1345 0 0 0-46 34c-6 3-7 3-19 3-11 0-12 0-18-3-8-4-10-8-17-20l-5-10 4 10c5 10 12 18 19 22 4 2 6 2 17 2 13 0 14 0 21-3l26-19 42-33a2183 2183 0 0 0 43-34 643 643 0 0 1 24-20", fill: "#fff", fillRule: "evenodd" }), /* @__PURE__ */ B.createElement("path", { d: "M478 114a620 620 0 0 1-39 6l-21 3a5481 5481 0 0 0-19 3 870 870 0 0 1-54 8l-1 1-6 1-12 2-13 2a992 992 0 0 0-76 12 400 400 0 0 1-45 8l-6 1-5 1h-3l-3 1-2 1-26 4-13 2-17 3c-23 5-33 9-43 19-7 8-9 13-9 27 0 8 1 9 4 14 5 9 8 11 21 10l21-2a1133 1133 0 0 1 23-4 659 659 0 0 0 74-14l3-1h3l3-1h3l2-1 2-1h3l2-1h2l24-5 38-7a2100 2100 0 0 1 93-18l3-1 10-1a2082 2082 0 0 1 120-17l2 1c2 0 8 5 8 7l1 2 1 6c0 4 0 6-3 10-2 4-16 16-18 16l-7 5-10 8a1070 1070 0 0 0-11 7 113 113 0 0 1-20 14l-2 2-3 2-2 2h-1a154 154 0 0 1-28 21l-5 4-5 4a573 573 0 0 1-50 37 175 175 0 0 0-24 18l-1 2-2 1-2 1-2 1-1 1-12 10a396 396 0 0 0-32 25l-8 6-6 5-9 7a326 326 0 0 1-25 20l-13 12a5073 5073 0 0 0-17 15c-24 20-34 27-39 27-2 0-8-6-8-9 0-2 1-3 22-27 18-20 85-86 138-137 41-41 74-75 76-80l2-6c0-2 0-3-2-3l-7 1a233 233 0 0 1-26 9l-1 1-1 1h-1l-1 1h-2l-3 2-1 1h-2l-3 2h-1l-5 2-22 10-9 4-4 2-5 2-10 4-2 1-2 1-2 1-13 6a334 334 0 0 1-38 17 75 75 0 0 0-14 6l-5 2-4 1-2 1-3 2-7 3-16 6a247 247 0 0 0-32 14l-1 1h-2l-1 1h-2l-1 1-12 6a103 103 0 0 0-27 15l-2 5-1 1v11l1 5 1 5 1 4c0 3 0 4 2 4v3l1 3 1 2 2 10 1 4 1 5 2 10 2 8 1 4 1 4c3 3 9 25 11 38l1 7v2l1 4v1l1 1v2l1 2 1 3v1l5 10c7 13 9 16 17 20 6 3 7 3 18 3 12 0 13 0 19-3 8-4 11-6 26-18a1345 1345 0 0 1 85-67 683 683 0 0 1 50-39l12-9a513 513 0 0 1 44-33 201 201 0 0 0 22-17 2270 2270 0 0 0 73-54 158 158 0 0 0 58-59c2 0 3-9 4-27l-1-19-1-4-1-6-1-3-4-6-4-6c0-2-6-8-13-14a77 77 0 0 0-28-18c-6-1-34-1-43 1" })), ql = B.forwardRef(au), iu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M765-321q0 117-84 196-83 80-200 80-118 0-200-80t-83-196v-392q0-85 61-144 61-58 146-58 86 0 147 58 61 59 61 144v374q0 54-39 92-39 37-93 37-55 0-93-37-38-38-38-92v-372h110v372q0 9 6 14t15 5q8 0 15-5t7-14v-374q0-39-29-66t-68-27q-40 0-69 27t-29 66v392q0 71 51 119t122 48q71 0 122-48t51-119v-426h111v426Z" })), es = B.forwardRef(iu), Au = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M125-165v-113h77v-273q0-93 55-167 56-75 146-100v-19q0-32 22-55 23-23 55-23t55 23q22 23 22 55v19q90 25 146 99 56 73 56 168v273h77v113H125ZM480-32q-38 0-66-27-27-27-27-66h186q0 39-27 66t-66 27Z" })), lu = B.forwardRef(Au), su = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M137-190v-113h78v-253q0-41 11-79 11-39 35-71l-9 150h10L17-802l74-74L873-92l-74 74-175-172H137Zm609-149L319-769q20-15 41-25t44-16v-28q0-32 22-54t54-22q32 0 55 22t22 54v28q85 23 137 94t52 160v217ZM481-47q-38 0-65-27t-27-65h184q0 38-27 65t-65 27Z" })), uu = B.forwardRef(su), cu = (f, c) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", ref: c, ...f }, /* @__PURE__ */ B.createElement("g", { strokeLinecap: "round", strokeWidth: 10 }, /* @__PURE__ */ B.createElement("path", { d: "m19 19 61 61M80 19 19 80" }))), du = B.forwardRef(cu), fu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M94-136v-255l351-93-351-92v-253l816 346L94-136Z" })), hu = B.forwardRef(fu), pu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M480-372q-61 0-105-43-43-43-43-105v-240q0-61 43-105 43-43 105-43 61 0 105 43 43 44 43 105v240q0 62-43 105t-105 43ZM425-76v-122q-121-16-197-108t-76-214h109q0 91 64 154t155 63q91 0 155-63t64-154h109q0 122-77 214T534-198v122H425Z" })), vu = B.forwardRef(pu), gu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m763-343-80-79q8-20 13-44 5-23 5-54h109q0 49-11 95t-36 82ZM625-482 336-770v-2q3-56 45-96t101-40q62 0 105 43t43 105v249l-1 17q-1 7-4 12ZM427-76v-122q-120-16-196-108-77-92-77-214h109q0 91 64 154t155 63q43 0 80-14 37-15 67-41l78 79q-35 32-78 53t-93 28v122H427Zm362 27L41-796l75-75 748 748-75 74Z" })), mu = B.forwardRef(gu), yu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M625-511q29 0 50-21t20-50q0-29-20-50-21-20-50-20t-50 20-20 50q0 29 20 50 21 21 50 21Zm-290 0q29 0 50-21t20-49q0-30-20-50t-50-21q-29 0-50 20-20 21-20 50 0 30 20 50 21 21 50 21Zm145 268q75 0 137-43t85-115H258q24 72 85 115 62 43 137 43Zm0 198q-90 0-170-34-79-34-138-93T79-310q-34-80-34-170t34-170q34-79 93-138t138-93q80-34 170-34t170 34q79 34 138 93t93 138q34 80 34 170t-34 170q-34 79-93 138T650-79q-80 34-170 34Zm0-435Zm0 322q134 0 228-94t94-228q0-134-94-228t-228-94q-134 0-228 94t-94 228q0 134 94 228t228 94Z" })), ts = B.forwardRef(yu), wu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M553-64v-108q107-27 173-113 67-87 67-197 0-109-67-195T553-789v-108q152 26 249 144 97 117 97 271 0 155-97 273T553-64ZM61-335v-290h176l236-237v764L237-335H61Zm492 28v-346q51 23 82 70t31 103-31 103q-31 47-82 70Z" })), bu = B.forwardRef(wu), Su = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M807-15 700-123q-33 21-71 37-38 15-80 22v-108q20-4 38-12l35-17-153-154v257L234-335H57v-290h144L10-818l74-75L882-90l-75 75Zm37-264-80-79q13-30 19-60 7-31 7-64 0-109-68-195-67-86-173-112v-108q152 26 249 144 98 117 98 271 0 55-14 107-13 51-38 96ZM661-462 549-575v-78q51 23 83 70 31 47 31 103l-1 9-1 9ZM469-655 366-759l103-103v207Z" })), xu = B.forwardRef(Su), Eu = "data:audio/wav;base64,", is = {
...
}, As = B.createContext({ settings: {}, setSettings: () => null }), De = () => B.useContext(As), Cu = ({
  children: f,
  settings: c = is,
  setSettings: g
...
}, ss = B.createContext({ styles: {}, setStyles: () => null }), Ye = () => B.useContext(ss), Du = ({
  children: f,
  styles: c = ls,
  setStyles: g
}) => /* @__PURE__ */ b.jsx(ss.Provider, { value: { styles: c, setStyles: g }, children: f }), Pu = ({ buttons: f }) => {
  var c, g, m, A, w;
...
}, us = B.createContext({}), bt = () => B.useContext(us), Bu = ({
  children: f,
  botIdRef: c,
  flowRef: g
}) => {
...
}, cs = B.createContext({}), gt = () => B.useContext(cs), ku = ({
  children: f,
  settings: c
}) => {
  var g, m, A, w, P, E;
  const [y, C] = B.useState(!1), [H, k] = B.useState(((g = c == null ? void 0 : c.chatWindow) == null ? void 0 : g.defaultOpen) ?? !1), [Q, U] = B.useState(((m = c == null ? void 0 : c.audio) == null ? void 0 : m.defaultToggledOn) ?? !1), [L, _] = B.useState(((A = c == null ? void 0 : c.voice) == null ? void 0 : A.defaultToggledOn) ?? !1), [F, T] = B.useState(
    ((w = c == null ? void 0 : c.notification) == null ? void 0 : w.defaultToggledOn) ?? !0
  ), [K, ne] = B.useState(!1), [X, G] = B.useState(!1), [$, Z] = B.useState(!0), [te, re] = B.useState(!1), [ue, ae] = B.useState(!1), [ce, ve] = B.useState(!1), [de, Me] = B.useState(0), [Ce, ee] = B.useState(0), [le, fe] = B.useState(!1), [be, oe] = B.useState(null), [me, Oe] = B.useState(((P = window.visualViewport) == null ? void 0 : P.height) ?? window.innerHeight), [Se, Ae] = B.useState(((E = window.visualViewport) == null ? void 0 : E.width) ?? window.innerWidth);
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { unreadCount: w, isScrolling: P, setIsScrolling: E } = gt(), { chatBodyRef: y } = bt(), [C, H] = B.useState(!1), k = {
  ...
  function L(F) {
    if (!y.current)
      return;
    const T = y.current.scrollTop, K = y.current.scrollHeight - y.current.clientHeight - T, ne = 20;
    let X = 0;
    function G() {
      if (!y.current)
        return;
  ...
  const _ = (F, T, K, ne) => (F /= ne / 2, F < 1 ? K / 2 * F * F + T : (F--, -K / 2 * (F * (F - 2) - 1) + T));
...
}, ds = B.createContext({ paths: [], setPaths: () => null }), Ol = () => B.useContext(ds), Ru = ({ children: f }) => {
  ...
  } = gt(), { botIdRef: y } = bt(), C = B.useCallback(() => c.length > 0 ? c[c.length - 1] : null, [c]), H = B.useCallback(() => c.length > 1 ? c[c.length - 2] : null, [c]), k = B.useCallback((Q) => {
    var U, L;
    if ((U = f.event) != null && U.rcbChangePath) {
      const _ = C(), F = H(), T = { botId: y.current, currPath: _, prevPath: F };
      if (event = xA(Ee.CHANGE_PATH, T, { currPath: _, prevPath: F, nextPath: Q }), event.defaultPrevented)
        return !1;
    }
...
}, fs = B.createContext({ toasts: [], setToasts: () => null }), hs = () => B.useContext(fs), Qu = ({ children: f }) => {
  const [c, g] = B.useState([]);
  return /* @__PURE__ */ b.jsx(fs.Provider, { value: { toasts: c, setToasts: g }, children: f });
}, PA = () => {
  const { settings: f } = De(), { toasts: c, setToasts: g } = hs(), { callRcbEvent: m } = Wn(), A = B.useRef(c);
  B.useEffect(() => {
    A.current = c;
  }, [c]);
  ...
  var m, A;
  const { settings: w } = De(), { styles: P } = Ye(), { dismissToast: E } = PA(), [y, C] = B.useState(!1), H = {
  ...
  return B.useEffect(() => {
    ...
    "div",
    {
      ...
      onMouseDown: (k) => {
        var Q;
        (Q = w.toast) != null && Q.dismissOnClick && (k.preventDefault(), E(f));
      },
...
}, ps = B.createContext({ messages: [], setMessages: () => null }), jl = () => B.useContext(ps), ju = ({ children: f }) => {
  const [c, g] = B.useState([]);
  return /* @__PURE__ */ b.jsx(ps.Provider, { value: { messages: c, setMessages: g }, children: f });
}, Fu = ({
  setChatScrollHeight: f
}) => {
  var c, g, m, A, w, P, E, y, C, H, k, Q;
  const { settings: U } = De(), { styles: L } = Ye(), { messages: _ } = jl(), { toasts: F } = hs(), { isChatWindowOpen: T } = vr(), {
    isBotTyping: K,
    isScrolling: ne,
    setIsScrolling: X,
    setUnreadCount: G
    ...
    ...L.userBubbleStyle
  }, re = (A = U.userBubble) != null && A.animate ? "rcb-user-message-entry" : "", ue = {
  ...
  var m, A, w, P, E, y, C, H, k, Q, U;
  const { settings: L } = De(), { styles: _ } = Ye(), { paths: F } = Ol(), { handleSubmitText: T } = Ha(), [K, ne] = B.useState(/* @__PURE__ */ new Set()), [X, G] = B.useState(!1), $ = {
  ...
  const P = /* @__PURE__ */ b.jsx(Lu, { checkboxes: w, checkedItems: /* @__PURE__ */ new Set(), path: g });
  ...
  var g, m, A, w, P, E;
  const { settings: y } = De(), { styles: C } = Ye(), { paths: H } = Ol(), { handleSubmitText: k } = Ha(), [Q, U] = B.useState([]), [L, _] = B.useState(!1), F = {
    ...
    return /* @__PURE__ */ b.jsx(
      "div",
      {
        ...
        onMouseDown: (Z) => {
          ...
          _(!f.reusable);
          let re;
          f.sendOutput != null ? re = f.sendOutput : re = ((te = y.chatInput) == null ? void 0 : te.sendOptionOutput) ?? !0, k(X, re);
        },
        children: X
      },
      X
  ...
  const P = /* @__PURE__ */ b.jsx(zu, { options: w, path: g });
  await m.injectMessage(P);
}, Zu = async (f, c, g) => {
  const m = f.path;
  if (!m)
  ...
  return w.includes("path") ? await Zu(A, g, m) : !1;
}, Vu = (f) => {
  const c = [];
  let g = "", m = !1;
...
const wA = async (f) => {
  ...
  var c, g, m;
  Il = (c = f.chatHistory) == null ? void 0 : c.storageKey, yA = (g = f.chatHistory) == null ? void 0 : g.maxEntries, ys = (m = f.chatHistory) == null ? void 0 : m.disabled, EA = tc(localStorage.getItem(Il));
  ...
  if (ms = !0, g != null)
    try {
      m((C) => {
        const H = Oo(/* @__PURE__ */ b.jsx(ec, {}), "system");
        return C.shift(), [H, ...C];
      });
      const y = g.map((C) => {
        if (C.type === "object") {
          const H = ws(C.content, f, c);
          return { ...C, content: H };
        }
        return C;
      });
      setTimeout(() => {
        m((C) => {
          ...
          C.shift();
          let k;
          return (H = f.chatHistory) != null && H.autoLoad ? k = Oo(/* @__PURE__ */ b.jsx(b.Fragment, {}), "system") : k = Oo(/* @__PURE__ */ b.jsx(qu, {}), "system"), [...y, k, ...C];
        });
      }, 500), setTimeout(() => {
        if (!A.current)
          return;
      ...
      return A.textContent;
    {
      ...
      let y = Array.from(A.attributes).reduce((H, k) => {
        ...
        if (Q === "style") {
          ...
          U.forEach((_) => {
            const [F, T] = _.split(":").map((ne) => ne.trim()), K = F.replace(/-([a-z])/g, (ne, X) => X.toUpperCase());
            L[K] = T;
          }), H[Q] = L;
        } else
          (E === "audio" || E === "video") && Q === "controls" && k.value === "" ? H[Q] = "true" : H[Q] = k.value;
        return H;
      }, {});
      const C = A.classList;
      if ((P = c.botBubble) != null && P.showAvatar && (y = Ac(C, y)), y = lc(C, y, c, g), y = sc(C, y, c, g), y = uc(C, y, c, g), y = cc(C, y, c, g), [
        "area",
        "base",
        "br",
        "col",
  ...
  const { settings: f } = De(), {
    ...
    if (_ != null && _.startsWith("data:audio")) {
      const K = atob(_.split(",")[1]), ne = new ArrayBuffer(K.length), X = new Uint8Array(ne);
  ...
  const { settings: A } = De(), { messages: w, setMessages: P } = jl(), {
    ...
    setIsBotTyping: H,
    setUnreadCount: k
  } = gt(), { streamMessageMap: Q, chatBodyRef: U } = bt(), { callRcbEvent: L } = Wn(), { playNotificationSound: _ } = Fl(), F = B.useCallback(async (Z, te, re) => {
    H(!1), P((ve) => {
      const de = [...ve, Z];
      return $(de), de;
    ...
    }), Q.current.delete("bot"), wA(w);
  }, [w, Q]), T = B.useCallback(async (Z, te = "bot") => {
    var re, ue, ae, ce, ve, de, Me, Ce;
    let ee = Oo(Z, te);
    if ((re = A.event) != null && re.rcbPreInjectMessage) {
    ...
    let le = !1;
    te === "bot" ? le = (ue = A.botBubble) == null ? void 0 : ue.dangerouslySetInnerHtml : te === "user" && (le = (ae = A.userBubble) == null ? void 0 : ae.dangerouslySetInnerHtml), $u(A, E, y, ee, le);
    ...
    return ee.id;
  }, [A, E, y, L, F]), K = B.useCallback(async (Z) => {
    var te;
    const re = w.find((ue) => ue.id === Z);
    return !re || (te = A.event) != null && te.rcbRemoveMessage && L(Ee.REMOVE_MESSAGE, { message: re }).defaultPrevented ? null : (P((ue) => {
      const ae = ue.filter((ce) => ce.id !== Z);
      return $(ae), ae;
    }), k((ue) => Math.max(ue - 1, 0)), Z);
  }, [L, w, (f = A.event) == null ? void 0 : f.rcbRemoveMessage]), ne = B.useCallback(async (Z, te = "bot") => {
    var re, ue;
    if (!Q.current.has(te)) {
      const ce = Oo(Z, te);
      return (re = A.event) != null && re.rcbStartStreamMessage && L(Ee.START_STREAM_MESSAGE, { message: ce }).defaultPrevented ? null : (H(!1), P((ve) => {
        const de = [...ve, ce];
        return $(de), [...ve, ce];
      }), k((ve) => ve + 1), Q.current.set(te, ce.id), ce.id);
    }
    const ae = { ...Oo(Z, te), id: Q.current.get(te) };
    return (ue = A.event) != null && ue.rcbChunkStreamMessage && L(
      Ee.CHUNK_STREAM_MESSAGE,
      { ...ae, id: Q.current.get(te) }
    ).defaultPrevented ? null : (P((ce) => {
      const ve = [...ce];
      for (let de = ve.length - 1; de >= 0; de--)
        if (ve[de].sender === te && typeof ve[de].content == typeof Z) {
          ve[de] = ae;
          break;
        }
      return $(ve), ve;
    }), Q.current.get(te) ?? null);
  }, [L, (c = A.event) == null ? void 0 : c.rcbChunkStreamMessage, (g = A.event) == null ? void 0 : g.rcbStartStreamMessage, Q]), X = B.useCallback(async (Z = "bot") => {
    var te;
    if (!Q.current.has(Z))
      return !0;
    const re = Q.current.get(Z), ue = w.find((ae) => ae.id === re);
    return (te = A.event) != null && te.rcbStopStreamMessage && L(Ee.STOP_STREAM_MESSAGE, { messageToEndStreamFor: ue }).defaultPrevented ? !1 : (Q.current.delete(Z), wA(w), !0);
    ...
    wA(Z);
    let ue = !0;
    (Z.length === 0 || y && !C) && (ue = !1), (te = A.general) != null && te.embedded && bs(U.current) && (ue = !1);
    const ae = Z[Z.length - 1];
    (!ae || ae.sender === "user") && (ue = !1), ue && _(), ((re = A.chatWindow) != null && re.autoJumpToBottom || !C) && setTimeout(() => {
...
const Ll = () => {
  ...
  var E;
  (E = f.voice) != null && E.sendAsAudio ? hc(g, w) : fc(
    f,
    c,
    g,
    m,
  ...
  C.onresult = (Q) => {
    ...
    Vr ? (C.start(), Un || (Un = setTimeout(() => Bl(c, w), H))) : (clearTimeout(Un), Un = null, clearTimeout(bA));
  ...
  var g, m, A;
  const w = Ll();
  (g = c.voice) != null && g.disabled || !((m = c.chatInput) != null && m.blockSpam) || !w || (f && !Vr ? (Vr = !0, (A = c.voice) != null && A.sendAsAudio ? zn == null || zn.start() : w.start()) : f || Hl());
}, Bl = (f, c) => {
  var g;
  ...
  const { settings: f } = De(), {
    ...
    if (E.current && C.current !== null) {
      const ne = (F = f.chatInput) == null ? void 0 : F.characterLimit, X = (T = f.chatInput) != null && T.allowNewline ? _ : _.replace(/\n/g, " ");
      if (ne != null && ne >= 0 && X.length > ne ? E.current.value = X.slice(0, ne) : E.current.value = X, (K = f.event) != null && K.rcbTextAreaChangeValue && H(
    ...
    (F = E.current) != null && F.disabled || setTimeout(() => {
      var T, K, ne;
      (T = f.general) != null && T.embedded ? bs(y == null ? void 0 : y.current) && ((K = E.current) == null || K.focus()) : _ !== "start" && ((ne = E.current) == null || ne.focus());
    }, 100);
  }, []), U = B.useCallback(() => {
  ...
  var f, c, g, m;
  const { settings: A } = De(), { endStreamMessage: w, injectMessage: P, removeMessage: E, streamMessage: y } = BA(), { getCurrPath: C, getPrevPath: H, goToPath: k } = DA(), {
    timeoutId: Q,
    voiceToggledOn: U,
    ...
    setInputLength: ne
  } = gt(), { flowRef: X, chatBodyRef: G, inputRef: $, keepVoiceOnRef: Z, paramsInputRef: te } = bt(), { showToast: re, dismissToast: ue } = PA(), { callRcbEvent: ae } = Wn(), { syncVoice: ce } = Nl(), { setTextAreaValue: ve } = La(), { openChat: de } = vr(), Me = B.useCallback(async (ee) => {
    var le, fe, be;
    const oe = C();
    if (!(!oe || !X.current[oe])) {
      if (_) {
    ...
    var be, oe;
    le = le.trim(), le !== "" && (fe && await Me(le), Q && clearTimeout(Q), te.current = le, G.current && (G.current.scrollTop = G.current.scrollHeight), $.current && (ve(""), ne(0)), (be = A.chatInput) != null && be.blockSpam && F(!0), Z.current = U, ce(!1), setTimeout(() => {
      T(!0);
      ...
      if (!await gs(X.current, ee, Oe, k)) {
        ...
        if (!Ae)
          return;
        Ae.chatDisabled || F((me = A.chatInput) == null ? void 0 : me.disabled), vs(Ae, L, Oe), K(typeof Ae.file == "function"), ce(Z.current), T(!1);
      }
  ...
  var c, g, m, A, w, P, E, y, C, H, k;
  const Q = kA(), { settings: U } = De(), { styles: L } = Ye(), {
    textAreaDisabled: _,
    ...
    setInputLength: X
  } = gt(), { inputRef: G } = bt(), [$, Z] = B.useState(!1), [te, re] = B.useState(!1), { handleSubmitText: ue } = Ha(), { setTextAreaValue: ae } = La(), ce = {
  ...
  return /* @__PURE__ */ b.jsxs(
    "div",
    {
      ...
      onMouseDown: (Se) => {
        var Ae;
        Se.stopPropagation(), !K && ((Ae = U.general) == null ? void 0 : Ae.flowStartTrigger) === "ON_CHATBOT_INTERACT" && ne(!0);
      },
  ...
  var f, c, g, m, A, w, P;
  const { settings: E } = De(), { styles: y } = Ye(), { unreadCount: C } = gt(), { isChatWindowOpen: H, toggleChatWindow: k } = vr(), Q = {
  ...
  var f, c, g, m;
  const A = kA(), { settings: w } = De(), { styles: P } = Ye(), { isChatWindowOpen: E, openChat: y } = vr(), [C, H] = B.useState(!1), [k, Q] = B.useState(!1), [U, L] = B.useState(0);
  B.useEffect(() => {
    var T, K, ne;
    ...
    if (X === "ALWAYS")
      if (A) {
        let G;
        E ? G = (((K = P.chatWindowStyle) == null ? void 0 : K.width) ?? 375) - (((ne = P.chatButtonStyle) == null ? void 0 : ne.width) ?? 75) : G = 0, L(G), H(!0);
      } else
        H(!E);
    else
      X === "NEVER" ? H(!1) : X === "START" ? k ? H(!1) : (Q(!0), H(!0)) : X === "CLOSE" && H(!E);
  }, [E]);
  const _ = {
  ...
  var f, c, g, m, A, w;
  const { settings: P } = De(), { styles: E } = Ye(), { injectMessage: y, streamMessage: C, removeMessage: H, endStreamMessage: k } = BA(), { getCurrPath: Q, getPrevPath: U, goToPath: L, blockAllowsAttachment: _ } = DA(), { flowRef: F, inputRef: T } = bt(), K = F.current, { showToast: ne, dismissToast: X } = PA(), { callRcbEvent: G } = Wn(), { openChat: $ } = vr(), { setTextAreaValue: Z } = La(), { handleSubmitText: te } = Ha(), re = {
    ...
    if (me != null) {
      ...
      await te("📄 " + Oe.join(", "), (ee = P.fileAttachment) == null ? void 0 : ee.sendFileName), await me({
  ...
  return /* @__PURE__ */ b.jsxs(
    "label",
    {
      ...
      style: _ ? E.fileAttachmentButtonStyle : re,
      children: [
        /* @__PURE__ */ b.jsx(
          "input",
          {
  ...
  var f, c, g, m, A, w;
  const { settings: P } = De(), { styles: E } = Ye(), { inputRef: y } = bt(), { textAreaDisabled: C, setTextAreaValue: H } = La(), k = B.useRef(null), Q = B.useRef(null), [U, L] = B.useState(!1), _ = {
    cursor: `url(${(f = P.general) == null ? void 0 : f.actionDisabledIcon}), auto`,
    ...E.emojiButtonStyle,
    // by default inherit the base style
  ...
  B.useEffect(() => {
    const G = (te) => {
      const re = te.composedPath();
      k.current && !re.includes(k.current) && Q.current && !re.includes(Q.current) && L(!1);
    }, $ = () => {
      if (k.current && Q.current) {
        const te = Q.current.getBoundingClientRect(), re = k.current.offsetHeight, ue = te.top - re - 8;
        k.current.style.left = `${te.left}px`, k.current.style.top = `${ue}px`;
      }
    }, Z = () => {
      $();
    };
  ...
  const K = (G, $) => {
    G.preventDefault(), y.current && (H(y.current.value + $), setTimeout(() => {
      ...
      if (Z) {
        Z.focus();
        const te = Z.value.length;
        Z.setSelectionRange(te, te);
      }
    }, 50)), L(!1);
  }, ne = (G) => {
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { audioToggledOn: w, toggleAudio: P } = Sc(), E = {
    ...
    var H, k;
    const Q = w ? (H = m.audio) == null ? void 0 : H.icon : (k = m.audio) == null ? void 0 : k.iconDisabled;
  ...
  var f, c;
  const { settings: g } = De(), { styles: m } = Ye(), { openChat: A } = vr(), w = {
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { notificationsToggledOn: w, toggleNotifications: P } = Cc(), E = {
    ...
    var H, k;
    const Q = w ? (H = m.notification) == null ? void 0 : H.icon : (k = m.notification) == null ? void 0 : k.iconDisabled;
    return !Q || typeof Q == "string" ? /* @__PURE__ */ b.jsx(
      "span",
      {
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { injectMessage: w } = BA(), { inputRef: P } = bt(), { voiceToggledOn: E, toggleVoice: y } = Nl(), { setInputLength: C, setTextAreaValue: H, textAreaDisabled: k } = La(), { handleSubmitText: Q } = Ha(), U = B.useRef([]), [L, _] = B.useState(!1);
  B.useEffect(() => {
    var G;
    (G = m.voice) != null && G.sendAsAudio ? (ne(), U.current = []) : Q();
  }, [L]), B.useEffect(() => {
    E ? dc(
      m,
      y,
  ...
  const F = {
    ...
    ) : Z && /* @__PURE__ */ b.jsx("span", { className: `rcb-voice-icon ${E && !k ? "on" : ""}`, children: /* @__PURE__ */ b.jsx(Z, { style: E && !k ? F : T }) });
  };
  return /* @__PURE__ */ b.jsx(
    "div",
    {
  ...
  var f, c, g, m, A, w, P, E;
  const { settings: y } = De(), { styles: C } = Ye(), { textAreaDisabled: H } = gt(), [k, Q] = B.useState(!1), { handleSubmitText: U } = Ha(), L = {
    ...
    var Z;
    const te = (Z = y.chatInput) == null ? void 0 : Z.sendButtonIcon;
    return !te || typeof te == "string" ? /* @__PURE__ */ b.jsx(
      "span",
      {
    ...
    ) : te && /* @__PURE__ */ b.jsx("span", { className: "rcb-send-icon", "data-testid": "rcb-send-icon", children: /* @__PURE__ */ b.jsx(
      te,
      {
        style: H ? K : k ? ne : T
      }
...
}, kc = (f) => Object.values(Je).includes(f), Tc = (f, c) => {
  ...
  const { settings: f } = De(), c = B.useMemo(() => ({
    [Je.CLOSE_CHAT_BUTTON]: () => Mc(),
    [Je.AUDIO_BUTTON]: () => Ic(),
    [Je.NOTIFICATION_BUTTON]: () => Rc(),
    [Je.EMOJI_PICKER_BUTTON]: () => Fc(),
    [Je.FILE_ATTACHMENT_BUTTON]: () => jc(),
    [Je.SEND_MESSAGE_BUTTON]: () => Oc(),
    [Je.VOICE_MESSAGE_BUTTON]: () => Qc()
  }), []), { header: g, chatInput: m, footer: A } = B.useMemo(() => Tc(f, c), [f, c]), w = B.useMemo(() => g, [g]), P = B.useMemo(() => m, [m]), E = B.useMemo(() => A, [A]);
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Ye(), { showChatHistory: w } = Es(), [P, E] = B.useState(!1), y = {
    color: (f = m.general) == null ? void 0 : f.primaryColor,
    borderColor: (c = m.general) == null ? void 0 : c.primaryColor,
  ...
  var f;
  const { settings: c } = De(), { hasInteractedPage: g, setHasInteractedPage: m, hasFlowStarted: A, setHasFlowStarted: w } = gt(), P = B.useCallback(() => {
    var E;
  ...
  const A = kA(), { settings: w } = De(), {
    ...
    messages: H,
    replaceMessages: k
  } = BA(), { getCurrPath: Q, getPrevPath: U, goToPath: L, paths: _ } = DA(), { showToast: F, dismissToast: T } = PA(), {
    isBotTyping: K,
    isChatWindowOpen: ne,
    isScrolling: X,
    hasFlowStarted: G,
    setIsChatWindowOpen: $,
    setTextAreaDisabled: Z,
    setAudioToggledOn: te,
    setVoiceToggledOn: re,
    setIsBotTyping: ue,
    setTextAreaSensitiveMode: ae,
    setBlockAllowsAttachment: ce,
    setTimeoutId: ve
  } = gt(), { chatBodyRef: de, flowRef: Me, streamMessageMap: Ce, paramsInputRef: ee, keepVoiceOnRef: le } = bt(), fe = Me.current, { viewportHeight: be, setViewportHeight: oe, setViewportWidth: me, openChat: Oe } = vr(), { setUpNotifications: Se } = Fl(), { handleFirstInteraction: Ae } = Nc(), { showChatHistory: Le } = Es(), { updateTextAreaFocus: Zt, setTextAreaValue: Gt } = La(), { syncVoice: tt } = Nl(), mt = B.useRef(0);
  B.useEffect(() => (window.addEventListener("click", Ae), window.addEventListener("keydown", Ae), window.addEventListener("touchstart", Ae), () => {
    ...
    var xe, Ue, Pe;
    Se(), Z((xe = w.chatInput) == null ? void 0 : xe.disabled), $((Ue = w.chatWindow) == null ? void 0 : Ue.defaultOpen), te((Pe = w.audio) == null ? void 0 : Pe.defaultToggledOn), setTimeout(() => {
      var Ie;
      re((Ie = w.voice) == null ? void 0 : Ie.defaultToggledOn);
    }, 1);
  }, []), B.useEffect(() => {
    ...
    else if (oc(w), localStorage.getItem((Pe = w.chatHistory) == null ? void 0 : Pe.storageKey) != null) {
      const Ke = Oo(/* @__PURE__ */ b.jsx(Hc, {}), "system");
    ...
    if (A)
      return;
    ne && (oe((xe = window.visualViewport) == null ? void 0 : xe.height), me((Ue = window.visualViewport) == null ? void 0 : Ue.width));
  ...
  var c, g, m, A;
  f == null || f.map((X) => X());
  const w = kA(), { settings: P } = De(), { styles: E } = Ye(), { hasFlowStarted: y, setHasFlowStarted: C } = gt(), { inputRef: H } = bt(), {
    setChatScrollHeight: k,
    viewportHeight: Q,
    viewportWidth: U,
    isChatWindowOpen: L
  } = vr(), { headerButtons: _, chatInputButtons: F, footerButtons: T } = Lc();
  Uc();
  const K = B.useMemo(() => {
    var X;
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: (() => {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ b.jsxs("div", { style: ne(), className: "rcb-chat-window", children: [
          ((g = P.general) == null ? void 0 : g.showHeader) && /* @__PURE__ */ b.jsx(Pu, { buttons: _ }),
          /* @__PURE__ */ b.jsx(Fu, { setChatScrollHeight: k }),
          ((m = P.general) == null ? void 0 : m.showInputRow) && /* @__PURE__ */ b.jsx(vc, { buttons: F }),
...
}, Wc = Ul.DEFAULT_URL, Zc = Ul.DEFAULT_EXPIRATION, Cs = Ul.CACHE_KEY_PREFIX, Gc = (f, c, g) => {
  const m = localStorage.getItem(`${Cs}_${f}_${c}`);
  if (!m)
    return null;
  try {
  ...
  localStorage.setItem(`${Cs}_${f}_${c}`, JSON.stringify(E));
}, Yc = async (f, c) => {
  ...
  const { id: g, version: m, baseUrl: A = Wc, cacheDuration: w = Zc } = c, P = m || await Yc(g, A);
  if (!P)
  ...
  Q.ok ? k = await Q.text() : console.info(`Could not fetch styles.css from ${y}`);
  const U = await fetch(C);
  let L = {};
  U.ok ? L = await U.json() : console.info(`Could not fetch settings.json from ${C}`);
  const _ = await fetch(H);
  let F = {};
  _.ok ? F = await _.json() : console.info(`Could not fetch styles.json from ${H}`), _c(g, P, L, F, k);
  const T = rs(f, k);
...
`), Ds = () => Ps(is), Xc = () => Ps(ls), Vc = async (f, c, g, m) => {
  var A, w;
  let P = Ds(), E = Xc(), y = "";
  if (m != null)
    if (Array.isArray(m))
  ...
  return c;
}, Bs = B.createContext(void 0), ks = () => B.useContext(Bs), Jc = ({
  children: f
}) => {
  var c;
  ...
  const H = async (k, Q, U, L, _, F) => {
    g.current = k, m.current = Q;
    const T = await Vc(k, U, L, _);
    F.current && (F.current.textContent = T.cssStylesText), w(T.settings), E(T.inlineStyles);
  };
  return y ? /* @__PURE__ */ b.jsx("div", { style: { fontFamily: (c = A.general) == null ? void 0 : c.fontFamily }, children: /* @__PURE__ */ b.jsx(Bs.Provider, { value: { loadConfig: H }, children: /* @__PURE__ */ b.jsx(Cu, { settings: A, setSettings: w, children: /* @__PURE__ */ b.jsx(Du, { styles: P, setStyles: E, children: /* @__PURE__ */ b.jsx(Qu, { children: /* @__PURE__ */ b.jsx(Bu, { botIdRef: g, flowRef: m, children: /* @__PURE__ */ b.jsx(Ru, { children: /* @__PURE__ */ b.jsx(ku, { settings: A, children: /* @__PURE__ */ b.jsx(ju, { children: f }) }) }) }) }) }) }) }) }) : null;
}, Kc = ({
  id: f,
  flow: c,
  settings: g,
  ...
  const y = B.useMemo(() => f, []), C = ks(), { flowRef: H } = bt();
  H && H.current !== c && (H.current = c);
  const k = async () => {
    var Q, U;
    (Q = g.event) != null && Q.rcbPreLoadChatBot && xA(
      Ee.PRE_LOAD_CHATBOT,
    ...
    ).defaultPrevented || (C != null && C.loadConfig && (await C.loadConfig(y, c, g, m, A, E), P(!0)), (U = g.event) != null && U.rcbPostLoadChatBot && xA(
  ...
  const P = B.useMemo(() => f || "rcb-" + SA(), []), E = !c || Object.keys(c).length === 0 ? $c : c, y = g || {}, C = m || {}, H = w || [], [k, Q] = B.useState(!1), U = ks(), L = B.useRef(null), [_, F] = B.useState(A || []);
  B.useEffect(() => {
    A && F(A);
  }, [A]);
...
}, Ts = Ds(), ed = B.createContext({
  settings: Ts,
  setSettings: () => {
  }
});
function td() {
  const [f, c] = B.useState(""), [g, m] = B.useState(""), [A, w] = B.useState(!1), [P, E] = B.useState(!1), [y, C] = B.useState({
    ...Ts,
    voice: {
      disabled: !0
    },
  ...
  }), [H, k] = B.useState(!1), [Q, U] = B.useState({});
  B.useEffect(() => {
    k(!0);
  }, []);
  const L = async (K) => {
    const { address: ne } = Fa.all();
    c(ne);
    let G = await js.getInstance().createToken(K).getBalance(ne);
    G = Fs(G), m(G);
  }, _ = async (K) => {
    Dl("handleQuestion params", K);
    const ne = await as.post("/ai/chat", {
    ...
    if (!X)
      ...
      let te = G;
      typeof G == "string" && (G.toLocaleLowerCase() === "pol" ? te = "MATIC" : G.toLocaleLowerCase() === "sepoliaeth" && (te = "ETH")), U({
        action: X,
        toEmail: Z,
        token: te,
        amount: $
    ...
    transfer: {
      ...
      component: (K) => {
        if (Q.action === "transfer")
          return Dl(P, f, g, Q.token, Q.toEmail, Q.amount), /* @__PURE__ */ b.jsx("div", { className: "pl-4 pt-2", children: P && f && g && Q.token && Q.toEmail && Q.amount && /* @__PURE__ */ b.jsx(Zs, { onClick: () => w(!0) }) });
      },
      // chatDisabled: true,
      path: "transfer"
    }
  ...
  return /* @__PURE__ */ b.jsx(b.Fragment, { children: H && /* @__PURE__ */ b.jsx(B.Suspense, { fallback: null, children: /* @__PURE__ */ b.jsxs("div", { children: [
    /* @__PURE__ */ b.jsx(ed.Provider, { value: { settings: y, setSettings: C }, children: /* @__PURE__ */ b.jsx(qc, { settings: y, flow: F, styles: T }) }),
    /* @__PURE__ */ b.jsx(
      Os,
      {
        open: A,
...
function pd() {
  ...
  return /* @__PURE__ */ b.jsx("section", { className: "bg-background w-full flex flex-col min-h-screen", children: /* @__PURE__ */ b.jsxs(Gs, { children: [
    /* @__PURE__ */ b.jsx(Vs, {}),
    /* @__PURE__ */ b.jsx("div", { className: "flex-grow min-h-[calc(100vh-60px)]", children: /* @__PURE__ */ b.jsx(_s, { children: /* @__PURE__ */ b.jsx(Ns, {}) }) }),
    !f && /* @__PURE__ */ b.jsx(td, {}),
    /* @__PURE__ */ b.jsx(Ws, {}),
    /* @__PURE__ */ b.jsx(id, {})
  ] }) });
