...
import { a as bA, c as Ne, D as Tl, b as Il, d as Rl, e as ja, l as Zl, B as Qs, f as as, h as Os, S as js, g as Dl, T as Fs, i as Ls } from "./main-Bd6o8N0r.js";
import { j as Ol, k as is, L as Gl, a as B, b as Hs, r as CA, p as jl, O as Ns } from "./vendor-react-DM3ZG7W6.js";
import { h as Us, X as zs } from "./vendor-ui-utils-DxmL71y2.js";
import { u as As, B as Ws } from "./vendor-utils-ZATHw6Y5.js";
import { W as _l, V as Zs } from "./index-DoZoQO17.js";
import { S as Gs } from "./SendButton-DpiIiqou.js";
import { W as _s, M as Ys } from "./MarketplaceProvider-DsJGUUBB.js";
function Xs({ routes: f, currentRouteName: c }) {
  const { pathname: g } = Ol(), m = is(), A = bA.isAuthenticated();
  return /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
    ...
    /* @__PURE__ */ b.jsx("div", { className: Ne("flex tablet:hidden"), children: /* @__PURE__ */ b.jsxs(Tl, { children: [
      ...
      /* @__PURE__ */ b.jsx(Rl, { className: "bg-white", children: f.map((y) => {
        const P = g.startsWith(y.href);
        return /* @__PURE__ */ b.jsx(
          ja,
          {
            ...
            children: P ? /* @__PURE__ */ b.jsxs(Gl, { to: y.href, className: "flex items-center gap-2", children: [
...
function Yl({
  ...
  const { i18n: c } = As(), [g, m] = B.useState(!1);
  B.useEffect(() => {
    const P = Zl.getData();
...
function Vs() {
  ...
  return /* @__PURE__ */ b.jsxs("div", { className: "justify-start items-center gap-[21px] flex", children: [
    ...
    /* @__PURE__ */ b.jsxs("div", { className: "justify-start items-center gap-7 flex", children: [
      ...
      ), children: /* @__PURE__ */ b.jsxs(Tl, { children: [
...
function Js() {
  const { pathname: f } = Ol(), { t: c } = As(), g = is(), m = [
    {
...
Please update the following components: %s`,
    ...
    function Yi(e, t, n, o) {
      ...
      typeof R == "function" && (e.state = si(e, t, R, l, n)), typeof t.getDerivedStateFromProps != "function" && typeof e.getSnapshotBeforeUpdate != "function" && (typeof e.UNSAFE_componentWillMount == "function" || typeof e.componentWillMount == "function") && (_i(t, e), ZA(d, e, n, o));
    }
    var GA = {
      id: 1,
      overflow: ""
...
` + o.stack;
    ...
    Mo.renderToNodeStream = El, Mo.renderToStaticMarkup = pA, Mo.renderToStaticNodeStream = r, Mo.renderToString = xl, Mo.version = c;
  }()), Mo;
}
var gA = {}, Kl;
function eu() {
...
` && r.push(yn), o;
    ...
    var _a = T(Ct + ';$RC("'), RA = T('$RC("'), MA = T('","'), Ti = T('")<\/script>');
    function Ii(r, e, t, n) {
      ...
      return k(r, t), k(r, MA), k(r, e.segmentPrefix), k(r, o), F(r, Ti);
    }
...
` + n.stack;
    ...
    var Pa = g.ReactCurrentDispatcher, Ba = g.ReactDebugCurrentFrame, ka = 0, Zr = 1, gi = 2, ur = 3, eA = 4, sl = 0, Gr = 1, _r = 2, ul = 12800;
    function cl(r) {
    ...
    gA.renderToReadableStream = El, gA.version = c;
  }()), gA;
}
var Oo, Ml;
jl.env.NODE_ENV === "production" ? (Oo = Ks(), Ml = $s()) : (Oo = qs(), Ml = eu());
...
const au = "data:image/svg+xml;base64,", iu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 0 637 637", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m478 113-13 2-4 1h4l14-2c10-2 35-2 42-1l6 3 3 1c3 0-4-3-8-5-7-1-34-1-44 1m56 6 8 6c7 5 20 17 20 19s7 12 8 12l-3-6-4-6c0-3-15-17-25-24-5-3-8-4-4-1m-198 16-9 1a512 512 0 0 1 9-1m-180 30a412 412 0 0 0-23 4 167 167 0 0 0-32 8 439 439 0 0 1 46-9 304 304 0 0 1 11-2l6-1h-8m369 8 4 3-7-6c-1 0 0 2 3 3m-439 9c-7 3-18 13-18 15l6-5c5-5 9-8 14-10l6-4-8 4m442 12-10 11-7 6 7-6c7-5 14-14 13-16l-3 5M65 205l-1 11c0 9 0 10 4 17 5 10 7 12 22 11 10 0 15 0 38-5l5-1-6 1-16 2-21 2c-13 1-16-1-21-10-3-5-4-6-4-15l1-12c1-4 1-5-1-1m335 1c3 0 3 1 3 3l-2 6c-2 5-35 39-76 80-53 51-120 117-138 137-21 24-22 25-22 27 0 3 6 9 9 9 4 0 14-8 38-27a5073 5073 0 0 1 15-16 1421 1421 0 0 0-17 15l-31 25-6 2-4-3c-3-3-3-4-2-6 3-8 79-85 160-163 57-57 79-80 79-86 0-2-3-4-7-4-2 0-2 0 1 1m165 18c-9 17-25 32-57 53l-10 8 16-11 12-8c15-10 27-22 39-39 5-7 6-8 4-8l-4 5m-221 2a199 199 0 0 0-19 10 183 183 0 0 1 27-12c0-1-1-1-8 2m-34 16c-3 3-2 3 2 0l1-2-3 2m151 3-1 2 2-2c3-3 2-3-1 0m-16 12-11 10a281 281 0 0 0 11-10m-24 18-7 5-7 5-42 31c-10 7-24 19-22 19l7-6 16-12a343 343 0 0 0 35-25 573 573 0 0 0 20-17m-187 0-2 2 4-2 3-2-5 2m-14 6-3 2 4-1 4-3-5 2m-7 3-8 4-18 8 18-7 7-3 3-1c1-2 0-2-2-1m254 24a2672 2672 0 0 1-71 54 601 601 0 0 0 39-29 1352 1352 0 0 1 32-25m-291-8-2 2 4-2 3-2-5 2m-13 5-2 2h3c5-3 4-4-1-2m-19 9-7 3-13 6c-10 5-13 7-14 10-3 4-2 5 1 0 2-3 5-5 14-9l13-6 12-6-6 2m178 36c-17 12-21 16-21 17a390 390 0 0 1 20-17m-206 34 1 4 1 3 1 5 2 8 1 5v-6l-1-8-2-5-1-4-1-2c-1-2-1-2-1 0m222 23-9 7a683 683 0 0 0-56 44 261 261 0 0 0-26 20 1345 1345 0 0 0-46 34c-6 3-7 3-19 3-11 0-12 0-18-3-8-4-10-8-17-20l-5-10 4 10c5 10 12 18 19 22 4 2 6 2 17 2 13 0 14 0 21-3l26-19 42-33a2183 2183 0 0 0 43-34 643 643 0 0 1 24-20", fill: "#fff", fillRule: "evenodd" }), /* @__PURE__ */ B.createElement("path", { d: "M478 114a620 620 0 0 1-39 6l-21 3a5481 5481 0 0 0-19 3 870 870 0 0 1-54 8l-1 1-6 1-12 2-13 2a992 992 0 0 0-76 12 400 400 0 0 1-45 8l-6 1-5 1h-3l-3 1-2 1-26 4-13 2-17 3c-23 5-33 9-43 19-7 8-9 13-9 27 0 8 1 9 4 14 5 9 8 11 21 10l21-2a1133 1133 0 0 1 23-4 659 659 0 0 0 74-14l3-1h3l3-1h3l2-1 2-1h3l2-1h2l24-5 38-7a2100 2100 0 0 1 93-18l3-1 10-1a2082 2082 0 0 1 120-17l2 1c2 0 8 5 8 7l1 2 1 6c0 4 0 6-3 10-2 4-16 16-18 16l-7 5-10 8a1070 1070 0 0 0-11 7 113 113 0 0 1-20 14l-2 2-3 2-2 2h-1a154 154 0 0 1-28 21l-5 4-5 4a573 573 0 0 1-50 37 175 175 0 0 0-24 18l-1 2-2 1-2 1-2 1-1 1-12 10a396 396 0 0 0-32 25l-8 6-6 5-9 7a326 326 0 0 1-25 20l-13 12a5073 5073 0 0 0-17 15c-24 20-34 27-39 27-2 0-8-6-8-9 0-2 1-3 22-27 18-20 85-86 138-137 41-41 74-75 76-80l2-6c0-2 0-3-2-3l-7 1a233 233 0 0 1-26 9l-1 1-1 1h-1l-1 1h-2l-3 2-1 1h-2l-3 2h-1l-5 2-22 10-9 4-4 2-5 2-10 4-2 1-2 1-2 1-13 6a334 334 0 0 1-38 17 75 75 0 0 0-14 6l-5 2-4 1-2 1-3 2-7 3-16 6a247 247 0 0 0-32 14l-1 1h-2l-1 1h-2l-1 1-12 6a103 103 0 0 0-27 15l-2 5-1 1v11l1 5 1 5 1 4c0 3 0 4 2 4v3l1 3 1 2 2 10 1 4 1 5 2 10 2 8 1 4 1 4c3 3 9 25 11 38l1 7v2l1 4v1l1 1v2l1 2 1 3v1l5 10c7 13 9 16 17 20 6 3 7 3 18 3 12 0 13 0 19-3 8-4 11-6 26-18a1345 1345 0 0 1 85-67 683 683 0 0 1 50-39l12-9a513 513 0 0 1 44-33 201 201 0 0 0 22-17 2270 2270 0 0 0 73-54 158 158 0 0 0 58-59c2 0 3-9 4-27l-1-19-1-4-1-6-1-3-4-6-4-6c0-2-6-8-13-14a77 77 0 0 0-28-18c-6-1-34-1-43 1" })), ql = B.forwardRef(iu), Au = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M765-321q0 117-84 196-83 80-200 80-118 0-200-80t-83-196v-392q0-85 61-144 61-58 146-58 86 0 147 58 61 59 61 144v374q0 54-39 92-39 37-93 37-55 0-93-37-38-38-38-92v-372h110v372q0 9 6 14t15 5q8 0 15-5t7-14v-374q0-39-29-66t-68-27q-40 0-69 27t-29 66v392q0 71 51 119t122 48q71 0 122-48t51-119v-426h111v426Z" })), es = B.forwardRef(Au), lu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M125-165v-113h77v-273q0-93 55-167 56-75 146-100v-19q0-32 22-55 23-23 55-23t55 23q22 23 22 55v19q90 25 146 99 56 73 56 168v273h77v113H125ZM480-32q-38 0-66-27-27-27-27-66h186q0 39-27 66t-66 27Z" })), su = B.forwardRef(lu), uu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M137-190v-113h78v-253q0-41 11-79 11-39 35-71l-9 150h10L17-802l74-74L873-92l-74 74-175-172H137Zm609-149L319-769q20-15 41-25t44-16v-28q0-32 22-54t54-22q32 0 55 22t22 54v28q85 23 137 94t52 160v217ZM481-47q-38 0-65-27t-27-65h184q0 38-27 65t-65 27Z" })), cu = B.forwardRef(uu), du = (f, c) => /* @__PURE__ */ B.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", ref: c, ...f }, /* @__PURE__ */ B.createElement("g", { strokeLinecap: "round", strokeWidth: 10 }, /* @__PURE__ */ B.createElement("path", { d: "m19 19 61 61M80 19 19 80" }))), fu = B.forwardRef(du), hu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M94-136v-255l351-93-351-92v-253l816 346L94-136Z" })), pu = B.forwardRef(hu), vu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M480-372q-61 0-105-43-43-43-43-105v-240q0-61 43-105 43-43 105-43 61 0 105 43 43 44 43 105v240q0 62-43 105t-105 43ZM425-76v-122q-121-16-197-108t-76-214h109q0 91 64 154t155 63q91 0 155-63t64-154h109q0 122-77 214T534-198v122H425Z" })), gu = B.forwardRef(vu), mu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "m763-343-80-79q8-20 13-44 5-23 5-54h109q0 49-11 95t-36 82ZM625-482 336-770v-2q3-56 45-96t101-40q62 0 105 43t43 105v249l-1 17q-1 7-4 12ZM427-76v-122q-120-16-196-108-77-92-77-214h109q0 91 64 154t155 63q43 0 80-14 37-15 67-41l78 79q-35 32-78 53t-93 28v122H427Zm362 27L41-796l75-75 748 748-75 74Z" })), yu = B.forwardRef(mu), wu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M625-511q29 0 50-21t20-50q0-29-20-50-21-20-50-20t-50 20-20 50q0 29 20 50 21 21 50 21Zm-290 0q29 0 50-21t20-49q0-30-20-50t-50-21q-29 0-50 20-20 21-20 50 0 30 20 50 21 21 50 21Zm145 268q75 0 137-43t85-115H258q24 72 85 115 62 43 137 43Zm0 198q-90 0-170-34-79-34-138-93T79-310q-34-80-34-170t34-170q34-79 93-138t138-93q80-34 170-34t170 34q79 34 138 93t93 138q34 80 34 170t-34 170q-34 79-93 138T650-79q-80 34-170 34Zm0-435Zm0 322q134 0 228-94t94-228q0-134-94-228t-228-94q-134 0-228 94t-94 228q0 134 94 228t228 94Z" })), ts = B.forwardRef(wu), bu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M553-64v-108q107-27 173-113 67-87 67-197 0-109-67-195T553-789v-108q152 26 249 144 97 117 97 271 0 155-97 273T553-64ZM61-335v-290h176l236-237v764L237-335H61Zm492 28v-346q51 23 82 70t31 103-31 103q-31 47-82 70Z" })), Su = B.forwardRef(bu), xu = (f, c) => /* @__PURE__ */ B.createElement("svg", { viewBox: "0 -960 960 960", ref: c, ...f }, /* @__PURE__ */ B.createElement("path", { d: "M807-15 700-123q-33 21-71 37-38 15-80 22v-108q20-4 38-12l35-17-153-154v257L234-335H57v-290h144L10-818l74-75L882-90l-75 75Zm37-264-80-79q13-30 19-60 7-31 7-64 0-109-68-195-67-86-173-112v-108q152 26 249 144 98 117 98 271 0 55-14 107-13 51-38 96ZM661-462 549-575v-78q51 23 83 70 31 47 31 103l-1 9-1 9ZM469-655 366-759l103-103v207Z" })), Eu = B.forwardRef(xu), Cu = "data:audio/wav;base64,", ls = {
  ...
  const { settings: f } = De(), { toasts: c, setToasts: g } = vs(), { callRcbEvent: m } = Wn(), A = B.useRef(c);
  B.useEffect(() => {
    A.current = c;
  }, [c]);
  ...
  var m, A;
  const { settings: y } = De(), { styles: P } = Xe(), { dismissToast: E } = PA(), [w, C] = B.useState(!1), H = {
  ...
  const P = /* @__PURE__ */ b.jsx(Hu, { checkboxes: y, checkedItems: /* @__PURE__ */ new Set(), path: g });
  ...
  const P = /* @__PURE__ */ b.jsx(Wu, { options: y, path: g });
  await m.injectMessage(P);
}, Gu = async (f, c, g) => {
  const m = f.path;
  if (!m)
  ...
  return y.includes("path") ? await Gu(A, g, m) : !1;
}, Ju = (f) => {
  const c = [];
  let g = "", m = !1;
...
let ws = !1, Ql = "rcb-history", mA = 30, bs = !1, EA = [];
const yA = async (f) => {
  if (bs)
    return;
  ...
  var c, g, m;
  Ql = (c = f.chatHistory) == null ? void 0 : c.storageKey, mA = (g = f.chatHistory) == null ? void 0 : g.maxEntries, bs = (m = f.chatHistory) == null ? void 0 : m.disabled, EA = nc(localStorage.getItem(Ql));
  ...
  var f, c, g, m;
  const { settings: A } = De(), { messages: y, setMessages: P } = Ll(), {
    audioToggledOn: E,
    isChatWindowOpen: w,
    isScrolling: C,
    setIsBotTyping: H,
...
const Nl = () => {
  ...
  var E;
  (E = f.voice) != null && E.sendAsAudio ? pc(g, y) : hc(
    f,
    c,
    g,
    m,
  ...
  C.onresult = (F) => {
    ...
    Un = setTimeout(() => Bl(c, y), H), (L = f.voice) != null && L.autoSendDisabled || (wA = setTimeout(g, k));
  }, C.onend = () => {
    Vr ? (C.start(), Un || (Un = setTimeout(() => Bl(c, y), H))) : (clearTimeout(Un), Un = null, clearTimeout(wA));
  }, Un = setTimeout(() => Bl(c, y), H);
}, pc = (f, c) => {
  ...
  var g, m, A;
  const y = Nl();
  (g = c.voice) != null && g.disabled || !((m = c.chatInput) != null && m.blockSpam) || !y || (f && !Vr ? (Vr = !0, (A = c.voice) != null && A.sendAsAudio ? zn == null || zn.start() : y.start()) : f || Ul());
}, Bl = (f, c) => {
  var g;
  ...
  var f, c, g, m;
  const { settings: A } = De(), { endStreamMessage: y, injectMessage: P, removeMessage: E, streamMessage: w } = BA(), { getCurrPath: C, getPrevPath: H, goToPath: k } = DA(), {
    timeoutId: F,
    voiceToggledOn: U,
    ...
    setInputLength: te
  } = gt(), { flowRef: X, chatBodyRef: G, inputRef: $, keepVoiceOnRef: Z, paramsInputRef: re } = bt(), { showToast: ne, dismissToast: ue } = PA(), { callRcbEvent: ae } = Wn(), { syncVoice: ce } = zl(), { setTextAreaValue: ve } = Fa(), { openChat: de } = vr(), Me = B.useCallback(async (ee) => {
    var le, fe, be;
    const oe = C();
    if (!(!oe || !X.current[oe])) {
      if (_) {
  ...
  var f, c, g, m;
  const A = kA(), { settings: y } = De(), { styles: P } = Xe(), { isChatWindowOpen: E, openChat: w } = vr(), [C, H] = B.useState(!1), [k, F] = B.useState(!1), [U, L] = B.useState(0);
  B.useEffect(() => {
    var T, K, te;
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Xe(), { audioToggledOn: y, toggleAudio: P } = xc(), E = {
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Xe(), { notificationsToggledOn: y, toggleNotifications: P } = Dc(), E = {
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Xe(), { injectMessage: y } = BA(), { inputRef: P } = bt(), { voiceToggledOn: E, toggleVoice: w } = zl(), { setInputLength: C, setTextAreaValue: H, textAreaDisabled: k } = Fa(), { handleSubmitText: F } = La(), U = B.useRef([]), [L, _] = B.useState(!1);
  B.useEffect(() => {
    var G;
  ...
  }), []), { header: g, chatInput: m, footer: A } = B.useMemo(() => Ic(f, c), [f, c]), y = B.useMemo(() => g, [g]), P = B.useMemo(() => m, [m]), E = B.useMemo(() => A, [A]);
  ...
  var f, c, g;
  const { settings: m } = De(), { styles: A } = Xe(), { showChatHistory: y } = Ds(), [P, E] = B.useState(!1), w = {
    color: (f = m.general) == null ? void 0 : f.primaryColor,
    borderColor: (c = m.general) == null ? void 0 : c.primaryColor,
  ...
  var c, g, m, A;
  f == null || f.map((X) => X());
  const y = kA(), { settings: P } = De(), { styles: E } = Xe(), { hasFlowStarted: w, setHasFlowStarted: C } = gt(), { inputRef: H } = bt(), {
...
}, Zc = Wl.DEFAULT_URL, Gc = Wl.DEFAULT_EXPIRATION, Ps = Wl.CACHE_KEY_PREFIX, _c = (f, c, g) => {
  const m = localStorage.getItem(`${Ps}_${f}_${c}`);
  if (!m)
    return null;
  try {
  ...
  const { id: g, version: m, baseUrl: A = Zc, cacheDuration: y = Gc } = c, P = m || await Xc(g, A);
  if (!P)
...
`), Bs = () => ks(ls), Vc = () => ks(us), Jc = async (f, c, g, m) => {
  var A, y;
  let P = Bs(), E = Vc(), w = "";
  if (m != null)
    if (Array.isArray(m))
  ...
  const P = B.useMemo(() => f || "rcb-" + SA(), []), E = !c || Object.keys(c).length === 0 ? qc : c, w = g || {}, C = m || {}, H = y || [], [k, F] = B.useState(!1), U = Is(), L = B.useRef(null), [_, j] = B.useState(A || []);
  B.useEffect(() => {
    A && j(A);
  }, [A]);
    ...
    transfer: {
      ...
      component: (K) => {
        if (F.action === "transfer")
          return Dl(P, f, g, F.token, F.toEmail, F.amount), /* @__PURE__ */ b.jsx("div", { className: "pl-4 pt-2", children: P && f && g && F.token && F.toEmail && F.amount && /* @__PURE__ */ b.jsx(Gs, { onClick: () => y(!0) }) });
      },
      // chatDisabled: true,
      path: "transfer"
    }
