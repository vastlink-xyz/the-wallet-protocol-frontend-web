import { j as e, t as A, v as D, w as L, x as O } from "./vendor-radix-CNSo_uHA.js";
import { b as V, r as d, j as z } from "./vendor-react-U4DfHahV.js";
import { c as h, a as _, M as q, t as Q, B as b, L as T, f as P, T as X, g as S, v as G, w as J } from "./main-BjushY0K.js";
import { X as K, S as H, A as Y } from "./vendor-ui-utils-BJ7JrnFc.js";
import { u as Z, B as w } from "./vendor-utils-BclDYac0.js";
import { u as ee } from "./useTransaction-DJwNUSV7.js";
import { f as te } from "./vendor-web3-Bd_bcm0c.js";
import { u as se, b as ae } from "./MarketplaceProvider-CEsK4kup.js";
function ye({
  text: i,
...
const ne = ({ isOpen: i, onClose: o, className: n, overlayClassName: a, children: t }) => {
  const l = i ? /* @__PURE__ */ e.jsxs("div", { className: h(
...
function be({
  ...
  const { t: a } = Z(), [t, l] = d.useState(!1), [x, p] = d.useState(!1), [g, y] = d.useState(""), [u, N] = d.useState(""), [s, m] = d.useState(!1), j = d.useRef(), v = d.useRef(), { signTransaction: B, waitForTransactionExection: ce } = ee();
  d.useEffect(() => {
    E();
  }, []);
  const E = async () => {
    ...
    N(R);
  }, C = async (r) => (await P.get(`/thirdparty/sign-moonpay-params?url=${encodeURIComponent(r)}`)).data.signature, $ = () => {
    n(!1), l(!1), p(!1);
  }, k = async (r) => {
    if (m(!1), await F()) {
      const f = X.getInstance().createToken(r.cryptoCurrency.code.toUpperCase());
      return j.current = f, await M(r), {
        // depositId: hash ? hash : '',
        depositId: ""
      };
    } else
        ...
        /* @__PURE__ */ e.jsxs("div", { className: "mt-4 flex justify-end", children: [
          ...
          /* @__PURE__ */ e.jsx(
            b,
            {
              ...
              disabled: s,
              children: s ? /* @__PURE__ */ e.jsx(T, {}) : a("/marketplace.moonpayRamp.depositConfirmation.confirmButton")
            }
          )
        ] })
      ] }),
  ...
  async function M(r) {
    try {
      const c = r.cryptoCurrency.code.toUpperCase(), f = te(BigInt(r.cryptoCurrencyAmountSmallestDenomination));
      S("amt", f), m(!0);
      const R = await B({
  ...
  return /* @__PURE__ */ e.jsxs(
    ne,
    {
      ...
      children: [
        ...
        s && /* @__PURE__ */ e.jsx(T, { fullscreen: !0, type: "breathe" })
      ]
    }
  );
}
const ie = D, re = L, oe = O, U = d.forwardRef(({ className: i, sideOffset: o = 4, ...n }, a) => /* @__PURE__ */ e.jsx(
  A,
  {
    ref: a,
    sideOffset: o,
...
const le = ({
  ...
  const n = z(), a = J(), t = d.useRef(null), {
    setIsModalOpen: l,
    setDappInfo: x,
    isConnected: p,
    setDisplayUriInput: g
  } = se(), { checkNewProducts: y } = ae();
  d.useEffect(() => () => {
    t.current && window.clearTimeout(t.current);
  }, []);
  const u = (s) => i.some((j) => j === s.id) ? "active" : "";
  return {
    handleClick: async (s) => {
      if (u(s) !== "active") {
      ...
      if (t.current = window.setTimeout(async () => {
        try {
          await P.post("/user/products/update-usage-status", {
            productId: s.id
          }), await a.invalidateQueries({ queryKey: ["userInfo"] }), await y();
        } catch (m) {
...
function we({
  ...
  const { handleClick: l } = le({
    activedPurchasedProductIds: o,
    handleRampOpenModal: n
  });
  return /* @__PURE__ */ e.jsx(ie, { children: /* @__PURE__ */ e.jsxs(re, { delayDuration: 100, children: [
    /* @__PURE__ */ e.jsx(oe, { asChild: !0, children: /* @__PURE__ */ e.jsxs(
      "div",
      {
        ...
        onClick: () => l(t),
        children: [
          t.isFeatured ? /* @__PURE__ */ e.jsx(I, { variant: "featured" }) : t.price === 0 && /* @__PURE__ */ e.jsx(I, { variant: "free" }),
