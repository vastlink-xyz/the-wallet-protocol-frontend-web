import { a as s, p as _ } from "./vendor-react-DG1r0zWq.js";
import { aL as pe, _ as me, r as B, aM as te, U as ye, T as ve, W as he, z as Ce, K as be, E as le, Y as $e, q as Se, R as ke, F as xe, aN as Ee } from "./main-ZrsMs0Kw.js";
import { o as Pe, R as we } from "./CheckOutlined-D3Nirlra.js";
import { _ as Ne } from "./vendor-ui-utils-9-Ouo9pm.js";
import { _ as z, p as ne, r as Oe } from "./vendor-web3-CfovYfnB.js";
import { d as Ie } from "./index-C7xoz9NP.js";
var _e = {
  percent: 0,
...
var ue = function(t) {
  var r = ne(ne({}, _e), t), n = r.id, o = r.prefixCls, a = r.steps, i = r.strokeWidth, l = r.trailWidth, c = r.gapDegree, f = c === void 0 ? 0 : c, d = r.gapPosition, g = r.trailColor, p = r.strokeLinecap, C = r.style, m = r.className, h = r.strokeColor, y = r.percent, b = Oe(r, Le), v = G / 2, I = Ae(n), P = "".concat(I, "-gradient"), $ = v - i / 2, S = Math.PI * 2 * $, O = f > 0 ? 90 + f / 2 : -90, x = S * ((360 - f) / 360), w = z(a) === "object" ? a : {
    ...
    return N && z(N) === "object";
  }), L = A && z(A) === "object", D = L ? "butt" : p, X = ee(S, x, 0, 100, O, f, d, g, D, i), K = De(), k = function() {
    var R = 0;
    ...
    return new Array(u).fill(null).map(function(Z, V) {
      var U = V <= R - 1 ? W[0] : g, J = U && z(U) === "object" ? "url(#".concat(P, ")") : void 0, re = ee(S, x, M, T, O, f, d, U, "butt", i, F);
...
}, Y = "--progress-line-stroke-color", fe = "--progress-percent", ae = (e) => {
  const t = e ? "100%" : "-100%";
