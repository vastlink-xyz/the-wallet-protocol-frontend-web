import { j as e, E as I, F as D, G as M, H as O } from "./vendor-radix-CPmBDWYo.js";
import { r as l, k as $ } from "./vendor-react-BA5A8Axg.js";
import { a as V, a9 as _, c as h, aa as q, ab as z, B as y, f as A, T as G, L as Q, g as T, ac as H, ad as J } from "./main-DH96ONN5.js";
import { u as K, B as w } from "./vendor-utils-nZmF9_dO.js";
import { u as X } from "./useTransaction-DF96Fmcv.js";
import { L as Y } from "./index-DozcSJTu.js";
import { S as Z, A as ee } from "./vendor-ui-utils-BWSrTfCS.js";
import { f as te } from "./vendor-web3-CqtRdeC5.js";
import { u as se, a as ae } from "./MarketplaceProvider-Dur8-uRC.js";
function be({
  text: o,
...
function ye({
  ...
  const { t: a } = K(), [t, m] = l.useState(!1), [x, p] = l.useState(!1), [g, b] = l.useState(""), [u, N] = l.useState(""), [s, d] = l.useState(!1), j = l.useRef(), v = l.useRef(), { signTransaction: U, waitForTransactionExection: le } = X();
  l.useEffect(() => {
    E();
  }, []);
  const E = async () => {
    ...
    N(R);
  }, C = async (n) => (await A.get(`/thirdparty/sign-moonpay-params?url=${encodeURIComponent(n)}`)).data.signature, B = () => {
    i(!1), m(!1), p(!1);
  }, k = async (n) => {
    if (d(!1), await F()) {
      const f = G.getInstance().createToken(n.cryptoCurrency.code.toUpperCase());
      return j.current = f, await L(n), {
        // depositId: hash ? hash : '',
        depositId: ""
      };
    } else
