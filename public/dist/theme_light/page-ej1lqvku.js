import { j as e } from "./vendor-radix-CNSo_uHA.js";
import { i as T, r as i, j as A, k as R, n as z } from "./vendor-react-U4DfHahV.js";
import { c as p, r as C, f as B, h as I, s as S } from "./main-BjushY0K.js";
import { S as M, P as O } from "./ProductList-DjIWNX0f.js";
import { b as F } from "./MarketplaceProvider-CEsK4kup.js";
import { j as E, b as P } from "./vendor-ui-utils-BJ7JrnFc.js";
import { B as _ } from "./vendor-utils-BclDYac0.js";
import { E as D } from "./index-B_1zzfpv.js";
const L = [
  "Most popular",
  "Free",
  "Latest",
...
function G({
  ...
  const { checkNewProducts: m, hasNewProducts: n } = F(), l = T(), h = L, [a, w] = i.useState(!1), [o, f] = i.useState(!1), d = i.useRef(null), [v, y] = i.useState(!1), b = i.useRef(0), x = () => {
    const t = d.current;
    if (t) {
  ...
  i.useEffect(() => {
    ...
    const t = d.current;
    if (t)
      return t.addEventListener("scroll", x), () => t.removeEventListener("scroll", x);
  }, []), i.useEffect(() => {
  ...
  const N = (t) => {
    b.current = window.scrollY, r == null || r(t);
  };
  return /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    v && /* @__PURE__ */ e.jsx("div", { className: "fixed top-0 left-0 right-0 h-[68px] bg-white shadow z-30" }),
    /* @__PURE__ */ e.jsxs(
      "div",
      {
        className: p([
                ...
                return /* @__PURE__ */ e.jsx(
                  "div",
                  {
                    ...
                    className: p(
                      ...
                      c ? "h-9 w-[110px] bg-black rounded-[60px] justify-center items-center gap-2 flex" : "h-9 flex items-center justify-center"
                    ),
...
function W({
  ...
  const l = Math.ceil(u / m), h = () => {
    ...
    return a.map((o, f) => {
      if (o === "ellipsis")
        return /* @__PURE__ */ e.jsx("div", { className: "w-8 h-8 flex items-center justify-center", children: /* @__PURE__ */ e.jsx("div", { className: "text-center text-black/25 text-sm font-normal leading-loose tracking-widest", children: "•••" }) }, `ellipsis-${f}`);
      const d = o === r;
      return /* @__PURE__ */ e.jsx(
        "div",
        {
...
function X() {
  const r = A(), [u] = R(), m = u.get("category"), [n, l] = i.useState(!1), [h, a] = i.useState(L[0]), {
    ...
    updateTotal: f,
    updatePageSize: d
  } = C(), { products: v, total: y } = z(), [b, x] = i.useState(v), g = i.useCallback(async (s) => {
    try {
      l(!0);
      const c = await B.post("/marketplace/product/search-products", s);
      x(c.data.products), f(c.data.total);
    } catch (c) {
      const k = I(c);
      _.error(k.message);
    } finally {
