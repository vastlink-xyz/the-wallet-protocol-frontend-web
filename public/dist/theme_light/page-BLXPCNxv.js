...
import { m as P, h as R, a as i } from "./vendor-react-DG1r0zWq.js";
import { f as x, t as B, B as p, L as M, V as D, ak as F, g, o as A, p as G, h as W } from "./main-ZrsMs0Kw.js";
import { B as c } from "./vendor-utils-CARgNrN0.js";
import { u as Y } from "./useTransaction-C_s6iHPH.js";
import { L as z } from "./index-DB8_Lllq.js";
import { k as v } from "./vendor-web3-CfovYfnB.js";
function U() {
  ...
  const b = async () => {
    ...
    if (e)
      try {
        ...
        g("result", n), n != null && n.needOtp ? (A.getVerifyMethod() === "email-by-sendgrid" && (S(n.transactionId), r(!0)), a = await T(n.transactionId)) : a = n == null ? void 0 : n.hash, await O(e.id, {
          status: "COMPLETED"
        }), h(e.id), g("hash is", a);
      } catch (s) {
