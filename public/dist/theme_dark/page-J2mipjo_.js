...
import { a as r } from "./vendor-react-D6ZgZFQ5.js";
import { B as u } from "./button-cBe5WUFQ.js";
import { C as v } from "./card-DCyeXAyg.js";
import { I as q } from "./input-CkYxSx-W.js";
import { L as K } from "./label-CSnN7sXM.js";
import { T as te, a as se, b as H, c as y, d as oe, e as U } from "./table-lRsiOS-7.js";
import { a as j } from "./index-CsjBluw_.js";
import { l as b } from "./main-BJkbpKmW.js";
import { h as M } from "./error-zbMK9Eli.js";
import { B as c } from "./vendor-utils-C4jFYPlP.js";
import { L as O } from "./index-D1dFQABU.js";
import { c as $ } from "./style-CX3mXOu3.js";
import { S as me } from "./index-CzCNuN_p.js";
import { R as le, E as ue } from "./vendor-ui-utils-CwlQOkPE.js";
const re = ({ steps: N, currentStep: m }) => /* @__PURE__ */ e.jsx("div", { className: "w-full mb-8", children: /* @__PURE__ */ e.jsx("div", { className: "flex items-center justify-between", children: N.map((p, o) => /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col items-center flex-1", children: [
    ...
    /* @__PURE__ */ e.jsx(
      "div",
      {
        className: $(
          ...
          o < m ? "bg-primary" : o === m ? "bg-background border-2 border-primary" : "bg-primary/20"
        )
      }
    )
  ] }),
  /* @__PURE__ */ e.jsx(
    "span",
    {
      className: $(
        ...
        o <= m ? "text-primary" : "text-primary/40"
      ),
      children: p
    }
  )
  ...
  i.href = k, i.download = m || "document.pdf", document.body.appendChild(i), i.click(), document.body.removeChild(i), URL.revokeObjectURL(k);
}, he = [
...
function pe({
  ...
  const [m, p] = r.useState(!1), [o, g] = r.useState(1), [C, A] = r.useState(""), [B, k] = r.useState([]), [i, w] = r.useState(null), [V, Y] = r.useState(null), [S, R] = r.useState({
    asicExtract: "idle",
    uboReport: "idle"
  }), [I, W] = r.useState({
    asicExtract: null,
    ...
    try {
      p(!0);
      const t = (await j.post("/marketplace/product/frankieone/get-token")).data, { data: l } = await j.post("/marketplace/product/frankieone/business-lookup", {
        search: C,
        token: t
      });
      b("data", l), k(l), g(2);
    ...
    try {
      ...
      const a = (f = (l = x.data) == null ? void 0 : l.document) == null ? void 0 : f.docScan;
      if (a && a.length > 0) {
    ...
    const l = t;
    ce(l.scanData, `${s}-${i == null ? void 0 : i.name}.pdf`, l.scanMIME);
  };
  return /* @__PURE__ */ e.jsxs("div", { children: [
    ...
    o === 1 && /* @__PURE__ */ e.jsxs(v, { className: "p-8", children: [
      ...
      /* @__PURE__ */ e.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ e.jsx(K, { htmlFor: "search", className: "text-sm font-medium", children: "Enter Business Name or ABN / ACN" }),
        /* @__PURE__ */ e.jsx(q, { id: "search", name: "search", placeholder: "Business name or ABN / ACN", onChange: P }),
        /* @__PURE__ */ e.jsx(u, { onClick: T, disabled: m, children: m ? /* @__PURE__ */ e.jsx(O, {}) : "Search" })
      ] })
    ] }),
...
function xe({
  ...
  const [m, p] = r.useState(!1), [o, g] = r.useState(1), [C, A] = r.useState(""), [B, k] = r.useState([]), [i, w] = r.useState(null), [V, Y] = r.useState(null), [S, R] = r.useState(""), [I, W] = r.useState(""), [P, T] = r.useState([]), [Z, E] = r.useState("idle"), D = (a) => {
    A(a);
  }, z = async () => {
    if (!S && !I) {
    ...
    o === 1 && /* @__PURE__ */ e.jsxs(v, { className: "p-8", children: [
      ...
      /* @__PURE__ */ e.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ e.jsxs("div", { children: [
          /* @__PURE__ */ e.jsx(K, { htmlFor: "country", className: "text-sm font-medium", children: "Select Country / Region" }),
          /* @__PURE__ */ e.jsx(
            me,
            {
              options: Se,
        ...
        /* @__PURE__ */ e.jsxs("div", { children: [
          /* @__PURE__ */ e.jsx(K, { htmlFor: "businessName", className: "text-sm font-medium", children: "Business Name" }),
          /* @__PURE__ */ e.jsx(
            q,
            {
              id: "businessName",
        ...
        /* @__PURE__ */ e.jsxs("div", { children: [
          /* @__PURE__ */ e.jsx(K, { htmlFor: "registrationNumber", className: "text-sm font-medium", children: "Registration Number" }),
          /* @__PURE__ */ e.jsx(
            q,
            {
        ...
        /* @__PURE__ */ e.jsx(
          u,
          {
            onClick: z,
            disabled: m || !C || !S && !I,
            children: m ? /* @__PURE__ */ e.jsx(O, {}) : "Search"
          }
        )
      ] })
    ] }),
      ...
      /* @__PURE__ */ e.jsx("div", { className: "space-y-4", children: P.length === 0 ? /* @__PURE__ */ e.jsx("div", { className: "flex justify-center", children: Z === "loading" ? /* @__PURE__ */ e.jsxs("div", { className: "flex items-center space-x-2", children: [
        ...
        /* @__PURE__ */ e.jsx("div", { className: "flex flex-col space-y-2", children: a.ordered ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
          ...
          u,
          {
            ...
            className: "w-40",
            children: a.status === "loading" ? /* @__PURE__ */ e.jsx(O, {}) : a.status === "error" ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
              /* @__PURE__ */ e.jsx(le, { className: "mr-2 h-4 w-4" }),
              "Retry"
            ] }) : "Order Report"
          }
        ) })
...
function be({
  ...
  return m ? /* @__PURE__ */ e.jsx(pe, { resetFlow: A }) : m === !1 ? /* @__PURE__ */ e.jsx(xe, { resetFlow: A }) : C();
}
function Te() {
