import { r as uo, p as fo, a as c, b as Zt, R as ze, $ as Ca, c as Ea } from "./vendor-react-D6ZgZFQ5.js";
var Ln = { exports: {} }, ht = {};
/**
 * @license React
...
fo.env.NODE_ENV === "production" ? Ln.exports = Ra() : Ln.exports = Sa();
var h = Ln.exports;
function Pa(e, t) {
...
var Le = c.forwardRef((e, t) => {
  const { children: n, ...r } = e, o = c.Children.toArray(n), i = o.find(Ta);
  if (i) {
...
var Oa = "Label", mo = c.forwardRef((e, t) => /* @__PURE__ */ h.jsx(
  F.label,
  {
    ...e,
    ref: t,
...
function Fe({
  ...
  const [r, o] = Na({ defaultProp: t, onChange: n }), i = e !== void 0, s = i ? e : r, a = xe(n), l = c.useCallback(
    (u) => {
      if (i) {
...
var ka = c.createContext(void 0);
function Qt(e) {
  const t = c.useContext(ka);
  return e || t || "ltr";
}
...
var Fa = "DismissableLayer", $n = "dismissableLayer.update", $a = "dismissableLayer.pointerDownOutside", Wa = "dismissableLayer.focusOutside", Vr, ho = c.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...l
    } = e, u = c.useContext(ho), [f, d] = c.useState(null), m = (f == null ? void 0 : f.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, g] = c.useState({}), w = q(t, (P) => d(P)), v = Array.from(u.layers), [x] = [...u.layersWithOutsidePointerEventsDisabled].slice(-1), b = v.indexOf(x), y = f ? v.indexOf(f) : -1, C = u.layersWithOutsidePointerEventsDisabled.size > 0, R = y >= b, S = Ha((P) => {
...
ft.displayName = Fa;
var Ba = "DismissableLayerBranch", Va = c.forwardRef((e, t) => {
  const n = c.useContext(ho), r = c.useRef(null), o = q(t, r);
  return c.useEffect(() => {
    const i = r.current;
    if (i)
...
function Ua(e, t = globalThis == null ? void 0 : globalThis.document) {
  ...
  return c.useEffect(() => {
    const o = (i) => {
      i.target && !r.current && go(Wa, n, { originalEvent: i }, {
        discrete: !1
      });
    };
...
var _n = "focusScope.autoFocusOnMount", An = "focusScope.autoFocusOnUnmount", Kr = { bubbles: !1, cancelable: !0 }, Ka = "FocusScope", Rt = c.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  c.useEffect(() => {
    ...
    if (a) {
      ...
      if (!a.contains(v)) {
        ...
        a.addEventListener(_n, u), a.dispatchEvent(b), b.defaultPrevented || (Ga(Za(wo(a)), { select: !0 }), document.activeElement === v && ke(a));
      }
      return () => {
  ...
  const w = c.useCallback(
    (v) => {
      ...
      if (x && b) {
        const y = v.currentTarget, [C, R] = Ya(y);
...
function Ya(e) {
  const t = wo(e), n = Gr(t, e), r = Gr(t.reverse(), e);
  return [n, r];
}
function wo(e) {
...
const ec = ["top", "right", "bottom", "left"], $e = Math.min, pe = Math.max, Ht = Math.round, Nt = Math.floor, We = (e) => ({
  x: e,
  y: e
}), tc = {
  left: "right",
...
async function xt(e, t) {
  ...
  const {
    ...
    altBoundary: m = !1,
    padding: g = 0
  } = De(t, e), w = yo(g), x = a[m ? d === "floating" ? "reference" : "floating" : d], b = Kt(await i.getClippingRect({
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = i.arrow) != null && n.alignmentOffset)
        return {};
      const b = Ne(o), y = Be(a), C = Ne(a) === a, R = await (l.isRTL == null ? void 0 : l.isRTL(u.floating)), S = m || (C || !v ? [Ut(a)] : oc(a)), O = w !== "none";
      !m && O && S.push(...sc(a, v, w, R));
...
function bo(e) {
  const t = Ve(e);
  return ct(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Me(t) && St(t) ? t : bo(t);
}
function bt(e, t, n) {
  var r;
  t === void 0 && (t = []), n === void 0 && (n = !0);
  const o = bo(e), i = o === ((r = e.ownerDocument) == null ? void 0 : r.body), s = ve(o);
  if (i) {
    const a = Vn(s);
...
const yc = /* @__PURE__ */ We(0);
function Eo(e) {
  const t = ve(e);
  return !sr() || !t.visualViewport ? yc : {
...
function Ro(e, t) {
  const n = Ve(e);
  return n === t || !Se(n) || ct(n) ? !1 : Pe(n).position === "fixed" || Ro(n, t);
}
function Pc(e, t) {
  const n = t.get(e);
  if (n)
  ...
  for (; Se(s) && !ct(s); ) {
    const a = Pe(s), l = ir(s);
    !l && a.position === "fixed" && (o = null), (i ? !l && !o : !l && a.position === "static" && !!o && ["absolute", "fixed"].includes(o.position) || St(s) && !l && Ro(e, s)) ? r = r.filter((f) => f !== s) : o = a, s = Ve(s);
  }
  return t.set(e, r), r;
}
function Tc(e) {
  ...
  const s = [...n === "clippingAncestors" ? nn(t) ? [] : Pc(t, this._c) : [].concat(n), r], a = s[0], l = s.reduce((u, f) => {
    const d = Qr(t, f, o);
...
function So(e, t) {
  ...
  for (; r && gc(r) && Mn(r); )
    r = eo(r, t);
  return r && ct(r) && Mn(r) && !ir(r) ? n : r || wc(e) || n;
}
...
const jc = pc, kc = vc, Lc = uc, Fc = hc, $c = fc, to = lc, Wc = mc, Bc = (e, t, n) => {
...
function Vc(e) {
  ...
  const [w, v] = c.useState(null), [x, b] = c.useState(null), y = c.useCallback((D) => {
    ...
    G.current && (D.platform = G.current), Bc(O.current, P.current, D).then((A) => {
      const Z = {
        ...A,
...
var Zc = "Arrow", To = c.forwardRef((e, t) => {
...
var cr = "Popper", [_o, He] = er(cr), [el, Ao] = _o(cr), Mo = (e) => {
  const { __scopePopper: t, children: n } = e, [r, o] = c.useState(null);
  return /* @__PURE__ */ h.jsx(el, { scope: t, anchor: r, onAnchorChange: o, children: n });
};
Mo.displayName = cr;
var Oo = "PopperAnchor", Io = c.forwardRef(
  (e, t) => {
    const { __scopePopper: n, virtualRef: r, ...o } = e, i = Ao(Oo, n), s = c.useRef(null), a = q(t, s);
    return c.useEffect(() => {
...
Io.displayName = Oo;
var lr = "PopperContent", [tl, nl] = _o(lr), Do = c.forwardRef(
  (e, t) => {
    var I, Y, J, U, Q, X;
    const {
      __scopePopper: n,
      ...
      onPlaced: w,
      ...v
    } = e, x = Ao(lr, n), [b, y] = c.useState(null), C = q(t, (ae) => y(ae)), [R, S] = c.useState(null), O = Qc(R), P = (O == null ? void 0 : O.width) ?? 0, M = (O == null ? void 0 : O.height) ?? 0, $ = r + (i !== "center" ? "-" + i : ""), W = typeof f == "number" ? f : { top: 0, right: 0, bottom: 0, left: 0, ...f }, G = Array.isArray(u) ? u : [u], V = G.length > 0, k = {
      padding: W,
      boundary: G.filter(ol),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: V
    }, { refs: L, floatingStyles: z, placement: N, isPositioned: H, middlewareData: D } = Vc({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: $,
      whileElementsMounted: (...ae) => Nc(...ae, {
      ...
      middleware: [
        Uc({ mainAxis: o + M, alignmentAxis: s }),
        l && Kc({
          mainAxis: !0,
          crossAxis: !1,
          limiter: d === "partial" ? Gc() : void 0,
          ...k
        }),
        l && Yc({ ...k }),
        zc({
        ...
        R && qc({ element: R, padding: a }),
        il({ arrowWidth: P, arrowHeight: M }),
        m && Xc({ strategy: "referenceHidden", ...k })
      ]
    }), [A, Z] = ko(N), ne = xe(w);
    le(() => {
      H && (ne == null || ne());
...
Do.displayName = lr;
var No = "PopperArrow", rl = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, jo = c.forwardRef(function(t, n) {
  const { __scopePopper: r, ...o } = t, i = nl(No, r), s = rl[i.placedSide];
  return (
...
var il = (e) => ({
  ...
  fn(t) {
    var x, b, y;
    const { placement: n, rects: r, middlewareData: o } = t, s = ((x = o.arrow) == null ? void 0 : x.centerOffset) !== 0, a = s ? 0 : e.arrowWidth, l = s ? 0 : e.arrowHeight, [u, f] = ko(n), d = { start: "0%", center: "50%", end: "100%" }[f], m = (((b = o.arrow) == null ? void 0 : b.x) ?? 0) + a / 2, g = (((y = o.arrow) == null ? void 0 : y.y) ?? 0) + l / 2;
    let w = "", v = "";
...
var on = Mo, Pt = Io, sn = Do, an = jo, sl = "Portal", Tt = c.forwardRef((e, t) => {
  var a;
...
var be = (e) => {
  const { present: t, children: n } = e, r = cl(t), o = typeof n == "function" ? n({ present: r.isPresent }) : c.Children.only(n), i = q(r.ref, ll(o));
  return typeof n == "function" || r.isPresent ? c.cloneElement(o, { ref: i }) : null;
};
be.displayName = "Presence";
function cl(e) {
  const [t, n] = c.useState(), r = c.useRef({}), o = c.useRef(e), i = c.useRef("none"), s = e ? "mounted" : "unmounted", [a, l] = al(s, {
    mounted: {
      UNMOUNT: "unmounted",
...
var In = "rovingFocusGroup.onEntryFocus", ul = { bubbles: !1, cancelable: !0 }, cn = "RovingFocusGroup", [Un, Lo, fl] = tr(cn), [dl, ln] = er(
  cn,
  [fl]
), [pl, vl] = dl(cn), Fo = c.forwardRef(
  (e, t) => /* @__PURE__ */ h.jsx(Un.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ h.jsx(Un.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ h.jsx(ml, { ...e, ref: t }) }) })
);
Fo.displayName = cn;
var ml = c.forwardRef((e, t) => {
  const {
    ...
    defaultProp: a,
    onChange: l
  }), [b, y] = c.useState(!1), C = xe(u), R = Lo(n), S = c.useRef(!1), [O, P] = c.useState(0);
  return c.useEffect(() => {
    const M = m.current;
    if (M)
...
}), $o = "RovingFocusGroupItem", Wo = c.forwardRef(
  (e, t) => {
    const {
      __scopeRovingFocusGroup: n,
      focusable: r = !0,
      ...
      tabStopId: i,
      ...s
    } = e, a = we(), l = i || a, u = vl($o, n), f = u.currentTabStopId === l, d = Lo(n), { onFocusableItemAdd: m, onFocusableItemRemove: g } = u;
    return c.useEffect(() => {
      if (r)
        return m(), () => g();
        ...
        children: /* @__PURE__ */ h.jsx(
          F.span,
          {
            ...
            onKeyDown: _(e.onKeyDown, (w) => {
              ...
              const v = wl(w, u.orientation, u.dir);
              if (v !== void 0) {
...
var Vo = Fo, Ho = Wo, xl = function(e) {
  if (typeof document > "u")
    return null;
  var t = Array.isArray(e) ? e[0] : e;
  return t.ownerDocument.body;
}, rt = /* @__PURE__ */ new WeakMap(), kt = /* @__PURE__ */ new WeakMap(), Lt = {}, Dn = 0, Uo = function(e) {
  ...
  return o ? (r.push.apply(r, Array.from(o.querySelectorAll("[aria-live]"))), Cl(r, o, n, "aria-hidden")) : function() {
    return null;
  };
}, Ae = function() {
...
var Bt = "right-scroll-bar-position", Vt = "width-before-scroll-bar", Rl = "with-scroll-bars-hidden", Sl = "--removed-body-scroll-bar-size";
function Nn(e, t) {
...
var Tl = typeof window < "u" ? c.useLayoutEffect : c.useEffect, ro = /* @__PURE__ */ new WeakMap();
function _l(e, t) {
...
var Go = function(e) {
  var t = e.sideCar, n = Ko(e, ["sideCar"]);
  if (!t)
...
var Yo = Ol(), jn = function() {
}, fn = c.forwardRef(function(e, t) {
  var n = c.useRef(null), r = c.useState({
    onScrollCapture: jn,
    onWheelCapture: jn,
    onTouchMoveCapture: jn
  }), o = r[0], i = r[1], s = e.forwardProps, a = e.children, l = e.className, u = e.removeScrollBar, f = e.enabled, d = e.shards, m = e.sideCar, g = e.noIsolation, w = e.inert, v = e.allowPinchZoom, x = e.as, b = x === void 0 ? "div" : x, y = e.gapMode, C = Ko(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), R = m, S = _l([n, t]), O = Ae(Ae({}, C), o);
  return c.createElement(
    c.Fragment,
    null,
    f && c.createElement(R, { sideCar: Yo, removeScrollBar: u, shards: d, noIsolation: g, inert: w, setCallbacks: i, allowPinchZoom: !!v, lockRef: n, gapMode: y }),
...
}, Vl = zo(), at = "data-scroll-locked", Hl = function(e, t, n, r) {
...
`);
  ...
  return c.createElement(Vl, { styles: Hl(i, !t, o, n ? "" : "!important") });
}, Kn = !1;
if (typeof window < "u")
  try {
...
var ot = Kn ? { passive: !1 } : !1, Gl = function(e) {
  ...
  do {
    var g = Zo(e, a), w = g[0], v = g[1], x = g[2], b = v - x - i * w;
    (w || b) && qo(e, a) && (d += b, m += w), a instanceof ShadowRoot ? a = a.host : a = a.parentNode;
  } while (
    // portaled content
...
function nu(e) {
  var t = c.useRef([]), n = c.useRef([0, 0]), r = c.useRef(), o = c.useState(tu++)[0], i = c.useState(zo)[0], s = c.useRef(e);
  c.useEffect(function() {
    s.current = e;
  }, [e]), c.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var v = El([e.lockRef.current], (e.shards || []).map(ao), !0).filter(Boolean);
  ...
  var a = c.useCallback(function(v, x) {
    ...
    var C = { name: v, delta: x, target: b, should: y, shadowParent: ru(b) };
  ...
  return c.createElement(
    c.Fragment,
    null,
    w ? c.createElement(i, { styles: eu(o) }) : null,
    g ? c.createElement(Kl, { gapMode: e.gapMode }) : null
  );
}
function ru(e) {
...
var _t = c.forwardRef(function(e, t) {
  return c.createElement(fn, Ae({}, e, { ref: t, sideCar: ou }));
});
_t.classNames = fn.classNames;
var Gn = ["Enter", " "], iu = ["ArrowDown", "PageUp", "Home"], Jo = ["ArrowUp", "PageDown", "End"], su = [...iu, ...Jo], au = {
  ltr: [...Gn, "ArrowRight"],
  rtl: [...Gn, "ArrowLeft"]
}, cu = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, At = "Menu", [Ct, lu, uu] = tr(At), [Qe, Qo] = Je(At, [
  uu,
  He,
  ln
]), dn = He(), ei = ln(), [fu, et] = Qe(At), [du, Mt] = Qe(At), ti = (e) => {
...
ti.displayName = At;
var pu = "MenuAnchor", ur = c.forwardRef(
  (e, t) => {
...
ur.displayName = pu;
var fr = "MenuPortal", [vu, ni] = Qe(fr, {
  forceMount: void 0
}), ri = (e) => {
  const { __scopeMenu: t, forceMount: n, children: r, container: o } = e, i = et(fr, t);
  return /* @__PURE__ */ h.jsx(vu, { scope: t, forceMount: n, children: /* @__PURE__ */ h.jsx(be, { present: n || i.open, children: /* @__PURE__ */ h.jsx(Tt, { asChild: !0, container: o, children: r }) }) });
};
ri.displayName = fr;
var ye = "MenuContent", [mu, dr] = Qe(ye), oi = c.forwardRef(
  (e, t) => {
    const n = ni(ye, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, i = et(ye, e.__scopeMenu), s = Mt(ye, e.__scopeMenu);
    return /* @__PURE__ */ h.jsx(Ct.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: /* @__PURE__ */ h.jsx(Ct.Slot, { scope: e.__scopeMenu, children: s.modal ? /* @__PURE__ */ h.jsx(hu, { ...o, ref: t }) : /* @__PURE__ */ h.jsx(gu, { ...o, ref: t }) }) }) });
  }
), hu = c.forwardRef(
  (e, t) => {
  ...
  (e, t) => {
    const {
      ...
      ...v
    } = e, x = et(ye, n), b = Mt(ye, n), y = dn(n), C = ei(n), R = lu(n), [S, O] = c.useState(null), P = c.useRef(null), M = q(t, P, x.onContentChange), $ = c.useRef(0), W = c.useRef(""), G = c.useRef(0), V = c.useRef(null), k = c.useRef("right"), L = c.useRef(0), z = w ? _t : c.Fragment, N = w ? { as: Le, allowPinchZoom: !0 } : void 0, H = (A) => {
      var I, Y;
      const Z = W.current + A, ne = R().filter((J) => !J.disabled), ie = document.activeElement, me = (I = ne.find((J) => J.ref.current === ie)) == null ? void 0 : I.textValue, fe = ne.map((J) => J.textValue), Ce = Au(fe, Z, me), se = (Y = ne.find((J) => J.textValue === Ce)) == null ? void 0 : Y.ref.current;
      (function J(U) {
    ...
    const D = c.useCallback((A) => {
      var ne, ie;
      return k.current === ((ne = V.current) == null ? void 0 : ne.side) && Ou(A, (ie = V.current) == null ? void 0 : ie.area);
    }, []);
    return /* @__PURE__ */ h.jsx(
      mu,
      {
                    ...
                    children: /* @__PURE__ */ h.jsx(
                      sn,
                      {
                        ...
                        onKeyDown: _(v.onKeyDown, (A) => {
                          ...
                          const fe = P.current;
                          if (A.target !== fe || !su.includes(A.key)) return;
                          A.preventDefault();
                          const se = R().filter((I) => !I.disabled).map((I) => I.ref.current);
                          Jo.includes(A.key) && se.reverse(), Tu(se);
                        }),
                        onBlur: _(e.onBlur, (A) => {
...
oi.displayName = ye;
var wu = "MenuGroup", vr = c.forwardRef(
  (e, t) => {
...
vr.displayName = wu;
var yu = "MenuLabel", ii = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
...
var si = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: r = !1, textValue: o, ...i } = e, s = dr(Yt, n), a = ei(n), l = c.useRef(null), u = q(t, l), [f, d] = c.useState(!1), [m, g] = c.useState("");
    return c.useEffect(() => {
      const w = l.current;
      ...
      Ct.ItemSlot,
      {
        ...
        disabled: r,
        textValue: o ?? m,
        children: /* @__PURE__ */ h.jsx(Ho, { asChild: !0, ...a, focusable: !r, children: /* @__PURE__ */ h.jsx(
          F.div,
          {
            role: "menuitem",
...
), xu = "MenuCheckboxItem", ai = c.forwardRef(
  (e, t) => {
    const { checked: n = !1, onCheckedChange: r, ...o } = e;
    return /* @__PURE__ */ h.jsx(di, { scope: e.__scopeMenu, checked: n, children: /* @__PURE__ */ h.jsx(
      pn,
      {
...
ai.displayName = xu;
var ci = "MenuRadioGroup", [bu, Cu] = Qe(
  ci,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ h.jsx(bu, { scope: e.__scopeMenu, value: n, onValueChange: i, children: /* @__PURE__ */ h.jsx(vr, { ...o, ref: t }) });
  }
);
li.displayName = ci;
var ui = "MenuRadioItem", fi = c.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = Cu(ui, e.__scopeMenu), i = n === o.value;
    return /* @__PURE__ */ h.jsx(di, { scope: e.__scopeMenu, checked: i, children: /* @__PURE__ */ h.jsx(
      pn,
      {
        role: "menuitemradio",
        "aria-checked": i,
...
var mr = "MenuItemIndicator", [di, Eu] = Qe(
  mr,
  { checked: !1 }
), pi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: r, ...o } = e, i = Eu(mr, n);
    return /* @__PURE__ */ h.jsx(
      be,
      {
...
pi.displayName = mr;
var Ru = "MenuSeparator", vi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
    return /* @__PURE__ */ h.jsx(
      F.div,
...
vi.displayName = Ru;
var Su = "MenuArrow", mi = c.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = dn(n);
...
mi.displayName = Su;
var Pu = "MenuSub", [vd, hi] = Qe(Pu), wt = "MenuSubTrigger", gi = c.forwardRef(
  (e, t) => {
    const n = et(wt, e.__scopeMenu), r = Mt(wt, e.__scopeMenu), o = hi(wt, e.__scopeMenu), i = dr(wt, e.__scopeMenu), s = c.useRef(null), { pointerGraceTimerRef: a, onPointerGraceIntentChange: l } = i, u = { __scopeMenu: e.__scopeMenu }, f = c.useCallback(() => {
    ...
    return c.useEffect(() => f, [f]), c.useEffect(() => {
      ...
      si,
      {
        ...
        onKeyDown: _(e.onKeyDown, (d) => {
          ...
          e.disabled || m && d.key === " " || au[r.dir].includes(d.key) && (n.onOpenChange(!0), (g = n.content) == null || g.focus(), d.preventDefault());
        })
      }
    ) });
  }
...
gi.displayName = wt;
var wi = "MenuSubContent", yi = c.forwardRef(
  (e, t) => {
    const n = ni(ye, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, i = et(ye, e.__scopeMenu), s = Mt(ye, e.__scopeMenu), a = hi(wi, e.__scopeMenu), l = c.useRef(null), u = q(t, l);
    return /* @__PURE__ */ h.jsx(Ct.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ h.jsx(be, { present: r || i.open, children: /* @__PURE__ */ h.jsx(Ct.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ h.jsx(
      pr,
      {
        ...
        onKeyDown: _(e.onKeyDown, (f) => {
          var g;
          const d = f.currentTarget.contains(f.target), m = cu[s.dir].includes(f.key);
...
var Iu = ti, Du = ur, Nu = ri, ju = oi, ku = vr, Lu = ii, Fu = pn, $u = ai, Wu = li, Bu = fi, Vu = pi, Hu = vi, Uu = mi, Ku = gi, Gu = yi, gr = "DropdownMenu", [Yu, md] = Je(
  gr,
  [Qo]
), ue = Qo(), [zu, bi] = Yu(gr), Ci = (e) => {
  const {
  ...
  return /* @__PURE__ */ h.jsx(
    zu,
    {
      ...
      modal: a,
      children: /* @__PURE__ */ h.jsx(Iu, { ...l, open: f, onOpenChange: d, dir: r, modal: a, children: n })
    }
  );
};
Ci.displayName = gr;
var Ei = "DropdownMenuTrigger", Ri = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, disabled: r = !1, ...o } = e, i = bi(Ei, n), s = ue(n);
    return /* @__PURE__ */ h.jsx(Du, { asChild: !0, ...s, children: /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
        id: i.triggerId,
...
Ri.displayName = Ei;
var Xu = "DropdownMenuPortal", Si = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, r = ue(t);
  return /* @__PURE__ */ h.jsx(Nu, { ...r, ...n });
};
Si.displayName = Xu;
var Pi = "DropdownMenuContent", Ti = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = bi(Pi, n), i = ue(n), s = c.useRef(!1);
    return /* @__PURE__ */ h.jsx(
      ju,
      {
        id: o.contentId,
...
Ti.displayName = Pi;
var qu = "DropdownMenuGroup", Zu = c.forwardRef(
  (e, t) => {
...
Zu.displayName = qu;
var Ju = "DropdownMenuLabel", _i = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
_i.displayName = Ju;
var Qu = "DropdownMenuItem", Ai = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
Ai.displayName = Qu;
var ef = "DropdownMenuCheckboxItem", Mi = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx($u, { ...o, ...r, ref: t });
});
Mi.displayName = ef;
var tf = "DropdownMenuRadioGroup", nf = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Wu, { ...o, ...r, ref: t });
});
nf.displayName = tf;
var rf = "DropdownMenuRadioItem", Oi = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Bu, { ...o, ...r, ref: t });
});
Oi.displayName = rf;
var of = "DropdownMenuItemIndicator", Ii = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Vu, { ...o, ...r, ref: t });
});
Ii.displayName = of;
var sf = "DropdownMenuSeparator", Di = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Hu, { ...o, ...r, ref: t });
});
Di.displayName = sf;
var af = "DropdownMenuArrow", cf = c.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
...
cf.displayName = af;
var lf = "DropdownMenuSubTrigger", Ni = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(Ku, { ...o, ...r, ref: t });
});
Ni.displayName = lf;
var uf = "DropdownMenuSubContent", ji = c.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = ue(n);
  return /* @__PURE__ */ h.jsx(
    Gu,
    {
...
ji.displayName = uf;
var hd = Ci, gd = Ri, wd = Si, yd = Ti, xd = _i, bd = Ai, Cd = Mi, Ed = Oi, Rd = Ii, Sd = Di, Pd = Ni, Td = ji, wr = "Dialog", [ki, _d] = Je(wr), [ff, Te] = ki(wr), Li = (e) => {
  const {
    __scopeDialog: t,
    children: n,
    open: r,
...
Li.displayName = wr;
var Fi = "DialogTrigger", $i = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(Fi, n), i = q(t, o.triggerRef);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
$i.displayName = Fi;
var yr = "DialogPortal", [df, Wi] = ki(yr, {
  forceMount: void 0
}), Bi = (e) => {
...
Bi.displayName = yr;
var Xt = "DialogOverlay", Vi = c.forwardRef(
  (e, t) => {
    const n = Wi(Xt, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(Xt, e.__scopeDialog);
...
), qe = "DialogContent", Hi = c.forwardRef(
  (e, t) => {
    const n = Wi(qe, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, i = Te(qe, e.__scopeDialog);
...
), xr = "DialogTitle", Ki = c.forwardRef(
  (e, t) => {
...
Ki.displayName = xr;
var Gi = "DialogDescription", Yi = c.forwardRef(
  (e, t) => {
...
Yi.displayName = Gi;
var zi = "DialogClose", Xi = c.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = Te(zi, n);
    return /* @__PURE__ */ h.jsx(
      F.button,
      {
        type: "button",
...
var qi = "DialogTitleWarning", [Ad, Zi] = Ia(qi, {
  contentName: qe,
  titleName: xr,
  docsSlug: "dialog"
}), hf = ({ titleId: e }) => {
  const t = Zi(qi), n = `\`${t.contentName}\` requires a \`${t.titleName}\` for the component to be accessible for screen reader users.
...
For more information, see https://radix-ui.com/primitives/docs/components/${t.docsSlug}`;
  ...
  const r = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${Zi(gf).contentName}}.`;
  return c.useEffect(() => {
    var i;
    const o = (i = e.current) == null ? void 0 : i.getAttribute("aria-describedby");
    t && o && (document.getElementById(t) || console.warn(r));
  }, [r, e, t]), null;
}, Md = Li, Od = $i, Id = Bi, Dd = Vi, Nd = Hi, jd = Ki, kd = Yi, Ld = Xi, Cr = "Tabs", [yf, Fd] = Je(Cr, [
  ln
...
var $d = Qi, Wd = ts, Bd = rs, Vd = is, bf = "VisuallyHidden", Rr = c.forwardRef(
  (e, t) => /* @__PURE__ */ h.jsx(
    F.span,
    {
      ...e,
...
Rr.displayName = bf;
var Cf = Rr, [vn, Hd] = Je("Tooltip", [
  He
]), mn = He(), cs = "TooltipProvider", Ef = 700, Yn = "tooltip.open", [Rf, Sr] = vn(cs), ls = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Ef,
...
ls.displayName = cs;
var hn = "Tooltip", [Sf, gn] = vn(hn), us = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
...
var Pf = "TooltipPortal", [Ud, Tf] = vn(Pf, {
  ...
  const n = gn(lt, e.__scopeTooltip), r = Sr(lt, e.__scopeTooltip), o = c.useRef(null), i = q(t, o), [s, a] = c.useState(null), { trigger: l, onClose: u } = n, f = o.current, { onPointerInTransitChange: d } = r, m = c.useCallback(() => {
    ...
    (w, v) => {
      const x = w.currentTarget, b = { x: w.clientX, y: w.clientY }, y = If(b, x.getBoundingClientRect()), C = Df(b, y), R = Nf(v.getBoundingClientRect()), S = kf([...C, ...R]);
      a(S), d(!0);
    },
    [d]
  );
...
var Ze = "SelectContent", Cs = c.forwardRef(
  (e, t) => {
    ...
    return /* @__PURE__ */ h.jsx(Rs, { ...e, ref: t });
  }
);
Cs.displayName = Ze;
var Re = 10, [Es, Ke] = vt(Ze), Yf = "SelectContentImpl", Rs = c.forwardRef(
  (e, t) => {
    const {
      __scopeSelect: n,
...
Rs.displayName = Yf;
var zf = "SelectItemAlignedPosition", Ss = c.forwardRef((e, t) => {
