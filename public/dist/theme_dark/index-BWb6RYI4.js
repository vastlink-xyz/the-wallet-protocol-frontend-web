import { j as e, r as A, t as $, v as L, w as W } from "./vendor-radix-CjL5_ZCn.js";
import { a as c, k as V, c as z } from "./vendor-react-D6ZgZFQ5.js";
import { u as _, M as q, b as K, l as R } from "./main-BJkbpKmW.js";
import { c as w } from "./style-CX3mXOu3.js";
import { a as k } from "./index-CsjBluw_.js";
import { u as X } from "./MarketplaceProvider-Croy5box.js";
import { B as j } from "./button-cBe5WUFQ.js";
import { a as G } from "./auth-Da6VcpsW.js";
import { X as J, S as H, A as Q } from "./vendor-ui-utils-CwlQOkPE.js";
import { u as Y, B as N } from "./vendor-utils-C4jFYPlP.js";
import { T as Z } from "./TokenService-B7AKV6_i.js";
import { L as I } from "./index-D1dFQABU.js";
import { T as ee } from "./transaction-Dz01ddzF.js";
import { u as te } from "./useTransaction-BRTWuZB-.js";
import { f as se } from "./vendor-web3-CnsO-8OJ.js";
const Ce = ({ className: i, onSearch: n, defaultValue: r = "", ...s }) => {
  ...
  return /* @__PURE__ */ e.jsxs("div", { className: w(
...
function re({
  ...
  } = _(), { checkNewProducts: m } = X(), y = (a) => n.some((u) => u === a.id) ? "active" : "", b = async () => {
    if (y(t) !== "active") {
...
const oe = ({ isOpen: i, onClose: n, className: r, children: s }) => {
  const t = i ? /* @__PURE__ */ e.jsxs("div", { className: w(
...
function le({
  ...
  const { t: s } = Y(), [t, o] = c.useState(!1), [x, p] = c.useState(!1), [g, d] = c.useState(""), [m, y] = c.useState(""), [b, a] = c.useState(!1), v = c.useRef(), u = c.useRef(), { signTransaction: E, waitForTransactionExection: ce } = te();
  c.useEffect(() => {
    F();
  }, []);
  const F = async () => {
    ...
    y(S);
  }, C = async (l) => (await k.get(`/thirdparty/sign-moonpay-params?url=${encodeURIComponent(l)}`)).data.signature, M = () => {
    r(!1), o(!1), p(!1);
  }, P = async (l) => {
    if (a(!1), await O()) {
...
function Pe({
  ...
  const m = async () => {
    ...
    o(v);
  }, y = async () => (await k.get("/user/purchasedProducts")).data, b = (a) => {
    p(!0), d(a);
  };
  return i ? null : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    n.length === 0 ? r : /* @__PURE__ */ e.jsx("div", { className: w([
