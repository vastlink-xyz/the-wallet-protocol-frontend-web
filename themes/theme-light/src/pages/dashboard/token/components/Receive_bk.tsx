  ...
  return(
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="w-[360px] text-primary">
        <DialogTitle>
          {t('/dashboard.[token].receiveModal.title')}
        </DialogTitle>

        <Tabs defaultValue="crypto" className="w-full">
          <TabsList className="w-full">
            <TabsTrigger value="crypto" className="w-full">{t('/dashboard.[token].receiveModal.Crypto')}</TabsTrigger>
            <TabsTrigger value="email" className="w-full">{t('/dashboard.[token].receiveModal.Email')}</TabsTrigger>
          </TabsList>
