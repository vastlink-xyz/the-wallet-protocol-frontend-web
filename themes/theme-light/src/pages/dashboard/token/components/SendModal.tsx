...
import { Loader, CircleCheck, AlertCircle } from "lucide-react"
        ...
        <form
          ...
          <div className="mb-5">
            <div className="flex items-center justify-between">
              ...
              <p className="text-xs mb-2 text-primary/60">{t('/dashboard.[token].sendModal.balance')}: {formatDecimal(balance)} {symbol}</p>
            </div>
            <div className="relative">
              <Input
                value={amount}
