...
import { House, Coins, NotebookText, Store, LucideProps, AlignJustify } from "lucide-react"
...
export function SideBar() {
  ...
  return <div className="relative w-0 md:w-auto md:h-screen flex flex-grow flex-col">
    ...
    <div className="relative md:hidden p-4 text-primary" onClick={() => toggleSidebar()}>
      <AlignJustify />
    </div>
  </div>
}
